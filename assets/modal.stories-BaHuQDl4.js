import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{m as n,n as r,r as i,s as a,t as o}from"./lit-JruGAyH3.js";import{n as ee,t as s}from"./dist-BZcjgT0h.js";import{a as te,i as c,n as l,o as u,r as d,t as f}from"./decorate-Dk3JVGAn.js";import{t as ne}from"./icon-C7QoHWvn.js";import{n as re,r as ie,t as ae}from"./i18n-CXvrc2gG.js";import{n as p,t as m}from"./styles-DphVJT09.js";import{a as h,o as oe}from"./iframe-BaP_gSrj.js";import{i as g,n as _,r as se,t as ce}from"./utilities-3bRBgS0D.js";function le(e){let t=-1;e.ontouchstart=e=>{e.targetTouches.length===1&&(t=e.targetTouches[0].clientY)},e.ontouchmove=n=>{if(n.targetTouches.length!==1)return;let r=n.targetTouches[0].clientY-t;return e.scrollTop===0&&r>0||he(e)&&r<0?b(n):(n.stopPropagation(),!0)}}function ue(e){e.ontouchstart=null,e.ontouchmove=null}function de(e){if(!e)throw Error(`Could not run setup, an element must be provided`);v.some(t=>t===e)||(v.length||(S(),ge()),le(e),v.push(e))}function fe(){v.forEach(ue),T(),me(),v=[]}var v,y,pe,b,x,S,C,me,he,w,ge,T,_e=e((()=>{v=[],y={documentElement:{},body:{}},pe=Object.freeze({documentElement:{"scrollbar-gutter":`stable`},body:{overflow:`hidden`,position:`relative`,height:`100%`}}),b=e=>{e.touches.length>1||e.preventDefault?.()},x=e=>([t,n])=>{y[e][t]=document[e].style[t],document[e].style[t]=n},S=()=>Object.entries(pe).forEach(([e,t])=>{Object.entries(t).forEach(x(e))}),C=e=>([t,n])=>{document[e].style[t]=y[e][t]},me=()=>Object.entries(y).forEach(([e,t])=>{Object.entries(t).forEach(C(e))}),he=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight,w=e=>()=>document[e?`addEventListener`:`removeEventListener`](`touchmove`,b,{passive:!1}),ge=w(!0),T=w()})),E,D,O=e((()=>{E=e=>class extends e{constructor(...e){super(...e),this.patchClose=!0,this._close=null}close(){this._close()}},D=e=>class extends e{handleSlotChange(e){let t=e.target.assignedNodes({flatten:!0});for(let e of t.filter(e=>e.patchClose))e._close=()=>this.close()}}})),k,ve=e((()=>{o(),d(),_e(),m(),O(),l(),k=class extends D(r){constructor(){super(),this.show=!1,this.ignoreBackdropClicks=!1,this._isClosing=!1,this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`command`,e=>{let t=e.command;t===`--show-modal`?this.open():(t===`--close`||t===`--confirm`)&&this.close()})}async open(){this._isClosing=!1,this.dialogEl.classList.remove(`close`),this.dialogEl.showModal(),this.handleListeners(),de(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent(`shown`,{bubbles:!0,composed:!0}))}close(){this.dialogEl?.open&&(this._isClosing=!0,this.handleListeners(`removeEventListener`),this.dialogEl.classList.add(`close`),this.dialogEl.addEventListener(`animationend`,async e=>{e.animationName===`w-modal-out`&&this._isClosing&&(this.dialogEl.classList.remove(`close`),this.dialogEl.close(),this._isClosing=!1,fe(),await this.updateComplete,this.dispatchEvent(new CustomEvent(`hidden`,{bubbles:!0,composed:!0})))},{once:!0}))}render(){return a`
    ...
    `}async willUpdate(e){if(e.has(`back`)){if(!this.titleEl)return;new P(this.titleEl).when(async()=>{await this.updateComplete})}}get titleClasses(){return[`header-title`,this.back?`header-title-with-back-button`:`header-title-without-back-button`,this._hasTopContent?`header-title-with-top-area`:``].join(` `)}get backButton(){return this.back&&!this._hasTopContent?a`<button
          ...
          @click="${this.emitBack}">
          <w-icon name="ArrowLeft" size="small" locale="${re()}" style="display: flex;" class="flex"></w-icon>
        ...
        <w-button
            ...
            small=""
            @click="${this.close}">
                <w-icon name="Close" size="small" locale="${re()}" style="display: flex;" class="flex"></w-icon>
        </w-button>
    </div>`}emitBack(){this.dispatchEvent(new CustomEvent(`backClicked`,{bubbles:!0,composed:!0}))}handleTopSlotChange(e){let t=e.target.assignedElements({flatten:!0});this._hasTopContent=!!t.length}static{this.styles=[p,n`
      .header {
        position: relative;
    ...
    `]}},f([u({type:String})],B.prototype,`title`,void 0),f([u({type:Boolean})],B.prototype,`back`,void 0),f([u({type:Boolean,attribute:`no-close`})],B.prototype,`noClose`,void 0),f([te()],B.prototype,`_hasTopContent`,void 0),f([c(`.title-el`)],B.prototype,`titleEl`,void 0),customElements.get(`w-modal-header`)||customElements.define(`w-modal-header`,B)})),V,Oe=e((()=>{o(),O(),m(),V=class extends E(D(r)){render(){return a`
      <div class="footer">
        <slot @slotchange="${this.handleSlotChange}"></slot>
      </div>
    `}static{this.styles=[p,n`
      .footer {
        display: flex;
        flex-shrink: 0;
    ...
    `]}},customElements.get(`w-modal-footer`)||customElements.define(`w-modal-footer`,V)})),ke=t({Default:()=>K,InvokerCommands:()=>q,Modal:()=>Y,ModalFooter:()=>Z,ModalHeader:()=>X,WithImage:()=>J,__namedExportsOrder:()=>Q,default:()=>G}),H,U,W,Ae,je,Me,Ne,Pe,Fe,G,K,q,J,Y,X,Z,Q,$=e((()=>{se(),oe(),o(),ce(),ve(),De(),Oe(),{events:H,args:U,argTypes:W}=h(`w-modal`),{events:Ae,args:je,argTypes:Me}=h(`w-modal-header`),{events:Ne,args:Pe,argTypes:Fe}=h(`w-modal-footer`),G={title:`Overlays/Modal`},K={args:{},render(){return a`
    ...
    `},parameters:{docs:{story:{autoplay:!0}}}},J={args:{},render(){return a`
    ...
    `},args:U,argTypes:W,parameters:{actions:{handles:H}}},X={render(e){return a`
      <p>
        This is here to document attributes. See the Default example for a
        complete usage example.
      </p>
      <w-modal-header ${g(_(e))}></w-modal-header>
    `},args:je,argTypes:Me,parameters:{actions:{handles:Ae}}},Z={render(e){return a`
      <p>
        This is here to document attributes. See the Default example for a
        complete usage example.
      </p>
      <w-modal-footer ${g(_(e))}></w-modal-footer>
    `},args:Pe,argTypes:Fe,parameters:{actions:{handles:Ne}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
  args: {},
  render() {
    return html\`
      <w-button id="modal-open-button-one" aria-haspopup="dialog">Open a modal</w-button>
...
}`,...Z.parameters?.docs?.source}}},Q=[`Default`,`InvokerCommands`,`WithImage`,`Modal`,`ModalHeader`,`ModalFooter`]}));$();export{K as Default,q as InvokerCommands,Y as Modal,Z as ModalFooter,X as ModalHeader,J as WithImage,Q as __namedExportsOrder,G as default,ke as n,$ as t};
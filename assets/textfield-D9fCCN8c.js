import{i as e}from"./preload-helper-CwA5MRLW.js";import{Bt as t,D as n,E as r,Ht as i,J as a,Kt as o,Lt as s,O as c,Rt as l,Wt as u,b as d,f,h as p,j as m,k as h,l as g,m as _,p as v,q as y,u as b,x}from"./iframe-DMjPUcM0.js";import{n as S,t as C}from"./form-control-EbCgjNJ6.js";import{r as w,t as T}from"./if-defined-BmC97mzt.js";var E,D=e((()=>{E=JSON.parse(`{"textfield.label.optional":["(valgfri)"]}`)})),O,k=e((()=>{O=JSON.parse(`{"textfield.label.optional":["(optional)"]}`)})),A,j=e((()=>{A=JSON.parse(`{"textfield.label.optional":["(valinnainen)"]}`)})),M,N=e((()=>{M=JSON.parse(`{"textfield.label.optional":["(valgfritt)"]}`)})),P,F=e((()=>{P=JSON.parse(`{"textfield.label.optional":["(valfritt)"]}`)})),I,L=e((()=>{s(),I=u`
	.w-textfield {

import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{_ as t,d as n,i as r,l as i,n as a,p as o,r as s,s as ee,t as c,u as l,x as u}from"./decorate-WA8yucmX.js";import{D as d,E as f,_ as te,d as ne,l as p,u as m,v as h,y as g}from"./iframe-DQOJ1xxY.js";import{r as re,t as ie}from"./if-defined-B6WcfsYE.js";function _(e){let t=-1;e.ontouchstart=e=>{e.targetTouches.length===1&&(t=e.targetTouches[0].clientY)},e.ontouchmove=n=>{if(n.targetTouches.length!==1)return;let r=n.targetTouches[0].clientY-t;return e.scrollTop===0&&r>0||E(e)&&r<0?x(n):(n.stopPropagation(),!0)}}function ae(e){e.ontouchstart=null,e.ontouchmove=null}function oe(e){if(!e)throw Error(`Could not run setup, an element must be provided`);v.some(t=>t===e)||(v.length||(C(),O()),_(e),v.push(e))}function se(){v.forEach(ae),k(),T(),v=[]}var v,y,b,x,S,C,w,T,E,D,O,k,A=e((()=>{v=[],y={documentElement:{},body:{}},b=Object.freeze({documentElement:{"scrollbar-gutter":`stable`},body:{overflow:`hidden`,position:`relative`,height:`100%`}}),x=e=>{e.touches.length>1||e.preventDefault?.()},S=e=>([t,n])=>{y[e][t]=document[e].style[t],document[e].style[t]=n},C=()=>Object.entries(b).forEach(([e,t])=>{Object.entries(t).forEach(S(e))}),w=e=>([t,n])=>{document[e].style[t]=y[e][t]},T=()=>Object.entries(y).forEach(([e,t])=>{Object.entries(t).forEach(w(e))}),E=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight,D=e=>()=>document[e?`addEventListener`:`removeEventListener`](`touchmove`,x,{passive:!1}),O=D(!0),k=D()})),j,ce=e((()=>{l(),j=u`
	:host {
		--_backdrop-bg: var(
...
`})),Z,he=e((()=>{W(),d(),l(),s(),ne(),g(),le(),ue(),de(),fe(),pe(),P(),p(),me(),a(),Z=class extends M(n){static{this.styles=[m,X]}constructor(){super(),this.back=!1,this.noClose=!1,this._hasTopContent=!1,te(K,J,q,G,Y)}async willUpdate(e){if(e.has(`back`)){if(!this.titleEl)return;new U(this.titleEl).when(async()=>{await this.updateComplete})}}emitBack(){this.dispatchEvent(new CustomEvent(`backClicked`,{bubbles:!0,composed:!0}))}handleTopSlotChange(e){let t=e.target.assignedElements({flatten:!0});this._hasTopContent=!!t.length}render(){let e=this.back&&!this._hasTopContent,n=!this.noClose;return t`
			...
			>
				...
				${e?t`<w-button
								...
								part="back"
								title=""
								aria-label="${f._({id:`modal.aria.back`,message:`Back`,comment:`Aria label for the back button in modal`})}"
								variant="pill"
								icon-only
								@click="${this.emitBack}"
							>
				...
				${n?t`<w-button
								...
								part="close"
								title=""
								aria-label="${f._({id:`modal.aria.close`,message:`Close`,comment:`Aria label for the close button in modal`})}"
								variant="pill"
								icon-only
								@click="${this.close}"
							>
...
`})),$,_e=e((()=>{l(),P(),p(),ge(),$=class extends M(N(n)){static{this.styles=[m,Q]}render(){return t`

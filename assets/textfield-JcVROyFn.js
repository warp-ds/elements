import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{C as t,_ as n,d as r,i,l as a,n as o,p as s,r as c,t as l,u,x as d}from"./decorate-WA8yucmX.js";import{n as f,t as p}from"./class-map-CrhALcV1.js";import{D as m,E as h,_ as g,g as _,h as v,l as y,u as b,y as x}from"./iframe-DQOJ1xxY.js";import{n as S,t as C}from"./form-control-BSFyWBnN.js";import{r as w,t as T}from"./if-defined-B6WcfsYE.js";var E,D=e((()=>{E=JSON.parse(`{"textfield.label.optional":["Valgfri"]}`)})),O,k=e((()=>{O=JSON.parse(`{"textfield.label.optional":["Optional"]}`)})),A,j=e((()=>{A=JSON.parse(`{"textfield.label.optional":["Valinnainen"]}`)})),M,N=e((()=>{M=JSON.parse(`{"textfield.label.optional":["Valgfri"]}`)})),P,F=e((()=>{P=JSON.parse(`{"textfield.label.optional":["Valfritt"]}`)})),I,L=e((()=>{u(),I=d`
	.w-textfield {
...
`})),U,W,G=e((()=>{v(),m(),C(),u(),c(),p(),T(),x(),y(),D(),k(),j(),N(),F(),L(),z(),H(),o(),U={base:`block text-m leading-m mb-0 px-8 py-12 rounded-4 w-full focusable focus:[--w-outline-offset:-2px] caret-current`,default:`border-1 s-text s-bg s-border-strong hover:s-border-strong-hover active:s-border-selected`,disabled:`border-1 s-text-disabled s-bg-disabled-subtle s-border-disabled pointer-events-none`,invalid:`border-1 s-text-negative s-bg s-border-negative hover:s-border-negative-hover outline-[--w-s-color-border-negative]!`,readOnly:`pl-0 bg-transparent pointer-events-none`,placeholder:`placeholder:s-text-placeholder`,suffix:`pr-40`,prefix:`pl-[var(--w-prefix-width,_40px)]`,textArea:`min-h-[42] sm:min-h-[45]`},W=class extends S(r){static{this.shadowRootOptions={...r.shadowRootOptions,delegatesFocus:!0}}constructor(){super(),this.disabled=!1,this.invalid=!1,this.optional=!1,this.readOnly=!1,this.readonly=!1,this.required=!1,this._hasPrefix=!1,this._hasSuffix=!1,this.#t=void 0,g(O,M,A,E,P)}#e(e){e.key===`Enter`&&this.internals.form&&this.internals.form.requestSubmit()}updated(e){e.has(`value`)&&this.value!==void 0&&(this.setValue(this.value),this.formatter&&this.mask&&(this.mask.innerText=this.formatter(this.value)))}#t;static{this.styles=[b,R,I,B,V]}firstUpdated(){this.#t=this.value}resetFormControl(){this.value=this.#t}get _inputstyles(){return _([U.base,this._hasSuffix&&U.suffix,this._hasPrefix&&U.prefix,!this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&U.default,this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&U.invalid,!this.invalid&&this.disabled&&!(this.readonly||this.readOnly)&&U.disabled,!this.invalid&&!this.disabled&&(this.readonly||this.readOnly)&&U.readOnly])}get _helptextstyles(){return`help-text`}get _label(){if(this.label){let e=this.label.length&&this.optional&&!this.required,t=!!this.tooltip;return n`
				<label for="${this._id}">
					${this.label}${e?n`
									<span>
										${h._({id:`textfield.label.optional`,message:`Optional`,comment:`Shown behind label when marked as optional`})}
									</span>
								`:s}
					${t?n`
									<button
			...
			>
				<div class="w-textfield__input-wrapper">
					${this.formatter?n`<div class="w-textfield__mask"></div>`:s}
					<input
						part="input"
		...
		`}},l([a({type:Boolean,reflect:!0})],W.prototype,`disabled`,void 0),l([a({type:Boolean,reflect:!0})],W.prototype,`invalid`,void 0),l([a({type:String,reflect:!0})],W.prototype,`label`,void 0),l([a({type:String,reflect:!0,attribute:`help-text`})],W.prototype,`helpText`,void 0),l([a({type:Boolean,reflect:!0})],W.prototype,`optional`,void 0),l([a({type:String,reflect:!0})],W.prototype,`size`,void 0),l([a({type:Number,reflect:!0})],W.prototype,`max`,void 0),l([a({type:Number,reflect:!0})],W.prototype,`min`,void 0),l([a({type:Number,reflect:!0,attribute:`min-length`})],W.prototype,`minLength`,void 0),l([a({type:Number,reflect:!0})],W.prototype,`minlength`,void 0),l([a({type:Number,reflect:!0,attribute:`max-length`})],W.prototype,`maxLength`,void 0),l([a({type:Number,reflect:!0})],W.prototype,`maxlength`,void 0),l([a({type:String,reflect:!0})],W.prototype,`pattern`,void 0),l([a({type:String,reflect:!0})],W.prototype,`placeholder`,void 0),l([a({type:Boolean,reflect:!0,attribute:`read-only`})],W.prototype,`readOnly`,void 0),l([a({type:Boolean,reflect:!0})],W.prototype,`readonly`,void 0),l([a({type:Boolean,reflect:!0})],W.prototype,`required`,void 0),l([a({type:String,reflect:!0})],W.prototype,`type`,void 0),l([a({type:String,reflect:!0})],W.prototype,`value`,void 0),l([a({type:String,reflect:!0})],W.prototype,`name`,void 0),l([a({type:Number,reflect:!0})],W.prototype,`step`,void 0),l([a({type:String,reflect:!0})],W.prototype,`autocomplete`,void 0),l([a({type:String,reflect:!0})],W.prototype,`tooltip`,void 0),l([a({attribute:!1})],W.prototype,`formatter`,void 0),l([i(`.w-textfield__mask`)],W.prototype,`mask`,void 0),l([a({type:Boolean})],W.prototype,`_hasPrefix`,void 0),l([a({type:Boolean})],W.prototype,`_hasSuffix`,void 0),customElements.get(`w-textfield`)||customElements.define(`w-textfield`,W)}));export{G as t};
import{x as i,r as E,a as S,i as k,f as w,s as j,u as A,p as q,E as M,n as d,l as z,g as B}from"./iframe-BJuG1XJ0.js";import{s as C,p as T}from"./utilities-DyyV9nTz.js";import{e as v}from"./query-NYTjQBeo.js";const L=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},O=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const n of o.filter(a=>a.patchClose))n._close=()=>this.close()}};let N=class extends L(O(k)){render(){return i`
      <div class="footer">
    ...
    `]}};customElements.get("w-modal-footer")||customElements.define("w-modal-footer",N);const W=(e,t)=>({dx:e.left-t.left,dy:e.top-t.top,dw:e.width/t.width,dh:e.height/t.height,first:e,last:t}),R=({dx:e,dy:t})=>[{transform:`translate(${e}px, ${t}px)`},{transform:"none"}],Y={easing:"ease",duration:300};let $=!1;const J=typeof window<"u";if(J){const e=window.matchMedia("(prefers-reduced-motion: reduce)"),t=({matches:o})=>$=o;e.addEventListener&&e.addEventListener("change",t),t(e)}class K{first;last;el;constructor(t,{animation:o={},keyframes:n,respectReduceMotion:a=!0}={}){this.el=t,this.first={},this.last={},this.userAnimationOptions=o,this.keyframeGenerator=n||R,this.shouldReduceMotion=a}async when(t){this.prep();const o=await t();return await this.play(),o}prep(){this.first=this.el.getBoundingClientRect()}async play(){if(this.last=this.el.getBoundingClientRect(),!this.el.animate)return;await this.el.animate(this.keyframes,this.animationOptions).finished}get keyframes(){return this.keyframeGenerator(W(this.first,this.last))}get defaults(){return Y}get mergedOptions(){return{...this.defaults,...this.userAnimationOptions}}get animationOptions(){return this.shouldReduceMotion?$?{...this.mergedOptions,duration:0}:this.mergedOptions:this.mergedOptions}}var G={},U=JSON.parse('{"icon.title.arrow-left":["Pil som peker mot venstre"]}'),Q=JSON.parse('{"icon.title.arrow-left":["Leftward-pointing arrow"]}'),V=JSON.parse('{"icon.title.arrow-left":["Vasemmalle osoittava nuoli"]}'),X=JSON.parse('{"icon.title.arrow-left":["Pil til venstre"]}'),Z=JSON.parse('{"icon.title.arrow-left":["Pil som pekar vänster"]}'),D=["en","nb","fi","da","sv"],_="en",ee=()=>{var e;let t;switch((e=process==null?void 0:G)==null?void 0:e.NMP_BRAND){case"FINN":t="nb";break;case"TORI":t="fi";break;case"BLOCKET":t="sv";break;case"DBA":t="da";break;default:t="en"}return t},H=()=>{var e;const t=(e=document?.location)==null?void 0:e.hostname;return t?.includes("finn")?"nb":t.includes("tori")?"fi":t.includes("blocket")?"sv":t.includes("dba")?"da":_},x=e=>D.find(t=>e===t||e.toLowerCase().includes(t))||H();function te(){var e;if(typeof window>"u"){const t=ee();return x(t)}try{const t=(e=document?.documentElement)==null?void 0:e.lang,o=H();return D.includes(t)?x(t??o):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),x(o))}catch(t){return console.warn("could not detect locale, falling back to source locale",t),_}}var oe=(e,t,o,n,a,r)=>e==="nb"?o:e==="fi"?n:e==="da"?a:e==="sv"?r:t,ae=(e,t,o,n,a)=>{const r=te(),s=oe(r,e,t,o,n,a);w.load(r,s),w.activate(r)};ae(Q,U,V,X,Z);var ne=class extends k{render(){const e=w.t({message:"Leftward-pointing arrow",id:"icon.title.arrow-left",comment:"Title for table arrow left icon"});return A`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-arrow-left-16-part">${j(`<title>${e}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="M5.222 8h6.667"></path><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.444 11.75 4.111 8l3.333-3.75"></path></svg>`}};customElements.get("w-icon-arrow-left-16")||customElements.define("w-icon-arrow-left-16",ne);const re=JSON.parse('{"modal.aria.back":["Tilbage"],"modal.aria.close":["Luk"]}'),se=JSON.parse('{"modal.aria.back":["Back"],"modal.aria.close":["Close"]}'),ie=JSON.parse('{"modal.aria.back":["Takaisin"],"modal.aria.close":["Sulje"]}'),le=JSON.parse('{"modal.aria.back":["Tilbake"],"modal.aria.close":["Lukk"]}'),de=JSON.parse('{"modal.aria.back":["Tillbaka"],"modal.aria.close":["Stäng"]}');var ce=Object.defineProperty,y=(e,t,o,n)=>{for(var a=void 0,r=e.length-1,s;r>=0;r--)(s=e[r])&&(a=s(t,o,a)||a);return a&&ce(t,o,a),a};let c=class extends L(k){constructor(){super(),this._hasTopContent=!1,q(se,le,ie,re,de)}render(){return i`
      <div class="header">

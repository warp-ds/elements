import{i as x,b,x as i,g as f}from"./iframe-BcvgjLuZ.js";import{s as p,p as c}from"./utilities-Bz95FPVz.js";import"./expand-transition-DUx9vEn0.js";class h extends x{static properties={level:{type:Number}};get _markup(){return`<h${this.level}
    style="margin: 0; font-weight: unset; font-size: unset; line-height: unset;"
  >
    <slot></slot>
  </h${this.level}>
`}render(){return this.level?b(this._markup):i`<slot></slot>`}}customElements.get("w-unstyled-heading")||customElements.define("w-unstyled-heading",h);var u=Object.freeze,g=Object.defineProperty,v=(e,S)=>u(g(e,"raw",{value:u(e.slice())})),m;const{events:w,args:y,argTypes:T}=f("w-expandable"),I={title:"Layout/Expandable",render(e){return i`
      <w-expandable ${p(c(e))}>
        <p>This is the expandable content that can be shown or hidden.</p>
        <p>It can contain multiple paragraphs and other elements.</p>
      </w-expandable>
    `},args:y,argTypes:T,parameters:{actions:{handles:w}}},a={args:{title:"I'm expandable",expanded:!1,box:!1,bleed:!1,animated:!1,"no-chevron":!1}},t={args:{title:"I'm expanded by default",expanded:!0,box:!1,bleed:!1,animated:!1,"no-chevron":!1}},n={args:{title:"I'm a box expandable",expanded:!1,box:!0,bleed:!1,animated:!1,"no-chevron":!1}},r={args:{title:"I'm animated",expanded:!1,box:!0,bleed:!1,animated:!0,"no-chevron":!1}},s={args:{title:"I'm wrapped in h2",expanded:!1,box:!0,bleed:!1,animated:!1,"no-chevron":!1,"heading-level":2}},l={args:{title:"I have no chevron",expanded:!1,box:!1,bleed:!1,animated:!1,"no-chevron":!0}},o={args:{expanded:!1,box:!0,bleed:!1,animated:!1,"no-chevron":!1},render(e){return i`
      <w-expandable ${p(c(e))}>
    ...
    `}},d={args:{expanded:!0,box:!0,animated:!0},render(e){return i(m||(m=v([`
...
}`,...d.parameters?.docs?.source}}};const _=["Default","Expanded","Box","Animated","WithHeading","NoChevron","CustomTitle","NoTitle"],C=Object.freeze(Object.defineProperty({__proto__:null,Animated:r,Box:n,CustomTitle:o,Default:a,Expanded:t,NoChevron:l,NoTitle:d,WithHeading:s,__namedExportsOrder:_,default:I},Symbol.toStringTag,{value:"Module"}));export{r as A,n as B,o as C,a as D,C as E,d as N,s as W,t as a,l as b};

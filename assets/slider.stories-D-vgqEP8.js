import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{n,t as r}from"./preload-helper-DAo5hWOf.js";import{C as i,_ as a,d as o,i as s,l as c,n as l,p as u,r as d,s as f,t as p,u as m,x as h}from"./decorate-WA8yucmX.js";import{n as ee,t as te}from"./class-map-CrhALcV1.js";import{D as g,E as _,T as ne,_ as re,b as ie,l as v,u as y,x as ae,y as oe}from"./iframe-AHAhJTMM.js";import{n as se,t as ce}from"./form-control-BSFyWBnN.js";import{t as le}from"./affix-DJicVkzW.js";import{r as b,t as ue}from"./if-defined-B6WcfsYE.js";import{t as de}from"./attention-BfZmhHOL.js";import{n as fe,t as x}from"./taggedTemplateLiteral-C9cDEsPD.js";import{t as pe}from"./textfield-DXHNoArd.js";var S,me=e((()=>{S=JSON.parse(`{"select.label.optional":["Valgfri"],"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),C,he=e((()=>{C=JSON.parse(`{"select.label.optional":["Optional"],"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),w,ge=e((()=>{w=JSON.parse(`{"select.label.optional":["Valinnainen"],"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),T,_e=e((()=>{T=JSON.parse(`{"select.label.optional":["Valgfri"],"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),E,ve=e((()=>{E=JSON.parse(`{"select.label.optional":["Valfritt"],"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),D,ye=e((()=>{m(),D=h`
	.w-slider {
		position: relative;
		border: none;
		padding: 0;
...
`})),O,be=e((()=>{m(),d(),g(),oe(),v(),me(),he(),ge(),_e(),ve(),ye(),l(),O=class extends o{static{this.shadowRootOptions={...o.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[y,D,h`
			:host {
		...
		`]}constructor(){super(),this.disabled=!1,this.openEnded=!1,this.invalid=!1,this.required=!1,this.optional=!1,this.hiddenTextfield=!1,this._invalidMessage=``,this._hasInternalError=!1,this._showError=!1,this._tabbableElements=[],this._hasLabel=!1,re(C,T,w,S,E)}#e(){let e=this.querySelectorAll(`w-slider-thumb`),t=!1;for(let n of e.values())n.min=this.edgeMin,n.max=this.edgeMax,n.step=this.step,n.suffix=this.suffix??``,n.required=this.required,n.labelFormatter=this.labelFormatter,n.valueFormatter=this.valueFormatter,n.tooltipFormatter=this.tooltipFormatter,n.openEnded=this.openEnded,n._hiddenTextfield=this.hiddenTextfield,n.ariaLabel||(n.slot||(n.ariaLabel=this.label||null),n.slot===`from`&&(n.ariaLabel=`${this.label} min`),n.slot===`to`&&(n.ariaLabel=`${this.label} max`)),(n.slot===`from`||n.slot===`to`)&&(t=!0),n.disabled=this.disabled,n.invalid=!!this.errorText,this.#c(n);t?(this.fieldset.style.setProperty(`--active-range-inline-start-padding`,`var(--w-slider-thumb-size, 28px)`),this.fieldset.style.setProperty(`--active-range-inline-end-padding`,`var(--w-slider-thumb-size, 28px)`)):this.fieldset.style.setProperty(`--active-range-border-radius`,`4px`)}get edgeMin(){return this.openEnded?(Number(this.min)-1).toString():this.min}get edgeMax(){return this.openEnded?(Number(this.max)+1).toString():this.max}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.step&&this.fieldset.style.setProperty(`--step`,String(this.step)),this.min!==void 0&&this.fieldset.style.setProperty(`--min`,this.edgeMin),this.max!==void 0&&this.fieldset.style.setProperty(`--max`,this.max),this.markers&&this.fieldset.style.setProperty(`--markers`,String(this.markers)),this.openEnded&&this.fieldset.style.setProperty(`--over-under-offset`,`1`),this.label&&(this._hasLabel=!0);let e=this.querySelectorAll(`w-slider-thumb`);if(e.length===2){this.fieldset.style.setProperty(`--range-slider-magic-pixel`,`1px`);let t=[...e];this._tabbableElements[0]=t[0].shadowRoot.querySelector(`input`),this._tabbableElements[1]=t[1].shadowRoot.querySelector(`input`),this._tabbableElements[2]=t[0].shadowRoot.querySelector(`w-textfield`),this._tabbableElements[3]=t[1].shadowRoot.querySelector(`w-textfield`)}else if(e.length===1){let t=[...e];this._tabbableElements[0]=t[0].shadowRoot.querySelector(`input`),this._tabbableElements[1]=t[0].shadowRoot.querySelector(`w-textfield`)}this.invalid&&this.error&&(this._showError=!0),this.#e()}updated(e){(e.has(`disabled`)||e.has(`required`)||e.has(`min`)||e.has(`step`)||e.has(`max`)||e.has(`suffix`)||e.has(`labelFormatter`)||e.has(`valueFormatter`)||e.has(`_invalidMessage`)||e.has(`_hasInternalError`))&&this.#e(),(e.has(`error`)||e.has(`invalid`))&&(this.error&&this.invalid?this._showError=!0:this._showError=!1,this.#e())}#t(e){e.stopPropagation();let t=e.target;this.#c(t)}#n(e){let t=e.target;this.#c(t),t.slot&&this.#a()}#r(){this.componentHasError?this._showError=!0:this._showError=!1,this.#e()}#i(e){if(e.key===`Tab`){let t=this._tabbableElements.indexOf(e.target.shadowRoot.activeElement);if(t===-1)return;let n=e.shiftKey?-1:1,r=this._tabbableElements[t+n];if(!r)return;e.preventDefault(),r.focus()}}#a(){let e=null,t=null,n=this.querySelectorAll(`w-slider-thumb`);for(let r of n.values())r.slot===`from`&&(e=r),r.slot===`to`&&(t=r);!e||!t||!e.invalid&&t.invalid}#o(e){e.stopPropagation();let t=this._hasInternalError||this.invalid,n=e.target;if(this._hasInternalError=!!e.detail.invalid||this.invalid,this._invalidMessage=e.detail.invalid,t===!0&&this._hasInternalError===!1){let e=this.querySelectorAll(`w-slider-thumb`);for(let t of e.values())t!==n&&t.updateFieldAfterValidation()}}#s(e,t){return t.value??=this.openEnded?``:e,t.value===``?e:t.value}#c(e){let t=e.slot;t||this.fieldset.style.setProperty(`--from`,`0`),t===`from`&&this.fieldset.style.setProperty(`--from`,this.#s(this.edgeMin,e)),(!t||t===`to`)&&this.fieldset.style.setProperty(`--to`,this.#s(this.edgeMax,e))}get componentHasError(){return this.invalid||this._hasInternalError}get errorText(){return this._showError?this.error||this._invalidMessage:``}_handleLabelSlotChange(e){let t=e.target.assignedElements().length>0;this._hasLabel=t||!!this.label,console.log(`Label content changed, has label:`,this._hasLabel)}get _label(){let e=this._hasLabel&&this.optional&&!this.required?a`<span class="w-slider__optional"
			...
			<fieldset
				...
				@thumbreset="${this.#t}"
				@keydown="${this.#i}"
				aria-invalid="${this.errorText?`true`:u}"
				?disabled="${this.disabled}"
			>
				${this._label}
				<slot class="w-slider__description" name="description"></slot>
				${this.markers?a`<div class="w-slider__markers"></div>`:u}
		...
		`}},p([c({reflect:!0})],O.prototype,`label`,void 0),p([c({type:Boolean,reflect:!0})],O.prototype,`disabled`,void 0),p([c({type:Boolean,attribute:`open-ended`})],O.prototype,`openEnded`,void 0),p([c({type:String,reflect:!0})],O.prototype,`error`,void 0),p([c({type:String,reflect:!0,attribute:`help-text`})],O.prototype,`helpText`,void 0),p([c({type:Boolean,reflect:!0})],O.prototype,`invalid`,void 0),p([c({type:Boolean,reflect:!0})],O.prototype,`required`,void 0),p([c({type:Boolean,reflect:!0})],O.prototype,`optional`,void 0),p([c({reflect:!0})],O.prototype,`min`,void 0),p([c({reflect:!0})],O.prototype,`max`,void 0),p([c({type:Number,reflect:!0})],O.prototype,`markers`,void 0),p([c({type:Number,reflect:!0})],O.prototype,`step`,void 0),p([c({reflect:!0})],O.prototype,`suffix`,void 0),p([c({type:Boolean,reflect:!0,attribute:`hidden-textfield`})],O.prototype,`hiddenTextfield`,void 0),p([c({attribute:!1})],O.prototype,`valueFormatter`,void 0),p([c({attribute:!1})],O.prototype,`tooltipFormatter`,void 0),p([c({attribute:!1})],O.prototype,`labelFormatter`,void 0),p([s(`fieldset`)],O.prototype,`fieldset`,void 0),p([f()],O.prototype,`_invalidMessage`,void 0),p([f()],O.prototype,`_hasInternalError`,void 0),p([f()],O.prototype,`_showError`,void 0),p([f()],O.prototype,`_tabbableElements`,void 0),p([f()],O.prototype,`_hasLabel`,void 0),customElements.get(`w-slider`)||customElements.define(`w-slider`,O)})),k,xe=e((()=>{m(),k=i(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`)})),Se,Ce=e((()=>{m(),Se=h`
	.w-slider-thumb {
		position: relative;
		display: grid;
...
`})),we,Te,A,Ee=e((()=>{g(),ce(),m(),d(),te(),ue(),xe(),v(),Ce(),l(),n(),we=/WebKit/,Te=/Chrome/,A=class extends se(o){constructor(...e){super(...e),this.ariaLabel=null,this.ariaDescription=null,this.disabled=!1,this.invalid=!1,this.openEnded=!1,this.required=!1,this.suffix=``,this._showTooltip=!1,this._inputHasFocus=!1,this._hiddenTextfield=!1,this.#e=void 0,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...o.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[y,k,Se]}#e;resetFormControl(){this.value=this.#e,this.dispatchEvent(new CustomEvent(`thumbreset`,{bubbles:!0}))}#t(){this._showTooltip=!0,this.shadowRoot.querySelector(`w-attention`).handleDone()}#n(){this._showTooltip=!1}#r(){this.range&&(this.value===``?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#i(e){this.dispatchEvent(new CustomEvent(`slidervalidity`,{bubbles:!0,detail:{invalid:e,slot:this.slot}}))}async updateFieldAfterValidation(){let e=this.shadowRoot.querySelector(`w-textfield`);await this.#a(e.value??``,!0)}async#a(e,t){let n=this.suffix??``,r=Number.parseInt(e);if(this.openEnded&&!t&&this.step&&!(this.slot===`to`&&r>=Number(this.max)-1||this.slot===`from`&&r<=Number(this.min)+1)){let t=1/this.step;r=Math.round(r*t)/t,e=r.toString()}let i=Number.parseInt(this.max),a=Number.parseInt(this.min);if(!this.openEnded&&(r>i||r<a))return this.#i(_.t({id:`slider.error.out_of_bounds`,message:`Value must be between {min} and {max}`,values:{min:`${this.min} ${n}`.trim(),max:`${this.max} ${n}`.trim()}})),{shouldCancel:!0};e===``&&this.required&&this.#i(_.t({id:`slider.error.required`,message:`This field is required`})),this.value=e;let o=e===this.max||e===this.min,s=!1;if(this.slot){let n=this.parentElement.querySelector(`w-slider-thumb[slot="to"]`),c=this.parentElement.querySelector(`w-slider-thumb[slot="from"]`),l=n.textfield.value||this.max,u=c.textfield.value||this.min,d=Number.parseInt(l),f=Number.parseInt(u),p=_.t({id:`slider.error.overlap`,message:`The maximum value cannot be less than the minimum`});if(this.slot===`from`){let n=this.openEnded&&d>i?d:Math.min(d,this.openEnded?i-1:i);r>n&&(s=!0,this.openEnded&&o?this.value=String(n):this.value=l,t&&(this.#i(p),await this.updateComplete,this.textfield.value=e))}else{let n=this.openEnded&&f<a?f:Math.max(Number.parseInt(u),this.openEnded?a+1:a);r<n&&(s=!0,this.openEnded&&o?this.value=String(n):this.value=u,t&&(this.#i(p),await this.updateComplete,this.textfield.value=e))}}return s?{shouldCancel:!0}:(this.#i(``),this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.openEnded&&!t&&o?``:e,this.shadowRoot.querySelector(`w-attention`).handleDone(),{shouldCancel:!1})}async#o(e){let t=e.currentTarget.tagName===`W-TEXTFIELD`;if(e instanceof CustomEvent)return!1;let n=e.currentTarget.value;return(await this.#a(n,t)).shouldCancel?(e.preventDefault(),!1):!0}async#s(e){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}if(!this.openEnded||e.key!==`ArrowLeft`&&e.key!==`ArrowRight`)return;let t=Number(this.range.value),n=this.step||1,r;r=e.key===`ArrowLeft`?t-n:t+n,r=Math.min(Math.max(r,Number(this.min)),Number(this.max)),(await this.#a(r.toString(),!1)).shouldCancel&&e.preventDefault()}async#c(e){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}if(this.textfield.value)return;let t=``;this.slot===`from`?e.key===`ArrowUp`?t=String(Number(this.min)+1)||`1`:e.key===`ArrowDown`&&(t=String(Number(this.min))||`0`):e.key===`ArrowUp`?t=String(Number(this.max))||`100`:e.key===`ArrowDown`&&(t=String(Number(this.max)-1)||`99`),t&&(e.preventDefault(),await this.#a(t,!0))}async connectedCallback(){if(super.connectedCallback(),this.#e=this.value,this.setValue(this.value),this.slot&&!this.ariaDescription&&(this.slot===`from`?this.ariaDescription=_.t({id:`slider.label.from`,comment:`Accessible label for the 'from value' input field in a range slider`,message:`From`}):this.slot===`to`&&(this.ariaDescription=_.t({id:`slider.label.to`,comment:`Accessible label for the 'to value' input field in a range slider`,message:`To`}))),`anchorName`in document.documentElement.style)await this.updateComplete;else{let e=import.meta.url.substring(0,import.meta.url.lastIndexOf(`/`));try{let[{default:t}]=await Promise.all([r(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[]),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement(`style`),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
      ...
      `,await t({roots:[this.shadowRoot],elements:[this.anchorPositioningStyleElement]})}catch(e){console.error(Error(`Error registering the CSS anchor positioning polyfill. The UI will look broken.`,{cause:e}))}}let e=window.navigator.userAgent;we.test(e)&&!Te.test(e)&&this.tooltipTarget&&this.tooltipTarget.style.setProperty(`--transform-offset`,`var(--w-slider-thumb-size, 28px)`),this.#r()}get boundaryValue(){return this.slot===`from`?this.min:this.max}get textFieldDisplayValue(){return this._inputHasFocus&&this.value===``?this.range?.value?Math.min(Math.max(Number(this.range.value),Number(this.min)+1),Number(this.max)-1).toString():``:this.value}get tooltipDisplayValue(){let e;return e=this.tooltipFormatter?this.tooltipFormatter(this.value,this.slot):this.valueFormatter?this.valueFormatter(this.value,this.slot):this.value===``?this.range?.value??this.boundaryValue:this.value||0,e}get ariaDescriptionText(){let e=``,t=this.ariaDescription||``,n=this.value===``;return this.openEnded&&n&&(e=this.slot===`from`?_.t({id:`slider.placeholder.from`,message:`Min`}):_.t({id:`slider.placeholder.to`,message:`Max`})),e?`${e}, ${t}`:t}updated(e){if(e.has(`openEnded`)&&this.openEnded&&!this.placeholder&&(this.slot===`to`||this.slot===``?this.placeholder=_.t({id:`slider.placeholder.to`,message:`Max`,comment:`Max as in short for Maximum`}):this.slot===`from`&&(this.placeholder=_.t({id:`slider.placeholder.from`,message:`Min`,comment:`Min as in short for Minimum`}))),e.has(`value`)){this.#e===void 0&&this.value!==void 0&&(this.#e=this.value),this.setValue(this.value),this.#r();let t=e.get(`value`);this.value===``&&t&&this.dispatchEvent(new CustomEvent(`thumbreset`,{bubbles:!0}))}}render(){let e=this.placeholder&&!this.value;return a`
			<div class="w-slider-thumb">
				...
				${this.slot===`from`||!this.slot?a` <span class="sr-only">
				...
				<w-textfield
					aria-label="${this.ariaLabel}"
					aria-description="${b(this.ariaDescriptionText)}"
					class="${ee({"w-slider-thumb__textfield":!0,"sr-only":this._hiddenTextfield})}"
					type="number"
					tabindex="${this._hiddenTextfield?-1:u}"
					placeholder="${this.placeholder}"
					.value="${this.textFieldDisplayValue}"
					.formatter=${this.valueFormatter&&!e?e=>this.valueFormatter(e,this.slot):u}
					min="${this.openEnded?u:this.min}"
					max="${this.openEnded?u:this.max}"
					step="${b(this.step)}"
				...
				>
					...
					></output>
					<span slot="message">
						${this.tooltipDisplayValue}${this.suffix??``?a`&nbsp;${this.suffix??``}`:u}
					</span>
				</w-attention>
		...
		`}},p([c({attribute:`aria-label`})],A.prototype,`ariaLabel`,void 0),p([c({attribute:`aria-description`})],A.prototype,`ariaDescription`,void 0),p([c({reflect:!0})],A.prototype,`name`,void 0),p([c({reflect:!0})],A.prototype,`value`,void 0),p([c({type:Boolean,reflect:!0})],A.prototype,`disabled`,void 0),p([c({type:Boolean,reflect:!0})],A.prototype,`invalid`,void 0),p([c({attribute:!1,reflect:!1})],A.prototype,`openEnded`,void 0),p([c({reflect:!0})],A.prototype,`placeholder`,void 0),p([f()],A.prototype,`markers`,void 0),p([f()],A.prototype,`required`,void 0),p([f()],A.prototype,`step`,void 0),p([f()],A.prototype,`min`,void 0),p([f()],A.prototype,`max`,void 0),p([f()],A.prototype,`suffix`,void 0),p([c({attribute:!1})],A.prototype,`valueFormatter`,void 0),p([c({attribute:!1})],A.prototype,`tooltipFormatter`,void 0),p([c({attribute:!1})],A.prototype,`labelFormatter`,void 0),p([s(`input[type="range"]`)],A.prototype,`range`,void 0),p([s(`.w-slider-thumb__tooltip-target`)],A.prototype,`tooltipTarget`,void 0),p([s(`w-textfield`)],A.prototype,`textfield`,void 0),p([f()],A.prototype,`_showTooltip`,void 0),p([f()],A.prototype,`_inputHasFocus`,void 0),p([f()],A.prototype,`_hiddenTextfield`,void 0),customElements.get(`w-slider-thumb`)||customElements.define(`w-slider-thumb`,A)})),De=t({CustomError:()=>J,Description:()=>Y,HiddenMinimumMaximumLabels:()=>Z,Marks:()=>U,OpenEnded:()=>G,Range:()=>R,RangeError:()=>q,RangeOptional:()=>z,Single:()=>F,SingleDisabled:()=>I,SingleError:()=>K,SingleOptional:()=>L,Step:()=>W,SuffixCurrency:()=>V,SuffixKilometers:()=>H,SuffixSquareMeters:()=>B,VisuallyHiddenLabel:()=>X,VisuallyHiddenTextfield:()=>Q,__namedExportsOrder:()=>$,default:()=>P}),Oe,ke,Ae,je,Me,Ne,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,Pe=e((()=>{ae(),m(),ne(),le(),de(),pe(),be(),Ee(),fe(),{events:j,args:M,argTypes:N}=ie(`w-slider`),P={title:`Forms/Slider and Range Slider`,args:M,argTypes:N,parameters:{actions:{handles:j}}},F={render(){return a`
            <form>
        ...
        `}},B={args:{locale:`nb`,suffix:`m²`},render({suffix:e}){return a`
            <w-slider
        ...
        `}},V={args:{locale:`nb`,suffix:`kr`},render({locale:e,suffix:t}){return a(Oe||=x([`
            <w-slider
                label="Price"
                min="0"
                max="250000"
            ...
            <\/script>
        `]),t,e)}},H={args:{locale:`nb`,suffix:`km`},render({locale:e,suffix:t}){return a(ke||=x([`
            <w-slider
                label="Distance"
                min="0"
                max="250000"
            ...
            <\/script>
        `]),t,e)}},U={args:{locale:`nb`,step:`5`,markers:`5`},render({markers:e,step:t}){return a`
            <w-slider
                label="Single"
                min="0"
                max="100"
        ...
        `}},W={args:{step:5},render({step:e}){return a`
            <w-slider label="Single" step="${e}" min="0" max="100">
                <w-slider-thumb name="value"></w-slider-thumb>
            </w-slider>
        `}},G={args:{},render(){return a(Ae||=x([`
        ...
        `}},q={args:{},render(){return a(je||=x([`
            ...
            <\/script>
        `]))}},J={args:{error:`I'm an external error telling you something is wrong`,invalid:!0},render(e){return a`
            <w-slider
                label="Model year"
                min="1950"
                max="2025"
        ...
        `}},Z={render(){return a(Me||=x([`
            ...
            <\/script>
        `]))}},Q={render({locale:e}){return a(Ne||=x([`

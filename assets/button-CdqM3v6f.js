import{a as u,q as b,l as h,r as g,i as d,A as p,b as i,n as o}from"./iframe-BnqHVJYW.js";import"./link-DPBGzURn.js";import{o as w}from"./if-defined-B9eqgckP.js";import{F as k}from"./FormControlMixin-DJnJZbro.js";const x=JSON.parse('{"button.aria.loading":["Indlæser..."]}'),f=JSON.parse('{"button.aria.loading":["Loading..."]}'),y=JSON.parse('{"button.aria.loading":["Ladataan..."]}'),m=JSON.parse('{"button.aria.loading":["Laster..."]}'),_=JSON.parse('{"button.aria.loading":["Laddar ..."]}'),$=u`
  :host {

    ...
    `}},L={args:{},render(){return r`
      <div style="display:grid; gap: 16px;">
        ...
        <div style="display:flex; flex-wrap: wrap; gap: 12px;">
          ${[`primary`,`secondary`,`negative`,`negativeQuiet`,`utility`,`utilityQuiet`,`quiet`,`link`,`overlay`,`overlayInverted`,`overlayQuiet`,`overlayInvertedQuiet`,`pill`].map(e=>r`<w-button variant=${e} loading type="button">${e}</w-button>`)}
        </div>
      </div>

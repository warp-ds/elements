import{a as e,i as t}from"./preload-helper-CwA5MRLW.js";import{A as n,Bt as r,C as i,Ht as a,J as o,Lt as s,M as c,N as ee,Rt as l,Wt as u,_ as d,c as te,j as ne,k as re,l as f,o as p,q as ie,s as m,u as ae,v as h,x as oe}from"./iframe-WxSccmAS.js";import{a as g,n as _,r as se,t as ce}from"./utilities-DE7KJPkf.js";function le(e){let t=-1;e.ontouchstart=e=>{e.targetTouches.length===1&&(t=e.targetTouches[0].clientY)},e.ontouchmove=n=>{if(n.targetTouches.length!==1)return;let r=n.targetTouches[0].clientY-t;return e.scrollTop===0&&r>0||C(e)&&r<0?b(n):(n.stopPropagation(),!0)}}function ue(e){e.ontouchstart=null,e.ontouchmove=null}function de(e){if(!e)throw Error(`Could not run setup, an element must be provided`);v.some(t=>t===e)||(v.length||(he(),T()),le(e),v.push(e))}function fe(){v.forEach(ue),E(),S(),v=[]}var v,y,pe,b,me,he,x,S,C,w,T,E,ge=t((()=>{v=[],y={documentElement:{},body:{}},pe=Object.freeze({documentElement:{"scrollbar-gutter":`stable`},body:{overflow:`hidden`,position:`relative`,height:`100%`}}),b=e=>{e.touches.length>1||e.preventDefault?.()},me=e=>([t,n])=>{y[e][t]=document[e].style[t],document[e].style[t]=n},he=()=>Object.entries(pe).forEach(([e,t])=>{Object.entries(t).forEach(me(e))}),x=e=>([t,n])=>{document[e].style[t]=y[e][t]},S=()=>Object.entries(y).forEach(([e,t])=>{Object.entries(t).forEach(x(e))}),C=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight,w=e=>()=>document[e?`addEventListener`:`removeEventListener`](`touchmove`,b,{passive:!1}),T=w(!0),E=w()})),D,O,k=t((()=>{D=e=>class extends e{constructor(...e){super(...e),this.patchClose=!0,this._close=null}close(){this._close()}},O=e=>class extends e{handleSlotChange(e){let t=e.target.assignedNodes({flatten:!0});for(let e of t.filter(e=>e.patchClose))e._close=()=>this.close()}}})),A,_e=t((()=>{s(),d(),ge(),p(),k(),ae(),A=class extends O(l){constructor(){super(),this.show=!1,this.ignoreBackdropClicks=!1,this._isClosing=!1,this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`command`,e=>{let t=e.command;t===`--show-modal`?this.open():(t===`--close`||t===`--confirm`)&&this.close()})}async open(){this._isClosing=!1,this.dialogEl.classList.remove(`close`),this.dialogEl.showModal(),this.handleListeners(),de(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent(`shown`,{bubbles:!0,composed:!0}))}close(){this.dialogEl?.open&&(this._isClosing=!0,this.handleListeners(`removeEventListener`),this.dialogEl.classList.add(`close`),this.dialogEl.addEventListener(`animationend`,async e=>{e.animationName===`w-modal-out`&&this._isClosing&&(this.dialogEl.classList.remove(`close`),this.dialogEl.close(),this._isClosing=!1,fe(),await this.updateComplete,this.dispatchEvent(new CustomEvent(`hidden`,{bubbles:!0,composed:!0})))},{once:!0}))}render(){return a`
    ...
    `]}},f([i({type:Boolean})],A.prototype,`show`,void 0),f([i({type:String,attribute:`content-id`})],A.prototype,`contentId`,void 0),f([i({type:Boolean,attribute:`ignore-backdrop-clicks`})],A.prototype,`ignoreBackdropClicks`,void 0),f([h(`.dialog-el`)],A.prototype,`dialogEl`,void 0),f([h(`.dialog-inner-el`)],A.prototype,`dialogInnerEl`,void 0),f([h(`.content-el`)],A.prototype,`contentEl`,void 0),customElements.get(`w-modal`)||customElements.define(`w-modal`,A)})),j,M,N,ve=t((()=>{j=(e,t)=>({dx:e.left-t.left,dy:e.top-t.top,dw:e.width/t.width,dh:e.height/t.height,first:e,last:t}),M=({dx:e,dy:t})=>[{transform:`translate(${e}px, ${t}px)`},{transform:`none`}],N={easing:`ease`,duration:300}})),P,ye=t((()=>{if(P=!1,typeof window<`u`){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`),t=({matches:e})=>P=e;e.addEventListener&&e.addEventListener(`change`,t),t(e)}})),F,be=t((()=>{ve(),ye(),F=class{first;last;el;constructor(e,{animation:t={},keyframes:n,respectReduceMotion:r=!0}={}){this.el=e,this.first={},this.last={},this.userAnimationOptions=t,this.keyframeGenerator=n||M,this.shouldReduceMotion=r}async when(e){this.prep();let t=await e();return await this.play(),t}prep(){this.first=this.el.getBoundingClientRect()}async play(){this.last=this.el.getBoundingClientRect(),this.el.animate&&await this.el.animate(this.keyframes,this.animationOptions).finished}get keyframes(){return this.keyframeGenerator(j(this.first,this.last))}get defaults(){return N}get mergedOptions(){return{...this.defaults,...this.userAnimationOptions}}get animationOptions(){return!this.shouldReduceMotion||!P?this.mergedOptions:{...this.mergedOptions,duration:0}}}})),I,xe=t((()=>{I=JSON.parse(`{"modal.aria.back":["Tilbage"],"modal.aria.close":["Luk"]}`)})),L,Se=t((()=>{L=JSON.parse(`{"modal.aria.back":["Back"],"modal.aria.close":["Close"]}`)})),R,Ce=t((()=>{R=JSON.parse(`{"modal.aria.back":["Takaisin"],"modal.aria.close":["Sulje"]}`)})),z,we=t((()=>{z=JSON.parse(`{"modal.aria.back":["Tilbake"],"modal.aria.close":["Lukk"]}`)})),B,Te=t((()=>{B=JSON.parse(`{"modal.aria.back":["Tillbaka"],"modal.aria.close":["Stäng"]}`)})),V,Ee=t((()=>{be(),o(),s(),d(),te(),ne(),xe(),Se(),Ce(),we(),Te(),k(),p(),ae(),V=class extends D(l){constructor(){super(),this.back=!1,this.noClose=!1,this._hasTopContent=!1,re(L,z,R,I,B)}render(){return a`
      <div class="header">
    ...
    `}async willUpdate(e){if(e.has(`back`)){if(!this.titleEl)return;new F(this.titleEl).when(async()=>{await this.updateComplete})}}get titleClasses(){return[`header-title`,this.back?`header-title-with-back-button`:`header-title-without-back-button`,this._hasTopContent?`header-title-with-top-area`:``].join(` `)}get backButton(){return this.back&&!this._hasTopContent?a`<button
          type="button"
          title=""
          aria-label="${ie._({id:`modal.aria.back`,message:`Back`,comment:`Aria label for the back button in modal`})}"
          class="header-button header-button-left"
          @click="${this.emitBack}">
          <w-icon name="ArrowLeft" size="small" locale="${n()}" style="display: flex;" class="flex"></w-icon>
        </button>`:r}get closeButton(){return this.noClose?r:a`<div class="header-close-button-container">
        <w-button
            type="button"
            title=""
            aria-label="${ie._({id:`modal.aria.close`,message:`Close`,comment:`Aria label for the close button in modal`})}"
            variant="pill"
            small
            @click="${this.close}">
                <w-icon name="Close" size="small" locale="${n()}" style="display: flex;" class="flex"></w-icon>
        </w-button>
    </div>`}emitBack(){this.dispatchEvent(new CustomEvent(`backClicked`,{bubbles:!0,composed:!0}))}handleTopSlotChange(e){let t=e.target.assignedElements({flatten:!0});this._hasTopContent=!!t.length}static{this.styles=[m,u`
      .header {
        position: relative;
    ...
    `]}},f([i({type:String})],V.prototype,`title`,void 0),f([i({type:Boolean})],V.prototype,`back`,void 0),f([i({type:Boolean,attribute:`no-close`})],V.prototype,`noClose`,void 0),f([oe()],V.prototype,`_hasTopContent`,void 0),f([h(`.title-el`)],V.prototype,`titleEl`,void 0),customElements.get(`w-modal-header`)||customElements.define(`w-modal-header`,V)})),H,De=t((()=>{s(),k(),p(),H=class extends D(O(l)){render(){return a`
      <div class="footer">
        <slot @slotchange="${this.handleSlotChange}"></slot>
      </div>
    `}static{this.styles=[m,u`
      .footer {
        display: flex;
        flex-shrink: 0;
    ...
    `]}},customElements.get(`w-modal-footer`)||customElements.define(`w-modal-footer`,H)})),Oe=e({Default:()=>q,InvokerCommands:()=>J,Modal:()=>X,ModalFooter:()=>Q,ModalHeader:()=>Z,WithImage:()=>Y,__namedExportsOrder:()=>$,default:()=>K}),U,W,G,ke,Ae,je,Me,Ne,Pe,K,q,J,Y,X,Z,Q,$,Fe=t((()=>{se(),ee(),s(),ce(),_e(),Ee(),De(),{events:U,args:W,argTypes:G}=c(`w-modal`),{events:ke,args:Ae,argTypes:je}=c(`w-modal-header`),{events:Me,args:Ne,argTypes:Pe}=c(`w-modal-footer`),K={title:`Overlays/Modal`},q={args:{},render(){return a`
    ...
    `},args:W,argTypes:G,parameters:{actions:{handles:U}}},Z={render(e){return a`
      <p>
        This is here to document attributes. See the Default example for a
        complete usage example.
      </p>
      <w-modal-header ${g(_(e))}></w-modal-header>
    `},args:Ae,argTypes:je,parameters:{actions:{handles:ke}}},Q={render(e){return a`
      <p>
        This is here to document attributes. See the Default example for a
        complete usage example.
      </p>
...
}`,...Q.parameters?.docs?.source}}},$=[`Default`,`InvokerCommands`,`WithImage`,`Modal`,`ModalHeader`,`ModalFooter`]}));Fe();export{q as Default,J as InvokerCommands,X as Modal,Q as ModalFooter,Z as ModalHeader,Y as WithImage,$ as __namedExportsOrder,K as default,Oe as n,Fe as t};
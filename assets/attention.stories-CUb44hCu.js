import{g as w,x as e}from"./iframe-BJuG1XJ0.js";import{s as c,p as v}from"./utilities-DyyV9nTz.js";import"./index-DK-ta_BI.js";import"./index-D9Pf45TE.js";var p=Object.freeze,y=Object.defineProperty,l=(t,g)=>p(y(t,"raw",{value:p(t.slice())})),d,u,m,b;const{events:E,args:I,argTypes:f}=w("w-attention"),T={title:"Overlays/Attention",render(t){return e`
      <w-attention ${c(v(t))}>
        <w-button
          ${c({id:t.buttonId})}
          variant="secondary"

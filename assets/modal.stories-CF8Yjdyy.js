import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{m as n,n as r,r as i,s as a,t as o}from"./lit-JruGAyH3.js";import{n as ee,t as s}from"./dist-DqaB6mbc.js";import{n as te,t as c}from"./dist-BZcjgT0h.js";import{a as ne,i as l,n as u,o as d,r as re,t as f}from"./decorate-Dk3JVGAn.js";import{t as ie}from"./icon-C7QoHWvn.js";import{n as ae,r as oe,t as se}from"./i18n-CXvrc2gG.js";import{n as p,t as m}from"./styles-DphVJT09.js";import{i as h,n as g,r as ce,t as le}from"./utilities-DiPTmiiI.js";function ue(e){let t=-1;e.ontouchstart=e=>{e.targetTouches.length===1&&(t=e.targetTouches[0].clientY)},e.ontouchmove=n=>{if(n.targetTouches.length!==1)return;let r=n.targetTouches[0].clientY-t;return e.scrollTop===0&&r>0||w(e)&&r<0?y(n):(n.stopPropagation(),!0)}}function de(e){e.ontouchstart=null,e.ontouchmove=null}function fe(e){if(!e)throw Error(`Could not run setup, an element must be provided`);_.some(t=>t===e)||(_.length||(x(),E()),ue(e),_.push(e))}function pe(){_.forEach(de),D(),C(),_=[]}var _,v,me,y,b,x,S,C,w,T,E,D,he=e((()=>{_=[],v={documentElement:{},body:{}},me=Object.freeze({documentElement:{"scrollbar-gutter":`stable`},body:{overflow:`hidden`,position:`relative`,height:`100%`}}),y=e=>{e.touches.length>1||e.preventDefault?.()},b=e=>([t,n])=>{v[e][t]=document[e].style[t],document[e].style[t]=n},x=()=>Object.entries(me).forEach(([e,t])=>{Object.entries(t).forEach(b(e))}),S=e=>([t,n])=>{document[e].style[t]=v[e][t]},C=()=>Object.entries(v).forEach(([e,t])=>{Object.entries(t).forEach(S(e))}),w=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight,T=e=>()=>document[e?`addEventListener`:`removeEventListener`](`touchmove`,y,{passive:!1}),E=T(!0),D=T()})),O,k,A=e((()=>{O=e=>class extends e{constructor(...e){super(...e),this.patchClose=!0,this._close=null}close(){this._close()}},k=e=>class extends e{handleSlotChange(e){let t=e.target.assignedNodes({flatten:!0});for(let e of t.filter(e=>e.patchClose))e._close=()=>this.close()}}})),j,ge=e((()=>{o(),re(),he(),m(),A(),u(),j=class extends k(r){constructor(){super(),this.show=!1,this.ignoreBackdropClicks=!1,this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`command`,e=>{let t=e.command;t===`--show-modal`?this.open():(t===`--close`||t===`--confirm`)&&this.close()})}async open(){this.dialogEl.showModal(),this.handleListeners(),fe(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent(`shown`,{bubbles:!0,composed:!0}))}close(){this.dialogEl?.open&&(this.handleListeners(`removeEventListener`),this.dialogEl.classList.add(`close`),this.dialogEl.addEventListener(`animationend`,async()=>{this.dialogEl.classList.remove(`close`),this.dialogEl.close(),pe(),await this.updateComplete,this.dispatchEvent(new CustomEvent(`hidden`,{bubbles:!0,composed:!0}))},{once:!0}))}render(){return a`
    ...
    `]}},f([d({type:String})],H.prototype,`title`,void 0),f([d({type:Boolean})],H.prototype,`back`,void 0),f([d({type:Boolean,attribute:`no-close`})],H.prototype,`noClose`,void 0),f([ne()],H.prototype,`_hasTopContent`,void 0),f([l(`.title-el`)],H.prototype,`titleEl`,void 0),customElements.get(`w-modal-header`)||customElements.define(`w-modal-header`,H)})),U,Ee=e((()=>{o(),A(),m(),U=class extends O(k(r)){render(){return a`
      <div class="footer">
    ...
    `]}},customElements.get(`w-modal-footer`)||customElements.define(`w-modal-footer`,U)})),De=t({Default:()=>q,InvokerCommands:()=>J,Modal:()=>X,ModalFooter:()=>Q,ModalHeader:()=>Z,WithImage:()=>Y,__namedExportsOrder:()=>$,default:()=>K}),W,G,Oe,ke,Ae,je,Me,Ne,Pe,K,q,J,Y,X,Z,Q,$,Fe=e((()=>{ce(),ee(),o(),le(),ge(),Te(),Ee(),{events:W,args:G,argTypes:Oe}=s(`w-modal`),{events:ke,args:Ae,argTypes:je}=s(`w-modal-header`),{events:Me,args:Ne,argTypes:Pe}=s(`w-modal-footer`),K={title:`Overlays/Modal`},q={args:{},render(){return a`
    ...
    `},args:G,argTypes:Oe,parameters:{actions:{handles:W}}},Z={render(e){return a`
      <p>
        This is here to document attributes. See the Default example for a
        complete usage example.
      </p>

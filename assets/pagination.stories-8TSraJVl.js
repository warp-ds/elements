    ...
    `]}constructor(){super(),g(D,j,k,T,N)}get _currentPage(){return this.currentPageNumber??1}get _visiblePages(){return this.visiblePages??7}get shouldShowShowFirstPageButton(){return this._currentPage-2>0}get shouldShowPreviousPageButton(){return this._currentPage-1>0}get shouldShowNextPageButton(){return this._currentPage<this.pages}get currentPageIndex(){return this._currentPage-1}get visiblePageNumbers(){if(this.pages<=this._visiblePages)return Array.from({length:this.pages},(e,t)=>t+1);let e=Math.floor(this._visiblePages/2),t=Math.max(1,this._currentPage-e),n=Math.min(this.pages,t+this._visiblePages-1);return n-t+1<this._visiblePages&&(t=Math.max(1,n-this._visiblePages+1)),Array.from({length:n-t+1},(e,n)=>t+n)}#e(e){let t=e.target.getAttribute(`data-page-number`);this.dispatchEvent(new CustomEvent(`page-click`,{detail:{clickedPage:t},bubbles:!0,composed:!0}))}render(){let e=this.visiblePageNumbers;return a`<nav class="flex items-center justify-center p-8" @click="${this.#e}">
      ...
      <div class="flex items-center s-text-link">
        ${this.shouldShowShowFirstPageButton?a`<a
              ...
              >
              <w-icon name="ChevronDoubleLeft" size="small" locale="${m()}" class="pointer-events-none flex items-center" class="flex"></w-icon>
        ...
        ${this.shouldShowPreviousPageButton?a`<a
              ...
              >
              <w-icon name="ChevronLeft" size="small" locale="${m()}" class="pointer-events-none flex items-center" class="flex"></w-icon>
              <span class="sr-only">${L()}</span>
            </a>`:i}
        ...
        <span class="block md:hidden p-8 font-bold">${c._({id:`pagination.label.current-page`,message:`Page {currentPage}`,values:{currentPage:this._currentPage},comment:`Default message for current page label in the pagination component`})}</span>

      ...
      <div class="wrapper" tabindex="${this._internalTabIndex}">
        ${this.label?o`
              <div class="label" id="${s}">
                ...
                ${this.optional?o`
                      <span class="optional">
                        ${g._({id:`checkbox-group.label.optional`,message:`Optional`,comment:`Shown behind label when marked as optional`})}
                      </span>
                    `:n}
              </div>
            `:n}

import{x as i,r as E,a as S,i as k,f as w,s as j,u as A,p as z,E as M,n as d,l as q,g as B}from"./iframe-DnahAwrs.js";import{s as C,p as T}from"./utilities-BVTJJRhe.js";import{e as v}from"./query-NYTjQBeo.js";const L=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},$=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const r of o.filter(a=>a.patchClose))r._close=()=>this.close()}};let N=class extends L($(k)){render(){return i`
      <div class="footer">
    ...
    `]}};customElements.get("w-modal-footer")||customElements.define("w-modal-footer",N);const W=(e,t)=>({dx:e.left-t.left,dy:e.top-t.top,dw:e.width/t.width,dh:e.height/t.height,first:e,last:t}),R=({dx:e,dy:t})=>[{transform:`translate(${e}px, ${t}px)`},{transform:"none"}],Y={easing:"ease",duration:300};let O=!1;const J=typeof window<"u";if(J){const e=window.matchMedia("(prefers-reduced-motion: reduce)"),t=({matches:o})=>O=o;e.addEventListener&&e.addEventListener("change",t),t(e)}class K{first;last;el;constructor(t,{animation:o={},keyframes:r,respectReduceMotion:a=!0}={}){this.el=t,this.first={},this.last={},this.userAnimationOptions=o,this.keyframeGenerator=r||R,this.shouldReduceMotion=a}async when(t){this.prep();const o=await t();return await this.play(),o}prep(){this.first=this.el.getBoundingClientRect()}async play(){if(this.last=this.el.getBoundingClientRect(),!this.el.animate)return;await this.el.animate(this.keyframes,this.animationOptions).finished}get keyframes(){return this.keyframeGenerator(W(this.first,this.last))}get defaults(){return Y}get mergedOptions(){return{...this.defaults,...this.userAnimationOptions}}get animationOptions(){return this.shouldReduceMotion?O?{...this.mergedOptions,duration:0}:this.mergedOptions:this.mergedOptions}}var G={},U=JSON.parse('{"icon.title.arrow-left":["Pil som peker mot venstre"]}'),Q=JSON.parse('{"icon.title.arrow-left":["Leftward-pointing arrow"]}'),V=JSON.parse('{"icon.title.arrow-left":["Vasemmalle osoittava nuoli"]}'),X=JSON.parse('{"icon.title.arrow-left":["Pil til venstre"]}'),Z=JSON.parse('{"icon.title.arrow-left":["Pil som pekar vänster"]}'),_=["en","nb","fi","da","sv"],D="en",ee=()=>{var e;let t;switch((e=process==null?void 0:G)==null?void 0:e.NMP_BRAND){case"FINN":t="nb";break;case"TORI":t="fi";break;case"BLOCKET":t="sv";break;case"DBA":t="da";break;default:t="en"}return t},H=()=>{var e;const t=(e=document?.location)==null?void 0:e.hostname;return t?.includes("finn")?"nb":t.includes("tori")?"fi":t.includes("blocket")?"sv":t.includes("dba")?"da":D},x=e=>_.find(t=>e===t||e.toLowerCase().includes(t))||H();function te(){var e;if(typeof window>"u"){const t=ee();return x(t)}try{const t=(e=document?.documentElement)==null?void 0:e.lang,o=H();return _.includes(t)?x(t??o):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),x(o))}catch(t){return console.warn("could not detect locale, falling back to source locale",t),D}}var oe=(e,t,o,r,a,n)=>e==="nb"?o:e==="fi"?r:e==="da"?a:e==="sv"?n:t,ae=(e,t,o,r,a)=>{const n=te(),s=oe(n,e,t,o,r,a);w.load(n,s),w.activate(n)};ae(Q,U,V,X,Z);var re=class extends k{render(){const e=w.t({message:"Leftward-pointing arrow",id:"icon.title.arrow-left",comment:"Title for table arrow left icon"});return A`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-arrow-left-16-part">${j(`<title>${e}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="M5.222 8h6.667"></path><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.444 11.75 4.111 8l3.333-3.75"></path></svg>`}};customElements.get("w-icon-arrow-left-16")||customElements.define("w-icon-arrow-left-16",re);const ne=JSON.parse('{"modal.aria.back":["Tilbage"],"modal.aria.close":["Luk"]}'),se=JSON.parse('{"modal.aria.back":["Back"],"modal.aria.close":["Close"]}'),ie=JSON.parse('{"modal.aria.back":["Takaisin"],"modal.aria.close":["Sulje"]}'),le=JSON.parse('{"modal.aria.back":["Tilbake"],"modal.aria.close":["Lukk"]}'),de=JSON.parse('{"modal.aria.back":["Tillbaka"],"modal.aria.close":["Stäng"]}');var ce=Object.defineProperty,y=(e,t,o,r)=>{for(var a=void 0,n=e.length-1,s;n>=0;n--)(s=e[n])&&(a=s(t,o,a)||a);return a&&ce(t,o,a),a};let c=class extends L(k){constructor(){super(),this._hasTopContent=!1,z(se,le,ie,ne,de)}render(){return i`
      <div class="header">
    ...
    `}async willUpdate(t){if(t.has("back")){if(!this.titleEl)return;new K(this.titleEl).when(async()=>{await this.updateComplete})}}get titleClasses(){return["header-title",this.back?"header-title-with-back-button":"header-title-without-back-button",this._hasTopContent?"header-title-with-top-area":""].join(" ")}get backButton(){return this.back&&!this._hasTopContent?i`<button
        ...
        </button>`:M}get closeButton(){return this.noClose?M:i`<button
      type="button"
    ...
    </button>`}emitBack(){this.dispatchEvent(new CustomEvent("backClicked",{bubbles:!0,composed:!0}))}handleTopSlotChange(t){const o=t.target.assignedElements({flatten:!0});this._hasTopContent=!!o.length}static{this.styles=[E,S`
      .header {
        position: relative;
    ...
    `]}};y([d({type:String})],c.prototype,"title");y([d({type:Boolean})],c.prototype,"back");y([d({type:Boolean,attribute:"no-close"})],c.prototype,"noClose");y([q()],c.prototype,"_hasTopContent");y([v(".title-el")],c.prototype,"titleEl");customElements.get("w-modal-header")||customElements.define("w-modal-header",c);let b=[];const I={documentElement:{},body:{}},he=Object.freeze({documentElement:{"scrollbar-gutter":"stable"},body:{overflow:"hidden",position:"relative",height:"100%"}}),P=e=>{e.touches.length>1||e.preventDefault?.()},me=e=>([t,o])=>{I[e][t]=document[e].style[t],document[e].style[t]=o},ue=()=>Object.entries(he).forEach(([e,t])=>{Object.entries(t).forEach(me(e))}),pe=e=>([t,o])=>{document[e].style[t]=I[e][t]},ge=()=>Object.entries(I).forEach(([e,t])=>{Object.entries(t).forEach(pe(e))}),fe=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight;function be(e){let t=-1;const o=r=>{if(r.targetTouches.length!==1)return;const a=r.targetTouches[0].clientY-t;return e.scrollTop===0&&a>0||fe(e)&&a<0?P(r):(r.stopPropagation(),!0)};e.ontouchstart=r=>{r.targetTouches.length===1&&(t=r.targetTouches[0].clientY)},e.ontouchmove=o}function we(e){e.ontouchstart=null,e.ontouchmove=null}const F=e=>()=>document[e?"addEventListener":"removeEventListener"]("touchmove",P,{passive:!1}),ye=F(!0),ke=F();function ve(e){if(!e)throw Error("Could not run setup, an element must be provided");b.some(t=>t===e)||(b.length||(ue(),ye()),be(e),b.push(e))}function xe(){b.forEach(we),ke(),ge(),b=[]}var Ee=Object.defineProperty,h=(e,t,o,r)=>{for(var a=void 0,n=e.length-1,s;n>=0;n--)(s=e[n])&&(a=s(t,o,a)||a);return a&&Ee(t,o,a),a};class l extends $(k){constructor(){super(),this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}async open(){this.dialogEl.showModal(),this.handleListeners(),ve(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent("shown",{bubbles:!0,composed:!0}))}close(){this.handleListeners("removeEventListener"),this.dialogEl.classList.add("close"),this.dialogEl.addEventListener("animationend",async()=>{this.dialogEl.classList.remove("close"),this.dialogEl.close(),xe(),await this.updateComplete,this.dispatchEvent(new CustomEvent("hidden",{bubbles:!0,composed:!0}))},{once:!0})}render(){return i`
    ...
    `},play:async({canvasElement:e})=>{await Promise.all([customElements.whenDefined("w-button"),customElements.whenDefined("w-modal"),customElements.whenDefined("w-modal-header"),customElements.whenDefined("w-modal-footer")]);const t=e.querySelector("#modal-open-button-one"),o=e.querySelector("#modal-close-button-one"),r=e.querySelector("#modal-toggle-back-one"),a=e.querySelector("#modal-close-button-cancel"),n=e.querySelector("#example-modal-one"),s=e.querySelector("#modal-header-one");t&&n&&t.addEventListener("click",()=>n.open()),o&&n&&o.addEventListener("click",()=>n.close()),a&&n&&a.addEventListener("click",()=>n.close()),r&&s&&r.addEventListener("click",()=>{s.back=!s.back})},parameters:{docs:{story:{autoplay:!0}}}},u={args:{},render(){return i`
    ...
    `},play:async({canvasElement:e})=>{await Promise.all([customElements.whenDefined("w-button"),customElements.whenDefined("w-modal"),customElements.whenDefined("w-modal-header"),customElements.whenDefined("w-modal-footer")]);const t=e.querySelector("#modal-open-button-two"),o=e.querySelector("#modal-close-button-two"),r=e.querySelector("#example-modal-two");t&&r&&t.addEventListener("click",()=>r.open()),o&&r&&o.addEventListener("click",()=>r.close())},parameters:{docs:{story:{autoplay:!0}}}},p={render(e){return i`
      <p>
    ...
    `},args:$e,argTypes:Oe,parameters:{actions:{handles:Le}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {},
  render() {
    return html\`
      <w-button id="modal-open-button-one" aria-haspopup="dialog"
...
}`,...f.parameters?.docs?.source}}};const De=["Default","WithImage","Modal","ModalHeader","ModalFooter"],ze=Object.freeze(Object.defineProperty({__proto__:null,Default:m,Modal:p,ModalFooter:f,ModalHeader:g,WithImage:u,__namedExportsOrder:De,default:_e},Symbol.toStringTag,{value:"Module"}));export{m as D,ze as M,u as W};

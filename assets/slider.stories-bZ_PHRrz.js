import{a as e,i as t,n,t as r}from"./preload-helper-CwA5MRLW.js";import{Bt as i,E as a,Ht as o,J as s,K as c,Kt as l,Lt as u,M as d,N as f,Rt as p,Wt as m,b as ee,f as h,h as te,j as ne,k as re,l as ie,m as ae,p as g,q as _,u as v,w as y,x as b}from"./iframe-BkoDQXad.js";import{n as oe,t as se}from"./form-control-EbCgjNJ6.js";import{t as ce}from"./affix-CPbCD9_i.js";import{r as x,t as le}from"./if-defined-B_Kax8v7.js";import{t as ue}from"./attention-CzH-29wb.js";import{n as de,t as S}from"./taggedTemplateLiteral-StQcbrp0.js";import{t as fe}from"./textfield-DlN1YHcz.js";var pe,me=t((()=>{pe=JSON.parse(`{"select.label.optional":["Valgfri"],"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),he,ge=t((()=>{he=JSON.parse(`{"select.label.optional":["Optional"],"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),_e,ve=t((()=>{_e=JSON.parse(`{"select.label.optional":["Valinnainen"],"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),ye,be=t((()=>{ye=JSON.parse(`{"select.label.optional":["Valgfri"],"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),C,xe=t((()=>{C=JSON.parse(`{"select.label.optional":["Valfritt"],"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),w,Se=t((()=>{u(),w=m`
	.w-slider {
		position: relative;
		border: none;
		padding: 0;
	...
	.w-slider[disabled] {
		--w-slider-track-active-background: var(
			--w-s-color-background-disabled-subtle
		);
	...
	.w-slider__active-range {
		...
		--offset-percentage: calc(
			calc(var(--from) - var(--min)) /
				calc(var(--max-with-offset) - var(--min)) * 100
		);
		margin-left: calc(
			max(var(--offset-percentage) * 1%, 0px) - var(
					--range-slider-magic-pixel,
					0px
				)
		);
		...
		--range-span-percentage: calc(
			calc(
					min(var(--to), var(--max-with-offset)) - max(var(--min), var(--from))
				) /
				var(--value-range) * 100
		);
		width: calc(
			var(--range-span-percentage) * 1% + var(--range-slider-magic-pixel, 0px)
		);
...
`})),T,Ce=t((()=>{u(),ee(),s(),ne(),ie(),me(),ge(),ve(),be(),xe(),Se(),g(),T=class extends p{static{this.shadowRootOptions={...p.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[v,w,m`
			:host {
		...
		`]}constructor(){super(),this.disabled=!1,this.openEnded=!1,this.invalid=!1,this.required=!1,this.optional=!1,this.hiddenTextfield=!1,this._invalidMessage=``,this._hasInternalError=!1,this._showError=!1,this._tabbableElements=[],this._hasLabel=!1,re(he,ye,_e,pe,C)}#e(){let e=this.querySelectorAll(`w-slider-thumb`),t=!1;for(let n of e.values())n.min=this.edgeMin,n.max=this.edgeMax,n.step=this.step,n.suffix=this.suffix??``,n.required=this.required,n.labelFormatter=this.labelFormatter,n.valueFormatter=this.valueFormatter,n.tooltipFormatter=this.tooltipFormatter,n.openEnded=this.openEnded,n._hiddenTextfield=this.hiddenTextfield,n.ariaLabel||(n.slot||(n.ariaLabel=this.label||null),n.slot===`from`&&(n.ariaLabel=`${this.label} min`),n.slot===`to`&&(n.ariaLabel=`${this.label} max`)),(n.slot===`from`||n.slot===`to`)&&(t=!0),n.disabled=this.disabled,n.invalid=!!this.errorText,this.#c(n);t?(this.fieldset.style.setProperty(`--active-range-inline-start-padding`,`var(--w-slider-thumb-size, 28px)`),this.fieldset.style.setProperty(`--active-range-inline-end-padding`,`var(--w-slider-thumb-size, 28px)`)):this.fieldset.style.setProperty(`--active-range-border-radius`,`4px`)}get edgeMin(){return this.openEnded?(Number(this.min)-1).toString():this.min}get edgeMax(){return this.openEnded?(Number(this.max)+1).toString():this.max}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.step&&this.fieldset.style.setProperty(`--step`,String(this.step)),this.min!==void 0&&this.fieldset.style.setProperty(`--min`,this.edgeMin),this.max!==void 0&&this.fieldset.style.setProperty(`--max`,this.max),this.markers&&this.fieldset.style.setProperty(`--markers`,String(this.markers)),this.openEnded&&this.fieldset.style.setProperty(`--over-under-offset`,`1`),this.label&&(this._hasLabel=!0);let e=this.querySelectorAll(`w-slider-thumb`);if(e.length===2){this.fieldset.style.setProperty(`--range-slider-magic-pixel`,`1px`);let t=[...e];this._tabbableElements[0]=t[0].shadowRoot.querySelector(`input`),this._tabbableElements[1]=t[1].shadowRoot.querySelector(`input`),this._tabbableElements[2]=t[0].shadowRoot.querySelector(`w-textfield`),this._tabbableElements[3]=t[1].shadowRoot.querySelector(`w-textfield`)}else if(e.length===1){let t=[...e];this._tabbableElements[0]=t[0].shadowRoot.querySelector(`input`),this._tabbableElements[1]=t[0].shadowRoot.querySelector(`w-textfield`)}this.invalid&&this.error&&(this._showError=!0),this.#e()}updated(e){(e.has(`disabled`)||e.has(`required`)||e.has(`min`)||e.has(`step`)||e.has(`max`)||e.has(`suffix`)||e.has(`labelFormatter`)||e.has(`valueFormatter`)||e.has(`_invalidMessage`)||e.has(`_hasInternalError`))&&this.#e(),(e.has(`error`)||e.has(`invalid`))&&(this.error&&this.invalid?this._showError=!0:this._showError=!1,this.#e())}#t(e){e.stopPropagation();let t=e.target;this.#c(t)}#n(e){let t=e.target;this.#c(t),t.slot&&this.#a()}#r(){this.componentHasError?this._showError=!0:this._showError=!1,this.#e()}#i(e){if(e.key===`Tab`){let t=this._tabbableElements.indexOf(e.target.shadowRoot.activeElement);if(t===-1)return;let n=e.shiftKey?-1:1,r=this._tabbableElements[t+n];if(!r)return;e.preventDefault(),r.focus()}}#a(){let e=null,t=null,n=this.querySelectorAll(`w-slider-thumb`);for(let r of n.values())r.slot===`from`&&(e=r),r.slot===`to`&&(t=r);!e||!t||!e.invalid&&t.invalid}#o(e){e.stopPropagation();let t=this._hasInternalError||this.invalid,n=e.target;if(this._hasInternalError=!!e.detail.invalid||this.invalid,this._invalidMessage=e.detail.invalid,t===!0&&this._hasInternalError===!1){let e=this.querySelectorAll(`w-slider-thumb`);for(let t of e.values())t!==n&&t.updateFieldAfterValidation()}}#s(e,t){return t.value??=this.openEnded?``:e,t.value===``?e:t.value}#c(e){let t=e.slot;t||this.fieldset.style.setProperty(`--from`,`0`),t===`from`&&this.fieldset.style.setProperty(`--from`,this.#s(this.edgeMin,e)),(!t||t===`to`)&&this.fieldset.style.setProperty(`--to`,this.#s(this.edgeMax,e))}get componentHasError(){return this.invalid||this._hasInternalError}get errorText(){return this._showError?this.error||this._invalidMessage:``}_handleLabelSlotChange(e){let t=e.target.assignedElements().length>0;this._hasLabel=t||!!this.label,console.log(`Label content changed, has label:`,this._hasLabel)}get _label(){let e=this._hasLabel&&this.optional&&!this.required?o`<span class="w-slider__optional"
			...
			<fieldset
				...
				@thumbreset="${this.#t}"
				@keydown="${this.#i}"
				aria-invalid="${this.errorText?`true`:i}"
				?disabled="${this.disabled}"
			>
				${this._label}
				<slot class="w-slider__description" name="description"></slot>
				${this.markers?o`<div class="w-slider__markers"></div>`:i}
				...
				<slot
					...
					@slotchange=${this.#e}
				></slot>
				${this.errorText?o`<p class="w-slider__error" aria-describes="fieldset">
							${this.errorText}
						</p>`:this.helpText?o`<p class="w-slider__help-text" aria-describes="fieldset">
								${this.helpText}
							</p>`:i}
			</fieldset>
		`}},h([a({reflect:!0})],T.prototype,`label`,void 0),h([a({type:Boolean,reflect:!0})],T.prototype,`disabled`,void 0),h([a({type:Boolean,attribute:`open-ended`})],T.prototype,`openEnded`,void 0),h([a({type:String,reflect:!0})],T.prototype,`error`,void 0),h([a({type:String,reflect:!0,attribute:`help-text`})],T.prototype,`helpText`,void 0),h([a({type:Boolean,reflect:!0})],T.prototype,`invalid`,void 0),h([a({type:Boolean,reflect:!0})],T.prototype,`required`,void 0),h([a({type:Boolean,reflect:!0})],T.prototype,`optional`,void 0),h([a({reflect:!0})],T.prototype,`min`,void 0),h([a({reflect:!0})],T.prototype,`max`,void 0),h([a({type:Number,reflect:!0})],T.prototype,`markers`,void 0),h([a({type:Number,reflect:!0})],T.prototype,`step`,void 0),h([a({reflect:!0})],T.prototype,`suffix`,void 0),h([a({type:Boolean,reflect:!0,attribute:`hidden-textfield`})],T.prototype,`hiddenTextfield`,void 0),h([a({attribute:!1})],T.prototype,`valueFormatter`,void 0),h([a({attribute:!1})],T.prototype,`tooltipFormatter`,void 0),h([a({attribute:!1})],T.prototype,`labelFormatter`,void 0),h([b(`fieldset`)],T.prototype,`fieldset`,void 0),h([y()],T.prototype,`_invalidMessage`,void 0),h([y()],T.prototype,`_hasInternalError`,void 0),h([y()],T.prototype,`_showError`,void 0),h([y()],T.prototype,`_tabbableElements`,void 0),h([y()],T.prototype,`_hasLabel`,void 0),customElements.get(`w-slider`)||customElements.define(`w-slider`,T)})),E,we=t((()=>{u(),E=l(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`)})),D,Te=t((()=>{u(),D=m`
	.w-slider-thumb {
		position: relative;
		display: grid;
   ...
   */
	.w-slider-thumb__range::-webkit-slider-thumb {
		...
		margin-top: calc(
			-1 *
				calc(
					var(--w-slider-thumb-offset) - calc(var(--w-slider-track-height) / 2)
				)
		);
...
`})),O,k,A,Ee=t((()=>{s(),se(),u(),ee(),ae(),le(),we(),ie(),Te(),g(),n(),O=/WebKit/,k=/Chrome/,A=class extends oe(p){constructor(...e){super(...e),this.ariaLabel=null,this.ariaDescription=null,this.disabled=!1,this.invalid=!1,this.openEnded=!1,this.required=!1,this.suffix=``,this._showTooltip=!1,this._inputHasFocus=!1,this._hiddenTextfield=!1,this.#e=void 0,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...p.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[v,E,D]}#e;resetFormControl(){this.value=this.#e,this.dispatchEvent(new CustomEvent(`thumbreset`,{bubbles:!0}))}#t(){this._showTooltip=!0,this.shadowRoot.querySelector(`w-attention`).handleDone()}#n(){this._showTooltip=!1}#r(){this.range&&(this.value===``?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#i(e){this.dispatchEvent(new CustomEvent(`slidervalidity`,{bubbles:!0,detail:{invalid:e,slot:this.slot}}))}async updateFieldAfterValidation(){let e=this.shadowRoot.querySelector(`w-textfield`);await this.#a(e.value??``,!0)}async#a(e,t){let n=this.suffix??``,r=Number.parseInt(e);if(this.openEnded&&!t&&this.step&&!(this.slot===`to`&&r>=Number(this.max)-1||this.slot===`from`&&r<=Number(this.min)+1)){let t=1/this.step;r=Math.round(r*t)/t,e=r.toString()}let i=Number.parseInt(this.max),a=Number.parseInt(this.min);if(!this.openEnded&&(r>i||r<a))return this.#i(_.t({id:`slider.error.out_of_bounds`,message:`Value must be between {min} and {max}`,values:{min:`${this.min} ${n}`.trim(),max:`${this.max} ${n}`.trim()}})),{shouldCancel:!0};e===``&&this.required&&this.#i(_.t({id:`slider.error.required`,message:`This field is required`})),this.value=e;let o=e===this.max||e===this.min,s=!1;if(this.slot){let n=this.parentElement.querySelector(`w-slider-thumb[slot="to"]`),c=this.parentElement.querySelector(`w-slider-thumb[slot="from"]`),l=n.textfield.value||this.max,u=c.textfield.value||this.min,d=Number.parseInt(l),f=Number.parseInt(u),p=_.t({id:`slider.error.overlap`,message:`The maximum value cannot be less than the minimum`});if(this.slot===`from`){let n=this.openEnded&&d>i?d:Math.min(d,this.openEnded?i-1:i);r>n&&(s=!0,this.openEnded&&o?this.value=String(n):this.value=l,t&&(this.#i(p),await this.updateComplete,this.textfield.value=e))}else{let n=this.openEnded&&f<a?f:Math.max(Number.parseInt(u),this.openEnded?a+1:a);r<n&&(s=!0,this.openEnded&&o?this.value=String(n):this.value=u,t&&(this.#i(p),await this.updateComplete,this.textfield.value=e))}}return s?{shouldCancel:!0}:(this.#i(``),this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.openEnded&&!t&&o?``:e,this.shadowRoot.querySelector(`w-attention`).handleDone(),{shouldCancel:!1})}async#o(e){let t=e.currentTarget.tagName===`W-TEXTFIELD`;if(e instanceof CustomEvent)return!1;let n=e.currentTarget.value;return(await this.#a(n,t)).shouldCancel?(e.preventDefault(),!1):!0}async#s(e){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}if(!this.openEnded||e.key!==`ArrowLeft`&&e.key!==`ArrowRight`)return;let t=Number(this.range.value),n=this.step||1,r;r=e.key===`ArrowLeft`?t-n:t+n,r=Math.min(Math.max(r,Number(this.min)),Number(this.max)),(await this.#a(r.toString(),!1)).shouldCancel&&e.preventDefault()}async#c(e){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}if(this.textfield.value)return;let t=``;this.slot===`from`?e.key===`ArrowUp`?t=String(Number(this.min)+1)||`1`:e.key===`ArrowDown`&&(t=String(Number(this.min))||`0`):e.key===`ArrowUp`?t=String(Number(this.max))||`100`:e.key===`ArrowDown`&&(t=String(Number(this.max)-1)||`99`),t&&(e.preventDefault(),await this.#a(t,!0))}async connectedCallback(){if(super.connectedCallback(),this.#e=this.value,this.setValue(this.value),this.slot&&!this.ariaDescription&&(this.slot===`from`?this.ariaDescription=_.t({id:`slider.label.from`,comment:`Accessible label for the 'from value' input field in a range slider`,message:`From`}):this.slot===`to`&&(this.ariaDescription=_.t({id:`slider.label.to`,comment:`Accessible label for the 'to value' input field in a range slider`,message:`To`}))),`anchorName`in document.documentElement.style)await this.updateComplete;else{let e=import.meta.url.substring(0,import.meta.url.lastIndexOf(`/`));try{let[{default:t}]=await Promise.all([r(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[]),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement(`style`),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
      ...
      `,await t({roots:[this.shadowRoot],elements:[this.anchorPositioningStyleElement]})}catch(e){console.error(Error(`Error registering the CSS anchor positioning polyfill. The UI will look broken.`,{cause:e}))}}let e=window.navigator.userAgent;O.test(e)&&!k.test(e)&&this.tooltipTarget&&this.tooltipTarget.style.setProperty(`--transform-offset`,`var(--w-slider-thumb-size, 28px)`),this.#r()}get boundaryValue(){return this.slot===`from`?this.min:this.max}get textFieldDisplayValue(){return this._inputHasFocus&&this.value===``?this.range?.value?Math.min(Math.max(Number(this.range.value),Number(this.min)+1),Number(this.max)-1).toString():``:this.value}get tooltipDisplayValue(){let e;return e=this.tooltipFormatter?this.tooltipFormatter(this.value,this.slot):this.valueFormatter?this.valueFormatter(this.value,this.slot):this.value===``?this.range?.value??this.boundaryValue:this.value||0,e}get ariaDescriptionText(){let e=``,t=this.ariaDescription||``,n=this.value===``;return this.openEnded&&n&&(e=this.slot===`from`?_.t({id:`slider.placeholder.from`,message:`Min`}):_.t({id:`slider.placeholder.to`,message:`Max`})),e?`${e}, ${t}`:t}updated(e){if(e.has(`openEnded`)&&this.openEnded&&!this.placeholder&&(this.slot===`to`||this.slot===``?this.placeholder=_.t({id:`slider.placeholder.to`,message:`Max`,comment:`Max as in short for Maximum`}):this.slot===`from`&&(this.placeholder=_.t({id:`slider.placeholder.from`,message:`Min`,comment:`Min as in short for Minimum`}))),e.has(`value`)){this.#e===void 0&&this.value!==void 0&&(this.#e=this.value),this.setValue(this.value),this.#r();let t=e.get(`value`);this.value===``&&t&&this.dispatchEvent(new CustomEvent(`thumbreset`,{bubbles:!0}))}}render(){let e=this.placeholder&&!this.value;return o`
			<div class="w-slider-thumb">
				${`anchorName`in document.documentElement.style?i:o`<div class="polyfill-range">
							<div class="polyfill-active-range"></div>
						</div>`}
				<input
					id="range"
					aria-label="${this.ariaLabel}"
					aria-describedby="${x(this.ariaDescription?`aria-description`:void 0)}"
					class="w-slider-thumb__range"
					type="range"
					.value="${this.value}"
					min="${this.min}"
					max="${this.max}"
					step="${x(!this.openEnded&&this.step?this.step:void 0)}"
					?disabled="${this.disabled}"
					@mousedown="${this.#t}"
					@mouseup="${this.#n}"
					@touchstart="${this.#t}"
				...
				${this.slot===`from`||!this.slot?o` <span class="sr-only">
							${_.t({id:`slider.label.from`,message:`From`})+` `+(this.labelFormatter?this.labelFormatter(`from`):this.min)+`, `+_.t({id:`slider.label.to`,message:`To`})+` `+(this.labelFormatter?this.labelFormatter(`to`):this.max)}
						</span>`:i}
				...
				<w-textfield
					aria-label="${this.ariaLabel}"
					aria-description="${x(this.ariaDescriptionText)}"
					class="${te({"w-slider-thumb__textfield":!0,"sr-only":this._hiddenTextfield})}"
					type="number"
					tabindex="${this._hiddenTextfield?-1:i}"
					placeholder="${this.placeholder}"
					.value="${this.textFieldDisplayValue}"
					.formatter=${this.valueFormatter&&!e?e=>this.valueFormatter(e,this.slot):i}
					min="${this.openEnded?i:this.min}"
					max="${this.openEnded?i:this.max}"
					step="${x(this.step)}"
				...
				>
					...
					></output>
					<span slot="message">
						${this.tooltipDisplayValue}${this.suffix??``?o`&nbsp;${this.suffix??``}`:i}
					</span>
				</w-attention>
		...
		`}},h([a({attribute:`aria-label`})],A.prototype,`ariaLabel`,void 0),h([a({attribute:`aria-description`})],A.prototype,`ariaDescription`,void 0),h([a({reflect:!0})],A.prototype,`name`,void 0),h([a({reflect:!0})],A.prototype,`value`,void 0),h([a({type:Boolean,reflect:!0})],A.prototype,`disabled`,void 0),h([a({type:Boolean,reflect:!0})],A.prototype,`invalid`,void 0),h([a({attribute:!1,reflect:!1})],A.prototype,`openEnded`,void 0),h([a({reflect:!0})],A.prototype,`placeholder`,void 0),h([y()],A.prototype,`markers`,void 0),h([y()],A.prototype,`required`,void 0),h([y()],A.prototype,`step`,void 0),h([y()],A.prototype,`min`,void 0),h([y()],A.prototype,`max`,void 0),h([y()],A.prototype,`suffix`,void 0),h([a({attribute:!1})],A.prototype,`valueFormatter`,void 0),h([a({attribute:!1})],A.prototype,`tooltipFormatter`,void 0),h([a({attribute:!1})],A.prototype,`labelFormatter`,void 0),h([b(`input[type="range"]`)],A.prototype,`range`,void 0),h([b(`.w-slider-thumb__tooltip-target`)],A.prototype,`tooltipTarget`,void 0),h([b(`w-textfield`)],A.prototype,`textfield`,void 0),h([y()],A.prototype,`_showTooltip`,void 0),h([y()],A.prototype,`_inputHasFocus`,void 0),h([y()],A.prototype,`_hiddenTextfield`,void 0),customElements.get(`w-slider-thumb`)||customElements.define(`w-slider-thumb`,A)})),De=e({CustomError:()=>J,Description:()=>Y,HiddenMinimumMaximumLabels:()=>Z,Marks:()=>U,OpenEnded:()=>G,Range:()=>R,RangeError:()=>q,RangeOptional:()=>z,Single:()=>F,SingleDisabled:()=>I,SingleError:()=>K,SingleOptional:()=>L,Step:()=>W,SuffixCurrency:()=>V,SuffixKilometers:()=>H,SuffixSquareMeters:()=>B,VisuallyHiddenLabel:()=>X,VisuallyHiddenTextfield:()=>Q,__namedExportsOrder:()=>$,default:()=>P}),Oe,ke,Ae,je,Me,Ne,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,Pe=t((()=>{f(),u(),c(),ce(),ue(),fe(),Ce(),Ee(),de(),{events:j,args:M,argTypes:N}=d(`w-slider`),P={title:`Forms/Slider and Range Slider`,args:M,argTypes:N,parameters:{actions:{handles:j}}},F={render(){return o`
            <form>
        ...
        `}},B={args:{locale:`nb`,suffix:`m²`},render({suffix:e}){return o`
            <w-slider
        ...
        `}},V={args:{locale:`nb`,suffix:`kr`},render({locale:e,suffix:t}){return o(Oe||=S([`
            <w-slider
                label="Price"
                min="0"
                max="250000"
            ...
            <\/script>
        `]),t,e)}},H={args:{locale:`nb`,suffix:`km`},render({locale:e,suffix:t}){return o(ke||=S([`
            <w-slider
                label="Distance"
                min="0"
                max="250000"
            ...
            <\/script>
        `]),t,e)}},U={args:{locale:`nb`,step:`5`,markers:`5`},render({markers:e,step:t}){return o`
            <w-slider
                label="Single"
                min="0"
                max="100"
        ...
        `}},W={args:{step:5},render({step:e}){return o`
            <w-slider label="Single" step="${e}" min="0" max="100">
                <w-slider-thumb name="value"></w-slider-thumb>
            </w-slider>
        `}},G={args:{},render(){return o(Ae||=S([`
        ...
        `}},q={args:{},render(){return o(je||=S([`
            ...
            <\/script>
        `]))}},J={args:{error:`I'm an external error telling you something is wrong`,invalid:!0},render(e){return o`
            <w-slider
                label="Model year"
                min="1950"
                max="2025"
        ...
        `}},Z={render(){return o(Me||=S([`
            ...
            <\/script>
        `]))}},Q={render({locale:e}){return o(Ne||=S([`
...
}`,...Q.parameters?.docs?.source}}},$=[`Single`,`SingleDisabled`,`SingleOptional`,`Range`,`RangeOptional`,`SuffixSquareMeters`,`SuffixCurrency`,`SuffixKilometers`,`Marks`,`Step`,`OpenEnded`,`SingleError`,`RangeError`,`CustomError`,`Description`,`VisuallyHiddenLabel`,`HiddenMinimumMaximumLabels`,`VisuallyHiddenTextfield`]}));Pe();export{J as CustomError,Y as Description,Z as HiddenMinimumMaximumLabels,U as Marks,G as OpenEnded,R as Range,q as RangeError,z as RangeOptional,F as Single,I as SingleDisabled,K as SingleError,L as SingleOptional,W as Step,V as SuffixCurrency,H as SuffixKilometers,B as SuffixSquareMeters,X as VisuallyHiddenLabel,Q as VisuallyHiddenTextfield,$ as __namedExportsOrder,P as default,De as n,Pe as t};
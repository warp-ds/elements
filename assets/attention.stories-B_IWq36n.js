import{g as w,b as e}from"./iframe-CJ3Q3f-F.js";import{s as c,p as v}from"./utilities-CWSs7dsx.js";import"./attention-DjjFpqcX.js";import"./button-H4gHwpIN.js";var p=Object.freeze,y=Object.defineProperty,l=(t,g)=>p(y(t,"raw",{value:p(t.slice())})),d,u,m,b;const{events:E,args:I,argTypes:f}=w("w-attention"),T={title:"Overlays/Attention",render(t){return e`
      <w-attention ${c(v(t))}>
        <w-button
          ${c({id:t.buttonId})}
          variant="secondary"

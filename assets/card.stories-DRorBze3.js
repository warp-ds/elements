import{g as i,x as o}from"./iframe-C2CydlFf.js";import{s as n,p}from"./utilities-DuMQfoJZ.js";const{events:d,args:m,argTypes:g}=i("w-card"),f={title:"Navigation/Card",render(c){return o`
      <w-card ${n(p(c))}>

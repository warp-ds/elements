import{a as y,q as P,i as h,l as C,b as s,n as m,k as w,m as x}from"./iframe-BJ4sG1Th.js";import"./preload-helper-DvrX7W50.js";/**
 * @license
...
`;var E=Object.defineProperty,v=(t,a,i,o)=>{for(var e=void 0,r=t.length-1,n;r>=0;r--)(n=t[r])&&(e=n(a,i,e)||e);return e&&E(a,i,e),e};P($,N,S,I,O);class u extends h{static{this.styles=[D]}get _validPageCount(){return Math.max(1,Math.floor(this.pageCount??1))}get _validSelectedPage(){const a=Math.floor(this.selectedPage??1);return Math.max(1,Math.min(a,this._validPageCount))}render(){const a=this._validPageCount,i=this._validSelectedPage,o=C._({id:"page-indicator.aria.label",comment:"Default screenreader message for page indicator group",message:"Dot {selectedPage} is highlighted in a row of {pageCount} dots",values:{selectedPage:i,pageCount:a}});return s`

import{a as P,i as z,r as j,E as T,x as o,n as l,k as u,g as A}from"./iframe-CmJLvn5Y.js";import"./index-Dm00FQHc.js";import"./index-ChBv8cbO.js";import{F as L}from"./FormControlMixin-DJnJZbro.js";import{_ as B}from"./preload-helper-DvrX7W50.js";import{e as V}from"./query-NYTjQBeo.js";import{e as M}from"./class-map-B4JAXzar.js";import{o as E}from"./if-defined-D42BvxAV.js";const W=P`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`;var U=Object.defineProperty,c=(a,e,r,n)=>{for(var t=void 0,d=a.length-1,h;d>=0;d--)(h=a[d])&&(t=h(e,r,t)||t);return t&&U(e,r,t),t};class m extends L(z){constructor(){super(...arguments),this.disabled=!1,this.invalid=!1,this.required=!1}static{this.shadowRootOptions={...z.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[j,W]}#r;#e(){const e=this.querySelectorAll("w-slider-thumb");for(const r of e.values())r.min=this.min,r.max=this.max,r.step=this.step,r.suffix=this.suffix,r.formatter=this.formatter,r.ariaLabel||(r.slot||(r.ariaLabel=this.label),r.slot==="from"&&(r.ariaLabel=`${this.label} min`),r.slot==="to"&&(r.ariaLabel=`${this.label} max`)),r.forceDisabled=this.disabled,r.forceInvalid=this.invalid,this.#a(r)}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.style.setProperty("--min",this.min),this.style.setProperty("--max",this.max),this.markers&&this.style.setProperty("--markers",String(this.markers));const e=getComputedStyle(this.shadowRoot.querySelector(".w-slider"));this.#r=Number.parseFloat(e.getPropertyValue("--w-slider-thumb-size").replace("px","")),this.#e()}updated(e){(e.has("disabled")||e.has("invalid")||e.has("required")||e.has("min")||e.has("step")||e.has("max")||e.has("suffix")||e.has("formatter"))&&this.#e()}#t(e){const r=e.target;this.#a(r)}#i(e){e.stopPropagation(),this.invalid=e.detail.invalid}#a(e){const r=e.slot;if(r){const n=this.#s(),t=this.#r,d=t-n;n<=t&&this.style.setProperty("--thumb-offset",String(d))}if(r||this.style.setProperty("--from","0"),r==="from"){const n=e.value??=this.min;this.style.setProperty("--from",n)}if(!r||r==="to"){const n=e.value??=this.max;this.style.setProperty("--to",n)}}#s(){const e=window.getComputedStyle(this.shadowRoot.querySelector(".w-slider__active-range"),"::before").width;return Number.parseFloat(e.replace("px",""))}render(){return o`
...
`,K=P`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var X=Object.defineProperty,s=(a,e,r,n)=>{for(var t=void 0,d=a.length-1,h;d>=0;d--)(h=a[d])&&(t=h(e,r,t)||t);return t&&X(e,r,t),t};class i extends L(z){constructor(){super(...arguments),this._invalid=!1,this._showTooltip=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...z.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[j,K,H]}#r(){this._showTooltip=!0}#e(){this._showTooltip=!1}#t(e){const r=e.detail?.value;r&&this._invalid&&(this._invalid=!1);const n=r||e.currentTarget.value,t=Number.parseInt(n),d=Number.parseInt(this.max),h=Number.parseInt(this.min);(t>d||t<h)&&(this._invalid=!0);let F=!1;if(this.slot){const C=getComputedStyle(this);if(this.slot==="from"){const p=C.getPropertyValue("--to");if(t>Number.parseInt(p)){if(r)return this._invalid=!0,!1;F=!0,this.value=p}}else{const p=C.getPropertyValue("--from");if(t<Number.parseInt(p)){if(r)return this._invalid=!0,!1;F=!0,this.value=p}}}return F?(e.preventDefault(),this.range.value=this.value,!1):(this.value=n,!0)}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:r}]=await Promise.all([B(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[]),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
        /*
      ...
      `,await r.call(this,{elements:[this.anchorPositioningStyleElement]})}catch(r){console.error(new Error("Error registering the CSS anchor positioning polyfill. The UI will look broken.",{cause:r}))}}this.range.value=this.value??this.max}updated(e){if(e.has("value")&&(this.setValue(this.value),!("anchorName"in document.documentElement.style))){const r=this.shadowRoot.querySelector("#target"),n=getComputedStyle(r).getPropertyValue("width"),t=Number.parseFloat(n.replace("px",""))/2;r.style.setProperty("margin-left",`-${t}px`)}e.has("_invalid")&&this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:this._invalid}}))}render(){return o`
    ...
    `}},w={args:{locale:"nb",suffix:"m²"},render({locale:a,suffix:e}){return o(N||(N=$([`
      ...
      <\/script>
    `])),e,a)}},g={args:{locale:"nb",suffix:"kr"},render({locale:a,suffix:e}){return o(I||(I=$([`
      ...
      <\/script>
    `])),e,a)}},v={args:{locale:"nb",suffix:"km"},render({locale:a,suffix:e}){return o(D||(D=$([`
      ...
      <\/script>
    `])),e,a)}},y={args:{locale:"nb",suffix:"km",step:"25000",markers:"25000"},render({locale:a,suffix:e,markers:r,step:n}){return o(R||(R=$([`
      ...
      <\/script>
    `])),r,n,e,a)}},x={args:{step:5},render({step:a}){return o`

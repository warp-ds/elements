import{i as e}from"./preload-helper-CwA5MRLW.js";import{E as t,Ht as n,J as r,K as i,Lt as a,M as o,N as ee,Rt as s,Wt as c,b as l,c as u,d,f,j as te,k as ne,l as p,o as m,p as h,q as g,s as _,u as v,w as y,x as b}from"./iframe-SOJ2hRXP.js";import{t as x}from"./attention-CjjjH95Z.js";import{t as S}from"./button-Bcljmyn7.js";import{n as C,r as w,t as T}from"./modal-footer-HFu_SflK.js";var E,re=e((()=>{a(),E=c`
    :host {
        display: block;
...
`})),H,U,W,G=e((()=>{r(),a(),k(),te(),j(),N(),F(),L(),z(),p(),V(),H={canClose:!0,duration:D.Short,variant:`neutral`},ne(M,I,P,A,R),U=/\s/,W=class extends s{static{this.styles=[v,B]}constructor(){super(),this.internals=this.attachInternals(),this.internals.ariaLive=`polite`,this.internals.role=`log`,this._onKeydown=this._onKeydown.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this._onKeydown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`keydown`,this._onKeydown)}_onKeydown(e){if(e.key===`Escape`){let e=this.shadowRoot?.host.querySelector(`w-snackbar-item:last-of-type`);e&&e.close()}else if(e.altKey&&e.key===`Enter`){e.preventDefault();let t=this.shadowRoot?.host.querySelector(`w-snackbar-item:last-of-type`);if(console.log(`Found item!`),t){let e=t.querySelector(`w-button[slot="action"]`);console.log(`Found action!`),e&&(e.click(),console.log(`Clicked!`))}}}create(e,t={}){let n={...H,...t},r=document.createElement(`w-snackbar-item`);if(n.duration&&(r.duration=n.duration),r.innerText=e,n.variant!==`neutral`){let e=document.createElement(`w-icon`);switch(e.slot=`icon`,n.variant){case`positive`:e.name=`SuccessFilled`;break;case`warning`:e.name=`WarningFilled`;break;case`negative`:e.name=`ErrorFilled`;break;case`info`:e.name=`InfoFilled`;break}r.prepend(e)}if(n.action){r.duration<D.Long&&(r.duration=D.Long);let e=document.createElement(`w-button`);e.slot=`action`,e.variant=`utilityQuiet`,e.small=!0;let{label:t,onclick:i,placement:a}=n.action;e.innerText=t;let o=document.createElement(`span`);o.classList.add(`sr-only`),o.innerHTML=`<kbd>${window.navigator.userAgent.includes(`Macintosh`)?`Option`:`Alt`}</kbd> + <kbd>Enter</kbd>`,e.append(o),e.onclick=t=>{let n=i.call(e,t);return t.defaultPrevented||r.close(),n},a?r.actionPlacement=a:U.test(t)&&(r.actionPlacement=`block`),r.append(e)}if(r.duration>D.Long&&(n.canClose=!0),n.canClose){let e=document.createElement(`w-button`);e.slot=`close`,e.variant=`utilityQuiet`,e.small=!0,e.iconOnly=!0,typeof n.canClose==`function`?e.onclick=t=>{let i=n.canClose.call(e,t);return t.defaultPrevented||r.close(),i}:e.onclick=r.close.bind(r);let t=document.createElement(`w-icon`);t.name=`Close`,t.size=`small`,t.ariaLabel=g.t({id:`snackbar.aria.close`,message:`Dismiss message`,comment:`Accessibility label for the button that closes the snackbar/toast popup`}),e.append(t),r.append(e)}return this.shadowRoot?.host.prepend(r),r}render(){return n`
        ...
        <div class="flex gap-8">
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short, but if it is not and spans multiple lines then the icon and actions should be centered vertically`,{variant:`positive`,duration:r,canClose:t})}}">Positive variant</w-button>
          ...
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{duration:r,canClose:t})}}">Neutral variant</w-button>
          
          <w-button @click="${()=>{let e=document.querySelector(`w-snackbar`).create(`The message should be short`,{duration:r,canClose:t}),n=document.createElement(`w-icon`);n.name=`Rocket`,n.slot=`icon`,e.prepend(n)}}">Neutral w/ icon</w-button>
        </div>
    `}},Z={render({duration:e,canClose:t}){let r=e===`Infinite`?D.Infinite:e===`10 seconds`?D.Long:D.Short;return n`
        <div class="flex gap-8">
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short, but if it is not and spans multiple lines then the icon and actions should be centered vertically`,{variant:`positive`,duration:r,canClose:t,action:{label:`Action`,onclick(){let e=document.getElementById(`with-action-modal`);e.show=!0}}})}}">Positive variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`warning`,duration:r,canClose:t,action:{label:`Action`,onclick(){let e=document.getElementById(`with-action-modal`);e.show=!0}}})}}">Warning variant</w-button>

          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`negative`,duration:r,canClose:t,action:{label:`Action`,onclick(){let e=document.getElementById(`with-action-modal`);e.show=!0}}})}}">Negative variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`info`,duration:r,canClose:t,action:{label:`Action`,onclick(){let e=document.getElementById(`with-action-modal`);e.show=!0}}})}}">Info variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{duration:r,canClose:t,action:{label:`Action`,onclick(){let e=document.getElementById(`with-action-modal`);e.show=!0}}})}}">Neutral variant</w-button>
        </div>
    ...
    `}},Q={render({duration:e,canClose:t}){let r=e===`Infinite`?D.Infinite:e===`10 seconds`?D.Long:D.Short;return n`
        <div class="flex gap-8">
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short, but if it is not and spans multiple lines then the icon and actions should be centered vertically`,{variant:`positive`,duration:r,canClose:t,action:{label:`Long action label`,onclick(){let e=document.getElementById(`with-long-action-modal`);e.show=!0}}})}}">Positive variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`warning`,duration:r,canClose:t,action:{label:`Long action label`,onclick(){let e=document.getElementById(`with-long-action-modal`);e.show=!0}}})}}">Warning variant</w-button>

          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`negative`,duration:r,canClose:t,action:{label:`Long action label`,onclick(){let e=document.getElementById(`with-long-action-modal`);e.show=!0}}})}}">Negative variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`info`,duration:r,canClose:t,action:{label:`Long action label`,onclick(){let e=document.getElementById(`with-long-action-modal`);e.show=!0}}})}}">Info variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{duration:r,canClose:t,action:{label:`Long action label`,onclick(){let e=document.getElementById(`with-long-action-modal`);e.show=!0}}})}}">Neutral variant</w-button>
        </div>

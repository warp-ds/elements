import{i as e}from"./preload-helper-CwA5MRLW.js";import{A as t,D as n,E as r,Ht as i,J as a,Kt as o,Lt as s,O as c,Rt as l,Wt as u,b as d,d as f,f as p,j as m,l as h,p as g,q as _,u as v}from"./iframe-C6p4gdWY.js";import{n as y,t as b}from"./form-control-EbCgjNJ6.js";var x,S=e((()=>{s(),x=u`
...
`})),C,w=e((()=>{s(),C=o(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.flex{display:flex}.static{position:static}`)})),T,E=e((()=>{n(),b(),a(),s(),d(),m(),h(),S(),w(),f(),g(),T=class extends y(l){constructor(...e){super(...e),this.ariaLabel=null,this.clear=!1,this.search=!1,this.label=``,this.icon=null}static{this.styles=[v,C,x]}get _wrapperClasses(){return c([this.label?`has-label`:`has-icon`])}resetContainingTextField(e){let t=this.closest(`w-textfield`);t&&t.resetFormControl(),e.stopPropagation()}submitContainingForm(e){let t=this.internals.form;t&&t.submit(),e.stopPropagation()}get _searchButton(){return i`
			<button
				part="wrapper"

import{a as u,i as s,r as b,x as v,n as o}from"./iframe-Cvgbux2v.js";import{e as g}from"./class-map-BXLCJIPJ.js";import{F as w}from"./FormControlMixin-DJnJZbro.js";const p=u`.w-button,
.w-button--secondary {
    ...
    }`;var h=Object.defineProperty,t=(n,a,d,k)=>{for(var e=void 0,i=n.length-1,c;i>=0;i--)(c=n[i])&&(e=c(a,d,e)||e);return e&&h(a,d,e),e};const l=["primary","secondary","negative","negativeQuiet","utility","utilityQuiet","pill","link"];class r extends w(s){static{this.shadowRootOptions={...s.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[b,p]}constructor(){super(),this.variant="secondary"}connectedCallback(){if(super.connectedCallback(),!l.includes(this.variant))throw new Error(`Invalid "variant" attribute. Set its value to one of the following:

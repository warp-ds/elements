      ...
      <div class="w-datepicker-wrapper" id="${Ne}">
        ...
        <div class="w-datepicker-input-wrapper">
          ...
          <w-button
            ...
            aria-label="${this.value?P.t({id:"datepicker.toggle.changeDate",values:{currentDate:C(this.value,this.dayFormat)},message:"Change date, {currentDate}",comment:"Used by screen readers to describe the button that toggles open the calendar in a date picker when there is a selected date"}):P.t({id:"datepicker.toggle.chooseDate",message:"Choose date",comment:"Used by screen readers to describe the button that toggles open the calendar in a date picker when there is no selected date"})}"
            variant="utility"
            quiet
            type="button"
            @click="${this.#a}">
            ...
            <div class="w-dropdown__popover w-dropdown__popover--open">
              <div
                ...
                <div class="w-datepicker__month-nav">
                  ...
                  <div class="w-datepicker__month__nav__header">${C(this.month,this.headerFormat,{locale:this.locale})}</div>
                  <w-button
                ...
                <div class="w-datepicker__month">
                  <table class="w-datepicker__table" role="grid">
                    <thead class="w-datepicker__weekdays">
                      <tr>
                        ${this.weeks[0].map(t=>M`<th class="w-datepicker__weekday">${C(t,this.weekdayFormat,{locale:this.locale})}</th> `)}
                      </tr>
                    </thead>
                    <tbody>
                      ${this.weeks.map(t=>M`<tr>
                            ${t.map(a=>{if(!ae(this.month,a))return M`<td></td>`;const n=this.isDayDisabled?this.isDayDisabled(a):!1,r=ye(a,this.selectedDate),i=a===this.navigationDate;return M`<td
                                aria-current="${X(ne(a)?"date":void 0)}"
                                aria-disabled="${n}"
                                aria-label="${C(a,this.dayFormat,{locale:this.locale})}"
                                aria-selected="${r}"

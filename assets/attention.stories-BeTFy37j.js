import{g as E,x as e}from"./iframe-uLWbraFA.js";import{s as c,p as v}from"./utilities-C0_nVcxZ.js";var p=Object.freeze,w=Object.defineProperty,n=(t,x)=>p(w(t,"raw",{value:p(t.slice())})),g,d,h,u,m,b;const{events:I,args:y,argTypes:f}=E("w-attention"),T={title:"Overlays/Attention",render(t){return e`
      <w-attention ${c(v(t))}>
        <button
          ${c({id:t.buttonId})}

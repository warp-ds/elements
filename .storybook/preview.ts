...
export const locales = {
	English:
		"en" /* Finnish: 'fi', Norwegian: 'nb', Danish: 'da', Swedish: 'sv' */,
};
...
export const rewriteStylesheets = (theme: string) => {
	...
	roots.forEach((root) => {
		...
		const tokensStylesheets = root.querySelectorAll(
			'link[rel="stylesheet"][href*="@warp-ds/css/v2/tokens/"]',
		);

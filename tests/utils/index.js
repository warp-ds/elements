export async function addContentToPage({ page, content }) {
  ...
  await page.addStyleTag({ url: 'https://assets.finn.no/pkg/@warp-ds/css/v2/tokens/finn-no.css' });
  await page.addStyleTag({ url: 'https://assets.finn.no/pkg/@warp-ds/css/v2/resets.css' });

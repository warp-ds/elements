...
export const Example = () => (
  <div>
    <div>
      <Icon name="Speedometer" size="small" locale="nb" />
      <Icon name="Speedometer" size="medium" locale="nb" />
      <Icon name="Speedometer" size="large" locale="nb" />
      <Icon name="Speedometer" size="42px" locale="nb" />
      <Icon name="Speedometer" size="64px" locale="nb" />
      <Icon name="Speedometer" size="96px" locale="nb" />
      <Icon name="Speedometer" size="128px" locale="nb" />
    </div>
    some text below
  </div>
);

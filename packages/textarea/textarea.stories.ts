...
export const MinLength: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates minlength validation. Type a short message and blur to see the validation error. The error clears when the minimum length is reached.',
      },
    },
  },
};
...
export const MaxLength: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates maxlength constraint. The browser prevents typing beyond the limit. Try typing more than 50 characters.',
      },
    },
  },
};

export const MinAndMaxLength: Story = {
  render: () => html`
    <form
      @submit=${(e: Event) => {
        e.preventDefault();
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Combines minlength and maxlength constraints. The message must be between 10 and 280 characters to submit successfully.',
      },
    },
  },
};

...
test("Box component with no attributes is rendered on the page", async (t) => {
  ...
  t.equal(
    await locator.getAttribute("bleed"),
    null,
    "Bleed attribute should be null",
  );
  t.equal(
    await locator.getAttribute("bordered"),
    null,
    "Bordered attribute should be null",
  );
  t.equal(
    await locator.getAttribute("info"),
    null,
    "Info attribute should be null",
  );
  t.equal(
    await locator.getAttribute("neutral"),
    null,
    "Neutral attribute should be null",
  );
});
...
test("Box component with bordered attribute", async (t) => {
  ...
  const locator = await page.locator("w-box");
  t.equal(
    await locator.evaluate((el) => el.bordered),
    true,
    "Bordered property should be true",
  );
  t.equal(
    await locator.getAttribute("bordered"),
    "",
    "Bordered attribute should be set",
  );
  t.equal(
    await locator.getAttribute("info"),
    null,
...
test("Box component with info attribute", async (t) => {
  ...
  t.equal(
    ...
    true,
    "Info property should be true",
  );
  t.equal(
    await locator.getAttribute("info"),
    "",
    "Info attribute should be set",
  );
});
...
test("Box component with neutral attribute", async (t) => {
  ...
  const locator = await page.locator("w-box");
  t.equal(
    await locator.evaluate((el) => el.neutral),
    true,
    "Neutral property should be true",
  );
  t.equal(
    await locator.getAttribute("neutral"),
    "",
    "Neutral attribute should be set",
  );
});
...
test("Box component with bleed attribute", async (t) => {
  ...
  t.equal(
    ...
    true,
    "Bleed property should be true",
  );
  t.equal(
    await locator.getAttribute("bleed"),
    "",
    "Bleed attribute should be set",
  );
});
...
test("Box component with paragraph child elements", async (t) => {
  ...
  t.equal(
    await page.locator("w-box p").count(),
    3,

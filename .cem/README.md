...
See [Custom Elements Manifest from Open WC](https://custom-elements-manifest.open-wc.org/analyzer/getting-started/#demo) and [Web Components Toolkit](https://wc-toolkit.com/cem-utilities/overview/) to learn more.

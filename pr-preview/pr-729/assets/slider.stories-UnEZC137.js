import{a as e,i as t,n,t as r}from"./preload-helper-xPQekRTU.js";import{Bt as i,E as a,Ht as o,J as s,K as c,Kt as l,Lt as u,M as d,N as f,Rt as p,Wt as m,b as ee,f as h,h as te,j as ne,k as re,l as g,m as ie,p as _,q as v,u as y,w as b,x}from"./iframe-ihHcNuh3.js";import{n as ae,t as oe}from"./form-control-DtXadPi-.js";import{t as se}from"./affix-C6_WRrub.js";import{r as S,t as ce}from"./if-defined-CS24ACXJ.js";import{t as le}from"./attention-C-WvIJmA.js";import{n as ue,t as C}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as de}from"./tooltip-DpLuTpYE.js";import{t as fe}from"./textfield-BGbec9cj.js";var pe,me=t((()=>{pe=JSON.parse(`{"select.label.optional":["Valgfri"],"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),he,ge=t((()=>{he=JSON.parse(`{"select.label.optional":["Optional"],"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),_e,ve=t((()=>{_e=JSON.parse(`{"select.label.optional":["Valinnainen"],"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),ye,be=t((()=>{ye=JSON.parse(`{"select.label.optional":["Valgfri"],"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),xe,Se=t((()=>{xe=JSON.parse(`{"select.label.optional":["Valfritt"],"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),Ce,we=t((()=>{u(),Ce=m`
	.w-slider {
		position: relative;
		border: none;
		padding: 0;
...
`})),w,Te=t((()=>{u(),ee(),s(),ne(),g(),me(),ge(),ve(),be(),Se(),we(),_(),w=class extends p{static{this.shadowRootOptions={...p.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[y,Ce,m`
			:host {
		...
		`}},h([a({reflect:!0})],w.prototype,`label`,void 0),h([a({type:String,reflect:!0})],w.prototype,`tooltip`,void 0),h([a({type:Boolean,reflect:!0})],w.prototype,`disabled`,void 0),h([a({type:Boolean,attribute:`open-ended`})],w.prototype,`openEnded`,void 0),h([a({type:String,reflect:!0})],w.prototype,`error`,void 0),h([a({type:String,reflect:!0,attribute:`help-text`})],w.prototype,`helpText`,void 0),h([a({type:Boolean,reflect:!0})],w.prototype,`invalid`,void 0),h([a({type:Boolean,reflect:!0})],w.prototype,`required`,void 0),h([a({type:Boolean,reflect:!0})],w.prototype,`optional`,void 0),h([a({reflect:!0})],w.prototype,`min`,void 0),h([a({reflect:!0})],w.prototype,`max`,void 0),h([a({type:Number,reflect:!0})],w.prototype,`markers`,void 0),h([a({type:Number,reflect:!0})],w.prototype,`step`,void 0),h([a({reflect:!0})],w.prototype,`suffix`,void 0),h([a({type:Boolean,reflect:!0,attribute:`hidden-textfield`})],w.prototype,`hiddenTextfield`,void 0),h([a({attribute:!1})],w.prototype,`valueFormatter`,void 0),h([a({attribute:!1})],w.prototype,`tooltipFormatter`,void 0),h([a({attribute:!1})],w.prototype,`labelFormatter`,void 0),h([x(`fieldset`)],w.prototype,`fieldset`,void 0),h([b()],w.prototype,`_invalidMessage`,void 0),h([b()],w.prototype,`_hasInternalError`,void 0),h([b()],w.prototype,`_showError`,void 0),h([b()],w.prototype,`_tabbableElements`,void 0),h([b()],w.prototype,`_hasLabel`,void 0),customElements.get(`w-slider`)||customElements.define(`w-slider`,w)})),T,Ee=t((()=>{u(),T=l(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`)})),E,De=t((()=>{u(),E=m`
	.w-slider-thumb {
		position: relative;
		display: grid;
      ...
      `,await t({roots:[this.shadowRoot],elements:[this.anchorPositioningStyleElement]})}catch(e){console.error(Error(`Error registering the CSS anchor positioning polyfill. The UI will look broken.`,{cause:e}))}}let e=window.navigator.userAgent;D.test(e)&&!O.test(e)&&this.tooltipTarget&&this.tooltipTarget.style.setProperty(`--transform-offset`,`var(--w-slider-thumb-size, 28px)`),this.#r()}get boundaryValue(){return this.slot===`from`?this.min:this.max}get textFieldDisplayValue(){return this._inputHasFocus&&this.value===``?this.range?.value?Math.min(Math.max(Number(this.range.value),Number(this.min)+1),Number(this.max)-1).toString():``:this.value}get tooltipDisplayValue(){let e;return e=this.tooltipFormatter?this.tooltipFormatter(this.value,this.slot):this.valueFormatter?this.valueFormatter(this.value,this.slot):this.value===``?this.range?.value??this.boundaryValue:this.value||0,e}get ariaDescriptionText(){let e=``,t=this.ariaDescription||``,n=this.value===``;return this.openEnded&&n&&(e=this.slot===`from`?v.t({id:`slider.placeholder.from`,message:`Min`}):v.t({id:`slider.placeholder.to`,message:`Max`})),e?`${e}, ${t}`:t}updated(e){if(e.has(`openEnded`)&&this.openEnded&&!this.placeholder&&(this.slot===`to`||this.slot===``?this.placeholder=v.t({id:`slider.placeholder.to`,message:`Max`,comment:`Max as in short for Maximum`}):this.slot===`from`&&(this.placeholder=v.t({id:`slider.placeholder.from`,message:`Min`,comment:`Min as in short for Minimum`}))),e.has(`value`)){this.#e===void 0&&this.value!==void 0&&(this.#e=this.value),this.setValue(this.value),this.#r();let t=e.get(`value`);this.value===``&&t&&this.dispatchEvent(new CustomEvent(`thumbreset`,{bubbles:!0}))}}render(){let e=this.placeholder&&!this.value;return o`
			<div class="w-slider-thumb">
				...
				${this.slot===`from`||!this.slot?o` <span class="sr-only">
							${v.t({id:`slider.label.from`,message:`From`})+` `+(this.labelFormatter?this.labelFormatter(`from`):this.min)+`, `+v.t({id:`slider.label.to`,message:`To`})+` `+(this.labelFormatter?this.labelFormatter(`to`):this.max)}
						</span>`:i}
		...
		`}},h([a({attribute:`aria-label`})],k.prototype,`ariaLabel`,void 0),h([a({attribute:`aria-description`})],k.prototype,`ariaDescription`,void 0),h([a({reflect:!0})],k.prototype,`name`,void 0),h([a({reflect:!0})],k.prototype,`value`,void 0),h([a({type:Boolean,reflect:!0})],k.prototype,`disabled`,void 0),h([a({type:Boolean,reflect:!0})],k.prototype,`invalid`,void 0),h([a({attribute:!1,reflect:!1})],k.prototype,`openEnded`,void 0),h([a({reflect:!0})],k.prototype,`placeholder`,void 0),h([b()],k.prototype,`markers`,void 0),h([b()],k.prototype,`required`,void 0),h([b()],k.prototype,`step`,void 0),h([b()],k.prototype,`min`,void 0),h([b()],k.prototype,`max`,void 0),h([b()],k.prototype,`suffix`,void 0),h([a({attribute:!1})],k.prototype,`valueFormatter`,void 0),h([a({attribute:!1})],k.prototype,`tooltipFormatter`,void 0),h([a({attribute:!1})],k.prototype,`labelFormatter`,void 0),h([x(`input[type="range"]`)],k.prototype,`range`,void 0),h([x(`.w-slider-thumb__tooltip-target`)],k.prototype,`tooltipTarget`,void 0),h([x(`w-textfield`)],k.prototype,`textfield`,void 0),h([b()],k.prototype,`_showTooltip`,void 0),h([b()],k.prototype,`_inputHasFocus`,void 0),h([b()],k.prototype,`_hiddenTextfield`,void 0),customElements.get(`w-slider-thumb`)||customElements.define(`w-slider-thumb`,k)})),ke=e({CustomError:()=>J,Description:()=>Y,HiddenMinimumMaximumLabels:()=>Z,Marks:()=>U,OpenEnded:()=>G,Range:()=>L,RangeError:()=>q,RangeOptional:()=>R,RangeWithTooltip:()=>z,Single:()=>N,SingleDisabled:()=>P,SingleError:()=>K,SingleOptional:()=>F,SingleWithTooltip:()=>I,Step:()=>W,SuffixCurrency:()=>V,SuffixKilometers:()=>H,SuffixSquareMeters:()=>B,VisuallyHiddenLabel:()=>X,VisuallyHiddenTextfield:()=>Q,__namedExportsOrder:()=>$,default:()=>M}),Ae,je,Me,Ne,Pe,Fe,A,j,Ie,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,Le=t((()=>{f(),u(),c(),se(),le(),fe(),de(),Te(),Oe(),ue(),{events:A,args:j,argTypes:Ie}=d(`w-slider`),M={title:`Forms/Slider and Range Slider`,args:j,argTypes:Ie,parameters:{actions:{handles:A}}},N={render(){return o`
            <form>
        ...
        `}},I={args:{optional:!0,required:!1},render({optional:e,required:t}){return o`
            <form>
                <w-slider
                    label="Single"
        ...
        `}},z={args:{optional:!0,required:!1},render({optional:e,required:t}){return o`
            <form>
                <w-slider
                    label="Range"
                    min="0"
        ...
        `}},V={args:{locale:`nb`,suffix:`kr`},render({locale:e,suffix:t}){return o(Ae||=C([`
            <w-slider
                label="Price"
                min="0"
                max="250000"
            ...
            <\/script>
        `]),t,e)}},H={args:{locale:`nb`,suffix:`km`},render({locale:e,suffix:t}){return o(je||=C([`
            <w-slider
                label="Distance"
                min="0"
                max="250000"
        ...
        `}},Z={render(){return o(Pe||=C([`
            ...
            <\/script>
        `]))}},Q={render({locale:e}){return o(Fe||=C([`
...
}`,...Q.parameters?.docs?.source}}},$=[`Single`,`SingleDisabled`,`SingleOptional`,`SingleWithTooltip`,`Range`,`RangeOptional`,`RangeWithTooltip`,`SuffixSquareMeters`,`SuffixCurrency`,`SuffixKilometers`,`Marks`,`Step`,`OpenEnded`,`SingleError`,`RangeError`,`CustomError`,`Description`,`VisuallyHiddenLabel`,`HiddenMinimumMaximumLabels`,`VisuallyHiddenTextfield`]}));Le();export{J as CustomError,Y as Description,Z as HiddenMinimumMaximumLabels,U as Marks,G as OpenEnded,L as Range,q as RangeError,R as RangeOptional,z as RangeWithTooltip,N as Single,P as SingleDisabled,K as SingleError,F as SingleOptional,I as SingleWithTooltip,W as Step,V as SuffixCurrency,H as SuffixKilometers,B as SuffixSquareMeters,X as VisuallyHiddenLabel,Q as VisuallyHiddenTextfield,$ as __namedExportsOrder,M as default,ke as n,Le as t};
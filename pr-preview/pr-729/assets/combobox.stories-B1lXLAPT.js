			...
			>
				...
				>
					<ul
						...
						class="${M.listbox}"
					>
						${ie(this._currentOptions,e=>e.key,e=>{let t=e.label||e.value;return r`
									<li
										id=${e.id}
										role="option"

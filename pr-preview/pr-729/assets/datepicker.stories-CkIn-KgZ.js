...
`}));function rf(e){if(typeof e!=`string`)return null;let t=e;cf.test(e)&&(t=`${e}T00:00:00Z`);let n=Date.parse(t);return Number.isNaN(n)?null:new Date(n)}function af(e=typeof navigator<`u`?navigator.userAgent:``){let t=lf.test(e),n=uf.test(e)&&!df.test(e);return t||n?`text`:`date`}function of(e){let t=e===`en`?`en-GB`:e;return new Intl.DateTimeFormat(t,{day:`2-digit`,month:`2-digit`,year:`numeric`,timeZone:`UTC`}).formatToParts(new Date(Date.UTC(2006,0,2))).map(e=>e.type===`day`?`dd`:e.type===`month`?`mm`:e.type===`year`?`yyyy`:e.value).join(``)}function sf(e,t){if(!cf.exec(e))return e;let[n,r,i]=e.split(`-`);return of(t).replace(`yyyy`,n).replace(`mm`,r).replace(`dd`,i)}var cf,lf,uf,df,ff=t((()=>{cf=/^\d{4}-\d{2}-\d{2}$/,lf=/iP(hone|od|ad)/,uf=/Safari/,df=/(Chrome|Chromium|CriOS|FxiOS|Edg|OPR|Android)/})),pf,G,mf,hf,gf,K,q,J,_f=t((()=>{s(),be(),$o(),jd(),c(),oe(),fe(),xe(),Id(),se(),le(),de(),Rd(),Bd(),Hd(),Wd(),Kd(),Xd(),Qd(),ef(),nf(),ff(),pe(),pf=af(),G=`calendar`,mf=`input`,hf=`toggle`,gf=`wrapper`,K=`previous`,q={en:lc,nb:yu,sv:_d,da:Zs,fi:sl},J=class extends ye(ee){static{this.shadowRootOptions={...ee.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[me,qd,Jd,Yd,Zd,$d,tf]}get selectedDate(){return this.value?rf(this.value)??null:null}get month(){return cn(this.navigationDate)}#e;get weeks(){let e=this.month,t=this.navigationDate,n=an({start:cn(e),end:ki(e)},{locale:this.locale}).map(e=>({start:e,end:vn(e,{locale:this.locale})})).map(e=>Zt(e));if(la(t,e)){let e=Di(t,{locale:this.locale})-1,r=Qe(t,T(t,{locale:this.locale}));n[e][r]=t}return n}get#t(){return this.lang||n()||`en`}get#n(){return pf===`text`&&this.value?sf(this.value,this.#t):this.value||``}async#r(e){e.preventDefault(),this.isCalendarOpen=!this.isCalendarOpen,this.isCalendarOpen&&(await this.updateComplete,(this.selectedCell||this.todayCell).focus())}#i(){this.navigationDate=Ie(this.month,1)}#a(){this.navigationDate=Ro(this.month,1)}async#o(){await this.updateComplete,this.input.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}_onClickOutside(e){this.isCalendarOpen&&(this.contains(e.target)||(this.isCalendarOpen=!1))}#s(e){this.value=e.target.value}#c(){this.#h=!0,this.#y()}#l(e){e.preventDefault(),this.isCalendarOpen=!0}#u(e){if(e.key===` `)return this.#r(e);e.key===`,`&&e.preventDefault(),e.key===`Enter`&&this.internals.form&&this.internals.form.requestSubmit()}async#d(e){let t=this.navigationDate,n=null;switch(e.key){case`ArrowUp`:n=Aa(t,7);break;case`ArrowLeft`:n=Aa(t,1);break;case`Home`:n=T(t,{locale:this.locale});break;case`PageUp`:n=Ro(t,1);break;case`ArrowDown`:n=S(t,7);break;case`ArrowRight`:n=S(t,1);break;case`End`:n=vn(t,{locale:this.locale});break;case`PageDown`:n=Ie(t,1);break;case`Escape`:this.isCalendarOpen=!1;break;case`Tab`:e.target.tagName===`TD`&&!e.shiftKey?(e.preventDefault(),this.previousMonthButton.focus()):e.target.id===K&&e.shiftKey&&(e.preventDefault(),(this.selectedCell||this.todayCell).focus());break}n&&(e.preventDefault(),this.navigationDate=n,await this.updateComplete,this.selectedCell.focus())}#f(e){let t=e.currentTarget.dataset.date;`key`in e?(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.value=t,this.input.value=this.#n,this.#y(),this.isCalendarOpen=!1,this.toggleButton.focus(),this.#o()):(this.value=t,this.input.value=this.#n,this.#y(),this.isCalendarOpen=!1,this.#o())}#p;#m;#h;constructor(){super(),this.required=!1,this.optional=!1,this.invalid=!1,this.disabled=!1,this.readonly=!1,this.headerFormat=`MMMM yyyy`,this.weekdayFormat=`EEEEEE`,this.dayFormat=`PPPP`,this.isCalendarOpen=!1,this.navigationDate=Po(),this.locale=lc,this.#e=void 0,this.#p=!1,this.#m=void 0,this.#h=!1,this.#v=e=>{e.preventDefault(),this.#h=!0,this.#y()},ue(zd,Ud,Vd,Ld,Gd);let e=n();e&&q[e]&&(this.locale=q[e]),this._onClickOutside=this._onClickOutside.bind(this)}resetFormControl(){this.value=this.#e,this.#h=!1,this.#_(),this.#y()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}get _error(){if(this.invalid&&this.helpText)return this.helpText}checkValidity(){return this.#y(),this.internals.checkValidity()}reportValidity(){return this.#h=!0,this.#y(),this.internals.checkValidity()}setCustomValidity(e){e?(this.internals.setValidity({customError:!0},e,this.input),this.#g(e)):(this.#_(),this.#y())}#g(e){this.#p||(this.#m=this.helpText),this.#p=!0,this.invalid=!0,this.helpText=e}#_(){this.#p&&=(this.invalid=!1,this.helpText=this.#m,this.#m=void 0,!1)}#v;#y(){if(this.disabled){this.internals.setValidity({}),this.#_();return}if(this.required&&!this.value){let e=this.input?.validationMessage||``;this.internals.setValidity({valueMissing:!0},e,this.input),this.#h&&this.#g(e);return}this.internals.setValidity({}),this.#_()}connectedCallback(){super.connectedCallback(),this.#e=this.value,this.value!==void 0&&this.setValue(this.value),this.addEventListener(`invalid`,this.#v);let e=this.lang;if(e&&q[e]&&(this.locale=q[e]),this.value){let e=rf(this.value);e&&(this.navigationDate=e)}document.addEventListener(`mousedown`,this._onClickOutside),document.addEventListener(`touchend`,this._onClickOutside),document.addEventListener(`focusin`,this._onClickOutside)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`invalid`,this.#v),document.removeEventListener(`mousedown`,this._onClickOutside),document.removeEventListener(`touchend`,this._onClickOutside),document.removeEventListener(`focusin`,this._onClickOutside)}updated(e){e.has(`value`)&&this.value!==void 0&&this.setValue(this.value),(e.has(`value`)||e.has(`required`)||e.has(`disabled`))&&this.#y()}firstUpdated(e){super.firstUpdated(e),this.#y()}render(){return o`
			<div class="w-datepicker-wrapper" id="${gf}">
				<label class="w-datepicker-input-label" for="${mf}">
					${this.label}
				...
				<div class="w-datepicker-input-wrapper">
					<input
						...
						type="${pf}"
						name="${g(this.name)}"
						placeholder="${g(pf===`text`?of(this.#t):void 0)}"
						.value="${this.#n}"
			...
			<div
				...
				style="${Pd({display:this.isCalendarOpen?void 0:`none`})}"
			>
				<div
		...
		`}},f([i({reflect:!0})],J.prototype,`label`,void 0),f([i({type:Boolean,reflect:!0})],J.prototype,`required`,void 0),f([i({type:Boolean,reflect:!0})],J.prototype,`optional`,void 0),f([i({type:String,reflect:!0,attribute:`help-text`})],J.prototype,`helpText`,void 0),f([i({type:Boolean,reflect:!0})],J.prototype,`invalid`,void 0),f([i({type:String,reflect:!0})],J.prototype,`tooltip`,void 0),f([i({reflect:!0})],J.prototype,`lang`,void 0),f([i({reflect:!0})],J.prototype,`name`,void 0),f([i({reflect:!0})],J.prototype,`value`,void 0),f([i({type:Boolean,reflect:!0})],J.prototype,`disabled`,void 0),f([i({type:Boolean,reflect:!0})],J.prototype,`readonly`,void 0),f([i({attribute:`header-format`})],J.prototype,`headerFormat`,void 0),f([i({attribute:`weekday-format`})],J.prototype,`weekdayFormat`,void 0),f([i({attribute:!1})],J.prototype,`isDayDisabled`,void 0),f([i({attribute:`day-format`})],J.prototype,`dayFormat`,void 0),f([m()],J.prototype,`isCalendarOpen`,void 0),f([m()],J.prototype,`navigationDate`,void 0),f([m()],J.prototype,`locale`,void 0),f([m()],J.prototype,`selectedDate`,null),f([m()],J.prototype,`month`,null),f([m()],J.prototype,`weeks`,null),f([h(`#${G}`)],J.prototype,`calendar`,void 0),f([h(`#${mf}`,!0)],J.prototype,`input`,void 0),f([h(`#${hf}`,!0)],J.prototype,`toggleButton`,void 0),f([h(`#${gf}`,!0)],J.prototype,`wrapper`,void 0),f([h(`#${K}`)],J.prototype,`previousMonthButton`,void 0),f([h(`[aria-current="date"]`)],J.prototype,`todayCell`,void 0),f([h(`[data-navigation="true"]`)],J.prototype,`selectedCell`,void 0),customElements.get(`w-datepicker`)||customElements.define(`w-datepicker`,J)})),vf=e({Default:()=>Y,DisableCalendarDates:()=>$,Invalid:()=>Z,WithHelpText:()=>X,WithTooltip:()=>Q,__namedExportsOrder:()=>Tf,default:()=>wf}),yf,bf,xf,Sf,Cf,wf,Y,X,Z,Q,$,Tf,Ef=t((()=>{_e(),u(),c(),ve(),Se(),Te(),_f(),Ce(),{events:xf,args:Sf,argTypes:Cf}=l(`w-datepicker`),wf={title:`Forms/Datepicker`,render(e){return o(yf||=we([`
        ...
        `]),he(ge(e)))},args:Sf,argTypes:Cf,parameters:{actions:{handles:xf}}},Y={args:{label:`Date`}},X={args:{label:`Date`,optional:!0,required:!1,helpText:`Help text is available`}},Z={args:{label:`Date`,invalid:!0,helpText:`Description of how to fix the problem`}},Q={args:{label:`Date`,optional:!0,required:!1,helpText:`Help text is available, but might not be enough, or the added context is not important enough that we use help-text`,tooltip:`This tooltip adds supplementary information`}},$={args:{label:`Date`},render(e){return o(bf||=we([`
            <!-- Workaround for Storybook's overflow hidden -->
            <div style="min-height: 400px">
                <w-datepicker `,`></w-datepicker>
            </div>
            ...
            <\/script>
        `]),he(ge(e)))}},Y.parameters={...Y.parameters,docs:{...Y.parameters?.docs,source:{originalSource:`{
  args: {
    label: "Date"
  }
...
}`,...$.parameters?.docs?.source}}},Tf=[`Default`,`WithHelpText`,`Invalid`,`WithTooltip`,`DisableCalendarDates`]}));Ef();export{Y as Default,$ as DisableCalendarDates,Z as Invalid,X as WithHelpText,Q as WithTooltip,Tf as __namedExportsOrder,wf as default,Ef as n,vf as t};
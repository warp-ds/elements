import{i as e}from"./preload-helper-CT_b8DTk.js";import{a as t,c as n,h as r,l as i,n as a,s as o,t as s,y as c}from"./decorators-CPAv1fbk.js";import{C as l,M as u,N as ee,P as te,S as ne,c as d,d as f,f as p,l as m,o as h,p as g,s as _,u as v,x as y,y as b}from"./iframe-Bsse8mc5.js";import{t as x}from"./attention-mGTCIOts.js";import{t as S}from"./button-S7ohxivb.js";import{n as C,r as w,t as T}from"./modal-footer-Cc4y2kfR.js";var E,re=e((()=>{n(),E=c`
	:host {
		display: block;
...
`})),D,O,k=e((()=>{n(),s(),d(),m(),re(),g(),D=function(e){return e[e.Short=4e3]=`Short`,e[e.Long=1e4]=`Long`,e[e.Infinite=12e7]=`Infinite`,e}({}),O=class extends i{constructor(...e){super(...e),this.actionPlacement=`inline`,this.duration=4e3,this.hasAction=!1,this.#e=!1,this.#t=4e3,this.#n=null,this.#r=null,this.#i=!1}static{this.styles=[v,E]}#e;#t;#n;#r;#i;connectedCallback(){if(super.connectedCallback(),this.duration!==12e7){let e=1e3;this.#t=this.duration-e,this.#r=setInterval(()=>{this.#i||(this.#t-=e,this.#t<=0&&this.close())},e)}}disconnectedCallback(){this.#r&&clearInterval(this.#r)}async updated(){this.root&&(this.#e||(await this.updateComplete,_(this.root,()=>{this.#e=!0})))}close(){this.#n&&this.#n.focus(),this.#e&&this.root?h(this.root,()=>{this.remove()}):this.remove()}#a(e){this.#n||(this.#i=!0,e.relatedTarget&&e.relatedTarget.focus&&(this.#n=e.relatedTarget))}#o(e){(!e.relatedTarget||!this.shadowRoot?.host.contains(e.relatedTarget))&&(this.#i=!1,this.#n=null)}#s(){this.#i=!0}#c(){this.#n||(this.#i=!1)}#l(){let e=this.shadowRoot?.querySelector(`slot[name="action"]`);return e?e.assignedElements().length>0:!1}firstUpdated(){this.hasAction=this.#l()}render(){if(this.hasAction&&document.documentElement.dataset.wKeyboardinteraction===`true`){let e=window.navigator.userAgent.includes(`Macintosh`)?`⌥`:`Alt`;return r`

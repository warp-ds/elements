...
`})),w,he=t((()=>{w=JSON.parse(`{"textarea.label.optional":["Valgfri"]}`)})),T,E=t((()=>{T=JSON.parse(`{"textarea.label.optional":["Optional"]}`)})),D,O=t((()=>{D=JSON.parse(`{"textarea.label.optional":["Valinnainen"]}`)})),k,A=t((()=>{k=JSON.parse(`{"textarea.label.optional":["Valgfri"]}`)})),j,M=t((()=>{j=JSON.parse(`{"textarea.label.optional":["Valfritt"]}`)})),N,P,F=t((()=>{ae(),te(),v(),d(),ee(),de(),m(),pe(),x(),me(),oe(),he(),E(),O(),A(),M(),s(),N={base:`block text-m leading-m mb-0 px-8 py-12 rounded-4 w-full focusable focus:[--w-outline-offset:-2px] caret-current`,default:`border-1 s-text s-bg s-border-strong hover:s-border-strong-hover active:s-border-selected`,disabled:`border-1 s-text-disabled s-bg-disabled-subtle s-border-disabled pointer-events-none`,invalid:`border-1 s-text-negative s-bg s-border-negative hover:s-border-negative-hover outline-[--w-s-color-border-negative]!`,readOnly:`pl-0 bg-transparent pointer-events-none`,placeholder:`placeholder:s-text-placeholder`,suffix:`pr-40`,prefix:`pl-[var(--w-prefix-width,_40px)]`,textArea:`min-h-[42] sm:min-h-[45]`,fixed:`resize-none`},P=class extends _(i){static{this.shadowRootOptions={...i.shadowRootOptions,delegatesFocus:!0}}#e;#t;#n;#r;#i;constructor(){super(),this.disabled=!1,this.invalid=!1,this.readOnly=!1,this.readonly=!1,this.required=!1,this.optional=!1,this.minHeight=-1/0,this.maxHeight=1/0,this.#e=void 0,this.#t=fe(`textarea-`),this.#n=!1,this.#r=void 0,this.#i=!1,this.#l=e=>{e.preventDefault(),this.#i=!0,this.#s()},ne(T,k,D,w,j)}updated(e){e.has(`value`)&&this.value!==void 0&&this.setValue(this.value),(e.has(`value`)||e.has(`required`)||e.has(`disabled`))&&this.#s()}resetFormControl(){this.value=this.#e,this.#i=!1,this.#o(),this.#s()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#s(),this.internals.checkValidity()}reportValidity(){return this.#i=!0,this.#s(),this.internals.checkValidity()}setCustomValidity(e){e?(this.internals.setValidity({customError:!0},e,this._textarea),this.#a(e)):(this.#o(),this.#s())}#a(e){this.#n||(this.#r=this.helpText),this.#n=!0,this.invalid=!0,this.helpText=e}#o(){this.#n&&=(this.invalid=!1,this.helpText=this.#r,this.#r=void 0,!1)}#s(){if(this.disabled){this.internals.setValidity({}),this.#o();return}if(this.required&&!this.value){let e=this._textarea?.validationMessage||``;this.internals.setValidity({valueMissing:!0},e,this._textarea),this.#i&&this.#a(e);return}this.internals.setValidity({}),this.#o()}static{this.styles=[h,b,S,C]}get _textareaStyles(){return ie([N.base,N.textArea,!!this.placeholder&&N.placeholder,!this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&N.default,this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&N.invalid,!this.invalid&&this.disabled&&!(this.readonly||this.readOnly)&&N.disabled,!this.invalid&&!this.disabled&&(this.readonly||this.readOnly)&&N.readOnly,this.maxRows&&N.fixed])}get _helptextstyles(){return`help-text`}get _helpId(){if(this.helpText)return`${this._id}__hint`}get _id(){return this.#t}get _error(){if(this.invalid&&this._helpId)return this._helpId}async connectedCallback(){if(super.connectedCallback(),this.#e=this.value,this.value!==void 0&&this.setValue(this.value),this.addEventListener(`invalid`,this.#l),await this.updateComplete,this.value||this.minRows){let e=this.shadowRoot?.querySelector(`textarea`);e&&this.#u(e)}}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`invalid`,this.#l)}firstUpdated(e){super.firstUpdated(e),this.#s()}handler(e){let t=e.currentTarget;this.value=t.value,this.#u(t)}#c(){this.#i=!0,this.#s()}#l;#u(e){let t=getComputedStyle(e),n=Number.parseFloat(t.getPropertyValue(`border-top-width`)),r=Number.parseFloat(t.getPropertyValue(`border-bottom-width`)),i=Number.parseFloat(t.getPropertyValue(`line-height`)),a=Number.parseFloat(t.getPropertyValue(`padding-top`))+Number.parseFloat(t.getPropertyValue(`padding-bottom`))+r+n;this.minRows&&(this.minHeight=i*this.minRows+a),this.maxRows&&(this.maxHeight=i*this.maxRows+a);let o=e.scrollHeight+n+r,s=Math.min(this.maxHeight,Math.max(this.minHeight,o));e.style.setProperty(`height`,s+`px`)}render(){return r`
			${this.label?r`
						<label for="${this._id}">
							${this.label}
							${this.optional&&!this.required?r`
										<span>
											${p._({id:`textarea.label.optional`,message:`Optional`,comment:`Shown behind label when marked as optional`})}
										</span>
									`:c}
						</label>
					`:c}
		...
		`}},u([o({type:Boolean,reflect:!0})],P.prototype,`disabled`,void 0),u([o({type:Boolean,reflect:!0})],P.prototype,`invalid`,void 0),u([o({type:String,reflect:!0})],P.prototype,`label`,void 0),u([o({type:String,reflect:!0,attribute:`help-text`})],P.prototype,`helpText`,void 0),u([o({type:Number,reflect:!0,attribute:`maximum-rows`})],P.prototype,`maxRows`,void 0),u([o({type:Number,reflect:!0,attribute:`minimum-rows`})],P.prototype,`minRows`,void 0),u([o({type:String,reflect:!0})],P.prototype,`name`,void 0),u([o({type:String,reflect:!0})],P.prototype,`placeholder`,void 0),u([o({type:Boolean,reflect:!0,attribute:`read-only`})],P.prototype,`readOnly`,void 0),u([o({type:Boolean,reflect:!0})],P.prototype,`readonly`,void 0),u([o({type:Boolean,reflect:!0})],P.prototype,`required`,void 0),u([o({type:String,reflect:!0})],P.prototype,`value`,void 0),u([o({type:Boolean,reflect:!0})],P.prototype,`optional`,void 0),u([l()],P.prototype,`minHeight`,void 0),u([l()],P.prototype,`maxHeight`,void 0),u([a(`textarea`)],P.prototype,`_textarea`,void 0),customElements.get(`w-textarea`)||customElements.define(`w-textarea`,P)})),I=e({Autofocus:()=>X,ControlledSize:()=>Y,Default:()=>V,Disabled:()=>K,FormParticipation:()=>Z,Invalid:()=>G,NoVisualLabel:()=>W,Optional:()=>J,ReadOnly:()=>q,WithHelpText:()=>U,WithPlaceholder:()=>H,__namedExportsOrder:()=>Q,default:()=>B}),L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=t((()=>{le(),g(),d(),ue(),F(),{events:L,args:R,argTypes:z}=re(`w-textarea`),B={title:`Forms/Textarea`,render(e){return r`<w-textarea ${se(ce(e))}></w-textarea>`},args:R,argTypes:z,parameters:{actions:{handles:L}}},V={args:{label:`Description`}},H={args:{label:`Description`,placeholder:`A Link to the Past is a distant prequel to the original The Legend of Zelda`}},U={args:{label:`Description`,"help-text":`You can provide a help text if necessary`}},W={args:{"aria-label":`Description`}},G={args:{label:`Description`,invalid:!0,"help-text":`A description is required`}},K={args:{label:`Description`,disabled:!0,value:`A Link to the Past is a distant prequel to the original The Legend of Zelda, and, within the official chronology, is the first game in the "Defeated Hero" timeline that connects to an alternate reality scenario where the Hero of Time does not succeed in Ocarina of Time.`}},q={args:{label:`Description`,"read-only":!0,value:`A Link to the Past is a distant prequel to the original The Legend of Zelda, and, within the official chronology, is the first game in the "Defeated Hero" timeline that connects to an alternate reality scenario where the Hero of Time does not succeed in Ocarina of Time.`}},J={args:{label:`Description`,optional:!0}},Y={args:{label:`Description`,"minimum-rows":3,"maximum-rows":3}},X={args:{label:`Description`,"minimum-rows":3,"maximum-rows":3,placeholder:`Refresh to see the autofocus take effect`,autofocus:!0}},Z={render:()=>r`
        <form

import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{c as n,h as r}from"./decorators-BoKEMuNh.js";import{C as i,S as a}from"./iframe-w5oojtxd.js";import{a as o,n as s,r as c,t as l}from"./utilities-DIER-odo.js";import{t as u}from"./affix-_V92jTyT.js";import{n as d,t as f}from"./taggedTemplateLiteral-C9cDEsPD.js";import{t as p}from"./textfield-BT4Eva0c.js";var m=t({Default:()=>b,Disabled:()=>w,FormParticipation:()=>N,Invalid:()=>C,Masking:()=>M,ReadOnly:()=>T,Required:()=>E,WithClearAffixResetTextfield:()=>k,WithHelpText:()=>S,WithIconAffix:()=>j,WithPlaceholder:()=>x,WithPrefix:()=>O,WithSearchAndClearAffixForm:()=>A,WithSuffix:()=>D,__namedExportsOrder:()=>P,default:()=>y}),h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F=e((()=>{c(),i(),n(),l(),p(),u(),d(),{events:g,args:_,argTypes:v}=a(`w-textfield`),y={title:`Forms/Textfield`,render(e){return r`<w-textfield ${o(s(e))}></w-textfield>`},args:_,argTypes:v,parameters:{actions:{handles:g}}},b={args:{label:`Email`,type:`email`}},x={args:{label:`Email`,placeholder:`user@example.com`,type:`email`}},S={args:{label:`Password`,"help-text":`Must be at least 8 characters`,type:`password`}},C={args:{label:`Email`,invalid:!0,"help-text":`Please enter a valid email address`,value:`invalid-email`,type:`email`}},w={args:{label:`Email`,disabled:!0,value:`user@example.com`,type:`email`}},T={args:{label:`Email`,"read-only":!0,value:`user@example.com`,type:`email`}},E={args:{label:`Email`,required:!0,type:`email`}},D={args:{label:`Price`,placeholder:`1 000 000`,type:`text`},render(e){return r`
            <w-textfield ${o(s(e))}>

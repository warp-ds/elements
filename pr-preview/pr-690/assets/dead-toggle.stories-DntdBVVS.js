import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{_ as n,d as r,l as i,n as a,r as o,t as s,u as c,x as l}from"./decorate-BxgRj7DM.js";import{b as u,l as d,u as f,x as p}from"./iframe-VqEg3fOI.js";import{a as m,n as h,r as g,t as _}from"./utilities-BGx-l0cq.js";var v,y=t((()=>{c(),v=l`
	[part~="label"] {
		display: block;
...
`})),b,x=t((()=>{c(),o(),d(),y(),a(),b=class extends r{constructor(...e){super(...e),this.checked=!1,this.indeterminate=!1,this.invalid=!1,this.disabled=!1}get indeterminateMarker(){return!this.checked&&this.indeterminate?`–`:``}render(){return n` <div class="control">${this.indeterminateMarker}</div> `}static{this.styles=[f,v]}},s([i({type:String,reflect:!0})],b.prototype,`type`,void 0),s([i({type:Boolean,reflect:!0})],b.prototype,`checked`,void 0),s([i({type:Boolean,reflect:!0})],b.prototype,`indeterminate`,void 0),s([i({type:Boolean,reflect:!0})],b.prototype,`invalid`,void 0),s([i({type:Boolean,reflect:!0})],b.prototype,`disabled`,void 0),customElements.get(`w-dead-toggle`)||customElements.define(`w-dead-toggle`,b)})),S=e({Checkbox:()=>O,Checked:()=>A,Indeterminate:()=>k,Invalid:()=>j,Radio:()=>D,__namedExportsOrder:()=>M,default:()=>E}),C,w,T,E,D,O,k,A,j,M,N=t((()=>{g(),p(),c(),_(),x(),{events:C,args:w,argTypes:T}=u(`w-dead-toggle`),E={title:`Forms/Dead toggle`,render(e){return n`<w-dead-toggle ${m(h(e))}></w-dead-toggle>`},args:w,argTypes:T,parameters:{actions:{handles:C}}},D={args:{type:`radio`}},O={args:{type:`checkbox`}},k={args:{indeterminate:!0}},A={args:{checked:!0}},j={args:{invalid:!0}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  args: {
    type: "radio"
  }

import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{c as t,h as n,l as r,s as i,t as a,x as o,y as s}from"./decorators-BoKEMuNh.js";import{O as c,_ as l,b as u,d,f,k as p,l as m,p as h,u as g,v as _,x as v}from"./iframe-w5oojtxd.js";import{n as y,t as b}from"./form-control-BSFyWBnN.js";var x,S=e((()=>{t(),x=s`
...
`})),C,w=e((()=>{t(),C=o(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.flex{display:flex}.static{position:static}`)})),T,E=e((()=>{l(),b(),p(),t(),a(),v(),m(),S(),w(),d(),h(),T=class extends y(r){constructor(...e){super(...e),this.ariaLabel=null,this.clear=!1,this.search=!1,this.label=``,this.icon=null}static{this.styles=[g,C,x]}get _wrapperClasses(){return _([this.label?`has-label`:`has-icon`])}resetContainingTextField(e){let t=this.closest(`w-textfield`);t&&t.resetFormControl(),e.stopPropagation()}submitContainingForm(e){let t=this.internals.form;t&&t.submit(),e.stopPropagation()}get _searchButton(){return n`
			<button
				part="wrapper"
		...
		`}get _markup(){if(this.label)return this._text;if(this.icon)return this._icon;if(this.search)return this._searchButton;if(this.clear)return this._clearButton}render(){return n`${this._markup}`}},f([i({attribute:`aria-label`,reflect:!0,useDefault:!0})],T.prototype,`ariaLabel`,void 0),f([i({type:Boolean})],T.prototype,`clear`,void 0),f([i({type:Boolean})],T.prototype,`search`,void 0),f([i({reflect:!0,useDefault:!0})],T.prototype,`label`,void 0),f([i({reflect:!0,useDefault:!0})],T.prototype,`icon`,void 0),customElements.get(`w-affix`)||customElements.define(`w-affix`,T)}));export{E as t};
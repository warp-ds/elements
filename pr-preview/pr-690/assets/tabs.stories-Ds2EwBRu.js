import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{_ as n,c as r,h as i,n as a,t as o}from"./lit-BuckkhbU.js";import{i as s,l as c,n as l,r as u,t as d}from"./decorate-CINhncxq.js";import{d as f,g as p,h as m,l as h,u as g}from"./iframe-Ck5JzZwq.js";import{n as _,t as v}from"./utils-D431BAPN.js";var y,b=t((()=>{o(),y=n(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.border-b{border-bottom-width:1px}.border-b-4{border-bottom-width:4px}.inline-grid{display:inline-grid}.grid-cols-1{grid-template-columns:repeat(1,minmax(0,1fr))}.grid-cols-2{grid-template-columns:repeat(2,minmax(0,1fr))}.grid-cols-3{grid-template-columns:repeat(3,minmax(0,1fr))}.grid-cols-4{grid-template-columns:repeat(4,minmax(0,1fr))}.grid-cols-5{grid-template-columns:repeat(5,minmax(0,1fr))}.grid-cols-6{grid-template-columns:repeat(6,minmax(0,1fr))}.grid-cols-7{grid-template-columns:repeat(7,minmax(0,1fr))}.grid-cols-8{grid-template-columns:repeat(8,minmax(0,1fr))}.grid-cols-9{grid-template-columns:repeat(9,minmax(0,1fr))}.-bottom-0{bottom:0}.absolute{position:absolute}.relative{position:relative}.static{position:static}.s-border{border-color:var(--w-s-color-border)}.s-border-selected{border-color:var(--w-s-color-border-selected)}.-mb-1{margin-bottom:-.1rem}.mb-32{margin-bottom:3.2rem}.resize{resize:both}.transition-all{transition-property:all;transition-duration:.15s;transition-timing-function:cubic-bezier(.4,0,.2,1)}`)})),x,S=t((()=>{o(),u(),h(),b(),l(),x=class extends a{static{this.styles=[g,y,i`
    ...
    `}},d([c({reflect:!0})],A.prototype,`active`,void 0),d([s(`[role="tablist"]`)],A.prototype,`tabList`,void 0),d([s(`.selection-indicator`)],A.prototype,`selectionIndicator`,void 0),customElements.get(`w-tabs`)||customElements.define(`w-tabs`,A)})),M=e({Default:()=>P,ManyTabs:()=>L,WithIcons:()=>F,WithIconsOver:()=>I,__namedExportsOrder:()=>R,default:()=>N}),N,P,F,I,L,R,z=t((()=>{o(),f(),S(),E(),j(),N={title:`Components/Tabs`},P=()=>r`
  <w-tabs active="tab2">

import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{c as n,h as r}from"./decorators-CPAv1fbk.js";import{C as i,S as a}from"./iframe-CS6EVC8h.js";import{a as o,n as s,r as c,t as l}from"./utilities-DkJA1ACB.js";import{t as u}from"./affix-Dk8LZ-v7.js";import{n as d,t as f}from"./taggedTemplateLiteral-2dP4OITE.js";import{t as p}from"./textfield-CvunoPk1.js";var m=e({Default:()=>b,Disabled:()=>w,FormParticipation:()=>N,Invalid:()=>C,Masking:()=>M,ReadOnly:()=>T,Required:()=>E,WithClearAffixResetTextfield:()=>k,WithHelpText:()=>S,WithIconAffix:()=>j,WithPlaceholder:()=>x,WithPrefix:()=>O,WithSearchAndClearAffixForm:()=>A,WithSuffix:()=>D,__namedExportsOrder:()=>P,default:()=>y}),h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F=t((()=>{c(),i(),n(),l(),p(),u(),d(),{events:g,args:_,argTypes:v}=a(`w-textfield`),y={title:`Forms/Textfield`,render(e){return r`<w-textfield ${o(s(e))}></w-textfield>`},args:_,argTypes:v,parameters:{actions:{handles:g}}},b={args:{label:`Email`,type:`email`}},x={args:{label:`Email`,placeholder:`user@example.com`,type:`email`}},S={args:{label:`Password`,"help-text":`Must be at least 8 characters`,type:`password`}},C={args:{label:`Email`,invalid:!0,"help-text":`Please enter a valid email address`,value:`invalid-email`,type:`email`}},w={args:{label:`Email`,disabled:!0,value:`user@example.com`,type:`email`}},T={args:{label:`Email`,"read-only":!0,value:`user@example.com`,type:`email`}},E={args:{label:`Email`,required:!0,type:`email`}},D={args:{label:`Price`,placeholder:`1 000 000`,type:`text`},render(e){return r`
            <w-textfield ${o(s(e))}>
        ...
        `}},k={args:{placeholder:`1 000 000`,type:`text`},render(e){return r`
            <w-textfield ${o(s(e))}>
        ...
        `}},j={args:{label:`Price`,placeholder:`1 000 000`,type:`text`},render(e){return r`
            <w-textfield ${o(s(e))}>
                <w-affix slot="prefix" icon="AwardMedal" aria-label="Search"></w-affix>
                <w-affix slot="suffix" icon="Search" aria-label="Clear"></w-affix>
            </w-textfield>
        `}},M={args:{label:`Price`,placeholder:`1 000 000`,type:`text`,locale:`nb`},render({locale:e,...t}){return r(h||=f([`
            ...
            <\/script>
        `]),o(s(t)),e)}},N={args:{type:`text`},render({locale:e,...t}){return r`

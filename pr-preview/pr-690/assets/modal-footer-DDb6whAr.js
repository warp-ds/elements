import{i as e}from"./preload-helper-xPQekRTU.js";import{_ as t,d as n,i as r,l as i,n as a,p as o,r as s,s as c,t as l,u,x as d}from"./decorate-BxgRj7DM.js";import{n as ee,t as f}from"./dist-BTTyunOH.js";import{_ as te,d as p,l as m,u as h,v as g,y as ne}from"./iframe-VqEg3fOI.js";function re(e){let t=-1;e.ontouchstart=e=>{e.targetTouches.length===1&&(t=e.targetTouches[0].clientY)},e.ontouchmove=n=>{if(n.targetTouches.length!==1)return;let r=n.targetTouches[0].clientY-t;return e.scrollTop===0&&r>0||O(e)&&r<0?C(n):(n.stopPropagation(),!0)}}function _(e){e.ontouchstart=null,e.ontouchmove=null}function v(e){if(!e)throw Error(`Could not run setup, an element must be provided`);b.some(t=>t===e)||(b.length||(T(),A()),re(e),b.push(e))}function y(){b.forEach(_),j(),D(),b=[]}var b,x,S,C,w,T,E,D,O,k,A,j,ie=e((()=>{b=[],x={documentElement:{},body:{}},S=Object.freeze({documentElement:{"scrollbar-gutter":`stable`},body:{overflow:`hidden`,position:`relative`,height:`100%`}}),C=e=>{e.touches.length>1||e.preventDefault?.()},w=e=>([t,n])=>{x[e][t]=document[e].style[t],document[e].style[t]=n},T=()=>Object.entries(S).forEach(([e,t])=>{Object.entries(t).forEach(w(e))}),E=e=>([t,n])=>{document[e].style[t]=x[e][t]},D=()=>Object.entries(x).forEach(([e,t])=>{Object.entries(t).forEach(E(e))}),O=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight,k=e=>()=>document[e?`addEventListener`:`removeEventListener`](`touchmove`,C,{passive:!1}),A=k(!0),j=k()})),M,N,P=e((()=>{M=e=>class extends e{constructor(...e){super(...e),this.patchClose=!0,this._close=null}close(){this._close()}},N=e=>class extends e{handleSlotChange(e){let t=e.target.assignedNodes({flatten:!0});for(let e of t.filter(e=>e.patchClose))e._close=()=>this.close()}}})),F,I=e((()=>{u(),s(),ie(),m(),P(),a(),F=class extends N(n){constructor(){super(),this.show=!1,this.ignoreBackdropClicks=!1,this._isClosing=!1,this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`command`,e=>{let t=e.command;t===`--show-modal`?this.open():(t===`--close`||t===`--confirm`)&&this.close()})}async open(){this._isClosing=!1,this.dialogEl.classList.remove(`close`),this.dialogEl.showModal(),this.handleListeners(),v(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent(`shown`,{bubbles:!0,composed:!0}))}close(){this.dialogEl?.open&&(this._isClosing=!0,this.handleListeners(`removeEventListener`),this.dialogEl.classList.add(`close`),this.dialogEl.addEventListener(`animationend`,async e=>{e.animationName===`w-modal-out`&&this._isClosing&&(this.dialogEl.classList.remove(`close`),this.dialogEl.close(),this._isClosing=!1,y(),this.show=!1,await this.updateComplete,this.dispatchEvent(new CustomEvent(`hidden`,{bubbles:!0,composed:!0})))},{once:!0}))}render(){return t`
		...
		</div>`}emitBack(){this.dispatchEvent(new CustomEvent(`backClicked`,{bubbles:!0,composed:!0}))}handleTopSlotChange(e){let t=e.target.assignedElements({flatten:!0});this._hasTopContent=!!t.length}static{this.styles=[h,d`
			.header {
				position: relative;

...
`})),H,U=e((()=>{n(),s(),V(),m(),H=class extends a{@o({type:Boolean,attribute:`current-page`})currentPage=!1;@o({type:String})href=null;static styles=[h,B];get link(){return this.href?i`<a
					part="link"
					class="s-text-link"
					href=${this.href}

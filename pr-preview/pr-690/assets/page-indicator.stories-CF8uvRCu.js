...
`})),I,L=e((()=>{m(),n(),o(),l(),b(),C(),g(),T(),D(),k(),j(),N(),F(),h(),_(E,A,O,w,M),I=class extends i{constructor(...e){super(...e),this.selectedPage=1,this.pageCount=1}static{this.styles=[P]}get _validPageCount(){return Math.max(1,Math.floor(this.pageCount??1))}get _validSelectedPage(){let e=Math.floor(this.selectedPage??1);return Math.max(1,Math.min(e,this._validPageCount))}render(){let e=this._validPageCount,t=this._validSelectedPage;return r`
		...
		`}},p([a({type:Number,attribute:`selected-page`,reflect:!0,useDefault:!0})],I.prototype,`selectedPage`,void 0),p([a({type:Number,attribute:`page-count`,reflect:!0,useDefault:!0})],I.prototype,`pageCount`,void 0),customElements.get(`w-page-indicator`)||customElements.define(`w-page-indicator`,I)})),R,z,B,V,H,U,W,G,K,q,J;e((()=>{u(),n(),o(),L(),h(),{events:R,args:z,argTypes:B}=f(`w-page-indicator`),V={component:`w-page-indicator`,title:`Navigation/PageIndicator`,render:({pageCount:e,selectedPage:t})=>r`
        <w-page-indicator
            page-count=${e}
            selected-page=${t}
        ></w-page-indicator>
...
`,W=class extends i{constructor(...e){super(...e),this.page=1}connectedCallback(){super.connectedCallback(),this.startPageChanger()}disconnectedCallback(){super.disconnectedCallback(),this.intervalId&&clearInterval(this.intervalId)}startPageChanger(){this.intervalId=setInterval(()=>{this.page>4?this.page=1:this.page+=1},1e3)}render(){return r`
        ...
        `}},p([t()],W.prototype,`page`,void 0),customElements.get(`page-indicator-change-page`)||customElements.define(`page-indicator-change-page`,W),G=()=>r`

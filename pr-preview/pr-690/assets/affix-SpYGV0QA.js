import{i as e}from"./preload-helper-CT_b8DTk.js";import{c as t,h as n,l as r,s as i,t as a,x as o,y as s}from"./decorators-D627o5w3.js";import{N as c,P as l,_ as u,b as d,d as f,f as p,l as m,p as h,u as g,v as _,x as v}from"./iframe-CTR6hqjO.js";import{n as y,t as b}from"./form-control-DGJoih1F.js";var x,S=e((()=>{t(),x=s`
...
`})),C,w=e((()=>{t(),C=o(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.flex{display:flex}.static{position:static}`)})),T,E=e((()=>{u(),b(),l(),t(),a(),v(),m(),S(),w(),f(),h(),T=class extends y(r){constructor(...e){super(...e),this.ariaLabel=null,this.clear=!1,this.search=!1,this.label=``,this.icon=null}static{this.styles=[g,C,x]}get _wrapperClasses(){return _([this.label?`has-label`:`has-icon`])}resetContainingTextField(e){let t=this.closest(`w-textfield`);t&&t.resetFormControl(),e.stopPropagation()}submitContainingForm(e){let t=this.internals.form;t&&t.submit(),e.stopPropagation()}get _searchButton(){return n`
			<button
				part="wrapper"

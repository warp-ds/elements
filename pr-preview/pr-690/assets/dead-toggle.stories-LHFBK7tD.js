import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{c as n,h as r,n as i,t as a}from"./lit-BuckkhbU.js";import{l as o,n as s,r as c,t as l}from"./decorate-CINhncxq.js";import{b as u,l as d,u as f,x as p}from"./iframe-CbKUZITT.js";import{a as m,n as h,r as g,t as _}from"./utilities-CRP5I3nd.js";var v,y=t((()=>{a(),v=r`
	[part~="label"] {
		display: block;
...
`})),b,x=t((()=>{a(),c(),d(),y(),s(),b=class extends i{constructor(...e){super(...e),this.checked=!1,this.indeterminate=!1,this.invalid=!1,this.disabled=!1}get indeterminateMarker(){return!this.checked&&this.indeterminate?`–`:``}render(){return n` <div class="control">${this.indeterminateMarker}</div> `}static{this.styles=[f,v]}},l([o({type:String,reflect:!0})],b.prototype,`type`,void 0),l([o({type:Boolean,reflect:!0})],b.prototype,`checked`,void 0),l([o({type:Boolean,reflect:!0})],b.prototype,`indeterminate`,void 0),l([o({type:Boolean,reflect:!0})],b.prototype,`invalid`,void 0),l([o({type:Boolean,reflect:!0})],b.prototype,`disabled`,void 0),customElements.get(`w-dead-toggle`)||customElements.define(`w-dead-toggle`,b)})),S=e({Checkbox:()=>O,Checked:()=>A,Indeterminate:()=>k,Invalid:()=>j,Radio:()=>D,__namedExportsOrder:()=>M,default:()=>E}),C,w,T,E,D,O,k,A,j,M,N=t((()=>{g(),p(),a(),_(),x(),{events:C,args:w,argTypes:T}=u(`w-dead-toggle`),E={title:`Forms/Dead toggle`,render(e){return n`<w-dead-toggle ${m(h(e))}></w-dead-toggle>`},args:w,argTypes:T,parameters:{actions:{handles:C}}},D={args:{type:`radio`}},O={args:{type:`checkbox`}},k={args:{indeterminate:!0}},A={args:{checked:!0}},j={args:{invalid:!0}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  args: {
    type: "radio"
  }

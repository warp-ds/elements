import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{c as n,h as r}from"./decorators-BoKEMuNh.js";import{n as i,r as a}from"./i18n-Cu-tp5qV.js";import{n as o,t as s}from"./dist-B-Y-CnmQ.js";import{t as c}from"./icon-Ckvp1uHx.js";import{a as l,n as u,r as d,t as f}from"./utilities-DIER-odo.js";import{t as p}from"./button-DlE6l7MA.js";var m=t({AllVariantsGrid:()=>F,AsLink:()=>k,FormControl:()=>A,FullWidth:()=>O,HrefModeRegression:()=>R,Link:()=>C,Loading:()=>D,LoadingAcrossVariants:()=>L,Negative:()=>x,Overlay:()=>j,OverlayInverted:()=>M,OverlayInvertedQuiet:()=>P,OverlayQuiet:()=>N,Pill:()=>w,Primary:()=>y,Quiet:()=>E,QuietBackCompatMapping:()=>I,Secondary:()=>b,Small:()=>T,Utility:()=>S,__namedExportsOrder:()=>z,default:()=>v}),h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B=e((()=>{d(),o(),n(),f(),p(),c(),a(),{events:h,args:g,argTypes:_}=s(`w-button`),v={title:`Buttons/Button`,render(e){return r`<w-button ${l(u(e))}>Button Text</w-button>`},args:g,argTypes:_,parameters:{actions:{handles:h}}},y={args:{variant:`primary`,type:`button`}},b={args:{variant:`secondary`,type:`button`}},x={args:{variant:`negative`,type:`button`}},S={args:{variant:`utility`,type:`button`}},C={args:{variant:`link`,type:`button`}},w={args:{variant:`pill`,type:`button`},render(e){let t=i();return r`<w-button ${l(u(e))}>
                <w-icon
                    name="ChevronLeft"
                    size="small"
                    locale="${t}"
            ...
            <w-button ${l(u(e))} small="">
                <w-icon
                    ...
                    class="flex"
                ></w-icon>
            </w-button>`}},T={args:{variant:`primary`,small:!0,type:`button`}},E={args:{variant:`secondary`,quiet:!0,type:`button`}},D={args:{variant:`primary`,loading:!0,type:`button`}},O={args:{variant:`primary`,"full-width":!0,type:`button`},render(e){return r`
            <div class="w-full flex flex-col gap-8">
                <w-button ${l(u(e))}>Full width</w-button>
            </div>
        `}},k={args:{variant:`primary`,href:`https://example.com`,target:`_blank`,type:`button`},render(e){return r`<w-button ${l(u(e))}>Visit Example</w-button>`}},A={args:{},render(){return r`
        ...
        `}},j={args:{variant:`overlay`,type:`button`}},M={args:{variant:`overlayInverted`,type:`button`}},N={args:{variant:`overlayQuiet`,type:`button`}},P={args:{variant:`overlayInvertedQuiet`,type:`button`}},F={args:{},render(){let e=i();return r`

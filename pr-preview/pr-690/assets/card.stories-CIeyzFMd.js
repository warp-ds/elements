import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{c as n,d as r,h as i,l as a,s as o,t as s,y as c}from"./decorators-D627o5w3.js";import{C as l,N as u,P as d,S as f,f as p,l as m,p as h,u as g,x as _,y as v}from"./iframe-8qWjFGj4.js";import{a as y,n as b,r as x,t as S}from"./utilities-g249eBWk.js";import{r as C,t as w}from"./if-defined-C-tsDTYv.js";var T,E=t((()=>{T=JSON.parse(`{"card.button.text":["Vælg"]}`)})),D,O=t((()=>{D=JSON.parse(`{"card.button.text":["Select"]}`)})),k,A=t((()=>{k=JSON.parse(`{"card.button.text":["Valitse"]}`)})),j,M=t((()=>{j=JSON.parse(`{"card.button.text":["Velg"]}`)})),N,P=t((()=>{N=JSON.parse(`{"card.button.text":["Välj"]}`)})),F,I=t((()=>{n(),F=c`
	:host {

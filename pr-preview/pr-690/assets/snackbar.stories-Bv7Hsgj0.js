import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,h as n,n as r,t as i}from"./lit-BuckkhbU.js";import{n as a,t as o}from"./dist-BTTyunOH.js";import{i as ee,l as s,n as c,r as l,s as te,t as u}from"./decorate-CINhncxq.js";import{A as ne,_ as d,b as f,c as p,d as m,l as h,o as g,s as _,u as v,x as y,y as b}from"./iframe-DlLvqNsC.js";import{t as x}from"./attention-BT85reY2.js";import{t as S}from"./button-Drp3fy8W.js";import{n as C,r as w,t as T}from"./modal-footer-Bdl85_gi.js";var E,re=e((()=>{i(),E=n`
    :host {
        display: block;
...
`})),D,O,k=e((()=>{i(),l(),p(),h(),re(),c(),D=function(e){return e[e.Short=4e3]=`Short`,e[e.Long=1e4]=`Long`,e[e.Infinite=12e7]=`Infinite`,e}({}),O=class extends r{constructor(...e){super(...e),this.actionPlacement=`inline`,this.duration=4e3,this.hasAction=!1,this.#e=!1,this.#t=4e3,this.#n=null,this.#r=null,this.#i=!1}static{this.styles=[v,E]}#e;#t;#n;#r;#i;connectedCallback(){if(super.connectedCallback(),this.duration!==12e7){let e=1e3;this.#t=this.duration-e,this.#r=setInterval(()=>{this.#i||(this.#t-=e,this.#t<=0&&this.close())},e)}}disconnectedCallback(){this.#r&&clearInterval(this.#r)}async updated(){this.root&&(this.#e||(await this.updateComplete,_(this.root,()=>{this.#e=!0})))}close(){this.#n&&this.#n.focus(),this.#e&&this.root?g(this.root,()=>{this.remove()}):this.remove()}#a(e){this.#n||(this.#i=!0,e.relatedTarget&&e.relatedTarget.focus&&(this.#n=e.relatedTarget))}#o(e){(!e.relatedTarget||!this.shadowRoot?.host.contains(e.relatedTarget))&&(this.#i=!1,this.#n=null)}#s(){this.#i=!0}#c(){this.#n||(this.#i=!1)}#l(){let e=this.shadowRoot?.querySelector(`slot[name="action"]`);return e?e.assignedElements().length>0:!1}firstUpdated(){this.hasAction=this.#l()}render(){if(this.hasAction&&document.documentElement.dataset.keyboardinteraction===`true`){let e=window.navigator.userAgent.includes(`Macintosh`)?`⌥`:`Alt`;return t`
                <w-attention
                    tooltip
                    placement="top"
                    distance="12"
...
`})),H,U,W,G=e((()=>{a(),i(),k(),b(),j(),N(),F(),L(),z(),h(),V(),H={canClose:!0,duration:D.Short,variant:`neutral`},d(M,I,P,A,R),U=/\s/,W=class extends r{static{this.styles=[v,B]}constructor(){super(),this.internals=this.attachInternals(),this.internals.ariaLive=`polite`,this.internals.role=`log`,this._onKeydown=this._onKeydown.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this._onKeydown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`keydown`,this._onKeydown)}_onKeydown(e){if(e.key===`Escape`){let e=this.shadowRoot?.host.querySelector(`w-snackbar-item:last-of-type`);e&&e.close()}else if(e.altKey&&e.key===`Enter`){e.preventDefault();let t=this.shadowRoot?.host.querySelector(`w-snackbar-item:last-of-type`);if(console.log(`Found item!`),t){let e=t.querySelector(`w-button[slot="action"]`);console.log(`Found action!`),e&&(e.click(),console.log(`Clicked!`))}}}create(e,t={}){let n={...H,...t},r=document.createElement(`w-snackbar-item`);if(n.duration&&(r.duration=n.duration),r.innerText=e,n.variant!==`neutral`){let e=document.createElement(`w-icon`);switch(e.slot=`icon`,n.variant){case`positive`:e.name=`SuccessFilled`;break;case`warning`:e.name=`WarningFilled`;break;case`negative`:e.name=`ErrorFilled`;break;case`info`:e.name=`InfoFilled`;break}r.prepend(e)}if(n.action){r.duration<D.Long&&(r.duration=D.Long);let e=document.createElement(`w-button`);e.slot=`action`,e.variant=`utilityQuiet`,e.small=!0;let{label:t,onclick:i,placement:a}=n.action;e.innerText=t;let o=document.createElement(`span`);o.classList.add(`sr-only`),o.innerHTML=`<kbd>${window.navigator.userAgent.includes(`Macintosh`)?`Option`:`Alt`}</kbd> + <kbd>Enter</kbd>`,e.append(o),e.onclick=t=>{let n=i.call(e,t);return t.defaultPrevented||r.close(),n},a?r.actionPlacement=a:U.test(t)&&(r.actionPlacement=`block`),r.append(e)}if(r.duration>D.Long&&(n.canClose=!0),n.canClose){let e=document.createElement(`w-button`);e.slot=`close`,e.variant=`utilityQuiet`,e.small=!0,e.iconOnly=!0,typeof n.canClose==`function`?e.onclick=t=>{let i=n.canClose.call(e,t);return t.defaultPrevented||r.close(),i}:e.onclick=r.close.bind(r);let t=document.createElement(`w-icon`);t.name=`Close`,t.size=`small`,t.ariaLabel=o.t({id:`snackbar.aria.close`,message:`Dismiss message`,comment:`Accessibility label for the button that closes the snackbar/toast popup`}),e.append(t),r.append(e)}return this.shadowRoot?.host.prepend(r),r}render(){return t`
            <aside part="container">
                <slot></slot>
            </aside>
        `}},customElements.get(`w-snackbar`)||customElements.define(`w-snackbar`,W)})),K,q,J,Y,X,Z,Q,$;e((()=>{y(),i(),ne(),x(),S(),m(),w(),C(),T(),G(),k(),{events:K,args:q,argTypes:J}=f(`w-snackbar`),Y={title:`Overlays/Snackbar`,args:{...q,canClose:!0,duration:void 0},argTypes:{...J,duration:{control:{type:`select`},options:[`4 seconds`,`10 seconds`,`Infinite`]}},parameters:{actions:{handles:K}}},X={render({duration:e,canClose:n}){let r=e===`Infinite`?D.Infinite:e===`10 seconds`?D.Long:D.Short;return t`
        <div class="flex gap-8">
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short, but if it is not and spans multiple lines then the icon and actions should be centered vertically`,{variant:`positive`,duration:r,canClose:n})}}">Positive variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`warning`,duration:r,canClose:n})}}">Warning variant</w-button>

          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`negative`,duration:r,canClose:n})}}">Negative variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`info`,duration:r,canClose:n})}}">Info variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{duration:r,canClose:n})}}">Neutral variant</w-button>
          
          <w-button @click="${()=>{let e=document.querySelector(`w-snackbar`).create(`The message should be short`,{duration:r,canClose:n}),t=document.createElement(`w-icon`);t.name=`Rocket`,t.slot=`icon`,e.prepend(t)}}">Neutral w/ icon</w-button>
        </div>
    `}},Z={render({duration:e,canClose:n}){let r=e===`Infinite`?D.Infinite:e===`10 seconds`?D.Long:D.Short;return t`
        <div class="flex gap-8">
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short, but if it is not and spans multiple lines then the icon and actions should be centered vertically`,{variant:`positive`,duration:r,canClose:n,action:{label:`Action`,onclick(){let e=document.getElementById(`with-action-modal`);e.show=!0}}})}}">Positive variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`warning`,duration:r,canClose:n,action:{label:`Action`,onclick(){let e=document.getElementById(`with-action-modal`);e.show=!0}}})}}">Warning variant</w-button>

          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`negative`,duration:r,canClose:n,action:{label:`Action`,onclick(){let e=document.getElementById(`with-action-modal`);e.show=!0}}})}}">Negative variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`info`,duration:r,canClose:n,action:{label:`Action`,onclick(){let e=document.getElementById(`with-action-modal`);e.show=!0}}})}}">Info variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{duration:r,canClose:n,action:{label:`Action`,onclick(){let e=document.getElementById(`with-action-modal`);e.show=!0}}})}}">Neutral variant</w-button>
        </div>
    ...
    `}},Q={render({duration:e,canClose:n}){let r=e===`Infinite`?D.Infinite:e===`10 seconds`?D.Long:D.Short;return t`
        <div class="flex gap-8">
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short, but if it is not and spans multiple lines then the icon and actions should be centered vertically`,{variant:`positive`,duration:r,canClose:n,action:{label:`Long action label`,onclick(){let e=document.getElementById(`with-long-action-modal`);e.show=!0}}})}}">Positive variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`warning`,duration:r,canClose:n,action:{label:`Long action label`,onclick(){let e=document.getElementById(`with-long-action-modal`);e.show=!0}}})}}">Warning variant</w-button>

          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`negative`,duration:r,canClose:n,action:{label:`Long action label`,onclick(){let e=document.getElementById(`with-long-action-modal`);e.show=!0}}})}}">Negative variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{variant:`info`,duration:r,canClose:n,action:{label:`Long action label`,onclick(){let e=document.getElementById(`with-long-action-modal`);e.show=!0}}})}}">Info variant</w-button>
          
          <w-button @click="${()=>{document.querySelector(`w-snackbar`).create(`The message should be short`,{duration:r,canClose:n,action:{label:`Long action label`,onclick(){let e=document.getElementById(`with-long-action-modal`);e.show=!0}}})}}">Neutral variant</w-button>
        </div>

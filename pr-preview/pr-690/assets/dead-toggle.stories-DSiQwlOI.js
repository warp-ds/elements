import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{c as n,h as r,l as i,s as a,t as o,y as s}from"./decorators-BoKEMuNh.js";import{n as c,t as l}from"./dist-B-Y-CnmQ.js";import{n as u,t as d}from"./styles-CVeKeHRg.js";import{a as f,n as p,r as m,t as h}from"./utilities-DIER-odo.js";var g,_=e((()=>{n(),g=s`
	[part~="label"] {
		display: block;
...
`})),v,y=e((()=>{n(),o(),d(),_(),v=class extends i{@a({type:String,reflect:!0})type;@a({type:Boolean,reflect:!0})checked=!1;@a({type:Boolean,reflect:!0})indeterminate=!1;@a({type:Boolean,reflect:!0})invalid=!1;@a({type:Boolean,reflect:!0})disabled=!1;get indeterminateMarker(){return!this.checked&&this.indeterminate?`–`:``}render(){return r` <div class="control">${this.indeterminateMarker}</div> `}static styles=[u,g]},customElements.get(`w-dead-toggle`)||customElements.define(`w-dead-toggle`,v)})),b=t({Checkbox:()=>E,Checked:()=>O,Indeterminate:()=>D,Invalid:()=>k,Radio:()=>T,__namedExportsOrder:()=>A,default:()=>w}),x,S,C,w,T,E,D,O,k,A,j=e((()=>{m(),c(),n(),h(),y(),{events:x,args:S,argTypes:C}=l(`w-dead-toggle`),w={title:`Forms/Dead toggle`,render(e){return r`<w-dead-toggle ${f(p(e))}></w-dead-toggle>`},args:S,argTypes:C,parameters:{actions:{handles:x}}},T={args:{type:`radio`}},E={args:{type:`checkbox`}},D={args:{indeterminate:!0}},O={args:{checked:!0}},k={args:{invalid:!0}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  args: {
    type: "radio"
  }

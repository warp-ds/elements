...
`})),Z,he=e((()=>{U(),ee(),n(),c(),re(),te(),ue(),de(),fe(),pe(),me(),P(),h(),X(),f(),Z=class extends M(a){static{this.styles=[m,Y]}constructor(){super(),this.back=!1,this.noClose=!1,this._hasTopContent=!1,ne(G,q,K,W,J)}async willUpdate(e){if(e.has(`back`)){if(!this.titleEl)return;new H(this.titleEl).when(async()=>{await this.updateComplete})}}emitBack(){this.dispatchEvent(new CustomEvent(`backClicked`,{bubbles:!0,composed:!0}))}handleTopSlotChange(e){let t=e.target.assignedElements({flatten:!0});this._hasTopContent=!!t.length}render(){let e=this.back&&!this._hasTopContent,t=!this.noClose;return i`
		...
		`}},p([s({type:String})],Z.prototype,`title`,void 0),p([s({type:Boolean})],Z.prototype,`back`,void 0),p([s({type:Boolean,attribute:`no-close`})],Z.prototype,`noClose`,void 0),p([t()],Z.prototype,`_hasTopContent`,void 0),p([o(`[part="title"]`)],Z.prototype,`titleEl`,void 0),customElements.get(`w-modal-header`)||customElements.define(`w-modal-header`,Z)})),Q,ge=e((()=>{n(),Q=l`
	:host {
...
`})),$,_e=e((()=>{n(),P(),h(),ge(),$=class extends M(N(a)){static{this.styles=[m,Q]}render(){return i`

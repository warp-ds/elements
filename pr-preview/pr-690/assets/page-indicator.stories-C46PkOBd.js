...
`})),I,L=e((()=>{a(),i(),l(),p(),b(),C(),_(),T(),D(),k(),j(),N(),F(),c(),m(E,A,O,w,M),I=class extends r{constructor(...e){super(...e),this.selectedPage=1,this.pageCount=1}static{this.styles=[P]}get _validPageCount(){return Math.max(1,Math.floor(this.pageCount??1))}get _validSelectedPage(){let e=Math.floor(this.selectedPage??1);return Math.max(1,Math.min(e,this._validPageCount))}render(){let e=this._validPageCount,n=this._validSelectedPage;return t`
      <div class="w-page-indicator" role="img" aria-label="${o._({id:`page-indicator.aria.label`,comment:`Default screenreader message for page indicator group`,message:`Dot {selectedPage} is highlighted in a row of {pageCount} dots`,values:{selectedPage:n,pageCount:e}})}">
        <div class="w-page-indicator--container">
          ${v(x(e),e=>t`<div class="${f({"w-page-indicator--dot":!0,"w-page-indicator--selecteddot":e+1===n})}"></div>`)}
        </div>
      </div>
    `}},d([s({type:Number,attribute:`selected-page`,reflect:!0,useDefault:!0})],I.prototype,`selectedPage`,void 0),d([s({type:Number,attribute:`page-count`,reflect:!0,useDefault:!0})],I.prototype,`pageCount`,void 0),customElements.get(`w-page-indicator`)||customElements.define(`w-page-indicator`,I)})),R,z,B,V,H,U,W,G,K,q,J;e((()=>{g(),i(),l(),L(),c(),{events:R,args:z,argTypes:B}=h(`w-page-indicator`),V={component:`w-page-indicator`,title:`Navigation/PageIndicator`,render:({pageCount:e,selectedPage:n})=>t`
    <w-page-indicator page-count=${e} selected-page=${n}></w-page-indicator>
...
`,W=class extends r{constructor(...e){super(...e),this.page=1}connectedCallback(){super.connectedCallback(),this.startPageChanger()}disconnectedCallback(){super.disconnectedCallback(),this.intervalId&&clearInterval(this.intervalId)}startPageChanger(){this.intervalId=setInterval(()=>{this.page>4?this.page=1:this.page+=1},1e3)}render(){return t`
      <div style="display: grid; height: 10vh; border: 1px solid lightgrey;">
    ...
    `}},d([u()],W.prototype,`page`,void 0),customElements.get(`page-indicator-change-page`)||customElements.define(`page-indicator-change-page`,W),G=()=>t` <page-indicator-change-page></page-indicator-change-page> `,K=()=>t`
  <div style="display: grid; height: 10vh; border: 1px solid lightgrey;">
...
\``,...U.parameters?.docs?.source}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:"() => html` <page-indicator-change-page></page-indicator-change-page> `",...G.parameters?.docs?.source}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`() => html\`
  <div style="display: grid; height: 10vh; border: 1px solid lightgrey;">
    <w-page-indicator page-count="10" selected-page="3" style="padding-bottom: 12px; align-self: end;"> </w-page-indicator>
  </div>

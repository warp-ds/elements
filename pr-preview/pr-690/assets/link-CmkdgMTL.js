import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,h as n,i as r,n as i,t as a}from"./lit-BuckkhbU.js";import{l as o,n as s,r as c,t as l}from"./decorate-CINhncxq.js";import{l as u,u as d}from"./iframe-CbKUZITT.js";var f,p,m,h,g,_=e((()=>{a(),f=n`
	:host {
...
`})),b,x,S=e((()=>{a(),c(),u(),y(),s(),b=[`primary`,`secondary`,`negative`,`negativeQuiet`,`utility`,`utilityQuiet`,`quiet`,`link`,`overlay`,`overlayInverted`,`overlayQuiet`,`overlayInvertedQuiet`],x=class extends i{constructor(...e){super(...e),this.autofocus=!1,this.small=!1,this.disabled=!1,this.fullWidth=!1}static{this.shadowRootOptions={...i.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[d,v]}connectedCallback(){if(super.connectedCallback(),this.variant&&!b.includes(this.variant))throw Error(`Invalid "variant" attribute. Set its value to one of the following:\n${b.join(`, `)}.`)}firstUpdated(){this.autofocus&&setTimeout(()=>this.focus(),0)}render(){return t`
		...
		`}},l([o({type:Boolean,reflect:!0})],x.prototype,`autofocus`,void 0),l([o({reflect:!0})],x.prototype,`variant`,void 0),l([o({type:Boolean,reflect:!0})],x.prototype,`small`,void 0),l([o({reflect:!0})],x.prototype,`href`,void 0),l([o({type:Boolean,reflect:!0})],x.prototype,`disabled`,void 0),l([o({reflect:!0})],x.prototype,`target`,void 0),l([o({reflect:!0})],x.prototype,`rel`,void 0),l([o({attribute:`full-width`,type:Boolean,reflect:!0})],x.prototype,`fullWidth`,void 0),customElements.get(`w-link`)||customElements.define(`w-link`,x)}));export{_ as n,g as r,S as t};
import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{a as n,c as r,d as i,g as a,h as o,l as s,n as c,p as l,s as u,t as d,y as f}from"./decorators-BoKEMuNh.js";import{c as ee,d as p,u as te}from"./async-directive-CC9NZ5MT.js";import{a as m,o as ne,r as re,t as ie}from"./i18n-Cu-tp5qV.js";import{i as h,n as ae,r as oe,t as se}from"./directive-Ba7oHnGg.js";import{n as ce,t as le}from"./dist-B-Y-CnmQ.js";import{n as g,t as _}from"./decorate-BUw_Sz5x.js";import{n as ue,t as de}from"./styles-CVeKeHRg.js";import{a as fe,n as pe,r as me,t as he}from"./utilities-DIER-odo.js";import{n as v,t as y}from"./form-control-BSFyWBnN.js";import{r as b,t as x}from"./if-defined-CAJ93-y8.js";var S,C=e((()=>{a(),oe(),ee(),S=se(class extends ae{constructor(e){if(super(e),e.type!==h.PROPERTY&&e.type!==h.ATTRIBUTE&&e.type!==h.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!p(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===l||t===i)return t;let n=e.element,r=e.name;if(e.type===h.PROPERTY){if(t===n[r])return l}else if(e.type===h.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return l}else if(e.type===h.ATTRIBUTE&&n.getAttribute(r)===t+``)return l;return te(e),t}})})),ge=e((()=>{C()})),w,_e=e((()=>{r(),w=f`
	:host {

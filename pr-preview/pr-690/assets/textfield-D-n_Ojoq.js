import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{c as t,d as n,h as r,l as i,n as a,s as o,t as s,x as c,y as l}from"./decorators-BoKEMuNh.js";import{n as u,t as d}from"./class-map-C6ketRHB.js";import{O as f,_ as p,f as m,k as h,l as g,p as _,u as v,v as y,x as b,y as x}from"./iframe-ab9daogv.js";import{n as S,t as C}from"./form-control-BSFyWBnN.js";import{r as w,t as T}from"./if-defined-CAJ93-y8.js";var E,D=e((()=>{E=JSON.parse(`{"textfield.label.optional":["Valgfri"]}`)})),O,k=e((()=>{O=JSON.parse(`{"textfield.label.optional":["Optional"]}`)})),A,j=e((()=>{A=JSON.parse(`{"textfield.label.optional":["Valinnainen"]}`)})),M,N=e((()=>{M=JSON.parse(`{"textfield.label.optional":["Valgfri"]}`)})),P,F=e((()=>{P=JSON.parse(`{"textfield.label.optional":["Valfritt"]}`)})),I,L=e((()=>{t(),I=l`
	.w-textfield {
...
`})),U,W,G=e((()=>{p(),h(),C(),t(),s(),d(),T(),b(),g(),D(),k(),j(),N(),F(),L(),z(),H(),_(),U={base:`block text-m leading-m mb-0 px-8 py-12 rounded-4 w-full focusable focus:[--w-outline-offset:-2px] caret-current`,default:`border-1 s-text s-bg s-border-strong hover:s-border-strong-hover active:s-border-selected`,disabled:`border-1 s-text-disabled s-bg-disabled-subtle s-border-disabled pointer-events-none`,invalid:`border-1 s-text-negative s-bg s-border-negative hover:s-border-negative-hover outline-[--w-s-color-border-negative]!`,readOnly:`pl-0 bg-transparent pointer-events-none`,placeholder:`placeholder:s-text-placeholder`,suffix:`pr-40`,prefix:`pl-[var(--w-prefix-width,_40px)]`,textArea:`min-h-[42] sm:min-h-[45]`},W=class extends S(i){static{this.shadowRootOptions={...i.shadowRootOptions,delegatesFocus:!0}}constructor(){super(),this.disabled=!1,this.invalid=!1,this.optional=!1,this.readOnly=!1,this.readonly=!1,this.required=!1,this._hasPrefix=!1,this._hasSuffix=!1,this.#t=void 0,x(O,M,A,E,P)}#e(e){e.key===`Enter`&&this.internals.form&&this.internals.form.requestSubmit()}updated(e){e.has(`value`)&&this.value!==void 0&&(this.setValue(this.value),this.formatter&&this.mask&&(this.mask.innerText=this.formatter(this.value)))}#t;static{this.styles=[v,R,I,B,V]}firstUpdated(){this.#t=this.value}resetFormControl(){this.value=this.#t}get _inputstyles(){return y([U.base,this._hasSuffix&&U.suffix,this._hasPrefix&&U.prefix,!this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&U.default,this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&U.invalid,!this.invalid&&this.disabled&&!(this.readonly||this.readOnly)&&U.disabled,!this.invalid&&!this.disabled&&(this.readonly||this.readOnly)&&U.readOnly])}get _helptextstyles(){return`help-text`}get _label(){if(this.label){let e=this.label.length&&this.optional&&!this.required,t=!!this.tooltip;return r`
				<label for="${this._id}">
					${this.label}${e?r`
								<span>
									${f._({id:`textfield.label.optional`,message:`Optional`,comment:`Shown behind label when marked as optional`})}
								</span>
							`:n}
					${t?r`
								<button
			...
			${this._label}
			<div
				class="${u({"w-textfield":!0,"w-textfield--has-prefix":this._hasPrefix,"w-textfield--has-suffix":this._hasSuffix})}"
			>
		...
		`}},m([o({type:Boolean,reflect:!0})],W.prototype,`disabled`,void 0),m([o({type:Boolean,reflect:!0})],W.prototype,`invalid`,void 0),m([o({type:String,reflect:!0})],W.prototype,`label`,void 0),m([o({type:String,reflect:!0,attribute:`help-text`})],W.prototype,`helpText`,void 0),m([o({type:Boolean,reflect:!0})],W.prototype,`optional`,void 0),m([o({type:String,reflect:!0})],W.prototype,`size`,void 0),m([o({type:Number,reflect:!0})],W.prototype,`max`,void 0),m([o({type:Number,reflect:!0})],W.prototype,`min`,void 0),m([o({type:Number,reflect:!0,attribute:`min-length`})],W.prototype,`minLength`,void 0),m([o({type:Number,reflect:!0})],W.prototype,`minlength`,void 0),m([o({type:Number,reflect:!0,attribute:`max-length`})],W.prototype,`maxLength`,void 0),m([o({type:Number,reflect:!0})],W.prototype,`maxlength`,void 0),m([o({type:String,reflect:!0})],W.prototype,`pattern`,void 0),m([o({type:String,reflect:!0})],W.prototype,`placeholder`,void 0),m([o({type:Boolean,reflect:!0,attribute:`read-only`})],W.prototype,`readOnly`,void 0),m([o({type:Boolean,reflect:!0})],W.prototype,`readonly`,void 0),m([o({type:Boolean,reflect:!0})],W.prototype,`required`,void 0),m([o({type:String,reflect:!0})],W.prototype,`type`,void 0),m([o({type:String,reflect:!0})],W.prototype,`value`,void 0),m([o({type:String,reflect:!0})],W.prototype,`name`,void 0),m([o({type:Number,reflect:!0})],W.prototype,`step`,void 0),m([o({type:String,reflect:!0})],W.prototype,`autocomplete`,void 0),m([o({type:String,reflect:!0})],W.prototype,`tooltip`,void 0),m([o({attribute:!1})],W.prototype,`formatter`,void 0),m([a(`.w-textfield__mask`)],W.prototype,`mask`,void 0),m([o({type:Boolean})],W.prototype,`_hasPrefix`,void 0),m([o({type:Boolean})],W.prototype,`_hasSuffix`,void 0),customElements.get(`w-textfield`)||customElements.define(`w-textfield`,W)}));export{G as t};
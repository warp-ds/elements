		...
		>
			...
			<div class="flex items-center s-text-link">
				${this.shouldShowShowFirstPageButton?r`<a
						...
						>
							<span class="sr-only"
								>${g._({id:`pagination.aria.first-page`,message:`First page`,comment:`Default screenreader message for first page link in the pagination component`})},</span
							>
							<w-icon
				...
				${this.shouldShowPreviousPageButton?r`<a
						...
						>
							<span class="sr-only"
								>${g._({id:`pagination.aria.prev-page`,message:`Previous page`,comment:`Default screenreader message for previous page link in the pagination component`})},</span
							>
							<w-icon
								name="ChevronLeft"
								size="small"
				...
				<div class="hidden md:block">
					${e.map(e=>{let t=e===this.currentPageNumber,n=`${this.baseUrl}${e}`,i=z;return t?i+=` s-bg-primary s-text-inverted`:i+=` hover:bg-[--w-color-button-pill-background-hover] active:bg-[--w-color-button-pill-background-active]`,r`<a
							data-page-number="${e}"
							aria-label="${g._({id:`pagination.aria.page`,message:`Page {currentPage}`,values:{currentPage:e},comment:`Default screenreader message for page link in the pagination component`})}"
							href="${n}"
							class="${i}"
							aria-current="${t?`page`:``}"
							>${e}</a
				...
				<span class="block md:hidden p-8 font-bold"
					>${g._({id:`pagination.label.current-page`,message:`Page {currentPage}`,values:{currentPage:this.currentPageNumber},comment:`Default message for current page label in the pagination component`})}</span
				>
				${this.shouldShowNextPageButton?r`<a
						...
						>
							<span class="sr-only">
								${g._({id:`pagination.aria.next-page`,message:`Next page`,comment:`Default screenreader message for next page link in the pagination component`})},</span
							>
							<w-icon
								name="ChevronRight"
								size="small"

import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{_ as n,d as r,h as i,i as a,l as o,n as s,p as c,r as l,s as u,t as d,u as f,v as ee,x as p}from"./decorate-BxgRj7DM.js";import{n as m,t as h}from"./dist-BTTyunOH.js";import{i as g,n as te,r as ne,t as re}from"./directive-CmXe-hdg.js";import{_ as ie,_t as ae,b as oe,l as se,u as ce,vt as le,x as ue,y as de,yt as fe}from"./iframe-VqEg3fOI.js";import{a as pe,n as me,r as he,t as ge}from"./utilities-BGx-l0cq.js";import{n as _,t as v}from"./form-control-DtXadPi-.js";import{r as y,t as b}from"./if-defined-B1ZLCare.js";var x,_e=t((()=>{ee(),ne(),ae(),x=re(class extends te{constructor(e){if(super(e),e.type!==g.PROPERTY&&e.type!==g.ATTRIBUTE&&e.type!==g.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!fe(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;let n=e.element,r=e.name;if(e.type===g.PROPERTY){if(t===n[r])return i}else if(e.type===g.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return i}else if(e.type===g.ATTRIBUTE&&n.getAttribute(r)===t+``)return i;return le(e),t}})})),ve=t((()=>{_e()})),S,C=t((()=>{f(),S=p`
	:host {
...
`})),w,ye=t((()=>{v(),f(),l(),b(),ve(),se(),C(),s(),w=class extends _(r){constructor(...e){super(...e),this.value=null,this.indeterminate=!1,this.checked=!1,this.disabled=!1,this.required=!1,this.invalid=!1,this.#e=!1,this.#t=!1,this.#n=!1,this.#r=()=>{this.#a(),this.#l()},this.#i=e=>{if(!this.disabled&&!e.defaultPrevented&&!(e.key!==` `&&e.key!==`Spacebar`&&e.key!==`Enter`)){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}e.composedPath()[0]!==this.input&&(e.preventDefault(),this.click())}}}static{this.styles=[ce,S]}static{this.shadowRootOptions={...r.shadowRootOptions,delegatesFocus:!0}}set name(e){this._ownName=e}get name(){return this._ownName||this._groupName}#e;#t;#n;get _computedInvalid(){return this.invalid||this._groupInvalid===!0}connectedCallback(){super.connectedCallback();let e=this.getAttribute(`value`);this.value=e??`on`,this.#e=this.hasAttribute(`checked`),this.checked=this.#e,this.addEventListener(`invalid`,this.#r),this.addEventListener(`keydown`,this.#i),this.#u()}handleClick(){this.disabled||(this.#a(),this.checked=!this.checked,this.indeterminate=!1,this.updateComplete.then(()=>{this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}))}#r;#i;updated(e){super.updated(e),(e.has(`checked`)||e.has(`indeterminate`))&&this.#d(),this.#f(e)&&(this.#u(),this.#l())}resetFormControl(){this.checked=this.#e,this.#u(),this.#l()}click(){this.disabled||this.input?.click()}focus(e){this.input?.focus(e)}blur(){this.input?.blur()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#l(),this.internals.checkValidity()}reportValidity(){return this.#a(),this.#l(),this.internals.checkValidity()}#a(){this.#n=!0}#o(){return this.input?.validationMessage||` `}#s(){return this.input??void 0}#c(e){this.internals.setValidity(e,this.#o(),this.#s())}#l(){if(this.disabled){this.internals.setValidity({});return}let e=this.required&&!this.checked,t=this.invalid&&!this.#t;if(e){this.#t=!0,this.invalid=this.#n,this.#c({valueMissing:!0});return}if(this.#t&&=(this.invalid=!1,!1),t){this.#c({customError:!0});return}this.internals.setValidity({})}#u(){if(this.disabled){this.setValue(null);return}let e=this.checked?this.value:null;this.setValue(e)}#d(){this.input&&(this.input.checked=this.checked,this.input.indeterminate=this.indeterminate)}#f(e){return e.has(`checked`)||e.has(`value`)||e.has(`disabled`)||e.has(`required`)||e.has(`invalid`)}render(){let e=!this.checked&&this.indeterminate,t=e?`mixed`:this.checked?`true`:`false`;return n`
		...
		`}},d([a(`input[type="checkbox"]`)],w.prototype,`input`,void 0),d([o({reflect:!0})],w.prototype,`name`,null),d([o({reflect:!0})],w.prototype,`value`,void 0),d([o({type:Boolean,reflect:!0})],w.prototype,`indeterminate`,void 0),d([o({type:Boolean,reflect:!0})],w.prototype,`checked`,void 0),d([o({type:Boolean,reflect:!0})],w.prototype,`disabled`,void 0),d([o({type:Boolean,reflect:!0})],w.prototype,`required`,void 0),d([o({type:Boolean,reflect:!0})],w.prototype,`invalid`,void 0),d([o({attribute:!1})],w.prototype,`_groupInvalid`,void 0),d([o({attribute:!1})],w.prototype,`_groupName`,void 0),customElements.get(`w-checkbox`)||customElements.define(`w-checkbox`,w)})),T,be=t((()=>{T=JSON.parse(`{"checkbox-group.label.optional":["Valgfri"],"checkbox-group.validation.required":["Mindst én valgt mulighed er påkrævet."]}`)})),E,xe=t((()=>{E=JSON.parse(`{"checkbox-group.label.optional":["Optional"],"checkbox-group.validation.required":["At least one selection is required."]}`)})),D,Se=t((()=>{D=JSON.parse(`{"checkbox-group.label.optional":["Valinnainen"],"checkbox-group.validation.required":["Vähintään yksi valinta vaaditaan."]}`)})),O,k=t((()=>{O=JSON.parse(`{"checkbox-group.label.optional":["Valgfri"],"checkbox-group.validation.required":["Minst ett valg er påkrevd."]}`)})),A,Ce=t((()=>{A=JSON.parse(`{"checkbox-group.label.optional":["Valfritt"],"checkbox-group.validation.required":["Minst ett val krävs."]}`)})),j,M,we=t((()=>{m(),v(),f(),l(),b(),de(),be(),xe(),Se(),k(),Ce(),s(),ie(E,O,D,T,A),j=()=>h._({id:`checkbox-group.validation.required`,message:`At least one selection is required.`,comment:`Shown when required checkbox group has no selections`}),M=class extends _(r){constructor(...e){super(...e),this.optional=!1,this.required=!1,this.invalid=!1,this.#e=!1,this.#t=!1,this._internalTabIndex=-1,this.#r=()=>{this.#o(),this.#_(),this.requestUpdate()},this.#i=()=>{this.#o(),this.#_(),this.requestUpdate()},this.#a=()=>{this.#l(),this.#_(),this.requestUpdate()},this.#s=()=>{this.requestUpdate()}}static{this.shadowRootOptions={...r.shadowRootOptions,delegatesFocus:!0}}#e;#t;#n;static{this.styles=p`
		.wrapper {
			display: inline-flex;

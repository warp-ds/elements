import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{_ as n,d as r,h as i,i as a,l as o,n as s,p as c,r as l,s as ee,t as u,u as d,v as te,x as f}from"./decorate-BxgRj7DM.js";import{i as p,n as ne,r as re,t as ie}from"./directive-CmXe-hdg.js";import{M as ae,_ as oe,b as se,bt as ce,j as m,l as le,u as ue,x as h,xt as g,y as de,yt as fe}from"./iframe-BKE-0EoA.js";import{a as pe,n as me,r as he,t as ge}from"./utilities-PUEjpjN2.js";import{n as _,t as v}from"./form-control-DtXadPi-.js";import{r as y,t as b}from"./if-defined-B1ZLCare.js";var x,_e=t((()=>{te(),re(),fe(),x=ie(class extends ne{constructor(e){if(super(e),e.type!==p.PROPERTY&&e.type!==p.ATTRIBUTE&&e.type!==p.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!g(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;let n=e.element,r=e.name;if(e.type===p.PROPERTY){if(t===n[r])return i}else if(e.type===p.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return i}else if(e.type===p.ATTRIBUTE&&n.getAttribute(r)===t+``)return i;return ce(e),t}})})),ve=t((()=>{_e()})),S,ye=t((()=>{d(),S=f`
	:host {
...
`})),C,be=t((()=>{v(),d(),l(),b(),ve(),le(),ye(),s(),C=class extends _(r){constructor(...e){super(...e),this.value=null,this.indeterminate=!1,this.checked=!1,this.disabled=!1,this.required=!1,this.invalid=!1,this.#e=!1,this.#t=!1,this.#n=!1,this.#r=()=>{this.#a(),this.#l()},this.#i=e=>{if(!this.disabled&&!e.defaultPrevented&&!(e.key!==` `&&e.key!==`Spacebar`&&e.key!==`Enter`)){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}e.composedPath()[0]!==this.input&&(e.preventDefault(),this.click())}}}static{this.styles=[ue,S]}static{this.shadowRootOptions={...r.shadowRootOptions,delegatesFocus:!0}}set name(e){this._ownName=e}get name(){return this._ownName||this._groupName}#e;#t;#n;get _computedInvalid(){return this.invalid||this._groupInvalid===!0}connectedCallback(){super.connectedCallback();let e=this.getAttribute(`value`);this.value=e??`on`,this.#e=this.hasAttribute(`checked`),this.checked=this.#e,this.addEventListener(`invalid`,this.#r),this.addEventListener(`keydown`,this.#i),this.#u()}handleClick(){this.disabled||(this.#a(),this.checked=!this.checked,this.indeterminate=!1,this.updateComplete.then(()=>{this.input.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}))}#r;#i;updated(e){super.updated(e),(e.has(`checked`)||e.has(`indeterminate`))&&this.#d(),this.#f(e)&&(this.#u(),this.#l())}resetFormControl(){this.checked=this.#e,this.#u(),this.#l()}click(){this.disabled||this.input?.click()}focus(e){this.input?.focus(e)}blur(){this.input?.blur()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#l(),this.internals.checkValidity()}reportValidity(){return this.#a(),this.#l(),this.internals.checkValidity()}#a(){this.#n=!0}#o(){return this.input?.validationMessage||` `}#s(){return this.input??void 0}#c(e){this.internals.setValidity(e,this.#o(),this.#s())}#l(){if(this.disabled){this.internals.setValidity({});return}let e=this.required&&!this.checked,t=this.invalid&&!this.#t;if(e){this.#t=!0,this.invalid=this.#n,this.#c({valueMissing:!0});return}if(this.#t&&=(this.invalid=!1,!1),t){this.#c({customError:!0});return}this.internals.setValidity({})}#u(){if(this.disabled){this.setValue(null);return}let e=this.checked?this.value:null;this.setValue(e)}#d(){this.input&&(this.input.checked=this.checked,this.input.indeterminate=this.indeterminate)}#f(e){return e.has(`checked`)||e.has(`value`)||e.has(`disabled`)||e.has(`required`)||e.has(`invalid`)}render(){let e=!this.checked&&this.indeterminate,t=e?`mixed`:this.checked?`true`:`false`;return n`
			<label part="base">
				<span part="control">
					<input
						...
						aria-checked=${t}
						aria-invalid=${y(this._computedInvalid?`true`:void 0)}
		...
		`}},u([a(`input[type="checkbox"]`)],C.prototype,`input`,void 0),u([o({reflect:!0})],C.prototype,`name`,null),u([o({reflect:!0})],C.prototype,`value`,void 0),u([o({type:Boolean,reflect:!0})],C.prototype,`indeterminate`,void 0),u([o({type:Boolean,reflect:!0})],C.prototype,`checked`,void 0),u([o({type:Boolean,reflect:!0})],C.prototype,`disabled`,void 0),u([o({type:Boolean,reflect:!0})],C.prototype,`required`,void 0),u([o({type:Boolean,reflect:!0})],C.prototype,`invalid`,void 0),u([o({attribute:!1})],C.prototype,`_groupInvalid`,void 0),u([o({attribute:!1})],C.prototype,`_groupName`,void 0),customElements.get(`w-checkbox`)||customElements.define(`w-checkbox`,C)})),w,T=t((()=>{w=JSON.parse(`{"checkbox-group.label.optional":["Valgfri"],"checkbox-group.validation.required":["Mindst én valgt mulighed er påkrævet."]}`)})),E,xe=t((()=>{E=JSON.parse(`{"checkbox-group.label.optional":["Optional"],"checkbox-group.validation.required":["At least one selection is required."]}`)})),D,Se=t((()=>{D=JSON.parse(`{"checkbox-group.label.optional":["Valinnainen"],"checkbox-group.validation.required":["Vähintään yksi valinta vaaditaan."]}`)})),O,k=t((()=>{O=JSON.parse(`{"checkbox-group.label.optional":["Valgfri"],"checkbox-group.validation.required":["Minst ett valg er påkrevd."]}`)})),A,Ce=t((()=>{A=JSON.parse(`{"checkbox-group.label.optional":["Valfritt"],"checkbox-group.validation.required":["Minst ett val krävs."]}`)})),j,M,we=t((()=>{ae(),v(),d(),l(),b(),de(),T(),xe(),Se(),k(),Ce(),s(),oe(E,O,D,w,A),j=()=>m._({id:`checkbox-group.validation.required`,message:`At least one selection is required.`,comment:`Shown when required checkbox group has no selections`}),M=class extends _(r){constructor(...e){super(...e),this.optional=!1,this.required=!1,this.invalid=!1,this.#e=!1,this.#t=!1,this._internalTabIndex=-1,this.#r=()=>{this.#o(),this.#_(),this.requestUpdate()},this.#i=()=>{this.#o(),this.#_(),this.requestUpdate()},this.#a=()=>{this.#l(),this.#_(),this.requestUpdate()},this.#s=()=>{this.requestUpdate()}}static{this.shadowRootOptions={...r.shadowRootOptions,delegatesFocus:!0}}#e;#t;#n;static{this.styles=f`
		.wrapper {
			display: inline-flex;
	...
	`}render(){let e=this.#c()>0,t=this.required&&!e&&this.#e,r=this.invalid||t,i=r?this.#p():this.helpText,a=i?`checkbox-group__help`:void 0,o=this.label?`checkbox-group__label`:void 0,s=r?`true`:void 0;return n`
		...
		`}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,this.#r),this.addEventListener(`invalid`,this.#i),this.addEventListener(`slotchange`,this.#a),this.#n=m.on(`change`,this.#s),this.setValue(null),this.#v()}disconnectedCallback(){this.#n?.(),this.#n=void 0,super.disconnectedCallback()}checkValidity(){return this.#_(),this.internals.checkValidity()}reportValidity(){return this.#o(),this.#_(),this.internals.checkValidity()}focus(e){let t=this.#d();if(t?.focus){t.focus(e);return}HTMLElement.prototype.focus.call(this,e)}#r;#i;#a;#o(){this.#e=!0}#s;#c(){return this.#f().filter(e=>e.checked).length}#l(){if(this.name)for(let e of this.#f()){let t=e;t&&typeof t==`object`&&!t.name&&(t._groupName=this.name)}}#u(e){for(let t of this.#f())`_groupInvalid`in t&&(t._groupInvalid=e)}#d(){return this.#f()[0]}#f(){return(this.shadowRoot?.querySelector(`slot`))?.assignedElements({flatten:!0})??[]}#p(){return j()}updated(e){super.updated(e),this.#m(e)&&(e.has(`name`)&&this.#l(),this.#_())}#m(e){return e.has(`invalid`)||e.has(`required`)||e.has(`helpText`)||e.has(`name`)}#h(e){let t=this.#d();this.internals.setValidity(e,` `,t??void 0)}#g(e){this._internalTabIndex=e?0:-1}#_(){this.#v();let e=this.#c()>0,t=this.required&&!e,n=this.invalid,r=t&&this.#e,i=n||r;if(this.#g(i),t){this.#h({valueMissing:!0}),this.#u(i);return}if(n){this.#h({customError:!0}),this.#u(!0);return}this.internals.setValidity({}),this.#u(!1)}#v(){this.#t||this.internals.form&&(this.name&&this.name.trim().length>0||(console.warn(`w-checkbox-group: "name" is required for form submission.`),this.#t=!0))}},u([o({type:String,reflect:!0})],M.prototype,`label`,void 0),u([o({type:String,reflect:!0})],M.prototype,`name`,void 0),u([o({type:Boolean,reflect:!0})],M.prototype,`optional`,void 0),u([o({type:String,reflect:!0,attribute:`help-text`})],M.prototype,`helpText`,void 0),u([o({type:Boolean,reflect:!0})],M.prototype,`required`,void 0),u([o({type:Boolean,reflect:!0})],M.prototype,`invalid`,void 0),u([ee()],M.prototype,`_internalTabIndex`,void 0),customElements.get(`w-checkbox-group`)||customElements.define(`w-checkbox-group`,M)})),Te=e({CheckboxFormAssociated:()=>H,CheckboxGroup:()=>W,CheckboxGroupFormAssociated:()=>Z,CheckboxGroupRequired:()=>X,CheckboxGroupWithHelpText:()=>G,CheckboxGroupWithHelpTextAndLabel:()=>q,CheckboxGroupWithInvalid:()=>Y,CheckboxGroupWithLabel:()=>K,CheckboxGroupWithOptional:()=>J,Default:()=>L,Disabled:()=>U,Indeterminate:()=>z,IndeterminateDisabled:()=>V,IndeterminateError:()=>B,Invalid:()=>R,__namedExportsOrder:()=>Q,default:()=>I}),N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=t((()=>{he(),h(),d(),ge(),be(),we(),{events:N,args:P,argTypes:F}=se(`w-checkbox`),I={title:`Forms/Checkbox`,render(e){return n` <w-checkbox ${pe(me(e))}>Check me</w-checkbox> `},args:P,argTypes:F,parameters:{actions:{handles:N}}},L={},R={args:{name:`invalidfoo`,value:`bar`,invalid:!0}},z={args:{name:`indeterminatefoo`,value:`bar`,indeterminate:!0}},B={args:{name:`indeterminateerrorfoo`,value:`bar`,indeterminate:!0,invalid:!0}},V={args:{name:`indeterminatedisabledfoo`,value:`bar`,indeterminate:!0,disabled:!0}},H={render:()=>n`
        ...
        `},U={args:{name:`disabledfoo`,value:`bar`,disabled:!0}},W={render:()=>n`

...
`})),T,Ce=e((()=>{a(),d(),g(),ae(),_(),he(),_e(),ye(),be(),xe(),Se(),v(),T=class extends c{static{this.shadowRootOptions={...c.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[y,w,p`
			:host {
		...
		`}},h([u({reflect:!0})],T.prototype,`label`,void 0),h([u({type:Boolean,reflect:!0})],T.prototype,`disabled`,void 0),h([u({type:Boolean,attribute:`open-ended`})],T.prototype,`openEnded`,void 0),h([u({type:String,reflect:!0})],T.prototype,`error`,void 0),h([u({type:String,reflect:!0,attribute:`help-text`})],T.prototype,`helpText`,void 0),h([u({type:Boolean,reflect:!0})],T.prototype,`invalid`,void 0),h([u({type:Boolean,reflect:!0})],T.prototype,`required`,void 0),h([u({type:Boolean,reflect:!0})],T.prototype,`optional`,void 0),h([u({reflect:!0})],T.prototype,`min`,void 0),h([u({reflect:!0})],T.prototype,`max`,void 0),h([u({type:Number,reflect:!0})],T.prototype,`markers`,void 0),h([u({type:Number,reflect:!0})],T.prototype,`step`,void 0),h([u({reflect:!0})],T.prototype,`suffix`,void 0),h([u({type:Boolean,reflect:!0,attribute:`hidden-textfield`})],T.prototype,`hiddenTextfield`,void 0),h([u({attribute:!1})],T.prototype,`valueFormatter`,void 0),h([u({attribute:!1})],T.prototype,`tooltipFormatter`,void 0),h([u({attribute:!1})],T.prototype,`labelFormatter`,void 0),h([l(`fieldset`)],T.prototype,`fieldset`,void 0),h([i()],T.prototype,`_invalidMessage`,void 0),h([i()],T.prototype,`_hasInternalError`,void 0),h([i()],T.prototype,`_showError`,void 0),h([i()],T.prototype,`_tabbableElements`,void 0),h([i()],T.prototype,`_hasLabel`,void 0),customElements.get(`w-slider`)||customElements.define(`w-slider`,T)})),E,we=e((()=>{a(),E=f(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`)})),D,Te=e((()=>{a(),D=p`
	.w-slider-thumb {
		position: relative;
		display: grid;
...
`})),O,k,A,Ee=e((()=>{g(),ce(),a(),d(),te(),ue(),we(),_(),Te(),v(),n(),O=/WebKit/,k=/Chrome/,A=class extends se(c){constructor(...e){super(...e),this.ariaLabel=null,this.ariaDescription=null,this.disabled=!1,this.invalid=!1,this.openEnded=!1,this.required=!1,this.suffix=``,this._showTooltip=!1,this._inputHasFocus=!1,this._hiddenTextfield=!1,this.#e=void 0,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...c.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[y,E,D]}#e;resetFormControl(){this.value=this.#e,this.dispatchEvent(new CustomEvent(`thumbreset`,{bubbles:!0}))}#t(){this._showTooltip=!0,this.shadowRoot.querySelector(`w-attention`).handleDone()}#n(){this._showTooltip=!1}#r(){this.range&&(this.value===``?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#i(e){this.dispatchEvent(new CustomEvent(`slidervalidity`,{bubbles:!0,detail:{invalid:e,slot:this.slot}}))}async updateFieldAfterValidation(){let e=this.shadowRoot.querySelector(`w-textfield`);await this.#a(e.value??``,!0)}async#a(e,t){let n=this.suffix??``,r=Number.parseInt(e);if(this.openEnded&&!t&&this.step&&!(this.slot===`to`&&r>=Number(this.max)-1||this.slot===`from`&&r<=Number(this.min)+1)){let t=1/this.step;r=Math.round(r*t)/t,e=r.toString()}let i=Number.parseInt(this.max),a=Number.parseInt(this.min);if(!this.openEnded&&(r>i||r<a))return this.#i(m.t({id:`slider.error.out_of_bounds`,message:`Value must be between {min} and {max}`,values:{min:`${this.min} ${n}`.trim(),max:`${this.max} ${n}`.trim()}})),{shouldCancel:!0};e===``&&this.required&&this.#i(m.t({id:`slider.error.required`,message:`This field is required`})),this.value=e;let o=e===this.max||e===this.min,s=!1;if(this.slot){let n=this.parentElement.querySelector(`w-slider-thumb[slot="to"]`),c=this.parentElement.querySelector(`w-slider-thumb[slot="from"]`),l=n.textfield.value||this.max,u=c.textfield.value||this.min,d=Number.parseInt(l),f=Number.parseInt(u),p=m.t({id:`slider.error.overlap`,message:`The maximum value cannot be less than the minimum`});if(this.slot===`from`){let n=this.openEnded&&d>i?d:Math.min(d,this.openEnded?i-1:i);r>n&&(s=!0,this.openEnded&&o?this.value=String(n):this.value=l,t&&(this.#i(p),await this.updateComplete,this.textfield.value=e))}else{let n=this.openEnded&&f<a?f:Math.max(Number.parseInt(u),this.openEnded?a+1:a);r<n&&(s=!0,this.openEnded&&o?this.value=String(n):this.value=u,t&&(this.#i(p),await this.updateComplete,this.textfield.value=e))}}return s?{shouldCancel:!0}:(this.#i(``),this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.openEnded&&!t&&o?``:e,this.shadowRoot.querySelector(`w-attention`).handleDone(),{shouldCancel:!1})}async#o(e){let t=e.currentTarget.tagName===`W-TEXTFIELD`;if(e instanceof CustomEvent)return!1;let n=e.currentTarget.value;return(await this.#a(n,t)).shouldCancel?(e.preventDefault(),!1):!0}async#s(e){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}if(!this.openEnded||e.key!==`ArrowLeft`&&e.key!==`ArrowRight`)return;let t=Number(this.range.value),n=this.step||1,r;r=e.key===`ArrowLeft`?t-n:t+n,r=Math.min(Math.max(r,Number(this.min)),Number(this.max)),(await this.#a(r.toString(),!1)).shouldCancel&&e.preventDefault()}async#c(e){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}if(this.textfield.value)return;let t=``;this.slot===`from`?e.key===`ArrowUp`?t=String(Number(this.min)+1)||`1`:e.key===`ArrowDown`&&(t=String(Number(this.min))||`0`):e.key===`ArrowUp`?t=String(Number(this.max))||`100`:e.key===`ArrowDown`&&(t=String(Number(this.max)-1)||`99`),t&&(e.preventDefault(),await this.#a(t,!0))}async connectedCallback(){if(super.connectedCallback(),this.#e=this.value,this.setValue(this.value),this.slot&&!this.ariaDescription&&(this.slot===`from`?this.ariaDescription=m.t({id:`slider.label.from`,comment:`Accessible label for the 'from value' input field in a range slider`,message:`From`}):this.slot===`to`&&(this.ariaDescription=m.t({id:`slider.label.to`,comment:`Accessible label for the 'to value' input field in a range slider`,message:`To`}))),`anchorName`in document.documentElement.style)await this.updateComplete;else{let e=import.meta.url.substring(0,import.meta.url.lastIndexOf(`/`));try{let[{default:t}]=await Promise.all([r(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement(`style`),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
      ...
      `,await t({roots:[this.shadowRoot],elements:[this.anchorPositioningStyleElement]})}catch(e){console.error(Error(`Error registering the CSS anchor positioning polyfill. The UI will look broken.`,{cause:e}))}}let e=window.navigator.userAgent;O.test(e)&&!k.test(e)&&this.tooltipTarget&&this.tooltipTarget.style.setProperty(`--transform-offset`,`var(--w-slider-thumb-size, 28px)`),this.#r()}get boundaryValue(){return this.slot===`from`?this.min:this.max}get textFieldDisplayValue(){return this._inputHasFocus&&this.value===``?this.range?.value?Math.min(Math.max(Number(this.range.value),Number(this.min)+1),Number(this.max)-1).toString():``:this.value}get tooltipDisplayValue(){let e;return e=this.tooltipFormatter?this.tooltipFormatter(this.value,this.slot):this.valueFormatter?this.valueFormatter(this.value,this.slot):this.value===``?this.range?.value??this.boundaryValue:this.value||0,e}get ariaDescriptionText(){let e=``,t=this.ariaDescription||``,n=this.value===``;return this.openEnded&&n&&(e=this.slot===`from`?m.t({id:`slider.placeholder.from`,message:`Min`}):m.t({id:`slider.placeholder.to`,message:`Max`})),e?`${e}, ${t}`:t}updated(e){if(e.has(`openEnded`)&&this.openEnded&&!this.placeholder&&(this.slot===`to`||this.slot===``?this.placeholder=m.t({id:`slider.placeholder.to`,message:`Max`,comment:`Max as in short for Maximum`}):this.slot===`from`&&(this.placeholder=m.t({id:`slider.placeholder.from`,message:`Min`,comment:`Min as in short for Minimum`}))),e.has(`value`)){this.#e===void 0&&this.value!==void 0&&(this.#e=this.value),this.setValue(this.value),this.#r();let t=e.get(`value`);this.value===``&&t&&this.dispatchEvent(new CustomEvent(`thumbreset`,{bubbles:!0}))}}render(){let e=this.placeholder&&!this.value;return s`
		...
		`}},h([u({attribute:`aria-label`})],A.prototype,`ariaLabel`,void 0),h([u({attribute:`aria-description`})],A.prototype,`ariaDescription`,void 0),h([u({reflect:!0})],A.prototype,`name`,void 0),h([u({reflect:!0})],A.prototype,`value`,void 0),h([u({type:Boolean,reflect:!0})],A.prototype,`disabled`,void 0),h([u({type:Boolean,reflect:!0})],A.prototype,`invalid`,void 0),h([u({attribute:!1,reflect:!1})],A.prototype,`openEnded`,void 0),h([u({reflect:!0})],A.prototype,`placeholder`,void 0),h([i()],A.prototype,`markers`,void 0),h([i()],A.prototype,`required`,void 0),h([i()],A.prototype,`step`,void 0),h([i()],A.prototype,`min`,void 0),h([i()],A.prototype,`max`,void 0),h([i()],A.prototype,`suffix`,void 0),h([u({attribute:!1})],A.prototype,`valueFormatter`,void 0),h([u({attribute:!1})],A.prototype,`tooltipFormatter`,void 0),h([u({attribute:!1})],A.prototype,`labelFormatter`,void 0),h([l(`input[type="range"]`)],A.prototype,`range`,void 0),h([l(`.w-slider-thumb__tooltip-target`)],A.prototype,`tooltipTarget`,void 0),h([l(`w-textfield`)],A.prototype,`textfield`,void 0),h([i()],A.prototype,`_showTooltip`,void 0),h([i()],A.prototype,`_inputHasFocus`,void 0),h([i()],A.prototype,`_hiddenTextfield`,void 0),customElements.get(`w-slider-thumb`)||customElements.define(`w-slider-thumb`,A)})),De=t({CustomError:()=>J,Description:()=>Y,HiddenMinimumMaximumLabels:()=>Z,Marks:()=>U,OpenEnded:()=>G,Range:()=>R,RangeError:()=>q,RangeOptional:()=>z,Single:()=>F,SingleDisabled:()=>I,SingleError:()=>K,SingleOptional:()=>L,Step:()=>W,SuffixCurrency:()=>V,SuffixKilometers:()=>H,SuffixSquareMeters:()=>B,VisuallyHiddenLabel:()=>X,VisuallyHiddenTextfield:()=>Q,__namedExportsOrder:()=>$,default:()=>P}),Oe,ke,Ae,je,Me,Ne,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,Pe=e((()=>{ne(),a(),re(),le(),de(),pe(),Ce(),Ee(),fe(),{events:j,args:M,argTypes:N}=ie(`w-slider`),P={title:`Forms/Slider and Range Slider`,args:M,argTypes:N,parameters:{actions:{handles:j}}},F={render(){return s`
            <form>
        ...
        `}},V={args:{locale:`nb`,suffix:`kr`},render({locale:e,suffix:t}){return s(Oe||=x([`
            <w-slider
                label="Price"
                min="0"
                max="250000"
            ...
            <\/script>
        `]),t,e)}},H={args:{locale:`nb`,suffix:`km`},render({locale:e,suffix:t}){return s(ke||=x([`
            <w-slider
                label="Distance"
                min="0"
                max="250000"
        ...
        `}},Z={render(){return s(Me||=x([`
            ...
            <\/script>
        `]))}},Q={render({locale:e}){return s(Ne||=x([`

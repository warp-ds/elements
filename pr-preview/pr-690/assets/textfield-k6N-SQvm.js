import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{c as t,d as n,h as r,l as i,n as a,s as o,t as s,x as c,y as l}from"./decorators-BoKEMuNh.js";import{n as u,t as d}from"./class-map-C6ketRHB.js";import{O as f,_ as p,f as m,k as h,l as g,p as _,u as v,v as y,x as b,y as x}from"./iframe-1xX-GGbm.js";import{n as S,t as C}from"./form-control-BSFyWBnN.js";import{r as w,t as T}from"./if-defined-CAJ93-y8.js";var E,D=e((()=>{E=JSON.parse(`{"textfield.label.optional":["Valgfri"]}`)})),O,k=e((()=>{O=JSON.parse(`{"textfield.label.optional":["Optional"]}`)})),A,j=e((()=>{A=JSON.parse(`{"textfield.label.optional":["Valinnainen"]}`)})),M,N=e((()=>{M=JSON.parse(`{"textfield.label.optional":["Valgfri"]}`)})),P,F=e((()=>{P=JSON.parse(`{"textfield.label.optional":["Valfritt"]}`)})),I,L=e((()=>{t(),I=l`
	.w-textfield {

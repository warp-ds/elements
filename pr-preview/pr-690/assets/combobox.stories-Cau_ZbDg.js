			...
			>
				...
				>
					<ul
						...
						class="${P.listbox}"
					>
						${ae(this._currentOptions,e=>e.key,e=>{let t=e.label||e.value;return n`
									<li
										id=${e.id}
										role="option"

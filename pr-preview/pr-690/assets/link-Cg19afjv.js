import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{c as t,d as n,h as r,l as i,s as a,t as o,y as s}from"./decorators-BoKEMuNh.js";import{n as c,t as l}from"./decorate-BUw_Sz5x.js";import{n as u,t as d}from"./styles-CVeKeHRg.js";var f,p,m,h,g,_=e((()=>{t(),f=s`
	:host {
...
`})),b,x,S=e((()=>{t(),o(),d(),y(),c(),b=[`primary`,`secondary`,`negative`,`negativeQuiet`,`utility`,`utilityQuiet`,`quiet`,`link`,`overlay`,`overlayInverted`,`overlayQuiet`,`overlayInvertedQuiet`],x=class extends i{constructor(...e){super(...e),this.autofocus=!1,this.small=!1,this.disabled=!1,this.fullWidth=!1}static{this.shadowRootOptions={...i.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[u,v]}connectedCallback(){if(super.connectedCallback(),this.variant&&!b.includes(this.variant))throw Error(`Invalid "variant" attribute. Set its value to one of the following:\n${b.join(`, `)}.`)}firstUpdated(){this.autofocus&&setTimeout(()=>this.focus(),0)}render(){return r`
		...
		`}},l([a({type:Boolean,reflect:!0})],x.prototype,`autofocus`,void 0),l([a({reflect:!0})],x.prototype,`variant`,void 0),l([a({type:Boolean,reflect:!0})],x.prototype,`small`,void 0),l([a({reflect:!0})],x.prototype,`href`,void 0),l([a({type:Boolean,reflect:!0})],x.prototype,`disabled`,void 0),l([a({reflect:!0})],x.prototype,`target`,void 0),l([a({reflect:!0})],x.prototype,`rel`,void 0),l([a({attribute:`full-width`,type:Boolean,reflect:!0})],x.prototype,`fullWidth`,void 0),customElements.get(`w-link`)||customElements.define(`w-link`,x)}));export{_ as n,g as r,S as t};
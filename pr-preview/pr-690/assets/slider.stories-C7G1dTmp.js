...
`})),E,Se=t((()=>{l(),h(),oe(),v(),me(),ge(),ve(),ye(),be(),xe(),m(),E=class extends c{static{this.shadowRootOptions={...c.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[y,T]}constructor(){super(),this.disabled=!1,this.openEnded=!1,this.invalid=!1,this.required=!1,this.hiddenTextfield=!1,this._invalidMessage=``,this._hasInternalError=!1,this._showError=!1,this._tabbableElements=[],re(he,C,_e,S,w)}#e(){let e=this.querySelectorAll(`w-slider-thumb`),t=!1;for(let n of e.values())n.min=this.edgeMin,n.max=this.edgeMax,n.step=this.step,n.suffix=this.suffix??``,n.required=this.required,n.labelFormatter=this.labelFormatter,n.valueFormatter=this.valueFormatter,n.tooltipFormatter=this.tooltipFormatter,n.openEnded=this.openEnded,n._hiddenTextfield=this.hiddenTextfield,n.ariaLabel||(n.slot||(n.ariaLabel=this.label||null),n.slot===`from`&&(n.ariaLabel=`${this.label} min`),n.slot===`to`&&(n.ariaLabel=`${this.label} max`)),(n.slot===`from`||n.slot===`to`)&&(t=!0),n.disabled=this.disabled,n.invalid=!!this.errorText,this.#c(n);t?(this.fieldset.style.setProperty(`--active-range-inline-start-padding`,`var(--w-slider-thumb-size, 28px)`),this.fieldset.style.setProperty(`--active-range-inline-end-padding`,`var(--w-slider-thumb-size, 28px)`)):this.fieldset.style.setProperty(`--active-range-border-radius`,`4px`)}get edgeMin(){return this.openEnded?(Number(this.min)-1).toString():this.min}get edgeMax(){return this.openEnded?(Number(this.max)+1).toString():this.max}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.step&&this.fieldset.style.setProperty(`--step`,String(this.step)),this.min!==void 0&&this.fieldset.style.setProperty(`--min`,this.edgeMin),this.max!==void 0&&this.fieldset.style.setProperty(`--max`,this.max),this.markers&&this.fieldset.style.setProperty(`--markers`,String(this.markers)),this.openEnded&&this.fieldset.style.setProperty(`--over-under-offset`,`1`);let e=this.querySelectorAll(`w-slider-thumb`);if(e.length===2){this.fieldset.style.setProperty(`--range-slider-magic-pixel`,`1px`);let t=[...e];this._tabbableElements[0]=t[0].shadowRoot.querySelector(`input`),this._tabbableElements[1]=t[1].shadowRoot.querySelector(`input`),this._tabbableElements[2]=t[0].shadowRoot.querySelector(`w-textfield`),this._tabbableElements[3]=t[1].shadowRoot.querySelector(`w-textfield`)}else if(e.length===1){let t=[...e];this._tabbableElements[0]=t[0].shadowRoot.querySelector(`input`),this._tabbableElements[1]=t[0].shadowRoot.querySelector(`w-textfield`)}this.invalid&&this.error&&(this._showError=!0),this.#e()}updated(e){(e.has(`disabled`)||e.has(`required`)||e.has(`min`)||e.has(`step`)||e.has(`max`)||e.has(`suffix`)||e.has(`labelFormatter`)||e.has(`valueFormatter`)||e.has(`_invalidMessage`)||e.has(`_hasInternalError`))&&this.#e(),(e.has(`error`)||e.has(`invalid`))&&(this.error&&this.invalid?this._showError=!0:this._showError=!1,this.#e())}#t(e){e.stopPropagation();let t=e.target;this.#c(t)}#n(e){let t=e.target;this.#c(t),t.slot&&this.#a()}#r(){this.componentHasError?this._showError=!0:this._showError=!1,this.#e()}#i(e){if(e.key===`Tab`){let t=this._tabbableElements.indexOf(e.target.shadowRoot.activeElement);if(t===-1)return;let n=e.shiftKey?-1:1,r=this._tabbableElements[t+n];if(!r)return;e.preventDefault(),r.focus()}}#a(){let e=null,t=null,n=this.querySelectorAll(`w-slider-thumb`);for(let r of n.values())r.slot===`from`&&(e=r),r.slot===`to`&&(t=r);!e||!t||!e.invalid&&t.invalid}#o(e){e.stopPropagation();let t=this._hasInternalError||this.invalid,n=e.target;if(this._hasInternalError=!!e.detail.invalid||this.invalid,this._invalidMessage=e.detail.invalid,t===!0&&this._hasInternalError===!1){let e=this.querySelectorAll(`w-slider-thumb`);for(let t of e.values())t!==n&&t.updateFieldAfterValidation()}}#s(e,t){return t.value??=this.openEnded?``:e,t.value===``?e:t.value}#c(e){let t=e.slot;t||this.fieldset.style.setProperty(`--from`,`0`),t===`from`&&this.fieldset.style.setProperty(`--from`,this.#s(this.edgeMin,e)),(!t||t===`to`)&&this.fieldset.style.setProperty(`--to`,this.#s(this.edgeMax,e))}get componentHasError(){return this.invalid||this._hasInternalError}get errorText(){return this._showError?this.error||this._invalidMessage:``}render(){return a`
			...
			>
				...
				${this.markers?a`<div class="w-slider__markers"></div>`:s}
		...
		`}},_([p({reflect:!0})],E.prototype,`label`,void 0),_([p({type:Boolean,reflect:!0})],E.prototype,`disabled`,void 0),_([p({type:Boolean,attribute:`open-ended`})],E.prototype,`openEnded`,void 0),_([p({type:String,reflect:!0})],E.prototype,`error`,void 0),_([p({type:String,reflect:!0,attribute:`help-text`})],E.prototype,`helpText`,void 0),_([p({type:Boolean,reflect:!0})],E.prototype,`invalid`,void 0),_([p({type:Boolean,reflect:!0})],E.prototype,`required`,void 0),_([p({reflect:!0})],E.prototype,`min`,void 0),_([p({reflect:!0})],E.prototype,`max`,void 0),_([p({type:Number,reflect:!0})],E.prototype,`markers`,void 0),_([p({type:Number,reflect:!0})],E.prototype,`step`,void 0),_([p({reflect:!0})],E.prototype,`suffix`,void 0),_([p({type:Boolean,reflect:!0,attribute:`hidden-textfield`})],E.prototype,`hiddenTextfield`,void 0),_([p({attribute:!1})],E.prototype,`valueFormatter`,void 0),_([p({attribute:!1})],E.prototype,`tooltipFormatter`,void 0),_([p({attribute:!1})],E.prototype,`labelFormatter`,void 0),_([f(`fieldset`)],E.prototype,`fieldset`,void 0),_([g()],E.prototype,`_invalidMessage`,void 0),_([g()],E.prototype,`_hasInternalError`,void 0),_([g()],E.prototype,`_showError`,void 0),_([g()],E.prototype,`_tabbableElements`,void 0),customElements.get(`w-slider`)||customElements.define(`w-slider`,E)})),D,Ce=t((()=>{l(),D=i(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`)})),O,we=t((()=>{l(),O=o`
	.w-slider-thumb {
		position: relative;
		display: grid;
      ...
      `,await t({roots:[this.shadowRoot],elements:[this.anchorPositioningStyleElement]})}catch(e){console.error(Error(`Error registering the CSS anchor positioning polyfill. The UI will look broken.`,{cause:e}))}}let e=window.navigator.userAgent;k.test(e)&&!A.test(e)&&this.tooltipTarget&&this.tooltipTarget.style.setProperty(`--transform-offset`,`var(--w-slider-thumb-size, 28px)`),this.#r()}get boundaryValue(){return this.slot===`from`?this.min:this.max}get textFieldDisplayValue(){return this._inputHasFocus&&this.value===``?this.range?.value?Math.min(Math.max(Number(this.range.value),Number(this.min)+1),Number(this.max)-1).toString():``:this.value}get tooltipDisplayValue(){let e;return e=this.tooltipFormatter?this.tooltipFormatter(this.value,this.slot):this.valueFormatter?this.valueFormatter(this.value,this.slot):this.value===``?this.range?.value??this.boundaryValue:this.value||0,e}get ariaDescriptionText(){let e=``,t=this.ariaDescription||``,n=this.value===``;return this.openEnded&&n&&(e=this.slot===`from`?d.t({id:`slider.placeholder.from`,message:`Min`}):d.t({id:`slider.placeholder.to`,message:`Max`})),e?`${e}, ${t}`:t}updated(e){if(e.has(`openEnded`)&&this.openEnded&&!this.placeholder&&(this.slot===`to`||this.slot===``?this.placeholder=d.t({id:`slider.placeholder.to`,message:`Max`,comment:`Max as in short for Maximum`}):this.slot===`from`&&(this.placeholder=d.t({id:`slider.placeholder.from`,message:`Min`,comment:`Min as in short for Minimum`}))),e.has(`value`)){this.#e===void 0&&this.value!==void 0&&(this.#e=this.value),this.setValue(this.value),this.#r();let t=e.get(`value`);this.value===``&&t&&this.dispatchEvent(new CustomEvent(`thumbreset`,{bubbles:!0}))}}render(){let e=this.placeholder&&!this.value;return a`
			<div class="w-slider-thumb">
				...
				${this.slot===`from`||!this.slot?a` <span class="sr-only">
							${d.t({id:`slider.label.from`,message:`From`})+` `+(this.labelFormatter?this.labelFormatter(`from`):this.min)+`, `+d.t({id:`slider.label.to`,message:`To`})+` `+(this.labelFormatter?this.labelFormatter(`to`):this.max)}
						</span>`:s}
				...
				<w-textfield
					...
					type="number"
					tabindex="${this._hiddenTextfield?-1:s}"
					placeholder="${this.placeholder}"
					.value="${this.textFieldDisplayValue}"
					.formatter=${this.valueFormatter&&!e?e=>this.valueFormatter(e,this.slot):s}
					min="${this.openEnded?s:this.min}"
					max="${this.openEnded?s:this.max}"
					step="${b(this.step)}"
				...
				>
					...
					></output>
					<span slot="message">
						${this.tooltipDisplayValue}${this.suffix??``?a`&nbsp;${this.suffix??``}`:s}
					</span>
				</w-attention>
		...
		`}},_([p({attribute:`aria-label`})],j.prototype,`ariaLabel`,void 0),_([p({attribute:`aria-description`})],j.prototype,`ariaDescription`,void 0),_([p({reflect:!0})],j.prototype,`name`,void 0),_([p({reflect:!0})],j.prototype,`value`,void 0),_([p({type:Boolean,reflect:!0})],j.prototype,`disabled`,void 0),_([p({type:Boolean,reflect:!0})],j.prototype,`invalid`,void 0),_([p({attribute:!1,reflect:!1})],j.prototype,`openEnded`,void 0),_([p({reflect:!0})],j.prototype,`placeholder`,void 0),_([g()],j.prototype,`markers`,void 0),_([g()],j.prototype,`required`,void 0),_([g()],j.prototype,`step`,void 0),_([g()],j.prototype,`min`,void 0),_([g()],j.prototype,`max`,void 0),_([g()],j.prototype,`suffix`,void 0),_([p({attribute:!1})],j.prototype,`valueFormatter`,void 0),_([p({attribute:!1})],j.prototype,`tooltipFormatter`,void 0),_([p({attribute:!1})],j.prototype,`labelFormatter`,void 0),_([f(`input[type="range"]`)],j.prototype,`range`,void 0),_([f(`.w-slider-thumb__tooltip-target`)],j.prototype,`tooltipTarget`,void 0),_([f(`w-textfield`)],j.prototype,`textfield`,void 0),_([g()],j.prototype,`_showTooltip`,void 0),_([g()],j.prototype,`_inputHasFocus`,void 0),_([g()],j.prototype,`_hiddenTextfield`,void 0),customElements.get(`w-slider-thumb`)||customElements.define(`w-slider-thumb`,j)})),Ee=e({CustomError:()=>q,Description:()=>J,HiddenMinimumMaximumLabels:()=>X,Marks:()=>H,OpenEnded:()=>W,Range:()=>R,RangeError:()=>K,Single:()=>I,SingleDisabled:()=>L,SingleError:()=>G,Step:()=>U,SuffixCurrency:()=>B,SuffixKilometers:()=>V,SuffixSquareMeters:()=>z,VisuallyHiddenLabel:()=>Y,VisuallyHiddenTextfield:()=>Z,__namedExportsOrder:()=>Q,default:()=>F}),De,Oe,ke,Ae,je,Me,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=t((()=>{ae(),l(),ne(),le(),de(),pe(),Se(),Te(),fe(),{events:M,args:N,argTypes:P}=ie(`w-slider`),F={title:`Forms/Slider and Range Slider`,args:N,argTypes:P,parameters:{actions:{handles:M}}},I={render(){return a`
            <form>
        ...
        `}},z={args:{locale:`nb`,suffix:`m²`},render({suffix:e}){return a`
            <w-slider
        ...
        `}},B={args:{locale:`nb`,suffix:`kr`},render({locale:e,suffix:t}){return a(De||=x([`
            <w-slider
                label="Price"
                min="0"
                max="250000"
            ...
            <\/script>
        `]),t,e)}},V={args:{locale:`nb`,suffix:`km`},render({locale:e,suffix:t}){return a(Oe||=x([`
            <w-slider
                label="Distance"
                min="0"
                max="250000"
            ...
            <\/script>
        `]),t,e)}},H={args:{locale:`nb`,step:`5`,markers:`5`},render({markers:e,step:t}){return a`
            <w-slider
                label="Single"
                min="0"
                max="100"
        ...
        `}},U={args:{step:5},render({step:e}){return a`
            <w-slider label="Single" step="${e}" min="0" max="100">
                <w-slider-thumb name="value"></w-slider-thumb>
            </w-slider>
        `}},W={args:{},render(){return a(ke||=x([`
        ...
        `}},K={args:{},render(){return a(Ae||=x([`
            ...
            <\/script>
        `]))}},q={args:{error:`I'm an external error telling you something is wrong`,invalid:!0},render(e){return a`
            <w-slider
                label="Model year"
                min="1950"
                max="2025"
        ...
        `}},X={render(){return a(je||=x([`
            ...
            <\/script>
        `]))}},Z={render({locale:e}){return a(Me||=x([`

import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{c as n,d as r,h as i,l as a,s as o,t as s,y as c}from"./decorators-BoKEMuNh.js";import{a as l,o as u,r as d,t as f}from"./i18n-Cu-tp5qV.js";import{n as p,t as m}from"./dist-B-Y-CnmQ.js";import{n as h,t as g}from"./decorate-BUw_Sz5x.js";import{n as _,t as v}from"./styles-CVeKeHRg.js";import{a as y,n as b,r as x,t as S}from"./utilities-DIER-odo.js";import{r as C,t as w}from"./if-defined-CAJ93-y8.js";var T,E=e((()=>{T=JSON.parse(`{"card.button.text":["Vælg"]}`)})),D,O=e((()=>{D=JSON.parse(`{"card.button.text":["Select"]}`)})),k,A=e((()=>{k=JSON.parse(`{"card.button.text":["Valitse"]}`)})),j,M=e((()=>{j=JSON.parse(`{"card.button.text":["Velg"]}`)})),N,P=e((()=>{N=JSON.parse(`{"card.button.text":["Välj"]}`)})),F,I=e((()=>{n(),F=c`
	:host {
...
`})),L,R,z=e((()=>{u(),n(),s(),w(),d(),v(),E(),O(),A(),M(),P(),I(),h(),L={ENTER:`Enter`,SPACE:` `},R=class extends a{static{this.styles=[_,F,c`
			a::after {
				content: "";
				position: absolute;
				top: 0;
		...
		`]}constructor(){super(),this.selected=!1,this.flat=!1,this.clickable=!1,f(D,j,k,T,N),this.buttonText=l._({id:`card.button.text`,message:`Select`,comment:`Screenreader message to indicate that the card is clickable`})}keypressed(e){!this.clickable||e.altKey||e.ctrlKey||(e.key===L.ENTER||e.key===L.SPACE)&&(e.preventDefault(),this.click())}render(){return i`
			<div
				part="base"
		...
		`}},g([o({type:Boolean,reflect:!0})],R.prototype,`selected`,void 0),g([o({type:Boolean})],R.prototype,`flat`,void 0),g([o({type:Boolean})],R.prototype,`clickable`,void 0),customElements.get(`w-card`)||customElements.define(`w-card`,R)})),B=t({Clickable:()=>Y,Default:()=>G,Flat:()=>q,FlatSelected:()=>J,PropertyExample:()=>X,Selected:()=>K,StylingApi:()=>Z,__namedExportsOrder:()=>Q,default:()=>W}),V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{x(),p(),n(),S(),z(),{events:V,args:H,argTypes:U}=m(`w-card`),W={title:`Navigation/Card`,render(e){return i`
            <w-card ${y(b(e))}>

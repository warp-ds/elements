import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{c as n,h as r,i,l as a,n as o,o as s,t as c}from"./lit-BuckkhbU.js";import{n as ee,t as l}from"./dist-BTTyunOH.js";import{i as u,n as te,r as ne,t as re}from"./directive-CmXe-hdg.js";import{i as ie,l as d,n as f,r as p,s as ae,t as m}from"./decorate-CINhncxq.js";import{_ as oe,_t as se,b as ce,l as h,u as g,vt as le,x as ue,y as de,yt as _}from"./iframe-rD-3RpFu.js";import{a as fe,n as pe,r as me,t as he}from"./utilities-D2RYQTxo.js";import{n as v,t as y}from"./form-control-DtXadPi-.js";import{r as b,t as x}from"./if-defined-BeZEKn_8.js";var S,ge=t((()=>{a(),ne(),se(),S=re(class extends te{constructor(e){if(super(e),e.type!==u.PROPERTY&&e.type!==u.ATTRIBUTE&&e.type!==u.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!_(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===s||t===i)return t;let n=e.element,r=e.name;if(e.type===u.PROPERTY){if(t===n[r])return s}else if(e.type===u.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return s}else if(e.type===u.ATTRIBUTE&&n.getAttribute(r)===t+``)return s;return le(e),t}})})),_e=t((()=>{ge()})),C,ve=t((()=>{c(),C=r`
	:host {
...
`})),w,ye=t((()=>{y(),c(),p(),x(),_e(),h(),ve(),f(),w=class extends v(o){constructor(...e){super(...e),this.value=null,this.indeterminate=!1,this.checked=!1,this.disabled=!1,this.required=!1,this.invalid=!1,this.#e=!1,this.#t=!1,this.#n=!1,this.#r=()=>{this.#a(),this.#l()},this.#i=e=>{if(!this.disabled&&!e.defaultPrevented&&!(e.key!==` `&&e.key!==`Spacebar`&&e.key!==`Enter`)){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}e.composedPath()[0]!==this.input&&(e.preventDefault(),this.click())}}}static{this.styles=[g,C]}static{this.shadowRootOptions={...o.shadowRootOptions,delegatesFocus:!0}}set name(e){this._ownName=e}get name(){return this._ownName||this._groupName}#e;#t;#n;get _computedInvalid(){return this.invalid||this._groupInvalid===!0}connectedCallback(){super.connectedCallback();let e=this.getAttribute(`value`);this.value=e??`on`,this.#e=this.hasAttribute(`checked`),this.checked=this.#e,this.addEventListener(`invalid`,this.#r),this.addEventListener(`keydown`,this.#i),this.#u()}handleClick(){this.disabled||(this.#a(),this.checked=!this.checked,this.indeterminate=!1,this.updateComplete.then(()=>{this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}))}#r;#i;updated(e){super.updated(e),(e.has(`checked`)||e.has(`indeterminate`))&&this.#d(),this.#f(e)&&(this.#u(),this.#l())}resetFormControl(){this.checked=this.#e,this.#u(),this.#l()}click(){this.disabled||this.input?.click()}focus(e){this.input?.focus(e)}blur(){this.input?.blur()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#l(),this.internals.checkValidity()}reportValidity(){return this.#a(),this.#l(),this.internals.checkValidity()}#a(){this.#n=!0}#o(){return this.input?.validationMessage||` `}#s(){return this.input??void 0}#c(e){this.internals.setValidity(e,this.#o(),this.#s())}#l(){if(this.disabled){this.internals.setValidity({});return}let e=this.required&&!this.checked,t=this.invalid&&!this.#t;if(e){this.#t=!0,this.invalid=this.#n,this.#c({valueMissing:!0});return}if(this.#t&&=(this.invalid=!1,!1),t){this.#c({customError:!0});return}this.internals.setValidity({})}#u(){if(this.disabled){this.setValue(null);return}let e=this.checked?this.value:null;this.setValue(e)}#d(){this.input&&(this.input.checked=this.checked,this.input.indeterminate=this.indeterminate)}#f(e){return e.has(`checked`)||e.has(`value`)||e.has(`disabled`)||e.has(`required`)||e.has(`invalid`)}render(){let e=!this.checked&&this.indeterminate,t=e?`mixed`:this.checked?`true`:`false`;return n`
		...
		`}},m([ie(`input[type="checkbox"]`)],w.prototype,`input`,void 0),m([d({reflect:!0})],w.prototype,`name`,null),m([d({reflect:!0})],w.prototype,`value`,void 0),m([d({type:Boolean,reflect:!0})],w.prototype,`indeterminate`,void 0),m([d({type:Boolean,reflect:!0})],w.prototype,`checked`,void 0),m([d({type:Boolean,reflect:!0})],w.prototype,`disabled`,void 0),m([d({type:Boolean,reflect:!0})],w.prototype,`required`,void 0),m([d({type:Boolean,reflect:!0})],w.prototype,`invalid`,void 0),m([d({attribute:!1})],w.prototype,`_groupInvalid`,void 0),m([d({attribute:!1})],w.prototype,`_groupName`,void 0),customElements.get(`w-checkbox`)||customElements.define(`w-checkbox`,w)})),T,be=t((()=>{T=JSON.parse(`{"checkbox-group.label.optional":["Valgfri"],"checkbox-group.validation.required":["Mindst én valgt mulighed er påkrævet."]}`)})),E,xe=t((()=>{E=JSON.parse(`{"checkbox-group.label.optional":["Optional"],"checkbox-group.validation.required":["At least one selection is required."]}`)})),D,Se=t((()=>{D=JSON.parse(`{"checkbox-group.label.optional":["Valinnainen"],"checkbox-group.validation.required":["Vähintään yksi valinta vaaditaan."]}`)})),O,k=t((()=>{O=JSON.parse(`{"checkbox-group.label.optional":["Valgfri"],"checkbox-group.validation.required":["Minst ett valg er påkrevd."]}`)})),A,Ce=t((()=>{A=JSON.parse(`{"checkbox-group.label.optional":["Valfritt"],"checkbox-group.validation.required":["Minst ett val krävs."]}`)})),j,M,we=t((()=>{ee(),y(),c(),p(),x(),de(),be(),xe(),Se(),k(),Ce(),f(),oe(E,O,D,T,A),j=()=>l._({id:`checkbox-group.validation.required`,message:`At least one selection is required.`,comment:`Shown when required checkbox group has no selections`}),M=class extends v(o){constructor(...e){super(...e),this.optional=!1,this.required=!1,this.invalid=!1,this.#e=!1,this.#t=!1,this._internalTabIndex=-1,this.#r=()=>{this.#o(),this.#_(),this.requestUpdate()},this.#i=()=>{this.#o(),this.#_(),this.requestUpdate()},this.#a=()=>{this.#l(),this.#_(),this.requestUpdate()},this.#s=()=>{this.requestUpdate()}}static{this.shadowRootOptions={...o.shadowRootOptions,delegatesFocus:!0}}#e;#t;#n;static{this.styles=r`
		.wrapper {
			display: inline-flex;
	...
	`}render(){let e=this.#c()>0,t=this.required&&!e&&this.#e,r=this.invalid||t,a=r?this.#p():this.helpText,o=a?`checkbox-group__help`:void 0,s=this.label?`checkbox-group__label`:void 0,c=r?`true`:void 0;return n`

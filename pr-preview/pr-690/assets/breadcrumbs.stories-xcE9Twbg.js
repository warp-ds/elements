import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{c as n,d as r,h as i,l as a,s as o,t as s,x as c,y as l}from"./decorators-CPAv1fbk.js";import{C as u,N as d,P as f,S as p,l as m,u as h,x as g,y as _}from"./iframe-JOZezF-2.js";import{a as v,n as y,r as b,t as x}from"./utilities-CIV6bzq0.js";function S(e,t){return e.flatMap(e=>[e,t]).slice(0,-1)}var C=t((()=>{})),w,T=t((()=>{w=JSON.parse(`{"breadcrumbs.ariaLabel":["Du er her"]}`)})),E,D=t((()=>{E=JSON.parse(`{"breadcrumbs.ariaLabel":["You are here"]}`)})),O,k=t((()=>{O=JSON.parse(`{"breadcrumbs.ariaLabel":["Olet tässä"]}`)})),A,j=t((()=>{A=JSON.parse(`{"breadcrumbs.ariaLabel":["Her er du"]}`)})),M,N=t((()=>{M=JSON.parse(`{"breadcrumbs.ariaLabel":["Du är här"]}`)})),P,F=t((()=>{n(),P=c(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.flex{display:flex}.static{position:static}.s-text{color:var(--w-s-color-text)}.s-text-link{color:var(--w-s-color-text-link)}.s-icon{color:var(--w-s-color-icon)}.space-x-8>:not([hidden])~:not([hidden]){--w-space-x-reverse:0;margin-left:calc(.8rem * calc(1 - var(--w-space-x-reverse)));margin-right:calc(.8rem * var(--w-space-x-reverse))}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}.select-none{-webkit-user-select:none;user-select:none}`)})),I,L,R,z=t((()=>{f(),C(),n(),g(),m(),T(),D(),k(),j(),N(),F(),I={wrapper:`flex space-x-8`,text:`s-text`,link:`s-text-link`,separator:`select-none s-icon`,a11y:`sr-only`},L=i`<span class=${I.separator}>/</span>`,R=class extends a{static{this.styles=[h,P]}constructor(){super(),this._children=[],this._internals=this.attachInternals(),_(E,A,O,w,M),this._defaultLabel=d._({id:`breadcrumbs.ariaLabel`,message:`You are here`,comment:`Default screen reader message for the breadcrumb component`}),this._internals.ariaLabel=this._defaultLabel}get _label(){return this.ariaLabel??this._defaultLabel}connectedCallback(){super.connectedCallback(),this._internals.role=`navigation`;let e=this.querySelectorAll(`:scope > a`),t=this.querySelectorAll(`:scope > span`),n=this.querySelectorAll(`w-breadcrumb-item`);n.length>0&&(e.length>0||t.length>0)&&console.warn(`Mixing Legacy API and w-breadcrumb-item API children is not supported.`);let r=0,a=!1;n.forEach((e,t)=>{e.hasAttribute(`current-page`)&&(t<n.length-1&&(a=!0),r++)}),r>1&&console.warn(`Please ensure only one w-breadcrumb-item has the current-page attribute.`),a&&console.warn(`The current-page attribute should only be used on the final breadcrumb item.`);let o=[...this.children].filter(e=>e&&e.tagName!==`W-BREADCRUMB-ITEM`).flat(1/0).filter(e=>e).map((e,t)=>{if(typeof e==`string`){let n=t===this.children.length-1;return i`<span
		...
		`}},customElements.get(`w-breadcrumbs`)||customElements.define(`w-breadcrumbs`,R)})),B,V=t((()=>{n(),B=l`
	:host {
...
`})),H,U=t((()=>{n(),s(),V(),m(),H=class extends a{@o({type:Boolean,attribute:`current-page`})currentPage=!1;@o({type:String})href=null;static styles=[h,B];get link(){return this.href?i`<a
					part="link"
					class="s-text-link"
					href=${this.href}
				...
				></span>`}get separator(){return this.currentPage?r:i`<span part="separator" class="separator" aria-hidden="true"
					>/</span
				>`}render(){return i`${this.link}${this.separator}`}},customElements.get(`w-breadcrumb-item`)||customElements.define(`w-breadcrumb-item`,H)})),W=e({Default:()=>J,WithLinks:()=>Y,WithSpanForCurrentPage:()=>X,__namedExportsOrder:()=>Z,default:()=>q}),G,K,q,J,Y,X,Z,Q=t((()=>{b(),u(),n(),x(),z(),U(),{events:G,argTypes:K}=p(`w-breadcrumbs`),q={title:`Navigation/Breadcrumbs`,render(e){return i`
            <w-breadcrumbs ${v(y(e))}>

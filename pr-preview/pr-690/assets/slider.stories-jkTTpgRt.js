import{a as e,i as t,n,t as r}from"./preload-helper-xPQekRTU.js";import{C as i,_ as a,d as o,i as s,l as c,n as l,p as u,r as d,s as f,t as p,u as m,x as h}from"./decorate-BxgRj7DM.js";import{n as ee,t as te}from"./class-map-v4FOSj6B.js";import{A as ne,M as g,_ as re,b as ie,j as _,l as v,u as y,x as ae,y as oe}from"./iframe-fb5oSF8V.js";import{n as se,t as ce}from"./form-control-DtXadPi-.js";import{t as le}from"./affix-CFvAx3Oq.js";import{r as b,t as ue}from"./if-defined-B1ZLCare.js";import{t as de}from"./attention-D5st0ERK.js";import{n as fe,t as x}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as pe}from"./textfield-Dg4Y-JOu.js";var S,me=t((()=>{S=JSON.parse(`{"select.label.optional":["Valgfri"],"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),C,he=t((()=>{C=JSON.parse(`{"select.label.optional":["Optional"],"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),w,ge=t((()=>{w=JSON.parse(`{"select.label.optional":["Valinnainen"],"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),T,_e=t((()=>{T=JSON.parse(`{"select.label.optional":["Valgfri"],"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),E,ve=t((()=>{E=JSON.parse(`{"select.label.optional":["Valfritt"],"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),D,ye=t((()=>{m(),D=h`
	.w-slider {
		position: relative;
		border: none;
		padding: 0;
...
`})),O,be=t((()=>{m(),d(),g(),oe(),v(),me(),he(),ge(),_e(),ve(),ye(),l(),O=class extends o{static{this.shadowRootOptions={...o.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[y,D,h`
			:host {

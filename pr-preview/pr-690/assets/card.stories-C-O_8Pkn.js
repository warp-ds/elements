import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{c as n,d as r,h as i,l as a,s as o,t as s,y as c}from"./decorators-BoKEMuNh.js";import{C as l,O as u,S as d,f,k as p,l as m,p as h,u as g,x as _,y as v}from"./iframe-ab9daogv.js";import{a as y,n as b,r as x,t as S}from"./utilities-DIER-odo.js";import{r as C,t as w}from"./if-defined-CAJ93-y8.js";var T,E=e((()=>{T=JSON.parse(`{"card.button.text":["Vælg"]}`)})),D,O=e((()=>{D=JSON.parse(`{"card.button.text":["Select"]}`)})),k,A=e((()=>{k=JSON.parse(`{"card.button.text":["Valitse"]}`)})),j,M=e((()=>{j=JSON.parse(`{"card.button.text":["Velg"]}`)})),N,P=e((()=>{N=JSON.parse(`{"card.button.text":["Välj"]}`)})),F,I=e((()=>{n(),F=c`
	:host {
...
`})),L,R,z=e((()=>{p(),n(),s(),w(),_(),m(),E(),O(),A(),M(),P(),I(),h(),L={ENTER:`Enter`,SPACE:` `},R=class extends a{static{this.styles=[g,F,c`
			a::after {
				content: "";
				position: absolute;
				top: 0;
		...
		`}},f([o({type:Boolean,reflect:!0})],R.prototype,`selected`,void 0),f([o({type:Boolean})],R.prototype,`flat`,void 0),f([o({type:Boolean})],R.prototype,`clickable`,void 0),customElements.get(`w-card`)||customElements.define(`w-card`,R)})),B=t({Clickable:()=>Y,Default:()=>G,Flat:()=>q,FlatSelected:()=>J,PropertyExample:()=>X,Selected:()=>K,StylingApi:()=>Z,__namedExportsOrder:()=>Q,default:()=>W}),V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{x(),l(),n(),S(),z(),{events:V,args:H,argTypes:U}=d(`w-card`),W={title:`Navigation/Card`,render(e){return i`
            <w-card ${y(b(e))}>

import{i as e}from"./preload-helper-xPQekRTU.js";import{A as t,Bt as n,E as r,Ht as i,J as ee,Lt as a,Rt as o,Wt as s,b as c,d as te,f as l,j as u,k as ne,l as d,p as f,q as p,u as m,w as re,x as h}from"./iframe-CRWlD6Yd.js";import{r as ie,t as g}from"./if-defined-3E03NETr.js";function ae(e){let t=-1;e.ontouchstart=e=>{e.targetTouches.length===1&&(t=e.targetTouches[0].clientY)},e.ontouchmove=n=>{if(n.targetTouches.length!==1)return;let r=n.targetTouches[0].clientY-t;return e.scrollTop===0&&r>0||E(e)&&r<0?x(n):(n.stopPropagation(),!0)}}function oe(e){e.ontouchstart=null,e.ontouchmove=null}function _(e){if(!e)throw Error(`Could not run setup, an element must be provided`);v.some(t=>t===e)||(v.length||(C(),O()),ae(e),v.push(e))}function se(){v.forEach(oe),k(),T(),v=[]}var v,y,b,x,S,C,w,T,E,D,O,k,A=e((()=>{v=[],y={documentElement:{},body:{}},b=Object.freeze({documentElement:{"scrollbar-gutter":`stable`},body:{overflow:`hidden`,position:`relative`,height:`100%`}}),x=e=>{e.touches.length>1||e.preventDefault?.()},S=e=>([t,n])=>{y[e][t]=document[e].style[t],document[e].style[t]=n},C=()=>Object.entries(b).forEach(([e,t])=>{Object.entries(t).forEach(S(e))}),w=e=>([t,n])=>{document[e].style[t]=y[e][t]},T=()=>Object.entries(y).forEach(([e,t])=>{Object.entries(t).forEach(w(e))}),E=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight,D=e=>()=>document[e?`addEventListener`:`removeEventListener`](`touchmove`,x,{passive:!1}),O=D(!0),k=D()})),j,ce=e((()=>{a(),j=s`
	:host {
		--_backdrop-bg: var(
...
`})),Z,he=e((()=>{U(),ee(),a(),c(),te(),u(),ue(),de(),fe(),pe(),me(),P(),d(),X(),f(),Z=class extends M(o){static{this.styles=[m,Y]}constructor(){super(),this.back=!1,this.noClose=!1,this._hasTopContent=!1,ne(G,q,K,W,J)}async willUpdate(e){if(e.has(`back`)){if(!this.titleEl)return;new H(this.titleEl).when(async()=>{await this.updateComplete})}}emitBack(){this.dispatchEvent(new CustomEvent(`backClicked`,{bubbles:!0,composed:!0}))}handleTopSlotChange(e){let t=e.target.assignedElements({flatten:!0});this._hasTopContent=!!t.length}render(){let e=this.back&&!this._hasTopContent,r=!this.noClose;return i`
			<div
				part="header"
			...
			>
				...
				${e?i`<w-button
							...
							part="back"
							title=""
							aria-label="${p._({id:`modal.aria.back`,message:`Back`,comment:`Aria label for the back button in modal`})}"
							variant="pill"
							icon-only
							@click="${this.emitBack}"
						>
				...
				${r?i`<w-button
							...
							part="close"
							title=""
							aria-label="${p._({id:`modal.aria.close`,message:`Close`,comment:`Aria label for the close button in modal`})}"
							variant="pill"
							icon-only
							@click="${this.close}"
						>
		...
		`}},l([r({type:String})],Z.prototype,`title`,void 0),l([r({type:Boolean})],Z.prototype,`back`,void 0),l([r({type:Boolean,attribute:`no-close`})],Z.prototype,`noClose`,void 0),l([re()],Z.prototype,`_hasTopContent`,void 0),l([h(`[part="title"]`)],Z.prototype,`titleEl`,void 0),customElements.get(`w-modal-header`)||customElements.define(`w-modal-header`,Z)})),Q,ge=e((()=>{a(),Q=s`
	:host {
...
`})),$,_e=e((()=>{a(),P(),d(),ge(),$=class extends M(N(o)){static{this.styles=[m,Q]}render(){return i`

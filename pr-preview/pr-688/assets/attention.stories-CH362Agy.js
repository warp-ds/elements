import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{Ht as n,Lt as r,M as i,N as a}from"./iframe-DYPhG_zd.js";import{a as o,n as s,r as c,t as l}from"./utilities-CCtCYYhL.js";import{t as u}from"./attention-BCTxMS1U.js";import{t as d}from"./button-Bq_gwIKJ.js";import{n as f,t as p}from"./taggedTemplateLiteral-pWa2IaV6.js";var m=e({AccessibleTooltip:()=>O,Callout:()=>T,Default:()=>C,DismissibleHighlight:()=>D,Highlight:()=>E,ToolTip:()=>w,__namedExportsOrder:()=>k,default:()=>S}),h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A=t((()=>{c(),a(),r(),l(),u(),d(),f(),{events:y,args:b,argTypes:x}=i(`w-attention`),S={title:`Overlays/Attention`,render(e){return n`
      <w-attention ${o(s(e))}>
        <w-button
          ${o({id:e.buttonId})}
          variant="secondary"

import{a as O,i as R,q as te,r as ee,A as c,b as i,n as s,m as h,l as p,k as re,g as ae}from"./iframe-CWWDjsTz.js";import"./affix-BfGuaHjo.js";import"./attention-D2XXzOS3.js";import"./textfield-DKSZJKUL.js";import{_ as ie}from"./preload-helper-Ct5FWWRu.js";import{e as P}from"./query-NYTjQBeo.js";import{o as N}from"./if-defined-C3c6gB96.js";import{F as se}from"./FormControlMixin-DJnJZbro.js";const oe=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]]}'),le=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]]}'),ne=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]]}'),de=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]]}'),me=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]]}'),ue=O`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`;var he=Object.defineProperty,m=(o,e,r,a)=>{for(var t=void 0,u=o.length-1,f;u>=0;u--)(f=o[u])&&(t=f(e,r,t)||t);return t&&he(e,r,t),t};class d extends R{constructor(){super(),this.disabled=!1,this.openEnded=!1,this.invalid=!1,this.required=!1,this.hiddenTextfield=!1,this._invalidMessage="",this._hasInternalError=!1,this._showError=!1,this._tabbableElements=[],this.#t=!1,te(le,de,ne,oe,me)}static{this.shadowRootOptions={...R.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[ee,ue]}#t;#e(){const e=this.querySelectorAll("w-slider-thumb");let r=!1;for(const t of e.values())t.min=this.edgeMin,t.max=this.edgeMax,t.step=this.step,t.suffix=this.suffix??"",t.required=this.required,t.labelFormatter=this.labelFormatter,t.valueFormatter=this.valueFormatter,t.tooltipFormatter=this.tooltipFormatter,t.openEnded=this.openEnded,t._hiddenTextfield=this.hiddenTextfield,t.ariaLabel||(t.slot||(t.ariaLabel=this.label),t.slot==="from"&&(t.ariaLabel=`${this.label} min`),t.slot==="to"&&(t.ariaLabel=`${this.label} max`)),(t.slot==="from"||t.slot==="to")&&(r=!0),t.disabled=this.disabled,t.invalid=!!this.errorText,this.#n(t);const a=this.shadowRoot.querySelector("fieldset");r?(a.style.setProperty("--active-range-inline-start-padding","var(--w-slider-thumb-size, 28px)"),a.style.setProperty("--active-range-inline-end-padding","var(--w-slider-thumb-size, 28px)")):a.style.setProperty("--active-range-border-radius","4px")}get edgeMin(){return this.openEnded?(Number(this.min)-1).toString():this.min}get edgeMax(){return this.openEnded?(Number(this.max)+1).toString():this.max}async connectedCallback(){super.connectedCallback(),await this.updateComplete,requestAnimationFrame(()=>{requestAnimationFrame(()=>{setTimeout(()=>{this.step&&this.style.setProperty("--step",String(this.step)),this.min!==void 0&&this.style.setProperty("--min",this.edgeMin),this.max!==void 0&&this.style.setProperty("--max",this.max),this.markers&&this.style.setProperty("--markers",String(this.markers)),this.openEnded&&this.style.setProperty("--over-under-offset","1"),this.querySelectorAll("w-slider-thumb").length===2&&this.style.setProperty("--range-slider-magic-pixel","1px")},0)})});const e=this.querySelectorAll("w-slider-thumb");if(e.length===2){const a=Array.from(e);this._tabbableElements[0]=a[0].shadowRoot.querySelector("input"),this._tabbableElements[1]=a[1].shadowRoot.querySelector("input"),this._tabbableElements[2]=a[0].shadowRoot.querySelector("w-textfield"),this._tabbableElements[3]=a[1].shadowRoot.querySelector("w-textfield")}else if(e.length===1){const a=Array.from(e);this._tabbableElements[0]=a[0].shadowRoot.querySelector("input"),this._tabbableElements[1]=a[0].shadowRoot.querySelector("w-textfield")}this.#e()}updated(e){(e.has("disabled")||e.has("required")||e.has("min")||e.has("step")||e.has("max")||e.has("suffix")||e.has("labelFormatter")||e.has("valueFormatter")||e.has("_invalidMessage")||e.has("_hasInternalError"))&&this.#e(),(e.has("error")||e.has("invalid"))&&(this.#t=!1,(!this.error||!this.invalid)&&(this._showError=!1),this.#e())}#a(e){this.#t=!0;const r=e.target;this.#n(r),r.slot&&this.#i()}#s(){this._hasInternalError||this.invalid&&!this.#t?this._showError=!0:this._showError=!1,this.#e()}#r(e){if(e.key==="Tab"){const r=this._tabbableElements.indexOf(e.target.shadowRoot.activeElement);if(r===-1)return;const a=e.shiftKey?-1:1,t=this._tabbableElements[r+a];if(!t)return;e.preventDefault(),t.focus()}}#i(){let e,r;const a=this.querySelectorAll("w-slider-thumb");for(const t of a.values())t.slot==="from"&&(e=t),t.slot==="to"&&(r=t);!e||!r||!e.invalid&&r.invalid}#o(e){e.stopPropagation();const r=this._hasInternalError,a=e.target;if(this._hasInternalError=!!e.detail.invalid,this._invalidMessage=e.detail.invalid,r===!0&&this._hasInternalError===!1){const t=this.querySelectorAll("w-slider-thumb");for(const u of t.values())u!==a&&u.updateFieldAfterValidation()}}#l(e,r){return(r.value===void 0||r.value===null)&&(r.value=this.openEnded?"":e),r.value===""?e:r.value}#n(e){const r=e.slot;r||this.style.setProperty("--from","0"),r==="from"&&this.style.setProperty("--from",this.#l(this.edgeMin,e)),(!r||r==="to")&&this.style.setProperty("--to",this.#l(this.edgeMax,e))}get errorText(){return this._showError?this._invalidMessage?this._invalidMessage:this.error&&!this.#t?this.error:"":""}render(){return i`
      <fieldset
        id="fieldset"
        class="w-slider"
        @input="${this.#a}"
    ...
    `}}m([s({reflect:!0})],d.prototype,"label");m([s({type:Boolean,reflect:!0})],d.prototype,"disabled");m([s({type:Boolean,attribute:"open-ended"})],d.prototype,"openEnded");m([s({type:String,reflect:!0})],d.prototype,"error");m([s({type:String,reflect:!0,attribute:"help-text"})],d.prototype,"helpText");m([s({type:Boolean,reflect:!0})],d.prototype,"invalid");m([s({type:Boolean,reflect:!0})],d.prototype,"required");m([s({reflect:!0})],d.prototype,"min");m([s({reflect:!0})],d.prototype,"max");m([s({type:Number,reflect:!0})],d.prototype,"markers");m([s({type:Number,reflect:!0})],d.prototype,"step");m([s({reflect:!0})],d.prototype,"suffix");m([s({type:Boolean,reflect:!0,attribute:"hidden-textfield"})],d.prototype,"hiddenTextfield");m([s({attribute:!1})],d.prototype,"valueFormatter");m([s({attribute:!1})],d.prototype,"tooltipFormatter");m([s({attribute:!1})],d.prototype,"labelFormatter");m([h()],d.prototype,"_invalidMessage");m([h()],d.prototype,"_hasInternalError");m([h()],d.prototype,"_showError");m([h()],d.prototype,"_tabbableElements");customElements.get("w-slider")||customElements.define("w-slider",d);const ce=O`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`,pe=O`
  .w-slider-thumb {
    position: relative;
    display: grid;
...
`;var fe=Object.defineProperty,n=(o,e,r,a)=>{for(var t=void 0,u=o.length-1,f;u>=0;u--)(f=o[u])&&(t=f(e,r,t)||t);return t&&fe(e,r,t),t};class l extends se(R){constructor(){super(...arguments),this.disabled=!1,this.invalid=!1,this.openEnded=!1,this.suffix="",this._showTooltip=!1,this._inputHasFocus=!1,this._hiddenTextfield=!1,this.#t=null,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...R.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[ee,ce,pe]}#t;resetFormControl(){this.value=this.#t}#e(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#a(){this._showTooltip=!1}#s(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#r(e){this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:e,slot:this.slot}}))}async updateFieldAfterValidation(){const e=this.shadowRoot.querySelector("w-textfield");await this.#i(e.value,!0)}async#i(e,r){const a=this.suffix??"";let t=Number.parseInt(e);if(this.openEnded&&!r&&this.step&&!(this.slot==="to"&&t>=Number(this.max)-1||this.slot==="from"&&t<=Number(this.min)+1)){const C=1/this.step;t=Math.round(t*C)/C,e=t.toString()}const u=Number.parseInt(this.max),f=Number.parseInt(this.min);if(!this.openEnded&&(t>u||t<f))return this.#r(p.t({id:"slider.error.out_of_bounds",message:"Value must be between {min} and {max}",values:{min:`${this.min} ${a}`.trim(),max:`${this.max} ${a}`.trim()}})),{shouldCancel:!0};e===""&&this.required&&this.#r(p.t({id:"slider.error.required",message:"This field is required"})),this.value=e;const I=e===this.max||e===this.min;let A=!1;if(this.slot){const H=this.parentElement.querySelector('w-slider-thumb[slot="to"]'),C=this.parentElement.querySelector('w-slider-thumb[slot="from"]'),X=H.textfield.value||this.max,B=C.textfield.value||this.min,L=Number.parseInt(X),j=Number.parseInt(B),K=p.t({id:"slider.error.overlap",message:"The maximum value cannot be less than the minimum"});if(this.slot==="from"){const g=this.openEnded&&L>u?L:Math.min(L,this.openEnded?u-1:u);t>g&&(A=!0,this.openEnded&&I?this.value=String(g):this.value=X,r&&(this.#r(K),await this.updateComplete,this.textfield.value=e))}else{const g=this.openEnded&&j<f?j:Math.max(Number.parseInt(B),this.openEnded?f+1:f);t<g&&(A=!0,this.openEnded&&I?this.value=String(g):this.value=B,r&&(this.#r(K),await this.updateComplete,this.textfield.value=e))}}return A?{shouldCancel:!0}:(this.#r(""),this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.openEnded&&!r&&I?"":e,this.shadowRoot.querySelector("w-attention").handleDone(),{shouldCancel:!1})}async#o(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const a=e.currentTarget.value;return(await this.#i(a,r)).shouldCancel?(e.preventDefault(),!1):!0}async#l(e){if(e.key!=="ArrowLeft"&&e.key!=="ArrowRight")return;const r=Number(this.range.value),a=this.step||1;let t;e.key==="ArrowLeft"?t=r-a:t=r+a,t=Math.min(Math.max(t,Number(this.min)),Number(this.max)),(await this.#i(t.toString(),!1)).shouldCancel&&e.preventDefault()}async connectedCallback(){if(super.connectedCallback(),this.#t=this.value,this.setValue(this.value),this.slot&&!this.ariaDescription&&(this.slot==="from"?this.ariaDescription=p.t({id:"slider.label.from",comment:"Accessible label for the 'from value' input field in a range slider",message:"From"}):this.slot==="to"&&(this.ariaDescription=p.t({id:"slider.label.to",comment:"Accessible label for the 'to value' input field in a range slider",message:"To"}))),"anchorName"in document.documentElement.style)await this.updateComplete;else{const a=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:t}]=await Promise.all([ie(()=>import(`${a}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
        /*
      ...
      <div class="w-slider-thumb">
        ...
        <input
          ...
          aria-describedby="${N(this.ariaDescription?"aria-description":void 0)}"
          class="w-slider-thumb__range"
          type="range"
          .value="${this.value}"
          min="${this.min}"
          max="${this.max}"
          step="${N(!this.openEnded&&this.step?this.step:void 0)}"
          ?disabled="${this.disabled}"
          @mousedown="${this.#e}"
          @mouseup="${this.#a}"
          @touchstart="${this.#e}"
        ...
        <w-textfield
          aria-label="${this.ariaLabel}"
          aria-description="${N(this.ariaDescriptionText)}"
          class="${re({"w-slider-thumb__textfield":!0,"sr-only":this._hiddenTextfield})}"
          type="number"
    ...
    `}}n([s({attribute:"aria-label"})],l.prototype,"ariaLabel");n([s({attribute:"aria-description"})],l.prototype,"ariaDescription");n([s({reflect:!0})],l.prototype,"name");n([s({reflect:!0})],l.prototype,"value");n([s({type:Boolean,reflect:!0})],l.prototype,"disabled");n([s({type:Boolean,reflect:!0})],l.prototype,"invalid");n([s({attribute:!1,reflect:!1})],l.prototype,"openEnded");n([s({reflect:!0})],l.prototype,"placeholder");n([h()],l.prototype,"markers");n([h()],l.prototype,"required");n([h()],l.prototype,"step");n([h()],l.prototype,"min");n([h()],l.prototype,"max");n([h()],l.prototype,"suffix");n([s({attribute:!1})],l.prototype,"valueFormatter");n([s({attribute:!1})],l.prototype,"tooltipFormatter");n([s({attribute:!1})],l.prototype,"labelFormatter");n([P('input[type="range"]')],l.prototype,"range");n([P(".w-slider-thumb__tooltip-target")],l.prototype,"tooltipTarget");n([P("w-textfield")],l.prototype,"textfield");n([h()],l.prototype,"_showTooltip");n([h()],l.prototype,"_inputHasFocus");n([h()],l.prototype,"_hiddenTextfield");customElements.get("w-slider-thumb")||customElements.define("w-slider-thumb",l);var U=Object.freeze,be=Object.defineProperty,b=(o,e)=>U(be(o,"raw",{value:U(o.slice())})),W,J,G,Q,Y,Z;const{events:ge,args:we,argTypes:ve}=ae("w-slider"),xe={title:"Forms/Slider and Range Slider",args:we,argTypes:ve,parameters:{actions:{handles:ge}}},w={render(){return i`
    ...
    `}},_={args:{locale:"nb",suffix:"kr"},render({locale:o,suffix:e}){return i(W||(W=b([`
      <w-slider
        label="Price"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,o)}},S={args:{locale:"nb",suffix:"km"},render({locale:o,suffix:e}){return i(J||(J=b([`
      <w-slider
        label="Distance"
        min="0"
        max="250000"
    ...
    `}},F={args:{step:5},render({step:o}){return i`
      <w-slider label="Single" step="${o}" min="0" max="100">
        <w-slider-thumb name="value"></w-slider-thumb>
      </w-slider>
    `}},E={args:{},render(){return i(G||(G=b([`
    ...
    `}},$={args:{},render(){return i(Q||(Q=b([`
      ...
      <\/script>
    `])))}},M={args:{error:"I'm an external error telling you something is wrong",invalid:!0},render(o){return i`
      <w-slider
        label="Model year"
        min="1950"
        max="2025"
    ...
    `}},q={render(){return i(Y||(Y=b([`
      ...
      <\/script>
    `])))}},z={render({locale:o}){return i(Z||(Z=b([`
...
}`,...z.parameters?.docs?.source}}};const ye=["Single","SingleDisabled","Range","SuffixSquareMeters","SuffixCurrency","SuffixKilometers","Marks","Step","OpenEnded","SingleError","RangeError","CustomError","Description","VisuallyHiddenLabel","HiddenMinimumMaximumLabels","VisuallyHiddenTextfield"],De=Object.freeze(Object.defineProperty({__proto__:null,CustomError:M,Description:D,HiddenMinimumMaximumLabels:q,Marks:k,OpenEnded:E,Range:x,RangeError:$,Single:w,SingleDisabled:v,SingleError:T,Step:F,SuffixCurrency:_,SuffixKilometers:S,SuffixSquareMeters:y,VisuallyHiddenLabel:V,VisuallyHiddenTextfield:z,__namedExportsOrder:ye,default:xe},Symbol.toStringTag,{value:"Module"}));export{k as M,E as O,x as R,De as S,w as a,y as b,_ as c,S as d,F as e,T as f,$ as g};

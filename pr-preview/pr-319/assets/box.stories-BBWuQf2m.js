import{g as t,k as l}from"./iframe-Pd9ZN29B.js";import{s as c,p as d}from"./utilities-D2MMe8_R.js";const{events:u,args:p,argTypes:i}=t("w-box"),g={title:"Layout/Box",render:n=>l`
      <w-box ${c(d(n))}>
        <h3>Box Content</h3>

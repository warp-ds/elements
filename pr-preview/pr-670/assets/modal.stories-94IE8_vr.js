import{a as e,i as t}from"./preload-helper-Cs4UwXAW.js";import{At as n,B as r,C as i,D as a,E as o,Mt as s,Ot as c,Pt as l,T as ee,_ as u,a as d,c as f,g as te,h as p,kt as m,l as ne,m as re,o as h,s as ie,w as ae,z as g}from"./iframe-CXLEcQ12.js";import{i as _,n as v,r as oe,t as se}from"./utilities-DlOgVT2s.js";function ce(e){let t=-1;e.ontouchstart=e=>{e.targetTouches.length===1&&(t=e.targetTouches[0].clientY)},e.ontouchmove=n=>{if(n.targetTouches.length!==1)return;let r=n.targetTouches[0].clientY-t;return e.scrollTop===0&&r>0||T(e)&&r<0?x(n):(n.stopPropagation(),!0)}}function le(e){e.ontouchstart=null,e.ontouchmove=null}function ue(e){if(!e)throw Error(`Could not run setup, an element must be provided`);y.some(t=>t===e)||(y.length||(S(),me()),ce(e),y.push(e))}function de(){y.forEach(le),he(),w(),y=[]}var y,b,fe,x,pe,S,C,w,T,E,me,he,ge=t((()=>{y=[],b={documentElement:{},body:{}},fe=Object.freeze({documentElement:{"scrollbar-gutter":`stable`},body:{overflow:`hidden`,position:`relative`,height:`100%`}}),x=e=>{e.touches.length>1||e.preventDefault?.()},pe=e=>([t,n])=>{b[e][t]=document[e].style[t],document[e].style[t]=n},S=()=>Object.entries(fe).forEach(([e,t])=>{Object.entries(t).forEach(pe(e))}),C=e=>([t,n])=>{document[e].style[t]=b[e][t]},w=()=>Object.entries(b).forEach(([e,t])=>{Object.entries(t).forEach(C(e))}),T=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight,E=e=>()=>document[e?`addEventListener`:`removeEventListener`](`touchmove`,x,{passive:!1}),me=E(!0),he=E()})),D,O,k=t((()=>{D=e=>class extends e{constructor(...e){super(...e),this.patchClose=!0,this._close=null}close(){this._close()}},O=e=>class extends e{handleSlotChange(e){let t=e.target.assignedNodes({flatten:!0});for(let e of t.filter(e=>e.patchClose))e._close=()=>this.close()}}})),A,_e=t((()=>{c(),re(),ge(),d(),k(),ne(),A=class extends O(m){constructor(){super(),this.show=!1,this.ignoreBackdropClicks=!1,this._isClosing=!1,this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`command`,e=>{let t=e.command;t===`--show-modal`?this.open():(t===`--close`||t===`--confirm`)&&this.close()})}async open(){this._isClosing=!1,this.dialogEl.classList.remove(`close`),this.dialogEl.showModal(),this.handleListeners(),ue(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent(`shown`,{bubbles:!0,composed:!0}))}close(){this.dialogEl?.open&&(this._isClosing=!0,this.handleListeners(`removeEventListener`),this.dialogEl.classList.add(`close`),this.dialogEl.addEventListener(`animationend`,async e=>{e.animationName===`w-modal-out`&&this._isClosing&&(this.dialogEl.classList.remove(`close`),this.dialogEl.close(),this._isClosing=!1,de(),await this.updateComplete,this.dispatchEvent(new CustomEvent(`hidden`,{bubbles:!0,composed:!0})))},{once:!0}))}render(){return s`
    ...
    `}async willUpdate(e){if(e.has(`back`)){if(!this.titleEl)return;new F(this.titleEl).when(async()=>{await this.updateComplete})}}get titleClasses(){return[`header-title`,this.back?`header-title-with-back-button`:`header-title-without-back-button`,this._hasTopContent?`header-title-with-top-area`:``].join(` `)}get backButton(){return this.back&&!this._hasTopContent?s`<button
        ...
        </button>`:n}get closeButton(){return this.noClose?n:s`<div class="header-close-button-container">
        <w-button
            type="button"
            title=""
    ...
    </div>`}emitBack(){this.dispatchEvent(new CustomEvent(`backClicked`,{bubbles:!0,composed:!0}))}handleTopSlotChange(e){let t=e.target.assignedElements({flatten:!0});this._hasTopContent=!!t.length}static{this.styles=[h,l`
      .header {
        position: relative;
    ...
    `]}},f([u({type:String})],V.prototype,`title`,void 0),f([u({type:Boolean})],V.prototype,`back`,void 0),f([u({type:Boolean,attribute:`no-close`})],V.prototype,`noClose`,void 0),f([te()],V.prototype,`_hasTopContent`,void 0),f([p(`.title-el`)],V.prototype,`titleEl`,void 0),customElements.get(`w-modal-header`)||customElements.define(`w-modal-header`,V)})),H,De=t((()=>{c(),k(),d(),H=class extends D(O(m)){render(){return s`
      <div class="footer">
        <slot @slotchange="${this.handleSlotChange}"></slot>
      </div>
    `}static{this.styles=[h,l`
      .footer {
        display: flex;
        flex-shrink: 0;
    ...
    `]}},customElements.get(`w-modal-footer`)||customElements.define(`w-modal-footer`,H)})),Oe=e({Default:()=>q,InvokerCommands:()=>J,Modal:()=>X,ModalFooter:()=>Q,ModalHeader:()=>Z,WithImage:()=>Y,__namedExportsOrder:()=>$,default:()=>K}),U,W,ke,Ae,je,G,Me,Ne,Pe,K,q,J,Y,X,Z,Q,$,Fe=t((()=>{oe(),a(),c(),se(),_e(),Ee(),De(),{events:U,args:W,argTypes:ke}=o(`w-modal`),{events:Ae,args:je,argTypes:G}=o(`w-modal-header`),{events:Me,args:Ne,argTypes:Pe}=o(`w-modal-footer`),K={title:`Overlays/Modal`},q={args:{},render(){return s`
    ...
    `},parameters:{docs:{story:{autoplay:!0}}}},Y={args:{},render(){return s`

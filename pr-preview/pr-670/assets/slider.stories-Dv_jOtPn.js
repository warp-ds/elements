import{a as e,i as t,n,t as r}from"./preload-helper-Cs4UwXAW.js";import{At as i,B as a,C as o,D as s,E as c,Mt as l,Ot as u,Pt as d,R as f,T as p,_ as m,a as ee,c as h,d as te,g,h as _,kt as v,l as ne,m as re,o as ie,u as ae,z as y}from"./iframe-CXLEcQ12.js";import{n as oe,t as se}from"./form-control-_t8OxpDL.js";import{t as ce}from"./affix-BP7HdX1b.js";import{n as b,t as le}from"./if-defined-CodTf17n.js";import{t as ue}from"./attention-B-51YUWB.js";import{n as de,t as x}from"./taggedTemplateLiteral-Dh47jvtJ.js";import{t as fe}from"./textfield-CPhv6K_W.js";var S,pe=t((()=>{S=JSON.parse(`{"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),C,me=t((()=>{C=JSON.parse(`{"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),w,he=t((()=>{w=JSON.parse(`{"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),T,ge=t((()=>{T=JSON.parse(`{"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),E,_e=t((()=>{E=JSON.parse(`{"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),D,ve=t((()=>{u(),D=d`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`})),O,ye=t((()=>{u(),re(),p(),ee(),pe(),me(),he(),ge(),_e(),ve(),ne(),O=class extends v{static{this.shadowRootOptions={...v.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[ie,D]}constructor(){super(),this.disabled=!1,this.openEnded=!1,this.invalid=!1,this.required=!1,this.hiddenTextfield=!1,this._invalidMessage=``,this._hasInternalError=!1,this._showError=!1,this._tabbableElements=[],o(C,T,w,S,E)}#e(){let e=this.querySelectorAll(`w-slider-thumb`),t=!1;for(let n of e.values())n.min=this.edgeMin,n.max=this.edgeMax,n.step=this.step,n.suffix=this.suffix??``,n.required=this.required,n.labelFormatter=this.labelFormatter,n.valueFormatter=this.valueFormatter,n.tooltipFormatter=this.tooltipFormatter,n.openEnded=this.openEnded,n._hiddenTextfield=this.hiddenTextfield,n.ariaLabel||(n.slot||(n.ariaLabel=this.label),n.slot===`from`&&(n.ariaLabel=`${this.label} min`),n.slot===`to`&&(n.ariaLabel=`${this.label} max`)),(n.slot===`from`||n.slot===`to`)&&(t=!0),n.disabled=this.disabled,n.invalid=!!this.errorText,this.#c(n);t?(this.fieldset.style.setProperty(`--active-range-inline-start-padding`,`var(--w-slider-thumb-size, 28px)`),this.fieldset.style.setProperty(`--active-range-inline-end-padding`,`var(--w-slider-thumb-size, 28px)`)):this.fieldset.style.setProperty(`--active-range-border-radius`,`4px`)}get edgeMin(){return this.openEnded?(Number(this.min)-1).toString():this.min}get edgeMax(){return this.openEnded?(Number(this.max)+1).toString():this.max}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.step&&this.fieldset.style.setProperty(`--step`,String(this.step)),this.min!==void 0&&this.fieldset.style.setProperty(`--min`,this.edgeMin),this.max!==void 0&&this.fieldset.style.setProperty(`--max`,this.max),this.markers&&this.fieldset.style.setProperty(`--markers`,String(this.markers)),this.openEnded&&this.fieldset.style.setProperty(`--over-under-offset`,`1`);let e=this.querySelectorAll(`w-slider-thumb`);if(e.length===2){this.fieldset.style.setProperty(`--range-slider-magic-pixel`,`1px`);let t=Array.from(e);this._tabbableElements[0]=t[0].shadowRoot.querySelector(`input`),this._tabbableElements[1]=t[1].shadowRoot.querySelector(`input`),this._tabbableElements[2]=t[0].shadowRoot.querySelector(`w-textfield`),this._tabbableElements[3]=t[1].shadowRoot.querySelector(`w-textfield`)}else if(e.length===1){let t=Array.from(e);this._tabbableElements[0]=t[0].shadowRoot.querySelector(`input`),this._tabbableElements[1]=t[0].shadowRoot.querySelector(`w-textfield`)}this.invalid&&this.error&&(this._showError=!0),this.#e()}updated(e){(e.has(`disabled`)||e.has(`required`)||e.has(`min`)||e.has(`step`)||e.has(`max`)||e.has(`suffix`)||e.has(`labelFormatter`)||e.has(`valueFormatter`)||e.has(`_invalidMessage`)||e.has(`_hasInternalError`))&&this.#e(),(e.has(`error`)||e.has(`invalid`))&&(this.error&&this.invalid?this._showError=!0:this._showError=!1,this.#e())}#t(e){e.stopPropagation();let t=e.target;this.#c(t)}#n(e){let t=e.target;this.#c(t),t.slot&&this.#a()}#r(){this.componentHasError?this._showError=!0:this._showError=!1,this.#e()}#i(e){if(e.key===`Tab`){let t=this._tabbableElements.indexOf(e.target.shadowRoot.activeElement);if(t===-1)return;let n=e.shiftKey?-1:1,r=this._tabbableElements[t+n];if(!r)return;e.preventDefault(),r.focus()}}#a(){let e,t,n=this.querySelectorAll(`w-slider-thumb`);for(let r of n.values())r.slot===`from`&&(e=r),r.slot===`to`&&(t=r);!e||!t||!e.invalid&&t.invalid}#o(e){e.stopPropagation();let t=this._hasInternalError||this.invalid,n=e.target;if(this._hasInternalError=!!e.detail.invalid||this.invalid,this._invalidMessage=e.detail.invalid,t===!0&&this._hasInternalError===!1){let e=this.querySelectorAll(`w-slider-thumb`);for(let t of e.values())t!==n&&t.updateFieldAfterValidation()}}#s(e,t){return(t.value===void 0||t.value===null)&&(t.value=this.openEnded?``:e),t.value===``?e:t.value}#c(e){let t=e.slot;t||this.fieldset.style.setProperty(`--from`,`0`),t===`from`&&this.fieldset.style.setProperty(`--from`,this.#s(this.edgeMin,e)),(!t||t===`to`)&&this.fieldset.style.setProperty(`--to`,this.#s(this.edgeMax,e))}get componentHasError(){return this.invalid||this._hasInternalError}get errorText(){return this._showError?this.error||this._invalidMessage:``}render(){return l`
      ...
      >
        ${this.label?l`<legend class="w-slider__label">
            ...
            </legend>`:l`<slot id="label" name="label"></slot>`}
        <slot class="w-slider__description" name="description"></slot>
        ${this.markers?l`<div class="w-slider__markers"></div>`:i}
        ...
        <slot
          ...
          @slotchange=${this.#e}
        ></slot>
        ${this.errorText?l`<p class="w-slider__error" aria-describes="fieldset">
              ${this.errorText}
            </p>`:this.helpText?l`<p class="w-slider__help-text" aria-describes="fieldset">
                ${this.helpText}
              </p>`:i}
      </fieldset>
    `}},h([m({reflect:!0})],O.prototype,`label`,void 0),h([m({type:Boolean,reflect:!0})],O.prototype,`disabled`,void 0),h([m({type:Boolean,attribute:`open-ended`})],O.prototype,`openEnded`,void 0),h([m({type:String,reflect:!0})],O.prototype,`error`,void 0),h([m({type:String,reflect:!0,attribute:`help-text`})],O.prototype,`helpText`,void 0),h([m({type:Boolean,reflect:!0})],O.prototype,`invalid`,void 0),h([m({type:Boolean,reflect:!0})],O.prototype,`required`,void 0),h([m({reflect:!0})],O.prototype,`min`,void 0),h([m({reflect:!0})],O.prototype,`max`,void 0),h([m({type:Number,reflect:!0})],O.prototype,`markers`,void 0),h([m({type:Number,reflect:!0})],O.prototype,`step`,void 0),h([m({reflect:!0})],O.prototype,`suffix`,void 0),h([m({type:Boolean,reflect:!0,attribute:`hidden-textfield`})],O.prototype,`hiddenTextfield`,void 0),h([m({attribute:!1})],O.prototype,`valueFormatter`,void 0),h([m({attribute:!1})],O.prototype,`tooltipFormatter`,void 0),h([m({attribute:!1})],O.prototype,`labelFormatter`,void 0),h([_(`fieldset`)],O.prototype,`fieldset`,void 0),h([g()],O.prototype,`_invalidMessage`,void 0),h([g()],O.prototype,`_hasInternalError`,void 0),h([g()],O.prototype,`_showError`,void 0),h([g()],O.prototype,`_tabbableElements`,void 0),customElements.get(`w-slider`)||customElements.define(`w-slider`,O)})),k,be=t((()=>{u(),k=d`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`})),A,xe=t((()=>{u(),A=d`
  .w-slider-thumb {
    position: relative;
    display: grid;
...
`})),j,Se=t((()=>{a(),se(),u(),re(),ae(),le(),be(),ee(),xe(),ne(),n(),j=class extends oe(v){constructor(...e){super(...e),this.disabled=!1,this.invalid=!1,this.openEnded=!1,this.suffix=``,this._showTooltip=!1,this._inputHasFocus=!1,this._hiddenTextfield=!1,this.#e=null,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...v.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[ie,k,A]}#e;resetFormControl(){this.value=this.#e,this.dispatchEvent(new CustomEvent(`thumbreset`,{bubbles:!0}))}#t(){this._showTooltip=!0,this.shadowRoot.querySelector(`w-attention`).handleDone()}#n(){this._showTooltip=!1}#r(){this.range&&(this.value===``?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#i(e){this.dispatchEvent(new CustomEvent(`slidervalidity`,{bubbles:!0,detail:{invalid:e,slot:this.slot}}))}async updateFieldAfterValidation(){let e=this.shadowRoot.querySelector(`w-textfield`);await this.#a(e.value,!0)}async#a(e,t){let n=this.suffix??``,r=Number.parseInt(e);if(this.openEnded&&!t&&this.step&&!(this.slot===`to`&&r>=Number(this.max)-1||this.slot===`from`&&r<=Number(this.min)+1)){let t=1/this.step;r=Math.round(r*t)/t,e=r.toString()}let i=Number.parseInt(this.max),a=Number.parseInt(this.min);if(!this.openEnded&&(r>i||r<a))return this.#i(y.t({id:`slider.error.out_of_bounds`,message:`Value must be between {min} and {max}`,values:{min:`${this.min} ${n}`.trim(),max:`${this.max} ${n}`.trim()}})),{shouldCancel:!0};e===``&&this.required&&this.#i(y.t({id:`slider.error.required`,message:`This field is required`})),this.value=e;let o=e===this.max||e===this.min,s=!1;if(this.slot){let n=this.parentElement.querySelector(`w-slider-thumb[slot="to"]`),c=this.parentElement.querySelector(`w-slider-thumb[slot="from"]`),l=n.textfield.value||this.max,u=c.textfield.value||this.min,d=Number.parseInt(l),f=Number.parseInt(u),p=y.t({id:`slider.error.overlap`,message:`The maximum value cannot be less than the minimum`});if(this.slot===`from`){let n=this.openEnded&&d>i?d:Math.min(d,this.openEnded?i-1:i);r>n&&(s=!0,this.openEnded&&o?this.value=String(n):this.value=l,t&&(this.#i(p),await this.updateComplete,this.textfield.value=e))}else{let n=this.openEnded&&f<a?f:Math.max(Number.parseInt(u),this.openEnded?a+1:a);r<n&&(s=!0,this.openEnded&&o?this.value=String(n):this.value=u,t&&(this.#i(p),await this.updateComplete,this.textfield.value=e))}}return s?{shouldCancel:!0}:(this.#i(``),this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.openEnded&&!t&&o?``:e,this.shadowRoot.querySelector(`w-attention`).handleDone(),{shouldCancel:!1})}async#o(e){let t=e.currentTarget.tagName===`W-TEXTFIELD`;if(e instanceof CustomEvent)return;let n=e.currentTarget.value;return(await this.#a(n,t)).shouldCancel?(e.preventDefault(),!1):!0}async#s(e){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}if(!this.openEnded||e.key!==`ArrowLeft`&&e.key!==`ArrowRight`)return;let t=Number(this.range.value),n=this.step||1,r;r=e.key===`ArrowLeft`?t-n:t+n,r=Math.min(Math.max(r,Number(this.min)),Number(this.max)),(await this.#a(r.toString(),!1)).shouldCancel&&e.preventDefault()}async#c(e){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}if(this.textfield.value)return;let t=``;this.slot===`from`?e.key===`ArrowUp`?t=String(Number(this.min)+1)||`1`:e.key===`ArrowDown`&&(t=String(Number(this.min))||`0`):e.key===`ArrowUp`?t=String(Number(this.max))||`100`:e.key===`ArrowDown`&&(t=String(Number(this.max)-1)||`99`),t&&(e.preventDefault(),await this.#a(t,!0))}async connectedCallback(){if(super.connectedCallback(),this.#e=this.value,this.setValue(this.value),this.slot&&!this.ariaDescription&&(this.slot===`from`?this.ariaDescription=y.t({id:`slider.label.from`,comment:`Accessible label for the 'from value' input field in a range slider`,message:`From`}):this.slot===`to`&&(this.ariaDescription=y.t({id:`slider.label.to`,comment:`Accessible label for the 'to value' input field in a range slider`,message:`To`}))),`anchorName`in document.documentElement.style)await this.updateComplete;else{let e=import.meta.url.substring(0,import.meta.url.lastIndexOf(`/`));try{let[{default:t}]=await Promise.all([r(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement(`style`),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
      ...
      <div class="w-slider-thumb">
        ...
        <w-textfield
          ...
          ?disabled="${this.disabled}"
        >
          ${this.suffix??``?l`<w-affix slot="suffix" label="${this.suffix??``}"></w-affix>`:i}
        </w-textfield>
        <w-attention
          tooltip
          placement="top"
        ...
        >
          ...
          ></output>
          <span slot="message">
            ${this.tooltipDisplayValue}${this.suffix??``?l`&nbsp;${this.suffix??``}`:i}
          </span>
        </w-attention>
    ...
    `}},h([m({attribute:`aria-label`})],j.prototype,`ariaLabel`,void 0),h([m({attribute:`aria-description`})],j.prototype,`ariaDescription`,void 0),h([m({reflect:!0})],j.prototype,`name`,void 0),h([m({reflect:!0})],j.prototype,`value`,void 0),h([m({type:Boolean,reflect:!0})],j.prototype,`disabled`,void 0),h([m({type:Boolean,reflect:!0})],j.prototype,`invalid`,void 0),h([m({attribute:!1,reflect:!1})],j.prototype,`openEnded`,void 0),h([m({reflect:!0})],j.prototype,`placeholder`,void 0),h([g()],j.prototype,`markers`,void 0),h([g()],j.prototype,`required`,void 0),h([g()],j.prototype,`step`,void 0),h([g()],j.prototype,`min`,void 0),h([g()],j.prototype,`max`,void 0),h([g()],j.prototype,`suffix`,void 0),h([m({attribute:!1})],j.prototype,`valueFormatter`,void 0),h([m({attribute:!1})],j.prototype,`tooltipFormatter`,void 0),h([m({attribute:!1})],j.prototype,`labelFormatter`,void 0),h([_(`input[type="range"]`)],j.prototype,`range`,void 0),h([_(`.w-slider-thumb__tooltip-target`)],j.prototype,`tooltipTarget`,void 0),h([_(`w-textfield`)],j.prototype,`textfield`,void 0),h([g()],j.prototype,`_showTooltip`,void 0),h([g()],j.prototype,`_inputHasFocus`,void 0),h([g()],j.prototype,`_hiddenTextfield`,void 0),customElements.get(`w-slider-thumb`)||customElements.define(`w-slider-thumb`,j)})),Ce=e({CustomError:()=>q,Description:()=>J,HiddenMinimumMaximumLabels:()=>X,Marks:()=>H,OpenEnded:()=>W,Range:()=>R,RangeError:()=>K,Single:()=>I,SingleDisabled:()=>L,SingleError:()=>G,Step:()=>U,SuffixCurrency:()=>B,SuffixKilometers:()=>V,SuffixSquareMeters:()=>z,VisuallyHiddenLabel:()=>Y,VisuallyHiddenTextfield:()=>Z,__namedExportsOrder:()=>Q,default:()=>F}),we,Te,Ee,De,Oe,ke,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=t((()=>{s(),u(),f(),ce(),ue(),fe(),ye(),Se(),de(),{events:M,args:N,argTypes:P}=c(`w-slider`),F={title:`Forms/Slider and Range Slider`,args:N,argTypes:P,parameters:{actions:{handles:M}}},I={render(){return l`
      <form>
    ...
    `}},z={args:{locale:`nb`,suffix:`m²`},render({locale:e,suffix:t}){return l`
      <w-slider
    ...
    `}},B={args:{locale:`nb`,suffix:`kr`},render({locale:e,suffix:t}){return l(we||=x([`
      <w-slider
        label="Price"
        min="0"
        max="250000"
      ...
      <\/script>
    `]),t,e)}},V={args:{locale:`nb`,suffix:`km`},render({locale:e,suffix:t}){return l(Te||=x([`
      <w-slider
        label="Distance"
        min="0"
        max="250000"
      ...
      <\/script>
    `]),t,e)}},H={args:{locale:`nb`,step:`5`,markers:`5`},render({markers:e,step:t}){return l`
      <w-slider
        label="Single"
        min="0"
        max="100"
    ...
    `}},U={args:{step:5},render({step:e}){return l`
      <w-slider label="Single" step="${e}" min="0" max="100">
        <w-slider-thumb name="value"></w-slider-thumb>
      </w-slider>
    `}},W={args:{},render(){return l(Ee||=x([`
    ...
    `}},K={args:{},render(){return l(De||=x([`
      ...
      <\/script>
    `]))}},q={args:{error:`I'm an external error telling you something is wrong`,invalid:!0},render(e){return l`
      <w-slider
        label="Model year"
        min="1950"
        max="2025"
    ...
    `}},X={render(){return l(Oe||=x([`
      ...
      <\/script>
    `]))}},Z={render({locale:e}){return l(ke||=x([`

import{i as e}from"./preload-helper-Cs4UwXAW.js";import{At as t,B as n,C as r,Mt as i,Ot as a,Pt as o,S as s,T as c,_ as l,a as u,c as d,g as f,kt as p,l as m,m as h,o as g,s as _,w as v,x as y,z as b}from"./iframe-CXLEcQ12.js";import{n as x,t as S}from"./if-defined-CodTf17n.js";var C,w=e((()=>{a(),C=o`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.text-center{text-align:center}.text-right{text-align:right}.border-2{border-width:2px}.rounded-full{border-radius:9999px}.flex{display:flex}.grid{display:grid}.flex-1{flex:1}.gap-x-16{column-gap:1.6rem}.gap-y-16{row-gap:1.6rem}.row-span-2{grid-row:span 2/span 2}.col-span-3{grid-column:span 3/span 3}.row-start-1{grid-row-start:1}.row-start-2{grid-row-start:2}.col-start-2{grid-column-start:2}.grid-flow-col{grid-auto-flow:column}.grid-rows-\\[20px_auto\\]{grid-template-rows:20px auto}.grid-rows-\\[auto_20px\\]{grid-template-rows:auto 20px}.grid-cols-\\[1fr_20px_1fr\\]{grid-template-columns:1fr 20px 1fr}.grid-cols-\\[1fr_20px\\]{grid-template-columns:1fr 20px}.grid-cols-\\[20px_1fr\\]{grid-template-columns:20px 1fr}.items-center{align-items:center}.justify-self-end{justify-self:end}.justify-self-center{justify-self:center}.static{position:static}.s-bg{background-color:var(--w-s-color-background)}.s-bg-disabled{background-color:var(--w-s-color-background-disabled)}.s-bg-primary{background-color:var(--w-s-color-background-primary)}.s-icon-inverted{color:var(--w-s-color-icon-inverted)}.s-border{border-color:var(--w-s-color-border)}.s-border-primary{border-color:var(--w-s-color-border-primary)}.h-2{height:.2rem}.h-20{height:2rem}.h-full{height:100%}.w-2{width:.2rem}.w-20{width:2rem}.w-full{width:100%}.last\\:mb-0:last-child{margin-bottom:0}.px-16{padding-left:1.6rem;padding-right:1.6rem}.pb-0{padding-bottom:0}.pb-32{padding-bottom:3.2rem}.invisible{visibility:hidden}.transition-colors{transition-property:color,background-color,border-color,text-decoration-color,fill,stroke;transition-duration:.15s;transition-timing-function:cubic-bezier(.4,0,.2,1)}.duration-300{transition-duration:.3s}`})),T,E,D=e((()=>{y(),a(),h(),u(),w(),m(),T={wrapper:`w-full`,horizontal:`flex`},E=class extends p{constructor(...e){super(...e),this.horizontal=!1,this.right=!1}static{this.styles=[g,C]}updated(){this.updateStepsContext()}updateStepsContext(){let e=this.querySelectorAll(`w-step`);e.forEach((t,n)=>{t.setContext({horizontal:this.horizontal,right:this.right,isLast:n===e.length-1,isFirst:n===0})})}render(){return i`
      <div role="list" class=${s([T.wrapper,this.horizontal&&T.horizontal])} ${this.horizontal&&`style='display: grid; grid-auto-rows: 1fr;grid-template-columns: 1fr;'`}>
        <slot></slot>
      </div>
    `}},d([l({type:Boolean,reflect:!0})],E.prototype,`horizontal`,void 0),d([l({type:Boolean,reflect:!0})],E.prototype,`right`,void 0),customElements.get(`w-step-indicator`)||customElements.define(`w-step-indicator`,E)})),O,k=e((()=>{O=JSON.parse(`{"steps.aria.active":["Trinindikator aktiv cirkel"],"steps.aria.completed":["Trinindikator fuldført cirkel"],"steps.aria.emptyCircle":["Tom cirkel"]}`)})),A,j=e((()=>{A=JSON.parse(`{"steps.aria.active":["Step indicator active circle"],"steps.aria.completed":["Step indicator completed circle"],"steps.aria.emptyCircle":["Empty circle"]}`)})),M,N=e((()=>{M=JSON.parse(`{"steps.aria.active":["Vaiheilmaisin aktiivinen ympyrä"],"steps.aria.completed":["Vaiheilmaisin valmis ympyrä"],"steps.aria.emptyCircle":["Tyhjä ympyrä"]}`)})),P,F=e((()=>{P=JSON.parse(`{"steps.aria.active":["Stegindikator aktiv sirkel"],"steps.aria.completed":["Stegindikator hel sirkel"],"steps.aria.emptyCircle":["Tom sirkel"]}`)})),I,L=e((()=>{I=JSON.parse(`{"steps.aria.active":["Stegindikator aktiv cirkel"],"steps.aria.completed":["Stegindikator fulländad cirkel"],"steps.aria.emptyCircle":["Tom cirkel"]}`)})),R,z,B=e((()=>{y(),n(),a(),h(),S(),_(),c(),w(),u(),k(),j(),N(),F(),L(),m(),R={base:`group/step`,vertical:`group/stepv grid-rows-[20px_auto] grid grid-flow-col gap-x-16`,horizontal:`group/steph grid-rows-[auto_20px] grid-cols-[1fr_20px_1fr] flex-1 grid items-center`,alignLeft:`grid-cols-[20px_1fr]`,alignRight:`grid-cols-[1fr_20px] text-right`,dot:`rounded-full border-2 h-20 w-20 transition-colors duration-300 s-icon-inverted`,dotAlignRight:`col-start-2`,dotHorizontal:`row-start-2 justify-self-end`,dotActive:`s-border-primary s-bg-primary`,dotIncomplete:`s-border s-bg`,line:`transition-colors duration-300`,lineVertical:`w-2 h-full justify-self-center`,lineAlignRight:`col-start-2`,lineHorizontal:`h-2 w-full row-start-2`,lineIncomplete:`s-bg-disabled`,lineComplete:`s-bg-primary`,content:`last:mb-0`,contentVertical:`row-span-2 pb-32`,contentHorizontal:`col-span-3 px-16 row-start-1 text-center`},z=class extends p{static{this.styles=[g,C]}constructor(){super(),this.active=!1,this.completed=!1,this._context={horizontal:!1,right:!1,isLast:!1,isFirst:!1},this._internals=this.attachInternals(),r(A,P,M,O,I)}connectedCallback(){super.connectedCallback(),this._internals.role=`listitem`}setContext(e){this._context=e}getAriaLabel(){return this.completed?b._({id:`steps.aria.completed`,message:`Step indicator completed circle`,comment:`Completed circle`}):this.active?b._({id:`steps.aria.active`,message:`Step indicator active circle`,comment:`Active circle`}):b._({id:`steps.aria.emptyCircle`,message:`Empty circle`,comment:`Empty circle`})}render(){let e=!this._context.horizontal,n=!this._context.right,r=this._context.isFirst,a=this._context.isLast,o=s([R.base,e?R.vertical:R.horizontal,e?n?R.alignLeft:R.alignRight:``]),c=s([R.line,R.lineHorizontal,this.active||this.completed?R.lineComplete:R.lineIncomplete,r?`invisible`:``]),l=s([R.dot,e?n?``:R.dotAlignRight:R.dotHorizontal,this.active||this.completed?R.dotActive:R.dotIncomplete]),u=s([R.line,e?R.lineVertical:R.lineHorizontal,e&&!n?R.lineAlignRight:``,this.completed?R.lineComplete:R.lineIncomplete,a?`invisible`:``]),d=s([R.content,e?R.contentVertical:R.contentHorizontal,a?`pb-0`:``]);return i`
      <div class="${o}" style=${x(this._context.horizontal?`height: 100%;`:void 0)}>
        ${e?t:i`<div class=${c}></div>`}
        <div class=${l} role="img" aria-label=${this.getAriaLabel()} aria-current=${this.active?`step`:t}>
          ${this.completed?i`<w-icon name="Check" size="small" locale="${v()}" data-testid="completed-icon" class="flex"></w-icon>`:t}
        </div>
        <div class=${u}></div>

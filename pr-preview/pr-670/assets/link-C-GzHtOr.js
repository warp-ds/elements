import{i as e}from"./preload-helper-Cs4UwXAW.js";import{At as t,Mt as n,Ot as r,Pt as i,_ as a,a as o,c as s,kt as c,l,m as u,o as d}from"./iframe-CXLEcQ12.js";var f,p,m,h,g,_=e((()=>{r(),f=i`
  :host {
...
`})),v,y=e((()=>{r(),_(),v=i`
  ...
  ${h}
`})),b,x,S=e((()=>{r(),u(),o(),y(),l(),b=[`primary`,`secondary`,`negative`,`negativeQuiet`,`utility`,`utilityQuiet`,`quiet`,`link`,`overlay`,`overlayInverted`,`overlayQuiet`,`overlayInvertedQuiet`],x=class extends c{constructor(...e){super(...e),this.autofocus=!1,this.small=!1,this.disabled=!1,this.fullWidth=!1}static{this.shadowRootOptions={...c.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[d,v]}connectedCallback(){if(super.connectedCallback(),this.variant&&!b.includes(this.variant))throw Error(`Invalid "variant" attribute. Set its value to one of the following:\n${b.join(`, `)}.`)}firstUpdated(){this.autofocus&&setTimeout(()=>this.focus(),0)}render(){return n`
      <a
        href="${this.href}"
        part="base"
        target="${this.target}"
    ...
    `}},s([a({type:Boolean,reflect:!0})],x.prototype,`autofocus`,void 0),s([a({reflect:!0})],x.prototype,`variant`,void 0),s([a({type:Boolean,reflect:!0})],x.prototype,`small`,void 0),s([a({reflect:!0})],x.prototype,`href`,void 0),s([a({type:Boolean,reflect:!0})],x.prototype,`disabled`,void 0),s([a({reflect:!0})],x.prototype,`target`,void 0),s([a({reflect:!0})],x.prototype,`rel`,void 0),s([a({attribute:`full-width`,type:Boolean,reflect:!0})],x.prototype,`fullWidth`,void 0),customElements.get(`w-link`)||customElements.define(`w-link`,x)}));export{_ as n,g as r,S as t};
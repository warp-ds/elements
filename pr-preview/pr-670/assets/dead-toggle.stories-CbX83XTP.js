import{a as e,i as t}from"./preload-helper-Cs4UwXAW.js";import{D as n,E as r,Mt as i,Ot as a,Pt as o,_ as s,a as c,c as l,kt as u,l as d,m as f,o as p}from"./iframe-CXLEcQ12.js";import{i as m,n as h,r as g,t as _}from"./utilities-DlOgVT2s.js";var v,y=t((()=>{a(),v=o`
  [part~='label'] {
    display: block;
...
`})),b,x=t((()=>{a(),f(),c(),y(),d(),b=class extends u{constructor(...e){super(...e),this.checked=!1,this.indeterminate=!1,this.invalid=!1,this.disabled=!1}get indeterminateMarker(){return!this.checked&&this.indeterminate?`–`:``}render(){return i` <div class="control">${this.indeterminateMarker}</div> `}static{this.styles=[p,v]}},l([s({type:String,reflect:!0})],b.prototype,`type`,void 0),l([s({type:Boolean,reflect:!0})],b.prototype,`checked`,void 0),l([s({type:Boolean,reflect:!0})],b.prototype,`indeterminate`,void 0),l([s({type:Boolean,reflect:!0})],b.prototype,`invalid`,void 0),l([s({type:Boolean,reflect:!0})],b.prototype,`disabled`,void 0),customElements.get(`w-dead-toggle`)||customElements.define(`w-dead-toggle`,b)})),S=e({Checkbox:()=>O,Checked:()=>A,Indeterminate:()=>k,Invalid:()=>j,Radio:()=>D,__namedExportsOrder:()=>M,default:()=>E}),C,w,T,E,D,O,k,A,j,M,N=t((()=>{g(),n(),a(),_(),x(),{events:C,args:w,argTypes:T}=r(`w-dead-toggle`),E={title:`Forms/Dead toggle`,render(e){return i`<w-dead-toggle ${m(h(e))}></w-dead-toggle>`},args:w,argTypes:T,parameters:{actions:{handles:C}}},D={args:{type:`radio`}},O={args:{type:`checkbox`}},k={args:{indeterminate:!0}},A={args:{checked:!0}},j={args:{invalid:!0}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  args: {
    type: 'radio'
  }

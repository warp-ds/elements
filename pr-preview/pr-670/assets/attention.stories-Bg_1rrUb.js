import{a as e,i as t}from"./preload-helper-Cs4UwXAW.js";import{D as n,E as r,Mt as i,Ot as a}from"./iframe-Ce_z_DY7.js";import{i as o,n as s,r as c,t as l}from"./utilities-DmdGJBZf.js";import{t as u}from"./attention-D62R9l0F.js";import{t as d}from"./button-Olh-4COk.js";import{n as f,t as p}from"./taggedTemplateLiteral-Dh47jvtJ.js";var m=e({AccessibleTooltip:()=>O,Callout:()=>T,Default:()=>C,DismissibleHighlight:()=>D,Highlight:()=>E,ToolTip:()=>w,__namedExportsOrder:()=>k,default:()=>S}),h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A=t((()=>{c(),n(),a(),l(),u(),d(),f(),{events:y,args:b,argTypes:x}=r(`w-attention`),S={title:`Overlays/Attention`,render(e){return i`
      <w-attention ${o(s(e))}>
        <w-button
          ${o({id:e.buttonId})}
          variant="secondary"
    ...
    `},args:b,argTypes:x,parameters:{actions:{handles:y}}},C={args:{placement:`bottom`,popover:!0,flip:!0},render(e){return i`
      <w-attention ${o(s(e))}>
        <w-button 
          id="popoverTarget" 
          slot="target"
    ...
    `}},w={args:{placement:`right`,buttonText:`hover me`,id:`tooltip-element`,tooltip:!0,flip:!0,buttonId:`tooltip-target`},decorators:[e=>i(h||=p([`
      `,`
      <script>
        (() => {
      ...
      <\/script>
    `]),e())]},T={args:{buttonText:`i need a callout`,class:`flex items-center gap-8`,placement:`right`,callout:!0,show:!0}},E={args:{buttonId:`highlight-target1`,id:`highlight-message`,buttonText:`I'm highlighted`,placement:`right`,highlight:!0,flip:!0},decorators:[e=>i(g||=p([`
      `,`
      <script>
        (() => {
      ...
      <\/script>
    `]),e())]},D={args:{class:`flex items-center gap-8`,placement:`right`,buttonId:`highlight-target2`,buttonText:`click me`,id:`dismissible-highlight-message`,"can-close":!0,"cross-axis":!0,highlight:!0,flip:!0},decorators:[e=>i(_||=p([`
      `,`
      <script>
        (() => {

...
`})),P,F=e((()=>{r(),i(),s(),c(),v(),x(),u(),C(),T(),D(),k(),j(),N(),m(),d(w,O,E,S,A),P=class extends a{static{this.styles=[M]}get _validPageCount(){return Math.max(1,Math.floor(this.pageCount??1))}get _validSelectedPage(){let e=Math.floor(this.selectedPage??1);return Math.max(1,Math.min(e,this._validPageCount))}render(){let e=this._validPageCount,t=this._validSelectedPage;return n`
      <div class="w-page-indicator" role="img" aria-label="${p._({id:`page-indicator.aria.label`,comment:`Default screenreader message for page indicator group`,message:`Dot {selectedPage} is highlighted in a row of {pageCount} dots`,values:{selectedPage:t,pageCount:e}})}">
        <div class="w-page-indicator--container">
          ${g(y(e),e=>n`<div class="${l({"w-page-indicator--dot":!0,"w-page-indicator--selecteddot":e+1===t})}"></div>`)}
        </div>
      </div>
    `}},f([t({type:Number,attribute:`selected-page`,reflect:!0})],P.prototype,`selectedPage`,void 0),f([t({type:Number,attribute:`page-count`,reflect:!0})],P.prototype,`pageCount`,void 0),customElements.get(`w-page-indicator`)||customElements.define(`w-page-indicator`,P)})),I,L,R,z,B,V,H,U;e((()=>{i(),s(),F(),m(),I={component:`w-page-indicator`,title:`Navigation/PageIndicator`,render:({pageCount:e,selectedPage:t})=>n`
...
`,z=class extends a{constructor(...e){super(...e),this.page=1}connectedCallback(){super.connectedCallback(),this.startPageChanger()}disconnectedCallback(){super.disconnectedCallback(),this.intervalId&&clearInterval(this.intervalId)}startPageChanger(){this.intervalId=setInterval(()=>{this.page>4?this.page=1:this.page+=1},1e3)}render(){return n`
      <div style="display: grid; height: 10vh; border: 1px solid lightgrey;">
    ...
    `}},f([h()],z.prototype,`page`,void 0),customElements.get(`page-indicator-change-page`)||customElements.define(`page-indicator-change-page`,z),B=()=>n` <page-indicator-change-page></page-indicator-change-page> `,V=()=>n`
  <div style="display: grid; height: 10vh; border: 1px solid lightgrey;">

...
`})),P,F=e((()=>{t(),i(),p(),m(),v(),x(),o(),C(),T(),D(),k(),j(),N(),f(),n(w,O,E,S,A),P=class extends d{static{this.styles=[M]}get _validPageCount(){return Math.max(1,Math.floor(this.pageCount??1))}get _validSelectedPage(){let e=Math.floor(this.selectedPage??1);return Math.max(1,Math.min(e,this._validPageCount))}render(){let e=this._validPageCount,t=this._validSelectedPage;return r`
      <div class="w-page-indicator" role="img" aria-label="${h._({id:`page-indicator.aria.label`,comment:`Default screenreader message for page indicator group`,message:`Dot {selectedPage} is highlighted in a row of {pageCount} dots`,values:{selectedPage:t,pageCount:e}})}">
        <div class="w-page-indicator--container">
          ${g(y(e),e=>r`<div class="${l({"w-page-indicator--dot":!0,"w-page-indicator--selecteddot":e+1===t})}"></div>`)}
        </div>
      </div>
    `}},c([s({type:Number,attribute:`selected-page`,reflect:!0})],P.prototype,`selectedPage`,void 0),c([s({type:Number,attribute:`page-count`,reflect:!0})],P.prototype,`pageCount`,void 0),customElements.get(`w-page-indicator`)||customElements.define(`w-page-indicator`,P)})),I,L,R,z,B,V,H,U;e((()=>{i(),p(),F(),f(),I={component:`w-page-indicator`,title:`Navigation/PageIndicator`,render:({pageCount:e,selectedPage:t})=>r`
...
`,z=class extends d{constructor(...e){super(...e),this.page=1}connectedCallback(){super.connectedCallback(),this.startPageChanger()}disconnectedCallback(){super.disconnectedCallback(),this.intervalId&&clearInterval(this.intervalId)}startPageChanger(){this.intervalId=setInterval(()=>{this.page>4?this.page=1:this.page+=1},1e3)}render(){return r`
      <div style="display: grid; height: 10vh; border: 1px solid lightgrey;">
    ...
    `}},c([u()],z.prototype,`page`,void 0),customElements.get(`page-indicator-change-page`)||customElements.define(`page-indicator-change-page`,z),B=()=>r` <page-indicator-change-page></page-indicator-change-page> `,V=()=>r`
  <div style="display: grid; height: 10vh; border: 1px solid lightgrey;">

import{a as e,i as t}from"./preload-helper-Cs4UwXAW.js";import{D as n,E as r,Mt as i,Ot as a,T as o,s,w as c}from"./iframe-CXLEcQ12.js";import{i as l,n as u,r as d,t as f}from"./utilities-DlOgVT2s.js";import{t as p}from"./button-BDI8wHSl.js";var m=e({AllVariantsGrid:()=>F,AsLink:()=>k,FormControl:()=>A,FullWidth:()=>O,HrefModeRegression:()=>R,Link:()=>C,Loading:()=>D,LoadingAcrossVariants:()=>L,Negative:()=>x,Overlay:()=>j,OverlayInverted:()=>M,OverlayInvertedQuiet:()=>P,OverlayQuiet:()=>N,Pill:()=>w,Primary:()=>y,Quiet:()=>E,QuietBackCompatMapping:()=>I,Secondary:()=>b,Small:()=>T,Utility:()=>S,__namedExportsOrder:()=>z,default:()=>v}),h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B=t((()=>{d(),n(),a(),f(),p(),s(),o(),{events:h,args:g,argTypes:_}=r(`w-button`),v={title:`Buttons/Button`,render(e){return i`<w-button ${l(u(e))}>Button Text</w-button>`},args:g,argTypes:_,parameters:{actions:{handles:h}}},y={args:{variant:`primary`,type:`button`}},b={args:{variant:`secondary`,type:`button`}},x={args:{variant:`negative`,type:`button`}},S={args:{variant:`utility`,type:`button`}},C={args:{variant:`link`,type:`button`}},w={args:{variant:`pill`,type:`button`},render(e){let t=c();return i`<w-button ${l(u(e))}>
      ...
      <w-button ${l(u(e))} small="">
        <w-icon name="ChevronRight" size="small" locale="${t}" style="height: 16px;" class="flex"></w-icon>
      </w-button>`}},T={args:{variant:`primary`,small:!0,type:`button`}},E={args:{variant:`secondary`,quiet:!0,type:`button`}},D={args:{variant:`primary`,loading:!0,type:`button`}},O={args:{variant:`primary`,"full-width":!0,type:`button`},render(e){return i`
      <div class="w-full flex flex-col gap-8">
        <w-button ${l(u(e))}>Full width</w-button>
      </div>
    `}},k={args:{variant:`primary`,href:`https://example.com`,target:`_blank`,type:`button`},render(e){return i`<w-button ${l(u(e))}>Visit Example</w-button>`}},A={args:{},render(){return i`
    ...
    `}},j={args:{variant:`overlay`,type:`button`}},M={args:{variant:`overlayInverted`,type:`button`}},N={args:{variant:`overlayQuiet`,type:`button`}},P={args:{variant:`overlayInvertedQuiet`,type:`button`}},F={args:{},render(){let e=c();return i`
      <div style="display:grid; gap: 16px;">
        ...
        <div style="display:grid; gap: 12px;">
          ${[`primary`,`secondary`,`negative`,`negativeQuiet`,`utility`,`utilityQuiet`,`quiet`,`link`,`pill`,`overlay`,`overlayInverted`,`overlayQuiet`,`overlayInvertedQuiet`].map(t=>i`
    ...
    `}},L={args:{},render(){return i`
      <div style="display:grid; gap: 16px;">
        ...
        <div style="display:flex; flex-wrap: wrap; gap: 12px;">
          ${[`primary`,`secondary`,`negative`,`negativeQuiet`,`utility`,`utilityQuiet`,`quiet`,`link`,`overlay`,`overlayInverted`,`overlayQuiet`,`overlayInvertedQuiet`,`pill`].map(e=>i`<w-button variant=${e} loading type="button">${e}</w-button>`)}
        </div>
      </div>
    `}},R={args:{},render(){return i`
      <div style="display:grid; gap: 12px;">
        <div style="font: 12px/1.4 system-ui; opacity: 0.8;">

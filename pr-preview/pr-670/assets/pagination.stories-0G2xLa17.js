import{a as e,i as t}from"./preload-helper-Cs4UwXAW.js";import{At as n,B as r,C as i,D as a,E as o,Mt as s,Ot as c,Pt as l,T as u,_ as d,a as f,c as p,kt as m,l as h,m as g,o as _,s as v,w as y,z as b}from"./iframe-CXLEcQ12.js";import{i as x,n as S,r as C,t as w}from"./utilities-DlOgVT2s.js";var T,E=t((()=>{T=JSON.parse(`{"pagination.aria.first-page":["Første side"],"pagination.aria.icon-suffix":["ikon"],"pagination.aria.next-page":["Næste side"],"pagination.aria.page":["Side ",["currentPage"]],"pagination.aria.pagination":["Sider"],"pagination.aria.prev-page":["Forrige side"],"pagination.label.current-page":["Side ",["currentPage"]]}`)})),D,O=t((()=>{D=JSON.parse(`{"pagination.aria.first-page":["First page"],"pagination.aria.icon-suffix":["icon"],"pagination.aria.next-page":["Next page"],"pagination.aria.page":["Page ",["currentPage"]],"pagination.aria.pagination":["Pages"],"pagination.aria.prev-page":["Previous page"],"pagination.label.current-page":["Page ",["currentPage"]]}`)})),k,A=t((()=>{k=JSON.parse(`{"pagination.aria.first-page":["Ensimmäinen sivu"],"pagination.aria.icon-suffix":["kuvake"],"pagination.aria.next-page":["Seuraava sivu"],"pagination.aria.page":["Sivu ",["currentPage"]],"pagination.aria.pagination":["Sivut"],"pagination.aria.prev-page":["Edellinen sivu"],"pagination.label.current-page":["Sivu ",["currentPage"]]}`)})),j,M=t((()=>{j=JSON.parse(`{"pagination.aria.first-page":["Første side"],"pagination.aria.icon-suffix":["ikon"],"pagination.aria.next-page":["Neste side"],"pagination.aria.page":["Side ",["currentPage"]],"pagination.aria.pagination":["Sider"],"pagination.aria.prev-page":["Forrige side"],"pagination.label.current-page":["Side ",["currentPage"]]}`)})),N,P=t((()=>{N=JSON.parse(`{"pagination.aria.first-page":["Första sidan"],"pagination.aria.icon-suffix":["ikon"],"pagination.aria.next-page":["Nästa sida"],"pagination.aria.page":["Sida ",["currentPage"]],"pagination.aria.pagination":["Sidor"],"pagination.aria.prev-page":["Föregående sida"],"pagination.label.current-page":["Sida ",["currentPage"]]}`)})),F,I=t((()=>{c(),F=l`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hover\\:bg-clip-padding:hover{-webkit-background-clip:padding-box;background-clip:padding-box}.hover\\:bg-\\[--w-color-button-pill-background-hover\\]:hover{background-color:var(--w-color-button-pill-background-hover)}.active\\:bg-\\[--w-color-button-pill-background-active\\]:active{background-color:var(--w-color-button-pill-background-active)}.border-0{border-width:0}.rounded-full{border-radius:9999px}.block{display:block}.flex{display:flex}.inline-flex{display:inline-flex}.hidden{display:none}.hover\\:no-underline:hover,.focus\\:no-underline:focus{text-decoration:none}.focusable:focus{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:focus-visible{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:not(:focus-visible){outline:none}.items-center{align-items:center}.justify-center{justify-content:center}.static{position:static}.s-bg-primary{background-color:var(--w-s-color-background-primary)}.s-text-inverted{color:var(--w-s-color-text-inverted)}.s-text-link{color:var(--w-s-color-text-link)}.s-icon{color:var(--w-s-color-icon)}.min-h-\\[44px\\]{min-height:44px}.min-w-\\[44px\\]{min-width:44px}.p-4{padding:.4rem}.p-8{padding:.8rem}.visible{visibility:visible}.font-bold{font-weight:700}.pointer-events-none{pointer-events:none}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}.transition-colors{transition-property:color,background-color,border-color,text-decoration-color,fill,stroke;transition-duration:.15s;transition-timing-function:cubic-bezier(.4,0,.2,1)}.ease-in-out{transition-timing-function:cubic-bezier(.4,0,.2,1)}@media (min-width:768px){.md\\:block{display:block}.md\\:hidden{display:none}}`})),L,R,z,B=t((()=>{r(),c(),g(),v(),u(),f(),E(),O(),A(),M(),P(),I(),h(),L=()=>b._({id:`pagination.aria.icon-suffix`,message:`icon`,comment:`Suffix added at the end of icon titles when img semantics are lost on an html element`}),R=`hover:no-underline focus:no-underline focusable inline-flex justify-center items-center transition-colors ease-in-out min-h-[44px] min-w-[44px] p-4 rounded-full border-0 hover:bg-clip-padding`,z=class extends m{static{this.styles=[_,F,l`
    ...
    `]}constructor(){super(),i(D,j,k,T,N)}get _currentPage(){return this.currentPageNumber??1}get _visiblePages(){return this.visiblePages??7}get shouldShowShowFirstPageButton(){return this._currentPage-2>0}get shouldShowPreviousPageButton(){return this._currentPage-1>0}get shouldShowNextPageButton(){return this._currentPage<this.pages}get currentPageIndex(){return this._currentPage-1}get visiblePageNumbers(){if(this.pages<=this._visiblePages)return Array.from({length:this.pages},(e,t)=>t+1);let e=Math.floor(this._visiblePages/2),t=Math.max(1,this._currentPage-e),n=Math.min(this.pages,t+this._visiblePages-1);return n-t+1<this._visiblePages&&(t=Math.max(1,n-this._visiblePages+1)),Array.from({length:n-t+1},(e,n)=>t+n)}#e(e){let t=e.target.getAttribute(`data-page-number`);this.dispatchEvent(new CustomEvent(`page-click`,{detail:{clickedPage:t},bubbles:!0,composed:!0}))}render(){let e=this.visiblePageNumbers;return s`<nav class="flex items-center justify-center p-8" @click="${this.#e}">
      ...
      <div class="flex items-center s-text-link">
        ...
        <div class="hidden md:block">
          ${e.map(e=>{let t=e===this._currentPage,n=`${this.baseUrl}${e}`,r=R;return t?r+=` s-bg-primary s-text-inverted`:r+=` hover:bg-[--w-color-button-pill-background-hover] active:bg-[--w-color-button-pill-background-active]`,s`<a
              data-page-number="${e}"
    ...
    </nav>`}},p([d({type:String,reflect:!0,attribute:`base-url`})],z.prototype,`baseUrl`,void 0),p([d({type:Number,reflect:!0})],z.prototype,`pages`,void 0),p([d({type:Number,reflect:!0,attribute:`current-page`})],z.prototype,`currentPageNumber`,void 0),p([d({type:Number,reflect:!0,attribute:`visible-pages`})],z.prototype,`visiblePages`,void 0),customElements.get(`w-pagination`)||customElements.define(`w-pagination`,z)})),V=e({BasicPagination:()=>K,LastPageSelected:()=>J,ManyPagesWithLimitedVisible:()=>Y,MiddlePageSelected:()=>q,SinglePage:()=>X,__namedExportsOrder:()=>Z,default:()=>G}),H,U,W,G,K,q,J,Y,X,Z,Q=t((()=>{C(),a(),c(),w(),B(),{events:H,args:U,argTypes:W}=o(`w-pagination`),G={title:`Navigation/Pagination`,render(e){return s`<w-pagination ${x(S(e))}></w-pagination>`},args:U,argTypes:W,parameters:{actions:{handles:H}}},K={args:{"current-page":1,pages:5,"base-url":`/search?page=`}},q={args:{"current-page":3,pages:7,"base-url":`/search?page=`}},J={args:{"current-page":10,pages:10,"base-url":`/search?page=`}},Y={args:{"current-page":15,pages:50,"visible-pages":5,"base-url":`/search?page=`}},X={args:{"current-page":1,pages:1,"base-url":`/search?page=`}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
  args: {
    'current-page': 1,
    pages: 5,

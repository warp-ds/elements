import{a as e,i as t}from"./preload-helper-Cs4UwXAW.js";import{At as n,B as r,D as i,E as a,Mt as o,Ot as s,Pt as c,_ as ee,a as l,b as u,c as d,d as f,f as te,kt as p,l as ne,o as m,s as re,u as ie,v as h,y as ae,z as oe}from"./iframe-Ce_z_DY7.js";import{i as g,n as _,r as se,t as ce}from"./utilities-DmdGJBZf.js";function le(e){let t=-1;e.ontouchstart=e=>{e.targetTouches.length===1&&(t=e.targetTouches[0].clientY)},e.ontouchmove=n=>{if(n.targetTouches.length!==1)return;let r=n.targetTouches[0].clientY-t;return e.scrollTop===0&&r>0||w(e)&&r<0?x(n):(n.stopPropagation(),!0)}}function ue(e){e.ontouchstart=null,e.ontouchmove=null}function de(e){if(!e)throw Error(`Could not run setup, an element must be provided`);v.some(t=>t===e)||(v.length||(me(),E()),le(e),v.push(e))}function fe(){v.forEach(ue),D(),C(),v=[]}var v,y,b,x,pe,me,S,C,w,T,E,D,he=t((()=>{v=[],y={documentElement:{},body:{}},b=Object.freeze({documentElement:{"scrollbar-gutter":`stable`},body:{overflow:`hidden`,position:`relative`,height:`100%`}}),x=e=>{e.touches.length>1||e.preventDefault?.()},pe=e=>([t,n])=>{y[e][t]=document[e].style[t],document[e].style[t]=n},me=()=>Object.entries(b).forEach(([e,t])=>{Object.entries(t).forEach(pe(e))}),S=e=>([t,n])=>{document[e].style[t]=y[e][t]},C=()=>Object.entries(y).forEach(([e,t])=>{Object.entries(t).forEach(S(e))}),w=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight,T=e=>()=>document[e?`addEventListener`:`removeEventListener`](`touchmove`,x,{passive:!1}),E=T(!0),D=T()})),O,k,A=t((()=>{O=e=>class extends e{constructor(...e){super(...e),this.patchClose=!0,this._close=null}close(){this._close()}},k=e=>class extends e{handleSlotChange(e){let t=e.target.assignedNodes({flatten:!0});for(let e of t.filter(e=>e.patchClose))e._close=()=>this.close()}}})),j,ge=t((()=>{s(),ee(),he(),l(),A(),te(),j=class extends k(p){constructor(){super(),this.show=!1,this.ignoreBackdropClicks=!1,this._isClosing=!1,this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`command`,e=>{let t=e.command;t===`--show-modal`?this.open():(t===`--close`||t===`--confirm`)&&this.close()})}async open(){this._isClosing=!1,this.dialogEl.classList.remove(`close`),this.dialogEl.showModal(),this.handleListeners(),de(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent(`shown`,{bubbles:!0,composed:!0}))}close(){this.dialogEl?.open&&(this._isClosing=!0,this.handleListeners(`removeEventListener`),this.dialogEl.classList.add(`close`),this.dialogEl.addEventListener(`animationend`,async e=>{e.animationName===`w-modal-out`&&this._isClosing&&(this.dialogEl.classList.remove(`close`),this.dialogEl.close(),this._isClosing=!1,fe(),await this.updateComplete,this.dispatchEvent(new CustomEvent(`hidden`,{bubbles:!0,composed:!0})))},{once:!0}))}render(){return o`
    ...
    `]}},customElements.get(`w-modal-footer`)||customElements.define(`w-modal-footer`,U)})),De=e({Default:()=>q,InvokerCommands:()=>J,Modal:()=>X,ModalFooter:()=>Q,ModalHeader:()=>Z,WithImage:()=>Y,__namedExportsOrder:()=>$,default:()=>K}),W,G,Oe,ke,Ae,je,Me,Ne,Pe,K,q,J,Y,X,Z,Q,$,Fe=t((()=>{se(),i(),s(),ce(),ge(),Te(),Ee(),{events:W,args:G,argTypes:Oe}=a(`w-modal`),{events:ke,args:Ae,argTypes:je}=a(`w-modal-header`),{events:Me,args:Ne,argTypes:Pe}=a(`w-modal-footer`),K={title:`Overlays/Modal`},q={args:{},render(){return o`

import{i as e}from"./preload-helper-Cs4UwXAW.js";import{At as t,B as n,Mt as r,Ot as i,Pt as a,_ as o,a as s,b as c,d as l,f as u,kt as d,l as f,o as p,s as m,v as h,z as g}from"./iframe-Ce_z_DY7.js";import{n as _,t as v}from"./form-control-_t8OxpDL.js";import{n as y,t as b}from"./if-defined-T7MLPU6p.js";import{t as x}from"./link-Cj6usxfE.js";var S,C=e((()=>{S=JSON.parse(`{"button.aria.loading":["Indlæser..."]}`)})),w,T=e((()=>{w=JSON.parse(`{"button.aria.loading":["Loading..."]}`)})),E,D=e((()=>{E=JSON.parse(`{"button.aria.loading":["Ladataan..."]}`)})),O,k=e((()=>{O=JSON.parse(`{"button.aria.loading":["Laster..."]}`)})),A,j=e((()=>{A=JSON.parse(`{"button.aria.loading":["Laddar ..."]}`)})),M,N=e((()=>{i(),M=a`
  :host {

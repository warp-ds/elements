import{a as e,i as t}from"./preload-helper-Cs4UwXAW.js";import{At as n,B as r,C as i,D as a,Dt as o,E as s,Et as ee,F as te,I as c,Mt as l,N as ne,Nt as re,Ot as u,P as ie,Pt as d,T as ae,Tt as oe,_ as f,a as se,c as p,g as ce,h as le,jt as m,kt as h,l as g,m as _,o as ue,z as v}from"./iframe-CXLEcQ12.js";import{i as de,n as fe,r as pe,t as me}from"./utilities-DlOgVT2s.js";import{n as y,t as b}from"./form-control-_t8OxpDL.js";import{n as x,t as S}from"./if-defined-CodTf17n.js";var C,he=t((()=>{re(),te(),oe(),C=ne(class extends ie{constructor(e){if(super(e),e.type!==c.PROPERTY&&e.type!==c.ATTRIBUTE&&e.type!==c.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!o(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===m||t===n)return t;let r=e.element,i=e.name;if(e.type===c.PROPERTY){if(t===r[i])return m}else if(e.type===c.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(i))return m}else if(e.type===c.ATTRIBUTE&&r.getAttribute(i)===t+``)return m;return ee(e),t}})})),ge=t((()=>{he()})),w,_e=t((()=>{u(),w=d`
  :host {
...
`})),T,ve=t((()=>{b(),u(),_(),S(),ge(),se(),_e(),g(),T=class extends y(h){constructor(...e){super(...e),this.value=null,this.indeterminate=!1,this.checked=!1,this.disabled=!1,this.required=!1,this.invalid=!1,this.#e=!1,this.#t=!1,this.#n=!1,this.#r=()=>{this.#a(),this.#l()},this.#i=e=>{if(!this.disabled&&!e.defaultPrevented&&!(e.key!==` `&&e.key!==`Spacebar`&&e.key!==`Enter`)){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}e.composedPath()[0]!==this.input&&(e.preventDefault(),this.click())}}}static{this.styles=[ue,w]}static{this.shadowRootOptions={...h.shadowRootOptions,delegatesFocus:!0}}set name(e){this._ownName=e}get name(){return this._ownName||this._groupName}#e;#t;#n;get _computedInvalid(){return this.invalid||this._groupInvalid===!0}connectedCallback(){super.connectedCallback();let e=this.getAttribute(`value`);this.value=e??`on`,this.#e=this.hasAttribute(`checked`),this.checked=this.#e,this.addEventListener(`invalid`,this.#r),this.addEventListener(`keydown`,this.#i),this.#u()}handleClick(){this.disabled||(this.#a(),this.checked=!this.checked,this.indeterminate=!1,this.updateComplete.then(()=>{this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}))}#r;#i;updated(e){super.updated(e),(e.has(`checked`)||e.has(`indeterminate`))&&this.#d(),this.#f(e)&&(this.#u(),this.#l())}resetFormControl(){this.checked=this.#e,this.#u(),this.#l()}click(){this.disabled||this.input?.click()}focus(e){this.input?.focus(e)}blur(){this.input?.blur()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#l(),this.internals.checkValidity()}reportValidity(){return this.#a(),this.#l(),this.internals.checkValidity()}#a(){this.#n=!0}#o(){return this.input?.validationMessage||` `}#s(){return this.input??void 0}#c(e){this.internals.setValidity(e,this.#o(),this.#s())}#l(){if(this.disabled){this.internals.setValidity({});return}let e=this.required&&!this.checked,t=this.invalid&&!this.#t;if(e){this.#t=!0,this.invalid=this.#n,this.#c({valueMissing:!0});return}if(this.#t&&=(this.invalid=!1,!1),t){this.#c({customError:!0});return}this.internals.setValidity({})}#u(){if(this.disabled){this.setValue(null);return}let e=this.checked?this.value:null;this.setValue(e)}#d(){this.input&&(this.input.checked=this.checked,this.input.indeterminate=this.indeterminate)}#f(e){return e.has(`checked`)||e.has(`value`)||e.has(`disabled`)||e.has(`required`)||e.has(`invalid`)}render(){let e=!this.checked&&this.indeterminate,t=e?`mixed`:this.checked?`true`:`false`;return l`
    ...
    `}},p([le(`input[type="checkbox"]`)],T.prototype,`input`,void 0),p([f({reflect:!0})],T.prototype,`name`,null),p([f({reflect:!0})],T.prototype,`value`,void 0),p([f({type:Boolean,reflect:!0})],T.prototype,`indeterminate`,void 0),p([f({type:Boolean,reflect:!0})],T.prototype,`checked`,void 0),p([f({type:Boolean,reflect:!0})],T.prototype,`disabled`,void 0),p([f({type:Boolean,reflect:!0})],T.prototype,`required`,void 0),p([f({type:Boolean,reflect:!0})],T.prototype,`invalid`,void 0),p([f({attribute:!1})],T.prototype,`_groupInvalid`,void 0),p([f({attribute:!1})],T.prototype,`_groupName`,void 0),customElements.get(`w-checkbox`)||customElements.define(`w-checkbox`,T)})),E,ye=t((()=>{E=JSON.parse(`{"checkbox-group.label.optional":["Valgfri"],"checkbox-group.validation.required":["Mindst én valgt mulighed er påkrævet."]}`)})),D,be=t((()=>{D=JSON.parse(`{"checkbox-group.label.optional":["Optional"],"checkbox-group.validation.required":["At least one selection is required."]}`)})),O,xe=t((()=>{O=JSON.parse(`{"checkbox-group.label.optional":["Valinnainen"],"checkbox-group.validation.required":["Vähintään yksi valinta vaaditaan."]}`)})),k,Se=t((()=>{k=JSON.parse(`{"checkbox-group.label.optional":["Valgfri"],"checkbox-group.validation.required":["Minst ett valg er påkrevd."]}`)})),A,Ce=t((()=>{A=JSON.parse(`{"checkbox-group.label.optional":["Valfritt"],"checkbox-group.validation.required":["Minst ett val krävs."]}`)})),j,M,we=t((()=>{r(),b(),u(),_(),S(),ae(),ye(),be(),xe(),Se(),Ce(),g(),i(D,k,O,E,A),j=()=>v._({id:`checkbox-group.validation.required`,message:`At least one selection is required.`,comment:`Shown when required checkbox group has no selections`}),M=class extends y(h){constructor(...e){super(...e),this.optional=!1,this.required=!1,this.invalid=!1,this.#e=!1,this.#t=!1,this._internalTabIndex=-1,this.#r=()=>{this.#o(),this.#_(),this.requestUpdate()},this.#i=()=>{this.#o(),this.#_(),this.requestUpdate()},this.#a=()=>{this.#l(),this.#_(),this.requestUpdate()},this.#s=()=>{this.requestUpdate()}}static{this.shadowRootOptions={...h.shadowRootOptions,delegatesFocus:!0}}#e;#t;#n;static{this.styles=d`
    .wrapper {
      display: inline-flex;

import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{f as n,y as r}from"./decorate-kJVNAdyH.js";import{n as i,t as a}from"./dist-Bn_0n649.js";import{i as o,n as s,r as c}from"./utilities-DyUKeeub.js";import{t as l}from"./expand-transition-C7QLNZ2R.js";import{t as u}from"./button-2zTV9SrP.js";import{t as d}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as f,t as p}from"./expandable-DrtB6sPl.js";var m=t({Animated:()=>T,Box:()=>S,BoxBleed:()=>C,CustomTitle:()=>O,Default:()=>b,DefaultWithDivider:()=>w,DeprecatedFlagsCompatibility:()=>j,Expanded:()=>x,NoChevron:()=>D,NoTitle:()=>k,StylingApi:()=>A,WithHeading:()=>E,__namedExportsOrder:()=>M,default:()=>y}),h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;function N(){return(N=e((()=>{c(),i(),n(),u(),l(),f(),p(),{events:g,args:_,argTypes:v}=a(`w-expandable`),y={title:`Layout/Expandable`,render(e){return r`
            <w-expandable ${o(s(e))}>
...
&lt;/style&gt;
        ...
        `}},j={args:{title:`Deprecated flags compatibility`,expanded:!1,box:!0,bleed:!0}},M=[`Default`,`Expanded`,`Box`,`BoxBleed`,`DefaultWithDivider`,`Animated`,`WithHeading`,`NoChevron`,`CustomTitle`,`NoTitle`,`StylingApi`,`DeprecatedFlagsCompatibility`],b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...j.parameters?.docs?.source}}}})))()}export{x as a,E as c,b as i,m as l,S as n,D as o,O as r,k as s,T as t,N as u};
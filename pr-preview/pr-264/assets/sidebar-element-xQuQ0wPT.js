...
negative, positive, warning, info.`)}get _wrapperClasses(){return F([vt.wrapper,vt[this.variant]])}get _iconClasses(){const e=vt[`${this.variant}Icon`];return F([vt.icon,e])}static{this.styles=[ye,Zl,J`
    ...
    `}}yo([x({reflect:!0})],mr.prototype,"variant");yo([x({type:Boolean,reflect:!0})],mr.prototype,"show");yo([x({reflect:!0})],mr.prototype,"role");customElements.get("w-alert")||customElements.define("w-alert",mr);const Gl=["top","right","bottom","left"],Qe=Math.min,fe=Math.max,Kt=Math.round,ke=t=>({x:t,y:t}),ec={left:"right",right:"left",bottom:"top",top:"bottom"},tc={start:"end",end:"start"};function Zr(t,e,r){return fe(t,Qe(e,r))}function Ze(t,e){return typeof t=="function"?t(e):t}function De(t){return t.split("-")[0]}function ct(t){return t.split("-")[1]}function pi(t){return t==="x"?"y":"x"}function xo(t){return t==="y"?"height":"width"}function Xe(t){return["top","bottom"].includes(De(t))?"y":"x"}function $o(t){return pi(Xe(t))}function rc(t,e,r){r===void 0&&(r=!1);const o=ct(t),n=$o(t),i=xo(n);let s=n==="x"?o===(r?"end":"start")?"right":"left":o==="start"?"bottom":"top";return e.reference[i]>e.floating[i]&&(s=Gt(s)),[s,Gt(s)]}function oc(t){const e=Gt(t);return[Kr(t),e,Kr(e)]}function Kr(t){return t.replace(/start|end/g,e=>tc[e])}function nc(t,e,r){const o=["left","right"],n=["right","left"],i=["top","bottom"],s=["bottom","top"];switch(t){case"top":case"bottom":return r?e?n:o:e?o:n;case"left":case"right":return e?i:s;default:return[]}}function ic(t,e,r,o){const n=ct(t);let i=nc(De(t),r==="start",o);return n&&(i=i.map(s=>s+"-"+n),e&&(i=i.concat(i.map(Kr)))),i}function Gt(t){return t.replace(/left|right|bottom|top/g,e=>ec[e])}function sc(t){return{top:0,right:0,bottom:0,left:0,...t}}function gi(t){return typeof t!="number"?sc(t):{top:t,right:t,bottom:t,left:t}}function er(t){const{x:e,y:r,width:o,height:n}=t;return{width:o,height:n,top:r,left:e,right:e+o,bottom:r+n,x:e,y:r}}function on(t,e,r){let{reference:o,floating:n}=t;const i=Xe(e),s=$o(e),l=xo(s),a=De(e),u=i==="y",h=o.x+o.width/2-n.width/2,c=o.y+o.height/2-n.height/2,g=o[l]/2-n[l]/2;let d;switch(a){case"top":d={x:h,y:o.y-n.height};break;case"bottom":d={x:h,y:o.y+o.height};break;case"right":d={x:o.x+o.width,y:c};break;case"left":d={x:o.x-n.width,y:c};break;default:d={x:o.x,y:o.y}}switch(ct(e)){case"start":d[s]-=g*(r&&u?-1:1);break;case"end":d[s]+=g*(r&&u?-1:1);break}return d}const ac=async(t,e,r)=>{const{placement:o="bottom",strategy:n="absolute",middleware:i=[],platform:s}=r,l=i.filter(Boolean),a=await(s.isRTL==null?void 0:s.isRTL(e));let u=await s.getElementRects({reference:t,floating:e,strategy:n}),{x:h,y:c}=on(u,o,a),g=o,d={},f=0;for(let p=0;p<l.length;p++){const{name:v,fn:E}=l[p],{x:A,y:C,data:D,reset:$}=await E({x:h,y:c,initialPlacement:o,placement:g,strategy:n,middlewareData:d,rects:u,platform:s,elements:{reference:t,floating:e}});h=A??h,c=C??c,d={...d,[v]:{...d[v],...D}},$&&f<=50&&(f++,typeof $=="object"&&($.placement&&(g=$.placement),$.rects&&(u=$.rects===!0?await s.getElementRects({reference:t,floating:e,strategy:n}):$.rects),{x:h,y:c}=on(u,g,a)),p=-1)}return{x:h,y:c,placement:g,strategy:n,middlewareData:d}};async function Lt(t,e){var r;e===void 0&&(e={});const{x:o,y:n,platform:i,rects:s,elements:l,strategy:a}=t,{boundary:u="clippingAncestors",rootBoundary:h="viewport",elementContext:c="floating",altBoundary:g=!1,padding:d=0}=Ze(e,t),f=gi(d),v=l[g?c==="floating"?"reference":"floating":c],E=er(await i.getClippingRect({element:(r=await(i.isElement==null?void 0:i.isElement(v)))==null||r?v:v.contextElement||await(i.getDocumentElement==null?void 0:i.getDocumentElement(l.floating)),boundary:u,rootBoundary:h,strategy:a})),A=c==="floating"?{x:o,y:n,width:s.floating.width,height:s.floating.height}:s.reference,C=await(i.getOffsetParent==null?void 0:i.getOffsetParent(l.floating)),D=await(i.isElement==null?void 0:i.isElement(C))?await(i.getScale==null?void 0:i.getScale(C))||{x:1,y:1}:{x:1,y:1},$=er(i.convertOffsetParentRelativeRectToViewportRelativeRect?await i.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:A,offsetParent:C,strategy:a}):A);return{top:(E.top-$.top+f.top)/D.y,bottom:($.bottom-E.bottom+f.bottom)/D.y,left:(E.left-$.left+f.left)/D.x,right:($.right-E.right+f.right)/D.x}}const lc=t=>({name:"arrow",options:t,async fn(e){const{x:r,y:o,placement:n,rects:i,platform:s,elements:l,middlewareData:a}=e,{element:u,padding:h=0}=Ze(t,e)||{};if(u==null)return{};const c=gi(h),g={x:r,y:o},d=$o(n),f=xo(d),p=await s.getDimensions(u),v=d==="y",E=v?"top":"left",A=v?"bottom":"right",C=v?"clientHeight":"clientWidth",D=i.reference[f]+i.reference[d]-g[d]-i.floating[f],$=g[d]-i.reference[d],O=await(s.getOffsetParent==null?void 0:s.getOffsetParent(u));let L=O?O[C]:0;(!L||!await(s.isElement==null?void 0:s.isElement(O)))&&(L=l.floating[C]||i.floating[f]);const M=D/2-$/2,H=L/2-p[f]/2-1,W=Qe(c[E],H),K=Qe(c[A],H),U=W,ae=L-p[f]-K,B=L/2-p[f]/2+M,ee=Zr(U,B,ae),Q=!a.arrow&&ct(n)!=null&&B!==ee&&i.reference[f]/2-(B<U?W:K)-p[f]/2<0,ne=Q?B<U?B-U:B-ae:0;return{[d]:g[d]+ne,data:{[d]:ee,centerOffset:B-ee-ne,...Q&&{alignmentOffset:ne}},reset:Q}}}),cc=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(e){var r,o;const{placement:n,middlewareData:i,rects:s,initialPlacement:l,platform:a,elements:u}=e,{mainAxis:h=!0,crossAxis:c=!0,fallbackPlacements:g,fallbackStrategy:d="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:p=!0,...v}=Ze(t,e);if((r=i.arrow)!=null&&r.alignmentOffset)return{};const E=De(n),A=Xe(l),C=De(l)===l,D=await(a.isRTL==null?void 0:a.isRTL(u.floating)),$=g||(C||!p?[Gt(l)]:oc(l)),O=f!=="none";!g&&O&&$.push(...ic(l,p,f,D));const L=[l,...$],M=await Lt(e,v),H=[];let W=((o=i.flip)==null?void 0:o.overflows)||[];if(h&&H.push(M[E]),c){const B=rc(n,s,D);H.push(M[B[0]],M[B[1]])}if(W=[...W,{placement:n,overflows:H}],!H.every(B=>B<=0)){var K,U;const B=(((K=i.flip)==null?void 0:K.index)||0)+1,ee=L[B];if(ee)return{data:{index:B,overflows:W},reset:{placement:ee}};let Q=(U=W.filter(ne=>ne.overflows[0]<=0).sort((ne,te)=>ne.overflows[1]-te.overflows[1])[0])==null?void 0:U.placement;if(!Q)switch(d){case"bestFit":{var ae;const ne=(ae=W.filter(te=>{if(O){const ie=Xe(te.placement);return ie===A||ie==="y"}return!0}).map(te=>[te.placement,te.overflows.filter(ie=>ie>0).reduce((ie,Ge)=>ie+Ge,0)]).sort((te,ie)=>te[1]-ie[1])[0])==null?void 0:ae[0];ne&&(Q=ne);break}case"initialPlacement":Q=l;break}if(n!==Q)return{reset:{placement:Q}}}return{}}}};function nn(t,e){return{top:t.top-e.height,right:t.right-e.width,bottom:t.bottom-e.height,left:t.left-e.width}}function sn(t){return Gl.some(e=>t[e]>=0)}const dc=function(t){return t===void 0&&(t={}),{name:"hide",options:t,async fn(e){const{rects:r}=e,{strategy:o="referenceHidden",...n}=Ze(t,e);switch(o){case"referenceHidden":{const i=await Lt(e,{...n,elementContext:"reference"}),s=nn(i,r.reference);return{data:{referenceHiddenOffsets:s,referenceHidden:sn(s)}}}case"escaped":{const i=await Lt(e,{...n,altBoundary:!0}),s=nn(i,r.floating);return{data:{escapedOffsets:s,escaped:sn(s)}}}default:return{}}}}};async function uc(t,e){const{placement:r,platform:o,elements:n}=t,i=await(o.isRTL==null?void 0:o.isRTL(n.floating)),s=De(r),l=ct(r),a=Xe(r)==="y",u=["left","top"].includes(s)?-1:1,h=i&&a?-1:1,c=Ze(e,t);let{mainAxis:g,crossAxis:d,alignmentAxis:f}=typeof c=="number"?{mainAxis:c,crossAxis:0,alignmentAxis:null}:{mainAxis:c.mainAxis||0,crossAxis:c.crossAxis||0,alignmentAxis:c.alignmentAxis};return l&&typeof f=="number"&&(d=l==="end"?f*-1:f),a?{x:d*h,y:g*u}:{x:g*u,y:d*h}}const hc=function(t){return t===void 0&&(t=0),{name:"offset",options:t,async fn(e){var r,o;const{x:n,y:i,placement:s,middlewareData:l}=e,a=await uc(e,t);return s===((r=l.offset)==null?void 0:r.placement)&&(o=l.arrow)!=null&&o.alignmentOffset?{}:{x:n+a.x,y:i+a.y,data:{...a,placement:s}}}}},pc=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(e){const{x:r,y:o,placement:n}=e,{mainAxis:i=!0,crossAxis:s=!1,limiter:l={fn:v=>{let{x:E,y:A}=v;return{x:E,y:A}}},...a}=Ze(t,e),u={x:r,y:o},h=await Lt(e,a),c=Xe(De(n)),g=pi(c);let d=u[g],f=u[c];if(i){const v=g==="y"?"top":"left",E=g==="y"?"bottom":"right",A=d+h[v],C=d-h[E];d=Zr(A,d,C)}if(s){const v=c==="y"?"top":"left",E=c==="y"?"bottom":"right",A=f+h[v],C=f-h[E];f=Zr(A,f,C)}const p=l.fn({...e,[g]:d,[c]:f});return{...p,data:{x:p.x-r,y:p.y-o,enabled:{[g]:i,[c]:s}}}}}},gc=function(t){return t===void 0&&(t={}),{name:"size",options:t,async fn(e){var r,o;const{placement:n,rects:i,platform:s,elements:l}=e,{apply:a=()=>{},...u}=Ze(t,e),h=await Lt(e,u),c=De(n),g=ct(n),d=Xe(n)==="y",{width:f,height:p}=i.floating;let v,E;c==="top"||c==="bottom"?(v=c,E=g===(await(s.isRTL==null?void 0:s.isRTL(l.floating))?"start":"end")?"left":"right"):(E=c,v=g==="end"?"top":"bottom");const A=p-h.top-h.bottom,C=f-h.left-h.right,D=Qe(p-h[v],A),$=Qe(f-h[E],C),O=!e.middlewareData.shift;let L=D,M=$;if((r=e.middlewareData.shift)!=null&&r.enabled.x&&(M=C),(o=e.middlewareData.shift)!=null&&o.enabled.y&&(L=A),O&&!g){const W=fe(h.left,0),K=fe(h.right,0),U=fe(h.top,0),ae=fe(h.bottom,0);d?M=f-2*(W!==0||K!==0?W+K:fe(h.left,h.right)):L=p-2*(U!==0||ae!==0?U+ae:fe(h.top,h.bottom))}await a({...e,availableWidth:M,availableHeight:L});const H=await s.getDimensions(l.floating);return f!==H.width||p!==H.height?{reset:{rects:!0}}:{}}}};function vr(){return typeof window<"u"}function dt(t){return fi(t)?(t.nodeName||"").toLowerCase():"#document"}function ue(t){var e;return(t==null||(e=t.ownerDocument)==null?void 0:e.defaultView)||window}function Ae(t){var e;return(e=(fi(t)?t.ownerDocument:t.document)||window.document)==null?void 0:e.documentElement}function fi(t){return vr()?t instanceof Node||t instanceof ue(t).Node:!1}function be(t){return vr()?t instanceof Element||t instanceof ue(t).Element:!1}function _e(t){return vr()?t instanceof HTMLElement||t instanceof ue(t).HTMLElement:!1}function an(t){return!vr()||typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof ue(t).ShadowRoot}function Mt(t){const{overflow:e,overflowX:r,overflowY:o,display:n}=we(t);return/auto|scroll|overlay|hidden|clip/.test(e+o+r)&&!["inline","contents"].includes(n)}function fc(t){return["table","td","th"].includes(dt(t))}function br(t){return[":popover-open",":modal"].some(e=>{try{return t.matches(e)}catch{return!1}})}function ko(t){const e=_o(),r=be(t)?we(t):t;return["transform","translate","scale","rotate","perspective"].some(o=>r[o]?r[o]!=="none":!1)||(r.containerType?r.containerType!=="normal":!1)||!e&&(r.backdropFilter?r.backdropFilter!=="none":!1)||!e&&(r.filter?r.filter!=="none":!1)||["transform","translate","scale","rotate","perspective","filter"].some(o=>(r.willChange||"").includes(o))||["paint","layout","strict","content"].some(o=>(r.contain||"").includes(o))}function mc(t){let e=Me(t);for(;_e(e)&&!lt(e);){if(ko(e))return e;if(br(e))return null;e=Me(e)}return null}function _o(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function lt(t){return["html","body","#document"].includes(dt(t))}function we(t){return ue(t).getComputedStyle(t)}function wr(t){return be(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function Me(t){if(dt(t)==="html")return t;const e=t.assignedSlot||t.parentNode||an(t)&&t.host||Ae(t);return an(e)?e.host:e}function mi(t){const e=Me(t);return lt(e)?t.ownerDocument?t.ownerDocument.body:t.body:_e(e)&&Mt(e)?e:mi(e)}function Gr(t,e,r){var o;e===void 0&&(e=[]),r===void 0&&(r=!0);const n=mi(t),i=n===((o=t.ownerDocument)==null?void 0:o.body),s=ue(n);if(i){const l=eo(s);return e.concat(s,s.visualViewport||[],Mt(n)?n:[],l&&r?Gr(l):[])}return e.concat(n,Gr(n,[],r))}function eo(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function vi(t){const e=we(t);let r=parseFloat(e.width)||0,o=parseFloat(e.height)||0;const n=_e(t),i=n?t.offsetWidth:r,s=n?t.offsetHeight:o,l=Kt(r)!==i||Kt(o)!==s;return l&&(r=i,o=s),{width:r,height:o,$:l}}function bi(t){return be(t)?t:t.contextElement}function it(t){const e=bi(t);if(!_e(e))return ke(1);const r=e.getBoundingClientRect(),{width:o,height:n,$:i}=vi(e);let s=(i?Kt(r.width):r.width)/o,l=(i?Kt(r.height):r.height)/n;return(!s||!Number.isFinite(s))&&(s=1),(!l||!Number.isFinite(l))&&(l=1),{x:s,y:l}}const vc=ke(0);function wi(t){const e=ue(t);return!_o()||!e.visualViewport?vc:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function bc(t,e,r){return e===void 0&&(e=!1),!r||e&&r!==ue(t)?!1:e}function Nt(t,e,r,o){e===void 0&&(e=!1),r===void 0&&(r=!1);const n=t.getBoundingClientRect(),i=bi(t);let s=ke(1);e&&(o?be(o)&&(s=it(o)):s=it(t));const l=bc(i,r,o)?wi(i):ke(0);let a=(n.left+l.x)/s.x,u=(n.top+l.y)/s.y,h=n.width/s.x,c=n.height/s.y;if(i){const g=ue(i),d=o&&be(o)?ue(o):o;let f=g,p=eo(f);for(;p&&o&&d!==f;){const v=it(p),E=p.getBoundingClientRect(),A=we(p),C=E.left+(p.clientLeft+parseFloat(A.paddingLeft))*v.x,D=E.top+(p.clientTop+parseFloat(A.paddingTop))*v.y;a*=v.x,u*=v.y,h*=v.x,c*=v.y,a+=C,u+=D,f=ue(p),p=eo(f)}}return er({width:h,height:c,x:a,y:u})}function So(t,e){const r=wr(t).scrollLeft;return e?e.left+r:Nt(Ae(t)).left+r}function yi(t,e,r){r===void 0&&(r=!1);const o=t.getBoundingClientRect(),n=o.left+e.scrollLeft-(r?0:So(t,o)),i=o.top+e.scrollTop;return{x:n,y:i}}function wc(t){let{elements:e,rect:r,offsetParent:o,strategy:n}=t;const i=n==="fixed",s=Ae(o),l=e?br(e.floating):!1;if(o===s||l&&i)return r;let a={scrollLeft:0,scrollTop:0},u=ke(1);const h=ke(0),c=_e(o);if((c||!c&&!i)&&((dt(o)!=="body"||Mt(s))&&(a=wr(o)),_e(o))){const d=Nt(o);u=it(o),h.x=d.x+o.clientLeft,h.y=d.y+o.clientTop}const g=s&&!c&&!i?yi(s,a,!0):ke(0);return{width:r.width*u.x,height:r.height*u.y,x:r.x*u.x-a.scrollLeft*u.x+h.x+g.x,y:r.y*u.y-a.scrollTop*u.y+h.y+g.y}}function yc(t){return Array.from(t.getClientRects())}function xc(t){const e=Ae(t),r=wr(t),o=t.ownerDocument.body,n=fe(e.scrollWidth,e.clientWidth,o.scrollWidth,o.clientWidth),i=fe(e.scrollHeight,e.clientHeight,o.scrollHeight,o.clientHeight);let s=-r.scrollLeft+So(t);const l=-r.scrollTop;return we(o).direction==="rtl"&&(s+=fe(e.clientWidth,o.clientWidth)-n),{width:n,height:i,x:s,y:l}}function $c(t,e){const r=ue(t),o=Ae(t),n=r.visualViewport;let i=o.clientWidth,s=o.clientHeight,l=0,a=0;if(n){i=n.width,s=n.height;const u=_o();(!u||u&&e==="fixed")&&(l=n.offsetLeft,a=n.offsetTop)}return{width:i,height:s,x:l,y:a}}function kc(t,e){const r=Nt(t,!0,e==="fixed"),o=r.top+t.clientTop,n=r.left+t.clientLeft,i=_e(t)?it(t):ke(1),s=t.clientWidth*i.x,l=t.clientHeight*i.y,a=n*i.x,u=o*i.y;return{width:s,height:l,x:a,y:u}}function ln(t,e,r){let o;if(e==="viewport")o=$c(t,r);else if(e==="document")o=xc(Ae(t));else if(be(e))o=kc(e,r);else{const n=wi(t);o={x:e.x-n.x,y:e.y-n.y,width:e.width,height:e.height}}return er(o)}function xi(t,e){const r=Me(t);return r===e||!be(r)||lt(r)?!1:we(r).position==="fixed"||xi(r,e)}function _c(t,e){const r=e.get(t);if(r)return r;let o=Gr(t,[],!1).filter(l=>be(l)&&dt(l)!=="body"),n=null;const i=we(t).position==="fixed";let s=i?Me(t):t;for(;be(s)&&!lt(s);){const l=we(s),a=ko(s);!a&&l.position==="fixed"&&(n=null),(i?!a&&!n:!a&&l.position==="static"&&!!n&&["absolute","fixed"].includes(n.position)||Mt(s)&&!a&&xi(t,s))?o=o.filter(h=>h!==s):n=l,s=Me(s)}return e.set(t,o),o}function Sc(t){let{element:e,boundary:r,rootBoundary:o,strategy:n}=t;const s=[...r==="clippingAncestors"?br(e)?[]:_c(e,this._c):[].concat(r),o],l=s[0],a=s.reduce((u,h)=>{const c=ln(e,h,n);return u.top=fe(c.top,u.top),u.right=Qe(c.right,u.right),u.bottom=Qe(c.bottom,u.bottom),u.left=fe(c.left,u.left),u},ln(e,l,n));return{width:a.right-a.left,height:a.bottom-a.top,x:a.left,y:a.top}}function Ec(t){const{width:e,height:r}=vi(t);return{width:e,height:r}}function Cc(t,e,r){const o=_e(e),n=Ae(e),i=r==="fixed",s=Nt(t,!0,i,e);let l={scrollLeft:0,scrollTop:0};const a=ke(0);if(o||!o&&!i)if((dt(e)!=="body"||Mt(n))&&(l=wr(e)),o){const g=Nt(e,!0,i,e);a.x=g.x+e.clientLeft,a.y=g.y+e.clientTop}else n&&(a.x=So(n));const u=n&&!o&&!i?yi(n,l):ke(0),h=s.left+l.scrollLeft-a.x-u.x,c=s.top+l.scrollTop-a.y-u.y;return{x:h,y:c,width:s.width,height:s.height}}function Mr(t){return we(t).position==="static"}function cn(t,e){if(!_e(t)||we(t).position==="fixed")return null;if(e)return e(t);let r=t.offsetParent;return Ae(t)===r&&(r=r.ownerDocument.body),r}function $i(t,e){const r=ue(t);if(br(t))return r;if(!_e(t)){let n=Me(t);for(;n&&!lt(n);){if(be(n)&&!Mr(n))return n;n=Me(n)}return r}let o=cn(t,e);for(;o&&fc(o)&&Mr(o);)o=cn(o,e);return o&&lt(o)&&Mr(o)&&!ko(o)?r:o||mc(t)||r}const Ac=async function(t){const e=this.getOffsetParent||$i,r=this.getDimensions,o=await r(t.floating);return{reference:Cc(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}};function Oc(t){return we(t).direction==="rtl"}const Lc={convertOffsetParentRelativeRectToViewportRelativeRect:wc,getDocumentElement:Ae,getClippingRect:Sc,getOffsetParent:$i,getElementRects:Ac,getClientRects:yc,getDimensions:Ec,getScale:it,isElement:be,isRTL:Oc},Nc=hc,Tc=pc,Pc=cc,Bc=gc,Dc=dc,Mc=lc,Rc=(t,e,r)=>{const o=new Map,n={platform:Lc,...r},i={...n.platform,_c:o};return ac(t,e,{...n,platform:i})},tr="top-start",rr="top",or="top-end",nr="right-start",ir="right",sr="right-end",ar="bottom-start",Tt="bottom",lr="bottom-end",cr="left-start",dr="left",ur="left-end",dn=[tr,rr,or,nr,ir,sr,ar,Tt,lr,cr,dr,ur],nt={[tr]:ar,[rr]:Tt,[or]:lr,[ar]:tr,[Tt]:rr,[lr]:or,[cr]:nr,[dr]:ir,[ur]:sr,[nr]:cr,[ir]:dr,[sr]:ur},zc={[cr]:-45,[dr]:-45,[ur]:-45,[tr]:45,[rr]:45,[or]:45,[nr]:135,[ir]:135,[sr]:135,[ar]:-135,[Tt]:-135,[lr]:-135},ki=t=>{let e;return/-/.test(t)?e=t.split("-").map(r=>r.charAt(0).toUpperCase()+r.slice(1)).join(""):e=t.charAt(0).toUpperCase()+t.slice(1),e},Ic=t=>t.split("-")[0],Fc=t=>nt[Ic(t)],_i=t=>nt[t],jc=t=>zc[_i(t)],Hc=(t,e,r)=>{Object.assign(t?.style,{borderTopLeftRadius:"4px",zIndex:1,[`margin${ki(Fc(r))}`]:"-0.5px",transform:`rotate(${e}deg)`})},un=8,jt=24;async function hn(t){if(!t?.isShowing||(t?.waitForDOM&&await t?.waitForDOM(),!t?.targetEl||!t?.attentionEl))return;let e=t?.targetEl;const r=t.attentionEl;return Rc(e,r,{placement:t?.directionName??Tt,middleware:[Nc({mainAxis:t?.distance??8,crossAxis:t?.skidding??0}),t?.flip&&Pc({crossAxis:t?.crossAxis,fallbackPlacements:t?.fallbackPlacements}),t?.flip&&Tc({crossAxis:!0}),!t?.noArrow&&t?.arrowEl&&Mc({element:t?.arrowEl}),Dc(),Bc({apply(){Object.assign(r.style,{paddingRight:`${un}px`,paddingLeft:`${un}px`})}})]}).then(({x:o,y:n,middlewareData:i,placement:s})=>{if(t.actualDirection=s,t?.isCallout||Object.assign(r.style,{left:`${o}px`,top:`${n}px`}),i?.hide&&!t?.isCallout){const{referenceHidden:l}=i.hide;Object.assign(r.style,{visibility:l?"hidden":""})}if(i?.arrow&&t?.arrowEl){const l=t?.arrowEl,{x:a,y:u}=i.arrow,h=window.getComputedStyle(r).direction==="rtl",c=_i(s).split("-")[1];let g="",d="",f="",p="";if(c==="start"){const v=typeof a=="number"?`calc(${jt}px - ${l.offsetWidth/2}px)`:"";g=typeof u=="number"?`calc(${jt}px - ${l.offsetWidth/2}px)`:"",d=h?v:"",p=h?"":v}else if(c==="end"){const v=typeof a=="number"?`calc(${jt}px - ${l.offsetWidth/2}px)`:"";d=h?"":v,p=h?v:"",f=typeof u=="number"?`calc(${jt}px - ${l.offsetWidth/2}px)`:""}else p=typeof a=="number"?`${a}px`:"",g=typeof u=="number"?`${u}px`:"";Object.assign(l.style,{top:g,right:d,bottom:f,left:p}),Hc(l,jc(s),s)}}),t}var Uc={};const Jc=["en","nb","fi","da","sv"],Si="en",pn=t=>Jc.find(e=>t===e||t.toLowerCase().includes(e))||Si;function Wc(){if(typeof window>"u"){const t=Uc.NMP_LANGUAGE||Intl.DateTimeFormat().resolvedOptions().locale;return pn(t)}try{const t=document.documentElement.lang;return pn(t)}catch(t){return console.warn("could not detect locale, falling back to source locale",t),Si}}const Vc=(t,e,r,o,n,i)=>t==="nb"?r:t==="fi"?o:t==="da"?n:t==="sv"?i:e,Oe=(t,e,r,o,n)=>{const i=Wc(),s=Vc(i,t,e,r,o,n);y.load(i,s),y.activate(i)},qc=JSON.parse('{"attention.aria.callout":["En grøn taleboble der introducerer noget nyt"],"attention.aria.close":["Luk"],"attention.aria.highlight":["En opmærksomhedsskabende taleboble med vigtig information"],"attention.aria.pointingDown":["peger nedad"],"attention.aria.pointingLeft":["peger til venstre"],"attention.aria.pointingRight":["peger til højre"],"attention.aria.pointingUp":["peger opad"],"attention.aria.popover":["En hvid taleboble med mere information"],"attention.aria.tooltip":["En sort taleboble med flere oplysninger"]}'),Yc=JSON.parse('{"attention.aria.callout":["A green speech bubble introducing something new"],"attention.aria.close":["Close"],"attention.aria.highlight":["An attention speech bubble with important information"],"attention.aria.pointingDown":["pointing down"],"attention.aria.pointingLeft":["pointing left"],"attention.aria.pointingRight":["pointing right"],"attention.aria.pointingUp":["pointing up"],"attention.aria.popover":["A white speech bubble providing additional information"],"attention.aria.tooltip":["A black speech bubble providing complementary information"]}'),Qc=JSON.parse('{"attention.aria.callout":["Vihreä puhekupla, joka esittelee jotain uutta"],"attention.aria.close":["Sulje"],"attention.aria.highlight":["Puhekupla, joka sisältää tärkeää tietoa"],"attention.aria.pointingDown":["osoittaa alas"],"attention.aria.pointingLeft":["osoittaa vasemmalle"],"attention.aria.pointingRight":["osoittaa oikealle"],"attention.aria.pointingUp":["osoittaa ylös"],"attention.aria.popover":["Valkoinen puhekupla, joka tarjoaa lisätietoa"],"attention.aria.tooltip":["Musta puhekupla, joka tarjoaa täydentävää tietoa"]}'),Xc=JSON.parse('{"attention.aria.callout":["Grønn taleboble som introduserer noe nytt"],"attention.aria.close":["Lukk"],"attention.aria.highlight":["En uthevet taleboble med viktig informasjon"],"attention.aria.pointingDown":["peker ned"],"attention.aria.pointingLeft":["peker til venstre"],"attention.aria.pointingRight":["peker til høyre"],"attention.aria.pointingUp":["peker opp"],"attention.aria.popover":["En hvit taleboble som gir tilleggsinformasjon"],"attention.aria.tooltip":["En svart taleboble som forklarer konteksten"]}'),Zc=JSON.parse('{"attention.aria.callout":["En grön pratbubbla som introducerar något nytt"],"attention.aria.close":["Stäng"],"attention.aria.highlight":["En pratbubbla med viktig information"],"attention.aria.pointingDown":["pekar ned"],"attention.aria.pointingLeft":["pekar vänster"],"attention.aria.pointingRight":["pekar höger"],"attention.aria.pointingUp":["pekar upp"],"attention.aria.popover":["En vit pratbubbla som ger ytterligare information"],"attention.aria.tooltip":["En svart pratbubbla som ger kompletterande information"]}');class Kc extends Dt(j){static properties={show:{type:Boolean,reflect:!0},placement:{type:String,reflect:!0},tooltip:{type:Boolean,reflect:!0},callout:{type:Boolean,reflect:!0},popover:{type:Boolean,reflect:!0},highlight:{type:Boolean,reflect:!0},canClose:{type:Boolean,reflect:!0},noArrow:{type:Boolean,reflect:!0},distance:{type:Number,reflect:!0},skidding:{type:Number,reflect:!0},flip:{type:Boolean,reflect:!0},crossAxis:{type:Boolean,reflect:!0},fallbackPlacements:{type:Array,reflect:!0}};static styles=[j.styles,J`
      #attention {
        position: absolute;
        z-index: 50;
    ...
    `];constructor(){super(),Oe(Yc,Xc,Qc,qc,Zc),this.handleDone=this.handleDone.bind(this),this.show=!1,this.placement="bottom",this.tooltip=!1,this.callout=!1,this.popover=!1,this.highlight=!1,this.canClose=!1,this.noArrow=!1,this.distance=8,this.skidding=0,this.flip=!1,this.crossAxis=!1,this._initialPlacement=this.placement,this._actualDirection=this.placement}connectedCallback(){if(super.connectedCallback(),this.placement&&!Object.keys(nt).includes(this.placement))throw new Error(`Invalid "placement" attribute. Set its value to one of the following:
...
${JSON.stringify(dn)}`);setTimeout(()=>{this.requestUpdate(),this.handleDone()},0),this.callout||(window.addEventListener("click",this.handleDone),window.addEventListener("scroll",this.handleDone),window.addEventListener("resize",this.handleDone),window.addEventListener("touch",this.handleDone)),this.tooltip&&(window.addEventListener("mouseover",this.handleDone),window.addEventListener("mouseout",this.handleDone))}disconnectedCallback(){window.removeEventListener("click",this.handleDone),window.removeEventListener("scroll",this.handleDone),window.removeEventListener("resize",this.handleDone),window.removeEventListener("touch",this.handleDone),window.removeEventListener("mouseover",this.handleDone),window.removeEventListener("mouseout",this.handleDone),super.disconnectedCallback()}handleDone(){window.requestAnimationFrame(()=>{this.show&&this._targetEl&&this._attentionEl?hn(this.attentionState).then(e=>{this._actualDirection=e?.actualDirection}):this._actualDirection=this._initialPlacement})}get _actualDirection(){return this.placement}set _actualDirection(e){this.placement=e}get _arrowEl(){return this.renderRoot.querySelector("#arrow")}get _arrowDirection(){return nt[this._actualDirection]}get _arrowClasses(){return F([tt.arrowBase,this._activeVariantClasses.arrow,tt[`arrowDirection${ki(this._arrowDirection)}`]])}get _arrowHtml(){return this.noArrow?"":b`<div id="arrow" class="${this._arrowClasses}"></div>`}get _activeVariantClasses(){const e={callout:this.callout,popover:this.popover,tooltip:this.tooltip,highlight:this.highlight},r=Object.keys(e).find(o=>!!e[o])||"";return{wrapper:tt[r],arrow:tt[`arrow${r.charAt(0).toUpperCase()+r.slice(1)}`]}}get _attentionEl(){return this.renderRoot.querySelector("#attention")}get _targetEl(){const e=this.renderRoot?.querySelector("slot[name='target']");return e?e.assignedNodes()[0]:null}get _messageEl(){const e=this.renderRoot.querySelector("slot[name='message']");return e?e.assignedNodes()[0]:null}get _wrapperClasses(){return F([tt.base,this._activeVariantClasses.wrapper])}get _ariaClose(){return y._({id:"attention.aria.close",message:"Close",comment:"Aria label for the close button in attention"})}get _closeBtnHtml(){return b`
    ...
    `}}customElements.get("w-attention")||customElements.define("w-attention",Kc);class Gc extends j{static properties={variant:{type:"neutral"|"info"|"positive"|"warning"|"negative"|"disabled"|"price"},position:{type:"top-left"|"top-right"|"bottom-right"|"bottom-left"}};static styles=[j.styles];constructor(){super(),this.variant="neutral"}get _class(){return F([ze.base,ze[this.variant],!!this.position&&ze.positionBase,this.position==="top-left"&&ze.positionTL,this.position==="top-right"&&ze.positionTR,this.position==="bottom-right"&&ze.positionBR,this.position==="bottom-left"&&ze.positionBL])}render(){return b`
      <div class="${this._class}">
        <slot></slot>
      </div>
    `}}customElements.get("w-badge")||customElements.define("w-badge",Gc);class ed extends j{static properties={bleed:{type:Boolean},bordered:{type:Boolean},info:{type:Boolean},neutral:{type:Boolean},role:{type:String}};static styles=[j.styles,J`
      :host {
        display: block;
      }
      ::slotted(:last-child) {
...
${gn.join(", ")}.`)}firstUpdated(){this.autofocus&&setTimeout(()=>this.focus(),0)}get _primaryClasses(){return[!this.small&&!this.quiet&&!this.loading&&N.primary,this.small&&!this.quiet&&!this.loading&&N.primarySmall,this.small&&this.quiet&&!this.loading&&N.primarySmallQuiet,this.small&&this.loading&&(this.quiet?N.primarySmallQuietLoading:N.primarySmallLoading),!this.small&&this.quiet&&!this.loading&&N.primaryQuiet,!this.small&&this.loading&&(this.quiet?N.primaryQuietLoading:N.primaryLoading)]}get _secondaryClasses(){return[!this.small&&!this.quiet&&!this.loading&&N.secondary,this.small&&!this.quiet&&!this.loading&&N.secondarySmall,this.small&&this.loading&&(this.quiet?N.secondarySmallQuietLoading:N.secondarySmallLoading),this.small&&this.quiet&&!this.loading&&N.secondarySmallQuiet,!this.small&&this.quiet&&!this.loading&&N.secondaryQuiet,!this.small&&this.loading&&(this.quiet?N.secondaryQuietLoading:N.secondaryLoading)]}get _utilityClasses(){return[!this.small&&!this.quiet&&!this.loading&&N.utility,this.small&&!this.quiet&&!this.loading&&N.utilitySmall,this.small&&this.quiet&&!this.loading&&N.utilitySmallQuiet,this.small&&this.loading&&(this.quiet?N.utilitySmallQuietLoading:N.utilitySmallLoading),!this.small&&this.quiet&&!this.loading&&N.utilityQuiet,!this.small&&this.loading&&(this.quiet?N.utilityQuietLoading:N.utilityLoading)]}get _negativeClasses(){return[!this.small&&!this.quiet&&!this.loading&&N.negative,this.small&&!this.quiet&&!this.loading&&N.negativeSmall,this.small&&this.quiet&&!this.loading&&N.negativeSmallQuiet,this.small&&this.loading&&(this.quiet?N.negativeSmallQuietLoading:N.negativeSmallLoading),!this.small&&this.quiet&&!this.loading&&N.negativeQuiet,!this.small&&this.loading&&(this.quiet?N.negativeQuietLoading:N.negativeLoading)]}get _pillClasses(){return[!this.loading&&(this.small?N.pillSmall:N.pill),this.loading&&(this.small?N.pillSmallLoading:N.pillLoading)]}get _linkClasses(){return[this.small?N.linkSmall:N.link]}get _classes(){return F(this.buttonClass,[this.variant==="primary"&&this._primaryClasses,this.variant==="secondary"&&this._secondaryClasses,this.variant==="utility"&&this._utilityClasses,this.variant==="negative"&&this._negativeClasses,this.variant==="pill"&&this._pillClasses,this.variant==="link"&&this._linkClasses,this.href&&N.linkAsButton,this.fullWidth?N.fullWidth:N.contentWidth])}_handleButtonClick(){this.type==="submit"?this.internals.form.requestSubmit():this.type==="reset"&&this.internals.form.reset()}render(){return b` ${this.href?b`<a
    ...
    </div>`}}xe([x({type:Boolean,reflect:!0})],me.prototype,"expanded");xe([x({type:String})],me.prototype,"title");xe([x({type:Boolean})],me.prototype,"box");xe([x({type:Boolean})],me.prototype,"bleed");xe([x({attribute:"button-class",type:String})],me.prototype,"buttonClass");xe([x({attribute:"content-class",type:String})],me.prototype,"contentClass");xe([x({attribute:"no-chevron",type:Boolean})],me.prototype,"noChevron");xe([x({type:Boolean})],me.prototype,"animated");xe([x({attribute:"heading-level",type:Number})],me.prototype,"headingLevel");xe([x({type:Boolean,state:!0})],me.prototype,"_hasTitle");xe([x({type:Boolean,state:!0})],me.prototype,"_showChevronUp");customElements.get("w-expandable")||customElements.define("w-expandable",me);const Pi=t=>class extends t{patchClose=!0;_close=null;close(){this._close()}},Bi=t=>class extends t{handleSlotChange(e){const r=e.target.assignedNodes({flatten:!0});for(const o of r.filter(n=>n.patchClose))o._close=()=>this.close()}};class Zd extends Pi(Bi(I)){render(){return b`
      <div class="footer">
        <slot @slotchange="${this.handleSlotChange}"></slot>
      </div>
    `}static{this.styles=[ye,J`
      .footer {
        display: flex;
        flex-shrink: 0;
        justify-content: flex-end;
    ...
    `}async willUpdate(e){e.has("back")&&new ru(this.titleEl).when(async()=>{await this.updateComplete})}get titleClasses(){return["header-title",this.back?"header-title-with-back-button":"header-title-without-back-button",this._hasTopContent?"header-title-with-top-area":""].join(" ")}get backButton(){return this.back&&!this._hasTopContent?b`<button
      ...
      @click="${this.close}">
      <w-icon-close-16></w-icon-close-16>
    </button>`}emitBack(){this.dispatchEvent(new CustomEvent("backClicked",{bubbles:!0,composed:!0}))}handleTopSlotChange(e){const r=e.target.assignedElements({flatten:!0});this._hasTopContent=!!r.length}static{this.styles=[ye,J`
      .header {
        position: relative;

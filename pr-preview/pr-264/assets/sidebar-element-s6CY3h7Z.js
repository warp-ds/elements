...
`),i.join("")}Et.default=Et;var Rs=Et;const zs=ks(Rs);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`)),Be(a)&&qn.test(a)?JSON.parse(`"${a}"`):Be(a)?a:ka(a,this._locale,this._locales)(r,o?.formats)}date(e,r){return wo(this._locales||this._locale,e,r)}number(e,r){return Xr(this._locales||this._locale,e,r)}}function Na(t={}){return new La(t)}const y=Na();var Ta={},Pa=JSON.parse('{"icon.title.search":["Forstørrelsesglass"]}'),Ba=JSON.parse('{"icon.title.search":["Magnifying glass"]}'),Da=JSON.parse('{"icon.title.search":["Suurennuslasi"]}'),Ma=JSON.parse('{"icon.title.search":["Forstørrelsesglas"]}'),Ra=JSON.parse('{"icon.title.search":["Förstoringsglas"]}'),Qn=["en","nb","fi","da","sv"],Xn="en",za=()=>{var t;let e;switch((t=process==null?void 0:Ta)==null?void 0:t.NMP_BRAND){case"FINN":e="nb";break;case"TORI":e="fi";break;case"BLOCKET":e="sv";break;case"DBA":e="da";break;default:e="en"}return e},Zn=()=>{var t;const e=(t=document?.location)==null?void 0:t.hostname;return e?.includes("finn")?"nb":e.includes("tori")?"fi":e.includes("blocket")?"sv":e.includes("dba")?"da":Xn},Lr=t=>Qn.find(e=>t===e||t.toLowerCase().includes(e))||Zn();function Ia(){var t;if(typeof window>"u"){const e=za();return Lr(e)}try{const e=(t=document?.documentElement)==null?void 0:t.lang,r=Zn();return Qn.includes(e)?Lr(e??r):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),Lr(r))}catch(e){return console.warn("could not detect locale, falling back to source locale",e),Xn}}var Fa=(t,e,r,o,n,i)=>t==="nb"?r:t==="fi"?o:t==="da"?n:t==="sv"?i:e,ja=(t,e,r,o,n)=>{const i=Ia(),s=Fa(i,t,e,r,o,n);y.load(i,s),y.activate(i)};ja(Ba,Pa,Da,Ma,Ra);var Ha=class extends I{render(){const t=y.t({message:"Magnifying glass",id:"icon.title.search",comment:"Title for search icon"});return pe`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-search-16-part">${he(`<title>${t}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8.905 12.102A6.042 6.042 0 1 0 4.18.981a6.042 6.042 0 0 0 4.726 11.121Zm1.909-1.289L15.5 15.5"></path></svg>`}};customElements.get("w-icon-search-16")||customElements.define("w-icon-search-16",Ha);var Ua={},Ja=JSON.parse('{"icon.title.close":["Kryss"]}'),Wa=JSON.parse('{"icon.title.close":["Cross"]}'),Va=JSON.parse('{"icon.title.close":["Rasti"]}'),qa=JSON.parse('{"icon.title.close":["Kryds"]}'),Ya=JSON.parse('{"icon.title.close":["Kryss"]}'),Kn=["en","nb","fi","da","sv"],Gn="en",Qa=()=>{var t;let e;switch((t=process==null?void 0:Ua)==null?void 0:t.NMP_BRAND){case"FINN":e="nb";break;case"TORI":e="fi";break;case"BLOCKET":e="sv";break;case"DBA":e="da";break;default:e="en"}return e},ei=()=>{var t;const e=(t=document?.location)==null?void 0:t.hostname;return e?.includes("finn")?"nb":e.includes("tori")?"fi":e.includes("blocket")?"sv":e.includes("dba")?"da":Gn},Nr=t=>Kn.find(e=>t===e||t.toLowerCase().includes(e))||ei();function Xa(){var t;if(typeof window>"u"){const e=Qa();return Nr(e)}try{const e=(t=document?.documentElement)==null?void 0:t.lang,r=ei();return Kn.includes(e)?Nr(e??r):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),Nr(r))}catch(e){return console.warn("could not detect locale, falling back to source locale",e),Gn}}var Za=(t,e,r,o,n,i)=>t==="nb"?r:t==="fi"?o:t==="da"?n:t==="sv"?i:e,Ka=(t,e,r,o,n)=>{const i=Xa(),s=Za(i,t,e,r,o,n);y.load(i,s),y.activate(i)};Ka(Wa,Ja,Va,qa,Ya);var Ga=class extends I{render(){const t=y.t({message:"Cross",id:"icon.title.close",comment:"Title for close icon"});return pe`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-close-16-part">${he(`<title>${t}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m12.5 3.5-9 9m0-9 9 9"></path></svg>`}};customElements.get("w-icon-close-16")||customElements.define("w-icon-close-16",Ga);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const el=co(class extends uo{constructor(t){if(super(t),t.type!==lo.ATTRIBUTE||t.name!=="class"||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!this.nt?.has(o)&&this.st.add(o);return this.render(e)}const r=t.element.classList;for(const o of this.st)o in e||(r.remove(o),this.st.delete(o));for(const o in e){const n=!!e[o];n===this.st.has(o)||this.nt?.has(o)||(n?(r.add(o),this.st.add(o)):(r.remove(o),this.st.delete(o)))}return Ce}}),tl=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase();function Dt(t){return class extends t{static createProperty(e,r){let o=r;(typeof r?.attribute>"u"||r?.attribute===!0)&&(o=Object.assign({},r,{attribute:tl(e.toString())})),super.createProperty(e,o)}}}function rl(){return`m${Math.random().toString(36).slice(2)}`}class ol extends Dt(j){static properties={ariaLabel:{type:String},clear:{type:Boolean},search:{type:Boolean},label:{type:String}};static styles=[j.styles];get _classBase(){return this.slot==="suffix"?Hs:Us}get _classes(){return F([this._classBase.wrapper,this.label?this._classBase.wrapperWithLabel:this._classBase.wrapperWithIcon])}get _searchButton(){return b`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function fr(t,e){return(r,o,n)=>{const i=s=>s.renderRoot?.querySelector(t)??null;return al(r,o,{get(){return i(this)}})}}var ll={},cl=JSON.parse('{"icon.title.info":["Informasjonssirkel"]}'),dl=JSON.parse('{"icon.title.info":["Information circle"]}'),ul=JSON.parse('{"icon.title.info":["Ympyrä, jonka sisällä on i-kirjain"]}'),hl=JSON.parse('{"icon.title.info":["Informationscirkel"]}'),pl=JSON.parse('{"icon.title.info":["Informationscirkel"]}'),ti=["en","nb","fi","da","sv"],ri="en",gl=()=>{var t;let e;switch((t=process==null?void 0:ll)==null?void 0:t.NMP_BRAND){case"FINN":e="nb";break;case"TORI":e="fi";break;case"BLOCKET":e="sv";break;case"DBA":e="da";break;default:e="en"}return e},oi=()=>{var t;const e=(t=document?.location)==null?void 0:t.hostname;return e?.includes("finn")?"nb":e.includes("tori")?"fi":e.includes("blocket")?"sv":e.includes("dba")?"da":ri},Tr=t=>ti.find(e=>t===e||t.toLowerCase().includes(e))||oi();function fl(){var t;if(typeof window>"u"){const e=gl();return Tr(e)}try{const e=(t=document?.documentElement)==null?void 0:t.lang,r=oi();return ti.includes(e)?Tr(e??r):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),Tr(r))}catch(e){return console.warn("could not detect locale, falling back to source locale",e),ri}}var ml=(t,e,r,o,n,i)=>t==="nb"?r:t==="fi"?o:t==="da"?n:t==="sv"?i:e,vl=(t,e,r,o,n)=>{const i=fl(),s=ml(i,t,e,r,o,n);y.load(i,s),y.activate(i)};vl(dl,cl,ul,hl,pl);var bl=class extends I{render(){const t=y.t({message:"Information circle",id:"icon.title.info",comment:"Title for info icon"});return pe`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-info-16-part">${he(`<title>${t}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" d="M8 6.5v5"></path><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8 4v.5"></path><path stroke="currentColor" stroke-miterlimit="10" d="M8 .5a7.5 7.5 0 1 1 0 15 7.5 7.5 0 0 1 0-15Z"></path></svg>`}};customElements.get("w-icon-info-16")||customElements.define("w-icon-info-16",bl);var wl={},yl=JSON.parse('{"icon.title.warning":["Varseltrekant med utropstegn"]}'),xl=JSON.parse('{"icon.title.warning":["Warning triangle with exclamation point"]}'),$l=JSON.parse('{"icon.title.warning":["Varoituskolmio, jonka sisällä on huutomerkki"]}'),kl=JSON.parse('{"icon.title.warning":["Advarselstrekant med et udråbstegn"]}'),_l=JSON.parse('{"icon.title.warning":["Varningstriangel med utropstecken"]}'),ni=["en","nb","fi","da","sv"],ii="en",Sl=()=>{var t;let e;switch((t=process==null?void 0:wl)==null?void 0:t.NMP_BRAND){case"FINN":e="nb";break;case"TORI":e="fi";break;case"BLOCKET":e="sv";break;case"DBA":e="da";break;default:e="en"}return e},si=()=>{var t;const e=(t=document?.location)==null?void 0:t.hostname;return e?.includes("finn")?"nb":e.includes("tori")?"fi":e.includes("blocket")?"sv":e.includes("dba")?"da":ii},Pr=t=>ni.find(e=>t===e||t.toLowerCase().includes(e))||si();function El(){var t;if(typeof window>"u"){const e=Sl();return Pr(e)}try{const e=(t=document?.documentElement)==null?void 0:t.lang,r=si();return ni.includes(e)?Pr(e??r):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),Pr(r))}catch(e){return console.warn("could not detect locale, falling back to source locale",e),ii}}var Cl=(t,e,r,o,n,i)=>t==="nb"?r:t==="fi"?o:t==="da"?n:t==="sv"?i:e,Al=(t,e,r,o,n)=>{const i=El(),s=Cl(i,t,e,r,o,n);y.load(i,s),y.activate(i)};Al(xl,yl,$l,kl,_l);var Ol=class extends I{render(){const t=y.t({message:"Warning triangle with exclamation point",id:"icon.title.warning",comment:"Title for warning icon"});return pe`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-warning-16-part">${he(`<title>${t}</title>`)}<path stroke="currentColor" d="m.712 14.07 6.25-12.994a1 1 0 0 1 1.792-.022l6.635 12.995a1 1 0 0 1-.89 1.455H1.613a1 1 0 0 1-.902-1.434Z"></path><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8 6v4.992M8 13v.333"></path></svg>`}};customElements.get("w-icon-warning-16")||customElements.define("w-icon-warning-16",Ol);var Ll={},Nl=JSON.parse('{"icon.title.error":["Åttekant med utropstegn"]}'),Tl=JSON.parse('{"icon.title.error":["Octagon with exclamation point"]}'),Pl=JSON.parse('{"icon.title.error":["Kahdeksankulmio, jonka sisällä on huutomerkki"]}'),Bl=JSON.parse('{"icon.title.error":["Ottekant med et udråbstegn"]}'),Dl=JSON.parse('{"icon.title.error":["Oktagon med utropstecken"]}'),ai=["en","nb","fi","da","sv"],li="en",Ml=()=>{var t;let e;switch((t=process==null?void 0:Ll)==null?void 0:t.NMP_BRAND){case"FINN":e="nb";break;case"TORI":e="fi";break;case"BLOCKET":e="sv";break;case"DBA":e="da";break;default:e="en"}return e},ci=()=>{var t;const e=(t=document?.location)==null?void 0:t.hostname;return e?.includes("finn")?"nb":e.includes("tori")?"fi":e.includes("blocket")?"sv":e.includes("dba")?"da":li},Br=t=>ai.find(e=>t===e||t.toLowerCase().includes(e))||ci();function Rl(){var t;if(typeof window>"u"){const e=Ml();return Br(e)}try{const e=(t=document?.documentElement)==null?void 0:t.lang,r=ci();return ai.includes(e)?Br(e??r):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),Br(r))}catch(e){return console.warn("could not detect locale, falling back to source locale",e),li}}var zl=(t,e,r,o,n,i)=>t==="nb"?r:t==="fi"?o:t==="da"?n:t==="sv"?i:e,Il=(t,e,r,o,n)=>{const i=Rl(),s=zl(i,t,e,r,o,n);y.load(i,s),y.activate(i)};Il(Tl,Nl,Pl,Bl,Dl);var Fl=class extends I{render(){const t=y.t({message:"Octagon with exclamation point",id:"icon.title.error",comment:"Title for error icon"});return pe`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-error-16-part">${he(`<title>${t}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M.5 11.107 4.748 15.5h6.503l4.248-4.393V4.893L11.252.5H4.748L.5 4.893z"></path><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8 11.398a.25.25 0 1 1 0-.5m0 .5a.25.25 0 1 0 0-.5"></path><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M8 8.5V3"></path></svg>`}};customElements.get("w-icon-error-16")||customElements.define("w-icon-error-16",Fl);var jl={},Hl=JSON.parse('{"icon.title.success":["Sirkel med sjekkmerke"]}'),Ul=JSON.parse('{"icon.title.success":["Circle with checkmark"]}'),Jl=JSON.parse('{"icon.title.success":["Ympyrä, jonka sisällä on valintamerkki"]}'),Wl=JSON.parse('{"icon.title.success":["Cirkel med et flueben"]}'),Vl=JSON.parse('{"icon.title.success":["Cirkel med bock"]}'),di=["en","nb","fi","da","sv"],ui="en",ql=()=>{var t;let e;switch((t=process==null?void 0:jl)==null?void 0:t.NMP_BRAND){case"FINN":e="nb";break;case"TORI":e="fi";break;case"BLOCKET":e="sv";break;case"DBA":e="da";break;default:e="en"}return e},hi=()=>{var t;const e=(t=document?.location)==null?void 0:t.hostname;return e?.includes("finn")?"nb":e.includes("tori")?"fi":e.includes("blocket")?"sv":e.includes("dba")?"da":ui},Dr=t=>di.find(e=>t===e||t.toLowerCase().includes(e))||hi();function Yl(){var t;if(typeof window>"u"){const e=ql();return Dr(e)}try{const e=(t=document?.documentElement)==null?void 0:t.lang,r=hi();return di.includes(e)?Dr(e??r):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),Dr(r))}catch(e){return console.warn("could not detect locale, falling back to source locale",e),ui}}var Ql=(t,e,r,o,n,i)=>t==="nb"?r:t==="fi"?o:t==="da"?n:t==="sv"?i:e,Xl=(t,e,r,o,n)=>{const i=Yl(),s=Ql(i,t,e,r,o,n);y.load(i,s),y.activate(i)};Xl(Ul,Hl,Jl,Wl,Vl);var Zl=class extends I{render(){const t=y.t({message:"Circle with checkmark",id:"icon.title.success",comment:"Title for success icon"});return pe`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-success-16-part">${he(`<title>${t}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m4 8.815 1.633 2.318a.7.7 0 0 0 1.138.034l5.228-6.615"></path><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M.5 7.999a7.5 7.5 0 1 0 15 0 7.5 7.5 0 0 0-15 0"></path></svg>`}};customElements.get("w-icon-success-16")||customElements.define("w-icon-success-16",Zl);const ye=q`
  *,
  :before,
  :after {
...
${JSON.stringify(dn)}`);setTimeout(()=>{this.requestUpdate(),this.handleDone()},0),this.callout||(window.addEventListener("click",this.handleDone),window.addEventListener("scroll",this.handleDone),window.addEventListener("resize",this.handleDone),window.addEventListener("touch",this.handleDone)),this.tooltip&&(window.addEventListener("mouseover",this.handleDone),window.addEventListener("mouseout",this.handleDone))}disconnectedCallback(){window.removeEventListener("click",this.handleDone),window.removeEventListener("scroll",this.handleDone),window.removeEventListener("resize",this.handleDone),window.removeEventListener("touch",this.handleDone),window.removeEventListener("mouseover",this.handleDone),window.removeEventListener("mouseout",this.handleDone),super.disconnectedCallback()}handleDone(){window.requestAnimationFrame(()=>{this.show&&this._targetEl&&this._attentionEl?hn(this.attentionState).then(e=>{this._actualDirection=e?.actualDirection}):this._actualDirection=this._initialPlacement})}get _actualDirection(){return this.placement}set _actualDirection(e){this.placement=e}get _arrowEl(){return this.renderRoot.querySelector("#arrow")}get _arrowDirection(){return nt[this._actualDirection]}get _arrowClasses(){return F([tt.arrowBase,this._activeVariantClasses.arrow,tt[`arrowDirection${_i(this._arrowDirection)}`]])}get _arrowHtml(){return this.noArrow?"":b`<div id="arrow" class="${this._arrowClasses}"></div>`}get _activeVariantClasses(){const e={callout:this.callout,popover:this.popover,tooltip:this.tooltip,highlight:this.highlight},r=Object.keys(e).find(o=>!!e[o])||"";return{wrapper:tt[r],arrow:tt[`arrow${r.charAt(0).toUpperCase()+r.slice(1)}`]}}get _attentionEl(){return this.renderRoot.querySelector("#attention")}get _targetEl(){const e=this.renderRoot?.querySelector("slot[name='target']");return e?e.assignedNodes()[0]:null}get _messageEl(){const e=this.renderRoot.querySelector("slot[name='message']");return e?e.assignedNodes()[0]:null}get _wrapperClasses(){return F([tt.base,this._activeVariantClasses.wrapper])}get _ariaClose(){return y._({id:"attention.aria.close",message:"Close",comment:"Aria label for the close button in attention"})}get _closeBtnHtml(){return b`
    ...
    `}}customElements.get("w-badge")||customElements.define("w-badge",ed);class td extends j{static properties={bleed:{type:Boolean},bordered:{type:Boolean},info:{type:Boolean},neutral:{type:Boolean},role:{type:String}};static styles=[j.styles,q`
      :host {
        display: block;
      }
      ::slotted(:last-child) {
...
${gn.join(", ")}.`)}firstUpdated(){this.autofocus&&setTimeout(()=>this.focus(),0)}get _primaryClasses(){return[!this.small&&!this.quiet&&!this.loading&&N.primary,this.small&&!this.quiet&&!this.loading&&N.primarySmall,this.small&&this.quiet&&!this.loading&&N.primarySmallQuiet,this.small&&this.loading&&(this.quiet?N.primarySmallQuietLoading:N.primarySmallLoading),!this.small&&this.quiet&&!this.loading&&N.primaryQuiet,!this.small&&this.loading&&(this.quiet?N.primaryQuietLoading:N.primaryLoading)]}get _secondaryClasses(){return[!this.small&&!this.quiet&&!this.loading&&N.secondary,this.small&&!this.quiet&&!this.loading&&N.secondarySmall,this.small&&this.loading&&(this.quiet?N.secondarySmallQuietLoading:N.secondarySmallLoading),this.small&&this.quiet&&!this.loading&&N.secondarySmallQuiet,!this.small&&this.quiet&&!this.loading&&N.secondaryQuiet,!this.small&&this.loading&&(this.quiet?N.secondaryQuietLoading:N.secondaryLoading)]}get _utilityClasses(){return[!this.small&&!this.quiet&&!this.loading&&N.utility,this.small&&!this.quiet&&!this.loading&&N.utilitySmall,this.small&&this.quiet&&!this.loading&&N.utilitySmallQuiet,this.small&&this.loading&&(this.quiet?N.utilitySmallQuietLoading:N.utilitySmallLoading),!this.small&&this.quiet&&!this.loading&&N.utilityQuiet,!this.small&&this.loading&&(this.quiet?N.utilityQuietLoading:N.utilityLoading)]}get _negativeClasses(){return[!this.small&&!this.quiet&&!this.loading&&N.negative,this.small&&!this.quiet&&!this.loading&&N.negativeSmall,this.small&&this.quiet&&!this.loading&&N.negativeSmallQuiet,this.small&&this.loading&&(this.quiet?N.negativeSmallQuietLoading:N.negativeSmallLoading),!this.small&&this.quiet&&!this.loading&&N.negativeQuiet,!this.small&&this.loading&&(this.quiet?N.negativeQuietLoading:N.negativeLoading)]}get _pillClasses(){return[!this.loading&&(this.small?N.pillSmall:N.pill),this.loading&&(this.small?N.pillSmallLoading:N.pillLoading)]}get _linkClasses(){return[this.small?N.linkSmall:N.link]}get _classes(){return F(this.buttonClass,[this.variant==="primary"&&this._primaryClasses,this.variant==="secondary"&&this._secondaryClasses,this.variant==="utility"&&this._utilityClasses,this.variant==="negative"&&this._negativeClasses,this.variant==="pill"&&this._pillClasses,this.variant==="link"&&this._linkClasses,this.href&&N.linkAsButton,this.fullWidth?N.fullWidth:N.contentWidth])}_handleButtonClick(){this.type==="submit"?this.internals.form.requestSubmit():this.type==="reset"&&this.internals.form.reset()}render(){return b` ${this.href?b`<a
    ...
    ${this.loading?b`<span class="sr-only" role="progressbar" aria-valuenow="{0}" aria-valuetext=${this.ariaValueTextLoading}></span>`:null}`}}ge([x({reflect:!0})],ce.prototype,"type");ge([x({type:Boolean,reflect:!0})],ce.prototype,"autofocus");ge([x({reflect:!0})],ce.prototype,"variant");ge([x({type:Boolean,reflect:!0})],ce.prototype,"quiet");ge([x({type:Boolean,reflect:!0})],ce.prototype,"small");ge([x({type:Boolean,reflect:!0})],ce.prototype,"loading");ge([x({reflect:!0})],ce.prototype,"href");ge([x({reflect:!0})],ce.prototype,"target");ge([x({reflect:!0})],ce.prototype,"rel");ge([x({type:Boolean,reflect:!0})],ce.prototype,"fullWidth");ge([x({reflect:!0})],ce.prototype,"buttonClass");ge([x({reflect:!0})],ce.prototype,"name");ge([x({reflect:!0})],ce.prototype,"value");customElements.get("w-button")||customElements.define("w-button",ce);const bd=JSON.parse('{"card.button.text":["Vælg"]}'),wd=JSON.parse('{"card.button.text":["Select"]}'),yd=JSON.parse('{"card.button.text":["Valitse"]}'),xd=JSON.parse('{"card.button.text":["Velg"]}'),$d=JSON.parse('{"card.button.text":["Välj"]}'),kd=q`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.border-2{border-width:2px}.border-transparent{border-color:#0000}.rounded-4{border-radius:4px}.rounded-8{border-radius:8px}.block{display:block}.overflow-hidden{overflow:hidden}.outline{outline-style:solid}.inset-0{top:0;bottom:0;left:0;right:0}.absolute{position:absolute}.relative{position:relative}.static{position:static}.\\!s-bg-selected{background-color:var(--w-s-color-background-selected)!important}.s-bg{background-color:var(--w-s-color-background)}.s-bg-selected{background-color:var(--w-s-color-background-selected)}.\\!hover\\:s-bg-selected-hover:hover{background-color:var(--w-s-color-background-selected-hover)!important}.hover\\:s-bg-hover:hover{background-color:var(--w-s-color-background-hover)}.hover\\:s-bg-selected-hover:hover{background-color:var(--w-s-color-background-selected-hover)}.\\!active\\:s-bg-selected-active:active{background-color:var(--w-s-color-background-selected-active)!important}.active\\:s-bg-active:active{background-color:var(--w-s-color-background-active)}.active\\:s-bg-selected-active:active{background-color:var(--w-s-color-background-selected-active)}.s-border{border-color:var(--w-s-color-border)}.s-border-selected{border-color:var(--w-s-color-border-selected)}.group:hover .group-hover\\:s-border-selected-hover{border-color:var(--w-s-color-border-selected-hover)}.hover\\:s-border-hover:hover{border-color:var(--w-s-color-border-hover)}.hover\\:s-border-selected-hover:hover{border-color:var(--w-s-color-border-selected-hover)}.active\\:s-border-active:active{border-color:var(--w-s-color-border-active)}.active\\:s-border-selected-active:active{border-color:var(--w-s-color-border-selected-active)}.group:active .group-active\\:s-border-active{border-color:var(--w-s-color-border-active)}.group:active .group-active\\:s-border-selected-active{border-color:var(--w-s-color-border-selected-active)}.s-surface-elevated-200{background-color:var(--w-s-color-surface-elevated-200);box-shadow:var(--w-s-shadow-surface-elevated-200)}.hover\\:s-surface-elevated-200-hover:hover{background-color:var(--w-s-color-surface-elevated-200-hover);box-shadow:var(--w-s-shadow-surface-elevated-200-hover)}.active\\:s-surface-elevated-200-active:active{background-color:var(--w-s-color-surface-elevated-200-active);box-shadow:var(--w-s-shadow-surface-elevated-200-active)}.cursor-pointer{cursor:pointer}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}.transition-all{transition-property:all;transition-duration:.15s;transition-timing-function:cubic-bezier(.4,0,.2,1)}`;var _d=Object.defineProperty,Co=(t,e,r,o)=>{for(var n=void 0,i=t.length-1,s;i>=0;i--)(s=t[i])&&(n=s(e,r,n)||n);return n&&_d(e,r,n),n};const $e={base:"cursor-pointer overflow-hidden relative transition-all",shadow:"group rounded-8 s-surface-elevated-200 hover:s-surface-elevated-200-hover active:s-surface-elevated-200-active",selected:"!s-bg-selected !hover:s-bg-selected-hover !active:s-bg-selected-active",outline:"absolute border-2 rounded-8 inset-0 transition-all",outlineUnselected:"border-transparent group-active:s-border-active",outlineSelected:"s-border-selected group-hover:s-border-selected-hover group-active:s-border-selected-active",flat:"border-2 rounded-4",flatUnselected:"s-bg hover:s-bg-hover active:s-bg-active s-border hover:s-border-hover active:s-border-active",flatSelected:"s-bg-selected hover:s-bg-selected-hover active:s-bg-selected-active s-border-selected hover:s-border-selected-hover active:s-border-selected-active",a11y:"sr-only"},fn={ENTER:"Enter",SPACE:" "};class yr extends I{constructor(){super(),this.selected=!1,this.flat=!1,this.clickable=!1,Oe(wd,xd,yd,bd,$d),this.buttonText=y._({id:"card.button.text",message:"Select",comment:"Screenreader message to indicate that the card is clickable"})}static{this.styles=[ye,kd,q`
      a::after {
        content: '';
        position: absolute;
        top: 0;
    ...
    `}}Co([x({type:Boolean,reflect:!0})],yr.prototype,"selected");Co([x({type:Boolean})],yr.prototype,"flat");Co([x({type:Boolean})],yr.prototype,"clickable");customElements.get("w-card")||customElements.define("w-card",yr);var Sd=Object.defineProperty,xr=(t,e,r,o)=>{for(var n=void 0,i=t.length-1,s;i>=0;i--)(s=t[i])&&(n=s(e,r,n)||n);return n&&Sd(e,r,n),n};class Rt extends I{constructor(){super(...arguments),this.type="radio",this.checked=!1,this.indeterminate=!1,this.invalid=!1}get indeterminateMarker(){return this.indeterminate?"–":""}render(){const e=el({checkbox:this.type==="checkbox",radio:this.type==="radio",checked:this.checked});return b` <div class="${e}">${this.indeterminateMarker}</div> `}static{this.styles=[ye,q`
      div {
        display: block;
        border-width: 1px;
        transition-property: all;
    ...
    </div>`}}xe([x({type:Boolean,reflect:!0})],me.prototype,"expanded");xe([x({type:String})],me.prototype,"title");xe([x({type:Boolean})],me.prototype,"box");xe([x({type:Boolean})],me.prototype,"bleed");xe([x({attribute:"button-class",type:String})],me.prototype,"buttonClass");xe([x({attribute:"content-class",type:String})],me.prototype,"contentClass");xe([x({attribute:"no-chevron",type:Boolean})],me.prototype,"noChevron");xe([x({type:Boolean})],me.prototype,"animated");xe([x({attribute:"heading-level",type:Number})],me.prototype,"headingLevel");xe([x({type:Boolean,state:!0})],me.prototype,"_hasTitle");xe([x({type:Boolean,state:!0})],me.prototype,"_showChevronUp");customElements.get("w-expandable")||customElements.define("w-expandable",me);const Bi=t=>class extends t{patchClose=!0;_close=null;close(){this._close()}},Di=t=>class extends t{handleSlotChange(e){const r=e.target.assignedNodes({flatten:!0});for(const o of r.filter(n=>n.patchClose))o._close=()=>this.close()}};class Zd extends Bi(Di(I)){render(){return b`
      <div class="footer">
        <slot @slotchange="${this.handleSlotChange}"></slot>
      </div>
    `}static{this.styles=[ye,q`
      .footer {
        display: flex;
        flex-shrink: 0;
        justify-content: flex-end;
    ...
    `]}}const Kd=(t,e)=>({dx:t.left-e.left,dy:t.top-e.top,dw:t.width/e.width,dh:t.height/e.height,first:t,last:e}),Gd=({dx:t,dy:e})=>[{transform:`translate(${t}px, ${e}px)`},{transform:"none"}],eu={easing:"ease",duration:300};let Mi=!1;const tu=typeof window<"u";if(tu){const t=window.matchMedia("(prefers-reduced-motion: reduce)"),e=({matches:r})=>Mi=r;t.addEventListener&&t.addEventListener("change",e),e(t)}class ru{first;last;el;constructor(e,{animation:r={},keyframes:o,respectReduceMotion:n=!0}={}){this.el=e,this.first={},this.last={},this.userAnimationOptions=r,this.keyframeGenerator=o||Gd,this.shouldReduceMotion=n}async when(e){this.prep();const r=await e();return await this.play(),r}prep(){this.first=this.el.getBoundingClientRect()}async play(){if(this.last=this.el.getBoundingClientRect(),!this.el.animate)return;await this.el.animate(this.keyframes,this.animationOptions).finished}get keyframes(){return this.keyframeGenerator(Kd(this.first,this.last))}get defaults(){return eu}get mergedOptions(){return{...this.defaults,...this.userAnimationOptions}}get animationOptions(){return this.shouldReduceMotion?Mi?{...this.mergedOptions,duration:0}:this.mergedOptions:this.mergedOptions}}var ou={},nu=JSON.parse('{"icon.title.arrow-left":["Pil som peker mot venstre"]}'),iu=JSON.parse('{"icon.title.arrow-left":["Leftward-pointing arrow"]}'),su=JSON.parse('{"icon.title.arrow-left":["Vasemmalle osoittava nuoli"]}'),au=JSON.parse('{"icon.title.arrow-left":["Pil til venstre"]}'),lu=JSON.parse('{"icon.title.arrow-left":["Pil som pekar vänster"]}'),Ri=["en","nb","fi","da","sv"],zi="en",cu=()=>{var t;let e;switch((t=process==null?void 0:ou)==null?void 0:t.NMP_BRAND){case"FINN":e="nb";break;case"TORI":e="fi";break;case"BLOCKET":e="sv";break;case"DBA":e="da";break;default:e="en"}return e},Ii=()=>{var t;const e=(t=document?.location)==null?void 0:t.hostname;return e?.includes("finn")?"nb":e.includes("tori")?"fi":e.includes("blocket")?"sv":e.includes("dba")?"da":zi},Ir=t=>Ri.find(e=>t===e||t.toLowerCase().includes(e))||Ii();function du(){var t;if(typeof window>"u"){const e=cu();return Ir(e)}try{const e=(t=document?.documentElement)==null?void 0:t.lang,r=Ii();return Ri.includes(e)?Ir(e??r):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),Ir(r))}catch(e){return console.warn("could not detect locale, falling back to source locale",e),zi}}var uu=(t,e,r,o,n,i)=>t==="nb"?r:t==="fi"?o:t==="da"?n:t==="sv"?i:e,hu=(t,e,r,o,n)=>{const i=du(),s=uu(i,t,e,r,o,n);y.load(i,s),y.activate(i)};hu(iu,nu,su,au,lu);var pu=class extends I{render(){const t=y.t({message:"Leftward-pointing arrow",id:"icon.title.arrow-left",comment:"Title for table arrow left icon"});return pe`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-arrow-left-16-part">${he(`<title>${t}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="M5.222 8h6.667"></path><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.444 11.75 4.111 8l3.333-3.75"></path></svg>`}};customElements.get("w-icon-arrow-left-16")||customElements.define("w-icon-arrow-left-16",pu);const gu=JSON.parse('{"modal.aria.back":["Tilbage"],"modal.aria.close":["Luk"]}'),fu=JSON.parse('{"modal.aria.back":["Back"],"modal.aria.close":["Close"]}'),mu=JSON.parse('{"modal.aria.back":["Takaisin"],"modal.aria.close":["Sulje"]}'),vu=JSON.parse('{"modal.aria.back":["Tilbake"],"modal.aria.close":["Lukk"]}'),bu=JSON.parse('{"modal.aria.back":["Tillbaka"],"modal.aria.close":["Stäng"]}');var wu=Object.defineProperty,zt=(t,e,r,o)=>{for(var n=void 0,i=t.length-1,s;i>=0;i--)(s=t[i])&&(n=s(e,r,n)||n);return n&&wu(e,r,n),n};class ut extends Bi(I){constructor(){super(),this._hasTopContent=!1,Oe(fu,vu,mu,gu,bu)}render(){return b`
      <div class="header">
    ...
    `}async willUpdate(e){e.has("back")&&new ru(this.titleEl).when(async()=>{await this.updateComplete})}get titleClasses(){return["header-title",this.back?"header-title-with-back-button":"header-title-without-back-button",this._hasTopContent?"header-title-with-top-area":""].join(" ")}get backButton(){return this.back&&!this._hasTopContent?b`<button
      ...
      @click="${this.close}">
      <w-icon-close-16></w-icon-close-16>
    </button>`}emitBack(){this.dispatchEvent(new CustomEvent("backClicked",{bubbles:!0,composed:!0}))}handleTopSlotChange(e){const r=e.target.assignedElements({flatten:!0});this._hasTopContent=!!r.length}static{this.styles=[ye,q`
      .header {
        position: relative;
    ...
    `]}}zt([x({type:String})],ut.prototype,"title");zt([x({type:Boolean})],ut.prototype,"back");zt([x({type:Boolean,attribute:"no-close"})],ut.prototype,"noClose");zt([sl()],ut.prototype,"_hasTopContent");zt([fr(".title-el")],ut.prototype,"titleEl");let kt=[];const Ao={documentElement:{},body:{}},yu=Object.freeze({documentElement:{"scrollbar-gutter":"stable"},body:{overflow:"hidden",position:"relative",height:"100%"}}),Fi=t=>{t.touches.length>1||t.preventDefault?.()},xu=t=>([e,r])=>{Ao[t][e]=document[t].style[e],document[t].style[e]=r},$u=()=>Object.entries(yu).forEach(([t,e])=>{Object.entries(e).forEach(xu(t))}),ku=t=>([e,r])=>{document[t].style[e]=Ao[t][e]},_u=()=>Object.entries(Ao).forEach(([t,e])=>{Object.entries(e).forEach(ku(t))}),Su=t=>t.scrollHeight-Math.abs(t.scrollTop)===t.clientHeight;function Eu(t){let e=-1;const r=o=>{if(o.targetTouches.length!==1)return;const n=o.targetTouches[0].clientY-e;return t.scrollTop===0&&n>0||Su(t)&&n<0?Fi(o):(o.stopPropagation(),!0)};t.ontouchstart=o=>{o.targetTouches.length===1&&(e=o.targetTouches[0].clientY)},t.ontouchmove=r}function Cu(t){t.ontouchstart=null,t.ontouchmove=null}const ji=t=>()=>document[t?"addEventListener":"removeEventListener"]("touchmove",Fi,{passive:!1}),Au=ji(!0),Ou=ji();function Lu(t){if(!t)throw Error("Could not run setup, an element must be provided");kt.some(e=>e===t)||(kt.length||($u(),Au()),Eu(t),kt.push(t))}function Nu(){kt.forEach(Cu),Ou(),_u(),kt=[]}var Tu=Object.defineProperty,ht=(t,e,r,o)=>{for(var n=void 0,i=t.length-1,s;i>=0;i--)(s=t[i])&&(n=s(e,r,n)||n);return n&&Tu(e,r,n),n};class Ke extends Di(I){constructor(){super(),this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}async open(){this.dialogEl.showModal(),this.handleListeners(),Lu(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent("shown",{bubbles:!0,composed:!0}))}close(){this.handleListeners("removeEventListener"),this.dialogEl.classList.add("close"),this.dialogEl.addEventListener("animationend",async()=>{this.dialogEl.classList.remove("close"),this.dialogEl.close(),Nu(),await this.updateComplete,this.dispatchEvent(new CustomEvent("hidden",{bubbles:!0,composed:!0}))},{once:!0})}render(){return b`
    ...
    `]}}ht([x({type:Boolean})],Ke.prototype,"show");ht([x({type:String,attribute:"content-id"})],Ke.prototype,"contentId");ht([x({type:Boolean,attribute:"ignore-backdrop-clicks"})],Ke.prototype,"ignoreBackdropClicks");ht([fr(".dialog-el")],Ke.prototype,"dialogEl");ht([fr(".dialog-inner-el")],Ke.prototype,"dialogInnerEl");ht([fr(".content-el")],Ke.prototype,"contentEl");customElements.get("w-modal")||(customElements.define("w-modal",Ke),customElements.define("w-modal-header",ut),customElements.define("w-modal-footer",Zd));var Pu={},Bu=JSON.parse('{"icon.title.chevron-double-left":["Dobbel pil til venstre"]}'),Du=JSON.parse('{"icon.title.chevron-double-left":["Double leftward arrow"]}'),Mu=JSON.parse('{"icon.title.chevron-double-left":["Kaksi nuolta vasemmalle"]}'),Ru=JSON.parse('{"icon.title.chevron-double-left":["Dobbelt venstrepil"]}'),zu=JSON.parse('{"icon.title.chevron-double-left":["Dubbel vänsterpil"]}'),Hi=["en","nb","fi","da","sv"],Ui="en",Iu=()=>{var t;let e;switch((t=process==null?void 0:Pu)==null?void 0:t.NMP_BRAND){case"FINN":e="nb";break;case"TORI":e="fi";break;case"BLOCKET":e="sv";break;case"DBA":e="da";break;default:e="en"}return e},Ji=()=>{var t;const e=(t=document?.location)==null?void 0:t.hostname;return e?.includes("finn")?"nb":e.includes("tori")?"fi":e.includes("blocket")?"sv":e.includes("dba")?"da":Ui},Fr=t=>Hi.find(e=>t===e||t.toLowerCase().includes(e))||Ji();function Fu(){var t;if(typeof window>"u"){const e=Iu();return Fr(e)}try{const e=(t=document?.documentElement)==null?void 0:t.lang,r=Ji();return Hi.includes(e)?Fr(e??r):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),Fr(r))}catch(e){return console.warn("could not detect locale, falling back to source locale",e),Ui}}var ju=(t,e,r,o,n,i)=>t==="nb"?r:t==="fi"?o:t==="da"?n:t==="sv"?i:e,Hu=(t,e,r,o,n)=>{const i=Fu(),s=ju(i,t,e,r,o,n);y.load(i,s),y.activate(i)};Hu(Du,Bu,Mu,Ru,zu);var Uu=class extends I{render(){const t=y.t({message:"Double leftward arrow",id:"icon.title.chevron-double-left",comment:"Title for chevron-double-left icon"});return pe`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-chevron-double-left-16-part">${he(`<title>${t}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 13 2 8l5-5m7 10L9 8l5-5"></path></svg>`}};customElements.get("w-icon-chevron-double-left-16")||customElements.define("w-icon-chevron-double-left-16",Uu);var Ju={},Wu=JSON.parse('{"icon.title.chevron-left":["Pil til venstre"]}'),Vu=JSON.parse('{"icon.title.chevron-left":["Leftward arrow"]}'),qu=JSON.parse('{"icon.title.chevron-left":["Nuoli vasemmalle"]}'),Yu=JSON.parse('{"icon.title.chevron-left":["Pil til venstre"]}'),Qu=JSON.parse('{"icon.title.chevron-left":["Pil vänster"]}'),Wi=["en","nb","fi","da","sv"],Vi="en",Xu=()=>{var t;let e;switch((t=process==null?void 0:Ju)==null?void 0:t.NMP_BRAND){case"FINN":e="nb";break;case"TORI":e="fi";break;case"BLOCKET":e="sv";break;case"DBA":e="da";break;default:e="en"}return e},qi=()=>{var t;const e=(t=document?.location)==null?void 0:t.hostname;return e?.includes("finn")?"nb":e.includes("tori")?"fi":e.includes("blocket")?"sv":e.includes("dba")?"da":Vi},jr=t=>Wi.find(e=>t===e||t.toLowerCase().includes(e))||qi();function Zu(){var t;if(typeof window>"u"){const e=Xu();return jr(e)}try{const e=(t=document?.documentElement)==null?void 0:t.lang,r=qi();return Wi.includes(e)?jr(e??r):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),jr(r))}catch(e){return console.warn("could not detect locale, falling back to source locale",e),Vi}}var Ku=(t,e,r,o,n,i)=>t==="nb"?r:t==="fi"?o:t==="da"?n:t==="sv"?i:e,Gu=(t,e,r,o,n)=>{const i=Zu(),s=Ku(i,t,e,r,o,n);y.load(i,s),y.activate(i)};Gu(Vu,Wu,qu,Yu,Qu);var eh=class extends I{render(){const t=y.t({message:"Leftward arrow",id:"icon.title.chevron-left",comment:"Title for chevron-left icon"});return pe`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-chevron-left-16-part">${he(`<title>${t}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10.5 13.75 5 8.25l5.5-5.5"></path></svg>`}};customElements.get("w-icon-chevron-left-16")||customElements.define("w-icon-chevron-left-16",eh);var th={},rh=JSON.parse('{"icon.title.chevron-right":["Pil til høyre"]}'),oh=JSON.parse('{"icon.title.chevron-right":["Rightward arrow"]}'),nh=JSON.parse('{"icon.title.chevron-right":["Nuoli oikealle"]}'),ih=JSON.parse('{"icon.title.chevron-right":["Pil til højre"]}'),sh=JSON.parse('{"icon.title.chevron-right":["Pil höger"]}'),Yi=["en","nb","fi","da","sv"],Qi="en",ah=()=>{var t;let e;switch((t=process==null?void 0:th)==null?void 0:t.NMP_BRAND){case"FINN":e="nb";break;case"TORI":e="fi";break;case"BLOCKET":e="sv";break;case"DBA":e="da";break;default:e="en"}return e},Xi=()=>{var t;const e=(t=document?.location)==null?void 0:t.hostname;return e?.includes("finn")?"nb":e.includes("tori")?"fi":e.includes("blocket")?"sv":e.includes("dba")?"da":Qi},Hr=t=>Yi.find(e=>t===e||t.toLowerCase().includes(e))||Xi();function lh(){var t;if(typeof window>"u"){const e=ah();return Hr(e)}try{const e=(t=document?.documentElement)==null?void 0:t.lang,r=Xi();return Yi.includes(e)?Hr(e??r):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),Hr(r))}catch(e){return console.warn("could not detect locale, falling back to source locale",e),Qi}}var ch=(t,e,r,o,n,i)=>t==="nb"?r:t==="fi"?o:t==="da"?n:t==="sv"?i:e,dh=(t,e,r,o,n)=>{const i=lh(),s=ch(i,t,e,r,o,n);y.load(i,s),y.activate(i)};dh(oh,rh,nh,ih,sh);var uh=class extends I{render(){const t=y.t({message:"Rightward arrow",id:"icon.title.chevron-right",comment:"Title for chevron-right icon"});return pe`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-chevron-right-16-part">${he(`<title>${t}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m5.5 13.75 5.5-5.5-5.5-5.5"></path></svg>`}};customElements.get("w-icon-chevron-right-16")||customElements.define("w-icon-chevron-right-16",uh);const hh=JSON.parse('{"pagination.aria.first-page":["Første side"],"pagination.aria.icon-suffix":["ikon"],"pagination.aria.next-page":["Næste side"],"pagination.aria.page":["Side ",["currentPage"]],"pagination.aria.pagination":["Sider"],"pagination.aria.prev-page":["Forrige side"]}'),ph=JSON.parse('{"pagination.aria.first-page":["First page"],"pagination.aria.icon-suffix":["icon"],"pagination.aria.next-page":["Next page"],"pagination.aria.page":["Page ",["currentPage"]],"pagination.aria.pagination":["Pages"],"pagination.aria.prev-page":["Previous page"]}'),gh=JSON.parse('{"pagination.aria.first-page":["Ensimmäinen sivu"],"pagination.aria.icon-suffix":["kuvake"],"pagination.aria.next-page":["Seuraava sivu"],"pagination.aria.page":["Sivu ",["currentPage"]],"pagination.aria.pagination":["Sivut"],"pagination.aria.prev-page":["Edellinen sivu"]}'),fh=JSON.parse('{"pagination.aria.first-page":["Første side"],"pagination.aria.icon-suffix":["ikon"],"pagination.aria.next-page":["Neste side"],"pagination.aria.page":["Side ",["currentPage"]],"pagination.aria.pagination":["Sider"],"pagination.aria.prev-page":["Forrige side"]}'),mh=JSON.parse('{"pagination.aria.first-page":["Första sidan"],"pagination.aria.icon-suffix":["ikon"],"pagination.aria.next-page":["Nästa sida"],"pagination.aria.page":["Sida ",["currentPage"]],"pagination.aria.pagination":["Sidor"],"pagination.aria.prev-page":["Föregående sida"]}');var vh=Object.defineProperty,$r=(t,e,r,o)=>{for(var n=void 0,i=t.length-1,s;i>=0;i--)(s=t[i])&&(n=s(e,r,n)||n);return n&&vh(e,r,n),n};const Ur=y._({id:"pagination.aria.icon-suffix",message:"icon",comment:"Suffix added at the end of icon titles when img semantics are lost on an html element"}),Ht="hover:no-underline focus:no-underline focusable inline-flex justify-center items-center transition-colors ease-in-out min-h-[44px] min-w-[44px] p-4 rounded-full border-0 hover:bg-clip-padding";class It extends I{constructor(){super(),this.currentPageNumber=1,this.visiblePages=7,Oe(ph,fh,gh,hh,mh)}static{this.styles=[ye,pi]}get shouldShowShowFirstPageButton(){return this.currentPageNumber-2>0}get shouldShowPreviousPageButton(){return this.currentPageNumber-1>0}get shouldShowNextPageButton(){return this.currentPageNumber<this.pages}get currentPageIndex(){return this.currentPageNumber-1}get visiblePageNumbers(){if(this.pages<=this.visiblePages)return Array.from({length:this.pages},(n,i)=>i+1);const e=Math.floor(this.visiblePages/2);let r=Math.max(1,this.currentPageNumber-e);const o=Math.min(this.pages,r+this.visiblePages-1);return o-r+1<this.visiblePages&&(r=Math.max(1,o-this.visiblePages+1)),Array.from({length:o-r+1},(n,i)=>r+i)}render(){const e=this.visiblePageNumbers;return b`<nav class="flex items-center justify-center p-8">
      <h1 class="sr-only">
 ...
 */const vn=(t,e,r)=>{const o=new Map;for(let n=e;n<=r;n++)o.set(t[n],n);return o},Fh=co(class extends uo{constructor(t){if(super(t),t.type!==lo.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,r){let o;r===void 0?r=e:e!==void 0&&(o=e);const n=[],i=[];let s=0;for(const l of t)n[s]=o?o(l,s):s,i[s]=r(l,s),s++;return{values:i,keys:n}}render(t,e,r){return this.dt(t,e,r).values}update(t,[e,r,o]){const n=Ih(t),{values:i,keys:s}=this.dt(e,r,o);if(!Array.isArray(n))return this.ut=s,i;const l=this.ut??=[],a=[];let u,h,c=0,g=n.length-1,d=0,f=i.length-1;for(;c<=g&&d<=f;)if(n[c]===null)c++;else if(n[g]===null)g--;else if(l[c]===s[d])a[d]=je(n[c],i[d]),c++,d++;else if(l[g]===s[f])a[f]=je(n[g],i[f]),g--,f--;else if(l[c]===s[f])a[f]=je(n[c],i[f]),wt(t,a[f+1],n[c]),c++,f--;else if(l[g]===s[d])a[d]=je(n[g],i[d]),wt(t,n[c],n[g]),g--,d++;else if(u===void 0&&(u=vn(s,d,f),h=vn(l,c,g)),u.has(l[c]))if(u.has(l[g])){const p=h.get(s[d]),v=p!==void 0?n[p]:null;if(v===null){const E=wt(t,n[c]);je(E,i[d]),a[d]=E}else a[d]=je(v,i[d]),wt(t,n[c],v),n[p]=null;d++}else Wr(n[g]),g--;else Wr(n[c]),c++;for(;d<=f;){const p=wt(t,a[f+1]);je(p,i[d]),a[d++]=p}for(;c<=g;){const p=n[c++];p!==null&&Wr(p)}return this.ut=s,zh(t,a),Ce}});class Zi extends j{static styles=[j.styles,q`
    ...
    `];static properties={_toasts:{state:!0}};constructor(){super(),this._toasts=new Map}connectedCallback(){super.connectedCallback(),this._interval=setInterval(()=>{const e=[],r=[];for(const n of this._toasts)Date.now()<=n[1].duration?e.push(n):r.push(n);const o=[];for(const[n]of r){const i=this.renderRoot.querySelector(`#${n}`);o.push(i.collapse())}Promise.all(o).then(()=>{e.length!==this._toasts.size&&(this._toasts=new Map(e))})},500)}disconnectedCallback(){super.disconnectedCallback(),this._interval&&clearTimeout(this._interval)}static init(){let e=document.querySelector("w-toast-container");return e||(e=document.createElement("w-toast-container"),document.body.appendChild(e)),e}get _toastsArray(){return Array.from(this._toasts).map(([,e])=>e)}get(e){if(!e)throw new Error('undefined "id" given when attempting to retrieve toast');if(typeof e!="string"&&!Number.isInteger(e))throw new Error('"id" must be number or string when attempting to retrieve toast');return this._toasts.get(e)}set(e){if(!e.id)throw new Error('invalid or undefined "id" on toast object');const r=this._toasts.set(e.id,{...e,duration:Date.now()+(e.duration||5e3)});return this._toasts=new Map(Array.from(this._toasts)),r}async del(e){if(!e)throw new Error('undefined "id" given when attempting to retrieve toast');if(typeof e!="string"&&!Number.isInteger(e))throw new Error('"id" must be number or string when attempting to retrieve toast');const r=this.renderRoot.querySelector(`#${e}`);if(!this._toasts.has(e))return!1;await r.collapse();const o=this._toasts.delete(e);return this._toasts=new Map(Array.from(this._toasts)),o}render(){return b`
      <aside class="${Er.wrapper}">
        <div class="${Er.base}" id="w-toast-container-list">
          ${Fh(this._toastsArray,e=>e.id,e=>b` <w-toast
                class="${Er.content}"
                id="${e.id}"
                type="${e.type}"
                text="${e.text}"
    ...
    </section>`:b``}}customElements.get("w-toast")||customElements.define("w-toast",Yh);class Qh extends j{static properties={show:{type:Boolean,reflect:!0},_removeElement:{type:Boolean,state:!0}};constructor(){super(),this.show=!1,this._mounted=!1,this._removeElement=!1}willUpdate(){this._mounted||(this._removeElement=!this.show),this.show&&this._removeElement&&(this._removeElement=!1)}updated(){if(this._wrapper){if(!this._mounted){this._mounted=!0;return}this.show&&ts(this._wrapper),!this.show&&!this._removeElement&&rs(this._wrapper,()=>this._removeElement=!0)}}get _wrapper(){return this??null}static styles=[j.styles,q`
      :host {
        display: block;
      }
    `];render(){return b`<div aria-hidden=${V(this.show?void 0:"true")}>${this._removeElement?b``:b`<slot></slot>`}</div>`}}customElements.get("w-expand-transition")||customElements.define("w-expand-transition",Qh);class Xh extends j{static properties={level:{type:Number}};static styles=[j.styles];get _markup(){return`<h${this.level}
    style="margin: 0; font-weight: unset; font-size: unset; line-height: unset;"
  >
    <slot></slot>
  </h${this.level}>
`}render(){return this.level?ho(this._markup):b`<slot></slot>`}}customElements.get("w-unstyled-heading")||customElements.define("w-unstyled-heading",Xh);var Zh={},Kh=JSON.parse('{"icon.title.bag":["Veske"]}'),Gh=JSON.parse('{"icon.title.bag":["Handbag"]}'),ep=JSON.parse('{"icon.title.bag":["Käsilaukku"]}'),tp=JSON.parse('{"icon.title.bag":["Håndtaske"]}'),rp=JSON.parse('{"icon.title.bag":["Handväska"]}'),os=["en","nb","fi","da","sv"],ns="en",op=()=>{var t;let e;switch((t=process==null?void 0:Zh)==null?void 0:t.NMP_BRAND){case"FINN":e="nb";break;case"TORI":e="fi";break;case"BLOCKET":e="sv";break;case"DBA":e="da";break;default:e="en"}return e},is=()=>{var t;const e=(t=document?.location)==null?void 0:t.hostname;return e?.includes("finn")?"nb":e.includes("tori")?"fi":e.includes("blocket")?"sv":e.includes("dba")?"da":ns},Vr=t=>os.find(e=>t===e||t.toLowerCase().includes(e))||is();function np(){var t;if(typeof window>"u"){const e=op();return Vr(e)}try{const e=(t=document?.documentElement)==null?void 0:t.lang,r=is();return os.includes(e)?Vr(e??r):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),Vr(r))}catch(e){return console.warn("could not detect locale, falling back to source locale",e),ns}}var ip=(t,e,r,o,n,i)=>t==="nb"?r:t==="fi"?o:t==="da"?n:t==="sv"?i:e,sp=(t,e,r,o,n)=>{const i=np(),s=ip(i,t,e,r,o,n);y.load(i,s),y.activate(i)};sp(Gh,Kh,ep,tp,rp);var ap=class extends I{render(){const t=y.t({message:"Handbag",id:"icon.title.bag",comment:"Title for bag icon"});return pe`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-bag-16-part">${he(`<title>${t}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M14.043 8.433a1.76 1.76 0 0 0-.647-1.029A1.93 1.93 0 0 0 12.211 7H3.788c-.432 0-.851.143-1.185.404a1.76 1.76 0 0 0-.647 1.03l-.921 4.444a1.7 1.7 0 0 0 .39 1.473c.174.203.394.366.644.479.249.112.521.17.797.17h10.267c.276 0 .548-.058.797-.17.25-.113.47-.276.645-.479s.3-.44.368-.695a1.7 1.7 0 0 0 .021-.778z"></path><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11 15V3.5c0-.663-.317-1.299-.88-1.768C9.559 1.263 8.796 1 8 1s-1.56.263-2.122.732C5.316 2.202 5 2.837 5 3.5V15"></path></svg>`}};customElements.get("w-icon-bag-16")||customElements.define("w-icon-bag-16",ap);kr&&(window.WarpToastContainer=Zi,window.toast=Ph,window.updateToast=Dh,window.removeToast=Bh);const lp={heading:{title:"Warp Elements",href:"/elements/"},pages:[{title:"Action",items:[{title:"Button",href:"/elements/button.html"},{title:"Pill",href:"/elements/pill.html"}]},{title:"Feedback Indicators",items:[{title:"Alert",href:"/elements/alert.html"}]},{title:"Forms",items:[{title:"Dead toggle",href:"/elements/deadtoggle.html"},{title:"Select",href:"/elements/select.html"},{title:"Textfield",href:"/elements/textfield.html"}]},{title:"Layout",items:[{title:"Badge",href:"/elements/badge.html"},{title:"Box",href:"/elements/box.html"},{title:"Card",href:"/elements/card.html"},{title:"Expandable",href:"/elements/expandable.html"},{title:"Toast",href:"/elements/toast.html"}]},{title:"Navigation",items:[{title:"Breadcrumbs",href:"/elements/breadcrumbs.html"},{title:"Pagination",href:"/elements/pagination.html"}]},{title:"Overlays",items:[{title:"Attention",href:"/elements/attention.html"},{title:"Modal",href:"/elements/modal.html"}]}]};class cp extends j{static styles=[j.styles,q`
      .sidebar {
        width: 300px;
      }
    ...
    `];render(){const{heading:e,pages:r}=lp;return b`
    ...
    `}renderItems(e){return e.map(r=>b`
      ...
      `)}}customElements.define("sidebar-element",cp);

import{g as i,x as o}from"./iframe-Cy-UY58g.js";import{s as n,p}from"./utilities-B31i9vTx.js";const{events:d,args:m,argTypes:g}=i("w-card"),f={title:"Navigation/Card",render(c){return o`
      <w-card ${n(p(c))}>

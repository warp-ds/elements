...
`,ur=te`*, :before, :after {
        ...
        `;var Sl=Object.defineProperty,no=(t,e,r,o)=>{for(var i=void 0,n=t.length-1,s;n>=0;n--)(s=t[n])&&(i=s(e,r,i)||i);return i&&Sl(e,r,i),i};const mt={negative:"negative",positive:"positive",warning:"warning",info:"info"};class hr extends V{constructor(){super(),this.variant="info",this.show=!0,this.role="alert",this.show=!1,this.role="alert"}connectedCallback(){if(super.connectedCallback(),!this.variant||!mt[this.variant])throw new Error(`Invalid 'variant' attribute. Set its value to one of the following:
negative, positive, warning, info.`)}get _wrapperClasses(){return I([gt.wrapper,gt[this.variant]])}get _iconClasses(){const e=gt[`${this.variant}Icon`];return I([gt.icon,e])}static{this.styles=[dr,ur,te`
      :host {
        display: block;
      }

import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{C as n,f as r,p as i,r as a,s as o,t as s,y as c}from"./decorate-D-MUTuIl.js";import{n as l,r as u}from"./i18n-CkjYRTT1.js";import{i as d,n as f,o as p,t as m}from"./dist-CXTYkVAl.js";import{t as h}from"./icon-DmyEA4mQ.js";import{n as g,t as _}from"./styles-Dxzaq_l3.js";import{i as v,n as y,r as b}from"./utilities-C5YHrCuy.js";import{r as x,t as S}from"./if-defined-CDQgRpqn.js";import{t as C}from"./expand-transition-SneieoSM.js";import{t as w}from"./button-CCI-dxFp.js";import{t as T}from"./taggedTemplateLiteral-BZenJ0bZ.js";var E;function D(){return(D=e((()=>{r(),d(),E=class extends i{static properties={level:{type:Number}};get _markup(){return`<h${this.level}
    style="margin: 0; font-weight: unset; font-size: unset; line-height: unset;"
  >
    <slot></slot>
  </h${this.level}>
`}render(){return this.level?p(this._markup):c`<slot></slot>`}},customElements.get(`w-unstyled-heading`)||customElements.define(`w-unstyled-heading`,E)})))()}var O;function k(){return(k=e((()=>{r(),O=n`
	:host {
		display: block;
...
`})))()}var A;function j(){return(j=e((()=>{r(),a(),S(),h(),C(),u(),D(),_(),k(),A=class extends i{constructor(...e){super(...e),this.expanded=!1,this.box=!1,this.bleed=!1,this.noChevron=!1,this.animated=!1,this._hasTitle=!0,this._showChevronUp=!1}static{this.styles=[g,O]}updated(e){e.has(`expanded`)&&setTimeout(()=>{this._showChevronUp=this.expanded},200)}firstUpdated(){let e=!!this.title,t=this.renderRoot.querySelector(`slot[name='title']`)?.assignedNodes().length>0;this._hasTitle=e||t}get#e(){let e=l();return this._showChevronUp?c`<w-icon
				...
				></w-icon>`:c`<w-icon
					...
					size="small"
					locale="${e}"
				></w-icon>`}get _expandableSlot(){let e=this.contentClass?`content ${this.contentClass}`:`content`;return c`<div
			class=${e}
			data-has-title=${x(this._hasTitle?``:void 0)}
		>
			<slot></slot>
		</div>`}render(){let e=this.buttonClass?`button ${this.buttonClass}`:`button`;return c` <div part="base">
			${this._hasTitle?c`<w-unstyled-heading level=${x(this.headingLevel)}>
							<button
								class=${e}
								type="button"
        ...
        `}},G={args:{expanded:!0,box:!0,animated:!0},render(e){return c(N||=T([`
            <w-button
            ...
            <\/script>
        `]),v(y(e)))}},K={args:{title:`Styled expandable`,box:!0,expanded:!1},render(e){return c`
            <pre>
<code>
&lt;style&gt;
w-expandable {

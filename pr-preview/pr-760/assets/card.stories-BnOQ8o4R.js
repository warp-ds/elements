import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{C as n,f as r,h as i,p as a,r as o,s,t as c,y as l}from"./decorate-D-MUTuIl.js";import{a as u,o as d,r as f,t as p}from"./i18n-CkjYRTT1.js";import{n as m,t as h}from"./dist-CXTYkVAl.js";import{n as g,t as _}from"./styles-Dxzaq_l3.js";import{i as v,n as y,r as b}from"./utilities-C5YHrCuy.js";import{r as x,t as S}from"./if-defined-CDQgRpqn.js";var C;function w(){return(w=e((()=>{C=JSON.parse(`{"card.button.text":["Vælg"]}`)})))()}var T;function E(){return(E=e((()=>{T=JSON.parse(`{"card.button.text":["Select"]}`)})))()}var D;function O(){return(O=e((()=>{D=JSON.parse(`{"card.button.text":["Valitse"]}`)})))()}var k;function A(){return(A=e((()=>{k=JSON.parse(`{"card.button.text":["Velg"]}`)})))()}var j;function M(){return(M=e((()=>{j=JSON.parse(`{"card.button.text":["Välj"]}`)})))()}var N;function P(){return(P=e((()=>{r(),N=n`
	:host {
...
`})))()}var F,I;function L(){return(L=e((()=>{d(),r(),o(),S(),f(),_(),w(),E(),O(),A(),M(),P(),F={ENTER:`Enter`,SPACE:` `},I=class extends a{static{this.styles=[g,N,n`
			a::after {
				content: "";
				position: absolute;
				top: 0;
		...
		`]}constructor(){super(),this.selected=!1,this.flat=!1,this.clickable=!1,p(T,k,D,C,j),this.buttonText=u._({id:`card.button.text`,message:`Select`,comment:`Screenreader message to indicate that the card is clickable`})}keypressed(e){!this.clickable||e.altKey||e.ctrlKey||(e.key===F.ENTER||e.key===F.SPACE)&&(e.preventDefault(),this.click())}render(){return l`
			...
			>
				<div part="border"></div>
				${this.clickable?l`<button
								class="sr-only"
								aria-pressed="${this.selected}"
								tabindex="-1"
							>
								${this.buttonText}
							</button>`:this.selected?l`<span
									class="sr-only"
									role="checkbox"
									aria-checked="true"
									aria-disabled="true"
		...
		`}},c([s({type:Boolean,reflect:!0})],I.prototype,`selected`,void 0),c([s({type:Boolean})],I.prototype,`flat`,void 0),c([s({type:Boolean})],I.prototype,`clickable`,void 0),customElements.get(`w-card`)||customElements.define(`w-card`,I)})))()}var R=t({Clickable:()=>q,Default:()=>U,Flat:()=>G,FlatSelected:()=>K,PropertyExample:()=>J,Selected:()=>W,StylingApi:()=>Y,__namedExportsOrder:()=>X,default:()=>H}),z,B,V,H,U,W,G,K,q,J,Y,X;function Z(){return(Z=e((()=>{b(),m(),r(),L(),{events:z,args:B,argTypes:V}=h(`w-card`),H={title:`Navigation/Card`,render(e){return l`
            <w-card ${v(y(e))}>
        ...
        `},args:B,argTypes:V,parameters:{actions:{handles:z}}},U={args:{selected:!1,flat:!1,clickable:!1}},W={args:{selected:!0,flat:!1,clickable:!1}},G={args:{selected:!1,flat:!0,clickable:!1}},K={args:{selected:!0,flat:!0,clickable:!1}},q={args:{selected:!1,flat:!1,clickable:!0}},J={args:{selected:!1,flat:!1,clickable:!0},render(e){return l`
            <w-card ${v(y(e))}>
                <img
        ...
        `}},Y={args:{clickable:!1,selected:!1,flat:!1},render(e){return l`
            <pre>
<code>
&lt;style&gt;
w-card::part(base) {

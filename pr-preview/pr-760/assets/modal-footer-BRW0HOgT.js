import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{C as t,a as n,f as r,h as i,p as a,r as o,s,t as c,y as l}from"./decorate-D-MUTuIl.js";import{a as u,n as d,o as ee,r as te,t as ne}from"./i18n-CkjYRTT1.js";import{t as f}from"./query-BHY-nhsh.js";import{t as re}from"./icon-DmyEA4mQ.js";import{n as p,t as m}from"./styles-Dxzaq_l3.js";import{r as ie,t as ae}from"./if-defined-CDQgRpqn.js";function oe(e){let t=-1;e.ontouchstart=e=>{e.targetTouches.length===1&&(t=e.targetTouches[0].clientY)},e.ontouchmove=n=>{if(n.targetTouches.length!==1)return;let r=n.targetTouches[0].clientY-t;return e.scrollTop===0&&r>0||C(e)&&r<0?v(n):(n.stopPropagation(),!0)}}function se(e){e.ontouchstart=null,e.ontouchmove=null}function ce(e){if(!e)throw Error(`Could not run setup, an element must be provided`);h.some(t=>t===e)||(h.length||(b(),T()),oe(e),h.push(e))}function le(){h.forEach(se),E(),S(),h=[]}var h,g,_,v,y,b,x,S,C,w,T,E;function D(){return(D=e((()=>{h=[],g={documentElement:{},body:{}},_=Object.freeze({documentElement:{"scrollbar-gutter":`stable`},body:{overflow:`hidden`,position:`relative`,height:`100%`}}),v=e=>{e.touches.length>1||e.preventDefault?.()},y=e=>([t,n])=>{g[e][t]=document[e].style[t],document[e].style[t]=n},b=()=>Object.entries(_).forEach(([e,t])=>{Object.entries(t).forEach(y(e))}),x=e=>([t,n])=>{document[e].style[t]=g[e][t]},S=()=>Object.entries(g).forEach(([e,t])=>{Object.entries(t).forEach(x(e))}),C=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight,w=e=>()=>document[e?`addEventListener`:`removeEventListener`](`touchmove`,v,{passive:!1}),T=w(!0),E=w()})))()}var O;function k(){return(k=e((()=>{r(),O=t`
	:host {
		--_backdrop-bg: var(
...
`})))()}var Q;function pe(){return(pe=e((()=>{V(),ee(),r(),o(),re(),te(),U(),G(),q(),Y(),Z(),M(),m(),fe(),Q=class extends A(a){static{this.styles=[p,de]}constructor(){super(),this.back=!1,this.noClose=!1,this._hasTopContent=!1,ne(W,J,K,H,X)}async willUpdate(e){if(e.has(`back`)){if(!this.titleEl)return;new B(this.titleEl).when(async()=>{await this.updateComplete})}}emitBack(){this.dispatchEvent(new CustomEvent(`backClicked`,{bubbles:!0,composed:!0}))}handleTopSlotChange(e){let t=e.target.assignedElements({flatten:!0});this._hasTopContent=!!t.length}render(){let e=this.back&&!this._hasTopContent,t=!this.noClose;return l`
			<div
				part="header"
		...
		`}},c([s({type:String})],Q.prototype,`title`,void 0),c([s({type:Boolean})],Q.prototype,`back`,void 0),c([s({type:Boolean,attribute:`no-close`})],Q.prototype,`noClose`,void 0),c([n()],Q.prototype,`_hasTopContent`,void 0),c([f(`[part="title"]`)],Q.prototype,`titleEl`,void 0),customElements.get(`w-modal-header`)||customElements.define(`w-modal-header`,Q)})))()}var me;function he(){return(he=e((()=>{r(),me=t`
	:host {
...
`})))()}var ge;function $(){return($=e((()=>{r(),M(),m(),he(),ge=class extends A(j(a)){static{this.styles=[p,me]}render(){return l`

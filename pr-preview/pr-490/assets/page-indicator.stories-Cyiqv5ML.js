import{a as v,i as h,b as r,n as m}from"./iframe-NsCd0iv1.js";import{e as b}from"./class-map-DKtq3BAv.js";import"./preload-helper-Ct5FWWRu.js";/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*f(t,e){if(t!==void 0){let i=0;for(const o of t)yield e(o,i++)}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*w(t,e,i=1){const o=e===void 0?0:t;e??=t;for(let a=o;i>0?a<e:e<a;a+=i)yield a}const x=v`
  .w-page-indicator {
    display: grid;
...
`;var C=Object.defineProperty,y=(t,e,i,o)=>{for(var a=void 0,p=t.length-1,u;p>=0;p--)(u=t[p])&&(a=u(e,i,a)||a);return a&&C(e,i,a),a};class l extends h{constructor(){super(...arguments),this.selectedPage=1,this.pageCount=1}static{this.styles=[x]}render(){return r`
      <div class="w-page-indicator">
        <div class="w-page-indicator--container">
          ${f(w(this.pageCount),e=>{const o={"w-page-indicator--dot":!0,"w-page-indicator--selecteddot":e===this.selectedPage-1};return r`<div class="${b(o)}"></div>`})}
        </div>
      </div>
    `}}y([m({type:Number,attribute:"selected-page"})],l.prototype,"selectedPage");y([m({type:Number,attribute:"page-count"})],l.prototype,"pageCount");customElements.get("w-page-indicator")||customElements.define("w-page-indicator",l);const _={component:"w-page-indicator",title:"Navigation/PageIndicator",render:({pageCount:t,selectedPage:e})=>r`

import{g as w,b as e}from"./iframe-NsCd0iv1.js";import{s as c,p as v}from"./utilities-Ctq498rP.js";import"./attention-DhBw4wBg.js";import"./button-IADQg7_f.js";var p=Object.freeze,y=Object.defineProperty,l=(t,g)=>p(y(t,"raw",{value:p(t.slice())})),d,u,m,b;const{events:E,args:I,argTypes:f}=w("w-attention"),T={title:"Overlays/Attention",render(t){return e`
      <w-attention ${c(v(t))}>
        <w-button
          ${c({id:t.buttonId})}
          variant="secondary"

import{a as F,i as $,r as N,E as h,x as n,n as o,k as d,g as A}from"./iframe-CzXQY2bL.js";import"./index-cLzNsoeX.js";import"./index-BCSJvUk9.js";import"./index-HnMRABPE.js";import{F as j}from"./FormControlMixin-DJnJZbro.js";import{_ as B}from"./preload-helper-Ct5FWWRu.js";import{e as L}from"./query-NYTjQBeo.js";import{o as E}from"./if-defined-Ds_JB8jX.js";const H=F`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`;var U=Object.defineProperty,m=(s,e,r,l)=>{for(var t=void 0,c=s.length-1,p;c>=0;c--)(p=s[c])&&(t=p(e,r,t)||t);return t&&U(e,r,t),t};class u extends j($){constructor(){super(...arguments),this.disabled=!1,this.allowValuesOutsideRange=!1,this.helpText="",this.invalid=!1,this.required=!1}static{this.shadowRootOptions={...$.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[N,H]}#e(){const e=this.querySelectorAll("w-slider-thumb");let r=!1;for(const t of e.values())t.min=this.min,t.max=this.max,t.step=this.step,t.suffix=this.suffix,t.required=this.required,t.formatter=this.formatter,t.allowValuesOutsideRange=this.allowValuesOutsideRange,t.ariaLabel||(t.slot||(t.ariaLabel=this.label),t.slot==="from"&&(t.ariaLabel=`${this.label} min`),t.slot==="to"&&(t.ariaLabel=`${this.label} max`)),(t.slot==="from"||t.slot==="to")&&(r=!0),t.forceDisabled=this.disabled,t.forceInvalid=this.invalid,this.#r(t);const l=this.shadowRoot.querySelector("fieldset");r?(l.style.setProperty("--active-range-inline-start-padding","var(--w-slider-thumb-size)"),l.style.setProperty("--active-range-inline-end-padding","var(--w-slider-thumb-size)")):l.style.setProperty("--active-range-border-radius","4px")}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.step&&this.style.setProperty("--step",String(this.step)),this.style.setProperty("--min",this.min),this.style.setProperty("--max",this.max),this.markers&&this.style.setProperty("--markers",String(this.markers)),this.#e()}updated(e){(e.has("disabled")||e.has("invalid")||e.has("required")||e.has("min")||e.has("step")||e.has("max")||e.has("suffix")||e.has("formatter"))&&this.#e()}#t(e){const r=e.target;this.#r(r)}#a(e){e.stopPropagation(),this.invalid=e.detail.invalid}#r(e){const r=e.slot,l=t=>((e.value===void 0||e.value===null)&&(e.value=this.allowValuesOutsideRange?"":t),e.value===""?t:e.value);r||this.style.setProperty("--from","0"),r==="from"&&this.style.setProperty("--from",l(this.min)),(!r||r==="to")&&this.style.setProperty("--to",l(this.max))}render(){return n`
      <fieldset
        id="fieldset"
        class="w-slider"
        @input="${this.#t}"
        ...
        aria-describedby="${this.invalid?"error-slot":h}"
      >
        ...
        ${this.markers?n`<div class="w-slider__markers"></div>`:h}
    ...
    `}}m([o({reflect:!0})],u.prototype,"label");m([o({type:Boolean,reflect:!0})],u.prototype,"disabled");m([o({type:Boolean,attribute:"allow-values-outside-range"})],u.prototype,"allowValuesOutsideRange");m([o({reflect:!0})],u.prototype,"helpText");m([o({type:Boolean,reflect:!0})],u.prototype,"invalid");m([o({type:Boolean,reflect:!0})],u.prototype,"required");m([o({reflect:!0})],u.prototype,"min");m([o({reflect:!0})],u.prototype,"max");m([o({type:Number,reflect:!0})],u.prototype,"markers");m([o({type:Number,reflect:!0})],u.prototype,"step");m([o({reflect:!0})],u.prototype,"suffix");m([o({attribute:!1})],u.prototype,"formatter");customElements.get("w-slider")||customElements.define("w-slider",u);const W=F`
  .w-slider-thumb {
    position: relative;
    display: grid;
...
`,X=F`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var K=Object.defineProperty,i=(s,e,r,l)=>{for(var t=void 0,c=s.length-1,p;c>=0;c--)(p=s[c])&&(t=p(e,r,t)||t);return t&&K(e,r,t),t};class a extends j($){constructor(){super(...arguments),this.allowValuesOutsideRange=!1,this._invalid=!1,this._showTooltip=!1,this._inputHasFocus=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...$.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[N,X,W]}#e(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#t(){this._showTooltip=!1}#a(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#r(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const l=e.currentTarget.value,t=Number.parseInt(l),c=Number.parseInt(this.max),p=Number.parseInt(this.min);if(!this.allowValuesOutsideRange&&(t>c||t<p))return this._invalid=!0,!1;if(l==="")return this.required&&(this._invalid=!0),!1;this._invalid&&(this._invalid=!1),this.value=l;let z=!1;if(this.slot){const R=getComputedStyle(this),O=R.getPropertyValue("--to"),q=R.getPropertyValue("--from");this.slot==="from"?t>Number.parseInt(O)&&(z=!0,this.value=O,r&&(this._invalid=!0)):t<Number.parseInt(q)&&(z=!0,this.value=q,r&&(this._invalid=!0))}if(z)return e.preventDefault(),!0;this.range.value=Math.min(Math.max(Number(l),Number(this.min)),Number(this.max)).toString();const M=(!this.range||this.range?.value===l)&&(l===this.max||l===this.min);return this.value=this.allowValuesOutsideRange&&!r&&M?"":l,this.shadowRoot.querySelector("w-attention").handleDone(),!0}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:r}]=await Promise.all([B(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
        /*
      ...
      `,await r({roots:[this.shadowRoot],elements:[this.anchorPositioningStyleElement]})}catch(r){console.error(new Error("Error registering the CSS anchor positioning polyfill. The UI will look broken.",{cause:r}))}}this.#a()}get boundaryValue(){return this.slot==="from"?this.min:this.max}get textFieldDisplayValue(){return this._inputHasFocus?this.value===""?this.range?.value??"":this.value:this.value}get tooltipDisplayValue(){return this.formatter?this.formatter(this.value,this.slot):this.value===""?this.range?.value??this.boundaryValue:this.value||0}updated(e){e.has("value")&&(this.setValue(this.value),this.#a()),e.has("_invalid")&&this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:this._invalid}}))}render(){return n`
      <div class="w-slider-thumb">
        <label for="range">${this.label}</label>
        ${"anchorName"in document.documentElement.style?h:n`<div class="polyfill-range">
        ...
        >
          ${this.suffix?n`<w-affix slot="suffix" label="${this.suffix}"></w-affix>`:h}
        </w-textfield>
        ...
        >
          ...
          ></output>
          <span slot="message">
            ${this.tooltipDisplayValue}${this.suffix?n`&nbsp;${this.suffix}`:h}
          </span>
        </w-attention>
    ...
    `}}i([o({attribute:"aria-label",reflect:!0})],a.prototype,"ariaLabel");i([o({attribute:"aria-description",reflect:!0})],a.prototype,"ariaDescription");i([o({reflect:!0})],a.prototype,"label");i([o({reflect:!0})],a.prototype,"name");i([o({reflect:!0})],a.prototype,"value");i([o({type:Boolean,reflect:!0})],a.prototype,"disabled");i([d()],a.prototype,"markers");i([d()],a.prototype,"required");i([d()],a.prototype,"step");i([d()],a.prototype,"min");i([d()],a.prototype,"max");i([d()],a.prototype,"suffix");i([d()],a.prototype,"allowValuesOutsideRange");i([d()],a.prototype,"forceDisabled");i([d()],a.prototype,"forceInvalid");i([d()],a.prototype,"formatter");i([L('input[type="range"]')],a.prototype,"range");i([L("w-textfield")],a.prototype,"textfield");i([d()],a.prototype,"_invalid");i([d()],a.prototype,"_showTooltip");i([d()],a.prototype,"_inputHasFocus");customElements.get("w-slider-thumb")||customElements.define("w-slider-thumb",a);var P=Object.freeze,G=Object.defineProperty,T=(s,e)=>P(G(s,"raw",{value:P(s.slice())})),D,V,C,I;const{events:J,args:Q,argTypes:Y}=A("w-slider"),Z={title:"Forms/Slider and Range Slider",args:Q,argTypes:Y,parameters:{actions:{handles:J}}},f={render(){return n`
    ...
    `}},g={args:{locale:"nb",suffix:"m²"},render({locale:s,suffix:e}){return n(D||(D=T([`
      <w-slider
      ...
      <\/script>
    `])),e,s)}},w={args:{locale:"nb",suffix:"kr"},render({locale:s,suffix:e}){return n(V||(V=T([`
      <w-slider
        label="Price"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,s)}},v={args:{locale:"nb",suffix:"km"},render({locale:s,suffix:e}){return n(C||(C=T([`
      <w-slider
        label="Distance"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,s)}},y={args:{locale:"nb",step:"5",markers:"5"},render({markers:s,step:e}){return n`
      <w-slider
        label="Single"
        min="0"
        max="100"
    ...
    `}},x={args:{step:5},render({step:s}){return n`
      <w-slider label="Single" step="${s}" min="0" max="100">
        <w-slider-thumb name="value"></w-slider-thumb>
      </w-slider>
    `}},_={args:{},render(){return n(I||(I=T([`

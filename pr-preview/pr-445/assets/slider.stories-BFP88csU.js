import{a as F,i as $,r as N,E as m,x as o,n as l,k as d,g as A}from"./iframe-Cv8sgpWm.js";import"./index-vjEAiSWy.js";import"./index-B9Sm6ior.js";import"./index-Bij77HwW.js";import{F as j}from"./FormControlMixin-DJnJZbro.js";import{_ as B}from"./preload-helper-Ct5FWWRu.js";import{e as L}from"./query-NYTjQBeo.js";import{o as E}from"./if-defined-CmAhuqaP.js";const H=F`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`;var U=Object.defineProperty,h=(s,e,r,n)=>{for(var t=void 0,c=s.length-1,p;c>=0;c--)(p=s[c])&&(t=p(e,r,t)||t);return t&&U(e,r,t),t};class u extends j($){constructor(){super(...arguments),this.disabled=!1,this.allowValuesOutsideRange=!1,this.helpText="",this.invalid=!1,this.required=!1}static{this.shadowRootOptions={...$.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[N,H]}#e(){const e=this.querySelectorAll("w-slider-thumb");let r=!1;for(const t of e.values())t.min=this.min,t.max=this.max,t.step=this.step,t.suffix=this.suffix,t.required=this.required,t.formatter=this.formatter,t.allowValuesOutsideRange=this.allowValuesOutsideRange,t.ariaLabel||(t.slot||(t.ariaLabel=this.label),t.slot==="from"&&(t.ariaLabel=`${this.label} min`),t.slot==="to"&&(t.ariaLabel=`${this.label} max`)),(t.slot==="from"||t.slot==="to")&&(r=!0),t.forceDisabled=this.disabled,t.forceInvalid=this.invalid,this.#r(t);const n=this.shadowRoot.querySelector("fieldset");r?(n.style.setProperty("--active-range-inline-start-padding","var(--w-slider-thumb-size)"),n.style.setProperty("--active-range-inline-end-padding","var(--w-slider-thumb-size)")):n.style.setProperty("--active-range-border-radius","4px")}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.step&&this.style.setProperty("--step",String(this.step)),this.style.setProperty("--min",this.min),this.style.setProperty("--max",this.max),this.markers&&this.style.setProperty("--markers",String(this.markers)),this.#e()}updated(e){(e.has("disabled")||e.has("invalid")||e.has("required")||e.has("min")||e.has("step")||e.has("max")||e.has("suffix")||e.has("formatter"))&&this.#e()}#t(e){const r=e.target;this.#r(r)}#a(e){e.stopPropagation(),this.invalid=e.detail.invalid}#r(e){const r=e.slot,n=t=>((e.value===void 0||e.value===null)&&(e.value=this.allowValuesOutsideRange?"":t),e.value===""?t:e.value);r||this.style.setProperty("--from","0"),r==="from"&&this.style.setProperty("--from",n(this.min)),(!r||r==="to")&&this.style.setProperty("--to",n(this.max))}render(){return o`
      ...
      >
        ...
        ${this.markers?o`<div class="w-slider__markers"></div>`:m}
    ...
    `}}h([l({reflect:!0})],u.prototype,"label");h([l({type:Boolean,reflect:!0})],u.prototype,"disabled");h([l({type:Boolean,attribute:"allow-values-outside-range"})],u.prototype,"allowValuesOutsideRange");h([l({reflect:!0})],u.prototype,"helpText");h([l({type:Boolean,reflect:!0})],u.prototype,"invalid");h([l({type:Boolean,reflect:!0})],u.prototype,"required");h([l({reflect:!0})],u.prototype,"min");h([l({reflect:!0})],u.prototype,"max");h([l({type:Number,reflect:!0})],u.prototype,"markers");h([l({type:Number,reflect:!0})],u.prototype,"step");h([l({reflect:!0})],u.prototype,"suffix");h([l({attribute:!1})],u.prototype,"formatter");customElements.get("w-slider")||customElements.define("w-slider",u);const W=F`
  .w-slider-thumb {
    position: relative;
    display: grid;
...
`,X=F`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var K=Object.defineProperty,i=(s,e,r,n)=>{for(var t=void 0,c=s.length-1,p;c>=0;c--)(p=s[c])&&(t=p(e,r,t)||t);return t&&K(e,r,t),t};class a extends j($){constructor(){super(...arguments),this.allowValuesOutsideRange=!1,this._invalid=!1,this._showTooltip=!1,this._inputHasFocus=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...$.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[N,X,W]}#e(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#t(){this._showTooltip=!1}#a(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#r(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const n=e.currentTarget.value,t=Number.parseInt(n),c=Number.parseInt(this.max),p=Number.parseInt(this.min);if(!this.allowValuesOutsideRange&&(t>c||t<p))return this._invalid=!0,!1;if(n==="")return this.required&&(this._invalid=!0),!1;this._invalid&&(this._invalid=!1),this.value=n;let z=!1;if(this.slot){const R=getComputedStyle(this),O=R.getPropertyValue("--to"),q=R.getPropertyValue("--from");this.slot==="from"?t>Number.parseInt(O)&&(z=!0,this.value=O,r&&(this._invalid=!0)):t<Number.parseInt(q)&&(z=!0,this.value=q,r&&(this._invalid=!0))}if(z)return e.preventDefault(),!0;this.range.value=Math.min(Math.max(Number(n),Number(this.min)),Number(this.max)).toString();const M=(!this.range||this.range?.value===n)&&(n===this.max||n===this.min);return this.value=this.allowValuesOutsideRange&&!r&&M?"":n,this.shadowRoot.querySelector("w-attention").handleDone(),!0}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:r}]=await Promise.all([B(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
      ...
      <div class="w-slider-thumb">
        ...
        ${"anchorName"in document.documentElement.style?m:o`<div class="polyfill-range">
        ...
        >
          ${this.suffix?o`<w-affix slot="suffix" label="${this.suffix}"></w-affix>`:m}
        </w-textfield>
        ...
        >
          ...
          ></output>
          <span slot="message">
            ${this.tooltipDisplayValue}${this.suffix?o`&nbsp;${this.suffix}`:m}
          </span>
        </w-attention>
    ...
    `}},g={args:{locale:"nb",suffix:"m²"},render({locale:s,suffix:e}){return o(D||(D=T([`
      <w-slider
      ...
      <\/script>
    `])),e,s)}},w={args:{locale:"nb",suffix:"kr"},render({locale:s,suffix:e}){return o(V||(V=T([`
      <w-slider
        label="Price"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,s)}},v={args:{locale:"nb",suffix:"km"},render({locale:s,suffix:e}){return o(C||(C=T([`
      <w-slider
        label="Distance"
        min="0"
        max="250000"

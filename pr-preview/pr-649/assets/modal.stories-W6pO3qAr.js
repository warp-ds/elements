import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{m as n,n as r,r as i,s as a,t as o}from"./lit-JruGAyH3.js";import{n as ee,t as s}from"./dist-DqaB6mbc.js";import{n as te,t as c}from"./dist-BZcjgT0h.js";import{a as ne,i as l,n as u,o as d,r as re,t as f}from"./decorate-Dk3JVGAn.js";import{t as ie}from"./icon-C7QoHWvn.js";import{n as ae,r as oe,t as se}from"./i18n-CXvrc2gG.js";import{n as p,t as m}from"./styles-DphVJT09.js";import{i as h,n as g,r as ce,t as le}from"./utilities-DiPTmiiI.js";function ue(e){let t=-1;e.ontouchstart=e=>{e.targetTouches.length===1&&(t=e.targetTouches[0].clientY)},e.ontouchmove=n=>{if(n.targetTouches.length!==1)return;let r=n.targetTouches[0].clientY-t;return e.scrollTop===0&&r>0||ge(e)&&r<0?y(n):(n.stopPropagation(),!0)}}function de(e){e.ontouchstart=null,e.ontouchmove=null}function fe(e){if(!e)throw Error(`Could not run setup, an element must be provided`);_.some(t=>t===e)||(_.length||(x(),w()),ue(e),_.push(e))}function pe(){_.forEach(de),T(),he(),_=[]}var _,v,me,y,b,x,S,he,ge,C,w,T,_e=e((()=>{_=[],v={documentElement:{},body:{}},me=Object.freeze({documentElement:{"scrollbar-gutter":`stable`},body:{overflow:`hidden`,position:`relative`,height:`100%`}}),y=e=>{e.touches.length>1||e.preventDefault?.()},b=e=>([t,n])=>{v[e][t]=document[e].style[t],document[e].style[t]=n},x=()=>Object.entries(me).forEach(([e,t])=>{Object.entries(t).forEach(b(e))}),S=e=>([t,n])=>{document[e].style[t]=v[e][t]},he=()=>Object.entries(v).forEach(([e,t])=>{Object.entries(t).forEach(S(e))}),ge=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight,C=e=>()=>document[e?`addEventListener`:`removeEventListener`](`touchmove`,y,{passive:!1}),w=C(!0),T=C()})),E,D,O=e((()=>{E=e=>class extends e{constructor(...e){super(...e),this.patchClose=!0,this._close=null}close(){this._close()}},D=e=>class extends e{handleSlotChange(e){let t=e.target.assignedNodes({flatten:!0});for(let e of t.filter(e=>e.patchClose))e._close=()=>this.close()}}})),k,ve=e((()=>{o(),re(),_e(),m(),O(),u(),k=class extends D(r){constructor(){super(),this.show=!1,this.ignoreBackdropClicks=!1,this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}async open(){this.dialogEl.showModal(),this.handleListeners(),fe(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent(`shown`,{bubbles:!0,composed:!0}))}close(){this.dialogEl?.open&&(this.handleListeners(`removeEventListener`),this.dialogEl.classList.add(`close`),this.dialogEl.addEventListener(`animationend`,async()=>{this.dialogEl.classList.remove(`close`),this.dialogEl.close(),pe(),await this.updateComplete,this.dispatchEvent(new CustomEvent(`hidden`,{bubbles:!0,composed:!0}))},{once:!0}))}render(){return a`
    ...
    `}async willUpdate(e){if(e.has(`back`)){if(!this.titleEl)return;new P(this.titleEl).when(async()=>{await this.updateComplete})}}get titleClasses(){return[`header-title`,this.back?`header-title-with-back-button`:`header-title-without-back-button`,this._hasTopContent?`header-title-with-top-area`:``].join(` `)}get backButton(){return this.back&&!this._hasTopContent?a`<button
          ...
          @click="${this.emitBack}">
          <w-icon name="ArrowLeft" size="small" locale="${ae()}" style="display: flex;" class="flex"></w-icon>
        ...
        <w-button
            ...
            small=""
            @click="${this.close}">
                <w-icon name="Close" size="small" locale="${ae()}" style="display: flex;" class="flex"></w-icon>
        </w-button>
    ...
    `]}},f([d({type:String})],B.prototype,`title`,void 0),f([d({type:Boolean})],B.prototype,`back`,void 0),f([d({type:Boolean,attribute:`no-close`})],B.prototype,`noClose`,void 0),f([ne()],B.prototype,`_hasTopContent`,void 0),f([l(`.title-el`)],B.prototype,`titleEl`,void 0),customElements.get(`w-modal-header`)||customElements.define(`w-modal-header`,B)})),V,Oe=e((()=>{o(),O(),m(),V=class extends E(D(r)){render(){return a`
      <div class="footer">
    ...
    `]}},customElements.get(`w-modal-footer`)||customElements.define(`w-modal-footer`,V)})),ke=t({Default:()=>J,Modal:()=>X,ModalFooter:()=>Q,ModalHeader:()=>Z,WithImage:()=>Y,__namedExportsOrder:()=>$,default:()=>q}),H,U,W,G,Ae,K,je,Me,Ne,q,J,Y,X,Z,Q,$,Pe=e((()=>{ce(),ee(),o(),le(),ve(),De(),Oe(),{events:H,args:U,argTypes:W}=s(`w-modal`),{events:G,args:Ae,argTypes:K}=s(`w-modal-header`),{events:je,args:Me,argTypes:Ne}=s(`w-modal-footer`),q={title:`Overlays/Modal`},J={args:{},render(){return a`
    ...
    `},play:async({canvasElement:e})=>{await Promise.all([customElements.whenDefined(`w-button`),customElements.whenDefined(`w-modal`),customElements.whenDefined(`w-modal-header`),customElements.whenDefined(`w-modal-footer`)]);let t=e.querySelector(`#modal-open-button-two`),n=e.querySelector(`#modal-close-button-two`),r=e.querySelector(`#example-modal-two`);t&&r&&t.addEventListener(`click`,()=>r.open()),n&&r&&n.addEventListener(`click`,()=>r.close())},parameters:{docs:{story:{autoplay:!0}}}},X={render(e){return a`
      ...
      <w-modal ${h(g(e))}></w-modal>
    `},args:U,argTypes:W,parameters:{actions:{handles:H}}},Z={render(e){return a`
      <p>
        This is here to document attributes. See the Default example for a
        complete usage example.
      </p>
      <w-modal-header ${h(g(e))}></w-modal-header>
    `},args:Ae,argTypes:K,parameters:{actions:{handles:G}}},Q={render(e){return a`
      <p>
        This is here to document attributes. See the Default example for a
        complete usage example.
      </p>
      <w-modal-footer ${h(g(e))}></w-modal-footer>
...
}`,...Q.parameters?.docs?.source}}},$=[`Default`,`WithImage`,`Modal`,`ModalHeader`,`ModalFooter`]}));Pe();export{J as Default,X as Modal,Q as ModalFooter,Z as ModalHeader,Y as WithImage,$ as __namedExportsOrder,q as default,ke as n,Pe as t};
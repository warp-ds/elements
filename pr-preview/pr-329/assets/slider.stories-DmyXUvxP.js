import{a as P,i as z,r as j,E as T,x as o,n as l,k as u,g as A}from"./iframe-CIcXbisk.js";import"./index-fy5Iko0j.js";import"./index-_kCGWkF8.js";import{F as L}from"./FormControlMixin-DJnJZbro.js";import{_ as B}from"./preload-helper-Ct5FWWRu.js";import{e as V}from"./query-NYTjQBeo.js";import{e as M}from"./class-map-Bznpi3rf.js";import{o as E}from"./if-defined-CyNr76qB.js";const W=P`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`,K=P`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var X=Object.defineProperty,s=(a,e,r,n)=>{for(var t=void 0,d=a.length-1,h;d>=0;d--)(h=a[d])&&(t=h(e,r,t)||t);return t&&X(e,r,t),t};class i extends L(z){constructor(){super(...arguments),this._invalid=!1,this._showTooltip=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...z.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[j,K,U]}#r(){this._showTooltip=!0}#e(){this._showTooltip=!1}#t(e){const r=e.detail?.value;r&&this._invalid&&(this._invalid=!1);const n=r||e.currentTarget.value,t=Number.parseInt(n),d=Number.parseInt(this.max),h=Number.parseInt(this.min);(t>d||t<h)&&(this._invalid=!0);let F=!1;if(this.slot){const q=getComputedStyle(this);if(this.slot==="from"){const p=q.getPropertyValue("--to");if(t>Number.parseInt(p)){if(r)return this._invalid=!0,!1;F=!0,this.value=p}}else{const p=q.getPropertyValue("--from");if(t<Number.parseInt(p)){if(r)return this._invalid=!0,!1;F=!0,this.value=p}}}return F?(e.preventDefault(),this.range.value=this.value,!1):(this.value=n,!0)}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/")),[{default:r}]=await Promise.all([B(()=>import(`${e}/oddbird-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
      ...
      `,await r.call(this,{elements:[this.anchorPositioningStyleElement]})}this.range.value=this.value??this.max}updated(e){if(e.has("value")&&(this.setValue(this.value),!("anchorName"in document.documentElement.style))){const r=this.shadowRoot.querySelector("#target"),n=getComputedStyle(r).getPropertyValue("width"),t=Number.parseFloat(n.replace("px",""))/2;r.style.setProperty("margin-left",`-${t}px`)}e.has("_invalid")&&this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:this._invalid}}))}render(){return o`
    ...
    `}},w={args:{locale:"nb",suffix:"m²"},render({locale:a,suffix:e}){return o(C||(C=$([`
    ...
    `])),e,a)}},v={args:{locale:"nb",suffix:"km"},render({locale:a,suffix:e}){return o(R||(R=$([`
      ...
      <\/script>
    `])),e,a)}},y={args:{locale:"nb",suffix:"km",step:"25000",markers:"25000"},render({locale:a,suffix:e,markers:r,step:n}){return o(I||(I=$([`

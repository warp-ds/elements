import{j as e}from"./index-C8ADKtso.js";import{useMDXComponents as r}from"./index-BwRnHMUQ.js";import{M as t,C as i}from"./blocks-Cg7i35h-.js";import{S as l,a as d,R as o,b as h,c as m,d as u,M as c,T as x,O as f,e as j,f as g}from"./slider.stories-n_CXCioL.js";import"./preload-helper-DvrX7W50.js";import"./iframe-UZ3nd3z1.js";function a(s){const n={h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{of:l,name:"Docs"}),`
`,e.jsx(n.h1,{id:"sliders",children:"Sliders"}),`
`,e.jsx(n.p,{children:"Sliders allow users to adjust a numeric value within a given range."}),`
...
`,e.jsx(i,{of:c}),`
`,e.jsx(n.h3,{id:"time-ranges",children:"Time ranges"}),`
`,e.jsx(n.p,{children:"Sliders can be used for time-of-day (TODO: can it, though?)."}),`
`,e.jsx(i,{of:x}),`
`,e.jsx(n.h3,{id:"slider-with-over-and-under-max-values",children:"Slider with over and under max values"}),`
`,e.jsx(n.p,{children:"Sliders can be configured so that the minimum and maximum values are empty."}),`
`,e.jsx(n.p,{children:'You can use that as a signal to treat the value as not set, for example if you want to have a selection for "Before 1950" to "After 2025" or "Over 200 000 km".'}),`
`,e.jsx(i,{of:f}),`
...
`,e.jsx(i,{of:j}),`
`,e.jsx(i,{of:g})]})}function M(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}export{M as default};

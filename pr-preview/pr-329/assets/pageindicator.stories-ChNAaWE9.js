import{x as e,a as d}from"./iframe-D9yHRnPP.js";import"./preload-helper-DvrX7W50.js";const l={component:"w-pageindicator",title:"Navigation/PageIndicator",render:({pageCount:n,selectedPage:o})=>e`
    <w-pageindicator page-count=${n} selected-page=${o}></w-pageindicator>
...
\``,...r.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => html\`
  <div style="height: 450px; border: 1px solid lightgrey;">
    <div style="height: 300px; border-bottom: 1px solid #e6e6e6;"></div>
    <w-pageindicator page-count="5" selected-page="1" style="padding-top: 16px;"> </w-pageindicator>
  </div>
\``,...s.parameters?.docs?.source}}};const h=["Default","InsideContainer","InsideContainerChangePage","InsideContainer10Pages","OutsideContainer"];export{a as Default,t as InsideContainer,r as InsideContainer10Pages,i as InsideContainerChangePage,s as OutsideContainer,h as __namedExportsOrder,l as default};

import{g as t,x as l}from"./iframe-bC05rXIF.js";import{s as c,p as d}from"./utilities-BoDe0c0x.js";const{events:u,args:p,argTypes:i}=t("w-box"),g={title:"Layout/Box",render:n=>l`
      <w-box ${c(d(n))}>
        <h3>Box Content</h3>

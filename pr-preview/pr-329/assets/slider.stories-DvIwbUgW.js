import{a as P,i as F,r as j,E as T,x as o,n as l,k as u,g as A}from"./iframe-BKxeEv7Q.js";import"./index-CZo58H3A.js";import"./index-DtGbVaY0.js";import"./index-Dj3I4Ng9.js";import{F as L}from"./FormControlMixin-DJnJZbro.js";import{_ as B}from"./preload-helper-Ct5FWWRu.js";import{e as V}from"./query-NYTjQBeo.js";import{o as E}from"./if-defined-psZx2NzR.js";const M=P`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`,H=P`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var K=Object.defineProperty,s=(a,e,r,n)=>{for(var t=void 0,d=a.length-1,h;d>=0;d--)(h=a[d])&&(t=h(e,r,t)||t);return t&&K(e,r,t),t};class i extends L(F){constructor(){super(...arguments),this._invalid=!1,this._showTooltip=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...F.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[j,H,U]}#r(){this._showTooltip=!0}#e(){this._showTooltip=!1}#t(e){const r=e.detail?.value;r&&this._invalid&&(this._invalid=!1);const n=r||e.currentTarget.value,t=Number.parseInt(n),d=Number.parseInt(this.max),h=Number.parseInt(this.min);(t>d||t<h)&&(this._invalid=!0);let z=!1;if(this.slot){const q=getComputedStyle(this);if(this.slot==="from"){const p=q.getPropertyValue("--to");if(t>Number.parseInt(p)){if(r)return this._invalid=!0,!1;z=!0,this.value=p}}else{const p=q.getPropertyValue("--from");if(t<Number.parseInt(p)){if(r)return this._invalid=!0,!1;z=!0,this.value=p}}}return z?(e.preventDefault(),this.range.value=this.value,!1):(this.value=n,!0)}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/")),[{default:r}]=await Promise.all([B(()=>import(`${e}/oddbird-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
      ...
      `,await r.call(this,{elements:[this.anchorPositioningStyleElement]})}this.range.value=this.value??this.max}updated(e){e.has("value")&&this.setValue(this.value),e.has("_invalid")&&this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:this._invalid}}))}render(){return o`

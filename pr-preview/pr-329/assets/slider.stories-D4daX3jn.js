import{g as x,x as r}from"./iframe-OFY4kkpb.js";var w=Object.freeze,v=Object.defineProperty,f=(e,t)=>w(v(e,"raw",{value:w(e.slice())})),b,p,h,g,S;const{events:y,args:k,argTypes:q}=x("w-slider"),_={title:"Forms/Slider and Range Slider",args:k,argTypes:q,parameters:{actions:{handles:y}}},s={render(){return r`
    ...
    `}},a={args:{locale:"nb",suffix:"m2"},render({locale:e,suffix:t}){return r(b||(b=f([`
      ...
      <\/script>
    `])),t,e)}},n={args:{locale:"nb",suffix:"kr"},render({locale:e,suffix:t}){return r(p||(p=f([`
      ...
      <\/script>
    `])),t,e)}},d={args:{locale:"nb",suffix:"km"},render({locale:e,suffix:t}){return r(h||(h=f([`
      ...
      <\/script>
    `])),t,e)}},l={args:{locale:"nb",suffix:"km"},render({locale:e,suffix:t}){return r(g||(g=f([`
      <w-slider
        label="Distance"
...
}`,...c.parameters?.docs?.source}}};const F=["Single","Range","SuffixSquareMeters","SuffixCurrency","SuffixKilometers","Marks","Step","OverUnder","SingleError","RangeError"],E=Object.freeze(Object.defineProperty({__proto__:null,Marks:l,OverUnder:i,Range:o,RangeError:c,Single:s,SingleError:u,Step:m,SuffixCurrency:n,SuffixKilometers:d,SuffixSquareMeters:a,__namedExportsOrder:F,default:_},Symbol.toStringTag,{value:"Module"}));export{l as M,i as O,o as R,E as S,s as a,a as b,n as c,d,m as e,u as f,c as g};

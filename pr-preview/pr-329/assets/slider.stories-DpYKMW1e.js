import{g as v,x as r}from"./iframe-2UQpUGCG.js";var b=Object.freeze,x=Object.defineProperty,f=(e,t)=>b(x(e,"raw",{value:b(e.slice())})),w,p,h,g,S;const{events:y,args:k,argTypes:F}=v("w-slider"),T={title:"Forms/Slider and Range Slider",args:k,argTypes:F,parameters:{actions:{handles:y}}},a={render(){return r`
    ...
    `])),t,e)}},i={args:{locale:"nb",suffix:"km"},render({locale:e,suffix:t}){return r(h||(h=f([`
      ...
      <\/script>
    `])),t,e)}},n={args:{locale:"nb",suffix:"km"},render({locale:e,suffix:t}){return r(g||(g=f([`
      <w-slider
        label="Distance"
      ...
      <\/script>
    `])),t,e)}},d={args:{step:5},render({step:e}){return r`
...
}`,...c.parameters?.docs?.source}}};const q=["Single","Range","SuffixSquareMeters","SuffixCurrency","SuffixKilometers","Marks","Step","OverUnder","SingleError","RangeError"],D=Object.freeze(Object.defineProperty({__proto__:null,Marks:n,OverUnder:m,Range:s,RangeError:c,Single:a,SingleError:u,Step:d,SuffixCurrency:l,SuffixKilometers:i,SuffixSquareMeters:o,__namedExportsOrder:q,default:T},Symbol.toStringTag,{value:"Module"}));export{n as M,m as O,s as R,D as S,a,o as b,l as c,i as d,d as e,u as f,c as g};

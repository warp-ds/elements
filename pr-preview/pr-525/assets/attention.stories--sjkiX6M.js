import{g as w,b as e}from"./iframe-B8PlbmJa.js";import{s as c,p as v}from"./utilities-DIuweEmF.js";import"./attention-BTfSpKjr.js";import"./button-BSlETvMQ.js";var p=Object.freeze,y=Object.defineProperty,l=(t,g)=>p(y(t,"raw",{value:p(t.slice())})),d,u,m,b;const{events:E,args:I,argTypes:f}=w("w-attention"),T={title:"Overlays/Attention",render(t){return e`
      <w-attention ${c(v(t))}>
        <w-button
          ${c({id:t.buttonId})}
          variant="secondary"

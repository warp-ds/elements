import{a as z,i as B,r as Q,b as i,n,q as X,p as G,k as N,m as O,g as U}from"./iframe-B8PlbmJa.js";import{s as Y,p as Z}from"./utilities-DIuweEmF.js";import{F as J}from"./FormControlMixin-DJnJZbro.js";import{o as W}from"./if-defined-Co0giv8A.js";import"./preload-helper-Ct5FWWRu.js";const j=z`
  :host {
...
`;var te=Object.defineProperty,p=(d,e,t,a)=>{for(var r=void 0,o=d.length-1,s;o>=0;o--)(s=d[o])&&(r=s(e,t,r)||r);return r&&te(e,t,r),r};class h extends J(B){constructor(){super(),this.name="",this.value=null,this.checked=!1,this.disabled=!1,this.required=!1,this.invalid=!1,this.#r=!1,this.#e=!1,this.#t=!1,this.#a=!1,this.handleClick=()=>{this.isInGroup()||this.disabled||(this.#t=!0,this.checked=!0,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}))},this.handleInvalid=()=>{this.#t=!0,this.updateValidity()},this.handleKeyDown=e=>{this.isInGroup()||this.disabled||e.defaultPrevented||e.key!==" "&&e.key!=="Spacebar"&&e.key!=="Enter"||(e.preventDefault(),this.click())},this.addEventListener("click",this.handleClick),this.addEventListener("invalid",this.handleInvalid),this.addEventListener("keydown",this.handleKeyDown)}static{this.styles=[j,Q,ee]}#r;#e;#t;#a;connectedCallback(){super.connectedCallback(),this.setAttribute("type","radio"),this.value=this.getAttribute("value")??"on",this.#r=this.hasAttribute("checked"),this.checked=this.#r,this.setAttribute("role","radio"),this.syncAriaDisabled(),this.syncTabIndex(),this.syncFormValue(),this.updateValidity()}syncAriaDisabled(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}updated(e){super.updated(e),e.has("checked")&&(this[this.checked?"setAttribute":"removeAttribute"]("checked-ui",""),this.setAttribute("aria-checked",this.checked?"true":"false"),this.checked&&!this.isInGroup()&&this.uncheckOtherRadios(),this.syncTabIndex()),e.has("disabled")&&(this[this.disabled?"setAttribute":"removeAttribute"]("disabled-ui",""),this.syncAriaDisabled(),this.syncTabIndex()),e.has("invalid")&&this.toggleAttribute("aria-invalid",this.invalid),e.has("name")&&this.checked&&!this.isInGroup()&&this.uncheckOtherRadios(),this.shouldSyncFormState(e)&&(this.syncFormValue(),this.updateValidity())}resetFormControl(){this.checked=this.#r,this.syncFormValue(),this.updateValidity()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.updateValidity(),this.internals.checkValidity()}reportValidity(){return this.#t=!0,this.updateValidity(),this.internals.checkValidity()}isInGroup(){return!!this.closest("w-radio-group")}getRadioScope(){return this.internals.form??this.closest("form")??document}uncheckOtherRadios(){if(!this.name)return;const e=this.getRadioScope();Array.from(e.querySelectorAll(`w-radio[name="${this.name}"]`)).forEach(a=>{a!==this&&(a.closest("w-radio-group")||a.checked&&(a.checked=!1))})}updateValidity(){if(this.disabled||this.isInGroup()){this.internals.setValidity({});return}const e=this.required&&!this.checked,t=this.invalid&&!this.#e;if(e){this.#e=!0,this.invalid=this.#t,this.internals.setValidity({valueMissing:!0},this.internals.validationMessage||" ");return}if(this.#e&&(this.invalid=!1,this.#e=!1),t){this.internals.setValidity({customError:!0},this.internals.validationMessage||" ");return}this.internals.setValidity({})}syncFormValue(){if(this.disabled){this.setValue(null);return}this.setValue(this.checked?this.value:null)}syncTabIndex(){if(!this.hasAttribute("tabindex")&&!this.#a&&(this.#a=!0,this.tabIndex=0),this.isInGroup()){this.disabled&&(this.tabIndex=-1);return}this.hasAttribute("tabindex")&&!this.#a||(this.tabIndex=this.disabled?-1:0,this.#a=!0)}shouldSyncFormState(e){return e.has("checked")||e.has("value")||e.has("disabled")||e.has("required")||e.has("invalid")}render(){return i`
      <div class="wrapper">
        <div part="control" class="control"></div>
        <slot part="label" class="label"></slot>
      </div>
    `}}p([n({reflect:!0})],h.prototype,"name");p([n({reflect:!0})],h.prototype,"value");p([n({type:Boolean,reflect:!0})],h.prototype,"checked");p([n({type:Boolean})],h.prototype,"disabled");p([n({type:Boolean,reflect:!0})],h.prototype,"required");p([n({type:Boolean,reflect:!0})],h.prototype,"invalid");customElements.get("w-radio")||customElements.define("w-radio",h);const ae=JSON.parse('{"radio-group.validation.required":["Vælg en mulighed."],"radio-group.label.optional":["Valgfri"]}'),re=JSON.parse('{"radio-group.validation.required":["Please select an option."],"radio-group.label.optional":["Optional"]}'),oe=JSON.parse('{"radio-group.validation.required":["Valitse vaihtoehto."],"radio-group.label.optional":["Valinnainen"]}'),ie=JSON.parse('{"radio-group.validation.required":["Velg et alternativ."],"radio-group.label.optional":["Valgfri"]}'),se=JSON.parse('{"radio-group.validation.required":["Välj ett alternativ."],"radio-group.label.optional":["Valfritt"]}'),ne=z`
  :host {
    display: block;
  }
...
`;var de=Object.defineProperty,u=(d,e,t,a)=>{for(var r=void 0,o=d.length-1,s;o>=0;o--)(s=d[o])&&(r=s(e,t,r)||r);return r&&de(e,t,r),r};X(re,ie,oe,ae,se);const le=()=>G._({id:"radio-group.validation.required",message:"Please select an option.",comment:"Shown when required radio group has no selections"});class l extends J(B){constructor(){super(),this.hasInteracted=!1,this.hasWarnedMissingName=!1,this.autoTabIndex=!1,this.label="",this.helpText="",this.optional=!1,this.invalid=!1,this.name=null,this.disabled=!1,this.required=!1,this.defaultCheckedValue=void 0,this.slottedHelpText=null,this.nameManagedRadios=new WeakSet,this.disabledManagedRadios=new WeakSet,this.handleRadioClick=e=>{const t=e.target.closest("w-radio");if(!t||t.disabled||this.disabled)return;const a=this.getCheckedValue(),r=this.getAllRadios();this.selectSingleRadio(t,r),this.getCheckedValue()!==a&&this.updateComplete.then(this.emitSelectionChange)},this.handleInvalid=e=>{e.preventDefault(),this.hasInteracted=!0,this.updateValidity()},this.handleHelpTextSlotChange=()=>{this.syncSlottedHelpText(),this.requestUpdate()},this.handleI18nChange=()=>{this.requestUpdate()},this.emitSelectionChange=()=>{this.hasInteracted=!0,this.syncFormValue(),this.updateValidity(),this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))},this.captureDefaultSelection=()=>{this.defaultCheckedValue===void 0&&(this.defaultCheckedValue=this.getCheckedValue())},this.addEventListener("keydown",this.handleKeyDown),this.addEventListener("click",this.handleRadioClick),this.addEventListener("invalid",this.handleInvalid)}static{this.styles=[j,ne]}static{this.shadowRootOptions={...B.shadowRootOptions,delegatesFocus:!0}}get validationTarget(){const e=this.querySelector(":is(w-radio):not([disabled])");if(e)return e}updated(e){(e.has("disabled")||e.has("name")||e.has("required")||e.has("invalid")||e.has("helpText"))&&(this.syncRadioElements(),this.syncFormValue(),this.updateValidity())}connectedCallback(){super.connectedCallback(),this.syncSlottedHelpText(),this.syncFormValue(),this.updateValidity(),this.unsubscribeI18n=G.on("change",this.handleI18nChange),this.warnIfMissingName(),this.updateComplete.then(this.captureDefaultSelection)}disconnectedCallback(){this.unsubscribeI18n?.(),this.unsubscribeI18n=void 0,super.disconnectedCallback()}resetFormControl(){const e=this.defaultCheckedValue??null;this.getAllRadios().forEach(t=>{t.checked=e?t.value===e:!1}),this.syncRadioElements(),this.syncFormValue(),this.updateValidity()}getAllRadios(){return[...this.querySelectorAll("w-radio")]}getCheckedValue(){return this.getAllRadios().find(t=>t.checked)?.value??null}getEnabledRadios(e=this.getAllRadios()){return e.filter(t=>!t.disabled)}selectSingleRadio(e,t=this.getAllRadios()){t.forEach(a=>{const r=a===e;a.checked=r,a.setAttribute("tabindex",r?"0":"-1")})}handleLabelClick(){this.focus()}async syncRadioElements(){const e=this.getAllRadios();e.forEach((t,a)=>{t.toggleAttribute("data-w-radio-first",a===0),t.toggleAttribute("data-w-radio-inner",a!==0&&a!==e.length-1),t.toggleAttribute("data-w-radio-last",a===e.length-1),this.syncRadioDisabledState(t),this.name?(!t.getAttribute("name")||this.nameManagedRadios.has(t))&&(t.setAttribute("name",this.name),this.nameManagedRadios.add(t)):this.nameManagedRadios.has(t)&&(t.removeAttribute("name"),this.nameManagedRadios.delete(t))}),await Promise.all(e.map(async t=>t.updateComplete)),this.normalizeCheckedRadios(e),this.syncTabOrder(e)}syncRadioDisabledState(e){if(this.disabled){e.disabled||(e.disabled=!0,this.disabledManagedRadios.add(e));return}this.disabledManagedRadios.has(e)&&(e.disabled=!1,this.disabledManagedRadios.delete(e))}syncTabOrder(e){if(this.disabled){e.forEach(r=>{r.tabIndex=-1});return}const t=this.getEnabledRadios(e),a=t.find(r=>r.checked);t.length>0&&(a?t.forEach(r=>{r.tabIndex=r.checked?0:-1}):t.forEach((r,o)=>{r.tabIndex=o===0?0:-1})),e.filter(r=>r.disabled).forEach(r=>{r.tabIndex=-1})}handleKeyDown(e){if(!["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"," "].includes(e.key)||this.disabled)return;const t=this.getAllRadios(),a=this.getEnabledRadios(t);if(a.length<=0)return;e.preventDefault();const r=this.getCheckedValue(),o=a.find(L=>L.checked)??a[0],s=e.key===" "?0:["ArrowUp","ArrowLeft"].includes(e.key)?-1:1;let c=a.indexOf(o)+s;c<0&&(c=a.length-1),c>=a.length&&(c=0),this.selectSingleRadio(a[c],t),a[c].focus(),this.getCheckedValue()!==r&&this.updateComplete.then(this.emitSelectionChange)}focus(e){if(this.disabled)return;const t=this.getAllRadios(),a=t.find(s=>s.checked),r=t.find(s=>!s.disabled),o=a||r;o&&o.focus(e)}checkValidity(){return this.updateValidity(),this.internals.checkValidity()}reportValidity(){return this.hasInteracted=!0,this.updateValidity(),this.internals.checkValidity()}hasSlottedContent(e){if(this.querySelector(`[slot="${e}"]`))return!0;const t=this.shadowRoot?.querySelector(`slot[name="${e}"]`);return t?t.assignedNodes({flatten:!0}).some(a=>a.nodeType===Node.ELEMENT_NODE?!0:a.nodeType===Node.TEXT_NODE?!!a.textContent?.trim():!1):!1}syncFormValue(){this.setValue(null)}syncSlottedHelpText(){const e=this.querySelector('[slot="help-text"]');if(!e){this.slottedHelpText=null;return}this.slottedHelpText=e.textContent?.trim()||null}updateValidity(){if(this.warnIfMissingName(),this.disabled){this.internals.setValidity({}),this.syncChildInvalid(!1),this.syncHostTabIndex(!1);return}const e=this.required&&!this.getCheckedValue(),t=this.invalid,a=e&&this.hasInteracted,r=t||a;if(this.syncHostTabIndex(r),e){this.setValidityState({valueMissing:!0}),this.syncChildInvalid(r);return}if(t){this.setValidityState({customError:!0}),this.syncChildInvalid(!0);return}this.internals.setValidity({}),this.syncChildInvalid(!1)}normalizeCheckedRadios(e){const t=e.find(a=>a.checked);t&&e.forEach(a=>{a!==t&&(a.checked=!1)})}syncChildInvalid(e){this.getAllRadios().forEach(t=>{t.invalid=e})}setValidityState(e){const t=this.validationTarget;this.internals.setValidity(e," ",t??void 0)}syncHostTabIndex(e){if(!(this.hasAttribute("tabindex")&&!this.autoTabIndex)){if(e){this.tabIndex=0,this.autoTabIndex=!0;return}this.autoTabIndex&&(this.removeAttribute("tabindex"),this.autoTabIndex=!1)}}warnIfMissingName(){this.hasWarnedMissingName||this.internals.form&&(this.name&&this.name.trim().length>0||(console.warn('w-radio-group: "name" is required for form submission.'),this.hasWarnedMissingName=!0))}render(){const e=this.hasSlottedContent("label"),t=this.hasSlottedContent("help-text"),a=this.label?!0:!!e,r=this.helpText?!0:!!t,s=this.required&&!this.getCheckedValue()&&this.hasInteracted,c=this.invalid||s,H=c,L=c?le():this.helpText,M=c||r,K=M?"help-text":void 0,P=this.slottedHelpText||void 0;return i`
    ...
    `}}u([O()],l.prototype,"hasInteracted");u([O()],l.prototype,"hasWarnedMissingName");u([O()],l.prototype,"autoTabIndex");u([n()],l.prototype,"label");u([n({attribute:"help-text"})],l.prototype,"helpText");u([n({type:Boolean,reflect:!0})],l.prototype,"optional");u([n({type:Boolean,reflect:!0})],l.prototype,"invalid");u([n({reflect:!0})],l.prototype,"name");u([n({type:Boolean,reflect:!0})],l.prototype,"disabled");u([n({type:Boolean,reflect:!0})],l.prototype,"required");customElements.get("w-radio-group")||customElements.define("w-radio-group",l);U("w-radio");U("w-radio-group");const me={title:"Forms/Radio",render:d=>i`
      <w-radio-group ${Y(Z(d))}>
        <w-radio value="foo" checked>foo</w-radio>
        <w-radio value="bar">bar</w-radio>
      </w-radio-group>
    `},b={args:{label:"Group",name:"foobar"}},m={args:{},render(){return i` <w-radio value="single">Single radio</w-radio> `}},g={args:{},render(){return i` <w-radio value="single" invalid>Single invalid radio</w-radio> `}},v={args:{},render(){return i` <w-radio value="single" disabled>Single disabled radio</w-radio> `}},f={args:{},render(){return i`
    ...
    `}},I={args:{label:"Help text",helpText:"Pick one option",name:"help-text"}},R={args:{label:"Optional",optional:!0,helpText:"This is optional",name:"optional"}},T={render:()=>i`
...
}`,...D.parameters?.docs?.source}}};const ge=["Default","SingleRadioDefault","SingleRadioInvalid","SingleRadioDisabled","SingleRadioFormAssociated","StandaloneRadioGroupByName","Disabled","Required","DisabledGroup","DisabledRadio","HelpText","Optional","RadioGroup","RadioGroupWithHelpText","RadioGroupWithLabel","RadioGroupWithHelpTextAndLabel","RadioGroupWithOptional","RadioGroupWithInvalid","RadioGroupRequired","RadioGroupFormAssociated","InvalidWithMessage","SlottedLabelAndHint"];export{b as Default,y as Disabled,S as DisabledGroup,k as DisabledRadio,I as HelpText,$ as InvalidWithMessage,R as Optional,T as RadioGroup,F as RadioGroupFormAssociated,A as RadioGroupRequired,C as RadioGroupWithHelpText,E as RadioGroupWithHelpTextAndLabel,q as RadioGroupWithInvalid,V as RadioGroupWithLabel,_ as RadioGroupWithOptional,x as Required,m as SingleRadioDefault,v as SingleRadioDisabled,f as SingleRadioFormAssociated,g as SingleRadioInvalid,D as SlottedLabelAndHint,w as StandaloneRadioGroupByName,ge as __namedExportsOrder,me as default};

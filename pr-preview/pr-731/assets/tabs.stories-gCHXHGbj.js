import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{D as n,E as r,Ht as i,Kt as a,Lt as o,O as s,Rt as c,Wt as l,b as u,d,f,l as p,p as m,u as h,w as g,x as _}from"./iframe-BvHU69WO.js";var v,y=t((()=>{o(),v=a(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.border-b{border-bottom-width:1px}.border-b-4{border-bottom-width:4px}.inline-grid{display:inline-grid}.grid-cols-1{grid-template-columns:repeat(1,minmax(0,1fr))}.grid-cols-2{grid-template-columns:repeat(2,minmax(0,1fr))}.grid-cols-3{grid-template-columns:repeat(3,minmax(0,1fr))}.grid-cols-4{grid-template-columns:repeat(4,minmax(0,1fr))}.grid-cols-5{grid-template-columns:repeat(5,minmax(0,1fr))}.grid-cols-6{grid-template-columns:repeat(6,minmax(0,1fr))}.grid-cols-7{grid-template-columns:repeat(7,minmax(0,1fr))}.grid-cols-8{grid-template-columns:repeat(8,minmax(0,1fr))}.grid-cols-9{grid-template-columns:repeat(9,minmax(0,1fr))}.-bottom-0{bottom:0}.absolute{position:absolute}.relative{position:relative}.static{position:static}.s-border{border-color:var(--w-s-color-border)}.s-border-selected{border-color:var(--w-s-color-border-selected)}.-mb-1{margin-bottom:-.1rem}.mb-32{margin-bottom:3.2rem}.resize{resize:both}.transition-all{transition-property:all;transition-duration:.15s;transition-timing-function:cubic-bezier(.4,0,.2,1)}`)})),b,x=t((()=>{o(),u(),p(),y(),m(),b=class extends c{static{this.styles=[h,v,l`
       ...
       * Visibility is now controlled internally via active state, so neutralize it. */
		...
		`]}constructor(){super(),this._internals=this.attachInternals()}set active(e){this._ownActive=e}get active(){return this._parentActive??this._ownActive??!1}connectedCallback(){super.connectedCallback(),this._internals.role=`tabpanel`,this.syncA11yState()}updated(){this.syncA11yState()}syncA11yState(){let e=this._internals;e.ariaLabelledBy=this._parentAriaLabelledBy||null,e.ariaHidden=this.active?`false`:`true`}render(){return i`<div class="panel-content" ?data-active=${this.active}>
			<slot></slot>
		</div>`}},f([r({attribute:`id`,reflect:!0})],b.prototype,`id`,void 0),f([r({type:Boolean})],b.prototype,`active`,null),f([r({attribute:!1})],b.prototype,`_parentActive`,void 0),f([r({attribute:!1})],b.prototype,`_parentAriaLabelledBy`,void 0),customElements.get(`w-tab-panel`)||customElements.define(`w-tab-panel`,b)})),S,C=t((()=>{o(),S=a(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.bg-transparent{background-color:#0000}.appearance-none{-webkit-appearance:none;appearance:none}.border-0{border-width:0}.border-b-4{border-bottom-width:4px}.border-transparent{border-color:#0000}.inline-block{display:inline-block}.flex{display:flex}.grid{display:grid}.focusable:focus{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:focus-visible{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:not(:focus-visible){outline:none}.gap-8{gap:.8rem}.outline{outline-style:solid}.items-center{align-items:center}.justify-center{justify-content:center}.static{position:static}.s-text-link{color:var(--w-s-color-text-link)}.s-text-subtle{color:var(--w-s-color-text-subtle)}.hover\\:s-text-link:hover{color:var(--w-s-color-text-link)}.s-border-selected{border-color:var(--w-s-color-border-selected)}.hover\\:s-border-primary:hover{border-color:var(--w-s-color-border-primary)}.w-full{width:100%}.m-0{margin:0}.mx-auto{margin-left:auto;margin-right:auto}.p-0{padding:0}.p-16{padding:1.6rem}.pb-8{padding-bottom:.8rem}.cursor-pointer{cursor:pointer}.font-bold{font-weight:700}`)})),w,T,E,D=t((()=>{n(),o(),u(),p(),C(),m(),w={base:`grid w-full items-center font-bold gap-8 antialias p-16 pb-8 border-b-4 bg-transparent border-transparent hover:s-text-link hover:s-border-primary`,inactive:`s-text-subtle`,active:`s-text-link s-border-selected`,icon:`mx-auto`,content:`flex items-center justify-center gap-8`,contentUnderlined:`content-underlined`},T=`focusable appearance-none cursor-pointer bg-transparent border-0 m-0 p-0 inline-block`,E=class extends c{static{this.styles=[h,S,l`
			::slotted([slot="icon"]) {
				display: flex;
			}
		...
		`}},f([r({reflect:!0})],L.prototype,`active`,void 0),f([_(`[role="tablist"]`)],L.prototype,`tabList`,void 0),f([_(`.selection-indicator`)],L.prototype,`selectionIndicator`,void 0),f([g()],L.prototype,`_activeTabFor`,void 0),customElements.get(`w-tabs`)||customElements.define(`w-tabs`,L)})),z=e({Default:()=>V,ManyTabs:()=>W,WithIcons:()=>H,WithIconsOver:()=>U,__namedExportsOrder:()=>G,default:()=>B}),B,V,H,U,W,G,K=t((()=>{o(),d(),x(),D(),R(),B={title:`Components/Tabs`},V=()=>i`
    <w-tabs active="tab2">
...
`,V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`() => html\`
    <w-tabs active="tab2">
        <w-tab for="tab1">First Tab</w-tab>
        <w-tab-panel id="tab1">
            <p>
...
\``,...U.parameters?.docs?.source}}},W.parameters={...W.parameters,docs:{...W.parameters?.docs,source:{originalSource:`() => html\`
    <w-tabs active="tab1">
        <w-tab for="tab1">Tab 1</w-tab>
        <w-tab-panel id="tab1">
            <p>Content for tab 1</p>
...
\``,...W.parameters?.docs?.source}}},G=[`Default`,`WithIcons`,`WithIconsOver`,`ManyTabs`]}));K();export{V as Default,W as ManyTabs,H as WithIcons,U as WithIconsOver,G as __namedExportsOrder,B as default,z as n,K as t};
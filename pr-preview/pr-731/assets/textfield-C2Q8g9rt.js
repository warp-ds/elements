import{i as e}from"./preload-helper-xPQekRTU.js";import{Bt as t,D as n,E as r,Ht as i,J as a,Kt as o,Lt as s,O as c,Rt as l,Wt as u,b as d,f,h as p,j as m,k as h,l as g,m as _,p as v,q as y,u as b,w as x,x as S}from"./iframe-BvHU69WO.js";import{n as C,t as w}from"./form-control-DtXadPi-.js";import{r as T,t as E}from"./if-defined-zntCw3iZ.js";var D,O=e((()=>{D=JSON.parse(`{"textfield.label.optional":["Valgfri"]}`)})),k,A=e((()=>{k=JSON.parse(`{"textfield.label.optional":["Optional"]}`)})),j,M=e((()=>{j=JSON.parse(`{"textfield.label.optional":["Valinnainen"]}`)})),N,P=e((()=>{N=JSON.parse(`{"textfield.label.optional":["Valgfri"]}`)})),F,I=e((()=>{F=JSON.parse(`{"textfield.label.optional":["Valfritt"]}`)})),L,R=e((()=>{s(),L=u`
	.w-textfield {
...
`})),W,G,K=e((()=>{n(),a(),w(),s(),d(),_(),E(),m(),g(),O(),A(),M(),P(),I(),R(),B(),U(),v(),W={base:`block text-m leading-m mb-0 px-8 py-12 rounded-4 w-full focusable focus:[--w-outline-offset:-2px] caret-current`,default:`border-1 s-text s-bg s-border-strong hover:s-border-strong-hover active:s-border-selected`,disabled:`border-1 s-text-disabled s-bg-disabled-subtle s-border-disabled pointer-events-none`,invalid:`border-1 s-text-negative s-bg s-border-negative hover:s-border-negative-hover outline-[--w-s-color-border-negative]!`,readOnly:`pl-0 bg-transparent pointer-events-none`,placeholder:`placeholder:s-text-placeholder`,suffix:`pr-40`,prefix:`pl-[var(--w-prefix-width,_40px)]`,textArea:`min-h-[42] sm:min-h-[45]`},G=class extends C(l){static{this.shadowRootOptions={...l.shadowRootOptions,delegatesFocus:!0}}constructor(){super(),this.disabled=!1,this.invalid=!1,this.optional=!1,this.readOnly=!1,this.readonly=!1,this.required=!1,this._hasPrefix=!1,this._hasSuffix=!1,this._hasHelpTextSlot=!1,this.#n=void 0,h(k,N,j,D,F)}get#e(){return this.helpText!==void 0||this._hasHelpTextSlot}#t(e){e.key===`Enter`&&this.internals.form&&this.internals.form.requestSubmit()}updated(e){e.has(`value`)&&this.value!==void 0&&(this.setValue(this.value),this.formatter&&this.mask&&(this.mask.innerText=this.formatter(this.value)))}#n;static{this.styles=[b,z,L,V,H]}firstUpdated(){this.#n=this.value}resetFormControl(){this.value=this.#n}get _inputstyles(){return c([W.base,this._hasSuffix&&W.suffix,this._hasPrefix&&W.prefix,!this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&W.default,this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&W.invalid,!this.invalid&&this.disabled&&!(this.readonly||this.readOnly)&&W.disabled,!this.invalid&&!this.disabled&&(this.readonly||this.readOnly)&&W.readOnly])}get _helptextstyles(){return`help-text`}get _label(){if(this.label){let e=this.label.length&&this.optional&&!this.required,n=!!this.tooltip;return i`
				<label for="${this._id}">
					${this.label}${e?i`
								<span>
		...
		`}},f([r({type:Boolean,reflect:!0})],G.prototype,`disabled`,void 0),f([r({type:Boolean,reflect:!0})],G.prototype,`invalid`,void 0),f([r({type:String,reflect:!0})],G.prototype,`label`,void 0),f([r({type:String,reflect:!0,attribute:`help-text`})],G.prototype,`helpText`,void 0),f([r({type:Boolean,reflect:!0})],G.prototype,`optional`,void 0),f([r({type:String,reflect:!0})],G.prototype,`size`,void 0),f([r({type:Number,reflect:!0})],G.prototype,`max`,void 0),f([r({type:Number,reflect:!0})],G.prototype,`min`,void 0),f([r({type:Number,reflect:!0,attribute:`min-length`})],G.prototype,`minLength`,void 0),f([r({type:Number,reflect:!0})],G.prototype,`minlength`,void 0),f([r({type:Number,reflect:!0,attribute:`max-length`})],G.prototype,`maxLength`,void 0),f([r({type:Number,reflect:!0})],G.prototype,`maxlength`,void 0),f([r({type:String,reflect:!0})],G.prototype,`pattern`,void 0),f([r({type:String,reflect:!0})],G.prototype,`placeholder`,void 0),f([r({type:Boolean,reflect:!0,attribute:`read-only`})],G.prototype,`readOnly`,void 0),f([r({type:Boolean,reflect:!0})],G.prototype,`readonly`,void 0),f([r({type:Boolean,reflect:!0})],G.prototype,`required`,void 0),f([r({type:String,reflect:!0})],G.prototype,`type`,void 0),f([r({type:String,reflect:!0})],G.prototype,`value`,void 0),f([r({type:String,reflect:!0})],G.prototype,`name`,void 0),f([r({type:Number,reflect:!0})],G.prototype,`step`,void 0),f([r({type:String,reflect:!0})],G.prototype,`autocomplete`,void 0),f([r({type:String,reflect:!0})],G.prototype,`tooltip`,void 0),f([r({attribute:!1})],G.prototype,`formatter`,void 0),f([S(`.w-textfield__mask`)],G.prototype,`mask`,void 0),f([r({type:Boolean})],G.prototype,`_hasPrefix`,void 0),f([r({type:Boolean})],G.prototype,`_hasSuffix`,void 0),f([x()],G.prototype,`_hasHelpTextSlot`,void 0),customElements.get(`w-textfield`)||customElements.define(`w-textfield`,G)}));export{K as t};
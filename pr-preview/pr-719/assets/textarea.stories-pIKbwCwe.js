...
`})),T,me=t((()=>{T=JSON.parse(`{"textarea.label.optional":["Valgfri"]}`)})),E,he=t((()=>{E=JSON.parse(`{"textarea.label.optional":["Optional"]}`)})),D,O=t((()=>{D=JSON.parse(`{"textarea.label.optional":["Valinnainen"]}`)})),k,A=t((()=>{k=JSON.parse(`{"textarea.label.optional":["Valgfri"]}`)})),j,M=t((()=>{j=JSON.parse(`{"textarea.label.optional":["Valfritt"]}`)})),N,P,F=t((()=>{r(),o(),_(),c(),ne(),y(),ae(),x(),fe(),pe(),re(),me(),he(),O(),A(),M(),oe(),N={base:`block text-m leading-m mb-0 px-8 py-12 rounded-4 w-full focusable focus:[--w-outline-offset:-2px] caret-current`,default:`border-1 s-text s-bg s-border-strong hover:s-border-strong-hover active:s-border-selected`,disabled:`border-1 s-text-disabled s-bg-disabled-subtle s-border-disabled pointer-events-none`,invalid:`border-1 s-text-negative s-bg s-border-negative hover:s-border-negative-hover outline-[--w-s-color-border-negative]!`,readOnly:`pl-0 bg-transparent pointer-events-none`,placeholder:`placeholder:s-text-placeholder`,suffix:`pr-40`,prefix:`pl-[var(--w-prefix-width,_40px)]`,textArea:`min-h-[42] sm:min-h-[45]`,fixed:`resize-none`},P=class extends de(u){static{this.shadowRootOptions={...u.shadowRootOptions,delegatesFocus:!0}}#e;#t;#n;#r;#i;constructor(){super(),this.disabled=!1,this.invalid=!1,this.readOnly=!1,this.readonly=!1,this.required=!1,this.optional=!1,this.minHeight=-1/0,this.maxHeight=1/0,this.#e=void 0,this.#t=b(`textarea-`),this.#n=!1,this.#r=void 0,this.#i=!1,this.#l=e=>{e.preventDefault(),this.#i=!0,this.#s()},ie(E,k,D,T,j)}updated(e){e.has(`value`)&&this.value!==void 0&&this.setValue(this.value),(e.has(`value`)||e.has(`required`)||e.has(`disabled`))&&this.#s()}resetFormControl(){this.value=this.#e,this.#i=!1,this.#o(),this.#s()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#s(),this.internals.checkValidity()}reportValidity(){return this.#i=!0,this.#s(),this.internals.checkValidity()}setCustomValidity(e){e?(this.internals.setValidity({customError:!0},e,this._textarea),this.#a(e)):(this.#o(),this.#s())}#a(e){this.#n||(this.#r=this.helpText),this.#n=!0,this.invalid=!0,this.helpText=e}#o(){this.#n&&=(this.invalid=!1,this.helpText=this.#r,this.#r=void 0,!1)}#s(){if(this.disabled){this.internals.setValidity({}),this.#o();return}if(this.required&&!this.value){let e=this._textarea?.validationMessage||``;this.internals.setValidity({valueMissing:!0},e,this._textarea),this.#i&&this.#a(e);return}this.internals.setValidity({}),this.#o()}static{this.styles=[p,S,C,w]}get _textareaStyles(){return te([N.base,N.textArea,!!this.placeholder&&N.placeholder,!this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&N.default,this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&N.invalid,!this.invalid&&this.disabled&&!(this.readonly||this.readOnly)&&N.disabled,!this.invalid&&!this.disabled&&(this.readonly||this.readOnly)&&N.readOnly,this.maxRows&&N.fixed])}get _helptextstyles(){return`help-text`}get _helpId(){if(this.helpText)return`${this._id}__hint`}get _id(){return this.#t}get _error(){if(this.invalid&&this._helpId)return this._helpId}async connectedCallback(){if(super.connectedCallback(),this.#e=this.value,this.value!==void 0&&this.setValue(this.value),this.addEventListener(`invalid`,this.#l),await this.updateComplete,this.value||this.minRows){let e=this.shadowRoot?.querySelector(`textarea`);e&&this.#u(e)}}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`invalid`,this.#l)}firstUpdated(e){super.firstUpdated(e),this.#s()}handler(e){let t=e.currentTarget;this.value=t.value,this.#u(t)}#c(){this.#i=!0,this.#s()}#l;#u(e){let t=getComputedStyle(e),n=Number.parseFloat(t.getPropertyValue(`border-top-width`)),r=Number.parseFloat(t.getPropertyValue(`border-bottom-width`)),i=Number.parseFloat(t.getPropertyValue(`line-height`)),a=Number.parseFloat(t.getPropertyValue(`padding-top`))+Number.parseFloat(t.getPropertyValue(`padding-bottom`))+r+n;this.minRows&&(this.minHeight=i*this.minRows+a),this.maxRows&&(this.maxHeight=i*this.maxRows+a);let o=e.scrollHeight+n+r,s=Math.min(this.maxHeight,Math.max(this.minHeight,o));e.style.setProperty(`height`,s+`px`)}render(){return a`
			${this.label?a`
						<label for="${this._id}">
							${this.label}
							${this.optional&&!this.required?a`
										<span>
											${se._({id:`textarea.label.optional`,message:`Optional`,comment:`Shown behind label when marked as optional`})}
										</span>
									`:n}
						</label>
					`:n}

import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{Bt as n,E as r,Ht as i,J as a,Lt as o,M as s,N as c,Rt as l,Wt as u,b as d,f,j as p,k as m,l as h,p as g,q as _,u as v}from"./iframe-BT9kugP-.js";import{a as y,n as b,r as x,t as S}from"./utilities-HI-dv_M8.js";import{r as C,t as w}from"./if-defined-Chf2rXFc.js";var T,E=t((()=>{T=JSON.parse(`{"card.button.text":["Vælg"]}`)})),D,O=t((()=>{D=JSON.parse(`{"card.button.text":["Select"]}`)})),k,A=t((()=>{k=JSON.parse(`{"card.button.text":["Valitse"]}`)})),j,M=t((()=>{j=JSON.parse(`{"card.button.text":["Velg"]}`)})),N,P=t((()=>{N=JSON.parse(`{"card.button.text":["Välj"]}`)})),F,I=t((()=>{o(),F=u`
	:host {
		...
		--_border-width: var(--w-c-card-border-width, 0px);
		--_box-shadow: var(
			--w-c-card-box-shadow,
...
`})),L,R,z=t((()=>{a(),o(),d(),w(),p(),h(),E(),O(),A(),M(),P(),I(),g(),L={ENTER:`Enter`,SPACE:` `},R=class extends l{static{this.styles=[v,F,u`
			a::after {
				content: "";
				position: absolute;
				top: 0;
		...
		`]}constructor(){super(),this.selected=!1,this.flat=!1,this.clickable=!1,m(D,j,k,T,N),this.buttonText=_._({id:`card.button.text`,message:`Select`,comment:`Screenreader message to indicate that the card is clickable`})}keypressed(e){!this.clickable||e.altKey||e.ctrlKey||(e.key===L.ENTER||e.key===L.SPACE)&&(e.preventDefault(),this.click())}render(){return i`
			<div
				part="base"
		...
		`}},f([r({type:Boolean,reflect:!0})],R.prototype,`selected`,void 0),f([r({type:Boolean})],R.prototype,`flat`,void 0),f([r({type:Boolean})],R.prototype,`clickable`,void 0),customElements.get(`w-card`)||customElements.define(`w-card`,R)})),B=e({Clickable:()=>Y,Default:()=>G,Flat:()=>q,FlatSelected:()=>J,PropertyExample:()=>X,Selected:()=>K,__namedExportsOrder:()=>Z,default:()=>W}),V,H,U,W,G,K,q,J,Y,X,Z,Q=t((()=>{x(),c(),o(),S(),z(),{events:V,args:H,argTypes:U}=s(`w-card`),W={title:`Navigation/Card`,render(e){return i`
            <w-card ${y(b(e))}>
        ...
        `},args:H,argTypes:U,parameters:{actions:{handles:V}}},G={args:{selected:!1,flat:!1,clickable:!1}},K={args:{selected:!0,flat:!1,clickable:!1}},q={args:{selected:!1,flat:!0,clickable:!1}},J={args:{selected:!0,flat:!0,clickable:!1}},Y={args:{selected:!1,flat:!1,clickable:!0}},X={args:{selected:!1,flat:!1,clickable:!0},render(e){return i`
            <w-card ${y(b(e))} style="max-width: 300px;">
                <img
...
}`,...X.parameters?.docs?.source}}},Z=[`Default`,`Selected`,`Flat`,`FlatSelected`,`Clickable`,`PropertyExample`]}));Q();export{Y as Clickable,G as Default,q as Flat,J as FlatSelected,X as PropertyExample,K as Selected,Z as __namedExportsOrder,W as default,Q as n,B as t};
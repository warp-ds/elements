import{a as O,i as N,q as te,r as ee,A as c,b as i,n as s,m as h,l as p,k as re,g as ae}from"./iframe-BHyA5CQh.js";import"./affix-Cv5Ganwf.js";import"./attention-BpzmUKBM.js";import"./textfield-o43CMix1.js";import{_ as ie}from"./preload-helper-Ct5FWWRu.js";import{e as P}from"./query-NYTjQBeo.js";import{o as C}from"./if-defined-Dwl7NSk0.js";import{F as se}from"./FormControlMixin-DJnJZbro.js";const oe=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]]}'),ne=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]]}'),le=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]]}'),de=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]]}'),me=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]]}'),ue=O`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`;var fe=Object.defineProperty,l=(o,e,r,a)=>{for(var t=void 0,u=o.length-1,f;u>=0;u--)(f=o[u])&&(t=f(e,r,t)||t);return t&&fe(e,r,t),t};class n extends se(N){constructor(){super(...arguments),this.disabled=!1,this.invalid=!1,this.openEnded=!1,this.suffix="",this._showTooltip=!1,this._inputHasFocus=!1,this._hiddenTextfield=!1,this.#e=null,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...N.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[ee,ce,pe]}#e;resetFormControl(){this.value=this.#e,this.dispatchEvent(new CustomEvent("thumbreset",{bubbles:!0}))}#r(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#a(){this._showTooltip=!1}#s(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#t(e){this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:e,slot:this.slot}}))}async updateFieldAfterValidation(){const e=this.shadowRoot.querySelector("w-textfield");await this.#i(e.value,!0)}async#i(e,r){const a=this.suffix??"";let t=Number.parseInt(e);if(this.openEnded&&!r&&this.step&&!(this.slot==="to"&&t>=Number(this.max)-1||this.slot==="from"&&t<=Number(this.min)+1)){const R=1/this.step;t=Math.round(t*R)/R,e=t.toString()}const u=Number.parseInt(this.max),f=Number.parseInt(this.min);if(!this.openEnded&&(t>u||t<f))return this.#t(p.t({id:"slider.error.out_of_bounds",message:"Value must be between {min} and {max}",values:{min:`${this.min} ${a}`.trim(),max:`${this.max} ${a}`.trim()}})),{shouldCancel:!0};e===""&&this.required&&this.#t(p.t({id:"slider.error.required",message:"This field is required"})),this.value=e;const I=e===this.max||e===this.min;let A=!1;if(this.slot){const H=this.parentElement.querySelector('w-slider-thumb[slot="to"]'),R=this.parentElement.querySelector('w-slider-thumb[slot="from"]'),X=H.textfield.value||this.max,B=R.textfield.value||this.min,L=Number.parseInt(X),j=Number.parseInt(B),K=p.t({id:"slider.error.overlap",message:"The maximum value cannot be less than the minimum"});if(this.slot==="from"){const w=this.openEnded&&L>u?L:Math.min(L,this.openEnded?u-1:u);t>w&&(A=!0,this.openEnded&&I?this.value=String(w):this.value=X,r&&(this.#t(K),await this.updateComplete,this.textfield.value=e))}else{const w=this.openEnded&&j<f?j:Math.max(Number.parseInt(B),this.openEnded?f+1:f);t<w&&(A=!0,this.openEnded&&I?this.value=String(w):this.value=B,r&&(this.#t(K),await this.updateComplete,this.textfield.value=e))}}return A?{shouldCancel:!0}:(this.#t(""),this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.openEnded&&!r&&I?"":e,this.shadowRoot.querySelector("w-attention").handleDone(),{shouldCancel:!1})}async#o(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const a=e.currentTarget.value;return(await this.#i(a,r)).shouldCancel?(e.preventDefault(),!1):!0}async#n(e){if(e.key!=="ArrowLeft"&&e.key!=="ArrowRight")return;const r=Number(this.range.value),a=this.step||1;let t;e.key==="ArrowLeft"?t=r-a:t=r+a,t=Math.min(Math.max(t,Number(this.min)),Number(this.max)),(await this.#i(t.toString(),!1)).shouldCancel&&e.preventDefault()}async connectedCallback(){if(super.connectedCallback(),this.#e=this.value,this.setValue(this.value),this.slot&&!this.ariaDescription&&(this.slot==="from"?this.ariaDescription=p.t({id:"slider.label.from",comment:"Accessible label for the 'from value' input field in a range slider",message:"From"}):this.slot==="to"&&(this.ariaDescription=p.t({id:"slider.label.to",comment:"Accessible label for the 'to value' input field in a range slider",message:"To"}))),"anchorName"in document.documentElement.style)await this.updateComplete;else{const a=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:t}]=await Promise.all([ie(()=>import(`${a}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
        /*
      ...
      <div class="w-slider-thumb">
        ...
        <input
          ...
          @blur="${this.#a}"
          @input="${this.#o}"
          @keydown="${this.openEnded?this.#n:c}"
        />
    ...
    `}}l([s({attribute:"aria-label"})],n.prototype,"ariaLabel");l([s({attribute:"aria-description"})],n.prototype,"ariaDescription");l([s({reflect:!0})],n.prototype,"name");l([s({reflect:!0})],n.prototype,"value");l([s({type:Boolean,reflect:!0})],n.prototype,"disabled");l([s({type:Boolean,reflect:!0})],n.prototype,"invalid");l([s({attribute:!1,reflect:!1})],n.prototype,"openEnded");l([s({reflect:!0})],n.prototype,"placeholder");l([h()],n.prototype,"markers");l([h()],n.prototype,"required");l([h()],n.prototype,"step");l([h()],n.prototype,"min");l([h()],n.prototype,"max");l([h()],n.prototype,"suffix");l([s({attribute:!1})],n.prototype,"valueFormatter");l([s({attribute:!1})],n.prototype,"tooltipFormatter");l([s({attribute:!1})],n.prototype,"labelFormatter");l([P('input[type="range"]')],n.prototype,"range");l([P(".w-slider-thumb__tooltip-target")],n.prototype,"tooltipTarget");l([P("w-textfield")],n.prototype,"textfield");l([h()],n.prototype,"_showTooltip");l([h()],n.prototype,"_inputHasFocus");l([h()],n.prototype,"_hiddenTextfield");customElements.get("w-slider-thumb")||customElements.define("w-slider-thumb",n);var U=Object.freeze,be=Object.defineProperty,b=(o,e)=>U(be(o,"raw",{value:U(o.slice())})),W,J,G,Q,Y,Z;const{events:we,args:ge,argTypes:ve}=ae("w-slider"),xe={title:"Forms/Slider and Range Slider",args:ge,argTypes:ve,parameters:{actions:{handles:we}}},g={render(){return i`
    ...
    `])))}},z={render({locale:o}){return i(Z||(Z=b([`
      ...
      <\/script>
    `])),o)}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render() {
    return html\`
      <w-slider label="Single" min="0" max="100">
        <w-slider-thumb name="value"></w-slider-thumb>

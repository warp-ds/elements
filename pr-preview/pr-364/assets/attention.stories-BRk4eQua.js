import{g as w,x as e}from"./iframe-BIDC9Dap.js";import{s as c,p as v}from"./utilities-kSBEC5fV.js";import"./index-BDBZqCnv.js";import"./index-BWrPeKho.js";var p=Object.freeze,y=Object.defineProperty,l=(t,g)=>p(y(t,"raw",{value:p(t.slice())})),d,u,m,b;const{events:E,args:I,argTypes:f}=w("w-attention"),T={title:"Overlays/Attention",render(t){return e`
      <w-attention ${c(v(t))}>
        <w-button
          ${c({id:t.buttonId})}
          variant="secondary"

import{g as i,x as o}from"./iframe-RCo1O8y5.js";import{s as n,p}from"./utilities-GBY6CYSQ.js";const{events:d,args:m,argTypes:g}=i("w-card"),f={title:"Navigation/Card",render(c){return o`
      <w-card ${n(p(c))}>

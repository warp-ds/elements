import{g as t,k as l}from"./iframe-BpPs0TWn.js";import{s as c,p as d}from"./utilities-B2ig1q7l.js";const{events:u,args:p,argTypes:i}=t("w-box"),g={title:"Layout/Box",render:n=>l`
      <w-box ${c(d(n))}>
        <h3>Box Content</h3>

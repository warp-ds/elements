import{g as w,x as e}from"./iframe-TWMkrlVy.js";import{s as c,p as v}from"./utilities-DbwUP7ur.js";import"./index-DI-jFYgR.js";import"./index-EMGxM2_Z.js";var p=Object.freeze,y=Object.defineProperty,l=(t,g)=>p(y(t,"raw",{value:p(t.slice())})),d,u,m,b;const{events:E,args:I,argTypes:f}=w("w-attention"),T={title:"Overlays/Attention",render(t){return e`
      <w-attention ${c(v(t))}>
        <w-button
          ${c({id:t.buttonId})}
          variant="secondary"

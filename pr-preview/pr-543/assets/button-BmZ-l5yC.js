import{a as u,r as b,i as d,q as h,l as g,A as p,b as i,n as o}from"./iframe-3K92GTKn.js";import"./link-CnfjC3_G.js";import{o as w}from"./if-defined-CAej0p-0.js";import{F as k}from"./FormControlMixin-DJnJZbro.js";const x=JSON.parse('{"button.aria.loading":["Indlæser..."]}'),f=JSON.parse('{"button.aria.loading":["Loading..."]}'),y=JSON.parse('{"button.aria.loading":["Ladataan..."]}'),m=JSON.parse('{"button.aria.loading":["Laster..."]}'),_=JSON.parse('{"button.aria.loading":["Laddar ..."]}'),$=u`
  :host {
...
`;var S=Object.defineProperty,t=(n,e,s,z)=>{for(var a=void 0,c=n.length-1,l;c>=0;c--)(l=n[c])&&(a=l(e,s,a)||a);return a&&S(e,s,a),a};const v=["primary","secondary","negative","negativeQuiet","utility","pill","link","quiet","utilityQuiet","overlay","overlayInverted","overlayQuiet","overlayInvertedQuiet"];class r extends k(d){static{this.styles=[b,$]}static{this.shadowRootOptions={...d.shadowRootOptions,delegatesFocus:!0}}#r=null;updated(e){e.has("value")&&this.setValue(this.value)}constructor(){super(),h(f,m,y,x,_),this.ariaValueTextLoading=g.t({id:"button.aria.loading",message:"Loading...",comment:"Screen reader message for buttons that are loading"})}connectedCallback(){super.connectedCallback();const e=this.variant||"secondary";if(!v.includes(e))throw new Error(`Invalid "variant" attribute. Set its value to one of the following:

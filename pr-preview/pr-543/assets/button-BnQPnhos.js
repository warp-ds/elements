import{a as u,q as b,l as h,r as g,i as d,A as p,b as i,n as o}from"./iframe-DasUocmV.js";import"./link-BDKvbOTj.js";import{o as w}from"./if-defined-CLjcRB8W.js";import{F as k}from"./FormControlMixin-DJnJZbro.js";const x=JSON.parse('{"button.aria.loading":["Indlæser..."]}'),f=JSON.parse('{"button.aria.loading":["Loading..."]}'),y=JSON.parse('{"button.aria.loading":["Ladataan..."]}'),m=JSON.parse('{"button.aria.loading":["Laster..."]}'),_=JSON.parse('{"button.aria.loading":["Laddar ..."]}'),$=u`
  :host {

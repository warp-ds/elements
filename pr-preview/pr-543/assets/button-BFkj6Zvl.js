import{a as v,r as b,i as d,q as g,l as h,A as w,b as i,k as p,n as r}from"./iframe-DkosRuhr.js";import"./link-C0bhGeK_.js";import{F as k}from"./FormControlMixin-DJnJZbro.js";const x=JSON.parse('{"button.aria.loading":["Indlæser..."]}'),y=JSON.parse('{"button.aria.loading":["Loading..."]}'),f=JSON.parse('{"button.aria.loading":["Ladataan..."]}'),m=JSON.parse('{"button.aria.loading":["Laster..."]}'),_=JSON.parse('{"button.aria.loading":["Laddar ..."]}'),q=v`
  .w-button,
  .w-button--secondary {
...
`;var $=Object.defineProperty,e=(n,t,c,S)=>{for(var a=void 0,l=n.length-1,s;l>=0;l--)(s=n[l])&&(a=s(t,c,a)||a);return a&&$(t,c,a),a};const u=["primary","secondary","negative","negativeQuiet","utility","pill","link","quiet","utilityQuiet","overlay","overlayInverted","overlayQuiet","overlayInvertedQuiet"];class o extends k(d){static{this.styles=[b,q]}static{this.shadowRootOptions={...d.shadowRootOptions,delegatesFocus:!0}}#t=null;updated(t){t.has("value")&&this.setValue(this.value)}constructor(){super(),g(y,m,f,x,_),this.ariaValueTextLoading=h.t({id:"button.aria.loading",message:"Loading...",comment:"Screen reader message for buttons that are loading"})}connectedCallback(){super.connectedCallback();const t=this.variant||"secondary";if(!u.includes(t))throw new Error(`Invalid "variant" attribute. Set its value to one of the following:
${u.join(", ")}.`);this.#t=this.value}firstUpdated(){this.autofocus&&!this.href&&setTimeout(()=>this.focus(),0)}_handleButtonClick(){this.type==="submit"?this.internals.form.requestSubmit():this.type==="reset"&&this.internals.form.reset()}resetFormControl(){this.value=this.#t}render(){const t=this.variant||"secondary";return i` ${this.href?i`
          <w-link
            href=${this.href}
            target=${this.target}

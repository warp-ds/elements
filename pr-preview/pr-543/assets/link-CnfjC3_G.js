import{a as s,i as d,r as b,A as u,b as h,n as o}from"./iframe-3K92GTKn.js";const g=s`
...
`;var w=Object.defineProperty,e=(a,c,n,k)=>{for(var t=void 0,i=a.length-1,v;i>=0;i--)(v=a[i])&&(t=v(c,n,t)||t);return t&&w(c,n,t),t};const l=["primary","secondary","negative","negativeQuiet","utility","utilityQuiet","quiet","link","overlay","overlayInverted","overlayQuiet","overlayInvertedQuiet"];class r extends d{static{this.shadowRootOptions={...d.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[b,g]}connectedCallback(){if(super.connectedCallback(),this.variant&&!l.includes(this.variant))throw new Error(`Invalid "variant" attribute. Set its value to one of the following:
${l.join(", ")}.`)}firstUpdated(){this.autofocus&&setTimeout(()=>this.focus(),0)}render(){return h`
      <a
        href="${this.href}"
        target="${this.target}"
        rel="${this.target==="_blank"?this.rel||"noopener":u}"
        tabindex="0"
      >
        <slot></slot>
      </a>

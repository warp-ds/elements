import{a as u,r as b,i as d,q as h,l as g,A as p,b as i,n as o}from"./iframe-X-4LgTk-.js";import"./link-CQ8Krih3.js";import{o as w}from"./if-defined-XLeATwlj.js";import{F as k}from"./FormControlMixin-DJnJZbro.js";const x=JSON.parse('{"button.aria.loading":["Indlæser..."]}'),f=JSON.parse('{"button.aria.loading":["Loading..."]}'),y=JSON.parse('{"button.aria.loading":["Ladataan..."]}'),m=JSON.parse('{"button.aria.loading":["Laster..."]}'),_=JSON.parse('{"button.aria.loading":["Laddar ..."]}'),$=u`
  :host {

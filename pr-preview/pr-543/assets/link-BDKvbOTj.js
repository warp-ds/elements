import{a as s,i as l,r as u,A as b,b as h,n as o}from"./iframe-DasUocmV.js";const g=s`
...
`;var w=Object.defineProperty,e=(a,c,n,k)=>{for(var t=void 0,i=a.length-1,v;i>=0;i--)(v=a[i])&&(t=v(c,n,t)||t);return t&&w(c,n,t),t};const d=["primary","secondary","negative","negativeQuiet","utility","utilityQuiet","quiet","link","overlay","overlayInverted","overlayQuiet","overlayInvertedQuiet"];class r extends l{constructor(){super(...arguments),this.autofocus=!1,this.small=!1,this.disabled=!1,this.fullWidth=!1}static{this.shadowRootOptions={...l.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[u,g]}connectedCallback(){if(super.connectedCallback(),this.variant&&!d.includes(this.variant))throw new Error(`Invalid "variant" attribute. Set its value to one of the following:
${d.join(", ")}.`)}firstUpdated(){this.autofocus&&setTimeout(()=>this.focus(),0)}render(){return h`
      <a
        href="${this.href}"
        target="${this.target}"
        rel="${this.target==="_blank"?this.rel||"noopener":b}"
        tabindex="0"
      >
        <slot></slot>
      </a>
    `}}e([o({type:Boolean,reflect:!0})],r.prototype,"autofocus");e([o({reflect:!0})],r.prototype,"variant");e([o({type:Boolean,reflect:!0})],r.prototype,"small");e([o({reflect:!0})],r.prototype,"href");e([o({type:Boolean,reflect:!0})],r.prototype,"disabled");e([o({reflect:!0})],r.prototype,"target");e([o({reflect:!0})],r.prototype,"rel");e([o({attribute:"full-width",type:Boolean,reflect:!0})],r.prototype,"fullWidth");customElements.get("w-link")||customElements.define("w-link",r);

...
`;var fe=Object.defineProperty,l=(o,e,r,a)=>{for(var t=void 0,u=o.length-1,f;u>=0;u--)(f=o[u])&&(t=f(e,r,t)||t);return t&&fe(e,r,t),t};class n extends se(C){constructor(){super(...arguments),this.disabled=!1,this.invalid=!1,this.openEnded=!1,this.suffix="",this._showTooltip=!1,this._inputHasFocus=!1,this._hiddenTextfield=!1,this.#e=null,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...C.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[ee,ce,pe]}#e;resetFormControl(){this.value=this.#e}#r(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#a(){this._showTooltip=!1}#o(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#t(e){this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:e,slot:this.slot}}))}async updateFieldAfterValidation(){const e=this.shadowRoot.querySelector("w-textfield");await this.#i(e.value,!0)}async#i(e,r){const a=this.suffix??"";let t=Number.parseInt(e);if(this.openEnded&&!r&&this.step&&!(this.slot==="to"&&t>=Number(this.max)-1||this.slot==="from"&&t<=Number(this.min)+1)){const N=1/this.step;t=Math.round(t*N)/N,e=t.toString()}const u=Number.parseInt(this.max),f=Number.parseInt(this.min);if(!this.openEnded&&(t>u||t<f))return this.#t(p.t({id:"slider.error.out_of_bounds",message:"Value must be between {min} and {max}",values:{min:`${this.min} ${a}`.trim(),max:`${this.max} ${a}`.trim()}})),{shouldCancel:!0};e===""&&this.required&&this.#t(p.t({id:"slider.error.required",message:"This field is required"})),this.value=e;const I=e===this.max||e===this.min;let A=!1;if(this.slot){const H=this.parentElement.querySelector('w-slider-thumb[slot="to"]'),N=this.parentElement.querySelector('w-slider-thumb[slot="from"]'),X=H.textfield.value||this.max,B=N.textfield.value||this.min,L=Number.parseInt(X),j=Number.parseInt(B),K=p.t({id:"slider.error.overlap",message:"The maximum value cannot be less than the minimum"});if(this.slot==="from"){const g=this.openEnded&&L>u?L:Math.min(L,this.openEnded?u-1:u);t>g&&(A=!0,this.openEnded&&I?this.value=String(g):this.value=X,r&&(this.#t(K),await this.updateComplete,this.textfield.value=e))}else{const g=this.openEnded&&j<f?j:Math.max(Number.parseInt(B),this.openEnded?f+1:f);t<g&&(A=!0,this.openEnded&&I?this.value=String(g):this.value=B,r&&(this.#t(K),await this.updateComplete,this.textfield.value=e))}}return A?{shouldCancel:!0}:(this.#t(""),this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.openEnded&&!r&&I?"":e,this.shadowRoot.querySelector("w-attention").handleDone(),{shouldCancel:!1})}async#s(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const a=e.currentTarget.value;return(await this.#i(a,r)).shouldCancel?(e.preventDefault(),!1):!0}async#n(e){if(e.key!=="ArrowLeft"&&e.key!=="ArrowRight")return;const r=Number(this.range.value),a=this.step||1;let t;e.key==="ArrowLeft"?t=r-a:t=r+a,t=Math.min(Math.max(t,Number(this.min)),Number(this.max)),(await this.#i(t.toString(),!1)).shouldCancel&&e.preventDefault()}async connectedCallback(){if(super.connectedCallback(),this.#e=this.value,this.setValue(this.value),this.slot&&!this.ariaDescription&&(this.slot==="from"?this.ariaDescription=p.t({id:"slider.label.from",comment:"Accessible label for the 'from value' input field in a range slider",message:"From"}):this.slot==="to"&&(this.ariaDescription=p.t({id:"slider.label.to",comment:"Accessible label for the 'to value' input field in a range slider",message:"To"}))),"anchorName"in document.documentElement.style)await this.updateComplete;else{const a=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:t}]=await Promise.all([ie(()=>import(`${a}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
        /*
      ...
      <div class="w-slider-thumb">
        ...
        <input
          ...
          min="${this.min}"
          max="${this.max}"
          step="${R(!this.openEnded&&this.step?this.step:void 0)}"
          ?disabled="${this.disabled}"
          @mousedown="${this.#r}"
          @mouseup="${this.#a}"
          @touchstart="${this.#r}"
        ...
        <w-textfield
          aria-label="${this.ariaLabel}"
          aria-description="${R(this.ariaDescriptionText)}"

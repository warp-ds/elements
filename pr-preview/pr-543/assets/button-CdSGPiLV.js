import{a as c,r as b,i as u,q as g,l as h,A as w,b as i,k as p,n as r}from"./iframe-rAA0jfaC.js";import"./link-C_vv8AVO.js";import{F as k}from"./FormControlMixin-DJnJZbro.js";const x=JSON.parse('{"button.aria.loading":["Indlæser..."]}'),y=JSON.parse('{"button.aria.loading":["Loading..."]}'),f=JSON.parse('{"button.aria.loading":["Ladataan..."]}'),m=JSON.parse('{"button.aria.loading":["Laster..."]}'),_=JSON.parse('{"button.aria.loading":["Laddar ..."]}'),q=c`
  .w-button,
  .w-button--secondary {

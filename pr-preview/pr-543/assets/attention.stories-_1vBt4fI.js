import{g as w,b as e}from"./iframe-3K92GTKn.js";import{s as c,p as v}from"./utilities-CS24hM_c.js";import"./attention-CsLXziVA.js";import"./button-BmZ-l5yC.js";var p=Object.freeze,y=Object.defineProperty,l=(t,g)=>p(y(t,"raw",{value:p(t.slice())})),d,u,m,b;const{events:E,args:I,argTypes:f}=w("w-attention"),T={title:"Overlays/Attention",render(t){return e`
      <w-attention ${c(v(t))}>
        <w-button
          ${c({id:t.buttonId})}
          variant="secondary"

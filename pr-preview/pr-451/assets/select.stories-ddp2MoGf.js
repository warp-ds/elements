import{a as O,i as D,p as R,r as A,x as c,j as S,w as k,b as T,n as o,g as F}from"./iframe-Cm5Fr1Rf.js";import{s as y,p as x}from"./utilities-b8ymJw4e.js";import{o as C}from"./if-defined-hWpo5vyz.js";import"./chevron-down-16-DhQC5FIt.js";import{F as I}from"./FormControlMixin-DJnJZbro.js";const L=JSON.parse('{"select.label.optional":["(valgfrit)"]}'),W=JSON.parse('{"select.label.optional":["(optional)"]}'),j=JSON.parse('{"select.label.optional":["(vapaaehtoinen)"]}'),P=JSON.parse('{"select.label.optional":["(valgfritt)"]}'),E=JSON.parse('{"select.label.optional":["(valfritt)"]}'),H=O`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.focus\\:\\[--w-outline-offset\\:-2px\\]:focus{--w-outline-offset:-2px}.bg-transparent{background-color:#0000}.appearance-none{-webkit-appearance:none;appearance:none}.border-0{border-width:0}.border-1{border-width:1px}.rounded-4{border-radius:4px}.caret-current{caret-color:currentColor}.opacity-25{opacity:.25}.block,.before\\:block:before{display:block}.before\\:hidden:before{display:none}.focusable:focus{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:focus-visible{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:not(:focus-visible){outline:none}.outline-\\[--w-s-color-border-negative\\]\\!{outline-color:var(--w-s-color-border-negative)!important}.bottom-0{bottom:0}.right-0{right:0}.before\\:bottom-0:before{bottom:0}.before\\:right-0:before{right:0}.top-\\[30\\%\\]{top:30%}.absolute{position:absolute}.relative{position:relative}.static{position:static}.before\\:absolute:before{position:absolute}.s-bg{background-color:var(--w-s-color-background)}.s-bg-disabled-subtle{background-color:var(--w-s-color-background-disabled-subtle)}.s-text{color:var(--w-s-color-text)}.s-text-disabled{color:var(--w-s-color-text-disabled)}.s-text-negative{color:var(--w-s-color-text-negative)}.s-text-subtle{color:var(--w-s-color-text-subtle)}.s-icon{color:var(--w-s-color-icon)}.s-border-disabled{border-color:var(--w-s-color-border-disabled)}.s-border-negative{border-color:var(--w-s-color-border-negative)}.s-border-strong{border-color:var(--w-s-color-border-strong)}.hover\\:s-border-disabled:hover{border-color:var(--w-s-color-border-disabled)}.hover\\:s-border-negative-hover:hover{border-color:var(--w-s-color-border-negative-hover)}.hover\\:s-border-strong-hover:hover{border-color:var(--w-s-color-border-strong-hover)}.active\\:s-border-active:active{border-color:var(--w-s-color-border-active)}.active\\:s-border-disabled:active{border-color:var(--w-s-color-border-disabled)}.h-full{height:100%}.w-32{width:3.2rem}.w-full{width:100%}.before\\:h-full:before{height:100%}.before\\:w-32:before{width:3.2rem}.mb-0{margin-bottom:0}.mt-4{margin-top:.4rem}.py-12{padding-top:1.2rem;padding-bottom:1.2rem}.pb-4{padding-bottom:.4rem}.pl-0{padding-left:0}.pl-8{padding-left:.8rem}.pr-32{padding-right:3.2rem}.cursor-pointer{cursor:pointer}.antialiased{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;font-smoothing:grayscale}.font-bold{font-weight:700}.font-normal{font-weight:400}.pointer-events-none,.before\\:pointer-events-none:before{pointer-events:none}.text-m{font-size:var(--w-font-size-m);line-height:var(--w-line-height-m)}.text-s{font-size:var(--w-font-size-s);line-height:var(--w-line-height-s)}.text-xs{font-size:var(--w-font-size-xs);line-height:var(--w-line-height-xs)}`;var J=Object.defineProperty,t=(l,e,p,i)=>{for(var a=void 0,s=l.length-1,d;s>=0;s--)(d=l[s])&&(a=d(e,p,a)||a);return a&&J(e,p,a),a};const n={base:"block text-m mb-0 py-12 pr-32 rounded-4 w-full focusable focus:[--w-outline-offset:-2px] appearance-none cursor-pointer caret-current",default:"s-text s-bg pl-8 border-1 s-border-strong hover:s-border-strong-hover active:s-border-active",disabled:"s-text-disabled s-bg-disabled-subtle pl-8 border-1 s-border-disabled hover:s-border-disabled active:s-border-disabled pointer-events-none",invalid:"s-text s-bg pl-8 border-1 s-border-negative hover:s-border-negative-hover active:s-border-active outline-[--w-s-color-border-negative]!",readOnly:"s-text bg-transparent pl-0 border-0 pointer-events-none before:hidden",wrapper:"relative",selectWrapper:"relative before:block before:absolute before:right-0 before:bottom-0 before:w-32 before:h-full before:pointer-events-none ",chevron:"block absolute top-[30%] right-0 bottom-0 w-32 h-full s-icon pointer-events-none cursor-pointer",chevronDisabled:"opacity-25"},_={base:"antialiased block relative text-s font-bold pb-4 cursor-pointer s-text",optional:"pl-8 font-normal text-s s-text-subtle"},B={base:"text-xs mt-4 block",color:"s-text-subtle",colorInvalid:"s-text-negative"};class r extends I(D){constructor(){super(),this._setValue=e=>{this.value=e,this.setValue(e)},R(W,P,j,L,E)}static{this.styles=[A,H,O`
    ...
    `]}connectedCallback(){super.connectedCallback(),(this.autofocus||this.autoFocus)&&this.shadowRoot.querySelector("select").focus();const p=Array.from(this.children).filter(i=>i.tagName.toLowerCase()==="option"||i.tagName.toLowerCase()==="w-option").map(i=>{const a=i.getAttribute("value")??"",s=i.textContent??"",d=i.hasAttribute("selected"),$=i.hasAttribute("disabled");return d&&this._setValue(a),c`<option
        value="${a}"
        ?selected=${d}
        ?disabled=${$}
      >
        ${s}
      </option>`});this._options=p}handleKeyDown(e){(this.readonly||this.readOnly)&&(e.key===" "||e.key==="ArrowDown"||e.key==="ArrowUp")&&e.preventDefault()}get#o(){return S([n.base,!this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&n.default,this.invalid&&n.invalid,this.disabled&&n.disabled,(this.readonly||this.readOnly)&&n.readOnly])}get#t(){return S([B.base,this.invalid?B.colorInvalid:B.color])}get#s(){return S([n.chevron,this.disabled&&n.chevronDisabled])}get#e(){return"select_id"}get#r(){return this.hint?`${this.#e}__hint`:void 0}onChange({target:e}){this._setValue(e.value);const p=new CustomEvent("change",{detail:e.value}),a=Array.from(this.children).filter(s=>s.tagName.toLowerCase()==="option"||s.tagName.toLowerCase()==="w-option").map(s=>{const d=s.getAttribute("value")??"",$=d===e.value,N=s.textContent??"",z=s.hasAttribute("disabled");return c`<option
        value="${d}"
        ?selected=${$}
        ?disabled=${z}
      >
        ${N}
      </option>`});this._options=a,this.dispatchEvent(p)}render(){return c`<div class="${n.wrapper}">
      ...
      ${k(this.helpText||this.always||this.invalid,()=>c`<div id="${this.#r}" class="${this.#t}">
    ...
    `},args:Y,argTypes:K,parameters:{actions:{handles:V}}},b={args:{label:"Berries"}},u={args:{label:"Berries",always:!0,hint:"We assume this is your jam preference"}},v={args:{label:"Berries",invalid:!0,hint:"Wrong choice"}},h={args:{label:"Berries",disabled:!0}},f={args:{label:"Berries","read-only":!0}},w={render(l){return c`
    ...
    `}},g={args:{label:"Berries",optional:!0}},m={args:{label:"Berries"},render(l){return c`
      <w-select ${y(x(l))}>
...
}`,...m.parameters?.docs?.source}}};const q=["Default","HelpText","Invalid","Disabled","ReadOnly","NoLabel","Optional","Placeholder"],ee=Object.freeze(Object.defineProperty({__proto__:null,Default:b,Disabled:h,HelpText:u,Invalid:v,NoLabel:w,Optional:g,Placeholder:m,ReadOnly:f,__namedExportsOrder:q,default:M},Symbol.toStringTag,{value:"Module"}));export{b as D,u as H,v as I,w as N,g as O,m as P,f as R,ee as S,h as a};

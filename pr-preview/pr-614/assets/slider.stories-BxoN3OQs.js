import{n as e,r as t}from"./chunk-BneVvdWh.js";import{n,t as r}from"./preload-helper-CV6hqhE5.js";import{m as i,n as a,r as o,s,t as c}from"./lit-C07f_Bua.js";import{n as l,t as u}from"./dist-WJrQKcXy.js";import{n as d,t as f}from"./dist-CaTrbEV7.js";import{t as p}from"./__uno-Cy9G7Sgf.js";import{a as m,i as h,n as g,o as _,r as v,t as y}from"./decorate-BZxMavXy.js";import{n as ee,t as te}from"./class-map-DFBsEYAd.js";import{r as ne,t as re}from"./i18n-BMPIj3pm.js";import{n as b,t as x}from"./styles-BM5RxtAH.js";import{n as ie,t as ae}from"./form-control-Dpu9R3Zk.js";import{t as oe}from"./affix-TXORPhRv.js";import{n as S,t as se}from"./if-defined-C6phCcrk.js";import{t as ce}from"./attention-CzFE9nR_.js";import{n as le,t as C}from"./taggedTemplateLiteral-BSp0U_4f.js";import{t as ue}from"./textfield-CC-KfAGP.js";var w,de=e((()=>{w=JSON.parse(`{"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),fe,pe=e((()=>{fe=JSON.parse(`{"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),me,he=e((()=>{me=JSON.parse(`{"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),T,ge=e((()=>{T=JSON.parse(`{"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),E,_e=e((()=>{E=JSON.parse(`{"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})),D,ve=e((()=>{c(),D=i`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;

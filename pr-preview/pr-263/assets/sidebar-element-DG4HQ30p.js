 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function mt(t,e){return(r,o,i)=>{const s=n=>n.renderRoot?.querySelector(t)??null;return ga(r,o,{get(){return s(this)}})}}/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Bi=(t,e,r)=>{const o=new Map;for(let i=e;i<=r;i++)o.set(t[i],i);return o},Up=Ar(class extends Or{constructor(t){if(super(t),t.type!==De.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,r){let o;r===void 0?r=e:e!==void 0&&(o=e);const i=[],s=[];let n=0;for(const l of t)i[n]=o?o(l,n):n,s[n]=r(l,n),n++;return{values:s,keys:i}}render(t,e,r){return this.dt(t,e,r).values}update(t,[e,r,o]){const i=bp(t),{values:s,keys:n}=this.dt(e,r,o);if(!Array.isArray(i))return this.ut=n,s;const l=this.ut??=[],a=[];let d,p,c=0,f=i.length-1,u=0,b=s.length-1;for(;c<=f&&u<=b;)if(i[c]===null)c++;else if(i[f]===null)f--;else if(l[c]===n[u])a[u]=Qe(i[c],s[u]),c++,u++;else if(l[f]===n[b])a[b]=Qe(i[f],s[b]),f--,b--;else if(l[c]===n[b])a[b]=Qe(i[c],s[b]),Lt(t,a[b+1],i[c]),c++,b--;else if(l[f]===n[u])a[u]=Qe(i[f],s[u]),Lt(t,i[c],i[f]),f--,u++;else if(d===void 0&&(d=Bi(n,u,b),p=Bi(l,c,f)),d.has(l[c]))if(d.has(l[f])){const g=p.get(n[u]),m=g!==void 0?i[g]:null;if(m===null){const E=Lt(t,i[c]);Qe(E,s[u]),a[u]=E}else a[u]=Qe(m,s[u]),Lt(t,i[c],m),i[g]=null;u++}else so(i[f]),f--;else so(i[c]),c++;for(;u<=b;){const g=Lt(t,a[b+1]);Qe(g,s[u]),a[u++]=g}for(;c<=f;){const g=i[c++];g!==null&&so(g)}return this.ut=n,wn(t,a),ve}});class $n extends oe{static styles=[oe.styles,F`
      :host {
        display: block;
      }
    ...
    `];render(){return w`<div aria-hidden=${J(this.show?void 0:"true")}>${this._removeElement?w``:w`<slot></slot>`}</div>`}}customElements.get("w-expand-transition")||customElements.define("w-expand-transition",Gp);class eg extends oe{static properties={level:{type:Number}};static styles=[oe.styles];get _markup(){return`<h${this.level}
    style="margin: 0; font-weight: unset; font-size: unset; line-height: unset;"
  >
    <slot></slot>
  </h${this.level}>
`}render(){return this.level?Co(this._markup):w`<slot></slot>`}}customElements.get("w-unstyled-heading")||customElements.define("w-unstyled-heading",eg);var tg={},rg=JSON.parse('{"icon.title.bag":["Veske"]}'),og=JSON.parse('{"icon.title.bag":["Handbag"]}'),ig=JSON.parse('{"icon.title.bag":["Käsilaukku"]}'),sg=JSON.parse('{"icon.title.bag":["Håndtaske"]}'),ng=JSON.parse('{"icon.title.bag":["Handväska"]}'),On=["en","nb","fi","da","sv"],Ln="en",ag=()=>{var t;let e;switch((t=process==null?void 0:tg)==null?void 0:t.NMP_BRAND){case"FINN":e="nb";break;case"TORI":e="fi";break;case"BLOCKET":e="sv";break;case"DBA":e="da";break;default:e="en"}return e},Nn=()=>{var t;const e=(t=document?.location)==null?void 0:t.hostname;return e?.includes("finn")?"nb":e.includes("tori")?"fi":e.includes("blocket")?"sv":e.includes("dba")?"da":Ln},co=t=>On.find(e=>t===e||t.toLowerCase().includes(e))||Nn();function lg(){var t;if(typeof window>"u"){const e=ag();return co(e)}try{const e=(t=document?.documentElement)==null?void 0:t.lang,r=Nn();return On.includes(e)?co(e??r):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),co(r))}catch(e){return console.warn("could not detect locale, falling back to source locale",e),Ln}}var cg=(t,e,r,o,i,s)=>t==="nb"?r:t==="fi"?o:t==="da"?i:t==="sv"?s:e,dg=(t,e,r,o,i)=>{const s=lg(),n=cg(s,t,e,r,o,i);x.load(s,n),x.activate(s)};dg(og,rg,ig,sg,ng);var ug=class extends P{render(){const t=x.t({message:"Handbag",id:"icon.title.bag",comment:"Title for bag icon"});return pe`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-bag-16-part">${he(`<title>${t}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M14.043 8.433a1.76 1.76 0 0 0-.647-1.029A1.93 1.93 0 0 0 12.211 7H3.788c-.432 0-.851.143-1.185.404a1.76 1.76 0 0 0-.647 1.03l-.921 4.444a1.7 1.7 0 0 0 .39 1.473c.174.203.394.366.644.479.249.112.521.17.797.17h10.267c.276 0 .548-.058.797-.17.25-.113.47-.276.645-.479s.3-.44.368-.695a1.7 1.7 0 0 0 .021-.778z"></path><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11 15V3.5c0-.663-.317-1.299-.88-1.768C9.559 1.263 8.796 1 8 1s-1.56.263-2.122.732C5.316 2.202 5 2.837 5 3.5V15"></path></svg>`}};customElements.get("w-icon-bag-16")||customElements.define("w-icon-bag-16",ug);Ir&&(window.WarpToastContainer=$n,window.toast=Fp,window.updateToast=Vp,window.removeToast=Hp);const hg={heading:{title:"Warp Elements",href:"/elements/"},pages:[{title:"Action",items:[{title:"Button",href:"/elements/button.html"},{title:"Pill",href:"/elements/pill.html"}]},{title:"Feedback Indicators",items:[{title:"Alert",href:"/elements/alert.html"}]},{title:"Forms",items:[{title:"Dead toggle",href:"/elements/deadtoggle.html"},{title:"Checkbox",href:"/elements/checkbox.html"},{title:"Radio",href:"/elements/radio.html"},{title:"Select",href:"/elements/select.html"},{title:"Textfield",href:"/elements/textfield.html"}]},{title:"Layout",items:[{title:"Badge",href:"/elements/badge.html"},{title:"Box",href:"/elements/box.html"},{title:"Card",href:"/elements/card.html"},{title:"Expandable",href:"/elements/expandable.html"},{title:"Toast",href:"/elements/toast.html"}]},{title:"Navigation",items:[{title:"Breadcrumbs",href:"/elements/breadcrumbs.html"},{title:"Pagination",href:"/elements/pagination.html"}]},{title:"Overlays",items:[{title:"Attention",href:"/elements/attention.html"},{title:"Modal",href:"/elements/modal.html"}]}]};class pg extends oe{static styles=[oe.styles,F`
      .sidebar {
        width: 300px;
      }
    ...
    `];render(){const{heading:e,pages:r}=hg;return w`
    ...
    `}renderItems(e){return e.map(r=>w`
      ...
      `)}}customElements.define("sidebar-element",pg);

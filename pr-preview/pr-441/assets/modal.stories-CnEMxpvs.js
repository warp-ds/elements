import{x as i,r as E,a as S,i as k,b as w,s as j,u as A,p as q,E as M,n as d,k as z,g as B}from"./iframe-Cf85z9Ae.js";import{s as C,p as T}from"./utilities-BKBCcSou.js";import{e as v}from"./query-NYTjQBeo.js";const L=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},O=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const n of o.filter(a=>a.patchClose))n._close=()=>this.close()}};let N=class extends L(O(k)){render(){return i`
      <div class="footer">

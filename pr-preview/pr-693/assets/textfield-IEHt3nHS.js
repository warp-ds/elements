import{i as e}from"./preload-helper-xPQekRTU.js";import{Bt as t,C as n,D as r,Ht as i,Kt as a,Lt as o,O as s,Rt as c,Wt as l,_ as u,d,f,l as p,o as m,s as h,u as g,v as _}from"./iframe-CWK0u4Vh.js";import{n as v,t as y}from"./form-control-DtXadPi-.js";import{r as b,t as x}from"./if-defined-BpjwcMIv.js";var S,C=e((()=>{o(),S=l`
  .w-textfield {
...
`})),k,A,j=e((()=>{r(),y(),o(),u(),d(),x(),m(),C(),T(),O(),g(),k={base:`block text-m leading-m mb-0 px-8 py-12 rounded-4 w-full focusable focus:[--w-outline-offset:-2px] caret-current`,default:`border-1 s-text s-bg s-border-strong hover:s-border-strong-hover active:s-border-selected`,disabled:`border-1 s-text-disabled s-bg-disabled-subtle s-border-disabled pointer-events-none`,invalid:`border-1 s-text-negative s-bg s-border-negative hover:s-border-negative-hover outline-[--w-s-color-border-negative]!`,readOnly:`pl-0 bg-transparent pointer-events-none`,placeholder:`placeholder:s-text-placeholder`,suffix:`pr-40`,prefix:`pl-[var(--w-prefix-width,_40px)]`,textArea:`min-h-[42] sm:min-h-[45]`},A=class extends v(c){constructor(...e){super(...e),this.disabled=!1,this.invalid=!1,this.optional=!1,this.readOnly=!1,this.readonly=!1,this.required=!1,this._hasPrefix=!1,this._hasSuffix=!1,this.#t=void 0}static{this.shadowRootOptions={...c.shadowRootOptions,delegatesFocus:!0}}#e(e){e.key===`Enter`&&this.internals.form&&this.internals.form.requestSubmit()}updated(e){e.has(`value`)&&this.value!==void 0&&(this.setValue(this.value),this.formatter&&this.mask&&(this.mask.innerText=this.formatter(this.value)))}#t;firstUpdated(e){this.#t=this.value}resetFormControl(){this.value=this.#t}static{this.styles=[h,w,S,E,D]}get _inputstyles(){return s([k.base,this._hasSuffix&&k.suffix,this._hasPrefix&&k.prefix,!this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&k.default,this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&k.invalid,!this.invalid&&this.disabled&&!(this.readonly||this.readOnly)&&k.disabled,!this.invalid&&!this.disabled&&(this.readonly||this.readOnly)&&k.readOnly])}get _helptextstyles(){return`help-text`}get _label(){if(this.label)return i`<label for="${this._id}">${this.label}${this.optional?i`<span>(optional)</span>`:t}</label>`}get _helpId(){if(this.helpText)return`${this._id}__hint`}get _id(){return`textfield`}get _error(){if(this.invalid&&this._helpId)return this._helpId}handler(e){let{name:t,value:n}=e.currentTarget;this.value=n;let r=new CustomEvent(e.type,{detail:{name:t,value:n,target:e.target}});this.dispatchEvent(r)}prefixSlotChange(){this.renderRoot.querySelector(`slot[name=prefix]`).assignedElements().length&&(this._hasPrefix=!0)}suffixSlotChange(){this.renderRoot.querySelector(`slot[name=suffix]`).assignedElements().length&&(this._hasSuffix=!0)}render(){return i`
      ${this._label}
      <div
    ...
    `}},p([n({type:Boolean,reflect:!0})],A.prototype,`disabled`,void 0),p([n({type:Boolean,reflect:!0})],A.prototype,`invalid`,void 0),p([n({type:String,reflect:!0})],A.prototype,`label`,void 0),p([n({type:String,reflect:!0,attribute:`help-text`})],A.prototype,`helpText`,void 0),p([n({type:Boolean,reflect:!0})],A.prototype,`optional`,void 0),p([n({type:String,reflect:!0})],A.prototype,`size`,void 0),p([n({type:Number,reflect:!0})],A.prototype,`max`,void 0),p([n({type:Number,reflect:!0})],A.prototype,`min`,void 0),p([n({type:Number,reflect:!0,attribute:`min-length`})],A.prototype,`minLength`,void 0),p([n({type:Number,reflect:!0})],A.prototype,`minlength`,void 0),p([n({type:Number,reflect:!0,attribute:`max-length`})],A.prototype,`maxLength`,void 0),p([n({type:Number,reflect:!0})],A.prototype,`maxlength`,void 0),p([n({type:String,reflect:!0})],A.prototype,`pattern`,void 0),p([n({type:String,reflect:!0})],A.prototype,`placeholder`,void 0),p([n({type:Boolean,reflect:!0,attribute:`read-only`})],A.prototype,`readOnly`,void 0),p([n({type:Boolean,reflect:!0})],A.prototype,`readonly`,void 0),p([n({type:Boolean,reflect:!0})],A.prototype,`required`,void 0),p([n({type:String,reflect:!0})],A.prototype,`type`,void 0),p([n({type:String,reflect:!0})],A.prototype,`value`,void 0),p([n({type:String,reflect:!0})],A.prototype,`name`,void 0),p([n({type:Number,reflect:!0})],A.prototype,`step`,void 0),p([n({type:String,reflect:!0})],A.prototype,`autocomplete`,void 0),p([n({attribute:!1})],A.prototype,`formatter`,void 0),p([_(`.w-textfield__mask`)],A.prototype,`mask`,void 0),p([n({type:Boolean})],A.prototype,`_hasPrefix`,void 0),p([n({type:Boolean})],A.prototype,`_hasSuffix`,void 0),customElements.get(`w-textfield`)||customElements.define(`w-textfield`,A)}));export{j as t};
import{i as e}from"./preload-helper-xPQekRTU.js";import{Bt as t,C as n,D as r,Ht as i,J as a,Kt as o,Lt as s,O as c,Rt as l,Wt as u,_ as d,d as f,f as p,j as m,k as h,l as g,o as _,q as v,s as y,u as b,v as x}from"./iframe-BLckkfZ5.js";import{n as S,t as C}from"./form-control-DtXadPi-.js";import{r as w,t as T}from"./if-defined-Ettba3Hg.js";var E,D=e((()=>{E=JSON.parse(`{"textfield.label.optional":["(valgfri)"]}`)})),O,k=e((()=>{O=JSON.parse(`{"textfield.label.optional":["(optional)"]}`)})),A,j=e((()=>{A=JSON.parse(`{"textfield.label.optional":["(valinnainen)"]}`)})),M,N=e((()=>{M=JSON.parse(`{"textfield.label.optional":["(valgfritt)"]}`)})),P,F=e((()=>{P=JSON.parse(`{"textfield.label.optional":["(valfritt)"]}`)})),I,L=e((()=>{s(),I=u`
  .w-textfield {
...
`})),U,W,G=e((()=>{r(),a(),C(),s(),d(),f(),T(),m(),_(),D(),k(),j(),N(),F(),L(),z(),H(),b(),U={base:`block text-m leading-m mb-0 px-8 py-12 rounded-4 w-full focusable focus:[--w-outline-offset:-2px] caret-current`,default:`border-1 s-text s-bg s-border-strong hover:s-border-strong-hover active:s-border-selected`,disabled:`border-1 s-text-disabled s-bg-disabled-subtle s-border-disabled pointer-events-none`,invalid:`border-1 s-text-negative s-bg s-border-negative hover:s-border-negative-hover outline-[--w-s-color-border-negative]!`,readOnly:`pl-0 bg-transparent pointer-events-none`,placeholder:`placeholder:s-text-placeholder`,suffix:`pr-40`,prefix:`pl-[var(--w-prefix-width,_40px)]`,textArea:`min-h-[42] sm:min-h-[45]`},W=class extends S(l){static{this.shadowRootOptions={...l.shadowRootOptions,delegatesFocus:!0}}constructor(){super(),this.disabled=!1,this.invalid=!1,this.optional=!1,this.readOnly=!1,this.readonly=!1,this.required=!1,this._hasPrefix=!1,this._hasSuffix=!1,this.#t=void 0,h(O,M,A,E,P)}#e(e){e.key===`Enter`&&this.internals.form&&this.internals.form.requestSubmit()}updated(e){e.has(`value`)&&this.value!==void 0&&(this.setValue(this.value),this.formatter&&this.mask&&(this.mask.innerText=this.formatter(this.value)))}#t;firstUpdated(e){this.#t=this.value}resetFormControl(){this.value=this.#t}static{this.styles=[y,R,I,B,V]}get _inputstyles(){return c([U.base,this._hasSuffix&&U.suffix,this._hasPrefix&&U.prefix,!this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&U.default,this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&U.invalid,!this.invalid&&this.disabled&&!(this.readonly||this.readOnly)&&U.disabled,!this.invalid&&!this.disabled&&(this.readonly||this.readOnly)&&U.readOnly])}get _helptextstyles(){return`help-text`}get _label(){if(this.label)return i`<label for="${this._id}">${this.label}${this.optional?i`
              <span>
                ${v._({id:`textfield.label.optional`,message:`(optional)`,comment:`Shown behind label when marked as optional`})}
              </span>`:t}</label>`}get _helpId(){if(this.helpText)return`${this._id}__hint`}get _id(){return`textfield`}get _error(){if(this.invalid&&this._helpId)return this._helpId}handler(e){let{name:t,value:n}=e.currentTarget;this.value=n;let r=new CustomEvent(e.type,{detail:{name:t,value:n,target:e.target}});this.dispatchEvent(r)}prefixSlotChange(){this.renderRoot.querySelector(`slot[name=prefix]`).assignedElements().length&&(this._hasPrefix=!0)}suffixSlotChange(){this.renderRoot.querySelector(`slot[name=suffix]`).assignedElements().length&&(this._hasSuffix=!0)}render(){return i`
      ${this._label}
      <div
    ...
    `}},g([n({type:Boolean,reflect:!0})],W.prototype,`disabled`,void 0),g([n({type:Boolean,reflect:!0})],W.prototype,`invalid`,void 0),g([n({type:String,reflect:!0})],W.prototype,`label`,void 0),g([n({type:String,reflect:!0,attribute:`help-text`})],W.prototype,`helpText`,void 0),g([n({type:Boolean,reflect:!0})],W.prototype,`optional`,void 0),g([n({type:String,reflect:!0})],W.prototype,`size`,void 0),g([n({type:Number,reflect:!0})],W.prototype,`max`,void 0),g([n({type:Number,reflect:!0})],W.prototype,`min`,void 0),g([n({type:Number,reflect:!0,attribute:`min-length`})],W.prototype,`minLength`,void 0),g([n({type:Number,reflect:!0})],W.prototype,`minlength`,void 0),g([n({type:Number,reflect:!0,attribute:`max-length`})],W.prototype,`maxLength`,void 0),g([n({type:Number,reflect:!0})],W.prototype,`maxlength`,void 0),g([n({type:String,reflect:!0})],W.prototype,`pattern`,void 0),g([n({type:String,reflect:!0})],W.prototype,`placeholder`,void 0),g([n({type:Boolean,reflect:!0,attribute:`read-only`})],W.prototype,`readOnly`,void 0),g([n({type:Boolean,reflect:!0})],W.prototype,`readonly`,void 0),g([n({type:Boolean,reflect:!0})],W.prototype,`required`,void 0),g([n({type:String,reflect:!0})],W.prototype,`type`,void 0),g([n({type:String,reflect:!0})],W.prototype,`value`,void 0),g([n({type:String,reflect:!0})],W.prototype,`name`,void 0),g([n({type:Number,reflect:!0})],W.prototype,`step`,void 0),g([n({type:String,reflect:!0})],W.prototype,`autocomplete`,void 0),g([n({attribute:!1})],W.prototype,`formatter`,void 0),g([x(`.w-textfield__mask`)],W.prototype,`mask`,void 0),g([n({type:Boolean})],W.prototype,`_hasPrefix`,void 0),g([n({type:Boolean})],W.prototype,`_hasSuffix`,void 0),customElements.get(`w-textfield`)||customElements.define(`w-textfield`,W)}));export{G as t};
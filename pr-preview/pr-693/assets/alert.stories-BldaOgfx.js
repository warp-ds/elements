...
negative, positive, warning, info.`)}get _wrapperClasses(){let e=this.variant;return u([D.wrapper,D[e]])}get _iconClasses(){let e=D[`${this.variant}Icon`];return u([D.icon,e])}static{this.styles=[y,T,f`
		...
		`]}get _icon(){let e=n(),t=this.variant||`info`;return t===O.info?a`<w-icon
				name="Info"
				size="small"
				locale="${e}"
				class="flex"
			></w-icon>`:t===O.warning?a`<w-icon
				name="Warning"
				size="small"
				locale="${e}"
				class="flex"
			></w-icon>`:t===O.negative?a`<w-icon
				name="Error"
				size="small"
				locale="${e}"
				class="flex"
			></w-icon>`:t===O.positive?a`<w-icon
				name="Success"
				size="small"
				locale="${e}"
				class="flex"
			></w-icon>`:``}render(){return a`

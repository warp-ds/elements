import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{A as n,C as r,D as i,Ht as a,J as o,Kt as s,Lt as c,M as ee,N as te,O as l,Rt as ne,Wt as u,_ as d,c as f,g as p,j as re,k as ie,l as m,m as ae,o as oe,q as h,s as se,u as ce}from"./iframe-CWK0u4Vh.js";import{a as g,n as _,r as v,t as y}from"./utilities-CDst2T9a.js";import{n as le,t as b}from"./form-control-DtXadPi-.js";import{r as x,t as ue}from"./if-defined-BpjwcMIv.js";var S,C=t((()=>{S=JSON.parse(`{"select.label.optional":["(valgfrit)"]}`)})),w,T=t((()=>{w=JSON.parse(`{"select.label.optional":["(optional)"]}`)})),E,D=t((()=>{E=JSON.parse(`{"select.label.optional":["(vapaaehtoinen)"]}`)})),O,de=t((()=>{O=JSON.parse(`{"select.label.optional":["(valgfritt)"]}`)})),k,A=t((()=>{k=JSON.parse(`{"select.label.optional":["(valfritt)"]}`)})),j,M=t((()=>{c(),j=s(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.focus\\:\\[--w-outline-offset\\:-2px\\]:focus{--w-outline-offset:-2px}.bg-transparent{background-color:#0000}.appearance-none{-webkit-appearance:none;appearance:none}.border-0{border-width:0}.border-1{border-width:1px}.rounded-4{border-radius:4px}.caret-current{caret-color:currentColor}.opacity-25{opacity:.25}.block,.before\\:block:before{display:block}.flex{display:flex}.before\\:hidden:before{display:none}.focusable:focus{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:focus-visible{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:not(:focus-visible){outline:none}.outline-\\[--w-s-color-border-negative\\]\\!{outline-color:var(--w-s-color-border-negative)!important}.bottom-0{bottom:0}.right-0{right:0}.before\\:bottom-0:before{bottom:0}.before\\:right-0:before{right:0}.top-\\[30\\%\\]{top:30%}.absolute{position:absolute}.relative{position:relative}.static{position:static}.before\\:absolute:before{position:absolute}.s-bg{background-color:var(--w-s-color-background)}.s-bg-disabled-subtle{background-color:var(--w-s-color-background-disabled-subtle)}.s-text{color:var(--w-s-color-text)}.s-text-disabled{color:var(--w-s-color-text-disabled)}.s-text-negative{color:var(--w-s-color-text-negative)}.s-text-subtle{color:var(--w-s-color-text-subtle)}.s-icon{color:var(--w-s-color-icon)}.s-border-disabled{border-color:var(--w-s-color-border-disabled)}.s-border-negative{border-color:var(--w-s-color-border-negative)}.s-border-strong{border-color:var(--w-s-color-border-strong)}.hover\\:s-border-disabled:hover{border-color:var(--w-s-color-border-disabled)}.hover\\:s-border-negative-hover:hover{border-color:var(--w-s-color-border-negative-hover)}.hover\\:s-border-strong-hover:hover{border-color:var(--w-s-color-border-strong-hover)}.active\\:s-border-active:active{border-color:var(--w-s-color-border-active)}.active\\:s-border-disabled:active{border-color:var(--w-s-color-border-disabled)}.h-full{height:100%}.w-32{width:3.2rem}.w-full{width:100%}.before\\:h-full:before{height:100%}.before\\:w-32:before{width:3.2rem}.mb-0{margin-bottom:0}.mt-4{margin-top:.4rem}.py-12{padding-top:1.2rem;padding-bottom:1.2rem}.pb-4{padding-bottom:.4rem}.pl-0{padding-left:0}.pl-8{padding-left:.8rem}.pr-32{padding-right:3.2rem}.cursor-pointer{cursor:pointer}.antialiased{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;font-smoothing:grayscale}.font-bold{font-weight:700}.font-normal{font-weight:400}.pointer-events-none,.before\\:pointer-events-none:before{pointer-events:none}.text-m{font-size:var(--w-font-size-m);line-height:var(--w-line-height-m)}.text-s{font-size:var(--w-font-size-s);line-height:var(--w-line-height-s)}.text-xs{font-size:var(--w-font-size-xs);line-height:var(--w-line-height-xs)}`)})),N,P,F=t((()=>{c(),N=u`
  ...
  label span {
    ...
    --_line-height: var(--w-c-input-optional-line-height, var(--w-line-height-s));
...
`})),I,L,R=t((()=>{i(),o(),b(),c(),d(),ue(),ae(),re(),oe(),C(),T(),D(),de(),A(),M(),F(),f(),ce(),I={base:`block text-m mb-0 py-12 pr-32 rounded-4 w-full focusable focus:[--w-outline-offset:-2px] appearance-none cursor-pointer caret-current`,default:`s-text s-bg pl-8 border-1 s-border-strong hover:s-border-strong-hover active:s-border-active`,disabled:`s-text-disabled s-bg-disabled-subtle pl-8 border-1 s-border-disabled hover:s-border-disabled active:s-border-disabled pointer-events-none`,invalid:`s-text s-bg pl-8 border-1 s-border-negative hover:s-border-negative-hover active:s-border-active outline-[--w-s-color-border-negative]!`,readOnly:`s-text bg-transparent pl-0 border-0 pointer-events-none before:hidden`,wrapper:`relative`,selectWrapper:`relative before:block before:absolute before:right-0 before:bottom-0 before:w-32 before:h-full before:pointer-events-none `,chevron:`block absolute top-[30%] right-0 bottom-0 w-32 h-full s-icon pointer-events-none cursor-pointer`,chevronDisabled:`opacity-25`},L=class extends le(ne){#e;#t;#n;static{this.styles=[se,j,N,P,u`
  ...
  `]}constructor(){super(),this.autoFocus=!1,this.autofocus=!1,this.invalid=!1,this.always=!1,this.optional=!1,this.disabled=!1,this.readOnly=!1,this.readonly=!1,this._options=[],this.#e=void 0,this.#t=()=>this.#s(),this._setValue=e=>{this.value=e,this.setValue(e)},ie(w,O,E,S,k)}resetFormControl(){this.value=this.#e}#r(){return Array.from(this.children).filter(e=>e.tagName.toLowerCase()===`option`||e.tagName.toLowerCase()===`w-option`)}#i(){return this.shadowRoot?.querySelector(`select`)}#a(){return this.#r().some(e=>e.hasAttribute(`selected`))}#o(e){let t=this.#i();if(!t)return;let n=!1;for(let r of Array.from(t.options)){let t=!n&&r.value===e;r.selected=t,r.toggleAttribute(`selected`,t),t&&(n=!0)}}#s({allowDefaultFirstOption:e=!1}={}){let t=this.#i();if(!t)return;let n=t.value;!n||n===this.value||!e&&!this.value&&!this.#a()&&t.selectedIndex===0||(this._setValue(n),this.#o(n))}#c({syncValueFromSelected:e=!1}={}){let t=this.#r(),n,r=t.map(t=>{let r=t.getAttribute(`value`)??``,i=t.textContent??``,o=t.hasAttribute(`selected`),s=t.hasAttribute(`disabled`);return e&&n===void 0&&o&&(n=r),a`<option value="${r}" ?selected=${o} ?disabled=${s}>${i}</option>`});this._options=r,e&&n!==void 0&&n!==this.value&&this._setValue(n)}connectedCallback(){super.connectedCallback(),this.#e=this.value,(this.autofocus||this.autoFocus)&&this.shadowRoot.querySelector(`select`).focus(),this.#c({syncValueFromSelected:!0}),this.ownerDocument?.defaultView?.addEventListener(`pageshow`,this.#t),this.#n=new MutationObserver(()=>{this.#c({syncValueFromSelected:!0})}),this.#n.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`selected`,`disabled`,`value`]})}disconnectedCallback(){super.disconnectedCallback(),this.ownerDocument?.defaultView?.removeEventListener(`pageshow`,this.#t),this.#n?.disconnect()}firstUpdated(){this.value&&this.#o(this.value),this.#s({allowDefaultFirstOption:!1})}formStateRestoreCallback(e,t){if(typeof e==`string`&&e){this._setValue(e),this.#o(e);return}this.#s({allowDefaultFirstOption:!0})}willUpdate(e){e.has(`value`)&&this.setValue(this.value)}updated(e){if(e.has(`value`)){let e=this.#i();e&&e.value!==this.value&&(e.value=this.value??``),this.#o(this.value??``)}}handleKeyDown(e){if((this.readonly||this.readOnly)&&(e.key===` `||e.key===`ArrowDown`||e.key===`ArrowUp`)&&e.preventDefault(),e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}}get#l(){return l([I.base,!this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&I.default,this.invalid&&I.invalid,this.disabled&&I.disabled,(this.readonly||this.readOnly)&&I.readOnly])}get#u(){return`help-text`}get#d(){return l([I.chevron,this.disabled&&I.chevronDisabled])}get#f(){return`select_id`}get#p(){return this.helpText||this.hint?`${this.#f}__hint`:void 0}onChange(e){let t=e.currentTarget.value;e.stopPropagation(),this._setValue(t),this.#o(t),this.dispatchEvent(new CustomEvent(`change`,{detail:t,bubbles:!0,composed:!0}))}render(){return a`<div class="${I.wrapper}">
      ...
      ${p(this.helpText||this.always||this.invalid,()=>a`<div id="${this.#p}" class="${this.#u}">${this.helpText||this.hint}</div>`)}
    </div>`}},m([r({attribute:`auto-focus`,type:Boolean,reflect:!0})],L.prototype,`autoFocus`,void 0),m([r({type:Boolean,reflect:!0})],L.prototype,`autofocus`,void 0),m([r({attribute:`help-text`,reflect:!0})],L.prototype,`helpText`,void 0),m([r({type:Boolean,reflect:!0})],L.prototype,`invalid`,void 0),m([r({type:Boolean,reflect:!0})],L.prototype,`always`,void 0),m([r({reflect:!0})],L.prototype,`hint`,void 0),m([r({reflect:!0})],L.prototype,`label`,void 0),m([r({type:Boolean,reflect:!0})],L.prototype,`optional`,void 0),m([r({type:Boolean,reflect:!0})],L.prototype,`disabled`,void 0),m([r({attribute:`read-only`,type:Boolean,reflect:!0})],L.prototype,`readOnly`,void 0),m([r({type:Boolean,reflect:!0})],L.prototype,`readonly`,void 0),m([r({attribute:!1,state:!0})],L.prototype,`_options`,void 0),m([r({reflect:!0})],L.prototype,`name`,void 0),m([r({reflect:!0})],L.prototype,`value`,void 0),customElements.get(`w-select`)||customElements.define(`w-select`,L)})),z=e({Default:()=>W,Disabled:()=>q,HelpText:()=>G,Invalid:()=>K,NoLabel:()=>Y,Optional:()=>X,Placeholder:()=>Z,ReadOnly:()=>J,__namedExportsOrder:()=>Q,default:()=>U}),B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=t((()=>{v(),te(),c(),y(),R(),{events:B,args:V,argTypes:H}=ee(`w-select`),U={title:`Forms/Select`,render(e){return a`
      <form>
        <w-select ${g(_(e))}>

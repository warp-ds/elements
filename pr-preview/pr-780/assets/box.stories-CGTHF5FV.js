import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{C as n,f as r,p as i,r as a,s as o,t as s,y as c}from"./decorate-kJVNAdyH.js";import{n as l,t as u}from"./dist-Bn_0n649.js";import{n as d,t as f}from"./styles-BxpTFSox.js";import{i as p,n as m,r as h}from"./utilities-DyUKeeub.js";import{n as g,t as _}from"./FormControlMixin-BCJbRrUC.js";var v;function y(){return(y=e((()=>{r(),v=n`
	:host {
		display: block;
...
`})))()}var b;function x(){return(x=e((()=>{r(),a(),g(),f(),y(),b=class extends _(i){constructor(...e){super(...e),this.bleed=!1,this.bordered=!1,this.info=!1,this.neutral=!1,this.role=`region`}static{this.styles=[d,v]}connectedCallback(){super.connectedCallback(),this.internals.role=this.role}updated(e){super.updated(e),e.has(`role`)&&(this.internals.role=this.role)}render(){return c`
			<div part="base">
				<slot></slot>
			</div>
		`}},s([o({type:Boolean,reflect:!0})],b.prototype,`bleed`,void 0),s([o({type:Boolean,reflect:!0})],b.prototype,`bordered`,void 0),s([o({type:Boolean,reflect:!0})],b.prototype,`info`,void 0),s([o({type:Boolean,reflect:!0})],b.prototype,`neutral`,void 0),s([o({type:String,reflect:!0,useDefault:!0})],b.prototype,`role`,void 0),customElements.get(`w-box`)||customElements.define(`w-box`,b)})))()}var S=t({AccessibleRegion:()=>M,Bleed:()=>j,Bordered:()=>A,Default:()=>D,Info:()=>O,Neutral:()=>k,StylingApi:()=>N,__namedExportsOrder:()=>P,default:()=>E}),C,w,T,E,D,O,k,A,j,M,N,P;function F(){return(F=e((()=>{h(),l(),r(),x(),{events:C,args:w,argTypes:T}=u(`w-box`),E={title:`Layout/Box`,render:e=>c`
            <w-box ${p(m(e))}>
                <h3>Box Content</h3>
                <p>This is content inside a box component.</p>
            </w-box>
        `,args:w,argTypes:T,parameters:{actions:{handles:C}}},D={args:{bleed:!1,bordered:!1,info:!1,neutral:!1}},O={args:{info:!0}},k={args:{neutral:!0}},A={args:{bordered:!0}},j={args:{bleed:!0,neutral:!0}},M={args:{},render:()=>c`
        ...
        `},N={args:{bordered:!0},render(e){return c`
            <pre>
<code>
&lt;style&gt;
w-box {
...
&lt;/style&gt;
        ...
        `}},P=[`Default`,`Info`,`Neutral`,`Bordered`,`Bleed`,`AccessibleRegion`,`StylingApi`],D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  args: {
    bleed: false,
    bordered: false,
    info: false,
...
}`,...N.parameters?.docs?.source}}}})))()}export{k as a,O as i,A as n,S as o,D as r,F as s,j as t};
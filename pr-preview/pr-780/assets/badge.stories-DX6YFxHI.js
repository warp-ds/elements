...
`})))()}var v;function y(){return(y=e((()=>{r(),a(),f(),_(),v=class extends i{constructor(...e){super(...e),this.variant=`neutral`}static{this.styles=[d,g]}render(){return c`<div part="base"><slot></slot></div>`}},s([o({type:String,reflect:!0,useDefault:!0})],v.prototype,`variant`,void 0),s([o({type:String,reflect:!0})],v.prototype,`position`,void 0),customElements.get(`w-badge`)||customElements.define(`w-badge`,v)})))()}var b=t({Info:()=>E,Negative:()=>k,Neutral:()=>T,Positioned:()=>M,Positive:()=>D,Price:()=>A,Sponsored:()=>j,StylingApi:()=>N,Warning:()=>O,__namedExportsOrder:()=>P,default:()=>w}),x,S,C,w,T,E,D,O,k,A,j,M,N,P;function F(){return(F=e((()=>{h(),l(),r(),y(),{events:x,args:S,argTypes:C}=u(`w-badge`),w={title:`Layout/Badge`,render(e){return c`<w-badge ${p(m(e))}>Badge text</w-badge>`},args:S,argTypes:C,parameters:{actions:{handles:x}}},T={args:{variant:`neutral`}},E={args:{variant:`info`}},D={args:{variant:`positive`}},O={args:{variant:`warning`}},k={args:{variant:`negative`}},A={args:{variant:`price`}},j={args:{variant:`sponsored`}},M={args:{variant:`price`,position:`top-right`},render(e){return c`
            <div
                style="position: relative; width: 200px; height: 100px; background: #f0f0f0; border-radius: 8px;"
            >
                <w-badge ${p(m(e))}>Badge</w-badge>
            </div>
        `}},N={args:{variant:`info`},render(e){return c`
            <pre>
<code>
&lt;style&gt;
w-badge {
...
&lt;/style&gt;
        ...
        `}},P=[`Neutral`,`Info`,`Positive`,`Warning`,`Negative`,`Price`,`Sponsored`,`Positioned`,`StylingApi`],T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  args: {
    variant: "neutral"
  }
...
}`,...N.parameters?.docs?.source}}}})))()}export{D as a,O as c,M as i,b as l,k as n,A as o,T as r,j as s,E as t,F as u};
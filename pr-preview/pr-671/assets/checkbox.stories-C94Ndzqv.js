import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{C as n,_ as r,a as i,b as a,c as o,d as s,f as c,h as l,l as ee,p as u,r as te,s as d,t as f,u as ne,y as p}from"./decorate-kJVNAdyH.js";import{l as re,s as ie,u as ae}from"./async-directive-CsHtPgB7.js";import{a as m,o as oe,r as se,t as ce}from"./i18n-DHFMqi9L.js";import{n as le,t as ue}from"./dist-Bn_0n649.js";import{t as de}from"./query-BHY-nhsh.js";import{t as fe}from"./icon-DgzLkPq-.js";import{n as pe,t as me}from"./styles-BxpTFSox.js";import{i as he,n as ge,r as _e}from"./utilities-DyUKeeub.js";import{n as ve,t as ye}from"./FormControlMixin-BCJbRrUC.js";import{r as h,t as be}from"./if-defined-CHz3vSYq.js";import{t as g}from"./tooltip-CWMXKh4r.js";var _;function v(){return(v=e((()=>{a(),ne(),ie(),_=o(class extends ee{constructor(e){if(super(e),e.type!==s.PROPERTY&&e.type!==s.ATTRIBUTE&&e.type!==s.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ae(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===r||t===l)return t;let n=e.element,i=e.name;if(e.type===s.PROPERTY){if(t===n[i])return r}else if(e.type===s.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(i))return r}else if(e.type===s.ATTRIBUTE&&n.getAttribute(i)===t+``)return r;return re(e),t}})})))()}function y(){return(y=e((()=>{v()})))()}var b;function x(){return(x=e((()=>{c(),b=n`
	:host {
...
`})))()}var S;function C(){return(C=e((()=>{ve(),c(),te(),be(),y(),me(),x(),S=class extends ye(u){constructor(...e){super(...e),this.value=null,this.indeterminate=!1,this.checked=!1,this.disabled=!1,this.required=!1,this.invalid=!1,this.#e=!1,this.#t=!1,this.#n=!1,this.#r=()=>{this.#a(),this.#l()},this.#i=e=>{if(!this.disabled&&!e.defaultPrevented&&(e.key===` `||e.key===`Spacebar`||e.key===`Enter`)){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}e.composedPath()[0]!==this.input&&(e.preventDefault(),this.click())}}}static{this.styles=[pe,b]}static{this.shadowRootOptions={...u.shadowRootOptions,delegatesFocus:!0}}set name(e){this._ownName=e}get name(){return this._ownName||this._groupName}#e;#t;#n;get _computedInvalid(){return this.invalid||this._groupInvalid===!0}connectedCallback(){super.connectedCallback();let e=this.getAttribute(`value`);this.value=e??`on`,this.#e=this.hasAttribute(`checked`),this.checked=this.#e,this.addEventListener(`invalid`,this.#r),this.addEventListener(`keydown`,this.#i),this.#u()}handleClick(){this.disabled||(this.#a(),this.checked=!this.checked,this.indeterminate=!1,this.updateComplete.then(()=>{this.input.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}))}#r;#i;updated(e){super.updated(e),(e.has(`checked`)||e.has(`indeterminate`))&&this.#d(),this.#f(e)&&(this.#u(),this.#l())}resetFormControl(){this.checked=this.#e,this.#u(),this.#l()}click(){this.disabled||this.input?.click()}focus(e){this.input?.focus(e)}blur(){this.input?.blur()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#l(),this.internals.checkValidity()}reportValidity(){return this.#a(),this.#l(),this.internals.checkValidity()}#a(){this.#n=!0}#o(){return this.input?.validationMessage||` `}#s(){return this.input??void 0}#c(e){this.internals.setValidity(e,this.#o(),this.#s())}#l(){if(this.disabled){this.internals.setValidity({});return}let e=this.required&&!this.checked,t=this.invalid&&!this.#t;if(e){this.#t=!0,this.invalid=this.#n,this.#c({valueMissing:!0});return}if(this.#t&&=(this.invalid=!1,!1),t){this.#c({customError:!0});return}this.internals.setValidity({})}#u(){if(this.disabled){this.setValue(null);return}let e=this.checked?this.value:null;this.setValue(e)}#d(){this.input&&(this.input.checked=this.checked,this.input.indeterminate=this.indeterminate)}#f(e){return e.has(`checked`)||e.has(`value`)||e.has(`disabled`)||e.has(`required`)||e.has(`invalid`)}render(){let e=!this.checked&&this.indeterminate,t=e?`mixed`:this.checked?`true`:`false`;return p`
		...
		`}},f([de(`input[type="checkbox"]`)],S.prototype,`input`,void 0),f([d({reflect:!0})],S.prototype,`name`,null),f([d({reflect:!0})],S.prototype,`value`,void 0),f([d({type:Boolean,reflect:!0})],S.prototype,`indeterminate`,void 0),f([d({type:Boolean,reflect:!0})],S.prototype,`checked`,void 0),f([d({type:Boolean,reflect:!0})],S.prototype,`disabled`,void 0),f([d({type:Boolean,reflect:!0})],S.prototype,`required`,void 0),f([d({type:Boolean,reflect:!0})],S.prototype,`invalid`,void 0),f([d({attribute:!1})],S.prototype,`_groupInvalid`,void 0),f([d({attribute:!1})],S.prototype,`_groupName`,void 0),customElements.get(`w-checkbox`)||customElements.define(`w-checkbox`,S)})))()}var w;function T(){return(T=e((()=>{w=JSON.parse(`{"checkbox-group.label.optional":["Valgfri"],"checkbox-group.validation.required":["Mindst én valgt mulighed er påkrævet."]}`)})))()}var E;function D(){return(D=e((()=>{E=JSON.parse(`{"checkbox-group.label.optional":["Optional"],"checkbox-group.validation.required":["At least one selection is required."]}`)})))()}var O;function k(){return(k=e((()=>{O=JSON.parse(`{"checkbox-group.label.optional":["Valinnainen"],"checkbox-group.validation.required":["Vähintään yksi valinta vaaditaan."]}`)})))()}var A;function j(){return(j=e((()=>{A=JSON.parse(`{"checkbox-group.label.optional":["Valgfri"],"checkbox-group.validation.required":["Minst ett valg er påkrevd."]}`)})))()}var M;function N(){return(N=e((()=>{M=JSON.parse(`{"checkbox-group.label.optional":["Valfritt"],"checkbox-group.validation.required":["Minst ett val krävs."]}`)})))()}var P,F;function I(){return(I=e((()=>{oe(),ve(),c(),te(),be(),se(),T(),D(),k(),j(),N(),fe(),g(),ce(E,A,O,w,M),P=()=>m._({id:`checkbox-group.validation.required`,message:`At least one selection is required.`,comment:`Shown when required checkbox group has no selections`}),F=class extends ye(u){constructor(...e){super(...e),this.optional=!1,this.required=!1,this.invalid=!1,this._hasHelpTextSlot=!1,this.#e=!1,this.#t=!1,this._internalTabIndex=-1,this.#r=()=>{this.#o(),this.#_(),this.requestUpdate()},this.#i=()=>{this.#o(),this.#_(),this.requestUpdate()},this.#a=()=>{this.#l(),this.#_(),this.requestUpdate()},this.#s=()=>{this.requestUpdate()}}static{this.shadowRootOptions={...u.shadowRootOptions,delegatesFocus:!0}}#e;#t;#n;static{this.styles=n`
		.wrapper {
			display: inline-flex;
	...
	`}helpTextSlotChange(){this.renderRoot.querySelector(`slot[name=help-text]`).assignedElements().length&&(this._hasHelpTextSlot=!0)}render(){let e=this.#c()>0,t=this.required&&!e&&this.#e,n=this.invalid||t,r=n?this.#p():this.helpText,i=!!(r||this._hasHelpTextSlot),a=i?`checkbox-group__help`:void 0,o=this.label?`checkbox-group__label`:void 0,s=n?`true`:void 0;return p`
			<div class="wrapper" tabindex="${this._internalTabIndex}">
				${this.label?p`
								<div class="label" id="${h(o)}">
									<span>${this.label}</span>
									${this.optional&&!this.required?p`
													<span class="optional">
														${m._({id:`checkbox-group.label.optional`,message:`Optional`,comment:`Shown behind label when marked as optional`})}
													</span>
												`:l}
									${this.tooltip?p`
													<button
		...
		`}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,this.#r),this.addEventListener(`invalid`,this.#i),this.addEventListener(`slotchange`,this.#a),this.#n=m.on(`change`,this.#s),this.setValue(null),this.#v()}disconnectedCallback(){this.#n?.(),this.#n=void 0,super.disconnectedCallback()}checkValidity(){return this.#_(),this.internals.checkValidity()}reportValidity(){return this.#o(),this.#_(),this.internals.checkValidity()}focus(e){let t=this.#d();if(t?.focus){t.focus(e);return}HTMLElement.prototype.focus.call(this,e)}#r;#i;#a;#o(){this.#e=!0}#s;#c(){return this.#f().filter(e=>e.checked).length}#l(){if(this.name)for(let e of this.#f()){let t=e;t&&typeof t==`object`&&!t.name&&(t._groupName=this.name)}}#u(e){for(let t of this.#f())`_groupInvalid`in t&&(t._groupInvalid=e)}#d(){return this.#f()[0]}#f(){return(this.shadowRoot?.querySelector(`slot`))?.assignedElements({flatten:!0})??[]}#p(){return P()}updated(e){super.updated(e),this.#m(e)&&(e.has(`name`)&&this.#l(),this.#_())}#m(e){return e.has(`invalid`)||e.has(`required`)||e.has(`helpText`)||e.has(`name`)}#h(e){let t=this.#d();this.internals.setValidity(e,` `,t??void 0)}#g(e){this._internalTabIndex=e?0:-1}#_(){this.#v();let e=this.#c()>0,t=this.required&&!e,n=this.invalid,r=t&&this.#e,i=n||r;if(this.#g(i),t){this.#h({valueMissing:!0}),this.#u(i);return}if(n){this.#h({customError:!0}),this.#u(!0);return}this.internals.setValidity({}),this.#u(!1)}#v(){this.#t||this.internals.form&&(this.name&&this.name.trim().length>0||(console.warn(`w-checkbox-group: "name" is required for form submission.`),this.#t=!0))}},f([d({type:String,reflect:!0})],F.prototype,`label`,void 0),f([d({type:String,reflect:!0})],F.prototype,`tooltip`,void 0),f([d({type:String,reflect:!0})],F.prototype,`name`,void 0),f([d({type:Boolean,reflect:!0})],F.prototype,`optional`,void 0),f([d({type:String,reflect:!0,attribute:`help-text`})],F.prototype,`helpText`,void 0),f([d({type:Boolean,reflect:!0})],F.prototype,`required`,void 0),f([d({type:Boolean,reflect:!0})],F.prototype,`invalid`,void 0),f([i()],F.prototype,`_hasHelpTextSlot`,void 0),f([i()],F.prototype,`_internalTabIndex`,void 0),customElements.get(`w-checkbox-group`)||customElements.define(`w-checkbox-group`,F)})))()}var xe=t({CheckboxFormAssociated:()=>W,CheckboxGroup:()=>K,CheckboxGroupFormAssociated:()=>$,CheckboxGroupRequired:()=>Q,CheckboxGroupWithHelpText:()=>q,CheckboxGroupWithHelpTextAndLabel:()=>Y,CheckboxGroupWithInvalid:()=>Z,CheckboxGroupWithLabel:()=>J,CheckboxGroupWithOptional:()=>X,Default:()=>R,Disabled:()=>G,Indeterminate:()=>V,IndeterminateDisabled:()=>U,IndeterminateError:()=>H,Invalid:()=>B,WithTooltip:()=>z,__namedExportsOrder:()=>Te,default:()=>we}),L,Se,Ce,we,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,Te;function Ee(){return(Ee=e((()=>{_e(),le(),c(),C(),I(),g(),{events:L,args:Se,argTypes:Ce}=ue(`w-checkbox`),we={title:`Forms/Checkbox`,render(e){return p` <w-checkbox ${he(ge(e))}>Check me</w-checkbox> `},args:Se,argTypes:Ce,parameters:{actions:{handles:L}}},R={},z={args:{optional:!0,required:!1,helpText:`Help text is available, but might not be enough, or the added context is not important enough that we use help-text`,tooltip:`This tooltip adds supplementary information`},render({optional:e,required:t}){return p`
            <w-checkbox-group
                name="tooltip-demo"
        ...
        `}},B={args:{name:`invalidfoo`,value:`bar`,invalid:!0}},V={args:{name:`indeterminatefoo`,value:`bar`,indeterminate:!0}},H={args:{name:`indeterminateerrorfoo`,value:`bar`,indeterminate:!0,invalid:!0}},U={args:{name:`indeterminatedisabledfoo`,value:`bar`,indeterminate:!0,disabled:!0}},W={render:()=>p`
        ...
        `},G={args:{name:`disabledfoo`,value:`bar`,disabled:!0}},K={render:()=>p`
    ...
    `},$={render:()=>p`
        ...
        `},Te=[`Default`,`WithTooltip`,`Invalid`,`Indeterminate`,`IndeterminateError`,`IndeterminateDisabled`,`CheckboxFormAssociated`,`Disabled`,`CheckboxGroup`,`CheckboxGroupWithHelpText`,`CheckboxGroupWithLabel`,`CheckboxGroupWithHelpTextAndLabel`,`CheckboxGroupWithOptional`,`CheckboxGroupWithInvalid`,`CheckboxGroupRequired`,`CheckboxGroupFormAssociated`],R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{}`,...R.parameters?.docs?.source}}},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  args: {
    optional: true,
    required: false,
...
}`,...$.parameters?.docs?.source}}}})))()}export{q as a,R as c,U as d,H as f,Ee as h,Q as i,G as l,xe as m,K as n,J as o,B as p,$ as r,X as s,W as t,V as u};
import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{T as t,a as n,f as r,h as i,p as a,r as o,s,t as c,y as l}from"./decorate-kJVNAdyH.js";import{a as u,n as d,o as f,r as p,t as m}from"./i18n-DHFMqi9L.js";import{n as h,t as g}from"./index.m-DHqwZk2H.js";import{t as _}from"./icon-DgzLkPq-.js";import{n as v,t as y}from"./styles-BxpTFSox.js";import{r as b,t as x}from"./if-defined-CHz3vSYq.js";var S;function C(){return(C=e((()=>{r(),S=t(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.flex{display:flex}.static{position:static}.w-full{width:100%}`)})))()}var w,T;function E(){return(E=e((()=>{g(),r(),o(),y(),C(),w={wrapper:`w-full`,horizontal:`flex`},T=class extends a{constructor(...e){super(...e),this.horizontal=!1,this.right=!1}static{this.styles=[v,S]}updated(){this.updateStepsContext()}updateStepsContext(){let e=this.querySelectorAll(`w-step`);e.forEach((t,n)=>{t.setContext({horizontal:this.horizontal,right:this.right,isLast:n===e.length-1,isFirst:n===0})})}render(){let e=h([w.wrapper,this.horizontal&&w.horizontal]);return l`
		...
		`}},c([s({type:Boolean,reflect:!0})],B.prototype,`active`,void 0),c([s({type:Boolean,reflect:!0})],B.prototype,`completed`,void 0),c([n()],B.prototype,`_context`,void 0),customElements.get(`w-step`)||customElements.define(`w-step`,B)})))()}var H,U,W,G,K,q,J,Y,X;function Z(){return(Z=e((()=>{r(),E(),V(),H={title:`Components/Step Indicator`,component:`w-step-indicator`,argTypes:{horizontal:{control:{type:`boolean`},description:`Display steps in horizontal layout`,defaultValue:!1},right:{control:{type:`boolean`},description:`Align steps to the right (vertical layout only)`,defaultValue:!1}}},U={args:{horizontal:!1,right:!1},render:e=>l`
    ...
    `},W={args:{horizontal:!0,right:!1},render:e=>l`
        <w-step-indicator ?horizontal=${e.horizontal} ?right=${e.right}>
            <w-step completed>
    ...
    `},G={args:{horizontal:!1,right:!0},render:e=>l`
        <w-step-indicator ?horizontal=${e.horizontal} ?right=${e.right}>
            <w-step completed>
    ...
    `},X=[`Default`,`Horizontal`,`RightAligned`,`SimpleSteps`,`SimpleHorizontal`,`AllCompleted`,`MinimalExample`],U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  args: {
    horizontal: false,
    right: false
  },
  ...
  render: () => html\`
    ...
    \`
}`,...Y.parameters?.docs?.source}}}})))()}Z();export{J as AllCompleted,U as Default,W as Horizontal,Y as MinimalExample,G as RightAligned,q as SimpleHorizontal,K as SimpleSteps,X as __namedExportsOrder,H as default};
import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{C as n,T as r,a as i,f as a,p as o,r as s,s as c,t as l,y as u}from"./decorate-kJVNAdyH.js";import{n as d,t as f}from"./index.m-DHqwZk2H.js";import{t as p}from"./query-BHY-nhsh.js";import{t as m}from"./icon-DgzLkPq-.js";import{n as h,t as g}from"./styles-BxpTFSox.js";var _;function v(){return(v=e((()=>{a(),_=r(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.border-b{border-bottom-width:1px}.border-b-4{border-bottom-width:4px}.inline-grid{display:inline-grid}.grid-cols-1{grid-template-columns:repeat(1,minmax(0,1fr))}.grid-cols-2{grid-template-columns:repeat(2,minmax(0,1fr))}.grid-cols-3{grid-template-columns:repeat(3,minmax(0,1fr))}.grid-cols-4{grid-template-columns:repeat(4,minmax(0,1fr))}.grid-cols-5{grid-template-columns:repeat(5,minmax(0,1fr))}.grid-cols-6{grid-template-columns:repeat(6,minmax(0,1fr))}.grid-cols-7{grid-template-columns:repeat(7,minmax(0,1fr))}.grid-cols-8{grid-template-columns:repeat(8,minmax(0,1fr))}.grid-cols-9{grid-template-columns:repeat(9,minmax(0,1fr))}.-bottom-0{bottom:0}.absolute{position:absolute}.relative{position:relative}.static{position:static}.s-border{border-color:var(--w-s-color-border)}.s-border-selected{border-color:var(--w-s-color-border-selected)}.-mb-1{margin-bottom:-.1rem}.mb-32{margin-bottom:3.2rem}.resize{resize:both}.transition-all{transition-property:all;transition-duration:.15s;transition-timing-function:cubic-bezier(.4,0,.2,1)}`)})))()}var y;function b(){return(b=e((()=>{a(),s(),g(),v(),y=class extends o{static{this.styles=[h,_,n`
       ...
       * Visibility is now controlled internally via active state, so neutralize it. */
		...
		`}},l([c({reflect:!0})],F.prototype,`active`,void 0),l([p(`[role="tablist"]`)],F.prototype,`tabList`,void 0),l([p(`.selection-indicator`)],F.prototype,`selectionIndicator`,void 0),l([i()],F.prototype,`_activeTabFor`,void 0),customElements.get(`w-tabs`)||customElements.define(`w-tabs`,F)})))()}var L=t({Default:()=>z,ManyTabs:()=>H,WithIcons:()=>B,WithIconsOver:()=>V,__namedExportsOrder:()=>U,default:()=>R}),R,z,B,V,H,U;function W(){return(W=e((()=>{a(),m(),b(),T(),I(),R={title:`Components/Tabs`},z=()=>u`
    <w-tabs active="tab2">
...
`,U=[`Default`,`WithIcons`,`WithIconsOver`,`ManyTabs`],z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`() => html\`
    <w-tabs active="tab2">
        <w-tab for="tab1">First Tab</w-tab>
        <w-tab-panel id="tab1">
            <p>
...
\``,...H.parameters?.docs?.source}}}})))()}export{L as a,W as i,H as n,B as r,z as t};
...
`})))()}var H;function U(){return(U=e((()=>{k(),f(),r(),o(),g(),p(),j(),N(),F(),L(),z(),y(),v(),V(),H=class extends b(a){static{this.styles=[_,B]}constructor(){super(),this.back=!1,this.noClose=!1,this._hasTopContent=!1,m(M,I,P,A,R)}async willUpdate(e){if(e.has(`back`)){if(!this.titleEl)return;new O(this.titleEl).when(async()=>{await this.updateComplete})}}emitBack(){this.dispatchEvent(new CustomEvent(`backClicked`,{bubbles:!0,composed:!0}))}handleTopSlotChange(e){let t=e.target.assignedElements({flatten:!0});this._hasTopContent=!!t.length}render(){let e=this.back&&!this._hasTopContent,t=!this.noClose;return l`
		...
		`}},c([s({type:String})],H.prototype,`title`,void 0),c([s({type:Boolean})],H.prototype,`back`,void 0),c([s({type:Boolean,attribute:`no-close`})],H.prototype,`noClose`,void 0),c([n()],H.prototype,`_hasTopContent`,void 0),c([h(`[part="title"]`)],H.prototype,`titleEl`,void 0),customElements.get(`w-modal-header`)||customElements.define(`w-modal-header`,H)})))()}var W;function G(){return(G=e((()=>{r(),W=t`
	:host {
...
`})))()}var K;function q(){return(q=e((()=>{r(),y(),v(),G(),K=class extends b(x(a)){static{this.styles=[_,W]}render(){return l`

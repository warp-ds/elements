import{a as N,i as F,q as J,r as W,A as m,b as a,n as s,l as c,d as q,g as K}from"./iframe-7RbQ2Zc3.js";import"./index-T9_TvU8i.js";import"./index-CYQRAUql.js";import"./index-2clhVQm2.js";import{_ as G}from"./preload-helper-Ct5FWWRu.js";import{e as X}from"./query-NYTjQBeo.js";import{o as z}from"./if-defined-BUFLlYOg.js";import{F as Q}from"./FormControlMixin-DJnJZbro.js";const Y=JSON.parse('{"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"]}'),Z=JSON.parse('{"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"]}'),ee=JSON.parse('{"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"]}'),re=JSON.parse('{"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"]}'),te=JSON.parse('{"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"]}'),ae=N`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`,oe=N`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var ne=Object.defineProperty,l=(o,e,t,i)=>{for(var r=void 0,h=o.length-1,p;h>=0;h--)(p=o[h])&&(r=p(e,t,r)||r);return r&&ne(e,t,r),r};class n extends Q(F){constructor(){super(...arguments),this.invalid=!1,this.allowValuesOutsideRange=!1,this.suffix="",this._showTooltip=!1,this._inputHasFocus=!1,this.#e=null,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...F.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[W,oe,se]}#e;resetFormControl(){this.value=this.#e}#t(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#a(){this._showTooltip=!1}#s(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#r(e){this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:e,slot:this.slot}}))}async#i(e,t){let i=Number.parseInt(e);if(this.allowValuesOutsideRange&&!t&&this.step&&!(this.slot==="to"&&i>=Number(this.max)-1||this.slot==="from"&&i<=Number(this.min)+1)){const g=1/this.step;i=Math.round(i*g)/g,e=i.toString()}const r=Number.parseInt(this.max),h=Number.parseInt(this.min);if(!this.allowValuesOutsideRange&&(i>r||i<h))return this.#r(q.t({id:"slider.error.out_of_bounds",message:"Value must be between {min} and {max}",values:{min:`${this.min} ${this.suffix}`.trim(),max:`${this.max} ${this.suffix}`.trim()}})),{shouldCancel:!0};if(e==="")return this.required&&this.#r(q.t({id:"slider.error.required",message:"This field is required"})),{shouldCancel:!0};this.value=e;const p=e===this.max||e===this.min;let O=!1;if(this.slot){const R=getComputedStyle(this),g=R.getPropertyValue("--to"),I=R.getPropertyValue("--from"),P=q.t({id:"slider.error.overlap",message:"The maximum value cannot be less than the minimum"});if(this.slot==="from"){const b=Math.min(Number.parseInt(g),this.allowValuesOutsideRange?r-1:r);i>b&&(O=!0,this.allowValuesOutsideRange&&p?this.value=String(b):this.value=g,t&&(this.#r(P),await this.updateComplete,this.textfield.value=e))}else{const b=Math.max(Number.parseInt(I),this.allowValuesOutsideRange?h+1:h);i<b&&(O=!0,this.allowValuesOutsideRange&&p?this.value=String(b):this.value=I,t&&(this.#r(P),await this.updateComplete,this.textfield.value=e))}}return O?{shouldCancel:!0}:(this.#r(""),this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.allowValuesOutsideRange&&!t&&p?"":e,this.shadowRoot.querySelector("w-attention").handleDone(),{shouldCancel:!1})}async#o(e){const t=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const i=e.currentTarget.value;return(await this.#i(i,t)).shouldCancel?(e.preventDefault(),!1):!0}async#n(e){if(e.key!=="ArrowLeft"&&e.key!=="ArrowRight")return;const t=Number(this.range.value),i=this.step||1;let r;e.key==="ArrowLeft"?r=t-i:r=t+i,r=Math.min(Math.max(r,Number(this.min)),Number(this.max)),(await this.#i(r.toString(),!1)).shouldCancel&&e.preventDefault()}async connectedCallback(){if(super.connectedCallback(),this.#e=this.value,this.setValue(this.value),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:t}]=await Promise.all([G(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
      ...
      <div class="w-slider-thumb">
        ...
        <input
          ...
          @blur="${this.#a}"
          @input="${this.#o}"
          @keydown="${this.allowValuesOutsideRange?this.#n:m}"
        />
    ...
    `])))}},D={args:{},render(){return a(U||(U=f([`
      ...
      <\/script>
    `])))}},V={args:{locale:"nb"},render(){return a`
      <w-slider
...
}`,...C.parameters?.docs?.source}}};const ce=["Single","Range","SuffixSquareMeters","SuffixCurrency","SuffixKilometers","Marks","Step","OverUnder","SingleError","RangeError","TestCase","CustomError","Description"],_e=Object.freeze(Object.defineProperty({__proto__:null,CustomError:V,Description:C,Marks:k,OverUnder:$,Range:v,RangeError:E,Single:w,SingleError:T,Step:S,SuffixCurrency:y,SuffixKilometers:_,SuffixSquareMeters:x,TestCase:D,__namedExportsOrder:ce,default:he},Symbol.toStringTag,{value:"Module"}));export{k as M,$ as O,v as R,_e as S,w as a,x as b,y as c,_ as d,S as e,T as f,E as g};

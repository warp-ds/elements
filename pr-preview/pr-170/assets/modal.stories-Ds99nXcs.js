import{b as s,r as S,a as B,n as d,i as v,d as y,s as j,u as q,q as z,A as L,l as W,g as C}from"./iframe-Cc7cmZX8.js";import{s as T,p as I}from"./utilities-CYhcLDJD.js";import{e as x}from"./query-NYTjQBeo.js";let w=[];const M={documentElement:{},body:{}},R=Object.freeze({documentElement:{"scrollbar-gutter":"stable"},body:{overflow:"hidden",position:"relative",height:"100%"}}),$=e=>{e.touches.length>1||e.preventDefault?.()},N=e=>([t,o])=>{M[e][t]=document[e].style[t],document[e].style[t]=o},Y=()=>Object.entries(R).forEach(([e,t])=>{Object.entries(t).forEach(N(e))}),K=e=>([t,o])=>{document[e].style[t]=M[e][t]},J=()=>Object.entries(M).forEach(([e,t])=>{Object.entries(t).forEach(K(e))}),G=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight;function U(e){let t=-1;const o=n=>{if(n.targetTouches.length!==1)return;const a=n.targetTouches[0].clientY-t;return e.scrollTop===0&&a>0||G(e)&&a<0?$(n):(n.stopPropagation(),!0)};e.ontouchstart=n=>{n.targetTouches.length===1&&(t=n.targetTouches[0].clientY)},e.ontouchmove=o}function Q(e){e.ontouchstart=null,e.ontouchmove=null}const O=e=>()=>document[e?"addEventListener":"removeEventListener"]("touchmove",$,{passive:!1}),V=O(!0),X=O();function Z(e){if(!e)throw Error("Could not run setup, an element must be provided");w.some(t=>t===e)||(w.length||(Y(),V()),U(e),w.push(e))}function ee(){w.forEach(Q),X(),J(),w=[]}const D=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},_=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const n of o.filter(a=>a.patchClose))n._close=()=>this.close()}};var te=Object.defineProperty,c=(e,t,o,n)=>{for(var a=void 0,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=i(t,o,a)||a);return a&&te(t,o,a),a};class l extends _(v){constructor(){super(),this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}async open(){this.dialogEl.showModal(),this.handleListeners(),Z(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent("shown",{bubbles:!0,composed:!0}))}close(){this.handleListeners("removeEventListener"),this.dialogEl.classList.add("close"),this.dialogEl.addEventListener("animationend",async()=>{this.dialogEl.classList.remove("close"),this.dialogEl.close(),ee(),await this.updateComplete,this.dispatchEvent(new CustomEvent("hidden",{bubbles:!0,composed:!0}))},{once:!0})}render(){return s`
    ...
    `]}}c([d({type:Boolean})],l.prototype,"show");c([d({type:String,attribute:"content-id"})],l.prototype,"contentId");c([d({type:Boolean,attribute:"ignore-backdrop-clicks"})],l.prototype,"ignoreBackdropClicks");c([x(".dialog-el")],l.prototype,"dialogEl");c([x(".dialog-inner-el")],l.prototype,"dialogInnerEl");c([x(".content-el")],l.prototype,"contentEl");customElements.get("w-modal")||customElements.define("w-modal",l);const oe=(e,t)=>({dx:e.left-t.left,dy:e.top-t.top,dw:e.width/t.width,dh:e.height/t.height,first:e,last:t}),ae=({dx:e,dy:t})=>[{transform:`translate(${e}px, ${t}px)`},{transform:"none"}],ne={easing:"ease",duration:300};let H=!1;const re=typeof window<"u";if(re){const e=window.matchMedia("(prefers-reduced-motion: reduce)"),t=({matches:o})=>H=o;e.addEventListener&&e.addEventListener("change",t),t(e)}class ie{first;last;el;constructor(t,{animation:o={},keyframes:n,respectReduceMotion:a=!0}={}){this.el=t,this.first={},this.last={},this.userAnimationOptions=o,this.keyframeGenerator=n||ae,this.shouldReduceMotion=a}async when(t){this.prep();const o=await t();return await this.play(),o}prep(){this.first=this.el.getBoundingClientRect()}async play(){if(this.last=this.el.getBoundingClientRect(),!this.el.animate)return;await this.el.animate(this.keyframes,this.animationOptions).finished}get keyframes(){return this.keyframeGenerator(oe(this.first,this.last))}get defaults(){return ne}get mergedOptions(){return{...this.defaults,...this.userAnimationOptions}}get animationOptions(){return this.shouldReduceMotion?H?{...this.mergedOptions,duration:0}:this.mergedOptions:this.mergedOptions}}var se={},P=["en","nb","fi","da","sv"],F="en",le=()=>{var e;let t;switch((e=process==null?void 0:se)==null?void 0:e.NMP_BRAND){case"FINN":t="nb";break;case"TORI":t="fi";break;case"BLOCKET":t="sv";break;case"DBA":t="da";break;default:t="en"}return t},A=()=>{var e;const t=(e=document?.location)==null?void 0:e.hostname;return t?.includes("finn")?"nb":t.includes("tori")?"fi":t.includes("blocket")?"sv":t.includes("dba")?"da":F},E=e=>P.find(t=>e===t||e.toLowerCase().includes(t))||A();function de(){var e;if(typeof window>"u"){const t=le();return E(t)}try{const t=(e=document?.documentElement)==null?void 0:e.lang,o=A();return P.includes(t)?E(t??o):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),E(o))}catch(t){return console.warn("could not detect locale, falling back to source locale",t),F}}var ce=(e,t,o,n,a,r)=>e==="nb"?o:e==="fi"?n:e==="da"?a:e==="sv"?r:t,he=(e,t,o,n,a)=>{const r=de(),i=ce(r,e,t,o,n,a);y.load(r,i),y.activate(r)},m={nb:{"icon.title.arrow-left":["Pil som peker mot venstre"]},en:{"icon.title.arrow-left":["Leftward-pointing arrow"]},fi:{"icon.title.arrow-left":["Vasemmalle osoittava nuoli"]},da:{"icon.title.arrow-left":["Pil til venstre"]},sv:{"icon.title.arrow-left":["Pil som pekar vänster"]}};he(m.en,m.nb,m.fi,m.da,m.sv);var me=class extends v{render(){const e=y.t({message:"Leftward-pointing arrow",id:"icon.title.arrow-left",comment:"Title for table arrow left icon"});return q`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-arrow-left-16-part">${j(`<title>${e}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="M5.222 8h6.667"></path><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.444 11.75 4.111 8l3.333-3.75"></path></svg>`}};customElements.get("w-icon-arrow-left-16")||customElements.define("w-icon-arrow-left-16",me);const ue=JSON.parse('{"modal.aria.back":["Tilbage"],"modal.aria.close":["Luk"]}'),pe=JSON.parse('{"modal.aria.back":["Back"],"modal.aria.close":["Close"]}'),ge=JSON.parse('{"modal.aria.back":["Takaisin"],"modal.aria.close":["Sulje"]}'),fe=JSON.parse('{"modal.aria.back":["Tilbake"],"modal.aria.close":["Lukk"]}'),be=JSON.parse('{"modal.aria.back":["Tillbaka"],"modal.aria.close":["Stäng"]}');var we=Object.defineProperty,k=(e,t,o,n)=>{for(var a=void 0,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=i(t,o,a)||a);return a&&we(t,o,a),a};let h=class extends D(v){constructor(){super(),this._hasTopContent=!1,z(pe,fe,ge,ue,be)}render(){return s`
      <div class="header">
    ...
    `]}};k([d({type:String})],h.prototype,"title");k([d({type:Boolean})],h.prototype,"back");k([d({type:Boolean,attribute:"no-close"})],h.prototype,"noClose");k([W()],h.prototype,"_hasTopContent");k([x(".title-el")],h.prototype,"titleEl");customElements.get("w-modal-header")||customElements.define("w-modal-header",h);let ye=class extends D(_(v)){render(){return s`
      <div class="footer">
    ...
    `]}};customElements.get("w-modal-footer")||customElements.define("w-modal-footer",ye);const{events:ke,args:ve,argTypes:xe}=C("w-modal"),{events:Ee,args:Se,argTypes:Be}=C("w-modal-header"),{events:Ce,args:Te,argTypes:Ie}=C("w-modal-footer"),Me={title:"Overlays/Modal"},u={args:{},render(){return s`

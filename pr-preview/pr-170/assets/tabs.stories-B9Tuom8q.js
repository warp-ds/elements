import{a as A,i as g,r as y,j as v,x as o,n as l}from"./iframe-BTAX3YKC.js";import{e as x}from"./query-NYTjQBeo.js";import"./preload-helper-Ct5FWWRu.js";const T=A`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.border-b{border-bottom-width:1px}.border-b-4{border-bottom-width:4px}.inline-block{display:inline-block}.inline-grid{display:inline-grid}.hidden{display:none}.grid-cols-1{grid-template-columns:repeat(1,minmax(0,1fr))}.grid-cols-2{grid-template-columns:repeat(2,minmax(0,1fr))}.grid-cols-3{grid-template-columns:repeat(3,minmax(0,1fr))}.grid-cols-4{grid-template-columns:repeat(4,minmax(0,1fr))}.grid-cols-5{grid-template-columns:repeat(5,minmax(0,1fr))}.grid-cols-6{grid-template-columns:repeat(6,minmax(0,1fr))}.grid-cols-7{grid-template-columns:repeat(7,minmax(0,1fr))}.grid-cols-8{grid-template-columns:repeat(8,minmax(0,1fr))}.grid-cols-9{grid-template-columns:repeat(9,minmax(0,1fr))}.-bottom-0{bottom:0}.absolute{position:absolute}.relative{position:relative}.static{position:static}.s-border{border-color:var(--w-s-color-border)}.s-border-selected{border-color:var(--w-s-color-border-selected)}.-mb-1{margin-bottom:-.1rem}.mb-32{margin-bottom:3.2rem}.resize{resize:both}.transition-all{transition-property:all;transition-duration:.15s;transition-timing-function:cubic-bezier(.4,0,.2,1)}.bg-transparent{background-color:#0000}.appearance-none{-webkit-appearance:none;appearance:none}.border-0{border-width:0}.border-b-4{border-bottom-width:4px}.border-transparent{border-color:#0000}.inline-block{display:inline-block}.flex{display:flex}.grid{display:grid}.focusable:focus{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:focus-visible{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:not(:focus-visible){outline:none}.gap-8{gap:.8rem}.focus\\:outline-none:focus{outline-offset:2px;outline:2px solid #0000}.items-center{align-items:center}.justify-center{justify-content:center}.static{position:static}.s-text-link{color:var(--w-s-color-text-link)}.s-text-subtle{color:var(--w-s-color-text-subtle)}.hover\\:s-text-link:hover{color:var(--w-s-color-text-link)}.s-border-selected{border-color:var(--w-s-color-border-selected)}.hover\\:s-border-primary:hover{border-color:var(--w-s-color-border-primary)}.m-0{margin:0}.mx-auto{margin-left:auto;margin-right:auto}.p-0{padding:0}.p-16{padding:1.6rem}.pb-8{padding-bottom:.8rem}.cursor-pointer{cursor:pointer}.font-bold{font-weight:700}.w-full{width: 100%;}`;var $=Object.defineProperty,w=(s,t,n,a)=>{for(var e=void 0,i=s.length-1,r;i>=0;i--)(r=s[i])&&(e=r(t,n,e)||e);return e&&$(t,n,e),e};const f={wrapper:"inline-block border-b s-border mb-32",base:"inline-grid relative -mb-1",selectionIndicator:"absolute s-border-selected -bottom-0 border-b-4 transition-all"},C={cols1:"grid-cols-1",cols2:"grid-cols-2",cols3:"grid-cols-3",cols4:"grid-cols-4",cols5:"grid-cols-5",cols6:"grid-cols-6",cols7:"grid-cols-7",cols8:"grid-cols-8",cols9:"grid-cols-9"};function S(s,t=200,n=!1){let a;return((...e)=>{const i=()=>{a=null,n||s(...e)},r=n&&!a;a&&clearTimeout(a),a=setTimeout(i,t),r&&s(...e)})}class d extends g{constructor(){super(),this.active="",this.tabClass="",this._activeTab="",this._updateSelectionIndicatorDebounced=S(this.updateSelectionIndicator.bind(this),100),this._handleTabClick=t=>{const n=t.detail.name;n!==this._activeTab&&(this.active=n,this._activeTab=n,this.updateSelectionIndicator(),this.updatePanels(),this._notifyTabChange())},this._handleKeyDown=t=>{if(t.altKey||t.ctrlKey||t.shiftKey||!["ArrowLeft","ArrowRight","Home","End"].includes(t.key))return;const n=Array.from(this.querySelectorAll("w-tab")),a=n.findIndex(i=>i.getAttribute("name")===this._activeTab);if(a===-1)return;let e=a;switch(t.key){case"Home":e=0;break;case"End":e=n.length-1;break;case"ArrowLeft":e=Math.max(0,a-1);break;case"ArrowRight":e=Math.min(n.length-1,a+1);break}if(e!==a){t.preventDefault();const i=n[e],r=i.getAttribute("name");r&&(this.active=r,this._activeTab=r,this.updateSelectionIndicator(),this.updatePanels(),this._notifyTabChange(),i.focus())}},this.addEventListener("tab-click",this._handleTabClick)}static{this.styles=[y,T]}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<"u"&&(this._resizeObserver=new ResizeObserver(()=>{this._updateSelectionIndicatorDebounced()}),this._resizeObserver.observe(this)),window.addEventListener("resize",this._updateSelectionIndicatorDebounced)}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver&&this._resizeObserver.disconnect(),window.removeEventListener("resize",this._updateSelectionIndicatorDebounced),this.removeEventListener("tab-click",this._handleTabClick)}firstUpdated(){this._initializeActiveTab(),this.updateSelectionIndicator(),this.updatePanels()}updated(t){t.has("active")&&this.active!==this._activeTab&&(this._activeTab=this.active,this.updateSelectionIndicator(),this.updatePanels(),this._notifyTabChange())}_initializeActiveTab(){const t=Array.from(this.querySelectorAll("w-tab")),n=t.find(a=>a.hasAttribute("active"));n?this._activeTab=n.getAttribute("name")||"":t.length>0&&(this._activeTab=t[0].getAttribute("name")||""),this._activeTab&&(this.active=this._activeTab)}_notifyTabChange(){this.dispatchEvent(new CustomEvent("change",{detail:{name:this._activeTab},bubbles:!0,composed:!0}))}updateSelectionIndicator(){requestAnimationFrame(()=>{if(!this.tabList||!this.selectionIndicator)return;const t=this.tabList.querySelector(`w-tab[name="${this._activeTab}"]`);if(!t)return;const n=this.tabList.getBoundingClientRect(),a=t.getBoundingClientRect(),e=a.left-n.left,i=a.width;this.selectionIndicator.style.left=`${e}px`,this.selectionIndicator.style.width=`${i}px`})}updatePanels(){document.querySelectorAll("w-tab-panel").forEach(a=>{a.getAttribute("name")===this._activeTab?(a.removeAttribute("hidden"),a.hidden=!1):(a.setAttribute("hidden",""),a.hidden=!0)}),this.querySelectorAll("w-tab").forEach(a=>{a.getAttribute("name")===this._activeTab?a.setAttribute("active",""):a.removeAttribute("active")})}get _tabCount(){return this.querySelectorAll("w-tab").length}get _gridClass(){const t=Math.min(this._tabCount,9);return C[`cols${t}`]||C.cols1}render(){const t=v(this.tabClass,f.wrapper),n=v([f.base,this._gridClass]);return o`
      <div class="${t}">
    ...
    `}}p([l({reflect:!0})],c.prototype,"name");p([l({reflect:!0})],c.prototype,"label");p([l({type:Boolean,reflect:!0})],c.prototype,"active");p([l({type:Boolean,reflect:!0})],c.prototype,"over");p([l({attribute:"tab-class",reflect:!0})],c.prototype,"tabClass");customElements.get("w-tab")||customElements.define("w-tab",c);var z=Object.defineProperty,k=(s,t,n,a)=>{for(var e=void 0,i=s.length-1,r;i>=0;i--)(r=s[i])&&(e=r(t,n,e)||e);return e&&z(t,n,e),e};class _ extends g{constructor(){super(...arguments),this.hidden=!0}static{this.styles=[y,T]}connectedCallback(){super.connectedCallback(),this.setAttribute("tabindex","-1"),this.setAttribute("role","tabpanel"),this.name&&(this.setAttribute("aria-labelledby",`warp-tab-${this.name}`),this.setAttribute("id",`warp-tabpanel-${this.name}`))}updated(t){t.has("name")&&this.name&&(this.setAttribute("aria-labelledby",`warp-tab-${this.name}`),this.setAttribute("id",`warp-tabpanel-${this.name}`))}render(){return o`<slot></slot>`}}k([l({reflect:!0})],_.prototype,"name");k([l({type:Boolean,reflect:!0})],_.prototype,"hidden");customElements.get("w-tab-panel")||customElements.define("w-tab-panel",_);const D={title:"Components/Tabs"},h=()=>o`
  <w-tabs active="tab1">
...
\``,...u.parameters?.docs?.source}}};const R=["Default","WithIcons","ManyTabs"];export{h as Default,u as ManyTabs,m as WithIcons,R as __namedExportsOrder,D as default};

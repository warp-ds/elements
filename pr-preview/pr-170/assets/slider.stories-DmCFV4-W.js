import{a as I,i as C,q as Q,r as K,A as h,b as i,n as s,l as c,d as N,g as Y}from"./iframe-Cc7cmZX8.js";import"./affix-BPXdlNIf.js";import"./attention-C4tIWSLh.js";import"./textfield-Cv32IVky.js";import{_ as Z}from"./preload-helper-Ct5FWWRu.js";import{e as G}from"./query-NYTjQBeo.js";import{o as R}from"./if-defined-BIjVHEzO.js";import{F as ee}from"./FormControlMixin-DJnJZbro.js";const te=JSON.parse('{"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"]}'),re=JSON.parse('{"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"]}'),ae=JSON.parse('{"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"]}'),ie=JSON.parse('{"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"]}'),se=JSON.parse('{"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"]}'),oe=I`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;

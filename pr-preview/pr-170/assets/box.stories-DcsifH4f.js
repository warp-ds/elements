import{g as t,x as l}from"./iframe-CHuwHlC2.js";import{s as c,p as d}from"./utilities-Bg9GOKEV.js";const{events:u,args:p,argTypes:i}=t("w-box"),g={title:"Layout/Box",render:n=>l`
      <w-box ${c(d(n))}>
        <h3>Box Content</h3>

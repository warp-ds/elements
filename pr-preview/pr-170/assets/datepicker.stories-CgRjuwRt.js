...
`,zr=/^\d{4}-\d{2}-\d{2}$/;function ge(e){if(typeof e!="string")return null;let t=e;zr.test(e)&&(t=`${e}T00:00:00Z`);const a=Date.parse(t);return Number.isNaN(a)?null:new Date(a)}var Lr=Object.defineProperty,qr=Object.getOwnPropertyDescriptor,f=(e,t,a,n)=>{for(var r=n>1?void 0:n?qr(t,a):t,i=e.length-1,o;i>=0;i--)(o=e[i])&&(r=(n?o(t,a,r):o(r))||r);return n&&r&&Lr(t,a,r),r};const Xr=typeof navigator<"u"?navigator.userAgent:"",Vr=/iP(hone|od|ad)/.test(Xr),Kr=Vr?"text":"date",T="calendar",U="input",Z="toggle",Ye="wrapper",L="previous",Y={en:Ce,nb:Kn,sv:br,da:Ea,fi:pn};class h extends Je(R){constructor(){super(),this.headerFormat="MMMM yyyy",this.weekdayFormat="EEEEEE",this.dayFormat="PPPP",this.isCalendarOpen=!1,this.navigationDate=ra(),this.locale=Ce,Qe(Tr,Cr,jr,Sr,Er);const t=Ie();t&&Y[t]&&(this.locale=Y[t]),this._onClickOutside=this._onClickOutside.bind(this)}static{this.shadowRootOptions={...R.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[Ae,Yr,Nr,Fr,Hr]}get selectedDate(){return ge(this.value)??null}get month(){return J(this.navigationDate)}get weeks(){const t=this.month,a=this.navigationDate,r=it({start:J(t),end:na(t)},{locale:this.locale}).map(i=>({start:i,end:ae(i,{locale:this.locale})})).map(i=>rt(i));if(se(a,t)){const i=aa(a,{locale:this.locale})-1,o=Pe(a,y(a,{locale:this.locale}));r[i][o]=a}return r}async#e(t){t.preventDefault(),this.isCalendarOpen=!this.isCalendarOpen,this.isCalendarOpen&&(await this.updateComplete,(this.selectedCell||this.todayCell).focus())}#n(){this.navigationDate=B(this.month,1)}#r(){this.navigationDate=ce(this.month)}async#t(){await this.updateComplete,this.input.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}_onClickOutside(t){!this.isCalendarOpen||this.contains(t.target)||(this.isCalendarOpen=!1)}#i(t){this.value=t.target.value}#o(t){t.preventDefault(),this.isCalendarOpen=!0}#s(t){if(t.key===" ")return this.#e(t);(t.key===","||t.key==="Enter")&&t.preventDefault()}async#d(t){const a=this.navigationDate;let n;switch(t.key){case"ArrowUp":n=ue(a,7);break;case"ArrowLeft":n=ue(a,1);break;case"Home":n=y(a,{locale:this.locale});break;case"PageUp":n=ce(a);break;case"ArrowDown":n=q(a,7);break;case"ArrowRight":n=q(a,1);break;case"End":n=ae(a,{locale:this.locale});break;case"PageDown":n=B(a,1);break;case"Escape":this.isCalendarOpen=!1;break;case"Tab":t.target.tagName==="TD"&&!t.shiftKey?(t.preventDefault(),this.previousMonthButton.focus()):t.target.id===L&&t.shiftKey&&(t.preventDefault(),(this.selectedCell||this.todayCell).focus());break}n&&(t.preventDefault(),this.navigationDate=n,await this.updateComplete,this.selectedCell.focus())}#a(t){const a=t.currentTarget.dataset.date;"key"in t?(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.value=a,this.isCalendarOpen=!1,this.toggleButton.focus(),this.#t()):(this.value=a,this.isCalendarOpen=!1,this.#t())}connectedCallback(){super.connectedCallback();const t=this.lang;if(t&&Y[t]&&(this.locale=Y[t]),this.value){const a=ge(this.value);a&&(this.navigationDate=a)}document.addEventListener("mousedown",this._onClickOutside),document.addEventListener("touchend",this._onClickOutside),document.addEventListener("focusin",this._onClickOutside)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._onClickOutside),document.removeEventListener("touchend",this._onClickOutside),document.removeEventListener("focusin",this._onClickOutside)}updated(t){t.has("value")&&this.setValue(this.value)}render(){return D`
            ...
            <table class="w-datepicker__table" role="grid">
              ...
              <tbody>
                ${this.weeks.map(t=>D`<tr>
                      ${t.map(a=>{if(!se(this.month,a))return D`<td></td>`;const n=this.isDayDisabled?this.isDayDisabled(a):!1,r=De(a,this.selectedDate),i=a===this.navigationDate;return D`<td
    ...
    `}}f([_({reflect:!0})],h.prototype,"label",2);f([_({reflect:!0})],h.prototype,"lang",2);f([_({reflect:!0})],h.prototype,"name",2);f([_({reflect:!0})],h.prototype,"value",2);f([_({attribute:"header-format"})],h.prototype,"headerFormat",2);f([_({attribute:"weekday-format"})],h.prototype,"weekdayFormat",2);f([_({attribute:"day-format"})],h.prototype,"dayFormat",2);f([x()],h.prototype,"isCalendarOpen",2);f([x()],h.prototype,"navigationDate",2);f([x()],h.prototype,"locale",2);f([x()],h.prototype,"selectedDate",1);f([x()],h.prototype,"month",1);f([x()],h.prototype,"weeks",1);f([$(`#${T}`)],h.prototype,"calendar",2);f([$(`#${U}`,!0)],h.prototype,"input",2);f([$(`#${Z}`,!0)],h.prototype,"toggleButton",2);f([$(`#${Ye}`,!0)],h.prototype,"wrapper",2);f([$(`#${L}`)],h.prototype,"previousMonthButton",2);f([$('[aria-current="date"]')],h.prototype,"todayCell",2);f([$('[data-navigation="true"]')],h.prototype,"selectedCell",2);customElements.get("w-datepicker")||customElements.define("w-datepicker",h);var ke=Object.freeze,Qr=Object.defineProperty,Ir=(e,t)=>ke(Qr(e,"raw",{value:ke(e.slice())})),we;const{events:Ar,args:Rr,argTypes:Br}=Re("w-datepicker"),Jr={title:"Forms/Datepicker",render(e){return D`
      <!-- Workaround for Storybook's overflow hidden -->
      <div style="min-height: 400px">
        <w-datepicker ${ve(ye(e))}></w-datepicker>
      </div>
    `},args:Rr,argTypes:Br,parameters:{actions:{handles:Ar}}},j={args:{label:"Dato",lang:"nb"}},C={args:{label:"Dato",lang:"nb"},render(e){return D(we||(we=Ir([`
      <!-- Workaround for Storybook's overflow hidden -->
      <div style="min-height: 400px">

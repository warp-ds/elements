import{b as s,r as S,a as B,i as v,d as y,s as j,u as q,q as z,A as L,n as d,l as W,g as C}from"./iframe-7RbQ2Zc3.js";import{s as T,p as I}from"./utilities-XXws7xiw.js";import{e as x}from"./query-NYTjQBeo.js";const $=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},O=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const n of o.filter(a=>a.patchClose))n._close=()=>this.close()}};let R=class extends $(O(v)){render(){return s`
      <div class="footer">

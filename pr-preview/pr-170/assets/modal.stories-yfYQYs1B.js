import{x as s,r as S,a as B,i as v,b as y,s as A,u as q,p as z,E as L,n as d,k as W,g as C}from"./iframe-Bo46vWgQ.js";import{s as T,p as I}from"./utilities-DmwdYBaB.js";import{e as x}from"./query-NYTjQBeo.js";const $=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},O=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const n of o.filter(a=>a.patchClose))n._close=()=>this.close()}};let R=class extends $(O(v)){render(){return s`
      <div class="footer">

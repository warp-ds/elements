import{x as s,r as S,a as B,i as v,f as y,s as A,u as z,p as q,E as L,n as d,l as W,g as C}from"./iframe-BviKYoqj.js";import{s as T,p as I}from"./utilities-C2ISksLn.js";import{e as x}from"./query-NYTjQBeo.js";const $=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},O=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const n of o.filter(a=>a.patchClose))n._close=()=>this.close()}};let R=class extends $(O(v)){render(){return s`
      <div class="footer">
    ...
    `]}};customElements.get("w-modal-footer")||customElements.define("w-modal-footer",R);const N=(e,t)=>({dx:e.left-t.left,dy:e.top-t.top,dw:e.width/t.width,dh:e.height/t.height,first:e,last:t}),Y=({dx:e,dy:t})=>[{transform:`translate(${e}px, ${t}px)`},{transform:"none"}],K={easing:"ease",duration:300};let _=!1;const J=typeof window<"u";if(J){const e=window.matchMedia("(prefers-reduced-motion: reduce)"),t=({matches:o})=>_=o;e.addEventListener&&e.addEventListener("change",t),t(e)}class G{first;last;el;constructor(t,{animation:o={},keyframes:n,respectReduceMotion:a=!0}={}){this.el=t,this.first={},this.last={},this.userAnimationOptions=o,this.keyframeGenerator=n||Y,this.shouldReduceMotion=a}async when(t){this.prep();const o=await t();return await this.play(),o}prep(){this.first=this.el.getBoundingClientRect()}async play(){if(this.last=this.el.getBoundingClientRect(),!this.el.animate)return;await this.el.animate(this.keyframes,this.animationOptions).finished}get keyframes(){return this.keyframeGenerator(N(this.first,this.last))}get defaults(){return K}get mergedOptions(){return{...this.defaults,...this.userAnimationOptions}}get animationOptions(){return this.shouldReduceMotion?_?{...this.mergedOptions,duration:0}:this.mergedOptions:this.mergedOptions}}var U={},D=["en","nb","fi","da","sv"],H="en",Q=()=>{var e;let t;switch((e=process==null?void 0:U)==null?void 0:e.NMP_BRAND){case"FINN":t="nb";break;case"TORI":t="fi";break;case"BLOCKET":t="sv";break;case"DBA":t="da";break;default:t="en"}return t},P=()=>{var e;const t=(e=document?.location)==null?void 0:e.hostname;return t?.includes("finn")?"nb":t.includes("tori")?"fi":t.includes("blocket")?"sv":t.includes("dba")?"da":H},E=e=>D.find(t=>e===t||e.toLowerCase().includes(t))||P();function V(){var e;if(typeof window>"u"){const t=Q();return E(t)}try{const t=(e=document?.documentElement)==null?void 0:e.lang,o=P();return D.includes(t)?E(t??o):(console.warn("Unsupported locale set in html lang tag, falling back to detection by hostname"),E(o))}catch(t){return console.warn("could not detect locale, falling back to source locale",t),H}}var X=(e,t,o,n,a,r)=>e==="nb"?o:e==="fi"?n:e==="da"?a:e==="sv"?r:t,Z=(e,t,o,n,a)=>{const r=V(),i=X(r,e,t,o,n,a);y.load(r,i),y.activate(r)},m={nb:{"icon.title.arrow-left":["Pil som peker mot venstre"]},en:{"icon.title.arrow-left":["Leftward-pointing arrow"]},fi:{"icon.title.arrow-left":["Vasemmalle osoittava nuoli"]},da:{"icon.title.arrow-left":["Pil til venstre"]},sv:{"icon.title.arrow-left":["Pil som pekar vänster"]}};Z(m.en,m.nb,m.fi,m.da,m.sv);var ee=class extends v{render(){const e=y.t({message:"Leftward-pointing arrow",id:"icon.title.arrow-left",comment:"Title for table arrow left icon"});return z`<svg xmlns="http://www.w3.org/2000/svg"width="16"height="16"fill="none"viewBox="0 0 16 16" part="w-icon-arrow-left-16-part">${A(`<title>${e}</title>`)}<path stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="M5.222 8h6.667"></path><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.444 11.75 4.111 8l3.333-3.75"></path></svg>`}};customElements.get("w-icon-arrow-left-16")||customElements.define("w-icon-arrow-left-16",ee);const te=JSON.parse('{"modal.aria.back":["Tilbage"],"modal.aria.close":["Luk"]}'),oe=JSON.parse('{"modal.aria.back":["Back"],"modal.aria.close":["Close"]}'),ae=JSON.parse('{"modal.aria.back":["Takaisin"],"modal.aria.close":["Sulje"]}'),ne=JSON.parse('{"modal.aria.back":["Tilbake"],"modal.aria.close":["Lukk"]}'),re=JSON.parse('{"modal.aria.back":["Tillbaka"],"modal.aria.close":["Stäng"]}');var ie=Object.defineProperty,k=(e,t,o,n)=>{for(var a=void 0,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=i(t,o,a)||a);return a&&ie(t,o,a),a};let c=class extends $(v){constructor(){super(),this._hasTopContent=!1,q(oe,ne,ae,te,re)}render(){return s`
      <div class="header">
    ...
    `}async willUpdate(t){if(t.has("back")){if(!this.titleEl)return;new G(this.titleEl).when(async()=>{await this.updateComplete})}}get titleClasses(){return["header-title",this.back?"header-title-with-back-button":"header-title-without-back-button",this._hasTopContent?"header-title-with-top-area":""].join(" ")}get backButton(){return this.back&&!this._hasTopContent?s`<button
        ...
        </button>`:L}get closeButton(){return this.noClose?L:s`<button
      type="button"
    ...
    </button>`}emitBack(){this.dispatchEvent(new CustomEvent("backClicked",{bubbles:!0,composed:!0}))}handleTopSlotChange(t){const o=t.target.assignedElements({flatten:!0});this._hasTopContent=!!o.length}static{this.styles=[S,B`
      .header {
        position: relative;

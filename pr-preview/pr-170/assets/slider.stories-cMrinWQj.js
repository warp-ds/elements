import{a as M,i as F,q as G,r as J,A as h,b as a,n as s,l as c,d as I,g as Q}from"./iframe-Cj-rBNrx.js";import"./index-M7HDzEar.js";import"./index-BluB-7X5.js";import"./index-C5bvM6A4.js";import{_ as Y}from"./preload-helper-Ct5FWWRu.js";import{e as K}from"./query-NYTjQBeo.js";import{o as z}from"./if-defined-BxkXB92_.js";import{F as Z}from"./FormControlMixin-DJnJZbro.js";const ee=JSON.parse('{"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"]}'),re=JSON.parse('{"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"]}'),te=JSON.parse('{"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"]}'),ae=JSON.parse('{"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"]}'),ie=JSON.parse('{"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"]}'),se=M`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`;var oe=Object.defineProperty,u=(o,e,t,i)=>{for(var r=void 0,m=o.length-1,p;m>=0;m--)(p=o[m])&&(r=p(e,t,r)||r);return r&&oe(e,t,r),r};class d extends F{constructor(){super(),this.disabled=!1,this.allowValuesOutsideRange=!1,this.error="",this.helpText="",this.invalid=!1,this.required=!1,this.suffix="",this._invalidMessage="",this._hasInternalError=!1,G(re,ae,te,ee,ie)}static{this.shadowRootOptions={...F.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[J,se]}#e(){const e=this.querySelectorAll("w-slider-thumb");let t=!1;for(const r of e.values())r.min=this.edgeMin,r.max=this.edgeMax,r.step=this.step,r.suffix=this.suffix,r.required=this.required,r.formatter=this.formatter,r.allowValuesOutsideRange=this.allowValuesOutsideRange,r.ariaLabel||(r.slot||(r.ariaLabel=this.label),r.slot==="from"&&(r.ariaLabel=`${this.label} min`),r.slot==="to"&&(r.ariaLabel=`${this.label} max`)),(r.slot==="from"||r.slot==="to")&&(t=!0),r.disabled=this.disabled,r.invalid=this.invalid||this._hasInternalError,this.#i(r);const i=this.shadowRoot.querySelector("fieldset");t?(i.style.setProperty("--active-range-inline-start-padding","var(--w-slider-thumb-size)"),i.style.setProperty("--active-range-inline-end-padding","var(--w-slider-thumb-size)")):i.style.setProperty("--active-range-border-radius","4px")}get edgeMin(){return this.allowValuesOutsideRange?(Number(this.min)-1).toString():this.min}get edgeMax(){return this.allowValuesOutsideRange?(Number(this.max)+1).toString():this.max}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.step&&this.style.setProperty("--step",String(this.step)),this.style.setProperty("--min",this.edgeMin),this.style.setProperty("--max",this.max),this.markers&&this.style.setProperty("--markers",String(this.markers)),this.#e()}updated(e){(e.has("disabled")||e.has("invalid")||e.has("required")||e.has("min")||e.has("step")||e.has("max")||e.has("suffix")||e.has("formatter")||e.has("_invalidMessage")||e.has("_hasInternalError"))&&this.#e()}#t(e){const t=e.target;this.#i(t),t.slot&&this.#a()}#a(){let e,t;const i=this.querySelectorAll("w-slider-thumb");for(const r of i.values())r.slot==="from"&&(e=r),r.slot==="to"&&(t=r);!e||!t||!e.invalid&&t.invalid}#s(e){e.stopPropagation(),this._hasInternalError=!!e.detail.invalid,this._invalidMessage=e.detail.invalid}#r(e,t){return(t.value===void 0||t.value===null)&&(t.value=this.allowValuesOutsideRange?"":e),t.value===""?e:t.value}#i(e){const t=e.slot;t||this.style.setProperty("--from","0"),t==="from"&&this.style.setProperty("--from",this.#r(this.edgeMin,e)),(!t||t==="to")&&this.style.setProperty("--to",this.#r(this.edgeMax,e))}get componentHasError(){return this.invalid||this._hasInternalError}get errorText(){return this.componentHasError?this.error||this._invalidMessage:""}render(){return a`
      <fieldset
        id="fieldset"
        class="w-slider"
        @input="${this.#t}"
      ...
      >
        ...
        ${this.markers?a`<div class="w-slider__markers"></div>`:h}
...
`,le=M`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var de=Object.defineProperty,l=(o,e,t,i)=>{for(var r=void 0,m=o.length-1,p;m>=0;m--)(p=o[m])&&(r=p(e,t,r)||r);return r&&de(e,t,r),r};class n extends Z(F){constructor(){super(...arguments),this.invalid=!1,this.allowValuesOutsideRange=!1,this.suffix="",this._showTooltip=!1,this._inputHasFocus=!1,this.#e=null,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...F.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[J,le,ne]}#e;resetFormControl(){this.value=this.#e}#t(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#a(){this._showTooltip=!1}#s(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#r(e){this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:e,slot:this.slot}}))}async#i(e,t){let i=Number.parseInt(e);if(this.allowValuesOutsideRange&&!t&&this.step&&!(this.slot==="to"&&i>=Number(this.max)-1||this.slot==="from"&&i<=Number(this.min)+1)){const g=1/this.step;i=Math.round(i*g)/g,e=i.toString()}const r=Number.parseInt(this.max),m=Number.parseInt(this.min);if(!this.allowValuesOutsideRange&&(i>r||i<m))return this.#r(I.t({id:"slider.error.out_of_bounds",message:"Value must be between {min} and {max}",values:{min:`${this.min} ${this.suffix}`.trim(),max:`${this.max} ${this.suffix}`.trim()}})),{shouldCancel:!0};if(e==="")return this.required&&this.#r(I.t({id:"slider.error.required",message:"This field is required"})),{shouldCancel:!0};this.value=e;const p=e===this.max||e===this.min;let O=!1;if(this.slot){const R=getComputedStyle(this),g=R.getPropertyValue("--to"),q=R.getPropertyValue("--from"),N=Number.parseInt(g),P=Number.parseInt(q),B=I.t({id:"slider.error.overlap",message:"The maximum value cannot be less than the minimum"});if(this.slot==="from"){const b=this.allowValuesOutsideRange&&N>r?N:Math.min(N,this.allowValuesOutsideRange?r-1:r);i>b&&(O=!0,this.allowValuesOutsideRange&&p?this.value=String(b):this.value=g,t&&(this.#r(B),await this.updateComplete,this.textfield.value=e))}else{const b=this.allowValuesOutsideRange&&P<m?P:Math.max(Number.parseInt(q),this.allowValuesOutsideRange?m+1:m);i<b&&(O=!0,this.allowValuesOutsideRange&&p?this.value=String(b):this.value=q,t&&(this.#r(B),await this.updateComplete,this.textfield.value=e))}}return O?{shouldCancel:!0}:(this.#r(""),this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.allowValuesOutsideRange&&!t&&p?"":e,this.shadowRoot.querySelector("w-attention").handleDone(),{shouldCancel:!1})}async#o(e){const t=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const i=e.currentTarget.value;return(await this.#i(i,t)).shouldCancel?(e.preventDefault(),!1):!0}async#n(e){if(e.key!=="ArrowLeft"&&e.key!=="ArrowRight")return;const t=Number(this.range.value),i=this.step||1;let r;e.key==="ArrowLeft"?r=t-i:r=t+i,r=Math.min(Math.max(r,Number(this.min)),Number(this.max)),(await this.#i(r.toString(),!1)).shouldCancel&&e.preventDefault()}async connectedCallback(){if(super.connectedCallback(),this.#e=this.value,this.setValue(this.value),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:t}]=await Promise.all([Y(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
        /*
      ...
      `,await t({roots:[this.shadowRoot],elements:[this.anchorPositioningStyleElement]})}catch(t){console.error(new Error("Error registering the CSS anchor positioning polyfill. The UI will look broken.",{cause:t}))}}this.#s()}#l(e){e instanceof CustomEvent&&e.type==="focus"&&(this._inputHasFocus=!0)}#d(e){e instanceof CustomEvent&&e.type==="blur"&&(this._inputHasFocus=!1)}get boundaryValue(){return this.slot==="from"?this.min:this.max}get textFieldDisplayValue(){return this._inputHasFocus?this.value!==""?this.value:this.range?.value?Math.min(Math.max(Number(this.range.value),Number(this.min)+1),Number(this.max)-1).toString():"":this.value}get tooltipDisplayValue(){return this.formatter?this.formatter(this.value,this.slot):this.value===""?this.range?.value??this.boundaryValue:this.value||0}updated(e){e.has("value")&&(this.setValue(this.value),this.#s())}render(){return a`
      <div class="w-slider-thumb">
        <label for="range">${this.label}</label>
        ${"anchorName"in document.documentElement.style?h:a`<div class="polyfill-range">
        ...
        <w-textfield
          ...
          @blur="${this.#d}"
        >
          ${this.suffix?a`<w-affix slot="suffix" label="${this.suffix}"></w-affix>`:h}
        </w-textfield>
        ...
        >
          ...
          ></output>
          <span slot="message">
            ${this.tooltipDisplayValue}${this.suffix?a`&nbsp;${this.suffix}`:h}
          </span>
        </w-attention>
    ...
    `}},x={args:{locale:"nb",suffix:"m²"},render({locale:o,suffix:e}){return a(j||(j=f([`
      <w-slider
      ...
      <\/script>
    `])),e,o)}},y={args:{locale:"nb",suffix:"kr"},render({locale:o,suffix:e}){return a(A||(A=f([`
      <w-slider
        label="Price"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,o)}},_={args:{locale:"nb",suffix:"km"},render({locale:o,suffix:e}){return a(H||(H=f([`
      <w-slider
        label="Distance"
        min="0"
        max="250000"
...
}`,...C.parameters?.docs?.source}}};const fe=["Single","Range","SuffixSquareMeters","SuffixCurrency","SuffixKilometers","Marks","Step","OverUnder","SingleError","RangeError","TestCase","CustomError","Description"],Se=Object.freeze(Object.defineProperty({__proto__:null,CustomError:D,Description:C,Marks:k,OverUnder:$,Range:v,RangeError:E,Single:w,SingleError:T,Step:S,SuffixCurrency:y,SuffixKilometers:_,SuffixSquareMeters:x,TestCase:V,__namedExportsOrder:fe,default:pe},Symbol.toStringTag,{value:"Module"}));export{k as M,$ as O,v as R,Se as S,w as a,x as b,y as c,_ as d,S as e,T as f,E as g};

import{x as i,r as E,a as B,i as v,f as y,s as D,u as N,p as Y,E as L,n as d,l as K,g as T}from"./iframe-DfbDQZsf.js";import{s as O,p as C}from"./utilities-D7J5LonZ.js";import{e as x}from"./query-NYTjQBeo.js";const H=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},j=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const r of o.filter(a=>a.patchClose))r._close=()=>this.close()}};let J=class extends H(j(v)){render(){return i`
      <div class="footer">

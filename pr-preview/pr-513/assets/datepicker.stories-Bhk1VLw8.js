...
`,Vr=/^\d{4}-\d{2}-\d{2}$/;function pe(e){if(typeof e!="string")return null;let t=e;Vr.test(e)&&(t=`${e}T00:00:00Z`);const a=Date.parse(t);return Number.isNaN(a)?null:new Date(a)}var Kr=Object.defineProperty,Qr=Object.getOwnPropertyDescriptor,f=(e,t,a,n)=>{for(var r=n>1?void 0:n?Qr(t,a):t,i=e.length-1,o;i>=0;i--)(o=e[i])&&(r=(n?o(t,a,r):o(r))||r);return n&&r&&Kr(t,a,r),r};const Ir=typeof navigator<"u"?navigator.userAgent:"",Ar=/iP(hone|od|ad)/.test(Ir),Rr=Ar?"text":"date",S="calendar",G="input",U="toggle",He="wrapper",z="previous",H={en:je,nb:Vn,sv:yr,da:Ca,fi:fn};class m extends Be(A){constructor(){super(),this.headerFormat="MMMM yyyy",this.weekdayFormat="EEEEEE",this.dayFormat="PPPP",this.isCalendarOpen=!1,this.navigationDate=na(),this.locale=je,this.#e=null,Ke(Nr,Hr,Fr,Er,Yr);const t=Qe();t&&H[t]&&(this.locale=H[t]),this._onClickOutside=this._onClickOutside.bind(this)}static{this.shadowRootOptions={...A.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[Ie,zr,Lr,qr,Xr]}get selectedDate(){return pe(this.value)??null}get month(){return B(this.navigationDate)}#e;get weeks(){const t=this.month,a=this.navigationDate,r=rt({start:B(t),end:aa(t)},{locale:this.locale}).map(i=>({start:i,end:te(i,{locale:this.locale})})).map(i=>nt(i));if(oe(a,t)){const i=ta(a,{locale:this.locale})-1,o=Me(a,y(a,{locale:this.locale}));r[i][o]=a}return r}resetFormControl(){this.value=this.#e}async#t(t){t.preventDefault(),this.isCalendarOpen=!this.isCalendarOpen,this.isCalendarOpen&&(await this.updateComplete,(this.selectedCell||this.todayCell).focus())}#r(){this.navigationDate=R(this.month,1)}#i(){this.navigationDate=ue(this.month)}async#a(){await this.updateComplete,this.input.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}_onClickOutside(t){!this.isCalendarOpen||this.contains(t.target)||(this.isCalendarOpen=!1)}#o(t){this.value=t.target.value}#s(t){t.preventDefault(),this.isCalendarOpen=!0}#d(t){if(t.key===" ")return this.#t(t);(t.key===","||t.key==="Enter")&&t.preventDefault()}async#u(t){const a=this.navigationDate;let n;switch(t.key){case"ArrowUp":n=de(a,7);break;case"ArrowLeft":n=de(a,1);break;case"Home":n=y(a,{locale:this.locale});break;case"PageUp":n=ue(a);break;case"ArrowDown":n=L(a,7);break;case"ArrowRight":n=L(a,1);break;case"End":n=te(a,{locale:this.locale});break;case"PageDown":n=R(a,1);break;case"Escape":this.isCalendarOpen=!1;break;case"Tab":t.target.tagName==="TD"&&!t.shiftKey?(t.preventDefault(),this.previousMonthButton.focus()):t.target.id===z&&t.shiftKey&&(t.preventDefault(),(this.selectedCell||this.todayCell).focus());break}n&&(t.preventDefault(),this.navigationDate=n,await this.updateComplete,this.selectedCell.focus())}#n(t){const a=t.currentTarget.dataset.date;"key"in t?(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.value=a,this.isCalendarOpen=!1,this.toggleButton.focus(),this.#a()):(this.value=a,this.isCalendarOpen=!1,this.#a())}connectedCallback(){super.connectedCallback(),this.#e=this.value;const t=this.lang;if(t&&H[t]&&(this.locale=H[t]),this.value){const a=pe(this.value);a&&(this.navigationDate=a)}document.addEventListener("mousedown",this._onClickOutside),document.addEventListener("touchend",this._onClickOutside),document.addEventListener("focusin",this._onClickOutside)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._onClickOutside),document.removeEventListener("touchend",this._onClickOutside),document.removeEventListener("focusin",this._onClickOutside)}updated(t){t.has("value")&&this.setValue(this.value)}render(){return _`

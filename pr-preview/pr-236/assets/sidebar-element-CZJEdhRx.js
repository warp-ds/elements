 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Lr extends ui{constructor(e){if(super(e),this.it=F,e.type!==ci.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===F||e==null)return this._t=void 0,this.it=e;if(e===Ce)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const r=[e];return r.raw=r,this._t={_$litType$:this.constructor.resultType,strings:r,values:[]}}}Lr.directiveName="unsafeHTML",Lr.resultType=1;const Wr=di(Lr);class as extends q{static styles=ee`
    :host {
      display: block;
      margin-top: 20px;
      margin-bottom: 20px;
...
`,vl=ee`*, :before, :after {
        ...
        `;var wl=Object.defineProperty,Zr=(t,e,r,o)=>{for(var i=void 0,n=t.length-1,s;n>=0;n--)(s=t[n])&&(i=s(e,r,i)||i);return i&&wl(e,r,i),i};const ht={negative:"negative",positive:"positive",warning:"warning",info:"info"};class sr extends ye(q){constructor(){super(),this.variant="info",this.show=!1,this.role="alert",this.show=!1,this.role="alert"}connectedCallback(){if(super.connectedCallback(),!this.variant||!ht[this.variant])throw new Error(`Invalid "variant" attribute. Set its value to one of the following:
 ...
 */function Pt(t,e,r){return t?e(t):r?.(t)}const Xd=JSON.parse('{"select.label.optional":["(valgfrit)"]}'),eu=JSON.parse('{"select.label.optional":["(optional)"]}'),tu=JSON.parse('{"select.label.optional":["(vapaaehtoinen)"]}'),ru=JSON.parse('{"select.label.optional":["(valgfritt)"]}'),ou=JSON.parse('{"select.label.optional":["(valfritt)"]}');class iu extends io(ye(D)){static properties={autoFocus:{type:Boolean,reflect:!0},invalid:{type:Boolean,reflect:!0},always:{type:Boolean,reflect:!0},hint:{type:String,reflect:!0},label:{type:String,reflect:!0},optional:{type:Boolean,reflect:!0},disabled:{type:Boolean,reflect:!0},readOnly:{type:Boolean,relfect:!0},_options:{state:!0},name:{type:String,reflect:!0},value:{type:String,reflect:!0}};static styles=[D.styles];constructor(){super(),Oe(eu,ru,tu,Xd,ou),this._options=this.innerHTML}_setValue=e=>{this.value=e,this.setValue(e)};firstUpdated(){this.autoFocus&&this.shadowRoot.querySelector("select").focus(),Array.from(this.children).map(e=>{e.selected&&this._setValue(e.value)})}handleKeyDown(e){this.readOnly&&(e.key===" "||e.key==="ArrowDown"||e.key==="ArrowUp")&&e.preventDefault()}get#e(){return I([ve.base,!this.invalid&&!this.disabled&&!this.readOnly&&ve.default,this.invalid&&ve.invalid,this.disabled&&ve.disabled,this.readOnly&&ve.readOnly])}get#t(){return I([et.base,this.invalid?et.colorInvalid:et.color])}get#i(){return I([ve.chevron,this.disabled&&ve.chevronDisabled])}get#r(){return"select_id"}get#o(){return this.hint?`${this.#r}__hint`:void 0}onChange({target:e}){this._setValue(e.value);const r=new CustomEvent("change",{detail:e.value});this.dispatchEvent(r)}render(){return w`<div class="${ve.wrapper}">
    ...
    </div>`}}customElements.get("w-select")||customElements.define("w-select",iu);class nu extends io(ye(D)){static properties={disabled:{type:Boolean},invalid:{type:Boolean},id:{type:String},label:{type:String},helpText:{type:String},size:{type:String},max:{type:Number},min:{type:Number},minLength:{type:Number},maxLength:{type:Number},pattern:{type:String},placeholder:{type:String},readOnly:{type:Boolean},required:{type:Boolean},type:{type:String},value:{type:String},name:{type:String},_hasPrefix:{state:!0},_hasSuffix:{state:!0}};static styles=[D.styles,ee`
      :host {
        display: block;
      }
      ::slotted(:last-child) {

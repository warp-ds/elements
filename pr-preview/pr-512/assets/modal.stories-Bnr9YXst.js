import{b as i,r as E,a as S,n as d,i as k,h as w,s as A,u as j,v as q,A as M,l as z,g as B}from"./iframe-BG3Y7ZSQ.js";import{s as C,p as T}from"./utilities-Drmdfdka.js";import{e as v}from"./query-NYTjQBeo.js";let b=[];const I={documentElement:{},body:{}},N=Object.freeze({documentElement:{"scrollbar-gutter":"stable"},body:{overflow:"hidden",position:"relative",height:"100%"}}),L=e=>{e.touches.length>1||e.preventDefault?.()},W=e=>([t,o])=>{I[e][t]=document[e].style[t],document[e].style[t]=o},R=()=>Object.entries(N).forEach(([e,t])=>{Object.entries(t).forEach(W(e))}),Y=e=>([t,o])=>{document[e].style[t]=I[e][t]},J=()=>Object.entries(I).forEach(([e,t])=>{Object.entries(t).forEach(Y(e))}),K=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight;function G(e){let t=-1;const o=r=>{if(r.targetTouches.length!==1)return;const a=r.targetTouches[0].clientY-t;return e.scrollTop===0&&a>0||K(e)&&a<0?L(r):(r.stopPropagation(),!0)};e.ontouchstart=r=>{r.targetTouches.length===1&&(t=r.targetTouches[0].clientY)},e.ontouchmove=o}function U(e){e.ontouchstart=null,e.ontouchmove=null}const O=e=>()=>document[e?"addEventListener":"removeEventListener"]("touchmove",L,{passive:!1}),Q=O(!0),V=O();function X(e){if(!e)throw Error("Could not run setup, an element must be provided");b.some(t=>t===e)||(b.length||(R(),Q()),G(e),b.push(e))}function Z(){b.forEach(U),V(),J(),b=[]}const $=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},D=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const r of o.filter(a=>a.patchClose))r._close=()=>this.close()}};var ee=Object.defineProperty,c=(e,t,o,r)=>{for(var a=void 0,n=e.length-1,s;n>=0;n--)(s=e[n])&&(a=s(t,o,a)||a);return a&&ee(t,o,a),a};class l extends D(k){constructor(){super(),this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}async open(){this.dialogEl.showModal(),this.handleListeners(),X(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent("shown",{bubbles:!0,composed:!0}))}close(){this.handleListeners("removeEventListener"),this.dialogEl.classList.add("close"),this.dialogEl.addEventListener("animationend",async()=>{this.dialogEl.classList.remove("close"),this.dialogEl.close(),Z(),await this.updateComplete,this.dispatchEvent(new CustomEvent("hidden",{bubbles:!0,composed:!0}))},{once:!0})}render(){return i`

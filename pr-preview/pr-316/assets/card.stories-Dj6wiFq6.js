import{g as i,x as o}from"./iframe-CR1nLUWB.js";import{s as n,p}from"./utilities-CYU-eqHV.js";const{events:d,args:m,argTypes:g}=i("w-card"),f={title:"Navigation/Card",render(c){return o`
      <w-card ${n(p(c))}>

import{g as i,x as o}from"./iframe-ByFBtrIp.js";import{s as n,p}from"./utilities-7pmNWMLg.js";const{events:d,args:m,argTypes:g}=i("w-card"),f={title:"Navigation/Card",render(c){return o`
      <w-card ${n(p(c))}>

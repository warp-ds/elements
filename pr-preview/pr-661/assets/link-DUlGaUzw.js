import{n as e}from"./chunk-DnJy8xQt.js";import{m as t,n,r,s as i,t as a}from"./lit-JruGAyH3.js";import{n as o,o as s,r as c,t as l}from"./decorate-CDMjP9kV.js";import{n as u,t as d}from"./styles-DphVJT09.js";var f,p,m,h,g,_=e((()=>{a(),f=t`
  :host {
...
`})),v,y=e((()=>{a(),_(),v=t`
  ...
  ${h}
`})),b,x,S=e((()=>{a(),c(),d(),y(),o(),b=[`primary`,`secondary`,`negative`,`negativeQuiet`,`utility`,`utilityQuiet`,`quiet`,`link`,`overlay`,`overlayInverted`,`overlayQuiet`,`overlayInvertedQuiet`],x=class extends n{constructor(...e){super(...e),this.autofocus=!1,this.small=!1,this.disabled=!1,this.fullWidth=!1}static{this.shadowRootOptions={...n.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[u,v]}connectedCallback(){if(super.connectedCallback(),this.variant&&!b.includes(this.variant))throw Error(`Invalid "variant" attribute. Set its value to one of the following:\n${b.join(`, `)}.`)}firstUpdated(){this.autofocus&&setTimeout(()=>this.focus(),0)}render(){return i`
      <a
        href="${this.href}"
        part="base"
        target="${this.target}"
        rel="${this.target===`_blank`?this.rel||`noopener`:r}"
        tabindex="0"
      >
        <slot></slot>
      </a>
    `}},l([s({type:Boolean,reflect:!0})],x.prototype,`autofocus`,void 0),l([s({reflect:!0})],x.prototype,`variant`,void 0),l([s({type:Boolean,reflect:!0})],x.prototype,`small`,void 0),l([s({reflect:!0})],x.prototype,`href`,void 0),l([s({type:Boolean,reflect:!0})],x.prototype,`disabled`,void 0),l([s({reflect:!0})],x.prototype,`target`,void 0),l([s({reflect:!0})],x.prototype,`rel`,void 0),l([s({attribute:`full-width`,type:Boolean,reflect:!0})],x.prototype,`fullWidth`,void 0),customElements.get(`w-link`)||customElements.define(`w-link`,x)}));export{_ as n,g as r,S as t};
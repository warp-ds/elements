...
`})))()}var F,I;function L(){return(L=e((()=>{se(),ne(),g(),r(),s(),fe(),re(),ue(),pe(),x(),C(),T(),D(),k(),j(),P(),ce(),y(),F={base:`block text-m mb-0 py-12 pr-32 rounded-4 w-full focusable focus:[--w-outline-offset:-2px] appearance-none cursor-pointer caret-current`,default:`s-text s-bg pl-8 border-1 s-border-strong hover:s-border-strong-hover active:s-border-active`,disabled:`s-text-disabled s-bg-disabled-subtle pl-8 border-1 s-border-disabled hover:s-border-disabled active:s-border-disabled pointer-events-none`,invalid:`s-text s-bg pl-8 border-1 s-border-negative hover:s-border-negative-hover active:s-border-active outline-[--w-s-color-border-negative]!`,readOnly:`s-text bg-transparent pl-0 border-0 pointer-events-none before:hidden`,wrapper:`relative`,selectWrapper:`relative before:block before:absolute before:right-0 before:bottom-0 before:w-32 before:h-full before:pointer-events-none `,chevron:`block absolute top-[30%] right-0 bottom-0 w-32 h-full s-icon pointer-events-none cursor-pointer`,chevronDisabled:`opacity-25`},I=class extends de(o){#e;get#t(){return this.helpText!==void 0||this._hasHelpTextSlot}#n;#r;#i;static{this.styles=[le,A,M,N,u`
		...
		`]}constructor(){super(),this.#e=new v(this),this.autoFocus=!1,this.autofocus=!1,this.invalid=!1,this.always=!1,this.optional=!1,this.disabled=!1,this.readOnly=!1,this.readonly=!1,this._options=[],this._hasHelpTextSlot=!1,this.#n=void 0,this.#r=()=>this.#l(),this._setValue=e=>{this.value=e,this.setValue(e)},ie(S,E,w,b,O)}resetFormControl(){this.value=this.#n}#a(){return[...this.children].filter(e=>e.tagName.toLowerCase()===`option`||e.tagName.toLowerCase()===`w-option`)}#o(){return this.shadowRoot?.querySelector(`select`)}#s(){return this.#a().some(e=>e.hasAttribute(`selected`))}#c(e){let t=this.#o();if(!t)return;let n=!1;for(let r of[...t.options]){let t=!n&&r.value===e;r.selected=t,r.toggleAttribute(`selected`,t),t&&(n=!0)}}#l({allowDefaultFirstOption:e=!1}={}){let t=this.#o();if(!t)return;let n=t.value;!n||n===this.value||!e&&!this.value&&!this.#s()&&t.selectedIndex===0||(this._setValue(n),this.#c(n))}#u({syncValueFromSelected:e=!1}={}){let t=this.#a(),n,r=t.map(t=>{let r=t.getAttribute(`value`)??``,i=t.textContent??``,o=t.hasAttribute(`selected`),s=t.hasAttribute(`disabled`);return e&&n===void 0&&o&&(n=r),a`<option
				value="${r}"
				?selected=${o}
				?disabled=${s}
			>
				${i}
			</option>`});this._options=r,e&&n!==void 0&&n!==this.value&&this._setValue(n)}connectedCallback(){super.connectedCallback(),this.#n=this.value,(this.autofocus||this.autoFocus)&&this.shadowRoot.querySelector(`select`).focus(),this.#u({syncValueFromSelected:!0}),this.ownerDocument?.defaultView?.addEventListener(`pageshow`,this.#r),this.#i=new MutationObserver(()=>{this.#u({syncValueFromSelected:!0})}),this.#i.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`selected`,`disabled`,`value`]})}disconnectedCallback(){super.disconnectedCallback(),this.ownerDocument?.defaultView?.removeEventListener(`pageshow`,this.#r),this.#i?.disconnect()}firstUpdated(){this.value&&this.#c(this.value),this.#l({allowDefaultFirstOption:!1})}formStateRestoreCallback(e,t){if(typeof e==`string`&&e){this._setValue(e),this.#c(e);return}this.#l({allowDefaultFirstOption:!0})}willUpdate(e){e.has(`value`)&&this.setValue(this.value)}updated(e){if(e.has(`value`)){let e=this.#o();e&&e.value!==this.value&&(e.value=this.value??``),this.#c(this.value??``)}}handleKeyDown(e){(this.readonly||this.readOnly)&&(e.key===` `||e.key===`ArrowDown`||e.key===`ArrowUp`)&&e.preventDefault(),this.#e.submit(e)}get#d(){return f([F.base,!this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&F.default,this.invalid&&F.invalid,this.disabled&&F.disabled,(this.readonly||this.readOnly)&&F.readOnly])}get#f(){return`help-text`}get#p(){return f([F.chevron,this.disabled&&F.chevronDisabled])}get#m(){return`select_id`}get#h(){return this.helpText||this.hint?`${this.#m}__hint`:void 0}onChange(e){let t=e.currentTarget.value;this._setValue(t),this.#c(t),this.dispatchEvent(new CustomEvent(`change`,{detail:t,bubbles:!0,composed:!0}))}helpTextSlotChange(){this.renderRoot.querySelector(`slot[name=help-text]`).assignedElements().length&&(this._hasHelpTextSlot=!0)}render(){return a`<div class="${F.wrapper}">
			${this.label?a`
							<label for="${this.#m}">
								${this.label}
								${this.optional?a`
			...
			<div class="${F.selectWrapper}">
				<select
					...
					aria-describedby="${_(this.#h)}"
					aria-invalid="${_(this.invalid)}"
					aria-errormessage="${_(this.invalid&&this.#h)}"
			...
			<div
				?hidden=${!this.#t&&!this.always&&!this.invalid}
				class="${this.#f}"
				id="${_(this.#h)}"
			>
        ...
        `},args:B,argTypes:V,parameters:{actions:{handles:z}}},U={args:{label:`Berries`}},W={args:{label:`Berries`,"help-text":`We assume this is your jam preference`}},G={args:{label:`Berries`,invalid:!0,"help-text":`Wrong choice`}},K={args:{label:`Berries`,disabled:!0}},q={args:{label:`Berries`,"read-only":!0}},J={render(e){return a`
            <div style="display: flex; flex-direction: column; gap: 32px;">
                ...
                <w-select ${p(m(e))} id="warp-aria-labelledby-example">
                    <option value="raspberries">Raspberries</option>
                    <option value="strawberries" selected>Strawberries</option>
                    <option value="cloudberries">Cloudberries</option>
                </w-select>

import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{n,t as r}from"./preload-helper-wdlQj8DP.js";import{a as i,c as a,d as o,h as s,l as c,r as l,s as u,t as d,x as f,y as p}from"./decorate-Bt2QF_uA.js";import{a as m,o as ee,r as te,t as ne}from"./i18n-CkjYRTT1.js";import"./__uno-CmvWQQDY.js";import{n as re,t as ie}from"./dist-D5kJVy4t.js";import{t as h}from"./query-BHY-nhsh.js";import{n as ae,t as oe}from"./class-map-DaGxfNVq.js";import{t as se}from"./icon-CD69d68Q.js";import{n as ce,t as le}from"./styles-Cw_r5k83.js";import{n as ue,t as de}from"./FormControlMixin-BCJbRrUC.js";import{t as fe}from"./affix-Chez9f4_.js";import{r as g,t as pe}from"./if-defined-DBI32Ir5.js";import{t as me}from"./attention-B97eQe-a.js";import{n as he,t as ge}from"./utils-qj3txzlQ.js";import{t as _}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{t as _e}from"./tooltip-D5IbvAIJ.js";import{t as ve}from"./textfield-DaPeGX4V.js";var ye;function be(){return(be=e((()=>{ye=JSON.parse(`{"select.label.optional":["Valgfri"],"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})))()}var xe;function Se(){return(Se=e((()=>{xe=JSON.parse(`{"select.label.optional":["Optional"],"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})))()}var Ce;function v(){return(v=e((()=>{Ce=JSON.parse(`{"select.label.optional":["Valinnainen"],"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})))()}var y;function b(){return(b=e((()=>{y=JSON.parse(`{"select.label.optional":["Valgfri"],"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})))()}var x;function S(){return(S=e((()=>{x=JSON.parse(`{"select.label.optional":["Valfritt"],"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"],"slider.label.from":["From"],"slider.label.to":["To"],"slider.placeholder.from":["Min"],"slider.placeholder.to":["Max"]}`)})))()}var C;function w(){return(w=e((()=>{a(),C=p`
	.w-slider {
		position: relative;
		border: none;
		padding: 0;
...
`})))()}var T;function E(){return(E=e((()=>{a(),l(),ee(),te(),le(),be(),Se(),v(),b(),S(),w(),pe(),se(),_e(),T=class extends c{static{this.shadowRootOptions={...c.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[ce,C,p`
			:host {
		...
		`]}get#e(){return this.helpText!==void 0||this._hasHelpTextSlot}constructor(){super(),this.disabled=!1,this.openEnded=!1,this.invalid=!1,this.required=!1,this.optional=!1,this.hiddenTextfield=!1,this._invalidMessage=``,this._hasInternalError=!1,this._showError=!1,this._tabbableElements=[],this._hasLabel=!1,this._hasHelpTextSlot=!1,ne(xe,y,Ce,ye,x)}#t(){let e=this.querySelectorAll(`w-slider-thumb`),t=!1;for(let n of e.values())n.min=this.edgeMin,n.max=this.edgeMax,n.step=this.step,n.suffix=this.suffix??``,n.required=this.required,n.labelFormatter=this.labelFormatter,n.valueFormatter=this.valueFormatter,n.tooltipFormatter=this.tooltipFormatter,n.openEnded=this.openEnded,n._hiddenTextfield=this.hiddenTextfield,n.ariaLabel||(n.slot||(n.ariaLabel=this.label||null),n.slot===`from`&&(n.ariaLabel=`${this.label} min`),n.slot===`to`&&(n.ariaLabel=`${this.label} max`)),(n.slot===`from`||n.slot===`to`)&&(t=!0),n.disabled=this.disabled,n.invalid=!!this.errorText,this.#l(n);t?(this.fieldset.style.setProperty(`--active-range-inline-start-padding`,`var(--w-slider-thumb-size, 28px)`),this.fieldset.style.setProperty(`--active-range-inline-end-padding`,`var(--w-slider-thumb-size, 28px)`)):this.fieldset.style.setProperty(`--active-range-border-radius`,`4px`)}get edgeMin(){return this.openEnded?(Number(this.min)-1).toString():this.min}get edgeMax(){return this.openEnded?(Number(this.max)+1).toString():this.max}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.step&&this.fieldset.style.setProperty(`--step`,String(this.step)),this.min!==void 0&&this.fieldset.style.setProperty(`--min`,this.edgeMin),this.max!==void 0&&this.fieldset.style.setProperty(`--max`,this.max),this.markers&&this.fieldset.style.setProperty(`--markers`,String(this.markers)),this.openEnded&&this.fieldset.style.setProperty(`--over-under-offset`,`1`),this.label&&(this._hasLabel=!0);let e=this.querySelectorAll(`w-slider-thumb`);if(e.length===2){this.fieldset.style.setProperty(`--range-slider-magic-pixel`,`1px`);let t=[...e];this._tabbableElements[0]=t[0].shadowRoot.querySelector(`input`),this._tabbableElements[1]=t[1].shadowRoot.querySelector(`input`),this._tabbableElements[2]=t[0].shadowRoot.querySelector(`w-textfield`),this._tabbableElements[3]=t[1].shadowRoot.querySelector(`w-textfield`)}else if(e.length===1){let t=[...e];this._tabbableElements[0]=t[0].shadowRoot.querySelector(`input`),this._tabbableElements[1]=t[0].shadowRoot.querySelector(`w-textfield`)}this.invalid&&this.error&&(this._showError=!0),this.#t()}updated(e){(e.has(`disabled`)||e.has(`required`)||e.has(`min`)||e.has(`step`)||e.has(`max`)||e.has(`suffix`)||e.has(`labelFormatter`)||e.has(`valueFormatter`)||e.has(`_invalidMessage`)||e.has(`_hasInternalError`))&&this.#t(),(e.has(`error`)||e.has(`invalid`))&&(this._showError=!!(this.error&&this.invalid),this.#t())}#n(e){e.stopPropagation();let t=e.target;this.#l(t)}#r(e){let t=e.target;this.#l(t),t.slot&&this.#o()}#i(){this._showError=!!this.componentHasError,this.#t()}#a(e){if(e.key===`Tab`){let t=this._tabbableElements.indexOf(e.target.shadowRoot.activeElement);if(t===-1)return;let n=e.shiftKey?-1:1,r=this._tabbableElements[t+n];if(!r)return;e.preventDefault(),r.focus()}}#o(){let e=null,t=null,n=this.querySelectorAll(`w-slider-thumb`);for(let r of n.values())r.slot===`from`&&(e=r),r.slot===`to`&&(t=r);!e||!t||!e.invalid&&t.invalid}#s(e){e.stopPropagation();let t=this._hasInternalError||this.invalid,n=e.target;if(this._hasInternalError=!!e.detail.invalid||this.invalid,this._invalidMessage=e.detail.invalid,t===!0&&this._hasInternalError===!1){let e=this.querySelectorAll(`w-slider-thumb`);for(let t of e.values())t!==n&&t.updateFieldAfterValidation()}}#c(e,t){return t.value??=this.openEnded?``:e,t.value===``?e:t.value}#l(e){let t=e.slot;t||this.fieldset.style.setProperty(`--from`,`0`),t===`from`&&this.fieldset.style.setProperty(`--from`,this.#c(this.edgeMin,e)),(!t||t===`to`)&&this.fieldset.style.setProperty(`--to`,this.#c(this.edgeMax,e))}get componentHasError(){return this.invalid||this._hasInternalError}get errorText(){return this._showError?this.error||this._invalidMessage:``}_handleLabelSlotChange(e){let t=e.target.assignedElements().length>0;this._hasLabel=t||!!this.label,console.log(`Label content changed, has label:`,this._hasLabel)}get _label(){let e=this._hasLabel&&this.optional&&!this.required?s`
				...
				`:s`
					...
					${e} ${t}
				`}helpTextSlotChange(){this.renderRoot.querySelector(`slot[name=help-text]`).assignedElements().length&&(this._hasHelpTextSlot=!0)}render(){return s`
			<fieldset
				id="fieldset"
				class="w-slider"
				@input="${this.#r}"
				...
				@thumbreset="${this.#n}"
				@keydown="${this.#a}"
				aria-invalid="${g(this.errorText?`true`:void 0)}"
		...
		`}},d([u({reflect:!0})],T.prototype,`label`,void 0),d([u({type:String,reflect:!0})],T.prototype,`tooltip`,void 0),d([u({type:Boolean,reflect:!0})],T.prototype,`disabled`,void 0),d([u({type:Boolean,attribute:`open-ended`})],T.prototype,`openEnded`,void 0),d([u({type:String,reflect:!0})],T.prototype,`error`,void 0),d([u({type:String,reflect:!0,attribute:`help-text`})],T.prototype,`helpText`,void 0),d([u({type:Boolean,reflect:!0})],T.prototype,`invalid`,void 0),d([u({type:Boolean,reflect:!0})],T.prototype,`required`,void 0),d([u({type:Boolean,reflect:!0})],T.prototype,`optional`,void 0),d([u({reflect:!0})],T.prototype,`min`,void 0),d([u({reflect:!0})],T.prototype,`max`,void 0),d([u({type:Number,reflect:!0})],T.prototype,`markers`,void 0),d([u({type:Number,reflect:!0})],T.prototype,`step`,void 0),d([u({reflect:!0})],T.prototype,`suffix`,void 0),d([u({type:Boolean,reflect:!0,attribute:`hidden-textfield`})],T.prototype,`hiddenTextfield`,void 0),d([u({attribute:!1})],T.prototype,`valueFormatter`,void 0),d([u({attribute:!1})],T.prototype,`tooltipFormatter`,void 0),d([u({attribute:!1})],T.prototype,`labelFormatter`,void 0),d([h(`fieldset`)],T.prototype,`fieldset`,void 0),d([i()],T.prototype,`_invalidMessage`,void 0),d([i()],T.prototype,`_hasInternalError`,void 0),d([i()],T.prototype,`_showError`,void 0),d([i()],T.prototype,`_tabbableElements`,void 0),d([i()],T.prototype,`_hasLabel`,void 0),d([i()],T.prototype,`_hasHelpTextSlot`,void 0),customElements.get(`w-slider`)||customElements.define(`w-slider`,T)})))()}var D;function O(){return(O=e((()=>{a(),D=f(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`)})))()}var k;function A(){return(A=e((()=>{a(),k=p`
	.w-slider-thumb {
		position: relative;
		display: grid;
      ...
      `,await t({roots:[this.shadowRoot],elements:[this.anchorPositioningStyleElement]})}catch(e){console.error(Error(`Error registering the CSS anchor positioning polyfill. The UI will look broken.`,{cause:e}))}}let e=window.navigator.userAgent;j.test(e)&&!M.test(e)&&this.tooltipTarget&&this.tooltipTarget.style.setProperty(`--transform-offset`,`var(--w-slider-thumb-size, 28px)`),this.#i()}get boundaryValue(){return this.slot===`from`?this.min:this.max}get textFieldDisplayValue(){return this._inputHasFocus&&this.value===``?this.range?.value?Math.min(Math.max(Number(this.range.value),Number(this.min)+1),Number(this.max)-1).toString():``:this.value}get tooltipDisplayValue(){let e;return e=this.tooltipFormatter?this.tooltipFormatter(this.value,this.slot):this.valueFormatter?this.valueFormatter(this.value,this.slot):this.value===``?this.range?.value??this.boundaryValue:this.value||0,e}get ariaDescriptionText(){let e=``,t=this.ariaDescription||``,n=this.value===``;return this.openEnded&&n&&(e=this.slot===`from`?m.t({id:`slider.placeholder.from`,message:`Min`}):m.t({id:`slider.placeholder.to`,message:`Max`})),e?`${e}, ${t}`:t}updated(e){if(e.has(`openEnded`)&&this.openEnded&&!this.placeholder&&(this.slot===`to`||this.slot===``?this.placeholder=m.t({id:`slider.placeholder.to`,message:`Max`,comment:`Max as in short for Maximum`}):this.slot===`from`&&(this.placeholder=m.t({id:`slider.placeholder.from`,message:`Min`,comment:`Min as in short for Minimum`}))),e.has(`value`)){this.#t===void 0&&this.value!==void 0&&(this.#t=this.value),this.setValue(this.value),this.#i();let t=e.get(`value`);this.value===``&&t&&this.dispatchEvent(new CustomEvent(`thumbreset`,{bubbles:!0}))}}render(){let e=this.placeholder&&!this.value,t=this.tooltipDisplayValue!==`Min`&&this.tooltipDisplayValue!==`Max`&&(this.suffix??``)!==``;return s`
			<div class="w-slider-thumb">
				...
				<input
					...
					aria-describedby="${g(this.ariaDescription?`aria-description`:void 0)}"
					class="w-slider-thumb__range"
					type="range"
					.value="${this.value}"
					min="${this.min}"
					max="${this.max}"
					step="${g(!this.openEnded&&this.step?this.step:void 0)}"
					?disabled="${this.disabled}"
					@mousedown="${this.#n}"
					@mouseup="${this.#r}"
					@touchstart="${this.#n}"
				...
				<w-textfield
					aria-label="${this.ariaLabel}"
					aria-description="${g(this.ariaDescriptionText)}"
					class="${ae({"w-slider-thumb__textfield":!0,"sr-only":this._hiddenTextfield})}"
					type="number"
				...
				>
					...
					></output>
					<span slot="message">
						${this.tooltipDisplayValue}${t?s`&nbsp;${this.suffix??``}`:o}
					</span>
				</w-attention>
		...
		`}},d([u({attribute:`aria-label`})],N.prototype,`ariaLabel`,void 0),d([u({attribute:`aria-description`})],N.prototype,`ariaDescription`,void 0),d([u({reflect:!0})],N.prototype,`name`,void 0),d([u({reflect:!0})],N.prototype,`value`,void 0),d([u({type:Boolean,reflect:!0})],N.prototype,`disabled`,void 0),d([u({type:Boolean,reflect:!0})],N.prototype,`invalid`,void 0),d([u({attribute:!1,reflect:!1})],N.prototype,`openEnded`,void 0),d([u({reflect:!0})],N.prototype,`placeholder`,void 0),d([i()],N.prototype,`markers`,void 0),d([i()],N.prototype,`required`,void 0),d([i()],N.prototype,`step`,void 0),d([i()],N.prototype,`min`,void 0),d([i()],N.prototype,`max`,void 0),d([i()],N.prototype,`suffix`,void 0),d([u({attribute:!1})],N.prototype,`valueFormatter`,void 0),d([u({attribute:!1})],N.prototype,`tooltipFormatter`,void 0),d([u({attribute:!1})],N.prototype,`labelFormatter`,void 0),d([h(`input[type="range"]`)],N.prototype,`range`,void 0),d([h(`.w-slider-thumb__tooltip-target`)],N.prototype,`tooltipTarget`,void 0),d([h(`w-textfield`)],N.prototype,`textfield`,void 0),d([i()],N.prototype,`_showTooltip`,void 0),d([i()],N.prototype,`_inputHasFocus`,void 0),d([i()],N.prototype,`_hiddenTextfield`,void 0),customElements.get(`w-slider-thumb`)||customElements.define(`w-slider-thumb`,N)})))()}var Te=t({CustomError:()=>Y,Description:()=>X,HiddenMinimumMaximumLabels:()=>Q,Marks:()=>W,OpenEnded:()=>K,Range:()=>R,RangeError:()=>J,RangeOptional:()=>z,RangeWithTooltip:()=>B,Single:()=>P,SingleDisabled:()=>F,SingleError:()=>q,SingleOptional:()=>I,SingleWithTooltip:()=>L,Step:()=>G,SuffixCurrency:()=>H,SuffixKilometers:()=>U,SuffixSquareMeters:()=>V,VisuallyHiddenLabel:()=>Z,VisuallyHiddenTextfield:()=>$,__namedExportsOrder:()=>Ie,default:()=>Fe}),Ee,De,Oe,ke,Ae,je,Me,Ne,Pe,Fe,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,Ie;function Le(){return(Le=e((()=>{re(),a(),fe(),me(),ve(),_e(),E(),we(),{events:Me,args:Ne,argTypes:Pe}=ie(`w-slider`),Fe={title:`Forms/Slider and Range Slider`,args:Ne,argTypes:Pe,parameters:{actions:{handles:Me}}},P={render(){return s`
            <form>
        ...
        `}},H={args:{locale:`nb`,suffix:`kr`},render({locale:e,suffix:t}){return s(Ee||=_([`
            <w-slider
                label="Price"
                min="0"
                max="250000"
            ...
            <\/script>
        `]),t,e)}},U={args:{locale:`nb`,suffix:`km`},render({locale:e,suffix:t}){return s(De||=_([`
            <w-slider
                label="Distance"
                min="0"
                max="250000"
...
}`,...$.parameters?.docs?.source}}},Ie=[`Single`,`SingleDisabled`,`SingleOptional`,`SingleWithTooltip`,`Range`,`RangeOptional`,`RangeWithTooltip`,`SuffixSquareMeters`,`SuffixCurrency`,`SuffixKilometers`,`Marks`,`Step`,`OpenEnded`,`SingleError`,`RangeError`,`CustomError`,`Description`,`VisuallyHiddenLabel`,`HiddenMinimumMaximumLabels`,`VisuallyHiddenTextfield`]})))()}export{P as a,H as c,Le as d,Te as f,J as i,U as l,K as n,q as o,R as r,G as s,W as t,V as u};
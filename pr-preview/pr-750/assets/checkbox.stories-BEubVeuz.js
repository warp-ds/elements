import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,c as r,d as i,g as a,h as o,l as s,p as c,r as l,s as u,t as d,y as ee}from"./decorate-Bt2QF_uA.js";import{l as te,s as ne,u as re}from"./async-directive-BZIqf2aE.js";import{a as f,o as ie,r as ae,t as oe}from"./i18n-CkjYRTT1.js";import{i as p,n as se,r as ce,t as le}from"./directive-CZiujxgm.js";import{n as ue,t as de}from"./dist-D5kJVy4t.js";import{t as fe}from"./query-BHY-nhsh.js";import{t as pe}from"./icon-CD69d68Q.js";import{n as me,t as he}from"./styles-Cw_r5k83.js";import{i as ge,n as _e,r as ve}from"./utilities-BHNt5DhH.js";import{n as m,t as ye}from"./FormControlMixin-BCJbRrUC.js";import{r as h,t as be}from"./if-defined-DBI32Ir5.js";import{n as xe,t as Se}from"./utils-qj3txzlQ.js";import{t as g}from"./tooltip-D5IbvAIJ.js";var _;function Ce(){return(Ce=e((()=>{a(),ce(),ne(),_=le(class extends se{constructor(e){if(super(e),e.type!==p.PROPERTY&&e.type!==p.ATTRIBUTE&&e.type!==p.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!re(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===c||t===i)return t;let n=e.element,r=e.name;if(e.type===p.PROPERTY){if(t===n[r])return c}else if(e.type===p.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return c}else if(e.type===p.ATTRIBUTE&&n.getAttribute(r)===t+``)return c;return te(e),t}})})))()}function we(){return(we=e((()=>{Ce()})))()}var Te;function Ee(){return(Ee=e((()=>{r(),Te=ee`
	:host {
...
`})))()}var v;function y(){return(y=e((()=>{m(),r(),l(),be(),we(),he(),xe(),Ee(),v=class extends ye(s){constructor(...e){super(...e),this.#e=new Se(this),this.value=null,this.indeterminate=!1,this.checked=!1,this.disabled=!1,this.required=!1,this.invalid=!1,this.#t=!1,this.#n=!1,this.#r=!1,this.#i=()=>{this.#o(),this.#u()},this.#a=e=>{this.disabled||e.defaultPrevented||(e.key===` `||e.key===`Spacebar`||e.key===`Enter`)&&(this.#e.submit(e)||e.composedPath()[0]!==this.input&&(e.preventDefault(),this.click()))}}static{this.styles=[me,Te]}#e;static{this.shadowRootOptions={...s.shadowRootOptions,delegatesFocus:!0}}set name(e){this._ownName=e}get name(){return this._ownName||this._groupName}#t;#n;#r;get _computedInvalid(){return this.invalid||this._groupInvalid===!0}connectedCallback(){super.connectedCallback();let e=this.getAttribute(`value`);this.value=e??`on`,this.#t=this.hasAttribute(`checked`),this.checked=this.#t,this.addEventListener(`invalid`,this.#i),this.addEventListener(`keydown`,this.#a),this.#d()}handleClick(){this.disabled||(this.#o(),this.checked=!this.checked,this.indeterminate=!1,this.updateComplete.then(()=>{this.input.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}))}#i;#a;updated(e){super.updated(e),(e.has(`checked`)||e.has(`indeterminate`))&&this.#f(),this.#p(e)&&(this.#d(),this.#u())}resetFormControl(){this.checked=this.#t,this.#d(),this.#u()}click(){this.disabled||this.input?.click()}focus(e){this.input?.focus(e)}blur(){this.input?.blur()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#u(),this.internals.checkValidity()}reportValidity(){return this.#o(),this.#u(),this.internals.checkValidity()}#o(){this.#r=!0}#s(){return this.input?.validationMessage||` `}#c(){return this.input??void 0}#l(e){this.internals.setValidity(e,this.#s(),this.#c())}#u(){if(this.disabled){this.internals.setValidity({});return}let e=this.required&&!this.checked,t=this.invalid&&!this.#n;if(e){this.#n=!0,this.invalid=this.#r,this.#l({valueMissing:!0});return}if(this.#n&&=(this.invalid=!1,!1),t){this.#l({customError:!0});return}this.internals.setValidity({})}#d(){if(this.disabled){this.setValue(null);return}let e=this.checked?this.value:null;this.setValue(e)}#f(){this.input&&(this.input.checked=this.checked,this.input.indeterminate=this.indeterminate)}#p(e){return e.has(`checked`)||e.has(`value`)||e.has(`disabled`)||e.has(`required`)||e.has(`invalid`)}render(){let e=!this.checked&&this.indeterminate,t=e?`mixed`:this.checked?`true`:`false`;return o`
			<label part="base">
				<span part="control">
					<input
						part="input"
						...
						aria-checked=${t}
						aria-invalid=${h(this._computedInvalid?`true`:void 0)}
		...
		`}},d([fe(`input[type="checkbox"]`)],v.prototype,`input`,void 0),d([u({reflect:!0})],v.prototype,`name`,null),d([u({reflect:!0})],v.prototype,`value`,void 0),d([u({type:Boolean,reflect:!0})],v.prototype,`indeterminate`,void 0),d([u({type:Boolean,reflect:!0})],v.prototype,`checked`,void 0),d([u({type:Boolean,reflect:!0})],v.prototype,`disabled`,void 0),d([u({type:Boolean,reflect:!0})],v.prototype,`required`,void 0),d([u({type:Boolean,reflect:!0})],v.prototype,`invalid`,void 0),d([u({attribute:!1})],v.prototype,`_groupInvalid`,void 0),d([u({attribute:!1})],v.prototype,`_groupName`,void 0),customElements.get(`w-checkbox`)||customElements.define(`w-checkbox`,v)})))()}var b;function x(){return(x=e((()=>{b=JSON.parse(`{"checkbox-group.label.optional":["Valgfri"],"checkbox-group.validation.required":["Mindst én valgt mulighed er påkrævet."]}`)})))()}var S;function C(){return(C=e((()=>{S=JSON.parse(`{"checkbox-group.label.optional":["Optional"],"checkbox-group.validation.required":["At least one selection is required."]}`)})))()}var w;function T(){return(T=e((()=>{w=JSON.parse(`{"checkbox-group.label.optional":["Valinnainen"],"checkbox-group.validation.required":["Vähintään yksi valinta vaaditaan."]}`)})))()}var E;function D(){return(D=e((()=>{E=JSON.parse(`{"checkbox-group.label.optional":["Valgfri"],"checkbox-group.validation.required":["Minst ett valg er påkrevd."]}`)})))()}var O;function k(){return(k=e((()=>{O=JSON.parse(`{"checkbox-group.label.optional":["Valfritt"],"checkbox-group.validation.required":["Minst ett val krävs."]}`)})))()}var A,j;function M(){return(M=e((()=>{ie(),m(),r(),l(),be(),ae(),x(),C(),T(),D(),k(),pe(),g(),oe(S,E,w,b,O),A=()=>f._({id:`checkbox-group.validation.required`,message:`At least one selection is required.`,comment:`Shown when required checkbox group has no selections`}),j=class extends ye(s){constructor(...e){super(...e),this.optional=!1,this.required=!1,this.invalid=!1,this._hasHelpTextSlot=!1,this.#e=!1,this.#t=!1,this._internalTabIndex=-1,this.#r=()=>{this.#o(),this.#_(),this.requestUpdate()},this.#i=()=>{this.#o(),this.#_(),this.requestUpdate()},this.#a=()=>{this.#l(),this.#_(),this.requestUpdate()},this.#s=()=>{this.requestUpdate()}}static{this.shadowRootOptions={...s.shadowRootOptions,delegatesFocus:!0}}#e;#t;#n;static{this.styles=ee`
		.wrapper {
			display: inline-flex;
	...
	`}helpTextSlotChange(){this.renderRoot.querySelector(`slot[name=help-text]`).assignedElements().length&&(this._hasHelpTextSlot=!0)}render(){let e=this.#c()>0,t=this.required&&!e&&this.#e,n=this.invalid||t,r=n?this.#p():this.helpText,a=!!(r||this._hasHelpTextSlot),s=a?`checkbox-group__help`:void 0,c=this.label?`checkbox-group__label`:void 0,l=n?`true`:void 0;return o`
        ...
        `}},z={args:{name:`invalidfoo`,value:`bar`,invalid:!0}},B={args:{name:`indeterminatefoo`,value:`bar`,indeterminate:!0}},V={args:{name:`indeterminateerrorfoo`,value:`bar`,indeterminate:!0,invalid:!0}},H={args:{name:`indeterminatedisabledfoo`,value:`bar`,indeterminate:!0,disabled:!0}},U={render:()=>o`
...
}`,...Q.parameters?.docs?.source}}},Oe=[`Default`,`WithTooltip`,`Invalid`,`Indeterminate`,`IndeterminateError`,`IndeterminateDisabled`,`CheckboxFormAssociated`,`Disabled`,`CheckboxGroup`,`CheckboxGroupWithHelpText`,`CheckboxGroupWithLabel`,`CheckboxGroupWithHelpTextAndLabel`,`CheckboxGroupWithOptional`,`CheckboxGroupWithInvalid`,`CheckboxGroupRequired`,`CheckboxGroupFormAssociated`]})))()}export{K as a,L as c,H as d,V as f,$ as h,Z as i,W as l,De as m,G as n,q as o,z as p,Q as r,Y as s,U as t,B as u};
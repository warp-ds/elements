import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,c as n,d as r,h as i,l as a,r as o,s,t as c,y as l}from"./decorate-Bt2QF_uA.js";import{a as u,o as d,r as ee,t as f}from"./i18n-CkjYRTT1.js";import{n as p,t as te}from"./dist-D5kJVy4t.js";import{t as ne}from"./icon-CD69d68Q.js";import{n as re,t as ie}from"./styles-Cw_r5k83.js";import{i as ae,n as oe,r as se}from"./utilities-BHNt5DhH.js";import{n as m,t as h}from"./FormControlMixin-BCJbRrUC.js";import{r as g,t as ce}from"./if-defined-DBI32Ir5.js";import{n as le,t as ue}from"./utils-qj3txzlQ.js";import{t as _}from"./tooltip-D5IbvAIJ.js";var v;function y(){return(y=e((()=>{n(),v=l`
	:host {
...
`})))()}var de;function fe(){return(fe=e((()=>{n(),de=l`
	:host {
		display: inline-flex;
		align-items: center;
		gap: var(--_gap);
...
`})))()}var b;function x(){return(x=e((()=>{m(),n(),o(),ie(),le(),y(),fe(),b=class extends h(a){static{this.styles=[v,re,de]}#e;static{this.shadowRootOptions={...a.shadowRootOptions,delegatesFocus:!0}}get tabIndex(){return this._internalTabIndex}set tabIndex(e){this._groupTabIndex=e}#t;#n;#r;constructor(){super(),this.#e=new ue(this),this.value=null,this.checked=!1,this.disabled=!1,this.required=!1,this.invalid=!1,this.#t=!1,this.#n=!1,this.#r=!1,this.handleClick=()=>{this.isInGroup()||this.disabled||(this.#r=!0,!this.checked&&(this.checked=!0,this.updateComplete.then(()=>{this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))})))},this.handleInvalid=()=>{this.#r=!0,this.updateValidity()},this.handleKeyDown=e=>{if(!this.isInGroup()&&!this.disabled&&!e.defaultPrevented){if([`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`].includes(e.key)){let t=this.getStandaloneNamedRadios().filter(e=>!e.disabled);if(t.length<=1)return;e.preventDefault();let n=t.find(e=>e.checked)??t.find(e=>e===this)??t[0],r=e.key===`ArrowUp`||e.key===`ArrowLeft`?-1:1,i=t[(t.indexOf(n)+r+t.length)%t.length];i.#r=!0,i.checked||(i.checked=!0,i.updateComplete.then(()=>{i.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))})),i.focus();return}(e.key===` `||e.key===`Spacebar`||e.key===`Enter`)&&(this.#e.submit(e)||(e.preventDefault(),this.click()))}},this.addEventListener(`click`,this.handleClick),this.addEventListener(`invalid`,this.handleInvalid),this.addEventListener(`keydown`,this.handleKeyDown)}connectedCallback(){super.connectedCallback(),this.value=this.getAttribute(`value`)??`on`,this.#t=this.hasAttribute(`checked`),this.checked=this.#t,this.internals.role=`radio`,this.syncAriaDisabled(),this.syncFormValue(),this.updateValidity()}syncAriaDisabled(){this.internals.ariaDisabled=this.disabled?`true`:`false`}syncAriaChecked(){this.internals.ariaChecked=this.checked?`true`:`false`}willUpdate(e){this.shouldSyncFormState(e)&&(this.syncFormValue(),this.updateValidity())}updated(e){super.updated(e),e.has(`checked`)&&(this.syncAriaChecked(),this.checked&&!this.isInGroup()&&(this.uncheckOtherRadios(),this.syncStandaloneTabOrder())),e.has(`disabled`)&&(this.syncAriaDisabled(),this.isInGroup()||this.syncStandaloneTabOrder()),e.has(`invalid`)&&(this.internals.ariaInvalid=this.invalid?`true`:null),e.has(`name`)&&this.checked&&!this.isInGroup()&&this.uncheckOtherRadios()}resetFormControl(){this.checked=this.#t,this.syncFormValue(),this.updateValidity()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.updateValidity(),this.internals.checkValidity()}reportValidity(){return this.#r=!0,this.updateValidity(),this.internals.checkValidity()}isInGroup(){return!!this.closest(`w-radio-group`)}getRadioScope(){return this.internals.form??this.closest(`form`)??document}getStandaloneNamedRadios(){return this.name?[...this.getRadioScope().querySelectorAll(`w-radio[name="${this.name}"]`)].filter(e=>!e.closest(`w-radio-group`)):[this]}syncStandaloneTabOrder(){let e=this.getStandaloneNamedRadios(),t=e.filter(e=>!e.disabled),n=t.find(e=>e.checked)??t[0]??null;e.forEach(e=>{e._standaloneTabIndex=e===n?0:-1})}get _internalTabIndex(){return this.disabled?-1:this._groupTabIndex===void 0?this._standaloneTabIndex===void 0?0:this._standaloneTabIndex:this._groupTabIndex}firstUpdated(){this.isInGroup()||this.syncStandaloneTabOrder()}uncheckOtherRadios(){this.name&&[...this.getRadioScope().querySelectorAll(`w-radio[name="${this.name}"]`)].forEach(e=>{e!==this&&(e.closest(`w-radio-group`)||(e.checked&&=!1))})}updateValidity(){if(this.disabled||this.isInGroup()){this.internals.setValidity({});return}let e=this.required&&!this.checked,t=this.invalid&&!this.#n;if(e){this.#n=!0,this.invalid=this.#r,this.internals.setValidity({valueMissing:!0},this.internals.validationMessage||` `);return}if(this.#n&&=(this.invalid=!1,!1),t){this.internals.setValidity({customError:!0},this.internals.validationMessage||` `);return}this.internals.setValidity({})}syncFormValue(){if(this.disabled){this.setValue(null);return}this.setValue(this.checked?this.value:null)}shouldSyncFormState(e){return e.has(`checked`)||e.has(`value`)||e.has(`disabled`)||e.has(`required`)||e.has(`invalid`)}render(){return i`
			<div part="base" tabindex="${this._internalTabIndex}">
				<div part="control"></div>
				<slot part="label"></slot>
			</div>
		`}},c([s({reflect:!0})],b.prototype,`name`,void 0),c([s({reflect:!0})],b.prototype,`value`,void 0),c([s({type:Boolean,reflect:!0})],b.prototype,`checked`,void 0),c([s({type:Boolean,reflect:!0})],b.prototype,`disabled`,void 0),c([s({type:Boolean,reflect:!0})],b.prototype,`required`,void 0),c([s({type:Boolean,reflect:!0})],b.prototype,`invalid`,void 0),c([s({attribute:!1})],b.prototype,`_groupTabIndex`,void 0),c([s({attribute:!1})],b.prototype,`_standaloneTabIndex`,void 0),customElements.get(`w-radio`)||customElements.define(`w-radio`,b)})))()}var pe;function me(){return(me=e((()=>{pe=JSON.parse(`{"radio-group.label.optional":["Valgfri"],"radio-group.validation.required":["Vælg en mulighed."]}`)})))()}var he;function ge(){return(ge=e((()=>{he=JSON.parse(`{"radio-group.label.optional":["Optional"],"radio-group.validation.required":["Please select an option."]}`)})))()}var _e;function ve(){return(ve=e((()=>{_e=JSON.parse(`{"radio-group.label.optional":["Valinnainen"],"radio-group.validation.required":["Valitse vaihtoehto."]}`)})))()}var ye;function be(){return(be=e((()=>{ye=JSON.parse(`{"radio-group.label.optional":["Valgfri"],"radio-group.validation.required":["Velg et alternativ."]}`)})))()}var S;function C(){return(C=e((()=>{S=JSON.parse(`{"radio-group.label.optional":["Valfritt"],"radio-group.validation.required":["Välj ett alternativ."]}`)})))()}var w;function T(){return(T=e((()=>{n(),w=l`
	:host {
		display: block;
...
}`,...$.parameters?.docs?.source}}},xe=[`Default`,`SingleRadioDefault`,`SingleRadioInvalid`,`SingleRadioDisabled`,`SingleRadioFormAssociated`,`StandaloneRadioGroupByName`,`Disabled`,`Required`,`DisabledGroup`,`DisabledRadio`,`HelpText`,`WithTooltip`,`Optional`,`RadioGroup`,`RadioGroupWithHelpText`,`RadioGroupWithLabel`,`RadioGroupWithHelpTextAndLabel`,`RadioGroupWithOptional`,`RadioGroupWithInvalid`,`RadioGroupRequired`,`RadioGroupFormAssociated`,`InvalidWithMessage`,`SlottedLabelAndHint`]})))()}Se();export{j as Default,L as Disabled,z as DisabledGroup,B as DisabledRadio,V as HelpText,Q as InvalidWithMessage,U as Optional,W as RadioGroup,Z as RadioGroupFormAssociated,X as RadioGroupRequired,G as RadioGroupWithHelpText,q as RadioGroupWithHelpTextAndLabel,Y as RadioGroupWithInvalid,K as RadioGroupWithLabel,J as RadioGroupWithOptional,R as Required,M as SingleRadioDefault,P as SingleRadioDisabled,F as SingleRadioFormAssociated,N as SingleRadioInvalid,$ as SlottedLabelAndHint,I as StandaloneRadioGroupByName,H as WithTooltip,xe as __namedExportsOrder,A as default};
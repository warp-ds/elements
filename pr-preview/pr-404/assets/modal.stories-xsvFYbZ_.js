import{x as i,r as E,a as S,i as k,f as w,s as j,u as A,p as z,E as M,n as d,l as q,g as B}from"./iframe-IwJaDIjU.js";import{s as C,p as T}from"./utilities-Dn1aucQD.js";import{e as v}from"./query-NYTjQBeo.js";const L=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},$=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const r of o.filter(a=>a.patchClose))r._close=()=>this.close()}};let N=class extends L($(k)){render(){return i`
      <div class="footer">

import{a as q,i as z,r as O,E as $,x as o,n as l,l as d,g as A}from"./iframe-K3V2YRZc.js";import"./index-9TaNMkZ3.js";import"./index-BBbX0Ouj.js";import"./index-DnQiCVqM.js";import{F as j}from"./FormControlMixin-DJnJZbro.js";import{_ as M}from"./preload-helper-Ct5FWWRu.js";import{e as L}from"./query-NYTjQBeo.js";import{o as F}from"./if-defined-Qdshx2AO.js";const B=q`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`,W=q`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var X=Object.defineProperty,s=(a,e,t,n)=>{for(var r=void 0,h=a.length-1,c;h>=0;h--)(c=a[h])&&(r=c(e,t,r)||r);return r&&X(e,t,r),r};class i extends j(z){constructor(){super(...arguments),this._invalid=!1,this._showTooltip=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...z.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[O,W,U]}#e(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#r(){this._showTooltip=!1}#t(e){const t=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const n=e.currentTarget.value;if(n==="")return this.required&&(this._invalid=!0),!1;t&&this._invalid&&(this._invalid=!1);const r=Number.parseInt(n),h=Number.parseInt(this.max),c=Number.parseInt(this.min);(r>h||r<c)&&(this._invalid=!0);let E=!1;if(this.slot){const P=getComputedStyle(this);if(this.slot==="from"){const p=P.getPropertyValue("--to");if(r>Number.parseInt(p)){if(t)return this._invalid=!0,!1;E=!0,this.value=p}}else{const p=P.getPropertyValue("--from");if(r<Number.parseInt(p)){if(t)return this._invalid=!0,!1;E=!0,this.value=p}}}return E?(e.preventDefault(),this.range.value=this.value,!1):(this.value=n,this.shadowRoot.querySelector("w-attention").handleDone(),!0)}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:t}]=await Promise.all([M(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
      ...
      <div class="w-slider-thumb">
        ...
        ${"anchorName"in document.documentElement.style?$:o`<div class="polyfill-range"><div class="polyfill-active-range"></div></div>`}
        <input
          id="range"
    ...
    `])),e,a)}},v={args:{locale:"nb",suffix:"km"},render({locale:a,suffix:e}){return o(N||(N=T([`
      ...
      <\/script>
    `])),e,a)}},y={args:{locale:"nb",step:"5",markers:"5"},render({markers:a,step:e}){return o`
      <w-slider label="Single" min="0" max="100" step="${e}" markers="${a}">
        <w-slider-thumb name="value"></w-slider-thumb>
      </w-slider>
    `}},x={args:{step:5},render({step:a}){return o`
      <w-slider label="Single" step="${a}" min="0" max="100">
        <w-slider-thumb name="value"></w-slider-thumb>
      </w-slider>
    `}},_={args:{},render(){return o(R||(R=T([`

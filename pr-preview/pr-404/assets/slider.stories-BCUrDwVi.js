import{a as q,i as T,r as j,E as z,x as o,n as l,l as d,g as V}from"./iframe-C6NdUDGm.js";import"./index-6dg-TOwD.js";import"./index-mnJgGgeo.js";import"./index-DJHtvjGB.js";import{F as L}from"./FormControlMixin-DJnJZbro.js";import{_ as B}from"./preload-helper-Ct5FWWRu.js";import{e as A}from"./query-NYTjQBeo.js";import{o as F}from"./if-defined-C3I72cIs.js";const M=q`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`;var W=Object.defineProperty,u=(a,e,t,n)=>{for(var r=void 0,h=a.length-1,c;h>=0;h--)(c=a[h])&&(r=c(e,t,r)||r);return r&&W(e,t,r),r};class m extends L(T){constructor(){super(...arguments),this.disabled=!1,this.invalid=!1,this.required=!1}static{this.shadowRootOptions={...T.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[j,M]}#r;#e(){const e=this.querySelectorAll("w-slider-thumb");let t=!1;for(const r of e.values())r.min=this.min,r.max=this.max,r.step=this.step,r.suffix=this.suffix,r.required=this.required,r.formatter=this.formatter,r.ariaLabel||(r.slot||(r.ariaLabel=this.label),r.slot==="from"&&(r.ariaLabel=`${this.label} min`),r.slot==="to"&&(r.ariaLabel=`${this.label} max`)),(r.slot==="from"||r.slot==="to")&&(t=!0),r.forceDisabled=this.disabled,r.forceInvalid=this.invalid,this.#a(r);const n=this.shadowRoot.querySelector("fieldset");t?(n.style.setProperty("--active-range-inline-start-padding","var(--w-slider-thumb-size)"),n.style.setProperty("--active-range-inline-end-padding","var(--w-slider-thumb-size)")):n.style.setProperty("--active-range-border-radius","4px")}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.style.setProperty("--min",this.min),this.style.setProperty("--max",this.max),this.markers&&this.style.setProperty("--markers",String(this.markers));const e=getComputedStyle(this.shadowRoot.querySelector(".w-slider"));this.#r=Number.parseFloat(e.getPropertyValue("--w-slider-thumb-size").replace("px","")),this.#e()}updated(e){(e.has("disabled")||e.has("invalid")||e.has("required")||e.has("min")||e.has("step")||e.has("max")||e.has("suffix")||e.has("formatter"))&&this.#e()}#t(e){const t=e.target;this.#a(t)}#i(e){e.stopPropagation(),this.invalid=e.detail.invalid}#a(e){const t=e.slot;if(t||this.style.setProperty("--from","0"),t==="from"){const n=e.value??=this.min;this.style.setProperty("--from",n)}if(!t||t==="to"){const n=e.value??=this.max;this.style.setProperty("--to",n)}}render(){return o`
      <fieldset id="fieldset" class="w-slider" @input="${this.#t}" @slidervalidity="${this.#i}">
        ...
        ${this.markers?o`<div class="w-slider__markers"></div>`:z}
...
`,U=q`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var H=Object.defineProperty,s=(a,e,t,n)=>{for(var r=void 0,h=a.length-1,c;h>=0;h--)(c=a[h])&&(r=c(e,t,r)||r);return r&&H(e,t,r),r};class i extends L(T){constructor(){super(...arguments),this._invalid=!1,this._showTooltip=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...T.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[j,U,X]}#r(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#e(){this._showTooltip=!1}#t(e){const t=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const n=e.currentTarget.value;if(n==="")return this.required&&(this._invalid=!0),!1;t&&this._invalid&&(this._invalid=!1);const r=Number.parseInt(n),h=Number.parseInt(this.max),c=Number.parseInt(this.min);(r>h||r<c)&&(this._invalid=!0);let E=!1;if(this.slot){const P=getComputedStyle(this);if(this.slot==="from"){const p=P.getPropertyValue("--to");if(r>Number.parseInt(p)){if(t)return this._invalid=!0,!1;E=!0,this.value=p}}else{const p=P.getPropertyValue("--from");if(r<Number.parseInt(p)){if(t)return this._invalid=!0,!1;E=!0,this.value=p}}}return E?(e.preventDefault(),this.range.value=this.value,!1):(this.value=n,this.shadowRoot.querySelector("w-attention").handleDone(),!0)}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:t}]=await Promise.all([B(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
      ...
      <div class="w-slider-thumb">
        ...
        ${"anchorName"in document.documentElement.style?z:o`<div id="anchor"></div>`}
        <input
          id="range"
        ...
        <w-textfield
          ...
          @input="${this.#t}">
          ${this.suffix?o`<w-affix slot="suffix" label="${this.suffix}"></w-affix>`:z}
        </w-textfield>
        ...
        <w-attention tooltip placement="top" flip distance="24" .show="${this._showTooltip}">
          ...
          <span slot="message">
            ${this.value?this.formatter?this.formatter(this.value):this.value:0}${this.suffix?o`&nbsp;${this.suffix}`:z}
          </span>
        </w-attention>
    ...
    `}},w={args:{locale:"nb",suffix:"m²"},render({locale:a,suffix:e}){return o(D||(D=$([`
    ...
    `])),e,a)}},g={args:{locale:"nb",suffix:"kr"},render({locale:a,suffix:e}){return o(I||(I=$([`
      ...
      <\/script>
    `])),e,a)}},v={args:{locale:"nb",suffix:"km"},render({locale:a,suffix:e}){return o(N||(N=$([`
      ...
      <\/script>
    `])),e,a)}},_={args:{locale:"nb",suffix:"km",step:"25000",markers:"25000"},render({locale:a,suffix:e,markers:t,step:n}){return o(R||(R=$([`

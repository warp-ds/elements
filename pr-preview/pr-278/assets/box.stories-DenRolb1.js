import{g as t,x as l}from"./iframe-C3nY7-ZB.js";import{s as c,p as d}from"./utilities-Ot7KTtHO.js";const{events:u,args:p,argTypes:i}=t("w-box"),g={title:"Layout/Box",render:n=>l`
      <w-box ${c(d(n))}>
        <h3>Box Content</h3>

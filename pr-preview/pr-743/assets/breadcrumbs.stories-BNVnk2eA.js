import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{C as n,_ as r,d as i,l as a,n as o,p as s,r as c,t as l,u,x as d}from"./decorate-WA8yucmX.js";import{D as f,E as p,_ as m,b as h,l as g,u as _,x as v,y}from"./iframe-BN7AeXSN.js";import{a as b,n as x,r as S,t as C}from"./utilities-CLq91F3N.js";function w(e,t){return e.flatMap(e=>[e,t]).slice(0,-1)}var ee=e((()=>{})),T,E=e((()=>{T=JSON.parse(`{"breadcrumbs.ariaLabel":["Du er her"]}`)})),D,O=e((()=>{D=JSON.parse(`{"breadcrumbs.ariaLabel":["You are here"]}`)})),k,A=e((()=>{k=JSON.parse(`{"breadcrumbs.ariaLabel":["Olet tässä"]}`)})),j,M=e((()=>{j=JSON.parse(`{"breadcrumbs.ariaLabel":["Her er du"]}`)})),N,P=e((()=>{N=JSON.parse(`{"breadcrumbs.ariaLabel":["Du är här"]}`)})),F,I=e((()=>{u(),F=n(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.flex{display:flex}.static{position:static}.s-text{color:var(--w-s-color-text)}.s-text-link{color:var(--w-s-color-text-link)}.s-icon{color:var(--w-s-color-icon)}.space-x-8>:not([hidden])~:not([hidden]){--w-space-x-reverse:0;margin-left:calc(.8rem * calc(1 - var(--w-space-x-reverse)));margin-right:calc(.8rem * var(--w-space-x-reverse))}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}.select-none{-webkit-user-select:none;user-select:none}`)})),L,R,z,B=e((()=>{f(),ee(),u(),y(),g(),E(),O(),A(),M(),P(),I(),L={wrapper:`flex space-x-8`,text:`s-text`,link:`s-text-link`,separator:`select-none s-icon`,a11y:`sr-only`},R=r`<span class=${L.separator}>/</span>`,z=class extends i{static{this.styles=[_,F]}constructor(){super(),this._children=[],this._internals=this.attachInternals(),m(D,j,k,T,N),this._defaultLabel=p._({id:`breadcrumbs.ariaLabel`,message:`You are here`,comment:`Default screen reader message for the breadcrumb component`}),this._internals.ariaLabel=this._defaultLabel}get _label(){return this.ariaLabel??this._defaultLabel}connectedCallback(){super.connectedCallback(),this._internals.role=`navigation`;let e=this.querySelectorAll(`:scope > a`),t=this.querySelectorAll(`:scope > span`),n=this.querySelectorAll(`w-breadcrumb-item`);n.length>0&&(e.length>0||t.length>0)&&console.warn(`Mixing Legacy API and w-breadcrumb-item API children is not supported.`);let i=0,a=!1;n.forEach((e,t)=>{e.hasAttribute(`current-page`)&&(t<n.length-1&&(a=!0),i++)}),i>1&&console.warn(`Please ensure only one w-breadcrumb-item has the current-page attribute.`),a&&console.warn(`The current-page attribute should only be used on the final breadcrumb item.`);let o=[...this.children].filter(e=>e&&e.tagName!==`W-BREADCRUMB-ITEM`).flat(1/0).filter(e=>e).map((e,t)=>{if(typeof e==`string`){let n=t===this.children.length-1;return r`<span
					class=${L.text}
		...
		`}},customElements.get(`w-breadcrumbs`)||customElements.define(`w-breadcrumbs`,z)})),V,H=e((()=>{u(),V=d`
	:host {
...
`})),U,W=e((()=>{u(),c(),H(),g(),o(),U=class extends i{constructor(...e){super(...e),this.currentPage=!1,this.href=null}static{this.styles=[_,V]}get link(){return this.href?r`<a
					part="link"
					class="s-text-link"
					href=${this.href}
				...
				></span>`}get separator(){return this.currentPage?s:r`<span part="separator" class="separator" aria-hidden="true"
					>/</span
				>`}render(){return r`${this.link}${this.separator}`}},l([a({type:Boolean,attribute:`current-page`})],U.prototype,`currentPage`,void 0),l([a({type:String})],U.prototype,`href`,void 0),customElements.get(`w-breadcrumb-item`)||customElements.define(`w-breadcrumb-item`,U)})),G=t({Default:()=>Y,WithLinks:()=>X,WithSpanForCurrentPage:()=>Z,__namedExportsOrder:()=>Q,default:()=>J}),K,q,J,Y,X,Z,Q,$=e((()=>{S(),v(),u(),C(),B(),W(),{events:K,argTypes:q}=h(`w-breadcrumbs`),J={title:`Navigation/Breadcrumbs`,render(e){return r`
            <w-breadcrumbs ${b(x(e))}>

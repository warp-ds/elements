import{u as i,j as e}from"./index-CeBkxLRa.js";import"./_commonjsHelpers-CqkleIqs.js";function t(s){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",p:"p",pre:"pre",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"warp-dselements",children:"@warp-ds/elements"}),`
...
`,e.jsx(n.p,{children:"You should see code completions and inline docs for Warp elements when writing HTML."})]})}function r(s={}){const{wrapper:n}={...i(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{r as default};

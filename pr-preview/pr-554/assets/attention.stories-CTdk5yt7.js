import{g as w,b as e}from"./iframe-DpD_wcZp.js";import{s as c,p as v}from"./utilities-D5RTl56V.js";import"./attention-Wf8oX5Vm.js";import"./button-COcJuLiB.js";var p=Object.freeze,y=Object.defineProperty,l=(t,g)=>p(y(t,"raw",{value:p(t.slice())})),d,u,m,b;const{events:E,args:I,argTypes:f}=w("w-attention"),T={title:"Overlays/Attention",render(t){return e`
      <w-attention ${c(v(t))}>
        <w-button
          ${c({id:t.buttonId})}
          variant="secondary"

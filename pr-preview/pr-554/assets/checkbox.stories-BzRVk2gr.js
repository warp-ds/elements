import{k as R,x as D,y as b,z as G,E as B,A as $,B as H,a as O,i as F,r as N,b as i,n,u as W,p as V,q as U,g as j}from"./iframe-BrpOaP_t.js";import{s as J,p as P}from"./utilities-BY_1gr0x.js";import{e as Y}from"./query-NYTjQBeo.js";import{o as p}from"./if-defined-C0r0TmQz.js";import{F as M}from"./FormControlMixin-DJnJZbro.js";/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const z=R(class extends D{constructor(a){if(super(a),a.type!==b.PROPERTY&&a.type!==b.ATTRIBUTE&&a.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!G(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===B||e===$)return e;const t=a.element,s=a.name;if(a.type===b.PROPERTY){if(e===t[s])return B}else if(a.type===b.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return B}else if(a.type===b.ATTRIBUTE&&t.getAttribute(s)===e+"")return B;return H(a),e}}),K=O`
  :host {

import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{C as t,_ as n,d as r,l as i,n as a,r as o,t as s,u as c,x as l}from"./decorate-WA8yucmX.js";import{D as u,E as d,d as f,g as p,h as m,l as h,u as g,v as _,y as v}from"./iframe-ji6WRVuy.js";import{n as y,t as b}from"./form-control-BSFyWBnN.js";var x,S=e((()=>{c(),x=l`
...
`})),C,w=e((()=>{c(),C=t(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.flex{display:flex}.static{position:static}`)})),T,E=e((()=>{m(),b(),u(),c(),o(),v(),h(),S(),w(),f(),a(),T=class extends y(r){constructor(...e){super(...e),this.ariaLabel=null,this.clear=!1,this.search=!1,this.label=``,this.icon=null}static{this.styles=[g,C,x]}get _wrapperClasses(){return p([this.label?`has-label`:`has-icon`])}resetContainingTextField(e){let t=this.closest(`w-textfield`);t&&t.resetFormControl(),e.stopPropagation()}submitContainingForm(e){let t=this.internals.form;t&&t.submit(),e.stopPropagation()}get _searchButton(){return n`
			<button
				part="wrapper"

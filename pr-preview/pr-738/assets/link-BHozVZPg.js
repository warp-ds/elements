import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{_ as t,d as n,l as r,n as i,p as a,r as o,t as s,u as c,x as l}from"./decorate-WA8yucmX.js";import{l as u,u as d}from"./iframe-23ToF-HN.js";var f,p,m,h,g,_=e((()=>{c(),f=l`
	:host {
...
`})),v,y=e((()=>{c(),_(),v=l`
  ...
  :host([full-width]) {
	...
	${h}
`})),b,x,S=e((()=>{c(),o(),u(),y(),i(),b=[`primary`,`secondary`,`negative`,`negativeQuiet`,`utility`,`utilityQuiet`,`quiet`,`link`,`overlay`,`overlayInverted`,`overlayQuiet`,`overlayInvertedQuiet`],x=class extends n{constructor(...e){super(...e),this.autofocus=!1,this.small=!1,this.disabled=!1,this.fullWidth=!1}static{this.shadowRootOptions={...n.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[d,v]}connectedCallback(){if(super.connectedCallback(),this.variant&&!b.includes(this.variant))throw Error(`Invalid "variant" attribute. Set its value to one of the following:\n${b.join(`, `)}.`)}firstUpdated(){this.autofocus&&setTimeout(()=>this.focus(),0)}render(){return t`
			<a
				href="${this.href}"
				part="base"
				target="${this.target}"
				rel="${this.target===`_blank`?this.rel||`noopener`:a}"
				tabindex="0"
			>
				<slot></slot>
			</a>
		`}},s([r({type:Boolean,reflect:!0})],x.prototype,`autofocus`,void 0),s([r({reflect:!0})],x.prototype,`variant`,void 0),s([r({type:Boolean,reflect:!0})],x.prototype,`small`,void 0),s([r({reflect:!0})],x.prototype,`href`,void 0),s([r({type:Boolean,reflect:!0})],x.prototype,`disabled`,void 0),s([r({reflect:!0})],x.prototype,`target`,void 0),s([r({reflect:!0})],x.prototype,`rel`,void 0),s([r({attribute:`full-width`,type:Boolean,reflect:!0})],x.prototype,`fullWidth`,void 0),customElements.get(`w-link`)||customElements.define(`w-link`,x)}));export{_ as n,g as r,S as t};
import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{_ as n,d as r,l as i,n as a,p as o,r as s,t as c,u as l,x as u}from"./decorate-WA8yucmX.js";import{D as d,E as f,_ as p,b as m,l as h,u as g,x as _,y as v}from"./iframe-ji6WRVuy.js";import{a as y,n as b,r as x,t as S}from"./utilities-CLq91F3N.js";import{r as C,t as w}from"./if-defined-B6WcfsYE.js";var T,E=e((()=>{T=JSON.parse(`{"card.button.text":["Vælg"]}`)})),D,O=e((()=>{D=JSON.parse(`{"card.button.text":["Select"]}`)})),k,A=e((()=>{k=JSON.parse(`{"card.button.text":["Valitse"]}`)})),j,M=e((()=>{j=JSON.parse(`{"card.button.text":["Velg"]}`)})),N,P=e((()=>{N=JSON.parse(`{"card.button.text":["Välj"]}`)})),F,I=e((()=>{l(),F=u`
	:host {
...
`})),L,R,z=e((()=>{d(),l(),s(),w(),v(),h(),E(),O(),A(),M(),P(),I(),a(),L={ENTER:`Enter`,SPACE:` `},R=class extends r{static{this.styles=[g,F,u`
			a::after {
				content: "";
				position: absolute;
				top: 0;
		...
		`]}constructor(){super(),this.selected=!1,this.flat=!1,this.clickable=!1,p(D,j,k,T,N),this.buttonText=f._({id:`card.button.text`,message:`Select`,comment:`Screenreader message to indicate that the card is clickable`})}keypressed(e){!this.clickable||e.altKey||e.ctrlKey||(e.key===L.ENTER||e.key===L.SPACE)&&(e.preventDefault(),this.click())}render(){return n`
			<div
				part="base"
		...
		`}},c([i({type:Boolean,reflect:!0})],R.prototype,`selected`,void 0),c([i({type:Boolean})],R.prototype,`flat`,void 0),c([i({type:Boolean})],R.prototype,`clickable`,void 0),customElements.get(`w-card`)||customElements.define(`w-card`,R)})),B=t({Clickable:()=>Y,Default:()=>G,Flat:()=>q,FlatSelected:()=>J,PropertyExample:()=>X,Selected:()=>K,StylingApi:()=>Z,__namedExportsOrder:()=>Q,default:()=>W}),V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{x(),_(),l(),S(),z(),{events:V,args:H,argTypes:U}=m(`w-card`),W={title:`Navigation/Card`,render(e){return n`
            <w-card ${y(b(e))}>
        ...
        `},args:H,argTypes:U,parameters:{actions:{handles:V}}},G={args:{selected:!1,flat:!1,clickable:!1}},K={args:{selected:!0,flat:!1,clickable:!1}},q={args:{selected:!1,flat:!0,clickable:!1}},J={args:{selected:!0,flat:!0,clickable:!1}},Y={args:{selected:!1,flat:!1,clickable:!0}},X={args:{selected:!1,flat:!1,clickable:!0},render(e){return n`
            <w-card ${y(b(e))}>
                <img
        ...
        `}},Z={args:{clickable:!1,selected:!1,flat:!1},render(e){return n`
            <pre>
<code>
&lt;style&gt;
w-card::part(base) {

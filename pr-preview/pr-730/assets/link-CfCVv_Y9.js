import{i as e}from"./preload-helper-xPQekRTU.js";import{Bt as t,E as n,Ht as r,Lt as i,Rt as a,Wt as o,b as s,f as c,l,p as u,u as d}from"./iframe-BiL_WLpS.js";import{r as f,t as p}from"./if-defined-dfONuEzX.js";var m,h,g,_,v,y=e((()=>{i(),m=o`
	:host {
...
`})),b,x=e((()=>{i(),y(),b=o`
  ...
  :host([full-width]) {
	...
	${_}
`})),S,C,w=e((()=>{i(),s(),l(),x(),p(),u(),S=[`primary`,`secondary`,`negative`,`negativeQuiet`,`utility`,`utilityQuiet`,`quiet`,`link`,`overlay`,`overlayInverted`,`overlayQuiet`,`overlayInvertedQuiet`],C=class extends a{constructor(...e){super(...e),this.autofocus=!1,this.small=!1,this.disabled=!1,this.fullWidth=!1}static{this.shadowRootOptions={...a.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[d,b]}connectedCallback(){if(super.connectedCallback(),this.variant&&!S.includes(this.variant))throw Error(`Invalid "variant" attribute. Set its value to one of the following:\n${S.join(`, `)}.`)}firstUpdated(){this.autofocus&&setTimeout(()=>this.focus(),0)}render(){return r`
			<a
				href="${this.href}"
				part="base"
				target="${this.target}"
		...
		`}},c([n({type:Boolean,reflect:!0})],C.prototype,`autofocus`,void 0),c([n({reflect:!0})],C.prototype,`variant`,void 0),c([n({type:Boolean,reflect:!0})],C.prototype,`small`,void 0),c([n({reflect:!0})],C.prototype,`href`,void 0),c([n({type:Boolean,reflect:!0})],C.prototype,`disabled`,void 0),c([n({reflect:!0})],C.prototype,`target`,void 0),c([n({reflect:!0})],C.prototype,`rel`,void 0),c([n({attribute:`full-width`,type:Boolean,reflect:!0})],C.prototype,`fullWidth`,void 0),customElements.get(`w-link`)||customElements.define(`w-link`,C)}));export{y as n,v as r,w as t};
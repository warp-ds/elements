import{a as N,i as D,r as U,E as d,x as i,n as o,b as O,k as p,g as K}from"./iframe-CQIrJB8e.js";import"./index-DRHHUeWm.js";import"./index-N3Mg-Sfn.js";import"./index-BmVGVuQ8.js";import{F as W}from"./FormControlMixin-DJnJZbro.js";import{_ as G}from"./preload-helper-Ct5FWWRu.js";import{e as X}from"./query-NYTjQBeo.js";import{o as F}from"./if-defined-BJu1Kt3U.js";const J=N`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`;var Q=Object.defineProperty,h=(s,e,r,a)=>{for(var t=void 0,m=s.length-1,c;m>=0;m--)(c=s[m])&&(t=c(e,r,t)||t);return t&&Q(e,r,t),t};class u extends W(D){constructor(){super(...arguments),this.disabled=!1,this.allowValuesOutsideRange=!1,this.error="",this.invalid="",this.required=!1,this.suffix=""}static{this.shadowRootOptions={...D.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[U,J]}#e(){const e=this.querySelectorAll("w-slider-thumb");let r=!1;for(const t of e.values())t.min=this.edgeMin,t.max=this.edgeMax,t.step=this.step,t.suffix=this.suffix,t.required=this.required,t.formatter=this.formatter,t.allowValuesOutsideRange=this.allowValuesOutsideRange,t.ariaLabel||(t.slot||(t.ariaLabel=this.label),t.slot==="from"&&(t.ariaLabel=`${this.label} min`),t.slot==="to"&&(t.ariaLabel=`${this.label} max`)),(t.slot==="from"||t.slot==="to")&&(r=!0),t.disabled=this.disabled,t.invalid=!!this.errorText,this.#i(t);const a=this.shadowRoot.querySelector("fieldset");r?(a.style.setProperty("--active-range-inline-start-padding","var(--w-slider-thumb-size)"),a.style.setProperty("--active-range-inline-end-padding","var(--w-slider-thumb-size)")):a.style.setProperty("--active-range-border-radius","4px")}get edgeMin(){return this.allowValuesOutsideRange?(Number(this.min)-1).toString():this.min}get edgeMax(){return this.allowValuesOutsideRange?(Number(this.max)+1).toString():this.max}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.step&&this.style.setProperty("--step",String(this.step)),this.style.setProperty("--min",this.edgeMin),this.style.setProperty("--max",this.max),this.markers&&this.style.setProperty("--markers",String(this.markers)),this.#e()}updated(e){(e.has("disabled")||e.has("invalid")||e.has("required")||e.has("min")||e.has("step")||e.has("max")||e.has("suffix")||e.has("formatter"))&&this.#e()}#r(e){const r=e.target;this.#i(r),r.slot&&this.#s()}#s(){let e,r;const a=this.querySelectorAll("w-slider-thumb");for(const t of a.values())t.slot==="from"&&(e=t),t.slot==="to"&&(r=t);!e||!r||!e.invalid&&r.invalid}#t(e){e.stopPropagation(),this.invalid=e.detail.invalid}#a(e,r){return(r.value===void 0||r.value===null)&&(r.value=this.allowValuesOutsideRange?"":e),r.value===""?e:r.value}#i(e){const r=e.slot;r||this.style.setProperty("--from","0"),r==="from"&&this.style.setProperty("--from",this.#a(this.edgeMin,e)),(!r||r==="to")&&this.style.setProperty("--to",this.#a(this.edgeMax,e))}get errorText(){return this.error||this.invalid}render(){return i`
      ...
      >
        ...
        ${this.markers?i`<div class="w-slider__markers"></div>`:d}
    ...
    `}}h([o({reflect:!0})],u.prototype,"label");h([o({type:Boolean,reflect:!0})],u.prototype,"disabled");h([o({type:Boolean,attribute:"allow-values-outside-range"})],u.prototype,"allowValuesOutsideRange");h([o({type:String,reflect:!0})],u.prototype,"error");h([o({type:String,reflect:!0})],u.prototype,"invalid");h([o({type:Boolean,reflect:!0})],u.prototype,"required");h([o({reflect:!0})],u.prototype,"min");h([o({reflect:!0})],u.prototype,"max");h([o({type:Number,reflect:!0})],u.prototype,"markers");h([o({type:Number,reflect:!0})],u.prototype,"step");h([o({reflect:!0})],u.prototype,"suffix");h([o({attribute:!1})],u.prototype,"formatter");customElements.get("w-slider")||customElements.define("w-slider",u);const Y=N`
  .w-slider-thumb {
    position: relative;
    display: grid;
...
`,Z=N`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var ee=Object.defineProperty,l=(s,e,r,a)=>{for(var t=void 0,m=s.length-1,c;m>=0;m--)(c=s[m])&&(t=c(e,r,t)||t);return t&&ee(e,r,t),t};class n extends W(D){constructor(){super(...arguments),this.invalid=!1,this.allowValuesOutsideRange=!1,this.suffix="",this._showTooltip=!1,this._inputHasFocus=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...D.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[U,Z,Y]}#e(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#r(){this._showTooltip=!1}#s(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#t(e){this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:e,slot:this.slot}}))}async#a(e,r){let a=Number.parseInt(e);if(this.allowValuesOutsideRange&&!r&&this.step&&!(this.slot==="to"&&a>=Number(this.max)-1||this.slot==="from"&&a<=Number(this.min)+1)){const g=1/this.step;a=Math.round(a*g)/g,e=a.toString()}const t=Number.parseInt(this.max),m=Number.parseInt(this.min);if(!this.allowValuesOutsideRange&&(a>t||a<m))return this.#t(O.t({id:"slider.error.out_of_bounds",message:"Value must be between {min} and {max}",values:{min:`${this.min} ${this.suffix}`.trim(),max:`${this.max} ${this.suffix}`.trim()}})),{shouldCancel:!0};if(e==="")return this.required&&this.#t(O.t({id:"slider.error.required",message:"This field is required"})),{shouldCancel:!0};this.value=e;const c=e===this.max||e===this.min;let R=!1;if(this.slot){const V=getComputedStyle(this),g=V.getPropertyValue("--to"),q=V.getPropertyValue("--from"),P=O.t({id:"slider.error.overlap",message:"The maximum value cannot be less than the minimum"});if(this.slot==="from"){const b=Math.min(Number.parseInt(g),this.allowValuesOutsideRange?t-1:t);a>b&&(R=!0,this.allowValuesOutsideRange&&c?this.value=String(b):this.value=g,r&&(this.#t(P),await this.updateComplete,this.textfield.value=e))}else{const b=Math.max(Number.parseInt(q),this.allowValuesOutsideRange?m+1:m);a<b&&(R=!0,this.allowValuesOutsideRange&&c?this.value=String(b):this.value=q,r&&(this.#t(P),await this.updateComplete,this.textfield.value=e))}}return R?{shouldCancel:!0}:(this.#t(""),this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.allowValuesOutsideRange&&!r&&c?"":e,this.shadowRoot.querySelector("w-attention").handleDone(),{shouldCancel:!1})}async#i(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const a=e.currentTarget.value;return(await this.#a(a,r)).shouldCancel?(e.preventDefault(),!1):!0}async#o(e){if(e.key!=="ArrowLeft"&&e.key!=="ArrowRight")return;const r=Number(this.range.value),a=this.step||1;let t;e.key==="ArrowLeft"?t=r-a:t=r+a,t=Math.min(Math.max(t,Number(this.min)),Number(this.max)),(await this.#a(t.toString(),!1)).shouldCancel&&e.preventDefault()}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:r}]=await Promise.all([G(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
        /*
      ...
      `,await r({roots:[this.shadowRoot],elements:[this.anchorPositioningStyleElement]})}catch(r){console.error(new Error("Error registering the CSS anchor positioning polyfill. The UI will look broken.",{cause:r}))}}this.#s()}#n(e){e instanceof CustomEvent&&e.type==="focus"&&(this._inputHasFocus=!0)}#l(e){e instanceof CustomEvent&&e.type==="blur"&&(this._inputHasFocus=!1)}get boundaryValue(){return this.slot==="from"?this.min:this.max}get textFieldDisplayValue(){return this._inputHasFocus?this.value!==""?this.value:this.range?.value?Math.min(Math.max(Number(this.range.value),Number(this.min)+1),Number(this.max)-1).toString():"":this.value}get tooltipDisplayValue(){return this.formatter?this.formatter(this.value,this.slot):this.value===""?this.range?.value??this.boundaryValue:this.value||0}updated(e){e.has("value")&&(this.setValue(this.value),this.#s())}render(){return i`
      <div class="w-slider-thumb">
        <label for="range">${this.label}</label>
        ${"anchorName"in document.documentElement.style?d:i`<div class="polyfill-range">
        ...
        <input
          ...
          @blur="${this.#r}"
          @input="${this.#i}"
          @keydown="${this.allowValuesOutsideRange?this.#o:d}"
        />
        ...
        <w-textfield
          ...
          @blur="${this.#l}"
        >
          ${this.suffix?i`<w-affix slot="suffix" label="${this.suffix}"></w-affix>`:d}
        </w-textfield>
        ...
        >
          ...
          ></output>
          <span slot="message">
            ${this.tooltipDisplayValue}${this.suffix?i`&nbsp;${this.suffix}`:d}
          </span>
        </w-attention>
    ...
    `}}l([o({attribute:"aria-label",reflect:!0})],n.prototype,"ariaLabel");l([o({attribute:"aria-description",reflect:!0})],n.prototype,"ariaDescription");l([o({reflect:!0})],n.prototype,"label");l([o({reflect:!0})],n.prototype,"name");l([o({reflect:!0})],n.prototype,"value");l([o({type:Boolean,reflect:!0})],n.prototype,"disabled");l([o({type:Boolean,reflect:!0})],n.prototype,"invalid");l([o({attribute:!1,reflect:!1})],n.prototype,"allowValuesOutsideRange");l([p()],n.prototype,"markers");l([p()],n.prototype,"required");l([p()],n.prototype,"step");l([p()],n.prototype,"min");l([p()],n.prototype,"max");l([p()],n.prototype,"suffix");l([p()],n.prototype,"formatter");l([X('input[type="range"]')],n.prototype,"range");l([X("w-textfield")],n.prototype,"textfield");l([p()],n.prototype,"_showTooltip");l([p()],n.prototype,"_inputHasFocus");customElements.get("w-slider-thumb")||customElements.define("w-slider-thumb",n);var I=Object.freeze,te=Object.defineProperty,f=(s,e)=>I(te(s,"raw",{value:I(s.slice())})),M,B,L,j,A,H;const{events:re,args:ae,argTypes:ie}=K("w-slider"),se={title:"Forms/Slider and Range Slider",args:ae,argTypes:ie,parameters:{actions:{handles:re}}},w={render(){return i`
    ...
    `}},y={args:{locale:"nb",suffix:"m²"},render({locale:s,suffix:e}){return i(M||(M=f([`
      <w-slider
      ...
      <\/script>
    `])),e,s)}},x={args:{locale:"nb",suffix:"kr"},render({locale:s,suffix:e}){return i(B||(B=f([`
      <w-slider
        label="Price"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,s)}},_={args:{locale:"nb",suffix:"km"},render({locale:s,suffix:e}){return i(L||(L=f([`
      <w-slider
        label="Distance"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,s)}},k={args:{locale:"nb",step:"5",markers:"5"},render({markers:s,step:e}){return i`
      <w-slider
        label="Single"
        min="0"
        max="100"
    ...
    `}},S={args:{step:5},render({step:s}){return i`
    ...
    `])))}},C={args:{},render(){return i(H||(H=f([`
      ...
      <\/script>
    `])))}},z={args:{locale:"nb"},render(){return i`
      <w-slider
...
}`,...z.parameters?.docs?.source}}};const oe=["Single","Range","SuffixSquareMeters","SuffixCurrency","SuffixKilometers","Marks","Step","OverUnder","SingleError","RangeError","TestCase","CustomError"],fe=Object.freeze(Object.defineProperty({__proto__:null,CustomError:z,Marks:k,OverUnder:$,Range:v,RangeError:E,Single:w,SingleError:T,Step:S,SuffixCurrency:x,SuffixKilometers:_,SuffixSquareMeters:y,TestCase:C,__namedExportsOrder:oe,default:se},Symbol.toStringTag,{value:"Module"}));export{k as M,$ as O,v as R,fe as S,w as a,y as b,x as c,_ as d,S as e,T as f,E as g};

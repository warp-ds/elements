import{a as q,i as O,r as H,E as m,x as a,n as i,b as V,k as p,g as X}from"./iframe-CKihqXCb.js";import"./index-Be4bilz0.js";import"./index-CUD8Q327.js";import"./index-C5IJbFnD.js";import{F as U}from"./FormControlMixin-DJnJZbro.js";import{_ as K}from"./preload-helper-Ct5FWWRu.js";import{e as W}from"./query-NYTjQBeo.js";import{o as R}from"./if-defined-Beso7O37.js";const G=q`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`;var J=Object.defineProperty,h=(s,e,r,o)=>{for(var t=void 0,d=s.length-1,c;d>=0;d--)(c=s[d])&&(t=c(e,r,t)||t);return t&&J(e,r,t),t};class u extends U(O){constructor(){super(...arguments),this.disabled=!1,this.allowValuesOutsideRange=!1,this.helpText="",this.error="",this.invalid="",this.required=!1,this.suffix=""}static{this.shadowRootOptions={...O.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[H,G]}#e(){const e=this.querySelectorAll("w-slider-thumb");let r=!1;for(const t of e.values())t.min=this.edgeMin,t.max=this.edgeMax,t.step=this.step,t.suffix=this.suffix,t.required=this.required,t.formatter=this.formatter,t.allowValuesOutsideRange=this.allowValuesOutsideRange,t.ariaLabel||(t.slot||(t.ariaLabel=this.label),t.slot==="from"&&(t.ariaLabel=`${this.label} min`),t.slot==="to"&&(t.ariaLabel=`${this.label} max`)),(t.slot==="from"||t.slot==="to")&&(r=!0),t.disabled=this.disabled,t.invalid=this.errorText,this.#s(t);const o=this.shadowRoot.querySelector("fieldset");r?(o.style.setProperty("--active-range-inline-start-padding","var(--w-slider-thumb-size)"),o.style.setProperty("--active-range-inline-end-padding","var(--w-slider-thumb-size)")):o.style.setProperty("--active-range-border-radius","4px")}get edgeMin(){return this.allowValuesOutsideRange?(Number(this.min)-1).toString():this.min}get edgeMax(){return this.allowValuesOutsideRange?(Number(this.max)+1).toString():this.max}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.step&&this.style.setProperty("--step",String(this.step)),this.style.setProperty("--min",this.edgeMin),this.style.setProperty("--max",this.max),this.markers&&this.style.setProperty("--markers",String(this.markers)),this.#e()}updated(e){(e.has("disabled")||e.has("invalid")||e.has("required")||e.has("min")||e.has("step")||e.has("max")||e.has("suffix")||e.has("formatter"))&&this.#e()}#t(e){const r=e.target;this.#s(r),r.slot&&this.#r()}#r(){let e,r;const o=this.querySelectorAll("w-slider-thumb");for(const f of o.values())f.slot==="from"&&(e=f),f.slot==="to"&&(r=f);if(!e||!r||!e.invalid&&!r.invalid)return;const t=e.shadowRoot.querySelector("w-textfield"),d=r.shadowRoot.querySelector("w-textfield"),c=Number(t.value)<=Number(d.value),g=Number(d.value)>=Number(t.value);c&&g&&(e.invalid="",r.invalid="",e.value!==t.value&&(e.value=t.value),r.value!==d.value&&(r.value=d.value))}#a(e){if(e.stopPropagation(),e.detail.invalid)this.invalid=e.detail.invalid;else{let r="";const o=this.querySelectorAll("w-slider-thumb");for(const t of o.values())t.invalid&&(r="Feilmelding 11");this.invalid=r}}#i(e,r){return(r.value===void 0||r.value===null)&&(r.value=this.allowValuesOutsideRange?"":e),r.value===""?e:r.value}#s(e){const r=e.slot;r||this.style.setProperty("--from","0"),r==="from"&&this.style.setProperty("--from",this.#i(this.edgeMin,e)),(!r||r==="to")&&this.style.setProperty("--to",this.#i(this.edgeMax,e))}get errorText(){return this.error||this.invalid}render(){return a`
      <fieldset
        id="fieldset"
        class="w-slider"
        @input="${this.#t}"
    ...
    `}}h([i({reflect:!0})],u.prototype,"label");h([i({type:Boolean,reflect:!0})],u.prototype,"disabled");h([i({type:Boolean,attribute:"allow-values-outside-range"})],u.prototype,"allowValuesOutsideRange");h([i({reflect:!0})],u.prototype,"helpText");h([i({type:String,reflect:!0})],u.prototype,"error");h([i({type:String,reflect:!0})],u.prototype,"invalid");h([i({type:Boolean,reflect:!0})],u.prototype,"required");h([i({reflect:!0})],u.prototype,"min");h([i({reflect:!0})],u.prototype,"max");h([i({type:Number,reflect:!0})],u.prototype,"markers");h([i({type:Number,reflect:!0})],u.prototype,"step");h([i({reflect:!0})],u.prototype,"suffix");h([i({attribute:!1})],u.prototype,"formatter");customElements.get("w-slider")||customElements.define("w-slider",u);const Q=q`
  .w-slider-thumb {
    position: relative;
    display: grid;
...
`,Y=q`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var Z=Object.defineProperty,l=(s,e,r,o)=>{for(var t=void 0,d=s.length-1,c;d>=0;d--)(c=s[d])&&(t=c(e,r,t)||t);return t&&Z(e,r,t),t};class n extends U(O){constructor(){super(...arguments),this.invalid="",this.allowValuesOutsideRange=!1,this.suffix="",this._showTooltip=!1,this._inputHasFocus=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...O.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[H,Y,Q]}#e(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#t(){this._showTooltip=!1}#r(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}async#a(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const o=e.currentTarget.value,t=Number.parseInt(o),d=Number.parseInt(this.max),c=Number.parseInt(this.min);if(!this.allowValuesOutsideRange&&(t>d||t<c))return this.invalid=V.t({id:"slider.error.out_of_bounds",message:"Value must be between {min} and {max}",values:{min:`${this.min} ${this.suffix}`.trim(),max:`${this.max} ${this.suffix}`.trim()}}),!1;if(o==="")return this.required&&(this.invalid=V.t({id:"slider.error.required",message:"This field is required"})),!1;this.invalid&&(this.invalid=""),this.value=o;const g=o===this.max||o===this.min;let f=!1;if(this.slot){const D=getComputedStyle(this),C=D.getPropertyValue("--to"),I=D.getPropertyValue("--from"),N=V.t({id:"slider.error.overlap",message:"The maximum value cannot be less than the minimum"});if(this.slot==="from"){const b=Math.min(Number.parseInt(C),this.allowValuesOutsideRange?d-1:d);t>b&&(f=!0,this.allowValuesOutsideRange&&g?this.value=String(b):this.value=C,r&&(this.invalid=N,await this.updateComplete,this.textfield.value=o))}else{const b=Math.max(Number.parseInt(I),this.allowValuesOutsideRange?c+1:c);t<b&&(f=!0,this.allowValuesOutsideRange&&g?this.value=String(b):this.value=I,r&&(this.invalid=N,await this.updateComplete,this.textfield.value=o))}}return f?(e.preventDefault(),!1):(this.range.value=Math.min(Math.max(Number(o),Number(this.min)),Number(this.max)).toString(),this.value=this.allowValuesOutsideRange&&!r&&g?"":o,this.shadowRoot.querySelector("w-attention").handleDone(),!0)}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:r}]=await Promise.all([K(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
        /*
    ...
    `}}l([i({attribute:"aria-label",reflect:!0})],n.prototype,"ariaLabel");l([i({attribute:"aria-description",reflect:!0})],n.prototype,"ariaDescription");l([i({reflect:!0})],n.prototype,"label");l([i({reflect:!0})],n.prototype,"name");l([i({reflect:!0})],n.prototype,"value");l([i({type:Boolean,reflect:!0})],n.prototype,"disabled");l([i({type:String,reflect:!0})],n.prototype,"invalid");l([i({attribute:!1,reflect:!1})],n.prototype,"allowValuesOutsideRange");l([p()],n.prototype,"markers");l([p()],n.prototype,"required");l([p()],n.prototype,"step");l([p()],n.prototype,"min");l([p()],n.prototype,"max");l([p()],n.prototype,"suffix");l([p()],n.prototype,"formatter");l([W('input[type="range"]')],n.prototype,"range");l([W("w-textfield")],n.prototype,"textfield");l([p()],n.prototype,"_showTooltip");l([p()],n.prototype,"_inputHasFocus");customElements.get("w-slider-thumb")||customElements.define("w-slider-thumb",n);var P=Object.freeze,ee=Object.defineProperty,F=(s,e)=>P(ee(s,"raw",{value:P(s.slice())})),M,L,B,j,A;const{events:te,args:re,argTypes:ae}=X("w-slider"),ie={title:"Forms/Slider and Range Slider",args:re,argTypes:ae,parameters:{actions:{handles:te}}},w={render(){return a`
    ...
    `}},x={args:{locale:"nb",suffix:"m²"},render({locale:s,suffix:e}){return a(M||(M=F([`
      <w-slider
      ...
      <\/script>
    `])),e,s)}},y={args:{locale:"nb",suffix:"kr"},render({locale:s,suffix:e}){return a(L||(L=F([`
      <w-slider
        label="Price"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,s)}},_={args:{locale:"nb",suffix:"km"},render({locale:s,suffix:e}){return a(B||(B=F([`
      <w-slider
        label="Distance"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,s)}},k={args:{locale:"nb",step:"5",markers:"5"},render({markers:s,step:e}){return a`
      <w-slider
        label="Single"
        min="0"
        max="100"
    ...
    `}},S={args:{step:5},render({step:s}){return a`
      <w-slider label="Single" step="${s}" min="0" max="100">
        <w-slider-thumb name="value"></w-slider-thumb>
      </w-slider>
    `}},$={args:{},render(){return a(j||(j=F([`
...
}`,...z.parameters?.docs?.source}}};const se=["Single","Range","SuffixSquareMeters","SuffixCurrency","SuffixKilometers","Marks","Step","OverUnder","SingleError","RangeError","CustomError"],pe=Object.freeze(Object.defineProperty({__proto__:null,CustomError:z,Marks:k,OverUnder:$,Range:v,RangeError:E,Single:w,SingleError:T,Step:S,SuffixCurrency:y,SuffixKilometers:_,SuffixSquareMeters:x,__namedExportsOrder:se,default:ie},Symbol.toStringTag,{value:"Module"}));export{k as M,$ as O,v as R,pe as S,w as a,x as b,y as c,_ as d,S as e,T as f,E as g};

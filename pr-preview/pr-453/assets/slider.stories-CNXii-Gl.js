import{a as I,i as D,r as U,E as m,x as i,n as s,k as c,b as O,g as K}from"./iframe-aIev130K.js";import"./index-DFE6Rxop.js";import"./index-CwEbzEe-.js";import"./index-DM0epSEz.js";import{F as W}from"./FormControlMixin-DJnJZbro.js";import{_ as G}from"./preload-helper-Ct5FWWRu.js";import{e as X}from"./query-NYTjQBeo.js";import{o as F}from"./if-defined-DOKYdwfx.js";const J=I`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`,Z=I`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var ee=Object.defineProperty,l=(o,e,r,a)=>{for(var t=void 0,h=o.length-1,p;h>=0;h--)(p=o[h])&&(t=p(e,r,t)||t);return t&&ee(e,r,t),t};class n extends W(D){constructor(){super(...arguments),this.invalid=!1,this.allowValuesOutsideRange=!1,this.suffix="",this._showTooltip=!1,this._inputHasFocus=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...D.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[U,Z,Y]}#e(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#r(){this._showTooltip=!1}#s(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#t(e){this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:e,slot:this.slot}}))}async#a(e,r){let a=Number.parseInt(e);if(this.allowValuesOutsideRange&&!r&&this.step&&!(this.slot==="to"&&a>=Number(this.max)-1||this.slot==="from"&&a<=Number(this.min)+1)){const g=1/this.step;a=Math.round(a*g)/g,e=a.toString()}const t=Number.parseInt(this.max),h=Number.parseInt(this.min);if(!this.allowValuesOutsideRange&&(a>t||a<h))return this.#t(O.t({id:"slider.error.out_of_bounds",message:"Value must be between {min} and {max}",values:{min:`${this.min} ${this.suffix}`.trim(),max:`${this.max} ${this.suffix}`.trim()}})),{shouldCancel:!0};if(e==="")return this.required&&this.#t(O.t({id:"slider.error.required",message:"This field is required"})),{shouldCancel:!0};this.value=e;const p=e===this.max||e===this.min;let R=!1;if(this.slot){const V=getComputedStyle(this),g=V.getPropertyValue("--to"),N=V.getPropertyValue("--from"),q=O.t({id:"slider.error.overlap",message:"The maximum value cannot be less than the minimum"});if(this.slot==="from"){const b=Math.min(Number.parseInt(g),this.allowValuesOutsideRange?t-1:t);a>b&&(R=!0,this.allowValuesOutsideRange&&p?this.value=String(b):this.value=g,r&&(this.#t(q),await this.updateComplete,this.textfield.value=e))}else{const b=Math.max(Number.parseInt(N),this.allowValuesOutsideRange?h+1:h);a<b&&(R=!0,this.allowValuesOutsideRange&&p?this.value=String(b):this.value=N,r&&(this.#t(q),await this.updateComplete,this.textfield.value=e))}}return R?{shouldCancel:!0}:(this.#t(""),this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.allowValuesOutsideRange&&!r&&p?"":e,this.shadowRoot.querySelector("w-attention").handleDone(),{shouldCancel:!1})}async#i(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const a=e.currentTarget.value;return(await this.#a(a,r)).shouldCancel?(e.preventDefault(),!1):!0}async#o(e){if(e.key!=="ArrowLeft"&&e.key!=="ArrowRight")return;const r=Number(this.range.value),a=this.step||1;let t;e.key==="ArrowLeft"?t=r-a:t=r+a,t=Math.min(Math.max(t,Number(this.min)),Number(this.max)),(await this.#a(t.toString(),!1)).shouldCancel&&e.preventDefault()}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:r}]=await Promise.all([G(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
    ...
    `}},y={args:{locale:"nb",suffix:"m²"},render({locale:o,suffix:e}){return i(M||(M=f([`
      <w-slider
      ...
      <\/script>
    `])),e,o)}},x={args:{locale:"nb",suffix:"kr"},render({locale:o,suffix:e}){return i(B||(B=f([`
      <w-slider
        label="Price"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,o)}},_={args:{locale:"nb",suffix:"km"},render({locale:o,suffix:e}){return i(L||(L=f([`
      <w-slider
        label="Distance"
        min="0"
        max="250000"
    ...
    `}},S={args:{step:5},render({step:o}){return i`

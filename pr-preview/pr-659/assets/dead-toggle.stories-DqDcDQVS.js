import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{m as n,n as r,s as i,t as a}from"./lit-JruGAyH3.js";import{n as o,t as s}from"./dist-DqaB6mbc.js";import{n as c,o as l,r as u,t as d}from"./decorate-Dk3JVGAn.js";import{n as f,t as p}from"./styles-DphVJT09.js";import{i as m,n as h,r as g,t as _}from"./utilities-DiPTmiiI.js";var v,y=e((()=>{a(),v=n`
  [part~='label'] {
    display: block;
...
`})),b,x=e((()=>{a(),u(),p(),y(),c(),b=class extends r{constructor(...e){super(...e),this.checked=!1,this.indeterminate=!1,this.invalid=!1,this.disabled=!1}get indeterminateMarker(){return!this.checked&&this.indeterminate?`–`:``}render(){return i` <div class="control">${this.indeterminateMarker}</div> `}static{this.styles=[f,v]}},d([l({type:String,reflect:!0})],b.prototype,`type`,void 0),d([l({type:Boolean,reflect:!0})],b.prototype,`checked`,void 0),d([l({type:Boolean,reflect:!0})],b.prototype,`indeterminate`,void 0),d([l({type:Boolean,reflect:!0})],b.prototype,`invalid`,void 0),d([l({type:Boolean,reflect:!0})],b.prototype,`disabled`,void 0),customElements.get(`w-dead-toggle`)||customElements.define(`w-dead-toggle`,b)})),S=t({Checkbox:()=>O,Checked:()=>A,Indeterminate:()=>k,Invalid:()=>j,Radio:()=>D,__namedExportsOrder:()=>M,default:()=>E}),C,w,T,E,D,O,k,A,j,M,N=e((()=>{g(),o(),a(),_(),x(),{events:C,args:w,argTypes:T}=s(`w-dead-toggle`),E={title:`Forms/Dead toggle`,render(e){return i`<w-dead-toggle ${m(h(e))}></w-dead-toggle>`},args:w,argTypes:T,parameters:{actions:{handles:C}}},D={args:{type:`radio`}},O={args:{type:`checkbox`}},k={args:{indeterminate:!0}},A={args:{checked:!0}},j={args:{invalid:!0}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  args: {
    type: 'radio'
  }

import{n as e}from"./chunk-BneVvdWh.js";import{m as t,n,r,s as i,t as a}from"./lit-C07f_Bua.js";import{n as o,t as s}from"./dist-B1PfYo3w.js";import{n as c,o as l,r as u,t as d}from"./decorate-BZxMavXy.js";import{r as f,t as p}from"./i18n-CXAEKYxp.js";import{n as m,t as h}from"./styles-BM5RxtAH.js";import{n as g,t as _}from"./if-defined-YNORsBYI.js";import{n as v,t as y}from"./form-control-DxmguQIf.js";import{t as b}from"./link-BCbeiwkm.js";var x,S=e((()=>{x=JSON.parse(`{"button.aria.loading":["Indlæser..."]}`)})),C,w=e((()=>{C=JSON.parse(`{"button.aria.loading":["Loading..."]}`)})),T,E=e((()=>{T=JSON.parse(`{"button.aria.loading":["Ladataan..."]}`)})),D,O=e((()=>{D=JSON.parse(`{"button.aria.loading":["Laster..."]}`)})),k,A=e((()=>{k=JSON.parse(`{"button.aria.loading":["Laddar ..."]}`)})),j,M=e((()=>{a(),j=t`
  :host {
...
`})),N,P,F=e((()=>{o(),y(),a(),u(),f(),b(),h(),S(),w(),E(),O(),A(),M(),_(),c(),N=[`primary`,`secondary`,`negative`,`negativeQuiet`,`utility`,`pill`,`link`,`quiet`,`utilityQuiet`,`overlay`,`overlayInverted`,`overlayQuiet`,`overlayInvertedQuiet`],P=class extends v(n){static{this.styles=[m,j]}static{this.shadowRootOptions={...n.shadowRootOptions,delegatesFocus:!0}}#e=null;updated(e){e.has(`value`)&&this.setValue(this.value)}constructor(){super(),this.autofocus=!1,this.quiet=!1,this.iconOnly=!1,this.small=!1,this.loading=!1,this.disabled=!1,this.fullWidth=!1,p(C,D,T,x,k),this.ariaValueTextLoading=s.t({id:`button.aria.loading`,message:`Loading...`,comment:`Screen reader message for buttons that are loading`})}connectedCallback(){super.connectedCallback();let e=this.variant||`secondary`;if(!N.includes(e))throw Error(`Invalid "variant" attribute. Set its value to one of the following:\n${N.join(`, `)}.`);this.#e=this.value}firstUpdated(){this.autofocus&&!this.href&&setTimeout(()=>this.focus(),0)}_handleButtonClick(){this.type===`submit`?this.internals.form.requestSubmit():this.type===`reset`&&this.internals.form.reset()}resetFormControl(){this.value=this.#e}render(){let e=this.variant||`secondary`;return i` ${this.href?i`
          <w-link
            href=${this.href}
            target=${this.target}
    ...
    ${this.loading?i`<span
        ...
        ></span>`:r}`}},d([l({reflect:!0})],P.prototype,`type`,void 0),d([l({type:Boolean,reflect:!0})],P.prototype,`autofocus`,void 0),d([l({reflect:!0})],P.prototype,`variant`,void 0),d([l({type:Boolean,reflect:!0})],P.prototype,`quiet`,void 0),d([l({type:Boolean,reflect:!0,attribute:`icon-only`})],P.prototype,`iconOnly`,void 0),d([l({type:Boolean,reflect:!0})],P.prototype,`small`,void 0),d([l({type:Boolean,reflect:!0})],P.prototype,`loading`,void 0),d([l({reflect:!0})],P.prototype,`href`,void 0),d([l({reflect:!0})],P.prototype,`target`,void 0),d([l({type:Boolean,reflect:!0})],P.prototype,`disabled`,void 0),d([l({reflect:!0})],P.prototype,`rel`,void 0),d([l({attribute:`full-width`,type:Boolean,reflect:!0})],P.prototype,`fullWidth`,void 0),d([l({attribute:`button-class`,reflect:!0})],P.prototype,`buttonClass`,void 0),d([l({reflect:!0})],P.prototype,`name`,void 0),d([l({reflect:!0})],P.prototype,`value`,void 0),customElements.get(`w-button`)||customElements.define(`w-button`,P)}));export{F as t};
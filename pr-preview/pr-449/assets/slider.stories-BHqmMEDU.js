import{a as V,i as E,r as L,E as u,x as o,n,k as m,g as H}from"./iframe-Pe20ddIa.js";import"./index-sD3hZoK0.js";import"./index-kAb1kD_n.js";import"./index-zlfum2MB.js";import{F as j}from"./FormControlMixin-DJnJZbro.js";import{_ as U}from"./preload-helper-Ct5FWWRu.js";import{e as A}from"./query-NYTjQBeo.js";import{o as D}from"./if-defined-DC3lSJLK.js";const W=V`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`;var X=Object.defineProperty,h=(s,e,r,l)=>{for(var t=void 0,c=s.length-1,p;c>=0;c--)(p=s[c])&&(t=p(e,r,t)||t);return t&&X(e,r,t),t};class d extends j(E){constructor(){super(...arguments),this.disabled=!1,this.allowValuesOutsideRange=!1,this.helpText="",this.invalid=!1,this.required=!1}static{this.shadowRootOptions={...E.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[L,W]}#e(){const e=this.querySelectorAll("w-slider-thumb");let r=!1;for(const t of e.values())t.min=this.edgeMin,t.max=this.edgeMax,t.step=this.step,t.suffix=this.suffix,t.required=this.required,t.formatter=this.formatter,t.allowValuesOutsideRange=this.allowValuesOutsideRange,t.ariaLabel||(t.slot||(t.ariaLabel=this.label),t.slot==="from"&&(t.ariaLabel=`${this.label} min`),t.slot==="to"&&(t.ariaLabel=`${this.label} max`)),(t.slot==="from"||t.slot==="to")&&(r=!0),t.forceDisabled=this.disabled,t.forceInvalid=this.invalid,this.#i(t);const l=this.shadowRoot.querySelector("fieldset");r?(l.style.setProperty("--active-range-inline-start-padding","var(--w-slider-thumb-size)"),l.style.setProperty("--active-range-inline-end-padding","var(--w-slider-thumb-size)")):l.style.setProperty("--active-range-border-radius","4px")}get edgeMin(){return this.allowValuesOutsideRange?(Number(this.min)-1).toString():this.min}get edgeMax(){return this.allowValuesOutsideRange?(Number(this.max)+1).toString():this.max}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.step&&this.style.setProperty("--step",String(this.step)),this.style.setProperty("--min",this.edgeMin),this.style.setProperty("--max",this.edgeMax),this.markers&&this.style.setProperty("--markers",String(this.markers)),this.#e()}updated(e){(e.has("disabled")||e.has("invalid")||e.has("required")||e.has("min")||e.has("step")||e.has("max")||e.has("suffix")||e.has("formatter"))&&this.#e()}#t(e){const r=e.target;this.#i(r)}#a(e){e.stopPropagation(),this.invalid=e.detail.invalid}#r(e,r){return(r.value===void 0||r.value===null)&&(r.value=this.allowValuesOutsideRange?"":e),r.value===""?e:r.value}#i(e){const r=e.slot;r||this.style.setProperty("--from","0"),r==="from"&&this.style.setProperty("--from",this.#r(this.edgeMin,e)),(!r||r==="to")&&this.style.setProperty("--to",this.#r(this.edgeMax,e))}render(){return o`
    ...
    `}}h([n({reflect:!0})],d.prototype,"label");h([n({type:Boolean,reflect:!0})],d.prototype,"disabled");h([n({type:Boolean,attribute:"allow-values-outside-range"})],d.prototype,"allowValuesOutsideRange");h([n({reflect:!0})],d.prototype,"helpText");h([n({type:Boolean,reflect:!0})],d.prototype,"invalid");h([n({type:Boolean,reflect:!0})],d.prototype,"required");h([n({reflect:!0})],d.prototype,"min");h([n({reflect:!0})],d.prototype,"max");h([n({type:Number,reflect:!0})],d.prototype,"markers");h([n({type:Number,reflect:!0})],d.prototype,"step");h([n({reflect:!0})],d.prototype,"suffix");h([n({attribute:!1})],d.prototype,"formatter");customElements.get("w-slider")||customElements.define("w-slider",d);const K=V`
  .w-slider-thumb {
    position: relative;
    display: grid;
...
`,G=V`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var J=Object.defineProperty,i=(s,e,r,l)=>{for(var t=void 0,c=s.length-1,p;c>=0;c--)(p=s[c])&&(t=p(e,r,t)||t);return t&&J(e,r,t),t};class a extends j(E){constructor(){super(...arguments),this.allowValuesOutsideRange=!1,this._invalid=!1,this._showTooltip=!1,this._inputHasFocus=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...E.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[L,G,K]}#e(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#t(){this._showTooltip=!1}#a(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}async#r(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const l=e.currentTarget.value,t=Number.parseInt(l),c=Number.parseInt(this.max),p=Number.parseInt(this.min);if(!this.allowValuesOutsideRange&&(t>c||t<p))return this._invalid=!0,!1;if(l==="")return this.required&&(this._invalid=!0),!1;this._invalid&&(this._invalid=!1),this.value=l;const g=l===this.max||l===this.min;let F=!1;if(this.slot){const C=getComputedStyle(this),R=C.getPropertyValue("--to"),O=C.getPropertyValue("--from");if(this.slot==="from"){const f=Math.min(Number.parseInt(R),this.allowValuesOutsideRange?c-1:c);t>f&&(F=!0,r?(this._invalid=!0,await this.updateComplete,this.allowValuesOutsideRange&&g?this.range.value=String(f):this.range.value=R):this.allowValuesOutsideRange&&g?this.value=String(f):this.value=R)}else{const f=Math.max(Number.parseInt(O),this.allowValuesOutsideRange?p+1:p);t<f&&(F=!0,r?(this._invalid=!0,await this.updateComplete,this.allowValuesOutsideRange&&g?this.range.value=String(f):this.range.value=O):this.allowValuesOutsideRange&&g?this.value=String(f):this.value=O)}}return F?(e.preventDefault(),!1):(this.range.value=Math.min(Math.max(Number(l),Number(this.min)),Number(this.max)).toString(),this.value=this.allowValuesOutsideRange&&!r&&g?"":l,this.shadowRoot.querySelector("w-attention").handleDone(),!0)}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:r}]=await Promise.all([U(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
        /*
      ...
      <div class="w-slider-thumb">
        ...
        <input
          ...
          aria-describedby="${D(this.ariaDescription?"aria-description":void 0)}"
          class="w-slider-thumb__range"
          type="range"
          .value="${this.value}"
          min="${this.min}"
          max="${this.max}"
          step="${D(this.step?this.step:void 0)}"
    ...
    `}}i([n({attribute:"aria-label",reflect:!0})],a.prototype,"ariaLabel");i([n({attribute:"aria-description",reflect:!0})],a.prototype,"ariaDescription");i([n({reflect:!0})],a.prototype,"label");i([n({reflect:!0})],a.prototype,"name");i([n({reflect:!0})],a.prototype,"value");i([n({type:Boolean,reflect:!0})],a.prototype,"disabled");i([n({attribute:!1,reflect:!1})],a.prototype,"allowValuesOutsideRange");i([m()],a.prototype,"markers");i([m()],a.prototype,"required");i([m()],a.prototype,"step");i([m()],a.prototype,"min");i([m()],a.prototype,"max");i([m()],a.prototype,"suffix");i([m()],a.prototype,"forceDisabled");i([m()],a.prototype,"forceInvalid");i([m()],a.prototype,"formatter");i([A('input[type="range"]')],a.prototype,"range");i([A("w-textfield")],a.prototype,"textfield");i([m()],a.prototype,"_invalid");i([m()],a.prototype,"_showTooltip");i([m()],a.prototype,"_inputHasFocus");customElements.get("w-slider-thumb")||customElements.define("w-slider-thumb",a);var I=Object.freeze,Q=Object.defineProperty,z=(s,e)=>I(Q(s,"raw",{value:I(s.slice())})),q,P,N,M,B;const{events:Y,args:Z,argTypes:ee}=H("w-slider"),te={title:"Forms/Slider and Range Slider",args:Z,argTypes:ee,parameters:{actions:{handles:Y}}},b={render(){return o`
    ...
    `}},v={args:{locale:"nb",suffix:"m²"},render({locale:s,suffix:e}){return o(q||(q=z([`
      <w-slider
      ...
      <\/script>
    `])),e,s)}},y={args:{locale:"nb",suffix:"kr"},render({locale:s,suffix:e}){return o(P||(P=z([`
      <w-slider
        label="Price"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,s)}},x={args:{locale:"nb",suffix:"km"},render({locale:s,suffix:e}){return o(N||(N=z([`
      <w-slider
        label="Distance"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,s)}},_={args:{locale:"nb",step:"5",markers:"5"},render({markers:s,step:e}){return o`
      <w-slider
        label="Single"
        min="0"
        max="100"
    ...
    `}},k={args:{step:5},render({step:s}){return o`
      <w-slider label="Single" step="${s}" min="0" max="100">
        <w-slider-thumb name="value"></w-slider-thumb>
      </w-slider>
    `}},S={args:{},render(){return o(M||(M=z([`
...
}`,...T.parameters?.docs?.source}}};const re=["Single","Range","SuffixSquareMeters","SuffixCurrency","SuffixKilometers","Marks","Step","OverUnder","SingleError","RangeError"],me=Object.freeze(Object.defineProperty({__proto__:null,Marks:_,OverUnder:S,Range:w,RangeError:T,Single:b,SingleError:$,Step:k,SuffixCurrency:y,SuffixKilometers:x,SuffixSquareMeters:v,__namedExportsOrder:re,default:te},Symbol.toStringTag,{value:"Module"}));export{_ as M,S as O,w as R,me as S,b as a,v as b,y as c,x as d,k as e,$ as f,T as g};

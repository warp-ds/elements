import{a as D,i as F,r as L,E as u,x as o,n,k as m,g as H}from"./iframe-BAc6T-a2.js";import"./index-D-97Qvbd.js";import"./index-BhAD-irg.js";import"./index-DmcNpq9o.js";import{F as j}from"./FormControlMixin-DJnJZbro.js";import{_ as U}from"./preload-helper-Ct5FWWRu.js";import{e as A}from"./query-NYTjQBeo.js";import{o as O}from"./if-defined-CwAgRmiP.js";const W=D`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`,G=D`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var J=Object.defineProperty,i=(s,e,r,l)=>{for(var t=void 0,c=s.length-1,p;c>=0;c--)(p=s[c])&&(t=p(e,r,t)||t);return t&&J(e,r,t),t};class a extends j(F){constructor(){super(...arguments),this.allowValuesOutsideRange=!1,this._invalid=!1,this._showTooltip=!1,this._inputHasFocus=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...F.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[L,G,K]}#e(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#t(){this._showTooltip=!1}#a(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}async#r(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const l=e.currentTarget.value,t=Number.parseInt(l),c=Number.parseInt(this.max),p=Number.parseInt(this.min);if(!this.allowValuesOutsideRange&&(t>c||t<p))return this._invalid=!0,!1;if(l==="")return this.required&&(this._invalid=!0),!1;this._invalid&&(this._invalid=!1),this.value=l;const g=l===this.max||l===this.min;let R=!1;if(this.slot){const V=getComputedStyle(this),C=V.getPropertyValue("--to"),E=V.getPropertyValue("--from");if(this.slot==="from"){const f=Math.min(Number.parseInt(C),this.allowValuesOutsideRange?c-1:c);t>f&&(R=!0,r?(this._invalid=!0,await this.updateComplete,this.allowValuesOutsideRange&&g?this.range.value=String(f):this.range.value=E):this.allowValuesOutsideRange&&g?this.value=String(f):this.value=C)}else{const f=Math.max(Number.parseInt(E),this.allowValuesOutsideRange?p+1:p);t<f&&(R=!0,r?(this._invalid=!0,await this.updateComplete,this.allowValuesOutsideRange&&g?this.range.value=String(f):this.range.value=E):this.allowValuesOutsideRange&&g?this.value=String(f):this.value=E)}}return R?(e.preventDefault(),!1):(this.range.value=Math.min(Math.max(Number(l),Number(this.min)),Number(this.max)).toString(),this.value=this.allowValuesOutsideRange&&!r&&g?"":l,this.shadowRoot.querySelector("w-attention").handleDone(),!0)}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:r}]=await Promise.all([U(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
        /*

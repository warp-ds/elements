import{a as O,i as z,r as I,E as u,x as o,n as l,k as m,g as A}from"./iframe-DAE5hhHs.js";import"./index-CjZhN_oT.js";import"./index-CTczfQFV.js";import"./index-CwwmXD2S.js";import{F as M}from"./FormControlMixin-DJnJZbro.js";import{_ as B}from"./preload-helper-Ct5FWWRu.js";import{e as j}from"./query-NYTjQBeo.js";import{o as F}from"./if-defined-DCIzZzey.js";const H=O`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`,X=O`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var K=Object.defineProperty,i=(s,e,r,n)=>{for(var t=void 0,c=s.length-1,p;c>=0;c--)(p=s[c])&&(t=p(e,r,t)||t);return t&&K(e,r,t),t};class a extends M(z){constructor(){super(...arguments),this.allowValuesOutsideRange=!1,this._invalid=!1,this._showTooltip=!1,this._inputHasFocus=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...z.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[I,X,W]}#e(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#t(){this._showTooltip=!1}#a(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#r(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const n=e.currentTarget.value,t=Number.parseInt(n),c=Number.parseInt(this.max),p=Number.parseInt(this.min);if(!this.allowValuesOutsideRange&&(t>c||t<p))return this._invalid=!0,!1;if(n==="")return this.required&&(this._invalid=!0),!1;this._invalid&&(this._invalid=!1),this.value=n;let E=!1;if(this.slot&&!(r&&this.allowValuesOutsideRange)){const V=getComputedStyle(this),$=V.getPropertyValue("--to"),T=V.getPropertyValue("--from");this.slot==="from"?(t>Number.parseInt($)||this.allowValuesOutsideRange&&t>=Number($))&&(E=!0,this.allowValuesOutsideRange?this.value=(Number($)-1).toString():this.value=$,r&&(this._invalid=!0)):(t<Number.parseInt(T)||this.allowValuesOutsideRange&&t<=Number(T))&&(E=!0,this.allowValuesOutsideRange?this.value=(Number(T)+1).toString():this.value=T,r&&(this._invalid=!0))}if(E)return e.preventDefault(),!0;this.range.value=Math.min(Math.max(Number(n),Number(this.min)),Number(this.max)).toString();const L=(!this.range||this.range?.value===n)&&(n===this.max||n===this.min);return this.value=this.allowValuesOutsideRange&&!r&&L?"":n,this.shadowRoot.querySelector("w-attention").handleDone(),!0}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:r}]=await Promise.all([B(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
        /*
    ...
    `}},g={args:{locale:"nb",suffix:"m²"},render({locale:s,suffix:e}){return o(q||(q=R([`
      <w-slider
      ...
      <\/script>
    `])),e,s)}},w={args:{locale:"nb",suffix:"kr"},render({locale:s,suffix:e}){return o(P||(P=R([`
      <w-slider
        label="Price"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,s)}},v={args:{locale:"nb",suffix:"km"},render({locale:s,suffix:e}){return o(D||(D=R([`
      <w-slider
        label="Distance"
        min="0"
        max="250000"

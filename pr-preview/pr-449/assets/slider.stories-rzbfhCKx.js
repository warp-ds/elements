import{a as V,i as T,r as L,E as u,x as o,n,k as m,g as H}from"./iframe-CyaT03PB.js";import"./index-BY8mG9Yr.js";import"./index-BZC3_lMv.js";import"./index-C29IJphQ.js";import{F as j}from"./FormControlMixin-DJnJZbro.js";import{_ as U}from"./preload-helper-Ct5FWWRu.js";import{e as A}from"./query-NYTjQBeo.js";import{o as O}from"./if-defined-rRpVxwio.js";const W=V`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`,G=V`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var J=Object.defineProperty,i=(s,e,r,l)=>{for(var t=void 0,c=s.length-1,p;c>=0;c--)(p=s[c])&&(t=p(e,r,t)||t);return t&&J(e,r,t),t};class a extends j(T){constructor(){super(...arguments),this.allowValuesOutsideRange=!1,this._invalid=!1,this._showTooltip=!1,this._inputHasFocus=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...T.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[L,G,K]}#e(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#t(){this._showTooltip=!1}#a(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#r(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const l=e.currentTarget.value,t=Number.parseInt(l),c=Number.parseInt(this.max),p=Number.parseInt(this.min);if(!this.allowValuesOutsideRange&&(t>c||t<p))return this._invalid=!0,!1;if(l==="")return this.required&&(this._invalid=!0),!1;this._invalid&&(this._invalid=!1),this.value=l;const z=l===this.max||l===this.min;let E=!1;if(this.slot){const C=getComputedStyle(this),F=C.getPropertyValue("--to"),R=C.getPropertyValue("--from");if(this.slot==="from"){const D=Math.min(Number.parseInt(F),this.allowValuesOutsideRange?c-1:c);t>D&&(E=!0,this.allowValuesOutsideRange&&z?this.value=(Number(F)-1).toString():this.value=F,r&&(this._invalid=!0))}else{const D=Math.max(Number.parseInt(R),this.allowValuesOutsideRange?p+1:p);t<D&&(E=!0,this.allowValuesOutsideRange&&z?this.value=(Number(R)+1).toString():this.value=R,r&&(this._invalid=!0))}}return E?(e.preventDefault(),!1):(this.range.value=Math.min(Math.max(Number(l),Number(this.min)),Number(this.max)).toString(),this.value=this.allowValuesOutsideRange&&!r&&z?"":l,this.shadowRoot.querySelector("w-attention").handleDone(),!0)}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:r}]=await Promise.all([U(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
    ...
    `}},b={args:{locale:"nb",suffix:"m²"},render({locale:s,suffix:e}){return o(q||(q=$([`
      <w-slider
      ...
      <\/script>
    `])),e,s)}},w={args:{locale:"nb",suffix:"kr"},render({locale:s,suffix:e}){return o(N||(N=$([`
      <w-slider
        label="Price"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,s)}},v={args:{locale:"nb",suffix:"km"},render({locale:s,suffix:e}){return o(P||(P=$([`
      <w-slider
        label="Distance"
        min="0"
        max="250000"
...
}`,...S.parameters?.docs?.source}}};const re=["Single","Range","SuffixSquareMeters","SuffixCurrency","SuffixKilometers","Marks","Step","OverUnder","SingleError","RangeError"],me=Object.freeze(Object.defineProperty({__proto__:null,Marks:y,OverUnder:_,Range:g,RangeError:S,Single:f,SingleError:k,Step:x,SuffixCurrency:w,SuffixKilometers:v,SuffixSquareMeters:b,__namedExportsOrder:re,default:te},Symbol.toStringTag,{value:"Module"}));export{y as M,_ as O,g as R,me as S,f as a,b,w as c,v as d,x as e,k as f,S as g};

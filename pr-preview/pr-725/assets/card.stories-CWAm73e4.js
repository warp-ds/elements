import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{Bt as n,E as r,Ht as i,J as a,Lt as o,M as s,N as c,Rt as l,Wt as u,b as d,f,j as p,k as m,l as h,p as g,q as _,u as v}from"./iframe-C-gIJc8-.js";import{a as y,n as b,r as x,t as S}from"./utilities-B5i-q1bD.js";import{r as C,t as w}from"./if-defined-Csg7oTci.js";var T,E=t((()=>{T=JSON.parse(`{"card.button.text":["Vælg"]}`)})),D,O=t((()=>{D=JSON.parse(`{"card.button.text":["Select"]}`)})),k,A=t((()=>{k=JSON.parse(`{"card.button.text":["Valitse"]}`)})),j,M=t((()=>{j=JSON.parse(`{"card.button.text":["Velg"]}`)})),N,P=t((()=>{N=JSON.parse(`{"card.button.text":["Välj"]}`)})),F,I=t((()=>{o(),F=u`
	:host {

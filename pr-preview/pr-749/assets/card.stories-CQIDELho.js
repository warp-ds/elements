import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{C as n,f as r,h as ee,p as te,r as i,s as a,t as o,y as s}from"./decorate-D-MUTuIl.js";import{a as c,o as l,r as u,t as d}from"./i18n-CkjYRTT1.js";import{n as f,t as p}from"./dist-CXTYkVAl.js";import{n as m,t as h}from"./styles-Dxzaq_l3.js";import{i as g,n as _,r as ne}from"./utilities-C5YHrCuy.js";import{r as re,t as v}from"./if-defined-CDQgRpqn.js";var y;function b(){return(b=e((()=>{y=JSON.parse(`{"card.button.text":["Vælg"]}`)})))()}var x;function S(){return(S=e((()=>{x=JSON.parse(`{"card.button.text":["Select"]}`)})))()}var C;function w(){return(w=e((()=>{C=JSON.parse(`{"card.button.text":["Valitse"]}`)})))()}var T;function E(){return(E=e((()=>{T=JSON.parse(`{"card.button.text":["Velg"]}`)})))()}var D;function O(){return(O=e((()=>{D=JSON.parse(`{"card.button.text":["Välj"]}`)})))()}var k;function A(){return(A=e((()=>{r(),k=n`
	:host {

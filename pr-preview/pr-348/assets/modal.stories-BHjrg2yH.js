import{x as i,r as S,a as E,i as k,f as w,s as R,u as W,l as D,E as I,n as d,k as Y,g as B}from"./iframe-DvzodPjT.js";import{s as T,p as O}from"./utilities-eWSlf40W.js";import{e as v}from"./query-NYTjQBeo.js";const _=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},H=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const r of o.filter(a=>a.patchClose))r._close=()=>this.close()}};let J=class extends _(H(k)){render(){return i`
      <div class="footer">

import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{Bt as n,D as r,E as i,Ht as a,J as o,Kt as s,Lt as c,M as l,N as u,O as d,Rt as f,b as p,f as m,l as h,p as g,q as _,u as v,w as y,x as b}from"./iframe-DniOoqQk.js";import{a as x,n as S,r as C,t as w}from"./utilities-CePNGznO.js";import{n as T,t as E}from"./form-control-DtXadPi-.js";import{r as D,t as O}from"./if-defined-CikA8f6p.js";import{n as ee,t as k}from"./utils-D431BAPN.js";var A,j=t((()=>{c(),A=s(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.focus\\:\\[--w-outline-offset\\:-2px\\]:focus{--w-outline-offset:-2px}.bg-transparent{background-color:#0000}.border-1{border-width:1px}.rounded-4{border-radius:4px}.caret-current{caret-color:currentColor}.block{display:block}.flex{display:flex}.focusable:focus{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:focus-visible{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:not(:focus-visible){outline:none}.outline-\\[--w-s-color-border-negative\\]\\!{outline-color:var(--w-s-color-border-negative)!important}.fixed{position:fixed}.relative{position:relative}.static{position:static}.s-bg{background-color:var(--w-s-color-background)}.s-bg-disabled-subtle{background-color:var(--w-s-color-background-disabled-subtle)}.s-text{color:var(--w-s-color-text)}.s-text-disabled{color:var(--w-s-color-text-disabled)}.s-text-negative{color:var(--w-s-color-text-negative)}.s-text-subtle{color:var(--w-s-color-text-subtle)}.placeholder\\:s-text-placeholder::placeholder{color:var(--w-s-color-text-placeholder)}.s-border-disabled{border-color:var(--w-s-color-border-disabled)}.s-border-negative{border-color:var(--w-s-color-border-negative)}.s-border-strong{border-color:var(--w-s-color-border-strong)}.hover\\:s-border-negative-hover:hover{border-color:var(--w-s-color-border-negative-hover)}.hover\\:s-border-strong-hover:hover{border-color:var(--w-s-color-border-strong-hover)}.active\\:s-border-selected:active{border-color:var(--w-s-color-border-selected)}.w-full{width:100%}.min-h-\\[42\\]{min-height:4.2rem}.mb-0{margin-bottom:0}.mt-4{margin-top:.4rem}.px-8{padding-left:.8rem;padding-right:.8rem}.py-12{padding-top:1.2rem;padding-bottom:1.2rem}.pb-4{padding-bottom:.4rem}.pl-0{padding-left:0}.pl-8{padding-left:.8rem}.pr-40{padding-right:4rem}.pl-\\[var\\(--w-prefix-width\\,_40px\\)\\]{padding-left:var(--w-prefix-width,40px)}.visible{visibility:visible}.cursor-pointer{cursor:pointer}.antialiased{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;font-smoothing:grayscale}.font-bold{font-weight:700}.font-normal{font-weight:400}.pointer-events-none{pointer-events:none}.resize{resize:both}.resize-none{resize:none}.text-m{font-size:var(--w-font-size-m);line-height:var(--w-line-height-m)}.text-s{font-size:var(--w-font-size-s);line-height:var(--w-line-height-s)}.text-xs{font-size:var(--w-font-size-xs);line-height:var(--w-line-height-xs)}.leading-m{line-height:var(--w-line-height-m)}@media (min-width:480px){.sm\\:min-h-\\[45\\]{min-height:4.5rem}}`)})),M,N,P,F,te=t((()=>{r(),o(),E(),c(),p(),O(),h(),k(),j(),g(),M={base:`block text-m leading-m mb-0 px-8 py-12 rounded-4 w-full focusable focus:[--w-outline-offset:-2px] caret-current`,default:`border-1 s-text s-bg s-border-strong hover:s-border-strong-hover active:s-border-selected`,disabled:`border-1 s-text-disabled s-bg-disabled-subtle s-border-disabled pointer-events-none`,invalid:`border-1 s-text-negative s-bg s-border-negative hover:s-border-negative-hover outline-[--w-s-color-border-negative]!`,readOnly:`pl-0 bg-transparent pointer-events-none`,placeholder:`placeholder:s-text-placeholder`,suffix:`pr-40`,prefix:`pl-[var(--w-prefix-width,_40px)]`,textArea:`min-h-[42] sm:min-h-[45]`,fixed:`resize-none`},N={base:`antialiased block relative text-s font-bold pb-4 cursor-pointer s-text flex`,optional:`pl-8 font-normal text-s s-text-subtle`},P={base:`text-xs mt-4 block`,color:`s-text-subtle`,colorInvalid:`s-text-negative`},F=class extends T(f){constructor(...e){super(...e),this.disabled=!1,this.invalid=!1,this.readOnly=!1,this.readonly=!1,this.required=!1,this.optional=!1,this.minHeight=-1/0,this.maxHeight=1/0,this.#e=void 0,this.#t=ee(`textarea-`),this.#n=!1,this.#r=void 0,this.#i=!1,this.#l=e=>{e.preventDefault(),this.#i=!0,this.#s()}}static{this.shadowRootOptions={...f.shadowRootOptions,delegatesFocus:!0}}#e;#t;#n;#r;#i;updated(e){e.has(`value`)&&this.value!==void 0&&this.setValue(this.value),(e.has(`value`)||e.has(`required`)||e.has(`disabled`))&&this.#s()}resetFormControl(){this.value=this.#e,this.#i=!1,this.#o(),this.#s()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#s(),this.internals.checkValidity()}reportValidity(){return this.#i=!0,this.#s(),this.internals.checkValidity()}setCustomValidity(e){e?(this.internals.setValidity({customError:!0},e,this._textarea),this.#a(e)):(this.#o(),this.#s())}#a(e){this.#n||(this.#r=this.helpText),this.#n=!0,this.invalid=!0,this.helpText=e}#o(){this.#n&&=(this.invalid=!1,this.helpText=this.#r,this.#r=void 0,!1)}#s(){if(this.disabled){this.internals.setValidity({}),this.#o();return}if(this.required&&!this.value){let e=this._textarea?.validationMessage||``;this.internals.setValidity({valueMissing:!0},e,this._textarea),this.#i&&this.#a(e);return}this.internals.setValidity({}),this.#o()}static{this.styles=[v,A]}get _textareaStyles(){return d([M.base,M.textArea,!!this.placeholder&&M.placeholder,!this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&M.default,this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&M.invalid,!this.invalid&&this.disabled&&!(this.readonly||this.readOnly)&&M.disabled,!this.invalid&&!this.disabled&&(this.readonly||this.readOnly)&&M.readOnly,this.maxRows&&M.fixed])}get _helptextstyles(){return d([P.base,this.invalid?P.colorInvalid:P.color])}get _helpId(){if(this.helpText)return`${this._id}__hint`}get _id(){return this.#t}get _error(){if(this.invalid&&this._helpId)return this._helpId}async connectedCallback(){if(super.connectedCallback(),this.#e=this.value,this.value!==void 0&&this.setValue(this.value),this.addEventListener(`invalid`,this.#l),await this.updateComplete,this.value||this.minRows){let e=this.shadowRoot?.querySelector(`textarea`);e&&this.#u(e)}}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`invalid`,this.#l)}firstUpdated(e){super.firstUpdated(e),this.#s()}handler(e){let t=e.currentTarget;this.value=t.value,this.#u(t)}#c(){this.#i=!0,this.#s()}#l;#u(e){let t=getComputedStyle(e),n=Number.parseFloat(t.getPropertyValue(`border-top-width`)),r=Number.parseFloat(t.getPropertyValue(`border-bottom-width`)),i=Number.parseFloat(t.getPropertyValue(`line-height`)),a=Number.parseFloat(t.getPropertyValue(`padding-top`))+Number.parseFloat(t.getPropertyValue(`padding-bottom`))+r+n;this.minRows&&(this.minHeight=i*this.minRows+a),this.maxRows&&(this.maxHeight=i*this.maxRows+a);let o=e.scrollHeight+n+r,s=Math.min(this.maxHeight,Math.max(this.minHeight,o));e.style.setProperty(`height`,s+`px`)}render(){return a`
        ...
        ${this.helpText?a`<div class="${this._helptextstyles}" id="${this._helpId}">${this.helpText}</div>`:n}
    `}},m([i({type:Boolean,reflect:!0})],F.prototype,`disabled`,void 0),m([i({type:Boolean,reflect:!0})],F.prototype,`invalid`,void 0),m([i({type:String,reflect:!0})],F.prototype,`label`,void 0),m([i({type:String,reflect:!0,attribute:`help-text`})],F.prototype,`helpText`,void 0),m([i({type:Number,reflect:!0,attribute:`maximum-rows`})],F.prototype,`maxRows`,void 0),m([i({type:Number,reflect:!0,attribute:`minimum-rows`})],F.prototype,`minRows`,void 0),m([i({type:String,reflect:!0})],F.prototype,`name`,void 0),m([i({type:String,reflect:!0})],F.prototype,`placeholder`,void 0),m([i({type:Boolean,reflect:!0,attribute:`read-only`})],F.prototype,`readOnly`,void 0),m([i({type:Boolean,reflect:!0})],F.prototype,`readonly`,void 0),m([i({type:Boolean,reflect:!0})],F.prototype,`required`,void 0),m([i({type:String,reflect:!0})],F.prototype,`value`,void 0),m([i({type:Boolean,reflect:!0})],F.prototype,`optional`,void 0),m([y()],F.prototype,`minHeight`,void 0),m([y()],F.prototype,`maxHeight`,void 0),m([b(`textarea`)],F.prototype,`_textarea`,void 0),customElements.get(`w-textarea`)||customElements.define(`w-textarea`,F)})),I=e({Autofocus:()=>X,ControlledSize:()=>Y,Default:()=>V,Disabled:()=>K,FormParticipation:()=>Z,Invalid:()=>G,NoVisualLabel:()=>W,Optional:()=>J,ReadOnly:()=>q,WithHelpText:()=>U,WithPlaceholder:()=>H,__namedExportsOrder:()=>Q,default:()=>B}),L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=t((()=>{C(),u(),c(),w(),te(),{events:L,args:R,argTypes:z}=l(`w-textarea`),B={title:`Forms/Textarea`,render(e){return a`<w-textarea ${x(S(e))}></w-textarea>`},args:R,argTypes:z,parameters:{actions:{handles:L}}},V={args:{label:`Description`}},H={args:{label:`Description`,placeholder:`A Link to the Past is a distant prequel to the original The Legend of Zelda`}},U={args:{label:`Description`,"help-text":`You can provide a help text if necessary`}},W={args:{"aria-label":`Description`}},G={args:{label:`Description`,invalid:!0,"help-text":`A description is required`}},K={args:{label:`Description`,disabled:!0,value:`A Link to the Past is a distant prequel to the original The Legend of Zelda, and, within the official chronology, is the first game in the "Defeated Hero" timeline that connects to an alternate reality scenario where the Hero of Time does not succeed in Ocarina of Time.`}},q={args:{label:`Description`,"read-only":!0,value:`A Link to the Past is a distant prequel to the original The Legend of Zelda, and, within the official chronology, is the first game in the "Defeated Hero" timeline that connects to an alternate reality scenario where the Hero of Time does not succeed in Ocarina of Time.`}},J={args:{label:`Description`,optional:!0}},Y={args:{label:`Description`,"minimum-rows":3,"maximum-rows":3}},X={args:{label:`Description`,"minimum-rows":3,"maximum-rows":3,placeholder:`Refresh to see the autofocus take effect`,autofocus:!0}},Z={render:()=>a`
    <form

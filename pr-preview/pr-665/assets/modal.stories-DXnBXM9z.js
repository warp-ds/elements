import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{m as n,n as r,r as i,s as a,t as o}from"./lit-3R6oe-ov.js";import{n as ee,t as te}from"./dist-BZcjgT0h.js";import{n as ne,r as re,t as ie}from"./i18n-BwuiYdgr.js";import{a as ae,i as s,n as oe,o as c,r as se,t as l}from"./decorate-BhMxcGWK.js";import{t as ce}from"./icon-D-PPUbC2.js";import{n as u,t as d}from"./styles-Dp7yDomj.js";import{a as f,o as le}from"./iframe-BjxdUAmq.js";import{i as p,n as m,r as ue,t as de}from"./utilities-DdavuZ2J.js";function fe(e){let t=-1;e.ontouchstart=e=>{e.targetTouches.length===1&&(t=e.targetTouches[0].clientY)},e.ontouchmove=n=>{if(n.targetTouches.length!==1)return;let r=n.targetTouches[0].clientY-t;return e.scrollTop===0&&r>0||S(e)&&r<0?_(n):(n.stopPropagation(),!0)}}function pe(e){e.ontouchstart=null,e.ontouchmove=null}function me(e){if(!e)throw Error(`Could not run setup, an element must be provided`);h.some(t=>t===e)||(h.length||(y(),w()),fe(e),h.push(e))}function he(){h.forEach(pe),T(),x(),h=[]}var h,g,ge,_,v,y,b,x,S,C,w,T,_e=e((()=>{h=[],g={documentElement:{},body:{}},ge=Object.freeze({documentElement:{"scrollbar-gutter":`stable`},body:{overflow:`hidden`,position:`relative`,height:`100%`}}),_=e=>{e.touches.length>1||e.preventDefault?.()},v=e=>([t,n])=>{g[e][t]=document[e].style[t],document[e].style[t]=n},y=()=>Object.entries(ge).forEach(([e,t])=>{Object.entries(t).forEach(v(e))}),b=e=>([t,n])=>{document[e].style[t]=g[e][t]},x=()=>Object.entries(g).forEach(([e,t])=>{Object.entries(t).forEach(b(e))}),S=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight,C=e=>()=>document[e?`addEventListener`:`removeEventListener`](`touchmove`,_,{passive:!1}),w=C(!0),T=C()})),E,D,O=e((()=>{E=e=>class extends e{constructor(...e){super(...e),this.patchClose=!0,this._close=null}close(){this._close()}},D=e=>class extends e{handleSlotChange(e){let t=e.target.assignedNodes({flatten:!0});for(let e of t.filter(e=>e.patchClose))e._close=()=>this.close()}}})),k,ve=e((()=>{o(),se(),_e(),d(),O(),oe(),k=class extends D(r){constructor(){super(),this.show=!1,this.ignoreBackdropClicks=!1,this._isClosing=!1,this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`command`,e=>{let t=e.command;t===`--show-modal`?this.open():(t===`--close`||t===`--confirm`)&&this.close()})}async open(){this._isClosing=!1,this.dialogEl.classList.remove(`close`),this.dialogEl.showModal(),this.handleListeners(),me(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent(`shown`,{bubbles:!0,composed:!0}))}close(){this.dialogEl?.open&&(this._isClosing=!0,this.handleListeners(`removeEventListener`),this.dialogEl.classList.add(`close`),this.dialogEl.addEventListener(`animationend`,async e=>{e.animationName===`w-modal-out`&&this._isClosing&&(this.dialogEl.classList.remove(`close`),this.dialogEl.close(),this._isClosing=!1,he(),await this.updateComplete,this.dispatchEvent(new CustomEvent(`hidden`,{bubbles:!0,composed:!0})))},{once:!0}))}render(){return a`
    ...
    `]}},l([c({type:Boolean})],k.prototype,`show`,void 0),l([c({type:String,attribute:`content-id`})],k.prototype,`contentId`,void 0),l([c({type:Boolean,attribute:`ignore-backdrop-clicks`})],k.prototype,`ignoreBackdropClicks`,void 0),l([s(`.dialog-el`)],k.prototype,`dialogEl`,void 0),l([s(`.dialog-inner-el`)],k.prototype,`dialogInnerEl`,void 0),l([s(`.content-el`)],k.prototype,`contentEl`,void 0),customElements.get(`w-modal`)||customElements.define(`w-modal`,k)})),A,j,M,ye=e((()=>{A=(e,t)=>({dx:e.left-t.left,dy:e.top-t.top,dw:e.width/t.width,dh:e.height/t.height,first:e,last:t}),j=({dx:e,dy:t})=>[{transform:`translate(${e}px, ${t}px)`},{transform:`none`}],M={easing:`ease`,duration:300}})),N,be=e((()=>{if(N=!1,typeof window<`u`){let e=window.matchMedia(`(prefers-reduced-motion: reduce)`),t=({matches:e})=>N=e;e.addEventListener&&e.addEventListener(`change`,t),t(e)}})),P,xe=e((()=>{ye(),be(),P=class{first;last;el;constructor(e,{animation:t={},keyframes:n,respectReduceMotion:r=!0}={}){this.el=e,this.first={},this.last={},this.userAnimationOptions=t,this.keyframeGenerator=n||j,this.shouldReduceMotion=r}async when(e){this.prep();let t=await e();return await this.play(),t}prep(){this.first=this.el.getBoundingClientRect()}async play(){this.last=this.el.getBoundingClientRect(),this.el.animate&&await this.el.animate(this.keyframes,this.animationOptions).finished}get keyframes(){return this.keyframeGenerator(A(this.first,this.last))}get defaults(){return M}get mergedOptions(){return{...this.defaults,...this.userAnimationOptions}}get animationOptions(){return!this.shouldReduceMotion||!N?this.mergedOptions:{...this.mergedOptions,duration:0}}}})),F,Se=e((()=>{F=JSON.parse(`{"modal.aria.back":["Tilbage"],"modal.aria.close":["Luk"]}`)})),I,Ce=e((()=>{I=JSON.parse(`{"modal.aria.back":["Back"],"modal.aria.close":["Close"]}`)})),L,we=e((()=>{L=JSON.parse(`{"modal.aria.back":["Takaisin"],"modal.aria.close":["Sulje"]}`)})),R,Te=e((()=>{R=JSON.parse(`{"modal.aria.back":["Tilbake"],"modal.aria.close":["Lukk"]}`)})),z,Ee=e((()=>{z=JSON.parse(`{"modal.aria.back":["Tillbaka"],"modal.aria.close":["Stäng"]}`)})),B,De=e((()=>{xe(),ee(),o(),se(),ce(),re(),Se(),Ce(),we(),Te(),Ee(),O(),d(),oe(),B=class extends E(r){constructor(){super(),this.back=!1,this.noClose=!1,this._hasTopContent=!1,ie(I,R,L,F,z)}render(){return a`
      <div class="header">
    ...
    `}async willUpdate(e){if(e.has(`back`)){if(!this.titleEl)return;new P(this.titleEl).when(async()=>{await this.updateComplete})}}get titleClasses(){return[`header-title`,this.back?`header-title-with-back-button`:`header-title-without-back-button`,this._hasTopContent?`header-title-with-top-area`:``].join(` `)}get backButton(){return this.back&&!this._hasTopContent?a`<button
          type="button"
          title=""
          aria-label="${te._({id:`modal.aria.back`,message:`Back`,comment:`Aria label for the back button in modal`})}"
          class="header-button header-button-left"
          @click="${this.emitBack}">
          <w-icon name="ArrowLeft" size="small" locale="${ne()}" style="display: flex;" class="flex"></w-icon>
        </button>`:i}get closeButton(){return this.noClose?i:a`<div class="header-close-button-container">
        <w-button
            type="button"
            title=""
            aria-label="${te._({id:`modal.aria.close`,message:`Close`,comment:`Aria label for the close button in modal`})}"
            variant="pill"
            small=""
            @click="${this.close}">
                <w-icon name="Close" size="small" locale="${ne()}" style="display: flex;" class="flex"></w-icon>
        </w-button>
    </div>`}emitBack(){this.dispatchEvent(new CustomEvent(`backClicked`,{bubbles:!0,composed:!0}))}handleTopSlotChange(e){let t=e.target.assignedElements({flatten:!0});this._hasTopContent=!!t.length}static{this.styles=[u,n`
      .header {
        position: relative;
    ...
    `]}},l([c({type:String})],B.prototype,`title`,void 0),l([c({type:Boolean})],B.prototype,`back`,void 0),l([c({type:Boolean,attribute:`no-close`})],B.prototype,`noClose`,void 0),l([ae()],B.prototype,`_hasTopContent`,void 0),l([s(`.title-el`)],B.prototype,`titleEl`,void 0),customElements.get(`w-modal-header`)||customElements.define(`w-modal-header`,B)})),V,Oe=e((()=>{o(),O(),d(),V=class extends E(D(r)){render(){return a`
      <div class="footer">
        <slot @slotchange="${this.handleSlotChange}"></slot>
      </div>
    `}static{this.styles=[u,n`
      .footer {
        display: flex;
        flex-shrink: 0;
    ...
    `]}},customElements.get(`w-modal-footer`)||customElements.define(`w-modal-footer`,V)})),ke=t({Default:()=>q,InvokerCommands:()=>J,Modal:()=>X,ModalFooter:()=>Q,ModalHeader:()=>Z,WithImage:()=>Y,__namedExportsOrder:()=>$,default:()=>K}),H,U,W,G,Ae,je,Me,Ne,Pe,K,q,J,Y,X,Z,Q,$,Fe=e((()=>{ue(),le(),o(),de(),ve(),De(),Oe(),{events:H,args:U,argTypes:W}=f(`w-modal`),{events:G,args:Ae,argTypes:je}=f(`w-modal-header`),{events:Me,args:Ne,argTypes:Pe}=f(`w-modal-footer`),K={title:`Overlays/Modal`},q={args:{},render(){return a`
    ...
    `},parameters:{docs:{story:{autoplay:!0}}}},Y={args:{},render(){return a`
...
}`,...Q.parameters?.docs?.source}}},$=[`Default`,`InvokerCommands`,`WithImage`,`Modal`,`ModalHeader`,`ModalFooter`]}));Fe();export{q as Default,J as InvokerCommands,X as Modal,Q as ModalFooter,Z as ModalHeader,Y as WithImage,$ as __namedExportsOrder,K as default,ke as n,Fe as t};
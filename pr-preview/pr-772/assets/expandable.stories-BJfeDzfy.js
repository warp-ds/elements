import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{f as n,y as r}from"./decorate-D-MUTuIl.js";import{n as i,t as a}from"./dist-CXTYkVAl.js";import{i as o,n as s,r as c}from"./utilities-C5YHrCuy.js";import{t as l}from"./expand-transition-SneieoSM.js";import{t as u}from"./button-znQbI9Qa.js";import{t as d}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as f,t as p}from"./expandable-tMun13gC.js";var m=t({Animated:()=>T,Box:()=>S,BoxBleed:()=>C,CustomTitle:()=>O,Default:()=>b,DefaultWithDivider:()=>w,DeprecatedFlagsCompatibility:()=>j,Expanded:()=>x,NoChevron:()=>D,NoTitle:()=>k,StylingApi:()=>A,WithHeading:()=>E,__namedExportsOrder:()=>M,default:()=>y}),h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;function N(){return(N=e((()=>{c(),i(),n(),u(),l(),f(),p(),{events:g,args:_,argTypes:v}=a(`w-expandable`),y={title:`Layout/Expandable`,render(e){return r`
            <w-expandable ${o(s(e))}>

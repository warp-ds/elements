import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{C as t,f as n,p as r,r as i,s as a,t as o,y as s}from"./decorate-D-MUTuIl.js";import{n as c,r as l}from"./i18n-CkjYRTT1.js";import{i as u,o as d}from"./dist-CXTYkVAl.js";import{t as f}from"./icon-DmyEA4mQ.js";import{n as p,t as m}from"./styles-Dxzaq_l3.js";import{r as h,t as g}from"./if-defined-CDQgRpqn.js";import{t as _}from"./expand-transition-SneieoSM.js";var v;function y(){return(y=e((()=>{n(),u(),v=class extends r{static properties={level:{type:Number}};get _markup(){return`<h${this.level}
    style="margin: 0; font-weight: unset; font-size: unset; line-height: unset;"
  >
    <slot></slot>
  </h${this.level}>
`}render(){return this.level?d(this._markup):s`<slot></slot>`}},customElements.get(`w-unstyled-heading`)||customElements.define(`w-unstyled-heading`,v)})))()}var b;function x(){return(x=e((()=>{n(),b=t`
	:host {
		display: block;
...
`})))()}var S;function C(){return(C=e((()=>{n(),i(),g(),f(),_(),l(),y(),m(),x(),S=class extends r{constructor(...e){super(...e),this.expanded=!1,this.variant=`default`,this.box=!1,this.bleed=!1,this.noChevron=!1,this.animated=!1,this._hasTitle=!0,this._showChevronUp=!1}static{this.styles=[p,b]}updated(e){e.has(`expanded`)&&setTimeout(()=>{this._showChevronUp=this.expanded},200)}firstUpdated(){let e=!!this.title,t=this.renderRoot.querySelector(`slot[name='title']`)?.assignedNodes().length>0;this._hasTitle=e||t}get#e(){let e=c();return this._showChevronUp?s`<w-icon
				...
				></w-icon>`:s`<w-icon
					...
					size="small"
					locale="${e}"
				></w-icon>`}get _expandableSlot(){let e=this.contentClass?`content ${this.contentClass}`:`content`;return s`<div
			class=${e}
			data-has-title=${h(this._hasTitle?``:void 0)}
		>
			<slot></slot>
		</div>`}render(){let e=this.buttonClass?`button ${this.buttonClass}`:`button`;return s` <div part="base">
			${this._hasTitle?s`<w-unstyled-heading level=${h(this.headingLevel)}>
							<button
								class=${e}
								type="button"
							...
							>
								<div class="title">
									${this.title?s`<span class="title-text">${this.title}</span>`:s`<slot class="title-text" name="title"></slot>`}
									${this.noChevron?``:s`<div part="chevron">${this.#e}</div>`}
								</div>
							</button>
						</w-unstyled-heading>`:``}
			${this.animated?s`<w-expand-transition class="expansion" ?show=${this.expanded}>
							${this._expandableSlot}
						</w-expand-transition>`:s`<div
							class="expansion"

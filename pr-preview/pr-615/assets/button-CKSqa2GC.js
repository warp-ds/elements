import{n as e}from"./chunk-DnJy8xQt.js";import{m as t,n,r,s as i,t as a}from"./lit-JruGAyH3.js";import{n as o,t as s}from"./dist-BZcjgT0h.js";import{r as c,t as l}from"./i18n-BwuiYdgr.js";import{i as u,n as d,o as f,r as p,t as m}from"./decorate-CDMjP9kV.js";import{n as h,t as g}from"./styles-DphVJT09.js";import{n as _,t as v}from"./form-control-CGD42XQP.js";import{n as y,t as b}from"./if-defined-BruKJeYQ.js";import{t as x}from"./link-Dz0UzrM1.js";var S,C=e((()=>{S=JSON.parse(`{"button.aria.loading":["Indlæser..."]}`)})),w,T=e((()=>{w=JSON.parse(`{"button.aria.loading":["Loading..."]}`)})),E,D=e((()=>{E=JSON.parse(`{"button.aria.loading":["Ladataan..."]}`)})),O,k=e((()=>{O=JSON.parse(`{"button.aria.loading":["Laster..."]}`)})),A,j=e((()=>{A=JSON.parse(`{"button.aria.loading":["Laddar ..."]}`)})),M,N=e((()=>{a(),M=t`
  :host {
...
`})),P,F,I=e((()=>{o(),v(),a(),p(),c(),x(),b(),g(),C(),T(),D(),k(),j(),N(),d(),P=[`primary`,`secondary`,`negative`,`negativeQuiet`,`utility`,`pill`,`link`,`quiet`,`utilityQuiet`,`overlay`,`overlayInverted`,`overlayQuiet`,`overlayInvertedQuiet`],F=class extends _(n){static{this.styles=[h,M]}static{this.shadowRootOptions={...n.shadowRootOptions,delegatesFocus:!0}}#e;updated(e){e.has(`value`)&&this.setValue(this.value)}constructor(){super(),this.autofocus=!1,this.quiet=!1,this.iconOnly=!1,this.small=!1,this.loading=!1,this.disabled=!1,this.fullWidth=!1,this.#e=null,l(w,O,E,S,A),this.ariaValueTextLoading=s.t({id:`button.aria.loading`,message:`Loading...`,comment:`Screen reader message for buttons that are loading`})}connectedCallback(){super.connectedCallback();let e=this.variant||`secondary`;if(!P.includes(e))throw Error(`Invalid "variant" attribute. Set its value to one of the following:\n${P.join(`, `)}.`);this.#e=this.value}closestWithId(e){let t=this.shadowRoot,n=null;try{for(;t;){if(n=t.getElementById(e),n)return n;t=t.getRootNode().host?.getRootNode()}}catch{}return document.getElementById(e)}firstUpdated(){this.autofocus&&!this.href&&setTimeout(()=>this.focus(),0),this.buttonEl&&this.commandfor&&(this.buttonEl.commandForElement=this.closestWithId(this.commandfor))}_handleButtonClick(){this.type===`submit`?this.internals.form.requestSubmit():this.type===`reset`&&this.internals.form.reset()}resetFormControl(){this.value=this.#e}render(){let e=this.variant||`secondary`;return i` ${this.href?i`
    ...
    ${this.loading?i`<span
        ...
        ></span>`:r}`}},m([f({reflect:!0})],F.prototype,`type`,void 0),m([f({type:Boolean,reflect:!0})],F.prototype,`autofocus`,void 0),m([f({reflect:!0})],F.prototype,`variant`,void 0),m([f({type:Boolean,reflect:!0})],F.prototype,`quiet`,void 0),m([f({type:Boolean,reflect:!0,attribute:`icon-only`})],F.prototype,`iconOnly`,void 0),m([f({type:Boolean,reflect:!0})],F.prototype,`small`,void 0),m([f({type:Boolean,reflect:!0})],F.prototype,`loading`,void 0),m([f({reflect:!0})],F.prototype,`href`,void 0),m([f({reflect:!0})],F.prototype,`target`,void 0),m([f({type:Boolean,reflect:!0})],F.prototype,`disabled`,void 0),m([f({reflect:!0})],F.prototype,`rel`,void 0),m([f({attribute:`full-width`,type:Boolean,reflect:!0})],F.prototype,`fullWidth`,void 0),m([f({attribute:`button-class`,reflect:!0})],F.prototype,`buttonClass`,void 0),m([f({reflect:!0})],F.prototype,`name`,void 0),m([f({reflect:!0})],F.prototype,`value`,void 0),m([f()],F.prototype,`commandfor`,void 0),m([f()],F.prototype,`command`,void 0),m([u(`button`)],F.prototype,`buttonEl`,void 0),customElements.get(`w-button`)||customElements.define(`w-button`,F)}));export{I as t};
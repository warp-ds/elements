import{n as e}from"./chunk-BneVvdWh.js";import{m as t,n,s as r,t as i}from"./lit-C07f_Bua.js";import{n as a,t as o}from"./dist-WJrQKcXy.js";import{n as s,t as c}from"./dist-B1PfYo3w.js";import{r as l,t as u}from"./i18n-Cuvpc9VM.js";import{a as d,n as f,o as p,r as m,t as h}from"./decorate-IReCy4XP.js";import{n as ee,t as te}from"./styles-BM5RxtAH.js";import{i as ne,n as re,r as ie,t as ae}from"./utilities-pbJZRFp6.js";import{n as g,t as oe}from"./if-defined-YNORsBYI.js";import{n as se,t as _}from"./form-control-DxmguQIf.js";var v,y=e((()=>{i(),v=t`
  :host {
      ...
      <fieldset
        ...
        ${n?r`
              <label part="form-control-label" id="label" @click=${this.handleLabelClick}>
                ...
                ${this.optional?r`<span class="optional">
                      ${c._({id:`radio-group.label.optional`,message:`Optional`,comment:`Shown behind label when marked as optional`})}
                    </span>`:null}
              </label>
            `:null}
        ...
        ${l?r`
              <div id="help-text" part="help-text" aria-label=${g(f)}>
                <slot name="help-text" @slotchange=${this.handleHelpTextSlotChange}>${s}</slot>
              </div>
            `:null}
      </fieldset>
    `}},h([d()],A.prototype,`hasInteracted`,void 0),h([p()],A.prototype,`label`,void 0),h([p({attribute:`help-text`})],A.prototype,`helpText`,void 0),h([p({type:Boolean,reflect:!0})],A.prototype,`optional`,void 0),h([p({type:Boolean,reflect:!0})],A.prototype,`invalid`,void 0),h([p({reflect:!0})],A.prototype,`name`,void 0),h([p({type:Boolean,reflect:!0})],A.prototype,`disabled`,void 0),h([p({type:Boolean,reflect:!0})],A.prototype,`required`,void 0),customElements.get(`w-radio-group`)||customElements.define(`w-radio-group`,A)})),ge,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,_e;e((()=>{ie(),a(),i(),ae(),S(),he(),{args:ge}=o(`w-radio-group`),j={title:`Forms/Radio`,render:e=>r`
      <w-radio-group ${ne(re(e))}>
        <w-radio value="foo" checked>foo</w-radio>
        <w-radio value="bar">bar</w-radio>
      </w-radio-group>
    `},M={args:{label:`Group`,name:`foobar`}},N={args:{},render(){return r` <w-radio value="single">Single radio</w-radio> `}},P={args:{},render(){return r` <w-radio value="single" invalid>Single invalid radio</w-radio> `}},F={args:{},render(){return r` <w-radio value="single" disabled>Single disabled radio</w-radio> `}},I={args:{},render(){return r`

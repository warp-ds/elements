import{n as e,r as t}from"./chunk-BneVvdWh.js";import{m as n,n as r,r as i,s as a,t as o}from"./lit-C07f_Bua.js";import{n as ee,t as s}from"./dist-WJrQKcXy.js";import{n as te,t as c}from"./dist-B1PfYo3w.js";import{n as l,r as ne,t as re}from"./i18n-Cuvpc9VM.js";import{a as ie,i as u,n as ae,o as d,r as oe,t as f}from"./decorate-IReCy4XP.js";import{t as se}from"./icon-ClYvBfoS.js";import{n as p,t as m}from"./styles-BM5RxtAH.js";import{i as h,n as g,r as ce,t as le}from"./utilities-pbJZRFp6.js";function ue(e){let t=-1;e.ontouchstart=e=>{e.targetTouches.length===1&&(t=e.targetTouches[0].clientY)},e.ontouchmove=n=>{if(n.targetTouches.length!==1)return;let r=n.targetTouches[0].clientY-t;return e.scrollTop===0&&r>0||ge(e)&&r<0?b(n):(n.stopPropagation(),!0)}}function de(e){e.ontouchstart=null,e.ontouchmove=null}function fe(e){if(!e)throw Error(`Could not run setup, an element must be provided`);_.some(t=>t===e)||(_.length||(S(),w()),ue(e),_.push(e))}function pe(){_.forEach(de),T(),he(),_=[]}var _,v,y,b,x,S,me,he,ge,C,w,T,_e=e((()=>{_=[],v={documentElement:{},body:{}},y=Object.freeze({documentElement:{"scrollbar-gutter":`stable`},body:{overflow:`hidden`,position:`relative`,height:`100%`}}),b=e=>{e.touches.length>1||e.preventDefault?.()},x=e=>([t,n])=>{v[e][t]=document[e].style[t],document[e].style[t]=n},S=()=>Object.entries(y).forEach(([e,t])=>{Object.entries(t).forEach(x(e))}),me=e=>([t,n])=>{document[e].style[t]=v[e][t]},he=()=>Object.entries(v).forEach(([e,t])=>{Object.entries(t).forEach(me(e))}),ge=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight,C=e=>()=>document[e?`addEventListener`:`removeEventListener`](`touchmove`,b,{passive:!1}),w=C(!0),T=C()})),E,D,O=e((()=>{E=e=>class extends e{constructor(...e){super(...e),this.patchClose=!0,this._close=null}close(){this._close()}},D=e=>class extends e{handleSlotChange(e){let t=e.target.assignedNodes({flatten:!0});for(let e of t.filter(e=>e.patchClose))e._close=()=>this.close()}}})),k,ve=e((()=>{o(),oe(),_e(),m(),O(),ae(),k=class extends D(r){constructor(){super(),this.show=!1,this.ignoreBackdropClicks=!1,this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}async open(){this.dialogEl.showModal(),this.handleListeners(),fe(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent(`shown`,{bubbles:!0,composed:!0}))}close(){this.dialogEl?.open&&(this.handleListeners(`removeEventListener`),this.dialogEl.classList.add(`close`),this.dialogEl.addEventListener(`animationend`,async()=>{this.dialogEl.classList.remove(`close`),this.dialogEl.close(),pe(),await this.updateComplete,this.dispatchEvent(new CustomEvent(`hidden`,{bubbles:!0,composed:!0}))},{once:!0}))}render(){return a`
    ...
    `}async willUpdate(e){if(e.has(`back`)){if(!this.titleEl)return;new P(this.titleEl).when(async()=>{await this.updateComplete})}}get titleClasses(){return[`header-title`,this.back?`header-title-with-back-button`:`header-title-without-back-button`,this._hasTopContent?`header-title-with-top-area`:``].join(` `)}get backButton(){return this.back&&!this._hasTopContent?a`<button
          ...
          @click="${this.emitBack}">
          <w-icon name="ArrowLeft" size="small" locale="${l()}" style="display: flex;" class="flex"></w-icon>
    ...
    `]}},f([d({type:String})],B.prototype,`title`,void 0),f([d({type:Boolean})],B.prototype,`back`,void 0),f([d({type:Boolean,attribute:`no-close`})],B.prototype,`noClose`,void 0),f([ie()],B.prototype,`_hasTopContent`,void 0),f([u(`.title-el`)],B.prototype,`titleEl`,void 0),customElements.get(`w-modal-header`)||customElements.define(`w-modal-header`,B)})),V,Oe=e((()=>{o(),O(),m(),V=class extends E(D(r)){render(){return a`
      <div class="footer">

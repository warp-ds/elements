...
negative, positive, warning, info.`)}get _wrapperClasses(){let e=this.variant;return m([T.wrapper,T[e]])}get _iconClasses(){let e=this.variant,t=T[`${e}Icon`];return m([T.icon,t])}static{this.styles=[_,C,l`
        ...
        `}},z=[`Info`,`Warning`,`Negative`,`Positive`,`WithDescription`],P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
  args: {
    variant: "info",
    show: true,
    role: "alert"
...
}`,...R.parameters?.docs?.source}}}})))()}export{R as a,F as i,I as n,k as o,L as r,B as s,P as t};
...
`})))()}var V;function H(){return(H=e((()=>{n(),o(),B(),v(),V=class extends a{constructor(...e){super(...e),this.currentPage=!1,this.href=null}static{this.styles=[_,z]}get link(){return this.href?i`<a
					part="link"
					class="s-text-link"
					href=${this.href}
				...
				></span>`}get separator(){return this.currentPage?r:i`<span part="separator" class="separator" aria-hidden="true"
					>/</span
				>`}render(){return i`${this.link}${this.separator}`}},c([s({type:Boolean,attribute:`current-page`})],V.prototype,`currentPage`,void 0),c([s({type:String})],V.prototype,`href`,void 0),customElements.get(`w-breadcrumb-item`)||customElements.define(`w-breadcrumb-item`,V)})))()}var U=t({Default:()=>q,WithLinks:()=>J,WithSpanForCurrentPage:()=>Y,__namedExportsOrder:()=>X,default:()=>K}),W,G,K,q,J,Y,X;function Z(){return(Z=e((()=>{x(),h(),n(),R(),H(),{events:W,argTypes:G}=g(`w-breadcrumbs`),K={title:`Navigation/Breadcrumbs`,render(e){return i`
            <w-breadcrumbs ${y(b(e))}>
        ...
        `},args:{"aria-label":`You are here`},argTypes:G,parameters:{actions:{handles:W}}},q={},J={render(e){return i`
            <w-breadcrumbs ${y(b(e))}>
                <w-breadcrumb-item href="#/home">Home</w-breadcrumb-item>
                <w-breadcrumb-item href="#/category">Category</w-breadcrumb-item>

import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,c as n,h as r,l as i,r as a,s as o,t as s,x as ee}from"./decorate-J4WBtiHw.js";import{a as c,o as l,r as u,t as d}from"./i18n-CkjYRTT1.js";import{n as f,t as te}from"./dist-DYA0KhTf.js";import{n as p,t as m}from"./index.m-DHqwZk2H.js";import{n as ne,t as re}from"./styles-CYn3YYhE.js";import{n as ie,t as ae}from"./repeat-Ce7G-pnG.js";import{i as oe,n as h,r as g}from"./utilities-DhdP2kMI.js";import{n as _,t as v}from"./FormControlMixin-BCJbRrUC.js";import{r as y,t as se}from"./if-defined-hoo3qVMT.js";import{t as ce}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{t as b}from"./textfield-DxWoQ9fM.js";var x;function S(){return(S=e((()=>{x=JSON.parse(`{"combobox.aria.noResults":["Ingen resultater"],"combobox.aria.noSuggestions":["Ingen forslag"],"combobox.aria.pluralResults":[["numResults","plural",{"one":["#"," resultat"],"other":["#"," resultater"]}]],"combobox.aria.pluralSuggestions":[["numSuggestions","plural",{"one":["#"," forslag"],"other":["#"," forslag"]}]]}`)})))()}var C;function w(){return(w=e((()=>{C=JSON.parse(`{"combobox.aria.noResults":["No results"],"combobox.aria.noSuggestions":["No suggestions"],"combobox.aria.pluralResults":[["numResults","plural",{"one":["#"," result"],"other":["#"," results"]}]],"combobox.aria.pluralSuggestions":[["numSuggestions","plural",{"one":["#"," suggestion"],"other":["#"," suggestions"]}]]}`)})))()}var T;function E(){return(E=e((()=>{T=JSON.parse(`{"combobox.aria.noResults":["Ei tuloksia"],"combobox.aria.noSuggestions":["Ei ehdotuksia"],"combobox.aria.pluralResults":[["numResults","plural",{"one":["#"," tulos"],"other":["#"," tulosta"]}]],"combobox.aria.pluralSuggestions":[["numSuggestions","plural",{"one":["#"," ehdotus"],"other":["#"," ehdotusta"]}]]}`)})))()}var D;function O(){return(O=e((()=>{D=JSON.parse(`{"combobox.aria.noResults":["Ingen resultater"],"combobox.aria.noSuggestions":["Ingen forslag"],"combobox.aria.pluralResults":[["numResults","plural",{"one":["#"," resultat"],"other":["#"," resultater"]}]],"combobox.aria.pluralSuggestions":[["numSuggestions","plural",{"one":["#"," forslag"],"other":["#"," forslag"]}]]}`)})))()}var k;function A(){return(A=e((()=>{k=JSON.parse(`{"combobox.aria.noResults":["Inga resultat"],"combobox.aria.noSuggestions":["Inga förslag"],"combobox.aria.pluralResults":[["numResults","plural",{"one":["#"," resultat"],"other":["#"," resultat"]}]],"combobox.aria.pluralSuggestions":[["numSuggestions","plural",{"one":["#"," förslag"],"other":["#"," förslag"]}]]}`)})))()}var j;function M(){return(M=e((()=>{n(),j=ee(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.rounded-8{border-radius:8px}.block{display:block}.overflow-hidden{overflow:hidden}.list-none{list-style-type:none}.left-0{left:0}.right-0{right:0}.absolute{position:absolute}.relative{position:relative}.static{position:static}.z-0{z-index:0}.z-20{z-index:20}.s-bg{background-color:var(--w-s-color-background)}.s-bg-selected{background-color:var(--w-s-color-background-selected)}.hover\\:s-bg-hover:hover{background-color:var(--w-s-color-background-hover)}.hover\\:s-bg-selected-hover:hover{background-color:var(--w-s-color-background-selected-hover)}.shadow-m{box-shadow:var(--w-shadow-m)}.m-0{margin:0}.p-0{padding:0}.p-8{padding:.8rem}.pb-4{padding-bottom:.4rem}.visible{visibility:visible}.cursor-pointer{cursor:pointer}.font-bold{font-weight:700}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}.select-none{-webkit-user-select:none;user-select:none}`)})))()}var N,P;function F(){return(F=e((()=>{m(),l(),_(),n(),a(),ae(),se(),u(),re(),S(),w(),E(),O(),A(),M(),N={wrapper:`relative z-0`,base:`absolute z-20 left-0 right-0 s-bg pb-4 rounded-8 overflow-hidden shadow-m`,listbox:`m-0 p-0 select-none list-none`,option:`block cursor-pointer p-8`,optionUnselected:`hover:s-bg-hover`,optionSelected:`s-bg-selected hover:s-bg-selected-hover`,textMatch:`font-bold`,a11y:`sr-only`},P=class extends v(i){static{this.styles=[ne,j]}constructor(){super(),this.options=[],this.label=``,this.placeholder=``,this.value=``,this.openOnFocus=!1,this.selectOnBlur=!0,this.matchTextSegments=!1,this.disableStaticFiltering=!1,this.invalid=!1,this.helpText=``,this.disabled=!1,this.required=!1,this.optional=!1,this.name=``,this.autocomplete=`off`,this._isOpen=!1,this._navigationOption=null,this._currentOptions=[],this._lightDomOptions=[],this._optionIdCounter=0,this._displayValue=``,this.#e=``,d(C,D,T,x,k)}#e;#t;firstUpdated(){this.#e=this.value}updated(e){e.has(`value`)&&this.setValue(this.value)}resetFormControl(){this.value=this.#e}connectedCallback(){super.connectedCallback(),this.#r(),this.#t=new MutationObserver(()=>{this.#r()}),this.#t.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`label`,`value`]})}disconnectedCallback(){super.disconnectedCallback(),this.#t?.disconnect()}get _listboxId(){return`${this._id}-listbox`}get _id(){return`combobox`}get _helpId(){return this.helpText?`${this._id}__hint`:void 0}get _sourceOptions(){return Array.isArray(this.options)&&this.options.length?this.options:this._lightDomOptions}get _navigationLabelOrDisplayValue(){return this._navigationOption?this._navigationOption.label||this._navigationOption.value:this._displayValue}get _navigationValueOrInputValue(){return this._navigationOption?.value||this.value}_createOptionsWithIdAndMatch(e,t){return e.map((e,n)=>({...e,id:`${this._id}-option-${this._optionIdCounter+n}`,key:e.key||e.value,currentInputValue:t}))}#n(){return[...this.children].filter(e=>e.tagName.toLowerCase()===`option`)}#r(){this._lightDomOptions=this.#n().map(e=>{let t=e.getAttribute(`value`)??``;return{value:t,label:e.hasAttribute(`label`)?e.getAttribute(`label`)??``:e.textContent??``,key:t}})}_getAriaText(e,t,n){if(!e||!n)return``;let r=e.filter(e=>(e.label||e.value).toLowerCase().includes(t.toLowerCase())),i=c._({id:`combobox.aria.pluralSuggestions`,message:`{numSuggestions, plural, one {# suggestion} other {# suggestions}}`,comment:`Aria text for combobox when there are one or more suggestions`,values:{numSuggestions:r.length}}),a=c._({id:`combobox.aria.noSuggestions`,message:`No suggestions`,comment:`Aria text for combobox when no suggestions`});return r.length?i:a}_getOptionClasses(e){return p(N.option,this._navigationOption?.id===e?.id?N.optionSelected:N.optionUnselected)}_handleKeyDown(e){let t=[`ArrowDown`,`ArrowUp`,`PageUp`,`PageDown`,`Home`,`End`].includes(e.key),n=[`ArrowDown`,`ArrowLeft`,`ArrowUp`,`ArrowRight`];if(t&&!this._isOpen){this._isOpen=!0;return}if(t&&this._isOpen){this._findAndSetActiveOption(e);return}if(!(e.altKey||e.ctrlKey||e.metaKey||e.shiftKey))switch(e.key){case`Enter`:this._navigationOption&&(e.preventDefault(),this._handleSelect(this._navigationOption),requestAnimationFrame(()=>{let e=(this.shadowRoot?.querySelector(`w-textfield`))?.shadowRoot?.querySelector(`input`);e&&(e.value=this._displayValue)})),this._isOpen=!1;break;case`Tab`:case`Delete`:this._isOpen=!1;break;case`Escape`:this._isOpen?this._isOpen=!1:this._handleChange(``),this._navigationOption=null;break;case`Backspace`:this._handleChange(this._navigationLabelOrDisplayValue),this._navigationOption=null,this._isOpen=!0;break;default:if(n.includes(e.key))break;this._isOpen=!0,this._navigationOption?(this._handleChange(this._navigationOption.value),this._navigationOption=null):this._handleChange(this.value)}}_findAndSetActiveOption(e){e.preventDefault();let t=this._currentOptions.findIndex(e=>e.id===this._navigationOption?.id),n=t+1,r=t-1;switch(e.key){case`ArrowDown`:this._navigationOption=n>this._currentOptions.length-1?null:this._currentOptions[n];break;case`ArrowUp`:this._navigationOption=r===-2?this._currentOptions.at(-1)??null:r<0?null:this._currentOptions[r];break;case`PageUp`:this._navigationOption=t-10<0?this._currentOptions[0]:this._currentOptions[t-10];break;case`PageDown`:this._navigationOption=t+10>this._currentOptions.length-1?this._currentOptions.at(-1)??null:this._currentOptions[t+10]??null;break;case`Home`:this._navigationOption=this._currentOptions[0];break;case`End`:this._navigationOption=this._currentOptions.at(-1)??null}}_handleSelect(e){this.value=e.value,this._displayValue=e.label||e.value,this.setValue(this.value);let t=new CustomEvent(`select`,{detail:{value:e.value},bubbles:!0,composed:!0});this.dispatchEvent(t),this._isOpen=!1,this._navigationOption=null,this.disableStaticFiltering&&(this._currentOptions=[])}_handleChange(e){if(e===void 0)return;this.value=e,this._displayValue=e;let t=new CustomEvent(`change`,{detail:{value:e},bubbles:!0,composed:!0});this.dispatchEvent(t)}_handleFocus(){if(!this.openOnFocus)return;let e=new CustomEvent(`focus`,{bubbles:!0,composed:!0});this.dispatchEvent(e),this._isOpen=!0}_handleBlur(e){let t=e.relatedTarget;if(t&&this.shadowRoot?.contains(t))return;if(this._isOpen=!1,this.selectOnBlur&&(this._navigationOption||!this._navigationOption&&this._currentOptions.findIndex(e=>e.value===this.value)!==-1)){let e=this._navigationOption?.value||this.value;this.value=e;let t=new CustomEvent(`select`,{detail:{value:e},bubbles:!0,composed:!0});this.dispatchEvent(t)}this._navigationOption=null;let n=new CustomEvent(`blur`,{detail:{value:this._navigationValueOrInputValue},bubbles:!0,composed:!0});this.dispatchEvent(n)}_handleOptionClick(e,t){this._handleSelect(t),requestAnimationFrame(()=>{let e=(this.shadowRoot?.querySelector(`w-textfield`))?.shadowRoot?.querySelector(`input`);e&&(e.value=t.label||t.value)})}_handleContainerBlur(e){(!e.currentTarget||!e.currentTarget.contains(e.relatedTarget))&&(this._isOpen=!1)}_renderTextMatch(e,t){if(!this.matchTextSegments)return e;let n=e.toLowerCase().indexOf(t.currentInputValue.toLowerCase());if(n!==-1){let i=n+t.currentInputValue.length;return r`${e.substring(0,n)}<span
		...
		`}},s([o({type:Array})],P.prototype,`options`,void 0),s([o({type:String,reflect:!0,useDefault:!0})],P.prototype,`label`,void 0),s([o({type:String,reflect:!0,useDefault:!0})],P.prototype,`placeholder`,void 0),s([o({type:String,reflect:!0,useDefault:!0})],P.prototype,`value`,void 0),s([o({type:Boolean,attribute:`open-on-focus`,reflect:!0})],P.prototype,`openOnFocus`,void 0),s([o({type:Boolean,attribute:`select-on-blur`,reflect:!0,useDefault:!0})],P.prototype,`selectOnBlur`,void 0),s([o({type:Boolean,attribute:`match-text-segments`,reflect:!0})],P.prototype,`matchTextSegments`,void 0),s([o({type:Boolean,attribute:`disable-static-filtering`,reflect:!0})],P.prototype,`disableStaticFiltering`,void 0),s([o({type:Boolean,reflect:!0})],P.prototype,`invalid`,void 0),s([o({type:String,attribute:`help-text`,reflect:!0,useDefault:!0})],P.prototype,`helpText`,void 0),s([o({type:Boolean,reflect:!0})],P.prototype,`disabled`,void 0),s([o({type:Boolean,reflect:!0})],P.prototype,`required`,void 0),s([o({type:Boolean,reflect:!0})],P.prototype,`optional`,void 0),s([o({type:String,reflect:!0,useDefault:!0})],P.prototype,`name`,void 0),s([o({type:String,reflect:!0,useDefault:!0})],P.prototype,`autocomplete`,void 0),s([t()],P.prototype,`_isOpen`,void 0),s([t()],P.prototype,`_navigationOption`,void 0),s([t()],P.prototype,`_currentOptions`,void 0),s([t()],P.prototype,`_lightDomOptions`,void 0),s([t()],P.prototype,`_optionIdCounter`,void 0),s([t()],P.prototype,`_displayValue`,void 0),customElements.get(`w-combobox`)||customElements.define(`w-combobox`,P)})))()}var I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{g(),f(),n(),F(),b(),{events:L,args:R,argTypes:z}=te(`w-combobox`),B={title:`Forms/Combobox`,component:`w-combobox`,render(e){return r`
            <w-combobox ${oe(h(e))}>
                ${H}
            </w-combobox>
...
`,U={args:{},render:()=>r`
  ...
  render: () => html\`
    ...
    \`
}`,...Z.parameters?.docs?.source}}},Q=[`Default`,`WithValue`,`OpenOnFocus`,`WithTextMatching`,`Invalid`,`Disabled`,`Optional`,`DisableStaticFiltering`,`FormSubmission`]})))()}$();export{U as Default,X as DisableStaticFiltering,J as Disabled,Z as FormSubmission,q as Invalid,G as OpenOnFocus,Y as Optional,K as WithTextMatching,W as WithValue,Q as __namedExportsOrder,B as default};
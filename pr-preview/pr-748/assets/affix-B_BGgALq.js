import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{c as t,h as n,l as r,r as i,s as a,t as o,x as s,y as c}from"./decorate-J4WBtiHw.js";import{a as l,n as u,o as d,r as f}from"./i18n-CkjYRTT1.js";import{n as p,t as m}from"./index.m-DHqwZk2H.js";import{t as h}from"./icon-oWwEbYYO.js";import{n as g,t as _}from"./styles-CYn3YYhE.js";import{n as v,t as y}from"./FormControlMixin-BCJbRrUC.js";var b;function x(){return(x=e((()=>{t(),b=c`
...
`})))()}var S;function C(){return(C=e((()=>{t(),S=s(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.flex{display:flex}.static{position:static}`)})))()}var w;function T(){return(T=e((()=>{m(),v(),d(),t(),i(),f(),_(),x(),C(),h(),w=class extends y(r){constructor(...e){super(...e),this.ariaLabel=null,this.clear=!1,this.search=!1,this.label=``,this.icon=null}static{this.styles=[g,S,b]}get _wrapperClasses(){return p([this.label?`has-label`:`has-icon`])}resetContainingTextField(e){let t=this.closest(`w-textfield`);t&&t.resetFormControl(),e.stopPropagation()}submitContainingForm(e){let t=this.internals.form;t&&t.submit(),e.stopPropagation()}get _searchButton(){let e=this.ariaLabel||l._({id:`affix.aria.search`,message:`Search`,comment:`Aria label for the search button in affix`});return n`
			<button
				part="wrapper"
				aria-label="${e}"
		...
		`}get _clearButton(){let e=this.ariaLabel||l._({id:`affix.aria.clearInput`,message:`Clear input`,comment:`Aria label for the clear input button in affix`});return n`
			<button
				part="wrapper"
				aria-label="${e}"
				class="${this._wrapperClasses}"
		...
		`}get _markup(){if(this.label)return this._text;if(this.icon)return this._icon;if(this.search)return this._searchButton;if(this.clear)return this._clearButton}render(){return n`${this._markup}`}},o([a({attribute:`aria-label`,reflect:!0,useDefault:!0})],w.prototype,`ariaLabel`,void 0),o([a({type:Boolean})],w.prototype,`clear`,void 0),o([a({type:Boolean})],w.prototype,`search`,void 0),o([a({reflect:!0,useDefault:!0})],w.prototype,`label`,void 0),o([a({reflect:!0,useDefault:!0})],w.prototype,`icon`,void 0),customElements.get(`w-affix`)||customElements.define(`w-affix`,w)})))()}export{T as t};
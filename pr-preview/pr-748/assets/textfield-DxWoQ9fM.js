import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,c as n,d as r,h as i,l as a,r as o,s,t as c,x as l,y as u}from"./decorate-J4WBtiHw.js";import{a as d,o as f,r as p,t as m}from"./i18n-CkjYRTT1.js";import{n as h,t as g}from"./index.m-DHqwZk2H.js";import{t as _}from"./query-BHY-nhsh.js";import{n as v,t as y}from"./class-map-DIRZr7YF.js";import{n as b,t as x}from"./styles-CYn3YYhE.js";import{n as S,t as C}from"./FormControlMixin-BCJbRrUC.js";import{r as w,t as T}from"./if-defined-hoo3qVMT.js";var E;function D(){return(D=e((()=>{E=JSON.parse(`{"textfield.label.optional":["Valgfri"]}`)})))()}var O;function k(){return(k=e((()=>{O=JSON.parse(`{"textfield.label.optional":["Optional"]}`)})))()}var A;function j(){return(j=e((()=>{A=JSON.parse(`{"textfield.label.optional":["Valinnainen"]}`)})))()}var M;function N(){return(N=e((()=>{M=JSON.parse(`{"textfield.label.optional":["Valgfri"]}`)})))()}var P;function F(){return(F=e((()=>{P=JSON.parse(`{"textfield.label.optional":["Valfritt"]}`)})))()}var I;function L(){return(L=e((()=>{n(),I=u`
	.w-textfield {
...
`})))()}var U,W;function G(){return(G=e((()=>{g(),f(),S(),n(),o(),y(),T(),p(),x(),D(),k(),j(),N(),F(),L(),z(),H(),U={base:`block text-m leading-m mb-0 px-8 py-12 rounded-4 w-full focusable focus:[--w-outline-offset:-2px] caret-current`,default:`border-1 s-text s-bg s-border-strong hover:s-border-strong-hover active:s-border-selected`,disabled:`border-1 s-text-disabled s-bg-disabled-subtle s-border-disabled pointer-events-none`,invalid:`border-1 s-text-negative s-bg s-border-negative hover:s-border-negative-hover outline-[--w-s-color-border-negative]!`,readOnly:`pl-0 bg-transparent pointer-events-none`,placeholder:`placeholder:s-text-placeholder`,suffix:`pr-40`,prefix:`pl-[var(--w-prefix-width,_40px)]`,textArea:`min-h-[42] sm:min-h-[45]`},W=class extends C(a){static{this.shadowRootOptions={...a.shadowRootOptions,delegatesFocus:!0}}constructor(){super(),this.disabled=!1,this.invalid=!1,this.optional=!1,this.readOnly=!1,this.readonly=!1,this.required=!1,this._hasPrefix=!1,this._hasSuffix=!1,this._hasHelpTextSlot=!1,this.#n=void 0,m(O,M,A,E,P)}get#e(){return this.helpText!==void 0||this._hasHelpTextSlot}#t(e){e.key===`Enter`&&this.internals.form&&this.internals.form.requestSubmit()}updated(e){e.has(`value`)&&this.value!==void 0&&(this.setValue(this.value),this.formatter&&this.mask&&(this.mask.innerText=this.formatter(this.value)))}#n;static{this.styles=[b,R,I,B,V]}firstUpdated(){this.#n=this.value}resetFormControl(){this.value=this.#n}get _inputstyles(){return h([U.base,this._hasSuffix&&U.suffix,this._hasPrefix&&U.prefix,!this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&U.default,this.invalid&&!this.disabled&&!(this.readonly||this.readOnly)&&U.invalid,!this.invalid&&this.disabled&&!(this.readonly||this.readOnly)&&U.disabled,!this.invalid&&!this.disabled&&(this.readonly||this.readOnly)&&U.readOnly])}get _helptextstyles(){return`help-text`}get _label(){if(this.label){let e=this.label.length&&this.optional&&!this.required,t=!!this.tooltip;return i`
				<label for="${this._id}">
					${this.label}${e?i`
									<span>
		...
		`}},c([s({type:Boolean,reflect:!0})],W.prototype,`disabled`,void 0),c([s({type:Boolean,reflect:!0})],W.prototype,`invalid`,void 0),c([s({type:String,reflect:!0})],W.prototype,`label`,void 0),c([s({type:String,reflect:!0,attribute:`help-text`})],W.prototype,`helpText`,void 0),c([s({type:Boolean,reflect:!0})],W.prototype,`optional`,void 0),c([s({type:String,reflect:!0})],W.prototype,`size`,void 0),c([s({type:Number,reflect:!0})],W.prototype,`max`,void 0),c([s({type:Number,reflect:!0})],W.prototype,`min`,void 0),c([s({type:Number,reflect:!0,attribute:`min-length`})],W.prototype,`minLength`,void 0),c([s({type:Number,reflect:!0})],W.prototype,`minlength`,void 0),c([s({type:Number,reflect:!0,attribute:`max-length`})],W.prototype,`maxLength`,void 0),c([s({type:Number,reflect:!0})],W.prototype,`maxlength`,void 0),c([s({type:String,reflect:!0})],W.prototype,`pattern`,void 0),c([s({type:String,reflect:!0})],W.prototype,`placeholder`,void 0),c([s({type:Boolean,reflect:!0,attribute:`read-only`})],W.prototype,`readOnly`,void 0),c([s({type:Boolean,reflect:!0})],W.prototype,`readonly`,void 0),c([s({type:Boolean,reflect:!0})],W.prototype,`required`,void 0),c([s({type:String,reflect:!0})],W.prototype,`type`,void 0),c([s({type:String,reflect:!0})],W.prototype,`value`,void 0),c([s({type:String,reflect:!0})],W.prototype,`name`,void 0),c([s({type:Number,reflect:!0})],W.prototype,`step`,void 0),c([s({type:String,reflect:!0})],W.prototype,`autocomplete`,void 0),c([s({type:String,reflect:!0})],W.prototype,`tooltip`,void 0),c([s({attribute:!1})],W.prototype,`formatter`,void 0),c([_(`.w-textfield__mask`)],W.prototype,`mask`,void 0),c([s({type:Boolean})],W.prototype,`_hasPrefix`,void 0),c([s({type:Boolean})],W.prototype,`_hasSuffix`,void 0),c([t()],W.prototype,`_hasHelpTextSlot`,void 0),customElements.get(`w-textfield`)||customElements.define(`w-textfield`,W)})))()}export{G as t};
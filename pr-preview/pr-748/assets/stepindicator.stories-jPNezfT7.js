import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,c as n,d as r,h as i,l as a,r as o,s,t as c,x as l}from"./decorate-J4WBtiHw.js";import{a as u,n as d,o as f,r as p,t as m}from"./i18n-CkjYRTT1.js";import{n as h,t as g}from"./index.m-DHqwZk2H.js";import{t as _}from"./icon-oWwEbYYO.js";import{n as v,t as y}from"./styles-CYn3YYhE.js";import{r as b,t as x}from"./if-defined-hoo3qVMT.js";var S;function C(){return(C=e((()=>{n(),S=l(`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.flex{display:flex}.grid{display:grid}.static{position:static}.w-full{width:100%}`)})))()}var w,T;function E(){return(E=e((()=>{g(),n(),o(),y(),C(),w={wrapper:`w-full`,horizontal:`flex`},T=class extends a{constructor(...e){super(...e),this.horizontal=!1,this.right=!1}static{this.styles=[v,S]}updated(){this.updateStepsContext()}updateStepsContext(){let e=this.querySelectorAll(`w-step`);e.forEach((t,n)=>{t.setContext({horizontal:this.horizontal,right:this.right,isLast:n===e.length-1,isFirst:n===0})})}render(){let e=h([w.wrapper,this.horizontal&&w.horizontal]);return i`
			<div
				role="list"
				class=${e}

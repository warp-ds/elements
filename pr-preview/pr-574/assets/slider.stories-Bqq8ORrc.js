import{a as L,i as C,q as ee,r as Z,A as c,b as i,n as s,m as h,l as p,k as te,g as re}from"./iframe-wIcw07Bn.js";import"./affix-CEKztUnl.js";import"./attention-BJgYsMVa.js";import"./textfield-BfN3s_KY.js";import{_ as ae}from"./preload-helper-Ct5FWWRu.js";import{e as O}from"./query-NYTjQBeo.js";import{o as R}from"./if-defined-D-3EvsnY.js";import{F as ie}from"./FormControlMixin-DJnJZbro.js";const se=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["Maksimumværdien må ikke være mindre end minimumværdien"],"slider.error.required":["Dette felt er påkrævet"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Værdien skal være mellem ",["min"]," og ",["max"]]}'),oe=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["The maximum value cannot be less than the minimum"],"slider.error.required":["This field is required"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Value must be between ",["min"]," and ",["max"]]}'),ne=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["Maksimiarvo ei voi olla pienempi kuin minimiarvo"],"slider.error.required":["Tämä kenttä on pakollinen"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Arvon on oltava välillä ",["min"]," - ",["max"]]}'),le=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["Maksimumsverdien kan ikke være mindre enn minimumsverdien"],"slider.error.required":["Dette feltet er påkrevd"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Verdien må være mellom ",["min"]," og ",["max"]]}'),de=JSON.parse('{"slider.label.from":["From"],"slider.placeholder.to":["Max"],"slider.placeholder.from":["Min"],"slider.error.overlap":["Maxvärdet kan inte vara mindre än minimivärdet"],"slider.error.required":["Detta fält är obligatoriskt"],"slider.label.to":["To"],"slider.error.out_of_bounds":["Värdet måste vara mellan ",["min"]," och ",["max"]]}'),me=L`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`;var pe=Object.defineProperty,l=(o,e,r,a)=>{for(var t=void 0,u=o.length-1,f;u>=0;u--)(f=o[u])&&(t=f(e,r,t)||t);return t&&pe(e,r,t),t};class n extends ie(C){constructor(){super(...arguments),this.disabled=!1,this.invalid=!1,this.openEnded=!1,this.suffix="",this._showTooltip=!1,this._inputHasFocus=!1,this._hiddenTextfield=!1,this.#e=null,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...C.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[Z,he,ce]}#e;resetFormControl(){this.value=this.#e}#r(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#a(){this._showTooltip=!1}#o(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}#t(e){this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:e,slot:this.slot}}))}async updateFieldAfterValidation(){const e=this.shadowRoot.querySelector("w-textfield");await this.#i(e.value,!0)}async#i(e,r){let a=Number.parseInt(e);if(this.openEnded&&!r&&this.step&&!(this.slot==="to"&&a>=Number(this.max)-1||this.slot==="from"&&a<=Number(this.min)+1)){const N=1/this.step;a=Math.round(a*N)/N,e=a.toString()}const t=Number.parseInt(this.max),u=Number.parseInt(this.min);if(!this.openEnded&&(a>t||a<u))return this.#t(p.t({id:"slider.error.out_of_bounds",message:"Value must be between {min} and {max}",values:{min:`${this.min} ${this.suffix}`.trim(),max:`${this.max} ${this.suffix}`.trim()}})),{shouldCancel:!0};e===""&&this.required&&this.#t(p.t({id:"slider.error.required",message:"This field is required"})),this.value=e;const f=e===this.max||e===this.min;let I=!1;if(this.slot){const P=this.parentElement.querySelector('w-slider-thumb[slot="to"]'),N=this.parentElement.querySelector('w-slider-thumb[slot="from"]'),H=P.textfield.value||this.max,A=N.textfield.value||this.min,B=Number.parseInt(H),X=Number.parseInt(A),j=p.t({id:"slider.error.overlap",message:"The maximum value cannot be less than the minimum"});if(this.slot==="from"){const g=this.openEnded&&B>t?B:Math.min(B,this.openEnded?t-1:t);a>g&&(I=!0,this.openEnded&&f?this.value=String(g):this.value=H,r&&(this.#t(j),await this.updateComplete,this.textfield.value=e))}else{const g=this.openEnded&&X<u?X:Math.max(Number.parseInt(A),this.openEnded?u+1:u);a<g&&(I=!0,this.openEnded&&f?this.value=String(g):this.value=A,r&&(this.#t(j),await this.updateComplete,this.textfield.value=e))}}return I?{shouldCancel:!0}:(this.#t(""),this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.openEnded&&!r&&f?"":e,this.shadowRoot.querySelector("w-attention").handleDone(),{shouldCancel:!1})}async#s(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const a=e.currentTarget.value;return(await this.#i(a,r)).shouldCancel?(e.preventDefault(),!1):!0}async#n(e){if(e.key!=="ArrowLeft"&&e.key!=="ArrowRight")return;const r=Number(this.range.value),a=this.step||1;let t;e.key==="ArrowLeft"?t=r-a:t=r+a,t=Math.min(Math.max(t,Number(this.min)),Number(this.max)),(await this.#i(t.toString(),!1)).shouldCancel&&e.preventDefault()}async connectedCallback(){if(super.connectedCallback(),this.#e=this.value,this.setValue(this.value),this.slot&&!this.ariaDescription&&(this.slot==="from"?this.ariaDescription=p.t({id:"slider.label.from",comment:"Accessible label for the 'from value' input field in a range slider",message:"From"}):this.slot==="to"&&(this.ariaDescription=p.t({id:"slider.label.to",comment:"Accessible label for the 'to value' input field in a range slider",message:"To"}))),"anchorName"in document.documentElement.style)await this.updateComplete;else{const a=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:t}]=await Promise.all([ae(()=>import(`${a}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
    ...
    `}},q={render(){return i(Q||(Q=b([`
      ...
      <\/script>
    `])))}},z={render({locale:o}){return i(Y||(Y=b([`
...
}`,...z.parameters?.docs?.source}}};const xe=["Single","SingleDisabled","Range","SuffixSquareMeters","SuffixCurrency","SuffixKilometers","Marks","Step","OpenEnded","SingleError","RangeError","CustomError","Description","VisuallyHiddenLabel","HiddenMinimumMaximumLabels","VisuallyHiddenTextfield"],Me=Object.freeze(Object.defineProperty({__proto__:null,CustomError:M,Description:D,HiddenMinimumMaximumLabels:q,Marks:k,OpenEnded:F,Range:x,RangeError:$,Single:w,SingleDisabled:v,SingleError:T,Step:E,SuffixCurrency:_,SuffixKilometers:S,SuffixSquareMeters:y,VisuallyHiddenLabel:V,VisuallyHiddenTextfield:z,__namedExportsOrder:xe,default:ve},Symbol.toStringTag,{value:"Module"}));export{k as M,F as O,x as R,Me as S,w as a,y as b,_ as c,S as d,E as e,T as f,$ as g};

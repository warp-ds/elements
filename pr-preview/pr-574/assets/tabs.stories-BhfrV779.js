import{p as z,n as r,m as F,i as m,k as O,b as l,a as S,r as I,j as x}from"./iframe-ER9f_Qwc.js";import{e as E}from"./query-NYTjQBeo.js";import{u as D}from"./utils-CCcvPjT2.js";var L=Object.defineProperty,v=(i,t,a,n)=>{for(var e=void 0,o=i.length-1,s;o>=0;o--)(s=i[o])&&(e=s(t,a,e)||e);return e&&L(t,a,e),e},P=`:host {
...
`,y=new Map,R='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"></svg>';function B(i,t={}){const a=t.responseParser??(n=>n.text());return y.has(i)||y.set(i,fetch(i).then(a)),y.get(i)}var p=class extends m{constructor(){super(...arguments),this.name="",this.size="medium",this.locale="en",this.svg=null}async fetchIcon(i){const t=`https://assets.finn.no/pkg/eikons/v1/${this.locale}/${i}.svg`;try{const a=await B(t);return new DOMParser().parseFromString(a,"text/html").body.querySelector("svg")}catch{return null}}firstUpdated(){this.loadIcon()}updated(i){(i.has("name")||i.has("locale"))&&this.loadIcon()}async loadIcon(){if(!this.name){this.svg=null;return}let i=await this.fetchIcon(this.name);i||(i=new DOMParser().parseFromString(R,"text/html").body.firstElementChild),this.svg=i}render(){const i={"w-icon":!0,"w-icon--s":this.size==="small","w-icon--m":this.size==="medium","w-icon--l":this.size==="large"},t=typeof this.size=="string"&&this.size.endsWith("px")?`--w-icon-size: ${this.size};`:"";return l`<div class="${O(i)}" style="${t}" part="w-${this.name.toLowerCase()}">${this.svg}</div>`}};p.styles=[z(P)];v([r({type:String,reflect:!0})],p.prototype,"name");v([r({type:String,reflect:!0})],p.prototype,"size");v([r({type:String,reflect:!0})],p.prototype,"locale");v([F()],p.prototype,"svg");customElements.get("w-icon")||customElements.define("w-icon",p);const C=S`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.border-b{border-bottom-width:1px}.border-b-4{border-bottom-width:4px}.inline-block{display:inline-block}.inline-grid{display:inline-grid}.hidden{display:none}.grid-cols-1{grid-template-columns:repeat(1,minmax(0,1fr))}.grid-cols-2{grid-template-columns:repeat(2,minmax(0,1fr))}.grid-cols-3{grid-template-columns:repeat(3,minmax(0,1fr))}.grid-cols-4{grid-template-columns:repeat(4,minmax(0,1fr))}.grid-cols-5{grid-template-columns:repeat(5,minmax(0,1fr))}.grid-cols-6{grid-template-columns:repeat(6,minmax(0,1fr))}.grid-cols-7{grid-template-columns:repeat(7,minmax(0,1fr))}.grid-cols-8{grid-template-columns:repeat(8,minmax(0,1fr))}.grid-cols-9{grid-template-columns:repeat(9,minmax(0,1fr))}.-bottom-0{bottom:0}.absolute{position:absolute}.relative{position:relative}.static{position:static}.s-border{border-color:var(--w-s-color-border)}.s-border-selected{border-color:var(--w-s-color-border-selected)}.-mb-1{margin-bottom:-.1rem}.mb-32{margin-bottom:3.2rem}.resize{resize:both}.transition-all{transition-property:all;transition-duration:.15s;transition-timing-function:cubic-bezier(.4,0,.2,1)}.bg-transparent{background-color:#0000}.appearance-none{-webkit-appearance:none;appearance:none}.border-0{border-width:0}.border-b-4{border-bottom-width:4px}.border-transparent{border-color:#0000}.inline-block{display:inline-block}.flex{display:flex}.grid{display:grid}.focusable:focus{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:focus-visible{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:not(:focus-visible){outline:none}.gap-8{gap:.8rem}.focus\\:outline-none:focus{outline-offset:2px;outline:2px solid #0000}.items-center{align-items:center}.justify-center{justify-content:center}.static{position:static}.s-text-link{color:var(--w-s-color-text-link)}.s-text-subtle{color:var(--w-s-color-text-subtle)}.hover\\:s-text-link:hover{color:var(--w-s-color-text-link)}.s-border-selected{border-color:var(--w-s-color-border-selected)}.hover\\:s-border-primary:hover{border-color:var(--w-s-color-border-primary)}.m-0{margin:0}.mx-auto{margin-left:auto;margin-right:auto}.p-0{padding:0}.p-16{padding:1.6rem}.pb-8{padding-bottom:.8rem}.cursor-pointer{cursor:pointer}.font-bold{font-weight:700}.w-full{width: 100%;}`;var q=Object.defineProperty,j=Object.getOwnPropertyDescriptor,A=(i,t,a,n)=>{for(var e=n>1?void 0:n?j(t,a):t,o=i.length-1,s;o>=0;o--)(s=i[o])&&(e=(n?s(t,a,e):s(e))||e);return n&&e&&q(t,a,e),e};class g extends m{static{this.styles=[I,C,S`
    ...
    `]}constructor(){super(),this._internals=this.attachInternals()}set active(t){this._ownActive=t}get active(){return this._parentActive??this._ownActive??!1}connectedCallback(){super.connectedCallback(),this._internals.role="tabpanel"}updated(){this._parentAriaLabelledBy&&(this._internals.ariaLabelledBy=this._parentAriaLabelledBy)}render(){return l`<div class="panel-content" ?data-active=${this.active}><slot></slot></div>`}}A([r({type:Boolean})],g.prototype,"active",1);A([r({attribute:!1})],g.prototype,"_parentActive",2);A([r({attribute:!1})],g.prototype,"_parentAriaLabelledBy",2);customElements.get("w-tab-panel")||customElements.define("w-tab-panel",g);var M=Object.defineProperty,W=Object.getOwnPropertyDescriptor,d=(i,t,a,n)=>{for(var e=n>1?void 0:n?W(t,a):t,o=i.length-1,s;o>=0;o--)(s=i[o])&&(e=(n?s(t,a,e):s(e))||e);return n&&e&&M(t,a,e),e};const b={base:"grid w-full items-center font-bold gap-8 antialias p-16 pb-8 border-b-4 bg-transparent border-transparent hover:s-text-link hover:s-border-primary",inactive:"s-text-subtle",active:"s-text-link s-border-selected",icon:"mx-auto",content:"flex items-center justify-center gap-8",contentUnderlined:"content-underlined"},U="focus:outline-none appearance-none cursor-pointer bg-transparent border-0 m-0 p-0 inline-block";class c extends m{constructor(){super(),this._handleClick=t=>{t.tab||(t.tab=this)},this.active=!1,this.over=!1,this._internals=this.attachInternals()}static{this.styles=[I,C,S`::slotted([slot="icon"]){display:flex}`]}static{this.shadowRootOptions={...m.shadowRootOptions,delegatesFocus:!0}}get tabIndex(){return this._parentTabIndex??0}set tabIndex(t){this._parentTabIndex=t}get _computedAriaSelected(){return this._parentAriaSelected??this._ownAriaSelected}set ariaSelected(t){const a=this._ownAriaSelected;this._ownAriaSelected=t,this._internals.ariaSelected=this._computedAriaSelected??null,this.requestUpdate("ariaSelected",a)}get ariaSelected(){return this._computedAriaSelected??"false"}get _classes(){return x([U,b.base,this.active||this.ariaSelected==="true"?b.active:b.inactive])}get _hasIcon(){return this.querySelector('[slot="icon"]')!==null}connectedCallback(){super.connectedCallback(),this._internals.role="tab",this.addEventListener("click",this._handleClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this._handleClick)}updated(t){super.updated(t),t.has("_parentAriaSelected")&&(this._internals.ariaSelected=this._computedAriaSelected??null),t.has("active")&&this.hasAttribute("active")&&(this._internals.ariaSelected=this.active?"true":"false")}render(){const t=this._hasIcon;return l`
      <button
        type="button"
        role="none"
    ...
    `}}$([r({reflect:!0})],_.prototype,"active");$([E('[role="tablist"]')],_.prototype,"tabList");$([E(".selection-indicator")],_.prototype,"selectionIndicator");customElements.get("w-tabs")||customElements.define("w-tabs",_);const H={title:"Components/Tabs"},h=()=>l`
  <w-tabs active="tab2">

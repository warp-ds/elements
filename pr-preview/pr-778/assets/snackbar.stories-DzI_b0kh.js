import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{C as t,a as n,f as r,p as i,r as a,s as o,t as s,y as c}from"./decorate-kJVNAdyH.js";import{a as l,o as u,r as d,t as f}from"./i18n-DxEA2sVo.js";import"./__uno-BiBlMnpD.js";import{n as p,t as m}from"./dist-Bn_0n649.js";import{t as ee}from"./query-BHY-nhsh.js";import{t as h}from"./icon-DgzLkPq-.js";import{n as g,t as _}from"./styles-BxpTFSox.js";import{n as te,r as ne,t as v}from"./element-collapse-D7tK4piP.js";import{t as y}from"./attention-B0FbE7EB.js";import{t as b}from"./button-C1QhNFgi.js";import{t as x}from"./modal-BOXWMWm_.js";import{n as S,t as C}from"./modal-footer-D11MP37P.js";var w;function T(){return(T=e((()=>{r(),w=t`
	:host {
		display: block;
...
`})))()}var E,D;function O(){return(O=e((()=>{r(),a(),ne(),_(),T(),E=function(e){return e[e.Short=4e3]=`Short`,e[e.Long=1e4]=`Long`,e[e.Infinite=12e7]=`Infinite`,e}({}),D=class extends i{constructor(...e){super(...e),this.actionPlacement=`inline`,this.duration=4e3,this.hasAction=!1,this.#e=!1,this.#t=4e3,this.#n=null,this.#r=null,this.#i=!1}static{this.styles=[g,w]}#e;#t;#n;#r;#i;connectedCallback(){if(super.connectedCallback(),this.duration!==12e7){let e=1e3;this.#t=this.duration-e,this.#r=setInterval(()=>{this.#i||(this.#t-=e,this.#t<=0&&this.close())},e)}}disconnectedCallback(){this.#r&&clearInterval(this.#r)}async updated(){this.root&&(this.#e||(await this.updateComplete,te(this.root,()=>{this.#e=!0})))}close(){this.#n&&this.#n.focus(),this.#e&&this.root?v(this.root,()=>{this.remove()}):this.remove()}#a(e){this.#n||(this.#i=!0,e.relatedTarget&&e.relatedTarget.focus&&(this.#n=e.relatedTarget))}#o(e){(!e.relatedTarget||!this.shadowRoot?.host.contains(e.relatedTarget))&&(this.#i=!1,this.#n=null)}#s(){this.#i=!0}#c(){this.#n||(this.#i=!1)}#l(){let e=this.shadowRoot?.querySelector(`slot[name="action"]`);return e?e.assignedElements().length>0:!1}firstUpdated(){this.hasAction=this.#l()}render(){if(this.hasAction&&document.documentElement.dataset.wKeyboardinteraction===`true`){let e=window.navigator.userAgent.includes(`Macintosh`)?`⌥`:`Alt`;return c`
...
`})))()}var V,H,U;function W(){return(W=e((()=>{u(),r(),O(),d(),A(),M(),P(),I(),R(),_(),B(),V={canClose:!0,duration:E.Short,variant:`neutral`},f(j,F,N,k,L),H=/\s/,U=class extends i{static{this.styles=[g,z]}constructor(){super(),this.internals=this.attachInternals(),this.internals.ariaLive=`polite`,this.internals.role=`log`,this._onKeydown=this._onKeydown.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this._onKeydown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`keydown`,this._onKeydown)}_onKeydown(e){if(e.key===`Escape`){let e=this.shadowRoot?.host.querySelector(`w-snackbar-item:last-of-type`);e&&e.close()}else if(e.altKey&&e.key===`Enter`){e.preventDefault();let t=this.shadowRoot?.host.querySelector(`w-snackbar-item:last-of-type`);if(console.log(`Found item!`),t){let e=t.querySelector(`w-button[slot="action"]`);console.log(`Found action!`),e&&(e.click(),console.log(`Clicked!`))}}}create(e,t={}){let n={...V,...t},r=document.createElement(`w-snackbar-item`);if(n.duration&&(r.duration=n.duration),r.innerText=e,n.variant!==`neutral`){let e=document.createElement(`w-icon`);switch(e.slot=`icon`,n.variant){case`positive`:e.name=`SuccessFilled`;break;case`warning`:e.name=`WarningFilled`;break;case`negative`:e.name=`ErrorFilled`;break;case`info`:e.name=`InfoFilled`}r.prepend(e)}if(n.action){r.duration<E.Long&&(r.duration=E.Long);let e=document.createElement(`w-button`);e.slot=`action`,e.variant=`utilityQuiet`,e.small=!0;let{label:t,onclick:i,placement:a}=n.action;e.innerText=t;let o=document.createElement(`span`);o.classList.add(`sr-only`),o.innerHTML=`<kbd>${window.navigator.userAgent.includes(`Macintosh`)?`Option`:`Alt`}</kbd> + <kbd>Enter</kbd>`,e.append(o),e.onclick=t=>{let n=i.call(e,t);return t.defaultPrevented||r.close(),n},a?r.actionPlacement=a:H.test(t)&&(r.actionPlacement=`block`),r.append(e)}if(r.duration>E.Long&&(n.canClose=!0),n.canClose){let e=document.createElement(`w-button`);e.slot=`close`,e.variant=`utilityQuiet`,e.small=!0,e.iconOnly=!0,e.onclick=typeof n.canClose==`function`?t=>{n.canClose.call(e,t),t.defaultPrevented||r.close()}:r.close.bind(r);let t=document.createElement(`w-icon`);t.name=`Close`,t.size=`small`,t.ariaLabel=l.t({id:`snackbar.aria.close`,message:`Dismiss message`,comment:`Accessibility label for the button that closes the snackbar/toast popup`}),e.append(t),r.append(e)}return this.shadowRoot?.host.prepend(r),r}render(){return c`
        ...
        `}},X={render({duration:e,canClose:t}){let n=e===`Infinite`?E.Infinite:e===`10 seconds`?E.Long:E.Short;return c`
            <div class="flex gap-8">
                <w-button
        ...
        `}},Z={render({duration:e,canClose:t}){let n=e===`Infinite`?E.Infinite:e===`10 seconds`?E.Long:E.Short;return c`
            <div class="flex gap-8">
                <w-button
        ...
        `}},Q=[`Default`,`WithAction`,`WithLongActionLabel`],Y.parameters={...Y.parameters,docs:{...Y.parameters?.docs,source:{originalSource:`{
  render({
    duration,
    canClose
  }) {
...
}`,...Z.parameters?.docs?.source}}}})))()}$();export{Y as Default,X as WithAction,Z as WithLongActionLabel,Q as __namedExportsOrder,J as default};
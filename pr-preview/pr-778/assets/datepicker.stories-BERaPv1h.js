...
`})))()}var po;function mo(){return(mo=e((()=>{c(),po=n`
...
`})))()}var ho;function go(){return(go=e((()=>{c(),ho=n`
	/* === Day Cell === */
	.w-datepicker__day {
		/* No longer in use? */
...
`})))()}var _o;function vo(){return(vo=e((()=>{c(),_o=n`
	.w-datepicker__month {
...
`})))()}function yo(e){if(typeof e!=`string`)return null;let t=e;Co.test(e)&&(t=`${e}T00:00:00Z`);let n=Date.parse(t);return Number.isNaN(n)?null:new Date(n)}function bo(e=typeof navigator<`u`?navigator.userAgent:``){let t=wo.test(e),n=To.test(e)&&!Eo.test(e);return t||n?`text`:`date`}function xo(e){let t=e===`en`?`en-GB`:e;return new Intl.DateTimeFormat(t,{day:`2-digit`,month:`2-digit`,year:`numeric`,timeZone:`UTC`}).formatToParts(new Date(Date.UTC(2006,0,2))).map(e=>e.type===`day`?`dd`:e.type===`month`?`mm`:e.type===`year`?`yyyy`:e.value).join(``)}function So(e,t){if(!Co.exec(e))return e;let[n,r,i]=e.split(`-`);return xo(t).replace(`yyyy`,n).replace(`mm`,r).replace(`dd`,i)}var Co,wo,To,Eo;function Do(){return(Do=e((()=>{Co=/^\d{4}-\d{2}-\d{2}$/,wo=/iP(hone|od|ad)/,To=/Safari/,Eo=/(Chrome|Chromium|CriOS|FxiOS|Edg|OPR|Android)/})))()}var Oo,W,ko,G,Ao,K,q,J;function jo(){return(jo=e((()=>{re(),ge(),je(),Ne(),Ve(),rt(),at(),dt(),jn(),Nn(),Fn(),zn(),Ye(),Un(),Gn(),Vn(),st(),Yn(),D(),qn(),Zn(),Nr(),Br(),Oi(),la(),Ka(),c(),te(),le(),ve(),Za(),ue(),xe(),ie(),fe(),$a(),to(),ro(),ao(),so(),fo(),mo(),go(),vo(),Do(),Oo=bo(),W=`calendar`,ko=`input`,G=`toggle`,Ao=`wrapper`,K=`previous`,q={en:zr,nb:ca,sv:Ga,da:Mr,fi:Di},J=class extends _e(ee){static{this.shadowRootOptions={...ee.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[de,co,lo,uo,po,ho,_o]}get selectedDate(){return this.value?yo(this.value)??null:null}get month(){return ot(this.navigationDate)}#e;get weeks(){let e=this.month,t=this.navigationDate,n=it({start:ot(e),end:Bn(e)},{locale:this.locale}).map(e=>({start:e,end:ut(e,{locale:this.locale})})).map(e=>nt(e));if(Hn(t,e)){let e=Rn(t,{locale:this.locale})-1,r=Be(t,E(t,{locale:this.locale}));n[e][r]=t}return n}get#t(){return this.lang||h()||`en`}get#n(){return Oo===`text`&&this.value?So(this.value,this.#t):this.value||``}async#r(e){e.preventDefault(),this.isCalendarOpen=!this.isCalendarOpen,this.isCalendarOpen&&(await this.updateComplete,(this.selectedCell||this.todayCell).focus())}#i(){this.navigationDate=Me(this.month,1)}#a(){this.navigationDate=Xn(this.month,1)}#o;async#s(){await this.updateComplete,this.input.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}_onClickOutside(e){this.isCalendarOpen&&(this.contains(e.target)||(this.isCalendarOpen=!1))}#c(e){this.value=e.target.value}#l(){this.#y=!0,this.#C()}#u(e){e.preventDefault(),this.isCalendarOpen=!0}#d(e){if(e.key===` `)return this.#r(e);e.key===`,`&&e.preventDefault(),e.key===`Enter`&&this.internals.form&&this.internals.form.requestSubmit()}async#f(e){let t=this.navigationDate,n=null;switch(e.key){case`ArrowUp`:n=Kn(t,7);break;case`ArrowLeft`:n=Kn(t,1);break;case`Home`:n=E(t,{locale:this.locale});break;case`PageUp`:n=Xn(t,1);break;case`ArrowDown`:n=C(t,7);break;case`ArrowRight`:n=C(t,1);break;case`End`:n=ut(t,{locale:this.locale});break;case`PageDown`:n=Me(t,1);break;case`Escape`:this.isCalendarOpen=!1;break;case`Tab`:e.target.tagName===`TD`&&!e.shiftKey?(e.preventDefault(),this.previousMonthButton.focus()):e.target.id===K&&e.shiftKey&&(e.preventDefault(),(this.selectedCell||this.todayCell).focus())}n&&(e.preventDefault(),this.navigationDate=n,await this.updateComplete,this.selectedCell.focus())}#p(e){let t=e.currentTarget.dataset.date;this.value=t,this.input.value=this.#n,this.#C(),this.isCalendarOpen=!1,this.#s()}#m(e){e.key===`Enter`&&this.#g(e)}#h(e){e.key===` `&&this.#g(e)}#g(e){let t=e.currentTarget.dataset.date;this.value=t,this.input.value=this.#n,this.#C(),this.isCalendarOpen=!1,this.toggleButton.focus(),this.#s()}#_;#v;#y;constructor(){super(),this.required=!1,this.optional=!1,this.invalid=!1,this.disabled=!1,this.readonly=!1,this.headerFormat=`MMMM yyyy`,this.weekdayFormat=`EEEEEE`,this.dayFormat=`PPPP`,this.isCalendarOpen=!1,this.navigationDate=Jn(),this.locale=zr,this.#e=void 0,this.#o=``,this.#_=!1,this.#v=void 0,this.#y=!1,this.#S=e=>{e.preventDefault(),this.#y=!0,this.#C()},ae(eo,io,no,Qa,oo);let e=h();e&&q[e]&&(this.locale=q[e]),this._onClickOutside=this._onClickOutside.bind(this)}resetFormControl(){this.value=this.#e,this.#y=!1,this.#x(),this.#C()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}get _error(){if(this.invalid&&this.helpText)return this.helpText}checkValidity(){return this.#C(),this.internals.checkValidity()}reportValidity(){return this.#y=!0,this.#C(),this.internals.checkValidity()}setCustomValidity(e){this.#o=e,e?(this.#C(),this.#b(e)):(this.#x(),this.#C())}#b(e){this.#_||(this.#v=this.helpText),this.#_=!0,this.invalid=!0,this.helpText=e}#x(){this.#_&&=(this.invalid=!1,this.helpText=this.#v,this.#v=void 0,!1)}#S;#C(){if(this.disabled){this.internals.setValidity({}),this.#x();return}let e={valueMissing:this.required&&!this.value,customError:this.#o!==``};if(Object.values(e).some(Boolean)){let t=e.customError?this.#o:this.input?.validationMessage||``;this.internals.setValidity(e,t,this.input),this.#y&&this.#b(t);return}this.internals.setValidity({}),this.#x()}connectedCallback(){super.connectedCallback(),this.#e=this.value,this.value!==void 0&&this.setValue(this.value),this.addEventListener(`invalid`,this.#S);let e=this.lang;if(e&&q[e]&&(this.locale=q[e]),this.value){let e=yo(this.value);e&&(this.navigationDate=e)}document.addEventListener(`mousedown`,this._onClickOutside),document.addEventListener(`touchend`,this._onClickOutside),document.addEventListener(`focusin`,this._onClickOutside)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`invalid`,this.#S),document.removeEventListener(`mousedown`,this._onClickOutside),document.removeEventListener(`touchend`,this._onClickOutside),document.removeEventListener(`focusin`,this._onClickOutside)}updated(e){e.has(`value`)&&this.value!==void 0&&this.setValue(this.value),(e.has(`value`)||e.has(`required`)||e.has(`disabled`))&&this.#C()}firstUpdated(e){super.firstUpdated(e),this.#C()}render(){return p`
			<div class="w-datepicker-wrapper" id="${Ao}">
				<label class="w-datepicker-input-label" for="${ko}">
					${this.label}
				...
				<div class="w-datepicker-input-wrapper">
					<input
						...
						type="${Oo}"
						name="${_(this.name)}"
						placeholder="${_(Oo===`text`?xo(this.#t):void 0)}"
						.value="${this.#n}"
			...
			<div
				...
				style="${Ya({display:this.isCalendarOpen?void 0:`none`})}"
			>
				<div
		...
		`]),pe(me(e)))},args:Io,argTypes:Lo,parameters:{actions:{handles:Fo}}},Y={args:{label:`Date`}},X={args:{label:`Date`,optional:!0,required:!1,helpText:`Help text is available`}},Z={args:{label:`Date`,invalid:!0,helpText:`Description of how to fix the problem`}},Q={args:{label:`Date`,optional:!0,required:!1,helpText:`Help text is available, but might not be enough, or the added context is not important enough that we use help-text`,tooltip:`This tooltip adds supplementary information`}},$={args:{label:`Date`},render(e){return p(Po||=be([`
			...
			<\/script>
		`]),pe(me(e)))}},zo=[`Default`,`WithHelpText`,`Invalid`,`WithTooltip`,`DisableCalendarDates`],Y.parameters={...Y.parameters,docs:{...Y.parameters?.docs,source:{originalSource:`{
  args: {
    label: "Date"
  }
...
}`,...$.parameters?.docs?.source}}}})))()}export{Mo as n,Bo as r,Y as t};
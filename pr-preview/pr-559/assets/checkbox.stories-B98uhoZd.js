import{f as G,u as R,v as u,w as D,E as B,A as F,x as H,a as z,i as $,r as W,b as i,n,q as U,l as A,g as N}from"./iframe-CY8RH9mW.js";import{s as j,p as J}from"./utilities-Dy07Th6Q.js";import{e as P}from"./query-NYTjQBeo.js";import{o as E}from"./if-defined-BqOV6xD9.js";import{F as M}from"./FormControlMixin-DJnJZbro.js";/**
 * @license
...
`;var K=Object.defineProperty,h=(a,e,t,s)=>{for(var r=void 0,o=a.length-1,l;o>=0;o--)(l=a[o])&&(r=l(e,t,r)||r);return r&&K(e,t,r),r};class c extends M($){constructor(){super(...arguments),this.name="",this.value=null,this.indeterminate=!1,this.checked=!1,this.disabled=!1,this.required=!1,this.invalid=!1,this.#e=!1,this.#t=!1,this.#r=!1,this.#o=!1,this.#l=()=>{this.#n(),this.#a()},this.#h=e=>{this.disabled||e.defaultPrevented||e.key!==" "&&e.key!=="Spacebar"&&e.key!=="Enter"||e.composedPath()[0]!==this.input&&(e.preventDefault(),this.click())}}static{this.styles=[W,Y]}static{this.shadowRootOptions={...$.shadowRootOptions,delegatesFocus:!0}}#e;#t;#r;#o;connectedCallback(){super.connectedCallback(),this.setAttribute("type","checkbox");const e=this.getAttribute("value");this.value=e??"on",this.#e=this.hasAttribute("checked"),this.checked=this.#e,this.#i(),this.addEventListener("invalid",this.#l),this.addEventListener("keydown",this.#h),this.#s()}handleClick(){this.disabled||(this.#n(),this.checked=!this.checked,this.indeterminate=!1,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}))}#l;#h;updated(e){super.updated(e),(e.has("checked")||e.has("indeterminate"))&&this.#p(),this.#v(e)&&(this.#s(),this.#a()),e.has("disabled")&&this.#i()}resetFormControl(){this.checked=this.#e,this.#s(),this.#a()}click(){this.disabled||this.input?.click()}focus(e){this.input?.focus(e)}blur(){this.input?.blur()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#a(),this.internals.checkValidity()}reportValidity(){return this.#n(),this.#a(),this.internals.checkValidity()}#n(){this.#r=!0}#d(){return this.input?.validationMessage||" "}#b(){return this.input??void 0}#u(e){this.internals.setValidity(e,this.#d(),this.#b())}#a(){if(this.disabled){this.internals.setValidity({});return}const e=this.required&&!this.checked,t=this.invalid&&!this.#t;if(e){this.#t=!0,this.invalid=this.#r,this.#u({valueMissing:!0});return}if(this.#t&&(this.invalid=!1,this.#t=!1),t){this.#u({customError:!0});return}this.internals.setValidity({})}#s(){if(this.disabled){this.setValue(null);return}const e=this.checked?this.value:null;this.setValue(e)}#p(){this.input&&(this.input.checked=this.checked,this.input.indeterminate=this.indeterminate)}#i(){this.hasAttribute("tabindex")&&!this.#o||(this.tabIndex=this.disabled?-1:0,this.#o=!0)}#v(e){return e.has("checked")||e.has("value")||e.has("disabled")||e.has("required")||e.has("invalid")}render(){const e=!this.checked&&this.indeterminate,t=e?"mixed":this.checked?"true":"false";return i`
  ...
  `}render(){const e=this.#u()>0,s=this.required&&!e&&this.#e,r=this.invalid||s,o=r?this.#v():this.helpText,l=o?"checkbox-group__help":void 0,V=this.label?"checkbox-group__label":void 0,O=r?"true":void 0;return i`
      <div class="wrapper">
        ${this.label?i`
    ...
    `}connectedCallback(){super.connectedCallback(),this.addEventListener("change",this.#l),this.addEventListener("invalid",this.#h),this.addEventListener("slotchange",this.#n),this.#o=A.on("change",this.#b),this.setValue(null),this.#x()}disconnectedCallback(){this.#o?.(),this.#o=void 0,super.disconnectedCallback()}checkValidity(){return this.#c(),this.internals.checkValidity()}reportValidity(){return this.#d(),this.#c(),this.internals.checkValidity()}focus(e){const t=this.#p();if(t?.focus){t.focus(e);return}HTMLElement.prototype.focus.call(this,e)}#l;#h;#n;#d(){this.#e=!0}#b;#u(){return this.#i().filter(e=>e.checked).length}#a(){if(this.name)for(const e of this.#i()){const t=e;t&&typeof t=="object"&&!t.name&&(t.name=this.name)}}#s(e){for(const t of this.#i())"invalid"in t&&(t.invalid=e)}#p(){return this.#i()[0]}#i(){return this.shadowRoot?.querySelector("slot")?.assignedElements({flatten:!0})??[]}#v(){return ae()}updated(e){super.updated(e),this.#k(e)&&(e.has("name")&&this.#a(),this.#c())}#k(e){return e.has("invalid")||e.has("required")||e.has("helpText")||e.has("name")}#m(e){const t=this.#p();this.internals.setValidity(e," ",t??void 0)}#g(e){if(!(this.hasAttribute("tabindex")&&!this.#r)){if(e){this.tabIndex=0,this.#r=!0;return}this.#r&&(this.removeAttribute("tabindex"),this.#r=!1)}}#c(){this.#x();const e=this.#u()>0,t=this.required&&!e,s=this.invalid,r=t&&this.#e,o=s||r;if(this.#g(o),t){this.#m({valueMissing:!0}),this.#s(o);return}if(s){this.#m({customError:!0}),this.#s(!0);return}this.internals.setValidity({}),this.#s(!1)}#x(){this.#t||this.internals.form&&(this.name&&this.name.trim().length>0||(console.warn('w-checkbox-group: "name" is required for form submission.'),this.#t=!0))}}b([n({type:String,reflect:!0})],d.prototype,"label");b([n({type:String,reflect:!0})],d.prototype,"name");b([n({type:Boolean,reflect:!0})],d.prototype,"optional");b([n({type:String,reflect:!0,attribute:"help-text"})],d.prototype,"helpText");b([n({type:Boolean,reflect:!0})],d.prototype,"required");b([n({type:Boolean,reflect:!0})],d.prototype,"invalid");customElements.get("w-checkbox-group")||customElements.define("w-checkbox-group",d);const{events:oe,args:se,argTypes:ie}=N("w-checkbox"),ne={title:"Forms/Checkbox",render(a){return i`

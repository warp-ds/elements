import{b as s,r as k,a as v,n as d,i as x,q as _,A as T,l as I,d as M,m as F,g as E}from"./iframe-DaqmkAc4.js";import{s as S,p as B}from"./utilities-C_fn-Rdi.js";import{e as y}from"./query-NYTjQBeo.js";let b=[];const C={documentElement:{},body:{}},z=Object.freeze({documentElement:{"scrollbar-gutter":"stable"},body:{overflow:"hidden",position:"relative",height:"100%"}}),L=e=>{e.touches.length>1||e.preventDefault?.()},j=e=>([t,o])=>{C[e][t]=document[e].style[t],document[e].style[t]=o},q=()=>Object.entries(z).forEach(([e,t])=>{Object.entries(t).forEach(j(e))}),A=e=>([t,o])=>{document[e].style[t]=C[e][t]},P=()=>Object.entries(C).forEach(([e,t])=>{Object.entries(t).forEach(A(e))}),W=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight;function R(e){let t=-1;const o=n=>{if(n.targetTouches.length!==1)return;const a=n.targetTouches[0].clientY-t;return e.scrollTop===0&&a>0||W(e)&&a<0?L(n):(n.stopPropagation(),!0)};e.ontouchstart=n=>{n.targetTouches.length===1&&(t=n.targetTouches[0].clientY)},e.ontouchmove=o}function Y(e){e.ontouchstart=null,e.ontouchmove=null}const $=e=>()=>document[e?"addEventListener":"removeEventListener"]("touchmove",L,{passive:!1}),N=$(!0),J=$();function K(e){if(!e)throw Error("Could not run setup, an element must be provided");b.some(t=>t===e)||(b.length||(q(),N()),R(e),b.push(e))}function G(){b.forEach(Y),J(),P(),b=[]}const O=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},D=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const n of o.filter(a=>a.patchClose))n._close=()=>this.close()}};var U=Object.defineProperty,c=(e,t,o,n)=>{for(var a=void 0,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=i(t,o,a)||a);return a&&U(t,o,a),a};class l extends D(x){constructor(){super(),this.show=!1,this.ignoreBackdropClicks=!1,this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}async open(){this.dialogEl.showModal(),this.handleListeners(),K(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent("shown",{bubbles:!0,composed:!0}))}close(){this.dialogEl?.open&&(this.handleListeners("removeEventListener"),this.dialogEl.classList.add("close"),this.dialogEl.addEventListener("animationend",async()=>{this.dialogEl.classList.remove("close"),this.dialogEl.close(),G(),await this.updateComplete,this.dispatchEvent(new CustomEvent("hidden",{bubbles:!0,composed:!0}))},{once:!0}))}render(){return s`
    ...
    `}async willUpdate(t){if(t.has("back")){if(!this.titleEl)return;new ee(this.titleEl).when(async()=>{await this.updateComplete})}}get titleClasses(){return["header-title",this.back?"header-title-with-back-button":"header-title-without-back-button",this._hasTopContent?"header-title-with-top-area":""].join(" ")}get backButton(){return this.back&&!this._hasTopContent?s`<button
        ...
        </button>`:T}get closeButton(){return this.noClose?T:s`<div class="header-close-button-container">
        <w-button
            type="button"
    ...
    `]}};customElements.get("w-modal-footer")||customElements.define("w-modal-footer",ie);const{events:le,args:de,argTypes:ce}=E("w-modal"),{events:he,args:me,argTypes:pe}=E("w-modal-header"),{events:ue,args:ge,argTypes:fe}=E("w-modal-footer"),be={title:"Overlays/Modal"},m={args:{},render(){return s`
...
}`,...f.parameters?.docs?.source}}};const we=["Default","WithImage","Modal","ModalHeader","ModalFooter"],Se=Object.freeze(Object.defineProperty({__proto__:null,Default:m,Modal:u,ModalFooter:f,ModalHeader:g,WithImage:p,__namedExportsOrder:we,default:be},Symbol.toStringTag,{value:"Module"}));export{m as D,Se as M,p as W};

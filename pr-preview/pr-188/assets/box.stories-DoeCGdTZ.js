import{g as t,x as l}from"./iframe-DRi0Tzle.js";import{s as c,p as d}from"./utilities-j09m-2e6.js";const{events:u,args:p,argTypes:i}=t("w-box"),g={title:"Layout/Box",render:n=>l`
      <w-box ${c(d(n))}>
        <h3>Box Content</h3>

...
negative, positive, warning, info.`)}get _wrapperClasses(){return k([a.wrapper,a[this.variant]])}get _iconClasses(){const e=a[`${this.variant}Icon`];return k([a.icon,e])}static{this.styles=[T,F,y`
    ...
    `]}get _icon(){return this.variant===i.info?n` <w-icon-info-16></w-icon-info-16>`:this.variant===i.warning?n` <w-icon-warning-16></w-icon-warning-16>`:this.variant===i.negative?n` <w-icon-error-16></w-icon-error-16>`:this.variant===i.positive?n` <w-icon-success-16></w-icon-success-16>`:""}render(){return n`
    ...
    `}}m([h({reflect:!0})],w.prototype,"variant");m([h({type:Boolean,reflect:!0})],w.prototype,"show");m([h({reflect:!0})],w.prototype,"role");customElements.get("w-alert")||customElements.define("w-alert",w);const{events:K,args:U,argTypes:V}=A("w-alert"),Y={title:"Feedback/Alert",render(r){return n`
      <w-alert ${_(I(r))}>
        <p>This is an alert message</p>
      </w-alert>
    `},args:U,argTypes:V,parameters:{actions:{handles:K}}},l={args:{variant:"info",show:!0,role:"alert"}},c={args:{variant:"warning",show:!0,role:"alert"}},d={args:{variant:"negative",show:!0,role:"alert"}},u={args:{variant:"positive",show:!0,role:"alert"}},v={args:{variant:"info",show:!0,role:"alert"},render(r){return n`
      <w-alert ${_(I(r))}>
        <h3>Alert Title</h3>

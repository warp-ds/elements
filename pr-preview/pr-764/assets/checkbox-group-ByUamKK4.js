...
`})))()}var L;function R(){return(R=e((()=>{D(),n(),c(),A(),P(),E(),I(),L=class extends O(o){constructor(...e){super(...e),this.value=null,this.indeterminate=!1,this.checked=!1,this.disabled=!1,this.required=!1,this.invalid=!1,this.#e=!1,this.#t=!1,this.#n=!1,this.#r=e=>{e.composedPath()[0]===this&&this.handleClick()},this.#i=()=>{this.#o(),this.#u()},this.#a=e=>{if(!this.disabled&&!e.defaultPrevented&&(e.key===` `||e.key===`Spacebar`||e.key===`Enter`)){if(e.key===`Enter`&&this.internals.form){this.internals.form.requestSubmit();return}e.composedPath()[0]!==this.input&&(e.preventDefault(),this.click())}}}static{this.styles=[T,F]}static{this.shadowRootOptions={...o.shadowRootOptions,delegatesFocus:!0}}set name(e){this._ownName=e}get name(){return this._ownName||this._groupName}#e;#t;#n;get _computedInvalid(){return this.invalid||this._groupInvalid===!0}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,this.#r);let e=this.getAttribute(`value`);this.value=e??`on`,this.#e=this.hasAttribute(`checked`),this.checked=this.#e,this.addEventListener(`invalid`,this.#i),this.addEventListener(`keydown`,this.#a),this.#d()}handleClick(){this.disabled||(this.#o(),this.checked=!this.checked,this.indeterminate=!1,this.updateComplete.then(()=>{this.input.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}))}#r;#i;#a;updated(e){super.updated(e),(e.has(`checked`)||e.has(`indeterminate`))&&this.#f(),this.#p(e)&&(this.#d(),this.#u())}resetFormControl(){this.checked=this.#e,this.#d(),this.#u()}click(){this.disabled||this.input?.click()}focus(e){this.input?.focus(e)}blur(){this.input?.blur()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#u(),this.internals.checkValidity()}reportValidity(){return this.#o(),this.#u(),this.internals.checkValidity()}#o(){this.#n=!0}#s(){return this.input?.validationMessage||` `}#c(){return this.input??void 0}#l(e){this.internals.setValidity(e,this.#s(),this.#c())}#u(){if(this.disabled){this.internals.setValidity({});return}let e=this.required&&!this.checked,t=this.invalid&&!this.#t;if(e){this.#t=!0,this.invalid=this.#n,this.#l({valueMissing:!0});return}if(this.#t&&=(this.invalid=!1,!1),t){this.#l({customError:!0});return}this.internals.setValidity({})}#d(){if(this.disabled){this.setValue(null);return}let e=this.checked?this.value:null;this.setValue(e)}#f(){this.input&&(this.input.checked=this.checked,this.input.indeterminate=this.indeterminate)}#p(e){return e.has(`checked`)||e.has(`value`)||e.has(`disabled`)||e.has(`required`)||e.has(`invalid`)}render(){let e=!this.checked&&this.indeterminate,t=e?`mixed`:this.checked?`true`:`false`;return a`
			<label part="base">
				<span part="control">
					<input
						part="input"

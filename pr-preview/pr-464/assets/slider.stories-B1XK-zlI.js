import{a as O,i as D,r as j,E as u,x as s,n as o,k as p,g as U}from"./iframe-Dh8ICQyY.js";import"./index-C73ILBB_.js";import"./index-BQNulEYW.js";import"./index-C8PLmLUw.js";import{F as A}from"./FormControlMixin-DJnJZbro.js";import{_ as W}from"./preload-helper-Ct5FWWRu.js";import{e as H}from"./query-NYTjQBeo.js";import{o as z}from"./if-defined-BcIm6Iyq.js";const X=O`
  .w-slider {
    position: relative;
    border: none;
    padding: 0;
...
`;var K=Object.defineProperty,h=(i,e,r,a)=>{for(var t=void 0,d=i.length-1,c;d>=0;d--)(c=i[d])&&(t=c(e,r,t)||t);return t&&K(e,r,t),t};class m extends A(D){constructor(){super(...arguments),this.disabled=!1,this.allowValuesOutsideRange=!1,this.helpText="",this.invalid=!1,this.required=!1}static{this.shadowRootOptions={...D.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[j,X]}#e(){const e=this.querySelectorAll("w-slider-thumb");let r=!1;for(const t of e.values())t.min=this.edgeMin,t.max=this.edgeMax,t.step=this.step,t.suffix=this.suffix,t.required=this.required,t.formatter=this.formatter,t.allowValuesOutsideRange=this.allowValuesOutsideRange,t.ariaLabel||(t.slot||(t.ariaLabel=this.label),t.slot==="from"&&(t.ariaLabel=`${this.label} min`),t.slot==="to"&&(t.ariaLabel=`${this.label} max`)),(t.slot==="from"||t.slot==="to")&&(r=!0),t.disabled=this.disabled,t.invalid=this.invalid,this.#s(t);const a=this.shadowRoot.querySelector("fieldset");r?(a.style.setProperty("--active-range-inline-start-padding","var(--w-slider-thumb-size)"),a.style.setProperty("--active-range-inline-end-padding","var(--w-slider-thumb-size)")):a.style.setProperty("--active-range-border-radius","4px")}get edgeMin(){return this.allowValuesOutsideRange?(Number(this.min)-1).toString():this.min}get edgeMax(){return this.allowValuesOutsideRange?(Number(this.max)+1).toString():this.max}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.step&&this.style.setProperty("--step",String(this.step)),this.style.setProperty("--min",this.edgeMin),this.style.setProperty("--max",this.max),this.markers&&this.style.setProperty("--markers",String(this.markers)),this.#e()}updated(e){(e.has("disabled")||e.has("invalid")||e.has("required")||e.has("min")||e.has("step")||e.has("max")||e.has("suffix")||e.has("formatter"))&&this.#e()}#t(e){const r=e.target;this.#s(r),r.slot&&this.#a()}#a(){let e,r;const a=this.querySelectorAll("w-slider-thumb");for(const f of a.values())f.slot==="from"&&(e=f),f.slot==="to"&&(r=f);if(!e||!r||!e.invalid&&!r.invalid)return;const t=e.shadowRoot.querySelector("w-textfield"),d=r.shadowRoot.querySelector("w-textfield"),c=Number(t.value)<=Number(d.value),g=Number(d.value)>=Number(t.value);c&&g&&(e.invalid=!1,r.invalid=!1,e.value!==t.value&&(e.value=t.value),r.value!==d.value&&(r.value=d.value))}#i(e){if(e.stopPropagation(),e.detail.invalid)this.invalid=!0;else{let r=!1;const a=this.querySelectorAll("w-slider-thumb");for(const t of a.values())t.invalid&&(r=!0);this.invalid=r}}#r(e,r){return(r.value===void 0||r.value===null)&&(r.value=this.allowValuesOutsideRange?"":e),r.value===""?e:r.value}#s(e){const r=e.slot;r||this.style.setProperty("--from","0"),r==="from"&&this.style.setProperty("--from",this.#r(this.edgeMin,e)),(!r||r==="to")&&this.style.setProperty("--to",this.#r(this.edgeMax,e))}render(){return s`
      ...
      >
        ...
        ${this.markers?s`<div class="w-slider__markers"></div>`:u}
    ...
    `}}h([o({reflect:!0})],m.prototype,"label");h([o({type:Boolean,reflect:!0})],m.prototype,"disabled");h([o({type:Boolean,attribute:"allow-values-outside-range"})],m.prototype,"allowValuesOutsideRange");h([o({reflect:!0})],m.prototype,"helpText");h([o({type:Boolean,reflect:!0})],m.prototype,"invalid");h([o({type:Boolean,reflect:!0})],m.prototype,"required");h([o({reflect:!0})],m.prototype,"min");h([o({reflect:!0})],m.prototype,"max");h([o({type:Number,reflect:!0})],m.prototype,"markers");h([o({type:Number,reflect:!0})],m.prototype,"step");h([o({reflect:!0})],m.prototype,"suffix");h([o({attribute:!1})],m.prototype,"formatter");customElements.get("w-slider")||customElements.define("w-slider",m);const G=O`
  .w-slider-thumb {
    position: relative;
    display: grid;
...
`,J=O`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.hidden{display:none}.absolute{position:absolute}.relative{position:relative}.static{position:static}.sr-only{clip:rect(0,0,0,0);white-space:nowrap;border-width:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}`;var Q=Object.defineProperty,l=(i,e,r,a)=>{for(var t=void 0,d=i.length-1,c;d>=0;d--)(c=i[d])&&(t=c(e,r,t)||t);return t&&Q(e,r,t),t};class n extends A(D){constructor(){super(...arguments),this.allowValuesOutsideRange=!1,this._showTooltip=!1,this._inputHasFocus=!1,this.anchorPositioningStyleElement=null}static{this.shadowRootOptions={...D.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[j,J,G]}#e(){this._showTooltip=!0,this.shadowRoot.querySelector("w-attention").handleDone()}#t(){this._showTooltip=!1}#a(){this.range&&(this.value===""?this.range.value=this.boundaryValue:this.value&&(this.range.value=this.value))}async#i(e,r){let a=Number.parseInt(e);if(this.allowValuesOutsideRange&&!r&&this.step&&!(this.slot==="to"&&a>=Number(this.max)-1||this.slot==="from"&&a<=Number(this.min)+1)){const w=1/this.step;a=Math.round(a*w)/w,e=a.toString()}const t=Number.parseInt(this.max),d=Number.parseInt(this.min);if(!this.allowValuesOutsideRange&&(a>t||a<d))return this.invalid=!0,{shouldCancel:!0};if(e==="")return this.required&&(this.invalid=!0),{shouldCancel:!0};this.invalid&&(this.invalid=!1),this.value=e;const c=e===this.max||e===this.min;let g=!1;if(this.slot){const f=getComputedStyle(this),w=f.getPropertyValue("--to"),V=f.getPropertyValue("--from");if(this.slot==="from"){const v=Math.min(Number.parseInt(w),this.allowValuesOutsideRange?t-1:t);a>v&&(g=!0,this.allowValuesOutsideRange&&c?this.value=String(v):this.value=w,r&&(this.invalid=!0,await this.updateComplete,this.textfield.value=e))}else{const v=Math.max(Number.parseInt(V),this.allowValuesOutsideRange?d+1:d);a<v&&(g=!0,this.allowValuesOutsideRange&&c?this.value=String(v):this.value=V,r&&(this.invalid=!0,await this.updateComplete,this.textfield.value=e))}}return g?{shouldCancel:!0}:(this.range.value=Math.min(Math.max(Number(e),Number(this.min)),Number(this.max)).toString(),this.value=this.allowValuesOutsideRange&&!r&&c?"":e,this.shadowRoot.querySelector("w-attention").handleDone(),{shouldCancel:!1})}async#r(e){const r=e.currentTarget.tagName==="W-TEXTFIELD";if(e instanceof CustomEvent)return;const a=e.currentTarget.value;return(await this.#i(a,r)).shouldCancel?(e.preventDefault(),!1):!0}async#s(e){if(e.key!=="ArrowLeft"&&e.key!=="ArrowRight")return;const r=Number(this.range.value),a=this.step||1;let t;e.key==="ArrowLeft"?t=r-a:t=r+a,t=Math.min(Math.max(t,Number(this.min)),Number(this.max)),(await this.#i(t.toString(),!1)).shouldCancel&&e.preventDefault()}async connectedCallback(){if(super.connectedCallback(),"anchorName"in document.documentElement.style)await this.updateComplete;else{const e=import.meta.url.substring(0,import.meta.url.lastIndexOf("/"));try{const[{default:r}]=await Promise.all([W(()=>import(`${e}/oddbird-css-anchor-positioning.js`),[],import.meta.url),this.updateComplete]);this.anchorPositioningStyleElement||(this.anchorPositioningStyleElement=document.createElement("style"),this.shadowRoot.prepend(this.anchorPositioningStyleElement)),this.anchorPositioningStyleElement.textContent=`
      ...
      `,await r({roots:[this.shadowRoot],elements:[this.anchorPositioningStyleElement]})}catch(r){console.error(new Error("Error registering the CSS anchor positioning polyfill. The UI will look broken.",{cause:r}))}}this.#a()}#o(e){e instanceof CustomEvent&&e.type==="focus"&&(this._inputHasFocus=!0)}#n(e){e instanceof CustomEvent&&e.type==="blur"&&(this._inputHasFocus=!1)}get boundaryValue(){return this.slot==="from"?this.min:this.max}get textFieldDisplayValue(){return this._inputHasFocus?this.value!==""?this.value:this.range?.value?Math.min(Math.max(Number(this.range.value),Number(this.min)+1),Number(this.max)-1).toString():"":this.value}get tooltipDisplayValue(){return this.formatter?this.formatter(this.value,this.slot):this.value===""?this.range?.value??this.boundaryValue:this.value||0}updated(e){e.has("value")&&(this.setValue(this.value),this.#a()),e.has("invalid")&&this.dispatchEvent(new CustomEvent("slidervalidity",{bubbles:!0,detail:{invalid:this.invalid}}))}render(){return s`
      <div class="w-slider-thumb">
        <label for="range">${this.label}</label>
        ${"anchorName"in document.documentElement.style?u:s`<div class="polyfill-range">
        ...
        <input
          ...
          @blur="${this.#t}"
          @input="${this.#r}"
          @keydown="${this.allowValuesOutsideRange?this.#s:u}"
        />

        ${this.slot==="from"?s`<span class="w-slider-thumb__from-marker"
              >${this.formatter?this.formatter(this.allowValuesOutsideRange?"":this.min,"from"):this.min}
              ${this.suffix}</span
            >`:u}
        ${this.slot==="to"?s`<span class="w-slider-thumb__to-marker"
        ...
        >
          ...
          ></output>
          <span slot="message">
            ${this.tooltipDisplayValue}${this.suffix?s`&nbsp;${this.suffix}`:u}
          </span>
        </w-attention>
    ...
    `}},_={args:{locale:"nb",suffix:"m²"},render({locale:i,suffix:e}){return s(q||(q=b([`
      <w-slider
      ...
      <\/script>
    `])),e,i)}},k={args:{locale:"nb",suffix:"kr"},render({locale:i,suffix:e}){return s(I||(I=b([`
      <w-slider
        label="Price"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,i)}},S={args:{locale:"nb",suffix:"km"},render({locale:i,suffix:e}){return s(P||(P=b([`
      <w-slider
        label="Distance"
        min="0"
        max="250000"
      ...
      <\/script>
    `])),e,i)}},T={args:{locale:"nb",step:"5",markers:"5"},render({markers:i,step:e}){return s`
      <w-slider
        label="Single"
        min="0"
        max="100"
    ...
    `}},$={args:{step:5},render({step:i}){return s`
      <w-slider label="Single" step="${i}" min="0" max="100">
        <w-slider-thumb name="value"></w-slider-thumb>
      </w-slider>
    `}},E={args:{},render(){return s(M||(M=b([`

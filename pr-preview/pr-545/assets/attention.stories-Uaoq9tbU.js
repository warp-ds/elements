import{g as w,b as e}from"./iframe-BXBvKFIB.js";import{s as c,p as v}from"./utilities-CkmRsFn0.js";import"./attention-BbNrEzEv.js";import"./button-CilqmGVx.js";var p=Object.freeze,y=Object.defineProperty,l=(t,g)=>p(y(t,"raw",{value:p(t.slice())})),d,u,m,b;const{events:E,args:I,argTypes:f}=w("w-attention"),T={title:"Overlays/Attention",render(t){return e`
      <w-attention ${c(v(t))}>
        <w-button
          ${c({id:t.buttonId})}
          variant="secondary"

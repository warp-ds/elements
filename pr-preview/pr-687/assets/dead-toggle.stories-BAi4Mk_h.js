import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{C as n,Ht as r,Lt as i,M as a,N as o,Rt as s,Wt as c,_ as l,l as u,o as d,s as f,u as p}from"./iframe-DDE3dW4Z.js";import{a as m,n as h,r as g,t as _}from"./utilities-DgX-ZO1b.js";var v,y=t((()=>{i(),v=c`
  [part~='label'] {
    display: block;
...
`})),b,x=t((()=>{i(),l(),d(),y(),p(),b=class extends s{constructor(...e){super(...e),this.checked=!1,this.indeterminate=!1,this.invalid=!1,this.disabled=!1}get indeterminateMarker(){return!this.checked&&this.indeterminate?`–`:``}render(){return r` <div class="control">${this.indeterminateMarker}</div> `}static{this.styles=[f,v]}},u([n({type:String,reflect:!0})],b.prototype,`type`,void 0),u([n({type:Boolean,reflect:!0})],b.prototype,`checked`,void 0),u([n({type:Boolean,reflect:!0})],b.prototype,`indeterminate`,void 0),u([n({type:Boolean,reflect:!0})],b.prototype,`invalid`,void 0),u([n({type:Boolean,reflect:!0})],b.prototype,`disabled`,void 0),customElements.get(`w-dead-toggle`)||customElements.define(`w-dead-toggle`,b)})),S=e({Checkbox:()=>O,Checked:()=>A,Indeterminate:()=>k,Invalid:()=>j,Radio:()=>D,__namedExportsOrder:()=>M,default:()=>E}),C,w,T,E,D,O,k,A,j,M,N=t((()=>{g(),o(),i(),_(),x(),{events:C,args:w,argTypes:T}=a(`w-dead-toggle`),E={title:`Forms/Dead toggle`,render(e){return r`<w-dead-toggle ${m(h(e))}></w-dead-toggle>`},args:w,argTypes:T,parameters:{actions:{handles:C}}},D={args:{type:`radio`}},O={args:{type:`checkbox`}},k={args:{indeterminate:!0}},A={args:{checked:!0}},j={args:{invalid:!0}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  args: {
    type: 'radio'
  }

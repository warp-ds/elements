import{g as t,k as l}from"./iframe-BEtGJJdy.js";import{s as c,p as d}from"./utilities-C6Ud48s_.js";const{events:u,args:p,argTypes:i}=t("w-box"),g={title:"Layout/Box",render:n=>l`
      <w-box ${c(d(n))}>
        <h3>Box Content</h3>

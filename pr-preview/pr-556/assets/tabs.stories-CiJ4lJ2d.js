import{p as F,n as c,m as D,i as m,k as O,b as r,a as $,r as C,j as x}from"./iframe-Cdgy4QBI.js";import{e as z}from"./query-NYTjQBeo.js";import{u as L}from"./utils-CCcvPjT2.js";var P=Object.defineProperty,v=(i,t,n,a)=>{for(var e=void 0,o=i.length-1,s;o>=0;o--)(s=i[o])&&(e=s(t,n,e)||e);return e&&P(t,n,e),e},R=`:host {
...
`,_=new Map,q='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"></svg>';function M(i,t={}){const n=t.responseParser??(a=>a.text());return _.has(i)||_.set(i,fetch(i).then(n)),_.get(i)}var d=class extends m{constructor(){super(...arguments),this.name="",this.size="medium",this.locale="en",this.svg=null}async fetchIcon(i){const t=`https://assets.finn.no/pkg/eikons/v1/${this.locale}/${i}.svg`;try{const n=await M(t);return new DOMParser().parseFromString(n,"text/html").body.querySelector("svg")}catch{return null}}firstUpdated(){this.loadIcon()}updated(i){(i.has("name")||i.has("locale"))&&this.loadIcon()}async loadIcon(){if(!this.name){this.svg=null;return}let i=await this.fetchIcon(this.name);i||(i=new DOMParser().parseFromString(q,"text/html").body.firstElementChild),this.svg=i}render(){const i={"w-icon":!0,"w-icon--s":this.size==="small","w-icon--m":this.size==="medium","w-icon--l":this.size==="large"},t=typeof this.size=="string"&&this.size.endsWith("px")?`--w-icon-size: ${this.size};`:"";return r`<div class="${O(i)}" style="${t}" part="w-${this.name.toLowerCase()}">${this.svg}</div>`}};d.styles=[F(R)];v([c({type:String,reflect:!0})],d.prototype,"name");v([c({type:String,reflect:!0})],d.prototype,"size");v([c({type:String,reflect:!0})],d.prototype,"locale");v([D()],d.prototype,"svg");customElements.get("w-icon")||customElements.define("w-icon",d);const I=$`*,:before,:after{--w-rotate:0;--w-rotate-x:0;--w-rotate-y:0;--w-rotate-z:0;--w-scale-x:1;--w-scale-y:1;--w-scale-z:1;--w-skew-x:0;--w-skew-y:0;--w-translate-x:0;--w-translate-y:0;--w-translate-z:0}.border-b{border-bottom-width:1px}.border-b-4{border-bottom-width:4px}.inline-block{display:inline-block}.inline-grid{display:inline-grid}.hidden{display:none}.grid-cols-1{grid-template-columns:repeat(1,minmax(0,1fr))}.grid-cols-2{grid-template-columns:repeat(2,minmax(0,1fr))}.grid-cols-3{grid-template-columns:repeat(3,minmax(0,1fr))}.grid-cols-4{grid-template-columns:repeat(4,minmax(0,1fr))}.grid-cols-5{grid-template-columns:repeat(5,minmax(0,1fr))}.grid-cols-6{grid-template-columns:repeat(6,minmax(0,1fr))}.grid-cols-7{grid-template-columns:repeat(7,minmax(0,1fr))}.grid-cols-8{grid-template-columns:repeat(8,minmax(0,1fr))}.grid-cols-9{grid-template-columns:repeat(9,minmax(0,1fr))}.-bottom-0{bottom:0}.absolute{position:absolute}.relative{position:relative}.static{position:static}.s-border{border-color:var(--w-s-color-border)}.s-border-selected{border-color:var(--w-s-color-border-selected)}.-mb-1{margin-bottom:-.1rem}.mb-32{margin-bottom:3.2rem}.resize{resize:both}.transition-all{transition-property:all;transition-duration:.15s;transition-timing-function:cubic-bezier(.4,0,.2,1)}.bg-transparent{background-color:#0000}.appearance-none{-webkit-appearance:none;appearance:none}.border-0{border-width:0}.border-b-4{border-bottom-width:4px}.border-transparent{border-color:#0000}.inline-block{display:inline-block}.flex{display:flex}.grid{display:grid}.focusable:focus{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:focus-visible{outline:2px solid var(--w-s-color-border-focus);outline-offset:var(--w-outline-offset,1px)}.focusable:not(:focus-visible){outline:none}.gap-8{gap:.8rem}.focus\\:outline-none:focus{outline-offset:2px;outline:2px solid #0000}.items-center{align-items:center}.justify-center{justify-content:center}.static{position:static}.s-text-link{color:var(--w-s-color-text-link)}.s-text-subtle{color:var(--w-s-color-text-subtle)}.hover\\:s-text-link:hover{color:var(--w-s-color-text-link)}.s-border-selected{border-color:var(--w-s-color-border-selected)}.hover\\:s-border-primary:hover{border-color:var(--w-s-color-border-primary)}.m-0{margin:0}.mx-auto{margin-left:auto;margin-right:auto}.p-0{padding:0}.p-16{padding:1.6rem}.pb-8{padding-bottom:.8rem}.cursor-pointer{cursor:pointer}.font-bold{font-weight:700}.w-full{width: 100%;}`;var W=Object.defineProperty,j=(i,t,n,a)=>{for(var e=void 0,o=i.length-1,s;o>=0;o--)(s=i[o])&&(e=s(t,n,e)||e);return e&&W(t,n,e),e};class A extends m{constructor(){super(...arguments),this.hidden=!0}static{this.styles=[C,I]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tabpanel")}render(){return r`<slot></slot>`}}j([c({type:Boolean,reflect:!0})],A.prototype,"hidden");customElements.get("w-tab-panel")||customElements.define("w-tab-panel",A);var B=Object.defineProperty,p=(i,t,n,a)=>{for(var e=void 0,o=i.length-1,s;o>=0;o--)(s=i[o])&&(e=s(t,n,e)||e);return e&&B(t,n,e),e};const l={base:"grid w-full items-center font-bold gap-8 antialias p-16 pb-8 border-b-4 bg-transparent border-transparent hover:s-text-link hover:s-border-primary",inactive:"s-text-subtle",active:"s-text-link s-border-selected",icon:"mx-auto",content:"flex items-center justify-center gap-8",contentUnderlined:"content-underlined"},N="focus:outline-none appearance-none cursor-pointer bg-transparent border-0 m-0 p-0 inline-block";class b extends m{constructor(){super(...arguments),this._handleClick=t=>{t.tab||(t.tab=this)},this.id="",this.for="",this.active=!1,this.over=!1}static{this.styles=[C,I,$`::slotted([slot="icon"]){display:flex}`]}get _classes(){return x([N,l.base,this.active||this.ariaSelected==="true"?l.active:l.inactive])}get _hasIcon(){return this.querySelector('[slot="icon"]')!==null}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab"),this.setAttribute("aria-controls",this.for),this.addEventListener("click",this._handleClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this._handleClick)}updated(t){super.updated(t),t.has("active")&&this.hasAttribute("active")&&this.setAttribute("aria-selected",this.active?"true":"false"),t.has("for")&&this.setAttribute("aria-controls",this.for)}render(){const t=this._hasIcon;return r`
    ...
    `}}k([c({reflect:!0})],g.prototype,"active");k([z('[role="tablist"]')],g.prototype,"tabList");k([z(".selection-indicator")],g.prototype,"selectionIndicator");customElements.get("w-tabs")||customElements.define("w-tabs",g);const H={title:"Components/Tabs"},h=()=>r`
  <w-tabs active="tab2">

import{n as e}from"./chunk-BneVvdWh.js";import{m as t,n,r,s as i,t as a}from"./lit-C07f_Bua.js";import{n as o,o as s,r as c,t as l}from"./decorate-BZxMavXy.js";import{n as u,t as d}from"./styles-BM5RxtAH.js";var f,p=e((()=>{a(),f=t`
...
`})),m,h,g=e((()=>{a(),c(),d(),p(),o(),m=[`primary`,`secondary`,`negative`,`negativeQuiet`,`utility`,`utilityQuiet`,`quiet`,`link`,`overlay`,`overlayInverted`,`overlayQuiet`,`overlayInvertedQuiet`],h=class extends n{constructor(...e){super(...e),this.autofocus=!1,this.small=!1,this.disabled=!1,this.fullWidth=!1}static{this.shadowRootOptions={...n.shadowRootOptions,delegatesFocus:!0}}static{this.styles=[u,f]}connectedCallback(){if(super.connectedCallback(),this.variant&&!m.includes(this.variant))throw Error(`Invalid "variant" attribute. Set its value to one of the following:\n${m.join(`, `)}.`)}firstUpdated(){this.autofocus&&setTimeout(()=>this.focus(),0)}render(){return i`
      <a
        href="${this.href}"
        target="${this.target}"
    ...
    `}},l([s({type:Boolean,reflect:!0})],h.prototype,`autofocus`,void 0),l([s({reflect:!0})],h.prototype,`variant`,void 0),l([s({type:Boolean,reflect:!0})],h.prototype,`small`,void 0),l([s({reflect:!0})],h.prototype,`href`,void 0),l([s({type:Boolean,reflect:!0})],h.prototype,`disabled`,void 0),l([s({reflect:!0})],h.prototype,`target`,void 0),l([s({reflect:!0})],h.prototype,`rel`,void 0),l([s({attribute:`full-width`,type:Boolean,reflect:!0})],h.prototype,`fullWidth`,void 0),customElements.get(`w-link`)||customElements.define(`w-link`,h)}));export{g as t};
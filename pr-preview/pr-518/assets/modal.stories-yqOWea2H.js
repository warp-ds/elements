import{b as i,r as k,a as v,n as d,i as x,v as _,A as T,l as I,d as M,m as F,g as E}from"./iframe-DYb0rld_.js";import{s as S,p as B}from"./utilities-BIbceZT9.js";import{e as y}from"./query-NYTjQBeo.js";let f=[];const C={documentElement:{},body:{}},z=Object.freeze({documentElement:{"scrollbar-gutter":"stable"},body:{overflow:"hidden",position:"relative",height:"100%"}}),L=e=>{e.touches.length>1||e.preventDefault?.()},j=e=>([t,o])=>{C[e][t]=document[e].style[t],document[e].style[t]=o},A=()=>Object.entries(z).forEach(([e,t])=>{Object.entries(t).forEach(j(e))}),P=e=>([t,o])=>{document[e].style[t]=C[e][t]},q=()=>Object.entries(C).forEach(([e,t])=>{Object.entries(t).forEach(P(e))}),W=e=>e.scrollHeight-Math.abs(e.scrollTop)===e.clientHeight;function R(e){let t=-1;const o=n=>{if(n.targetTouches.length!==1)return;const a=n.targetTouches[0].clientY-t;return e.scrollTop===0&&a>0||W(e)&&a<0?L(n):(n.stopPropagation(),!0)};e.ontouchstart=n=>{n.targetTouches.length===1&&(t=n.targetTouches[0].clientY)},e.ontouchmove=o}function Y(e){e.ontouchstart=null,e.ontouchmove=null}const $=e=>()=>document[e?"addEventListener":"removeEventListener"]("touchmove",L,{passive:!1}),N=$(!0),J=$();function K(e){if(!e)throw Error("Could not run setup, an element must be provided");f.some(t=>t===e)||(f.length||(A(),N()),R(e),f.push(e))}function G(){f.forEach(Y),J(),q(),f=[]}const O=e=>class extends e{constructor(){super(...arguments),this.patchClose=!0,this._close=null}close(){this._close()}},D=e=>class extends e{handleSlotChange(t){const o=t.target.assignedNodes({flatten:!0});for(const n of o.filter(a=>a.patchClose))n._close=()=>this.close()}};var U=Object.defineProperty,c=(e,t,o,n)=>{for(var a=void 0,r=e.length-1,s;r>=0;r--)(s=e[r])&&(a=s(t,o,a)||a);return a&&U(t,o,a),a};class l extends D(x){constructor(){super(),this.interceptEscape=this.interceptEscape.bind(this),this.closeOnBackdropClick=this.closeOnBackdropClick.bind(this),this.eventPreventer=this.eventPreventer.bind(this),this.modifyBorderRadius=this.modifyBorderRadius.bind(this)}async open(){this.dialogEl.showModal(),this.handleListeners(),K(this.contentEl),await this.updateComplete,this.dispatchEvent(new CustomEvent("shown",{bubbles:!0,composed:!0}))}close(){this.handleListeners("removeEventListener"),this.dialogEl.classList.add("close"),this.dialogEl.addEventListener("animationend",async()=>{this.dialogEl.classList.remove("close"),this.dialogEl.close(),G(),await this.updateComplete,this.dispatchEvent(new CustomEvent("hidden",{bubbles:!0,composed:!0}))},{once:!0})}render(){return i`

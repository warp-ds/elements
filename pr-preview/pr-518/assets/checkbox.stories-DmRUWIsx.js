import{f as G,u as H,v as u,w as R,E as B,A as F,x as D,a as z,i as $,r as W,b as i,n as c,q as U,l as A,g as N}from"./iframe-D1mHxl24.js";import{s as j,p as J}from"./utilities-DqWt1k43.js";import{e as P}from"./query-NYTjQBeo.js";import{o as E}from"./if-defined-D0Td7Xln.js";import{F as M}from"./FormControlMixin-DJnJZbro.js";/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const L=G(class extends H{constructor(a){if(super(a),a.type!==u.PROPERTY&&a.type!==u.ATTRIBUTE&&a.type!==u.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!R(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===B||e===F)return e;const t=a.element,s=a.name;if(a.type===u.PROPERTY){if(e===t[s])return B}else if(a.type===u.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return B}else if(a.type===u.ATTRIBUTE&&t.getAttribute(s)===e+"")return B;return D(a),e}}),Y=z`
  :host {
...
`;var K=Object.defineProperty,d=(a,e,t,s)=>{for(var r=void 0,o=a.length-1,l;o>=0;o--)(l=a[o])&&(r=l(e,t,r)||r);return r&&K(e,t,r),r};class n extends M($){constructor(){super(...arguments),this.name="",this.value=null,this.indeterminate=!1,this.checked=!1,this.disabled=!1,this.required=!1,this.invalid=!1,this.#e=!1,this.#t=!1,this.#r=!1,this.#o=!1,this.#h=()=>{this.#n(),this.#a()},this.#u=e=>{this.disabled||e.defaultPrevented||e.key!==" "&&e.key!=="Spacebar"&&e.key!=="Enter"||e.composedPath()[0]!==this.input&&(e.preventDefault(),this.click())}}static{this.styles=[W,Y]}static{this.shadowRootOptions={...$.shadowRootOptions,delegatesFocus:!0}}#e;#t;#r;#o;connectedCallback(){super.connectedCallback(),this.setAttribute("type","checkbox");const e=this.getAttribute("value");this.value=e??"on",this.#e=this.hasAttribute("checked"),this.checked=this.#e,this.#i(),this.addEventListener("invalid",this.#h),this.addEventListener("keydown",this.#u),this.#s()}handleClick(){this.disabled||(this.#n(),this.checked=!this.checked,this.indeterminate=!1,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}))}#h;#u;updated(e){super.updated(e),(e.has("checked")||e.has("indeterminate"))&&this.#b(),this.#v(e)&&(this.#s(),this.#a()),e.has("disabled")&&this.#i()}resetFormControl(){this.checked=this.#e,this.#s(),this.#a()}click(){this.disabled||this.input?.click()}focus(e){this.input?.focus(e)}blur(){this.input?.blur()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#a(),this.internals.checkValidity()}reportValidity(){return this.#n(),this.#a(),this.internals.checkValidity()}#n(){this.#r=!0}#l(){return this.input?.validationMessage||" "}#p(){return this.input??void 0}#d(e){this.internals.setValidity(e,this.#l(),this.#p())}#a(){if(this.disabled){this.internals.setValidity({});return}const e=this.required&&!this.checked,t=this.invalid&&!this.#t;if(e){this.#t=!0,this.invalid=this.#r,this.#d({valueMissing:!0});return}if(this.#t&&(this.invalid=!1,this.#t=!1),t){this.#d({customError:!0});return}this.internals.setValidity({})}#s(){if(this.disabled){this.setValue(null);return}const e=this.checked?this.value:null;this.setValue(e)}#b(){this.input&&(this.input.checked=this.checked,this.input.indeterminate=this.indeterminate)}#i(){this.hasAttribute("tabindex")&&!this.#o||(this.tabIndex=this.disabled?-1:0,this.#o=!0)}#v(e){return e.has("checked")||e.has("value")||e.has("disabled")||e.has("required")||e.has("invalid")}render(){const e=!this.checked&&this.indeterminate,t=e?"mixed":this.checked?"true":"false";return i`
    ...
    `}}d([P('input[type="checkbox"]')],n.prototype,"input");d([c({reflect:!0})],n.prototype,"name");d([c({reflect:!0})],n.prototype,"value");d([c({type:Boolean,reflect:!0})],n.prototype,"indeterminate");d([c({type:Boolean,reflect:!0})],n.prototype,"checked");d([c({type:Boolean,reflect:!0})],n.prototype,"disabled");d([c({type:Boolean,reflect:!0})],n.prototype,"required");d([c({type:Boolean,reflect:!0})],n.prototype,"invalid");customElements.get("w-checkbox")||customElements.define("w-checkbox",n);const Q=JSON.parse('{"checkbox-group.validation.required":["Mindst én valgt mulighed er påkrævet."],"checkbox-group.label.optional":["Valgfri"]}'),X=JSON.parse('{"checkbox-group.validation.required":["At least one selection is required."],"checkbox-group.label.optional":["Optional"]}'),Z=JSON.parse('{"checkbox-group.validation.required":["Vähintään yksi valinta vaaditaan."],"checkbox-group.label.optional":["Valinnainen"]}'),ee=JSON.parse('{"checkbox-group.validation.required":["Minst ett valg er påkrevd."],"checkbox-group.label.optional":["Valgfri"]}'),te=JSON.parse('{"checkbox-group.validation.required":["Minst ett val krävs."],"checkbox-group.label.optional":["Valfritt"]}');var re=Object.defineProperty,b=(a,e,t,s)=>{for(var r=void 0,o=a.length-1,l;o>=0;o--)(l=a[o])&&(r=l(e,t,r)||r);return r&&re(e,t,r),r};U(X,ee,Z,Q,te);const ae=()=>A._({id:"checkbox-group.validation.required",message:"At least one selection is required.",comment:"Shown when required checkbox group has no selections"});class h extends M($){#e=!1;#t=!1;#r=!1;#o;static{this.styles=z`
    .wrapper {
      display: inline-flex;
  ...
  `}render(){const e=this.#d()>0,s=this.required&&!e&&this.#e,r=this.invalid||s,o=r?this.#v():this.helpText,l=o?"checkbox-group__help":void 0,V=this.label?"checkbox-group__label":void 0,O=r?"true":void 0;return i`
    ...
    `}connectedCallback(){super.connectedCallback(),this.addEventListener("change",this.#h),this.addEventListener("invalid",this.#u),this.addEventListener("slotchange",this.#n),this.#o=A.on("change",this.#p),this.setValue(null),this.#x()}disconnectedCallback(){this.#o?.(),this.#o=void 0,super.disconnectedCallback()}checkValidity(){return this.#c(),this.internals.checkValidity()}reportValidity(){return this.#l(),this.#c(),this.internals.checkValidity()}focus(e){const t=this.#b();if(t?.focus){t.focus(e);return}HTMLElement.prototype.focus.call(this,e)}#h=()=>{this.#l(),this.#c(),this.requestUpdate()};#u=()=>{this.#l(),this.#c(),this.requestUpdate()};#n=()=>{this.#a(),this.#c(),this.requestUpdate()};#l(){this.#e=!0}#p=()=>{this.requestUpdate()};#d(){return this.#i().filter(e=>e.checked).length}#a(){if(this.name)for(const e of this.#i()){const t=e;t&&typeof t=="object"&&!t.name&&(t.name=this.name)}}#s(e){for(const t of this.#i())"invalid"in t&&(t.invalid=e)}#b(){return this.#i()[0]}#i(){return this.shadowRoot?.querySelector("slot")?.assignedElements({flatten:!0})??[]}#v(){return ae()}updated(e){super.updated(e),this.#k(e)&&(e.has("name")&&this.#a(),this.#c())}#k(e){return e.has("invalid")||e.has("required")||e.has("helpText")||e.has("name")}#m(e){const t=this.#b();this.internals.setValidity(e," ",t??void 0)}#g(e){if(!(this.hasAttribute("tabindex")&&!this.#r)){if(e){this.tabIndex=0,this.#r=!0;return}this.#r&&(this.removeAttribute("tabindex"),this.#r=!1)}}#c(){this.#x();const e=this.#d()>0,t=this.required&&!e,s=this.invalid,r=t&&this.#e,o=s||r;if(this.#g(o),t){this.#m({valueMissing:!0}),this.#s(o);return}if(s){this.#m({customError:!0}),this.#s(!0);return}this.internals.setValidity({}),this.#s(!1)}#x(){this.#t||this.internals.form&&(this.name&&this.name.trim().length>0||(console.warn('w-checkbox-group: "name" is required for form submission.'),this.#t=!0))}}b([c({type:String,reflect:!0})],h.prototype,"label");b([c({type:String,reflect:!0})],h.prototype,"name");b([c({type:Boolean,reflect:!0})],h.prototype,"optional");b([c({type:String,reflect:!0,attribute:"help-text"})],h.prototype,"helpText");b([c({type:Boolean,reflect:!0})],h.prototype,"required");b([c({type:Boolean,reflect:!0})],h.prototype,"invalid");customElements.get("w-checkbox-group")||customElements.define("w-checkbox-group",h);const{events:oe,args:se,argTypes:ie}=N("w-checkbox"),ce={title:"Forms/Checkbox",render(a){return i`
...
}`,...q.parameters?.docs?.source}}};const ne=["Default","Invalid","Indeterminate","IndeterminateError","IndeterminateDisabled","CheckboxFormAssociated","Disabled","CheckboxGroup","CheckboxGroupWithHelpText","CheckboxGroupWithLabel","CheckboxGroupWithHelpTextAndLabel","CheckboxGroupWithOptional","CheckboxGroupWithInvalid","CheckboxGroupRequired","CheckboxGroupFormAssociated"],pe=Object.freeze(Object.defineProperty({__proto__:null,CheckboxFormAssociated:g,CheckboxGroup:w,CheckboxGroupFormAssociated:q,CheckboxGroupRequired:T,CheckboxGroupWithHelpText:y,CheckboxGroupWithHelpTextAndLabel:S,CheckboxGroupWithInvalid:C,CheckboxGroupWithLabel:_,CheckboxGroupWithOptional:I,Default:p,Disabled:f,Indeterminate:m,IndeterminateDisabled:k,IndeterminateError:x,Invalid:v,__namedExportsOrder:ne,default:ce},Symbol.toStringTag,{value:"Module"}));export{pe as C,p as D,v as I,f as a,m as b,x as c,k as d,w as e,y as f,_ as g,I as h,T as i,g as j,q as k};

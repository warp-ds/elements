import{f as G,p as R,t as u,q as H,E as v,A as L,s as D,a as z,i as $,r as O,b as i,n as c,l as V,m as W,g as N}from"./iframe-BHjNvoPB.js";import{s as U,p as j}from"./utilities-BtlQZykp.js";import{e as Y}from"./query-NYTjQBeo.js";import{o as p}from"./if-defined-Dh9cH9nJ.js";import{F as A}from"./FormControlMixin-DJnJZbro.js";import"./preload-helper-Ct5FWWRu.js";/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const M=G(class extends R{constructor(o){if(super(o),o.type!==u.PROPERTY&&o.type!==u.ATTRIBUTE&&o.type!==u.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!H(o))throw Error("`live` bindings can only contain a single expression")}render(o){return o}update(o,[e]){if(e===v||e===L)return e;const t=o.element,a=o.name;if(o.type===u.PROPERTY){if(e===t[a])return v}else if(o.type===u.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(a))return v}else if(o.type===u.ATTRIBUTE&&t.getAttribute(a)===e+"")return v;return D(o),e}}),Q=z`
  :host {
...
`;var J=Object.defineProperty,l=(o,e,t,a)=>{for(var r=void 0,s=o.length-1,b;s>=0;s--)(b=o[s])&&(r=b(e,t,r)||r);return r&&J(e,t,r),r};class n extends A($){constructor(){super(...arguments),this.name="",this.value=null,this.indeterminate=!1,this.checked=!1,this.disabled=!1,this.required=!1,this.invalid=!1,this.#t=!1,this.#e=!1,this.#r=!1,this.#a=()=>{this.#r=!0,this.#o()}}static{this.styles=[O,Q]}static{this.shadowRootOptions={...$.shadowRootOptions,delegatesFocus:!0}}#t;#e;#r;connectedCallback(){super.connectedCallback(),this.setAttribute("type","checkbox");const e=this.getAttribute("value");this.value=e??"on",this.#t=this.hasAttribute("checked"),this.checked=this.#t,this.addEventListener("invalid",this.#a),this.#s()}disconnectedCallback(){this.removeEventListener("invalid",this.#a),super.disconnectedCallback()}handleClick(){this.disabled||(this.#r=!0,this.checked=!this.checked,this.indeterminate=!1,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}))}#a;updated(e){super.updated(e),(e.has("checked")||e.has("indeterminate"))&&this.input&&(this.input.checked=this.checked,this.input.indeterminate=this.indeterminate),(e.has("checked")||e.has("value")||e.has("disabled")||e.has("required")||e.has("invalid"))&&(this.#s(),this.#o())}resetFormControl(){this.checked=this.#t,this.#s(),this.#o()}click(){this.disabled||this.input?.click()}focus(e){this.input?.focus(e)}blur(){this.input?.blur()}get validationMessage(){return this.internals.validationMessage}get validity(){return this.internals.validity}checkValidity(){return this.#o(),this.internals.checkValidity()}reportValidity(){return this.#r=!0,this.#o(),this.internals.checkValidity()}#o(){if(this.disabled){this.internals.setValidity({});return}if(this.required&&!this.checked){this.#e=!0,this.#r?this.invalid=!0:this.invalid=!1;const e=this.input?.validationMessage||" ",t=this.input??void 0;this.internals.setValidity({valueMissing:!0},e,t);return}if(this.invalid&&!this.#e){const e=this.input?.validationMessage||" ",t=this.input??void 0;this.internals.setValidity({customError:!0},e,t);return}this.#e&&(this.invalid=!1,this.#e=!1),this.internals.setValidity({})}#s(){if(this.disabled){this.setValue(null);return}const e=this.checked?this.value:null;this.setValue(e)}render(){const e=!this.checked&&this.indeterminate,t=e?"mixed":this.checked?"true":"false";return i`
    ...
    `}}l([Y('input[type="checkbox"]')],n.prototype,"input");l([c({reflect:!0})],n.prototype,"name");l([c({reflect:!0})],n.prototype,"value");l([c({type:Boolean,reflect:!0})],n.prototype,"indeterminate");l([c({type:Boolean,reflect:!0})],n.prototype,"checked");l([c({type:Boolean,reflect:!0})],n.prototype,"disabled");l([c({type:Boolean,reflect:!0})],n.prototype,"required");l([c({type:Boolean,reflect:!0})],n.prototype,"invalid");customElements.get("w-checkbox")||customElements.define("w-checkbox",n);var K=Object.defineProperty,d=(o,e,t,a)=>{for(var r=void 0,s=o.length-1,b;s>=0;s--)(b=o[s])&&(r=b(e,t,r)||r);return r&&K(e,t,r),r};const m=()=>V._({id:"checkbox-group.validation.required",message:"At least one selection is required.",comment:"Shown when required checkbox group has no selections"});class h extends A($){constructor(){super(...arguments),this._validationMessage=null,this.#t=!1,this.#e=!1,this.#r=!1,this.#a=()=>{this.#e=!0,this.#i()},this.#o=()=>{this.#e=!0,this.#i()},this.#s=()=>{this.#l(),this.#i()}}#t;#e;#r;static{this.styles=z`
    .wrapper {
      display: inline-flex;
  ...
  `}render(){const e=this.invalid||this._validationMessage,t=this.helpText||e?"checkbox-group__help":void 0,a=this.label?"checkbox-group__label":void 0,r=this._validationMessage??(this.invalid?m():this.helpText),s=e?"true":void 0;return i`
      <div class="wrapper">
        ...
        ${r?i`<div class="${e?"help-text error":"help-text"}" id="${t}">${r}</div>`:L}
      </div>
    `}connectedCallback(){super.connectedCallback(),this.addEventListener("change",this.#a),this.addEventListener("invalid",this.#o),this.addEventListener("slotchange",this.#s),this.setValue(null),this.#n()}disconnectedCallback(){this.removeEventListener("change",this.#a),this.removeEventListener("invalid",this.#o),this.removeEventListener("slotchange",this.#s),super.disconnectedCallback()}checkValidity(){return this.#i(),this.internals.checkValidity()}reportValidity(){return this.#e=!0,this.#i(),this.internals.checkValidity()}#a;#o;#s;#d(){return(this.shadowRoot?.querySelector("slot")?.assignedElements({flatten:!0})??[]).filter(a=>a.checked).length}#l(){if(!this.name)return;const t=this.shadowRoot?.querySelector("slot")?.assignedElements({flatten:!0})??[];for(const a of t){const r=a;r&&typeof r=="object"&&!r.name&&(r.name=this.name)}}#c(e){const a=this.shadowRoot?.querySelector("slot")?.assignedElements({flatten:!0})??[];for(const r of a)"invalid"in r&&(r.invalid=e)}#h(){return(this.shadowRoot?.querySelector("slot")?.assignedElements({flatten:!0})??[])[0]}updated(e){super.updated(e),(e.has("invalid")||e.has("required")||e.has("helpText")||e.has("name"))&&(e.has("name")&&this.#l(),e.has("name")&&this.#n(),this.#i())}#i(){this.#n();const e=this.#d()>0;if(this.required&&!e){if(this.#t=!0,this.#e){const a=m();this.invalid=!0,this._validationMessage=a}else this.invalid=!1,this._validationMessage=null;const t=m();this.internals.setValidity({valueMissing:!0},t,this.#h()),this.#c(this.invalid);return}if(this.#t&&(this.invalid=!1,this.#t=!1),this.invalid){const t=m();this._validationMessage=t,this.internals.setValidity({customError:!0},t,this.#h()),this.#c(!0);return}this._validationMessage=null,this.internals.setValidity({}),this.#c(!1)}#n(){this.#r||this.internals.form&&(this.name&&this.name.trim().length>0||(console.warn('w-checkbox-group: "name" is required for form submission.'),this.#r=!0))}}d([c({type:String,reflect:!0})],h.prototype,"label");d([c({type:String,reflect:!0})],h.prototype,"name");d([c({type:Boolean,reflect:!0})],h.prototype,"optional");d([c({type:String,reflect:!0,attribute:"help-text"})],h.prototype,"helpText");d([c({type:Boolean,reflect:!0})],h.prototype,"required");d([c({type:Boolean,reflect:!0})],h.prototype,"invalid");d([W()],h.prototype,"_validationMessage");customElements.get("w-checkbox-group")||customElements.define("w-checkbox-group",h);const{events:X,args:Z,argTypes:P}=N("w-checkbox"),ie={title:"Forms/Checkbox",render(o){return i`
      <w-checkbox ${U(j(o))}>Check me</w-checkbox>
    `},args:Z,argTypes:P,parameters:{actions:{handles:X}}},k={},x={args:{name:"invalidfoo",value:"bar",invalid:!0}},g={args:{name:"indeterminatefoo",value:"bar",indeterminate:!0}},f={args:{name:"indeterminateerrorfoo",value:"bar",indeterminate:!0,invalid:!0}},w={args:{name:"indeterminatedisabledfoo",value:"bar",indeterminate:!0,disabled:!0}},y={render:()=>i`
    ...
    `},_={args:{name:"disabledfoo",value:"bar",disabled:!0}},S={render:()=>i`

import{g as w,b as e}from"./iframe-BdBsAI8l.js";import{s as c,p as v}from"./utilities-xTkRlJrH.js";import"./attention-BJuY3o9X.js";import"./button-U667JWCY.js";var p=Object.freeze,y=Object.defineProperty,l=(t,g)=>p(y(t,"raw",{value:p(t.slice())})),d,u,m,b;const{events:E,args:I,argTypes:f}=w("w-attention"),T={title:"Overlays/Attention",render(t){return e`
      <w-attention ${c(v(t))}>
        <w-button
          ${c({id:t.buttonId})}
          variant="secondary"

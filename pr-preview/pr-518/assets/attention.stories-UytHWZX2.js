import{g as w,b as e}from"./iframe-DYb0rld_.js";import{s as c,p as v}from"./utilities-BIbceZT9.js";import"./attention-zrbQ0TPw.js";import"./button-CQuO8s3G.js";var p=Object.freeze,y=Object.defineProperty,l=(t,g)=>p(y(t,"raw",{value:p(t.slice())})),d,u,m,b;const{events:E,args:I,argTypes:f}=w("w-attention"),T={title:"Overlays/Attention",render(t){return e`
      <w-attention ${c(v(t))}>
        <w-button
          ${c({id:t.buttonId})}
          variant="secondary"
